...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("bullet-heaven", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("bullet-heaven", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "bullet-heaven";
		app.meta["name"] = "bullet-heaven";
		...
		#elseif air
		app.window.title = "bullet-heaven";
		#else

...
HXLINE(  39)		HX_VARI(  ::Dynamic,c) = o->__GetClass();
...
HXLINE(  72)
HXLINE(  73)		HX_VARI( ::hx::Class,result) =  ::hx::Class_obj::Resolve(name);
...
::hx::Class Type_obj::resolveEnum(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE(  80)
HXLINE(  81)		HX_VARI( ::hx::Class,result) =  ::hx::Class_obj::Resolve(name);
...
HXLINE( 127)		HX_VARI( int,t) = ( (int)(v->__GetType()) );
...
::String Type_obj::enumConstructor( ::Dynamic e){
            	...
            	HX_STACK_ARG(e,"e")
HXLINE( 153)
HXLINE( 154)		HX_VARI(  hx::EnumBase,value) = ( ( hx::EnumBase)(e) );
...
::cpp::VirtualArray Type_obj::enumParameters( ::Dynamic e){
            	...
            	HX_STACK_ARG(e,"e")
HXLINE( 158)
HXLINE( 159)		HX_VARI(  hx::EnumBase,value) = ( ( hx::EnumBase)(e) );

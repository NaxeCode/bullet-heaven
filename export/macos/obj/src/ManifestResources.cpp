...
HXLINE(  76)		HX_VAR(  ::Dynamic,data);
HXDLIN(  76)		HX_VAR(  ::Dynamic,manifest);
HXDLIN(  76)		HX_VAR(  ::Dynamic,bundle);
HXLINE(  78)		{
...
HXLINE(  76)		HX_VARI(  ::lime::utils::AssetLibrary,library) = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));

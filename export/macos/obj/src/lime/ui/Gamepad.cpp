...
HXLINE(  49)			HX_VARI(  ::lime::ui::Gamepad,gamepad) =  ::lime::ui::Gamepad_obj::__alloc( HX_CTX ,id);
...
void Gamepad_obj::_hx___disconnect(int id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE(  56)
HXLINE(  57)		HX_VARI(  ::lime::ui::Gamepad,gamepad) = ( ( ::lime::ui::Gamepad)(::lime::ui::Gamepad_obj::devices->get(id)) );

...
HXLINE( 105)			switch((int)(type1->__get(0).StaticCast<  ::lime::ui::FileDialogType >()->_hx_getIndex())){
            				case (int)0: {
HXLINE( 112)					HX_VARI(  ::hx::Object *,path) = ::hx::DynamicPtr(null());
...
HXLINE( 125)					worker->sendComplete(( ( ::Dynamic)(path) ));
            				...
            				break;
            				case (int)1: {
HXLINE( 132)					HX_VARI(  ::hx::Object *,paths) = ::hx::DynamicPtr(null());
...
HXLINE( 149)					worker->sendComplete(( ( ::Dynamic)(paths) ));
            				...
            				break;
            				case (int)2: {
HXLINE( 176)					HX_VARI_NAME(  ::hx::Object *,path1,"path") = ::hx::DynamicPtr(null());
...
HXLINE( 189)					worker->sendComplete(( ( ::Dynamic)(path1) ));
            				...
            				break;
            				case (int)3: {
HXLINE( 156)					HX_VARI_NAME(  ::hx::Object *,path2,"path") = ::hx::DynamicPtr(null());
...
HXLINE( 195)			switch((int)(type1->__get(0).StaticCast<  ::lime::ui::FileDialogType >()->_hx_getIndex())){
            				case (int)1: {
HXLINE( 216)					HX_VARI( ::Array< ::String >,paths) = ( (::Array< ::String >)(result) );
...
HXLINE( 198)					HX_VARI( ::String,path) = ( (::String)(result) );
...
HXLINE( 212)						_gthis->onCancel->dispatch();
            	...
            	HX_STACK_ARG(defaultPath,"defaultPath")
            	HX_STACK_ARG(title,"title")
HXLINE(  97)
HXDLIN(  97)		HX_VARI_NAME( ::Array< ::Dynamic>,type1,"type") = ::Array_obj< ::Dynamic>::__new(1)->init(0,type);
...
HXLINE( 101)		HX_VARI(  ::lime::_hx_system::BackgroundWorker,worker) =  ::lime::_hx_system::BackgroundWorker_obj::__alloc( HX_CTX );
...
bool FileDialog_obj::open(::String filter,::String defaultPath,::String title){
            		...
            		void _hx_run( ::Dynamic _){
            			...
            			HX_STACK_ARG(_,"_")
HXLINE( 255)
HXLINE( 260)			HX_VARI(  ::hx::Object *,path) = ::hx::DynamicPtr(null());
...
HXLINE( 279)					HX_VARI(  ::haxe::io::Bytes,data) = ::sys::io::File_obj::getBytes(path);
...
HXLINE( 252)		HX_VARI(  ::lime::_hx_system::BackgroundWorker,worker) =  ::lime::_hx_system::BackgroundWorker_obj::__alloc( HX_CTX );
...
bool FileDialog_obj::save( ::haxe::io::Bytes data,::String filter,::String defaultPath,::String title,::String __o_type){
            		...
            		void _hx_run( ::Dynamic _){
            			...
            			HX_STACK_ARG(_,"_")
HXLINE( 325)
HXLINE( 330)			HX_VARI(  ::hx::Object *,path) = ::hx::DynamicPtr(null());
...
HXLINE( 322)		HX_VARI(  ::lime::_hx_system::BackgroundWorker,worker) =  ::lime::_hx_system::BackgroundWorker_obj::__alloc( HX_CTX );

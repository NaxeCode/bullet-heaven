...
HXLINE(  41)			HX_VARI(  ::lime::ui::Joystick,joystick) =  ::lime::ui::Joystick_obj::__alloc( HX_CTX ,id);
...
void Joystick_obj::_hx___disconnect(int id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE(  48)
HXLINE(  49)		HX_VARI(  ::lime::ui::Joystick,joystick) = ( ( ::lime::ui::Joystick)(::lime::ui::Joystick_obj::devices->get(id)) );

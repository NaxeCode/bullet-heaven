...
void HBBuffer_Impl__obj::addCodepoints( ::Dynamic this1,Float text,int textLength,int itemOffset,int itemLength){
            	...
            	HX_STACK_ARG(textLength,"textLength")
            	HX_STACK_ARG(itemOffset,"itemOffset")
            	HX_STACK_ARG(itemLength,"itemLength")
HXLINE(  42)
...
HXLINE(  75)
HXLINE(  77)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::lime::utils::_Bytes::Bytes_Impl__obj::alloc(0);
...
HXLINE(  86)			HX_VARI( ::Array< ::Dynamic>,result) = ::Array_obj< ::Dynamic>::__new();
HXLINE(  88)			HX_VARI( int,length) = bytes->length;
HXLINE(  89)			HX_VARI( int,position) = 0;
HXDLIN(  89)			HX_VAR(  ::lime::text::harfbuzz::HBGlyphInfo,info);
...
HXLINE( 111)
HXLINE( 113)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::lime::utils::_Bytes::Bytes_Impl__obj::alloc(0);
...
HXLINE( 122)			HX_VARI( ::Array< ::Dynamic>,result) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 124)			HX_VARI( int,length) = bytes->length;
HXLINE( 125)			HX_VARI( int,position) = 0;
HXDLIN( 125)			HX_VAR(  ::lime::text::harfbuzz::HBGlyphPosition,glyphPosition);

...
HXLINE( 106)		HX_VARI(  ::Dynamic,data) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_font_outline_decompose(::hx::DynamicPtr(this->src),20480)) );
...
HXLINE( 189)
HXLINE( 191)		HX_VARI(  ::Dynamic,glyphs) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_font_get_glyph_indices(::hx::DynamicPtr(this->src),characters)) );
...
HXLINE( 199)
HXLINE( 201)		HX_VARI(  ::Dynamic,value) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_font_get_glyph_metrics(::hx::DynamicPtr(this->src),glyph)) );
HXLINE( 202)		HX_VARI(  ::lime::text::GlyphMetrics,metrics) =  ::lime::text::GlyphMetrics_obj::__alloc( HX_CTX );
...
HXLINE( 220)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc(0);
HXLINE( 223)		HX_VARI( int,dataPosition) = 0;
...
HXLINE( 228)			HX_VARI( int,index) = (((( (int)(bytes->b->__get(dataPosition)) ) | (( (int)(bytes->b->__get((dataPosition + 1))) ) << 8)) | (( (int)(bytes->b->__get((dataPosition + 2))) ) << 16)) | (( (int)(bytes->b->__get((dataPosition + 3))) ) << 24));
HXLINE( 229)			dataPosition = (dataPosition + 4);
HXLINE( 230)			HX_VARI( int,width) = (((( (int)(bytes->b->__get(dataPosition)) ) | (( (int)(bytes->b->__get((dataPosition + 1))) ) << 8)) | (( (int)(bytes->b->__get((dataPosition + 2))) ) << 16)) | (( (int)(bytes->b->__get((dataPosition + 3))) ) << 24));
HXLINE( 231)			dataPosition = (dataPosition + 4);
HXLINE( 232)			HX_VARI( int,height) = (((( (int)(bytes->b->__get(dataPosition)) ) | (( (int)(bytes->b->__get((dataPosition + 1))) ) << 8)) | (( (int)(bytes->b->__get((dataPosition + 2))) ) << 16)) | (( (int)(bytes->b->__get((dataPosition + 3))) ) << 24));
HXLINE( 233)			dataPosition = (dataPosition + 4);
HXLINE( 234)			HX_VARI( int,x) = (((( (int)(bytes->b->__get(dataPosition)) ) | (( (int)(bytes->b->__get((dataPosition + 1))) ) << 8)) | (( (int)(bytes->b->__get((dataPosition + 2))) ) << 16)) | (( (int)(bytes->b->__get((dataPosition + 3))) ) << 24));
HXLINE( 235)			dataPosition = (dataPosition + 4);
HXLINE( 236)			HX_VARI( int,y) = (((( (int)(bytes->b->__get(dataPosition)) ) | (( (int)(bytes->b->__get((dataPosition + 1))) ) << 8)) | (( (int)(bytes->b->__get((dataPosition + 2))) ) << 16)) | (( (int)(bytes->b->__get((dataPosition + 3))) ) << 24));
HXLINE( 237)			dataPosition = (dataPosition + 4);
HXLINE( 239)			HX_VARI(  ::haxe::io::Bytes,data) = bytes->sub(dataPosition,(width * height));
...
HXDLIN( 242)			HX_VARI(  ::lime::graphics::ImageBuffer,buffer) =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,width,height,8,null());
HXLINE( 243)			HX_VARI(  ::lime::graphics::Image,image) =  ::lime::graphics::Image_obj::__alloc( HX_CTX ,buffer,0,0,width,height,null(),null());
...
HX_DEFINE_DYNAMIC_FUNC2(Font_obj,renderGlyph,return )
 ...
 ::haxe::ds::IntMap Font_obj::renderGlyphs(::Array< int > glyphs,int fontSize){
            	...
            	HX_STACK_ARG(fontSize,"fontSize")
HXLINE( 255)
HXLINE( 257)		HX_VARI(  ::haxe::ds::IntMap,uniqueGlyphs) =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 259)		{
HXLINE( 259)			int _g = 0;
HXDLIN( 259)			while((_g < glyphs->length)){
HXLINE( 259)				HX_VARI( int,glyph) = glyphs->__get(_g);
HXDLIN( 259)				_g = (_g + 1);
HXLINE( 261)				uniqueGlyphs->set(glyph,true);
            			}
            		}
HXLINE( 264)		HX_VARI( ::Array< int >,glyphList) = ::Array_obj< int >::__new(0);
HXLINE( 266)		{
HXLINE( 266)			HX_VARI(  ::Dynamic,key) = uniqueGlyphs->keys();
HXDLIN( 266)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 266)				HX_VARI_NAME( int,key1,"key") = ( (int)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 284)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc(0);
...
HXLINE( 289)			HX_VARI( int,bytesPosition) = 0;
HXLINE( 290)			HX_VARI( int,count) = (((( (int)(bytes->b->__get(bytesPosition)) ) | (( (int)(bytes->b->__get((bytesPosition + 1))) ) << 8)) | (( (int)(bytes->b->__get((bytesPosition + 2))) ) << 16)) | (( (int)(bytes->b->__get((bytesPosition + 3))) ) << 24));
HXLINE( 291)			bytesPosition = (bytesPosition + 4);
HXLINE( 293)			HX_VARI( int,bufferWidth) = 128;
HXLINE( 294)			HX_VARI( int,bufferHeight) = 128;
HXLINE( 295)			HX_VARI( int,offsetX) = 0;
HXLINE( 296)			HX_VARI( int,offsetY) = 0;
HXLINE( 297)			HX_VARI( int,maxRows) = 0;
HXLINE( 299)			HX_VAR( int,width);
HXDLIN( 299)			HX_VAR( int,height);
HXLINE( 300)			HX_VARI( int,i) = 0;
...
HXLINE( 351)			HX_VARI(  ::haxe::ds::IntMap,map) =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 352)			HX_VARI(  ::lime::graphics::ImageBuffer,buffer) =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,null(),bufferWidth,bufferHeight,8,null());
HXLINE( 353)			HX_VARI( int,dataPosition) = 0;
HXLINE( 354)			HX_VARI(  ::haxe::io::Bytes,data) = ::haxe::io::Bytes_obj::alloc((bufferWidth * bufferHeight));
HXLINE( 356)			bytesPosition = 4;
HXLINE( 357)			offsetX = 0;
HXLINE( 358)			offsetY = 0;
HXLINE( 359)			maxRows = 0;
HXLINE( 361)			HX_VAR( int,index);
HXDLIN( 361)			HX_VAR( int,x);
HXDLIN( 361)			HX_VAR( int,y);
HXDLIN( 361)			HX_VAR(  ::lime::graphics::Image,image);
HXLINE( 363)			{
HXLINE( 363)				int _g1 = 0;
HXDLIN( 363)				int _g2 = count;
HXDLIN( 363)				while((_g1 < _g2)){
HXLINE( 363)					_g1 = (_g1 + 1);
HXDLIN( 363)					HX_VARI_NAME( int,i1,"i") = (_g1 - 1);
...
HXDLIN( 383)							HX_VARI_NAME( int,i2,"i") = (_g3 - 1);
...
HX_DEFINE_DYNAMIC_FUNC0(Font_obj,_hx___initializeSource,(void))
 ...
 ::lime::app::Future Font_obj::_hx___loadFromName(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 496)
HXLINE( 497)		HX_VARI(  ::lime::app::Promise_lime_text_Font,promise) =  ::lime::app::Promise_lime_text_Font_obj::__alloc( HX_CTX );
...
HXLINE( 124)		HX_VARI(  ::lime::text::Font,font) =  ::lime::text::Font_obj::__alloc( HX_CTX ,null());
...
HXLINE( 138)		HX_VARI(  ::lime::text::Font,font) =  ::lime::text::Font_obj::__alloc( HX_CTX ,null());
...
HXLINE( 158)			return null();
            	...
            	HX_STACK_ARG(path,"path")
HXLINE( 154)
HXLINE( 155)		HX_VARI(  ::lime::net::_HTTPRequest_lime_text_Font,request) =  ::lime::net::_HTTPRequest_lime_text_Font_obj::__alloc( HX_CTX ,null());

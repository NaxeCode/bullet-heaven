...
HXLINE( 124)				HX_VARI(  ::lime::utils::AssetLibrary,library) = _g1->__get(_g).StaticCast<  ::lime::utils::AssetLibrary >();
HXDLIN( 124)				_g = (_g + 1);
...
HXLINE( 132)				HX_VARI_NAME(  ::lime::utils::AssetLibrary,library1,"library") = _g3->__get(_g2).StaticCast<  ::lime::utils::AssetLibrary >();
...
HXLINE( 176)				HX_VARI( ::String,name) = _g5->__get(_g4);
...
HXLINE( 190)		HX_VARI( int,current) = this->loadedLibraries;
HXLINE( 191)		if (!(this->preloadStarted)) {
HXLINE( 191)			current = (current + 1);
            		}
HXLINE( 193)		HX_VARI( int,totalLibraries) = (this->libraries->length + this->libraryNames->length);
...
HXLINE( 267)								_gthis->onProgress->dispatch(_gthis->bytesLoaded,_gthis->bytesTotal);
            					...
            					void _hx_run( ::lime::utils::AssetLibrary library){
            						...
            						HX_STACK_ARG(library,"library")
HXLINE( 272)
HXLINE( 273)						HX_VARI( int,total) = 200;
...
HXLINE( 237)					HX_VARI( ::String,name) = _g1->__get(_g);
HXDLIN( 237)					_g = (_g + 1);

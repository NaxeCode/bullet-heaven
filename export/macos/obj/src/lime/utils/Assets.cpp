...
HXLINE(  83)				HX_VARI(  ::Dynamic,font) = ::lime::utils::Assets_obj::cache->font->get(id);
...
HXLINE(  91)				HX_VARI(  ::lime::graphics::Image,image) = ( ( ::lime::graphics::Image)(::lime::utils::Assets_obj::cache->image->get(id)) );
...
HXLINE(  99)				HX_VARI(  ::lime::media::AudioBuffer,audio) = ( ( ::lime::media::AudioBuffer)(::lime::utils::Assets_obj::cache->audio->get(id)) );
...
HXLINE( 122)					HX_VARI(  ::Dynamic,asset) = symbol_library->getAsset(symbol_symbolName,type);
...
::Array< ::String > Assets_obj::list(::String type){
            	...
            	HX_STACK_ARG(type,"type")
HXLINE( 287)
HXLINE( 288)		HX_VARI( ::Array< ::String >,items) = ::Array_obj< ::String >::__new(0);
HXLINE( 290)		{
HXLINE( 290)			HX_VARI(  ::Dynamic,library) = ::lime::utils::Assets_obj::libraries->iterator();
HXDLIN( 290)			while(( (bool)(library->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 290)				HX_VARI_NAME(  ::lime::utils::AssetLibrary,library1,"library") = ( ( ::lime::utils::AssetLibrary)(library->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 292)				HX_VARI( ::Array< ::String >,libraryItems) = library1->list(type);
...
HXLINE( 308)			::String _hx_switch_0 = type;
            			if (  (_hx_switch_0==HX_("FONT",cf,25,81,2e)) ){
HXLINE( 315)				HX_VARI(  ::Dynamic,font) = ::lime::utils::Assets_obj::cache->font->get(id);
...
HXLINE( 314)				goto _hx_goto_16;
            			...
            			if (  (_hx_switch_0==HX_("IMAGE",3b,57,57,3b)) ){
HXLINE( 323)				HX_VARI(  ::lime::graphics::Image,image) = ( ( ::lime::graphics::Image)(::lime::utils::Assets_obj::cache->image->get(id)) );
...
HXLINE( 322)				goto _hx_goto_16;
            			...
            			if (  (_hx_switch_0==HX_("MUSIC",85,08,49,8e)) ||  (_hx_switch_0==HX_("SOUND",af,c4,ba,fe)) ){
HXLINE( 331)				HX_VARI(  ::lime::media::AudioBuffer,audio) = ( ( ::lime::media::AudioBuffer)(::lime::utils::Assets_obj::cache->audio->get(id)) );
...
HXLINE( 352)				HX_VARI(  ::lime::app::Future,future) = symbol_library->loadAsset(symbol_symbolName,type);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Assets_obj,loadImage,return )
 ...
 ::lime::app::Future Assets_obj::loadLibrary(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 396)
HXLINE( 397)		HX_VARI(  ::lime::app::Promise_lime_utils_AssetLibrary,promise) =  ::lime::app::Promise_lime_utils_AssetLibrary_obj::__alloc( HX_CTX );
HXLINE( 400)		HX_VARI(  ::lime::utils::AssetLibrary,library) = ::lime::utils::Assets_obj::getLibrary(id);
HXLINE( 402)		if (::hx::IsNotNull( library )) {
HXLINE( 404)			return library->load();
            		}
HXLINE( 407)		HX_VARI( ::String,path) = id;
HXLINE( 408)		HX_VARI( ::String,rootPath) = null();
...
HXLINE( 420)				HX_VARI(  ::lime::utils::AssetLibrary,library) = ::lime::utils::AssetLibrary_obj::fromBundle(bundle);
...
HXLINE( 466)				HX_VARI(  ::lime::utils::AssetLibrary,library) = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
...
HXLINE( 528)		HX_VARI(  ::lime::utils::AssetLibrary,library) = ( ( ::lime::utils::AssetLibrary)(::lime::utils::Assets_obj::libraries->get(name)) );

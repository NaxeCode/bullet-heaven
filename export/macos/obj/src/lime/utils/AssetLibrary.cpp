...
HXLINE(  53)
HXLINE(  54)		HX_VAR( ::String,requestedType);
...
HXLINE(  55)		HX_VARI( ::String,assetType) = this->types->get_string(id);
...
HXLINE( 215)				HX_VARI(  ::haxe::io::Bytes,bytes) = ::lime::utils::_Bytes::Bytes_Impl__obj::ofString(this->cachedText->get_string(id));
...
HXLINE( 314)			HX_VARI(  ::haxe::io::Bytes,bytes) = this->getBytes(id);
...
::Array< ::String > AssetLibrary_obj::list(::String type){
            	...
            	HX_STACK_ARG(type,"type")
HXLINE( 359)
HXLINE( 360)		HX_VAR( ::String,requestedType);
...
HXLINE( 361)		HX_VARI( ::Array< ::String >,items) = ::Array_obj< ::String >::__new(0);
HXLINE( 363)		{
HXLINE( 363)			HX_VARI(  ::Dynamic,id) = this->types->keys();
HXDLIN( 363)			while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 363)				HX_VARI_NAME( ::String,id1,"id") = ( (::String)(id->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 404)			{
HXLINE( 404)				HX_VARI(  ::Dynamic,id) = this->preload->keys();
HXDLIN( 404)				while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 404)					HX_VARI_NAME( ::String,id1,"id") = ( (::String)(id->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 415)								HX_VARI(  ::lime::app::Future,future) = this->loadBytes(id1);
...
HXLINE( 423)								HX_VARI_NAME(  ::lime::app::Future,future1,"future") = this->loadFont(id1);
...
HXLINE( 431)								HX_VARI_NAME(  ::lime::app::Future,future2,"future") = this->loadImage(id1);
...
HXLINE( 439)								HX_VARI_NAME(  ::lime::app::Future,future3,"future") = this->loadAudioBuffer(id1);
...
HXLINE( 447)								HX_VARI_NAME(  ::lime::app::Future,future4,"future") = this->loadText(id1);
...
HXLINE( 513)				HX_VARI(  ::lime::text::Font,font) = ( ( ::lime::text::Font)(::Type_obj::createInstance(this->classTypes->get(id),::cpp::VirtualArray_obj::__new(0))) );
...
HXLINE( 594)				HX_VARI(  ::haxe::io::Bytes,bytes) = this->getBytes(id);
HXLINE( 596)				if (::hx::IsNull( bytes )) {
HXLINE( 598)					return ::lime::app::Future_obj::withValue(null());
            				}
            				else {
HXLINE( 602)					HX_VARI( ::String,text) = bytes->getString(0,bytes->length,null());
HXLINE( 603)					this->cachedText->set(id,text);
HXLINE( 604)					return ::lime::app::Future_obj::withValue(text);
            				}
            			}
            			else {
HXLINE( 609)				HX_VARI(  ::lime::net::_HTTPRequest_String,request) =  ::lime::net::_HTTPRequest_String_obj::__alloc( HX_CTX ,null());
...
HXLINE( 642)			HX_VAR(  ::Dynamic,size);
...
HXLINE( 650)				HX_VARI(  ::Dynamic,cache) = this->bytesLoadedCache->get(id);
...
void AssetLibrary_obj::_hx___fromBundle( ::lime::utils::AssetBundle bundle, ::lime::utils::AssetManifest manifest){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(bundle,"bundle")
            	HX_STACK_ARG(manifest,"manifest")
HXLINE( 680)
HXDLIN( 680)		if (::hx::IsNotNull( manifest )) {
HXLINE( 682)			HX_VAR( ::String,id);
HXDLIN( 682)			HX_VAR(  ::haxe::io::Bytes,data);
HXDLIN( 682)			HX_VAR( ::String,type);
HXLINE( 683)			{
HXLINE( 683)				int _g = 0;
HXDLIN( 683)				::cpp::VirtualArray _g1 = manifest->assets;
HXDLIN( 683)				while((_g < _g1->get_length())){
HXLINE( 683)					HX_VARI(  ::Dynamic,asset) = _g1->__get(_g);
HXDLIN( 683)					_g = (_g + 1);
...
HXLINE( 717)				HX_VARI( ::String,path) = _g3->__get(_g2);
...
void AssetLibrary_obj::_hx___fromManifest( ::lime::utils::AssetManifest manifest){
            	...
            	HX_STACK_ARG(manifest,"manifest")
HXLINE( 726)
HXLINE( 727)		HX_VARI( bool,hasSize) = (manifest->version >= 2);
HXLINE( 728)		HX_VAR( int,size);
HXDLIN( 728)		HX_VAR( ::String,id);
HXDLIN( 728)		HX_VAR( ::Array< ::String >,pathGroup);
HXDLIN( 728)		HX_VAR( ::hx::Class,classRef);
HXLINE( 730)		HX_VARI( ::String,basePath) = manifest->rootPath;
...
HXLINE( 734)				HX_VARI(  ::Dynamic,asset) = _g1->__get(_g);
HXDLIN( 734)				_g = (_g + 1);
...
HXDLIN( 748)							HX_VARI( int,i) = (_g2 - 1);
...
HXLINE( 781)				HX_VARI_NAME(  ::Dynamic,asset1,"asset") = _g5->__get(_g4);
...
HXLINE( 796)		HX_VARI( int,colonIdx) = path.indexOf(HX_(":",3a,00,00,00),null());
...
HXLINE( 799)			HX_VARI( int,lastSlashIdx) = (colonIdx + 3);
HXLINE( 800)			HX_VARI( ::String,httpSection) = path.substr(0,lastSlashIdx);
...
HXLINE( 817)			HX_VARI( ::Array< ::String >,split) = path.split(HX_("/",2f,00,00,00));
HXLINE( 818)			HX_VARI( ::Array< ::String >,newPath) = ::Array_obj< ::String >::__new(0);
HXLINE( 820)			{
HXLINE( 820)				int _g = 0;
HXDLIN( 820)				int _g1 = split->length;
HXDLIN( 820)				while((_g < _g1)){
HXLINE( 820)					_g = (_g + 1);
HXDLIN( 820)					HX_VARI( int,i) = (_g - 1);
...
HXLINE( 858)			HX_VARI( ::Array< ::String >,pathGroup) = ( (::Array< ::String >)(this->pathGroups->get(id)) );
HXLINE( 860)			{
HXLINE( 860)				HX_VARI(  ::Dynamic,otherID) = this->pathGroups->keys();
HXDLIN( 860)				while(( (bool)(otherID->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 860)					HX_VARI_NAME( ::String,otherID1,"otherID") = ( (::String)(otherID->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 864)							HX_VARI( ::String,path) = pathGroup->__get(_g);
HXDLIN( 864)							_g = (_g + 1);
...
HXLINE( 936)			HX_VARI(  ::Dynamic,size) = this->sizes->get(id);
HXLINE( 937)			HX_VAR( Float,percent);
...
HXLINE( 954)				HX_VARI(  ::Dynamic,cache) = this->bytesLoadedCache->get(id);
...
HXLINE( 103)			HX_VARI(  ::lime::utils::AssetManifest,manifest) = ::lime::utils::AssetManifest_obj::fromBytes(( ( ::haxe::io::Bytes)(bundle->data->get(HX_("library.json",7b,9c,b0,78))) ),null());
HXLINE( 104)			if (::hx::IsNotNull( manifest )) {
HXLINE( 106)				HX_VARI(  ::lime::utils::AssetLibrary,library) = null();
HXLINE( 108)				if (::hx::IsNull( manifest->libraryType )) {
HXLINE( 110)					library =  ::lime::utils::AssetLibrary_obj::__alloc( HX_CTX );
            				}
            				else {
HXLINE( 114)					HX_VARI( ::hx::Class,libraryClass) = ::Type_obj::resolveClass(manifest->libraryType);
...
HXLINE( 133)			HX_VARI_NAME(  ::lime::utils::AssetLibrary,library1,"library") =  ::lime::utils::AssetLibrary_obj::__alloc( HX_CTX );
...
HXLINE( 144)		HX_VARI(  ::lime::utils::AssetLibrary,library) = null();
HXLINE( 146)		if (::hx::IsNull( manifest->libraryType )) {
HXLINE( 148)			library =  ::lime::utils::AssetLibrary_obj::__alloc( HX_CTX );
            		}
            		else {
HXLINE( 152)			HX_VARI( ::hx::Class,libraryClass) = ::Type_obj::resolveClass(manifest->libraryType);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(AssetLibrary_obj,loadFromFile,return )
 ...
 ::lime::app::Future AssetLibrary_obj::loadFromManifest( ::lime::utils::AssetManifest manifest){
            	...
            	HX_STACK_ARG(manifest,"manifest")
HXLINE( 548)
HXLINE( 549)		HX_VARI(  ::lime::utils::AssetLibrary,library) = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);

...
HXLINE(  89)			HX_VARI(  ::Dynamic,keys) = this->audio->keys();
HXLINE(  91)			{
HXLINE(  91)				HX_VARI(  ::Dynamic,key) = keys;
HXDLIN(  91)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  91)					HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  93)					if (::StringTools_obj::startsWith(key1,prefix)) {
HXLINE(  95)						this->audio->remove(key1);
            					}
            				}
            			}
HXLINE(  99)			HX_VARI_NAME(  ::Dynamic,keys1,"keys") = this->font->keys();
HXLINE( 101)			{
HXLINE( 101)				HX_VARI_NAME(  ::Dynamic,key2,"key") = keys1;
HXDLIN( 101)				while(( (bool)(key2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 101)					HX_VARI_NAME( ::String,key3,"key") = ( (::String)(key2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 103)					if (::StringTools_obj::startsWith(key3,prefix)) {
HXLINE( 105)						this->font->remove(key3);
            					}
            				}
            			}
HXLINE( 109)			HX_VARI_NAME(  ::Dynamic,keys2,"keys") = this->image->keys();
HXLINE( 111)			{
HXLINE( 111)				HX_VARI_NAME(  ::Dynamic,key4,"key") = keys2;
HXDLIN( 111)				while(( (bool)(key4->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 111)					HX_VARI_NAME( ::String,key5,"key") = ( (::String)(key4->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );

...
HXLINE( 143)
HXLINE( 144)		HX_VARI(  ::lime::app::Application,currentApp) = ::lime::app::Application_obj::current;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(System_obj,exit,(void))
 ...
 ::lime::_hx_system::Display System_obj::getDisplay(int id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 171)
HXLINE( 173)		HX_VARI(  ::Dynamic,displayInfo) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_system_get_display(id)) );
HXLINE( 175)		if (::hx::IsNotNull( displayInfo )) {
HXLINE( 177)			HX_VARI(  ::lime::_hx_system::Display,display) =  ::lime::_hx_system::Display_obj::__alloc( HX_CTX );
...
HXLINE( 206)			HX_VAR(  ::lime::_hx_system::DisplayMode,displayMode);
HXLINE( 211)			HX_VARI( ::cpp::VirtualArray,supportedModes) = ( (::cpp::VirtualArray)(displayInfo->__Field(HX_("supportedModes",a2,a6,b8,b7),::hx::paccDynamic)) );
HXLINE( 213)			{
HXLINE( 213)				int _g = 0;
HXDLIN( 213)				while((_g < supportedModes->get_length())){
HXLINE( 213)					HX_VARI(  ::Dynamic,mode) = supportedModes->__get(_g);
HXDLIN( 213)					_g = (_g + 1);
...
HXLINE( 219)			HX_VARI_NAME(  ::Dynamic,mode1,"mode") = displayInfo->__Field(HX_("currentMode",3c,ac,f2,80),::hx::paccDynamic);
HXLINE( 220)			HX_VARI(  ::lime::_hx_system::DisplayMode,currentMode) =  ::lime::_hx_system::DisplayMode_obj::__alloc( HX_CTX ,( (int)(mode1->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic)) ),( (int)(mode1->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic)) ),( (int)(mode1->__Field(HX_("refreshRate",5b,e2,3f,40),::hx::paccDynamic)) ),( (int)(mode1->__Field(HX_("pixelFormat",5d,72,1b,6f),::hx::paccDynamic)) ));
HXLINE( 222)			{
HXLINE( 222)				int _g1 = 0;
HXDLIN( 222)				::Array< ::Dynamic> _g2 = display->supportedModes;
HXDLIN( 222)				while((_g1 < _g2->length)){
HXLINE( 222)					HX_VARI_NAME(  ::lime::_hx_system::DisplayMode,mode2,"mode") = _g2->__get(_g1).StaticCast<  ::lime::_hx_system::DisplayMode >();
...
HXLINE( 303)			::Sys_obj::command(HX_("/usr/bin/open",5c,58,a2,62),::Array_obj< ::String >::__new(1)->init(0,path));
            		}
            	}
...
HXLINE( 342)				HX_VARI( ::String,field) = _g1->__get(_g);
HXDLIN( 342)				_g = (_g + 1);
...
HXLINE( 360)			HX_VAR( ::String,path);
HXLINE( 362)			if ((type == 1)) {
HXLINE( 364)				HX_VARI( ::String,company) = HX_("MyCompany",11,c3,2e,cc);
HXLINE( 365)				HX_VARI( ::String,file) = HX_("MyApplication",24,d3,d1,1c);
...
HXLINE( 398)			HX_VARI( ::String,seperator) = HX_("/",2f,00,00,00);
...
HXLINE( 430)
HXLINE( 433)		HX_VARI( ::Array< ::String >,arguments) = ::Sys_obj::args();
HXLINE( 434)		HX_VARI(  ::EReg,stripQuotes) =  ::EReg_obj::__alloc( HX_CTX ,HX_("^['\"](.*)['\"]$",13,22,1b,37),HX_("",00,00,00,00));
HXLINE( 435)		HX_VAR( int,equals);
HXDLIN( 435)		HX_VAR( ::String,argValue);
HXDLIN( 435)		HX_VARI(  ::haxe::ds::StringMap,parameters) = null();
HXLINE( 436)		HX_VARI( ::String,windowParamPrefix) = HX_("--window-",dd,62,c2,0a);
HXLINE( 438)		if (::hx::IsNotNull( arguments )) {
HXLINE( 440)			int _g = 0;
HXDLIN( 440)			while((_g < arguments->length)){
HXLINE( 440)				HX_VARI( ::String,argument) = arguments->__get(_g);
HXDLIN( 440)				_g = (_g + 1);
...
HXLINE( 464)			{
HXLINE( 464)				HX_VARI(  ::Dynamic,parameter) = parameters->keys();
HXDLIN( 464)				while(( (bool)(parameter->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 464)					HX_VARI_NAME( ::String,parameter1,"parameter") = ( (::String)(parameter->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
void System_obj::_hx___registerEntryPoint(::String projectName, ::Dynamic entryPoint){
            	...
            	HX_STACK_ARG(entryPoint,"entryPoint")
HXLINE( 534)
...
HXLINE( 550)			HX_VARI(  ::sys::io::Process,process) =  ::sys::io::Process_obj::__alloc( HX_CTX ,command,args,null());
HXLINE( 551)			HX_VARI( ::String,value) = ::StringTools_obj::trim(process->_hx_stdout->readLine().toString());
...
HXLINE( 625)			::lime::_hx_system::System_obj::_hx___deviceModel = ::lime::_hx_system::System_obj::_hx___runProcess(HX_("sysctl",ae,bd,d5,f2),::Array_obj< ::String >::fromData( _hx_array_data_acbd8395_23,2));
            		}
...
HXLINE( 651)			::lime::_hx_system::System_obj::_hx___deviceVendor = HX_("Apple",3a,f5,68,b7);
            		}
...
HXLINE( 687)			HX_VARI(  ::haxe::io::Bytes,arrayBuffer) = ::haxe::io::Bytes_obj::alloc(2);
...
HXDLIN( 688)			HX_VARI(  ::lime::utils::ArrayBufferView,uint8Array) = this1;
...
HXDLIN( 689)			HX_VARI(  ::lime::utils::ArrayBufferView,uint16array) = this2;
...
HXLINE( 734)			HX_VARI( ::String,name) = ::lime::_hx_system::System_obj::get_platformName();
HXLINE( 735)			HX_VARI( ::String,version) = ::lime::_hx_system::System_obj::get_platformVersion();
...
HXLINE( 751)			::lime::_hx_system::System_obj::_hx___platformName = HX_("macOS",73,51,16,03);
            		}
...
HXLINE( 799)			::lime::_hx_system::System_obj::_hx___platformVersion = ::lime::_hx_system::System_obj::_hx___runProcess(HX_("sw_vers",6b,99,f9,43),::Array_obj< ::String >::fromData( _hx_array_data_acbd8395_33,1));
            		}

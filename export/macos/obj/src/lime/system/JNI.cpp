...
HXLINE(  52)
HXLINE(  53)		HX_VARI( ::Array< ::String >,parts) = className.split(HX_(".",2e,00,00,00));
HXLINE(  54)		if ((parts->length <= 1)) {
HXLINE(  55)			return className;
            		}
HXLINE(  57)		HX_VARI( ::String,nestedClassName) = HX_("",00,00,00,00);
...
HXLINE( 213)
HXLINE( 214)		HX_VARI(  ::Dynamic,field) = ::Reflect_obj::field(object,method);

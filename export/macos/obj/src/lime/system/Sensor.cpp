...
HXLINE(  34)					HX_VARI(  ::lime::_hx_system::Sensor,sensor) = _g1->__get(_g).StaticCast<  ::lime::_hx_system::Sensor >();
HXDLIN(  34)					_g = (_g + 1);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Sensor_obj,getSensors,return )
 ...
 ::lime::_hx_system::Sensor Sensor_obj::registerSensor( ::lime::_hx_system::SensorType type,int id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE(  47)
HXLINE(  48)		HX_VARI(  ::lime::_hx_system::Sensor,sensor) =  ::lime::_hx_system::Sensor_obj::__alloc( HX_CTX ,type,id);

...
HXLINE(  69)		HX_VARI(  ::Dynamic,result) = null();
...
HXLINE( 139)			HX_VARI( ::String,programPath) = HX_(".",2e,00,00,00);
...
HXLINE( 210)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 212)			HX_VARI(  ::sys::io::Process,proc) =  ::sys::io::Process_obj::__alloc( HX_CTX ,HX_("haxelib",df,b6,80,08),::Array_obj< ::String >::__new(2)->init(0,HX_("path",a5,e5,51,4a))->init(1,library),null());
HXLINE( 214)			if (::hx::IsNotNull( proc )) {
HXLINE( 216)				HX_VARI(  ::haxe::io::Input,stream) = proc->_hx_stdout;
HXLINE( 218)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 220)					while(true){
HXLINE( 222)						HX_VARI( ::String,s) = stream->readLine();
...
HXLINE( 246)
HXLINE( 252)		HX_VARI( bool,debug) = ::hx::IsNotNull( ::Sys_obj::getEnv(HX_("OPENFL_LOAD_DEBUG",a9,1b,ff,9b)) );
HXLINE( 255)		if (debug) {
...
HXLINE( 322)
HXLINE( 325)		HX_VARI(  ::Dynamic,sys_string) = ::cpp::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("sys_string",03,f9,de,46),0);
...
HXLINE( 338)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 341)			HX_VARI(  ::Dynamic,result) = ::cpp::Lib_obj::load(name,func,args);

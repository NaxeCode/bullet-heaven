...
void ImageCanvasUtil_obj::convertToData( ::lime::graphics::Image image,::hx::Null< bool >  __o_clear){
            	...
            	HX_STACK_ARG(clear,"clear")
HXLINE(  79)
HXLINE(  80)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) = image->buffer;
...
HXLINE( 142)			HX_VARI(  ::lime::graphics::Image,tempData) = sourceImage->clone();
...
HXLINE( 229)		HX_VAR( int,r);
HXDLIN( 229)		HX_VAR( int,g);
HXDLIN( 229)		HX_VAR( int,b);
HXDLIN( 229)		HX_VAR( int,a);
...
HXLINE( 308)
HXLINE( 309)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) = image->buffer;
...
HXLINE( 319)			HX_VARI(  ::Dynamic,sourceCanvas) = buffer->_hx___srcCanvas;
...
HXLINE( 336)		HX_VARI(  ::lime::graphics::Image,copy) = image->clone();

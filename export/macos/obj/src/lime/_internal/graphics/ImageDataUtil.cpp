...
void ImageDataUtil_obj::displaceMap( ::lime::graphics::Image target, ::lime::graphics::Image source, ::lime::graphics::Image map, ::lime::math::Vector2 mapPoint, ::lime::math::Vector4 componentX, ::lime::math::Vector4 componentY,bool smooth){
            	...
            	HX_STACK_ARG(mapPoint,"mapPoint")
            	HX_STACK_ARG(componentX,"componentX")
            	HX_STACK_ARG(componentY,"componentY")
            	HX_STACK_ARG(smooth,"smooth")
HXLINE(  33)
HXLINE(  34)		HX_VARI(  ::lime::utils::ArrayBufferView,targetData) = target->buffer->data;
HXLINE(  35)		HX_VARI(  ::lime::utils::ArrayBufferView,sourceData) = source->buffer->data;
HXLINE(  36)		HX_VARI(  ::lime::utils::ArrayBufferView,mapData) = map->buffer->data;
HXLINE(  38)		HX_VARI( int,targetFormat) = target->buffer->format;
HXLINE(  39)		HX_VARI( int,sourceFormat) = source->buffer->format;
HXLINE(  40)		HX_VARI( int,mapFormat) = map->buffer->format;
HXLINE(  42)		HX_VARI( bool,targetPremultiplied) = target->get_premultiplied();
HXLINE(  43)		HX_VARI( bool,sourcePremultiplied) = source->get_premultiplied();
HXLINE(  44)		HX_VARI( bool,mapPremultiplied) = map->get_premultiplied();
HXLINE(  46)		HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,sourceView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,source,null());
HXLINE(  47)		HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,mapView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,map,null());
HXLINE(  49)		HX_VAR( int,row);
HXLINE(  51)		HX_VAR( int,sourceOffset);
HXLINE(  53)		HX_VARI( int,sourcePixel) = 0;
HXLINE(  54)		HX_VARI( int,mapPixel) = 0;
HXLINE(  55)		HX_VARI( int,targetPixel) = 0;
HXLINE(  57)		HX_VAR( Float,mapPixelX);
HXLINE(  58)		HX_VAR( Float,mapPixelY);
HXLINE(  59)		HX_VAR( Float,mapPixelA);
HXLINE(  62)		HX_VARI( int,s1) = 0;
HXLINE(  63)		HX_VARI( int,s2) = 0;
HXLINE(  64)		HX_VARI( int,s3) = 0;
HXLINE(  65)		HX_VARI( int,s4) = 0;
HXLINE(  67)		HX_VAR( int,mPointXFloor);
HXLINE(  68)		HX_VAR( int,mPointYFloor);
HXLINE(  70)		HX_VAR( int,disOffsetXFloor);
HXLINE(  71)		HX_VAR( int,disOffsetYFloor);
HXLINE(  73)		HX_VAR( Float,disX);
HXLINE(  74)		HX_VAR( Float,disY);
HXLINE(  76)		{
HXLINE(  76)			int _g = 0;
HXDLIN(  76)			int _g1 = sourceView->height;
HXDLIN(  76)			while((_g < _g1)){
HXLINE(  76)				_g = (_g + 1);
HXDLIN(  76)				HX_VARI( int,y) = (_g - 1);
...
int ImageDataUtil_obj::lerpRGBA(int v0,int v1,Float x){
            	...
            	HX_STACK_ARG(x,"x")
HXLINE( 143)
HXLINE( 144)		HX_VARI( int,result) = 0;
HXLINE( 145)		{
...
HXLINE( 164)
HXLINE( 165)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
...
HXLINE( 173)			HX_VARI( int,format) = image->buffer->format;
HXLINE( 174)			HX_VARI( bool,premultiplied) = image->buffer->premultiplied;
HXLINE( 176)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,dataView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,image,rect);
HXLINE( 178)			HX_VARI(  ::lime::utils::ArrayBufferView,alphaTable) = ::lime::math::_ColorMatrix::ColorMatrix_Impl__obj::getAlphaTable(colorMatrix);
HXLINE( 179)			HX_VARI(  ::lime::utils::ArrayBufferView,redTable) = ::lime::math::_ColorMatrix::ColorMatrix_Impl__obj::getRedTable(colorMatrix);
HXLINE( 180)			HX_VARI(  ::lime::utils::ArrayBufferView,greenTable) = ::lime::math::_ColorMatrix::ColorMatrix_Impl__obj::getGreenTable(colorMatrix);
HXLINE( 181)			HX_VARI(  ::lime::utils::ArrayBufferView,blueTable) = ::lime::math::_ColorMatrix::ColorMatrix_Impl__obj::getBlueTable(colorMatrix);
HXLINE( 183)			HX_VAR( int,row);
HXDLIN( 183)			HX_VAR( int,offset);
HXDLIN( 183)			HX_VARI( int,pixel) = 0;
HXLINE( 185)			{
HXLINE( 185)				int _g = 0;
HXDLIN( 185)				int _g1 = dataView->height;
HXDLIN( 185)				while((_g < _g1)){
HXLINE( 185)					_g = (_g + 1);
HXDLIN( 185)					HX_VARI( int,y) = (_g - 1);
...
HXDLIN( 189)							HX_VARI( int,x) = (_g2 - 1);
...
HXLINE( 223)		HX_VARI(  ::lime::utils::ArrayBufferView,srcData) = sourceImage->buffer->data;
HXLINE( 224)		HX_VARI(  ::lime::utils::ArrayBufferView,destData) = image->buffer->data;
...
HXLINE( 233)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,srcView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,sourceImage,sourceRect);
HXLINE( 234)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,destView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,image, ::lime::math::Rectangle_obj::__alloc( HX_CTX ,destPoint->x,destPoint->y,srcView->width,srcView->height));
HXLINE( 236)			HX_VARI( int,srcFormat) = sourceImage->buffer->format;
HXLINE( 237)			HX_VARI( int,destFormat) = image->buffer->format;
HXLINE( 238)			HX_VARI( bool,srcPremultiplied) = sourceImage->buffer->premultiplied;
HXLINE( 239)			HX_VARI( bool,destPremultiplied) = image->buffer->premultiplied;
HXLINE( 241)			HX_VAR( int,srcPosition);
HXDLIN( 241)			HX_VAR( int,destPosition);
HXDLIN( 241)			HX_VARI( int,srcPixel) = 0;
HXDLIN( 241)			HX_VARI( int,destPixel) = 0;
HXDLIN( 241)			HX_VARI( int,value) = 0;
HXLINE( 247)			{
HXLINE( 247)				int _g = 0;
HXDLIN( 247)				int _g1 = destView->height;
HXDLIN( 247)				while((_g < _g1)){
HXLINE( 247)					_g = (_g + 1);
HXDLIN( 247)					HX_VARI( int,y) = (_g - 1);
...
HXDLIN( 252)							HX_VARI( int,x) = (_g2 - 1);
HXLINE( 254)							{
...
HXLINE( 318)				HX_VARI(  ::lime::utils::ArrayBufferView,sourceData) = sourceImage->buffer->data;
HXLINE( 319)				HX_VARI(  ::lime::utils::ArrayBufferView,destData) = image->buffer->data;
...
HXLINE( 323)				HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,sourceView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,sourceImage,sourceRect);
HXLINE( 324)				HX_VARI(  ::lime::math::Rectangle,destRect) =  ::lime::math::Rectangle_obj::__alloc( HX_CTX ,destPoint->x,destPoint->y,sourceView->width,sourceView->height);
HXLINE( 325)				HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,destView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,image,destRect);
HXLINE( 327)				HX_VARI( int,sourceFormat) = sourceImage->buffer->format;
HXLINE( 328)				HX_VARI( int,destFormat) = image->buffer->format;
HXLINE( 330)				HX_VAR( int,sourcePosition);
HXDLIN( 330)				HX_VAR( int,destPosition);
HXLINE( 331)				HX_VAR( Float,sourceAlpha);
HXDLIN( 331)				HX_VAR( Float,destAlpha);
HXDLIN( 331)				HX_VAR( Float,oneMinusSourceAlpha);
HXDLIN( 331)				HX_VAR( Float,blendAlpha);
HXLINE( 332)				HX_VARI( int,sourcePixel) = 0;
HXLINE( 333)				HX_VARI( int,destPixel) = 0;
HXLINE( 335)				HX_VARI( bool,sourcePremultiplied) = sourceImage->buffer->premultiplied;
HXLINE( 336)				HX_VARI( bool,destPremultiplied) = image->buffer->premultiplied;
HXLINE( 337)				HX_VARI( int,sourceBytesPerPixel) = ::Std_obj::_hx_int((( (Float)(sourceImage->buffer->bitsPerPixel) ) / ( (Float)(8) )));
HXLINE( 338)				HX_VARI( int,destBytesPerPixel) = ::Std_obj::_hx_int((( (Float)(image->buffer->bitsPerPixel) ) / ( (Float)(8) )));
HXLINE( 340)				HX_VAR( bool,useAlphaImage);
...
HXDLIN( 353)									HX_VARI( int,x) = (_g2 - 1);
HXLINE( 355)									{
...
HXDLIN( 392)								HX_VARI_NAME( int,y1,"y") = (_g4 - 1);
...
HXDLIN( 407)								HX_VARI_NAME( int,y2,"y") = (_g6 - 1);
...
HXDLIN( 412)										HX_VARI_NAME( int,x1,"x") = (_g8 - 1);
HXLINE( 414)										{
...
HXLINE( 425)					HX_VARI(  ::lime::utils::ArrayBufferView,alphaData) = alphaImage->buffer->data;
HXLINE( 426)					HX_VARI( int,alphaFormat) = alphaImage->buffer->format;
HXLINE( 427)					HX_VAR( int,alphaPosition);
HXDLIN( 427)					HX_VARI( int,alphaPixel) = 0;
...
HXLINE( 429)					HX_VARI_NAME(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,alphaView2,"alphaView") =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,alphaImage, ::lime::math::Rectangle_obj::__alloc( HX_CTX ,(sourceView->x + alphaView),(sourceView->y + alphaView1),sourceView->width,sourceView->height));
...
HXDLIN( 437)							HX_VARI_NAME( int,y3,"y") = (_g10 - 1);
...
HXDLIN( 443)									HX_VARI_NAME( int,x2,"x") = (_g12 - 1);
HXLINE( 445)									{
...
HXDLIN( 479)							HX_VARI_NAME( int,y4,"y") = (_g14 - 1);
...
HXDLIN( 485)									HX_VARI_NAME( int,x3,"x") = (_g16 - 1);
HXLINE( 487)									{
...
HXLINE( 508)
HXLINE( 509)		HX_VAR( int,fillColor);
...
HXLINE( 526)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
...
HXLINE( 535)			HX_VARI_NAME( int,format1,"format") = image->buffer->format;
HXLINE( 536)			HX_VARI( bool,premultiplied) = image->buffer->premultiplied;
...
HXLINE( 539)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,dataView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,image,rect);
HXLINE( 540)			HX_VAR( int,row);
HXLINE( 542)			{
HXLINE( 542)				int _g = 0;
HXDLIN( 542)				int _g1 = dataView->height;
HXDLIN( 542)				while((_g < _g1)){
HXLINE( 542)					_g = (_g + 1);
HXDLIN( 542)					HX_VARI( int,y) = (_g - 1);
...
HXDLIN( 546)							HX_VARI( int,x) = (_g2 - 1);
HXLINE( 548)							{
...
void ImageDataUtil_obj::floodFill( ::lime::graphics::Image image,int x,int y,int color,int format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 558)
HXLINE( 559)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
...
HXLINE( 570)			HX_VARI_NAME( int,format1,"format") = image->buffer->format;
HXLINE( 571)			HX_VARI( bool,premultiplied) = image->buffer->premultiplied;
HXLINE( 573)			HX_VARI( int,fillColor) = color;
HXLINE( 575)			HX_VARI( int,hitColor) = 0;
HXLINE( 576)			{
...
HXLINE( 588)			HX_VARI( ::Array< int >,dx) = ::Array_obj< int >::fromData( _hx_array_data_0eb0fdcf_29,4);
HXLINE( 589)			HX_VARI( ::Array< int >,dy) = ::Array_obj< int >::fromData( _hx_array_data_0eb0fdcf_30,4);
HXLINE( 591)			HX_VARI( int,minX) = -(image->offsetX);
HXLINE( 592)			HX_VARI( int,minY) = -(image->offsetY);
HXLINE( 593)			HX_VARI( int,maxX) = (minX + image->width);
HXLINE( 594)			HX_VARI( int,maxY) = (minY + image->height);
HXLINE( 596)			HX_VARI( ::Array< int >,queue) = ::Array_obj< int >::__new();
HXLINE( 597)			queue->push(x);
HXLINE( 598)			queue->push(y);
HXLINE( 600)			HX_VAR(  ::Dynamic,curPointX);
HXDLIN( 600)			HX_VAR(  ::Dynamic,curPointY);
HXDLIN( 600)			HX_VAR( int,nextPointX);
HXDLIN( 600)			HX_VAR( int,nextPointY);
HXDLIN( 600)			HX_VAR( int,nextPointOffset);
HXDLIN( 600)			HX_VARI( int,readColor) = 0;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC5(ImageDataUtil_obj,floodFill,(void))
 ...
 ::lime::graphics::Image ImageDataUtil_obj::gaussianBlur( ::lime::graphics::Image image, ::lime::graphics::Image sourceImage, ::lime::math::Rectangle sourceRect, ::lime::math::Vector2 destPoint,::hx::Null< Float >  __o_blurX,::hx::Null< Float >  __o_blurY,::hx::Null< int >  __o_quality,::hx::Null< Float >  __o_strength, ::Dynamic color){
            	...
            	HX_STACK_ARG(color,"color")
HXLINE( 642)
HXLINE( 646)		HX_VARI( bool,imagePremultiplied) = image->get_premultiplied();
...
STATIC_HX_DEFINE_DYNAMIC_FUNC9(ImageDataUtil_obj,gaussianBlur,return )
 ...
 ::lime::math::Rectangle ImageDataUtil_obj::getColorBoundsRect( ::lime::graphics::Image image,int mask,int color,bool findColor,int format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 668)
HXLINE( 669)		HX_VARI( int,left) = (image->width + 1);
HXLINE( 670)		HX_VARI( int,right) = 0;
HXLINE( 671)		HX_VARI( int,top) = (image->height + 1);
HXLINE( 672)		HX_VARI( int,bottom) = 0;
HXLINE( 674)		HX_VAR( int,_color);
HXDLIN( 674)		HX_VAR( int,_mask);
...
HXLINE( 697)		HX_VAR( int,pixel);
HXDLIN( 697)		HX_VAR( bool,hit);
HXLINE( 699)		{
HXLINE( 699)			int _g = 0;
HXDLIN( 699)			int _g1 = image->width;
HXDLIN( 699)			while((_g < _g1)){
HXLINE( 699)				_g = (_g + 1);
HXDLIN( 699)				HX_VARI( int,x) = (_g - 1);
...
HXDLIN( 703)						HX_VARI( int,y) = (_g2 - 1);
...
HXDLIN( 728)						HX_VARI_NAME( int,y1,"y") = (_g6 - 1);
...
HXDLIN( 746)				HX_VARI_NAME( int,y2,"y") = (_g8 - 1);
...
HXDLIN( 750)						HX_VARI_NAME( int,x2,"x") = (_g10 - 1);
...
HXDLIN( 775)						HX_VARI_NAME( int,x3,"x") = (_g14 - 1);
...
HXLINE( 793)		HX_VARI( int,w) = (right - left);
HXLINE( 794)		HX_VARI( int,h) = (bottom - top);
HXLINE( 796)		if ((w > 0)) {
HXLINE( 796)			w = (w + 1);
            		}
HXLINE( 797)		if ((h > 0)) {
...
int ImageDataUtil_obj::getPixel( ::lime::graphics::Image image,int x,int y,int format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 812)
HXLINE( 813)		HX_VARI( int,pixel) = 0;
HXLINE( 815)		{
...
int ImageDataUtil_obj::getPixel32( ::lime::graphics::Image image,int x,int y,int format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 831)
HXLINE( 832)		HX_VARI( int,pixel) = 0;
HXLINE( 834)		{
...
HXLINE( 852)		HX_VARI( int,length) = ::Std_obj::_hx_int((rect->width * rect->height));
HXLINE( 853)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc((length * 4));
...
HXLINE( 860)			HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
HXLINE( 861)			HX_VARI( int,sourceFormat) = image->buffer->format;
HXLINE( 862)			HX_VARI( bool,premultiplied) = image->buffer->premultiplied;
HXLINE( 864)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,dataView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,image,rect);
HXLINE( 865)			HX_VAR( int,position);
HXLINE( 866)			HX_VARI( int,argb) = 0;
HXLINE( 867)			HX_VARI( int,bgra) = 0;
HXLINE( 868)			HX_VARI( int,pixel) = 0;
HXLINE( 869)			HX_VARI( int,destPosition) = 0;
HXLINE( 871)			{
HXLINE( 871)				int _g = 0;
HXDLIN( 871)				int _g1 = dataView->height;
HXDLIN( 871)				while((_g < _g1)){
HXLINE( 871)					_g = (_g + 1);
HXDLIN( 871)					HX_VARI( int,y) = (_g - 1);
...
HXDLIN( 875)							HX_VARI( int,x) = (_g2 - 1);
HXLINE( 877)							{
...
HXLINE( 914)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,sourceView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,sourceImage,sourceRect);
HXLINE( 915)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,destView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,image, ::lime::math::Rectangle_obj::__alloc( HX_CTX ,destPoint->x,destPoint->y,sourceView->width,sourceView->height));
HXLINE( 917)			HX_VARI(  ::lime::utils::ArrayBufferView,sourceData) = sourceImage->buffer->data;
HXLINE( 918)			HX_VARI(  ::lime::utils::ArrayBufferView,destData) = image->buffer->data;
HXLINE( 919)			HX_VARI( int,sourceFormat) = sourceImage->buffer->format;
HXLINE( 920)			HX_VARI( int,destFormat) = image->buffer->format;
HXLINE( 921)			HX_VARI( bool,sourcePremultiplied) = sourceImage->buffer->premultiplied;
HXLINE( 922)			HX_VARI( bool,destPremultiplied) = image->buffer->premultiplied;
HXLINE( 924)			HX_VAR( int,sourcePosition);
HXDLIN( 924)			HX_VAR( int,destPosition);
HXLINE( 925)			HX_VARI( int,sourcePixel) = 0;
HXLINE( 926)			HX_VARI( int,destPixel) = 0;
HXLINE( 928)			{
HXLINE( 928)				int _g = 0;
HXDLIN( 928)				int _g1 = destView->height;
HXDLIN( 928)				while((_g < _g1)){
HXLINE( 928)					_g = (_g + 1);
HXDLIN( 928)					HX_VARI( int,y) = (_g - 1);
...
HXDLIN( 933)							HX_VARI( int,x) = (_g2 - 1);
HXLINE( 935)							{
...
void ImageDataUtil_obj::multiplyAlpha( ::lime::graphics::Image image){
            	...
            	HX_STACK_ARG(image,"image")
HXLINE( 956)
HXLINE( 957)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
...
HXLINE( 965)			HX_VARI( int,format) = image->buffer->format;
HXLINE( 966)			HX_VARI( int,length) = ::Std_obj::_hx_int((( (Float)(data->length) ) / ( (Float)(4) )));
HXLINE( 967)			HX_VARI( int,pixel) = 0;
HXLINE( 969)			{
HXLINE( 969)				int _g = 0;
HXDLIN( 969)				int _g1 = length;
HXDLIN( 969)				while((_g < _g1)){
HXLINE( 969)					_g = (_g + 1);
HXDLIN( 969)					HX_VARI( int,i) = (_g - 1);
HXLINE( 971)					{
...
HXLINE( 982)
HXLINE( 983)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) = image->buffer;
...
HXDLIN( 985)		HX_VARI(  ::lime::graphics::ImageBuffer,newBuffer) =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,newWidth,newHeight,null(),null());
...
HXLINE( 992)			HX_VARI( int,imageWidth) = image->width;
HXLINE( 993)			HX_VARI( int,imageHeight) = image->height;
HXLINE( 995)			HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->get_data();
HXLINE( 996)			HX_VARI(  ::lime::utils::ArrayBufferView,newData) = newBuffer->data;
HXLINE( 997)			HX_VAR( int,sourceIndex);
HXDLIN( 997)			HX_VAR( int,sourceIndexX);
HXDLIN( 997)			HX_VAR( int,sourceIndexY);
HXDLIN( 997)			HX_VAR( int,sourceIndexXY);
HXDLIN( 997)			HX_VAR( int,index);
HXLINE(1002)			HX_VAR( int,sourceX);
HXDLIN(1002)			HX_VAR( int,sourceY);
HXLINE(1003)			HX_VAR( Float,u);
HXDLIN(1003)			HX_VAR( Float,v);
HXDLIN(1003)			HX_VAR( Float,uRatio);
HXDLIN(1003)			HX_VAR( Float,vRatio);
HXDLIN(1003)			HX_VAR( Float,uOpposite);
HXDLIN(1003)			HX_VAR( Float,vOpposite);
HXLINE(1010)			{
HXLINE(1010)				int _g = 0;
HXDLIN(1010)				int _g1 = newHeight;
HXDLIN(1010)				while((_g < _g1)){
HXLINE(1010)					_g = (_g + 1);
HXDLIN(1010)					HX_VARI( int,y) = (_g - 1);
HXLINE(1012)					{
HXLINE(1012)						int _g2 = 0;
HXDLIN(1012)						int _g3 = newWidth;
HXDLIN(1012)						while((_g2 < _g3)){
HXLINE(1012)							_g2 = (_g2 + 1);
HXDLIN(1012)							HX_VARI( int,x) = (_g2 - 1);
...
void ImageDataUtil_obj::resizeBuffer( ::lime::graphics::Image image,int newWidth,int newHeight){
            	...
            	HX_STACK_ARG(newHeight,"newHeight")
HXLINE(1071)
HXLINE(1072)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) = image->buffer;
HXLINE(1073)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->get_data();
...
HXDLIN(1074)		HX_VARI(  ::lime::utils::ArrayBufferView,newData) = this1;
HXLINE(1075)		HX_VAR( int,sourceIndex);
HXDLIN(1075)		HX_VAR( int,index);
HXLINE(1077)		{
HXLINE(1077)			int _g = 0;
HXDLIN(1077)			int _g1 = buffer->height;
HXDLIN(1077)			while((_g < _g1)){
HXLINE(1077)				_g = (_g + 1);
HXDLIN(1077)				HX_VARI( int,y) = (_g - 1);
HXLINE(1079)				{
HXLINE(1079)					int _g2 = 0;
HXDLIN(1079)					int _g3 = buffer->width;
HXDLIN(1079)					while((_g2 < _g3)){
HXLINE(1079)						_g2 = (_g2 + 1);
HXDLIN(1079)						HX_VARI( int,x) = (_g2 - 1);
...
void ImageDataUtil_obj::setFormat( ::lime::graphics::Image image,int format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE(1107)
HXLINE(1108)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
...
HXLINE(1116)			HX_VAR( int,index);
HXDLIN(1116)			HX_VAR(  ::Dynamic,a16);
HXLINE(1117)			HX_VARI( int,length) = ::Std_obj::_hx_int((( (Float)(data->length) ) / ( (Float)(4) )));
HXLINE(1118)			HX_VAR( int,r1);
HXDLIN(1118)			HX_VAR( int,g1);
HXDLIN(1118)			HX_VAR( int,b1);
HXDLIN(1118)			HX_VAR( int,a1);
HXDLIN(1118)			HX_VAR( int,r2);
HXDLIN(1118)			HX_VAR( int,g2);
HXDLIN(1118)			HX_VAR( int,b2);
HXDLIN(1118)			HX_VAR( int,a2);
HXLINE(1119)			HX_VAR(  ::Dynamic,r);
HXDLIN(1119)			HX_VAR(  ::Dynamic,g);
HXDLIN(1119)			HX_VAR(  ::Dynamic,b);
HXDLIN(1119)			HX_VAR(  ::Dynamic,a);
...
HXLINE(1163)					_g = (_g + 1);
HXDLIN(1163)					HX_VARI( int,i) = (_g - 1);
...
HXLINE(1200)		HX_VARI( int,source) = 0;
HXLINE(1201)		{
...
HXLINE(1243)			HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
HXLINE(1244)			HX_VARI( int,sourceFormat) = image->buffer->format;
HXLINE(1245)			HX_VARI( bool,premultiplied) = image->buffer->premultiplied;
HXLINE(1246)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,dataView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,image,rect);
HXLINE(1247)			HX_VAR( int,row);
HXDLIN(1247)			HX_VAR( int,color);
HXDLIN(1247)			HX_VAR( int,pixel);
HXLINE(1248)			HX_VARI( bool,transparent) = image->get_transparent();
HXLINE(1249)			HX_VARI(  ::haxe::io::Bytes,bytes) = bytePointer->bytes;
HXLINE(1250)			HX_VARI( int,dataPosition) = bytePointer->offset;
HXLINE(1251)			HX_VARI( bool,littleEndian) = ::hx::IsPointerNotEq( endian,::lime::_hx_system::Endian_obj::_hx_BIG_ENDIAN_dyn() );
HXLINE(1253)			{
HXLINE(1253)				int _g = 0;
HXDLIN(1253)				int _g1 = dataView->height;
HXDLIN(1253)				while((_g < _g1)){
HXLINE(1253)					_g = (_g + 1);
HXDLIN(1253)					HX_VARI( int,y) = (_g - 1);
...
HXDLIN(1257)							HX_VARI( int,x) = (_g2 - 1);
...
int ImageDataUtil_obj::threshold( ::lime::graphics::Image image, ::lime::graphics::Image sourceImage, ::lime::math::Rectangle sourceRect, ::lime::math::Vector2 destPoint,::String operation,int threshold,int color,int mask,bool copySource,int format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE(1293)
HXLINE(1294)		HX_VAR( int,_color);
HXDLIN(1294)		HX_VAR( int,_mask);
HXDLIN(1294)		HX_VAR( int,_threshold);
...
HXLINE(1314)		HX_VAR( int,_operation);
...
HXLINE(1327)		HX_VARI(  ::lime::utils::ArrayBufferView,srcData) = sourceImage->buffer->data;
HXLINE(1328)		HX_VARI(  ::lime::utils::ArrayBufferView,destData) = image->buffer->data;
...
HXLINE(1332)		HX_VARI( int,hits) = 0;
...
HXLINE(1340)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,srcView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,sourceImage,sourceRect);
HXLINE(1341)			HX_VARI(  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView,destView) =  ::lime::_internal::graphics::_ImageDataUtil::ImageDataView_obj::__alloc( HX_CTX ,image, ::lime::math::Rectangle_obj::__alloc( HX_CTX ,destPoint->x,destPoint->y,srcView->width,srcView->height));
HXLINE(1343)			HX_VARI( int,srcFormat) = sourceImage->buffer->format;
HXLINE(1344)			HX_VARI( int,destFormat) = image->buffer->format;
HXLINE(1345)			HX_VARI( bool,srcPremultiplied) = sourceImage->buffer->premultiplied;
HXLINE(1346)			HX_VARI( bool,destPremultiplied) = image->buffer->premultiplied;
HXLINE(1348)			HX_VAR( int,srcPosition);
HXDLIN(1348)			HX_VAR( int,destPosition);
HXDLIN(1348)			HX_VARI( int,srcPixel) = 0;
HXDLIN(1348)			HX_VARI( int,destPixel) = 0;
HXDLIN(1348)			HX_VAR( int,pixelMask);
HXDLIN(1348)			HX_VAR( bool,test);
HXDLIN(1348)			HX_VAR( int,value);
HXLINE(1356)			{
HXLINE(1356)				int _g = 0;
HXDLIN(1356)				int _g1 = destView->height;
HXDLIN(1356)				while((_g < _g1)){
HXLINE(1356)					_g = (_g + 1);
HXDLIN(1356)					HX_VARI( int,y) = (_g - 1);
...
HXDLIN(1361)							HX_VARI( int,x) = (_g2 - 1);
HXLINE(1363)							{
...
void ImageDataUtil_obj::unmultiplyAlpha( ::lime::graphics::Image image){
            	...
            	HX_STACK_ARG(image,"image")
HXLINE(1406)
HXLINE(1407)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = image->buffer->data;
...
HXLINE(1415)			HX_VARI( int,format) = image->buffer->format;
HXLINE(1416)			HX_VARI( int,length) = ::Std_obj::_hx_int((( (Float)(data->length) ) / ( (Float)(4) )));
HXLINE(1417)			HX_VARI( int,pixel) = 0;
HXLINE(1419)			{
HXLINE(1419)				int _g = 0;
HXDLIN(1419)				int _g1 = length;
HXDLIN(1419)				while((_g < _g1)){
HXLINE(1419)					_g = (_g + 1);
HXDLIN(1419)					HX_VARI( int,i) = (_g - 1);
HXLINE(1421)					{
...
void ImageDataUtil_obj::_hx___boxBlur( ::lime::utils::ArrayBufferView imgA, ::lime::utils::ArrayBufferView imgB,int w,int h,Float bx,Float by){
            	...
            	HX_STACK_ARG(imgA,"imgA")
            	HX_STACK_ARG(imgB,"imgB")
            	HX_STACK_ARG(w,"w")
            	HX_STACK_ARG(h,"h")
            	HX_STACK_ARG(bx,"bx")
            	HX_STACK_ARG(by,"by")
...
HXLINE(1437)		HX_VARI_NAME( int,bx1,"bx") = ::Std_obj::_hx_int(bx);
HXLINE(1438)		HX_VARI_NAME( int,by1,"by") = ::Std_obj::_hx_int(by);
HXLINE(1440)		{
...
HXLINE(1452)
HXLINE(1453)		HX_VARI( Float,iarr) = (( (Float)(1) ) / ( (Float)(((r + r) + 1)) ));
HXLINE(1454)		HX_VAR( int,ti);
HXDLIN(1454)		HX_VAR( int,li);
HXDLIN(1454)		HX_VAR( int,ri);
HXDLIN(1454)		HX_VAR(  ::Dynamic,fv);
HXDLIN(1454)		HX_VAR(  ::Dynamic,lv);
HXDLIN(1454)		HX_VAR( int,val);
HXLINE(1456)		{
HXLINE(1456)			int _g = 0;
HXDLIN(1456)			int _g1 = h;
HXDLIN(1456)			while((_g < _g1)){
HXLINE(1456)				_g = (_g + 1);
HXDLIN(1456)				HX_VARI( int,i) = (_g - 1);
HXLINE(1458)				ti = (i * w);
HXLINE(1459)				li = ti;
HXLINE(1460)				ri = (ti + r);
...
HXDLIN(1466)						HX_VARI( int,j) = (_g2 - 1);
...
HXDLIN(1471)						HX_VARI_NAME( int,j1,"j") = (_g4 - 1);
...
HXDLIN(1479)						HX_VARI_NAME( int,j2,"j") = (_g6 - 1);
...
HXDLIN(1488)						HX_VARI_NAME( int,j3,"j") = (_g8 - 1);
...
void ImageDataUtil_obj::_hx___boxBlurT( ::lime::utils::ArrayBufferView imgA, ::lime::utils::ArrayBufferView imgB,int w,int h,int r,int off){
            	...
            	HX_STACK_ARG(off,"off")
HXLINE(1499)
HXLINE(1500)		HX_VARI( Float,iarr) = (( (Float)(1) ) / ( (Float)(((r + r) + 1)) ));
HXLINE(1501)		HX_VARI( int,ws) = (w * 4);
HXLINE(1502)		HX_VAR( int,ti);
HXDLIN(1502)		HX_VAR( int,li);
HXDLIN(1502)		HX_VAR( int,ri);
HXDLIN(1502)		HX_VAR(  ::Dynamic,fv);
HXDLIN(1502)		HX_VAR(  ::Dynamic,lv);
HXDLIN(1502)		HX_VAR( int,val);
HXLINE(1504)		{
HXLINE(1504)			int _g = 0;
HXDLIN(1504)			int _g1 = w;
HXDLIN(1504)			while((_g < _g1)){
HXLINE(1504)				_g = (_g + 1);
HXDLIN(1504)				HX_VARI( int,i) = (_g - 1);
...
HXDLIN(1514)						HX_VARI( int,j) = (_g2 - 1);
...
HXDLIN(1519)						HX_VARI_NAME( int,j1,"j") = (_g4 - 1);
...
HXDLIN(1527)						HX_VARI_NAME( int,j2,"j") = (_g6 - 1);
...
HXDLIN(1536)						HX_VARI_NAME( int,j3,"j") = (_g8 - 1);
...
HXLINE(1551)
HXLINE(1552)		HX_VARI( int,sourceX) = (destX - ::Std_obj::_hx_int(destPoint->x));
HXLINE(1553)		HX_VARI( int,sourceY) = (destY - ::Std_obj::_hx_int(destPoint->y));
HXLINE(1555)		HX_VARI( int,offset) = 0;
...
::Array< Float > ImageDataUtil_obj::_hx___getBoxesForGaussianBlur(Float sigma,int n){
            	...
            	HX_STACK_ARG(sigma,"sigma")
            	HX_STACK_ARG(n,"n")
HXLINE(1570)
HXLINE(1571)		HX_VARI( Float,wIdeal) = ::Math_obj::sqrt(((((( (Float)(12) ) * sigma) * sigma) / ( (Float)(n) )) + 1));
HXLINE(1572)		HX_VARI( int,wl) = ::Math_obj::floor(wIdeal);
HXLINE(1573)		if ((::hx::Mod(wl,2) == 0)) {
HXLINE(1573)			wl = (wl - 1);
            		}
HXLINE(1574)		HX_VARI( int,wu) = (wl + 2);
HXLINE(1576)		HX_VARI( Float,mIdeal) = ((((((( (Float)(12) ) * sigma) * sigma) - ( (Float)(((n * wl) * wl)) )) - ( (Float)(((4 * n) * wl)) )) - ( (Float)((3 * n)) )) / ( (Float)(((-4 * wl) - 4)) ));
HXLINE(1577)		HX_VARI( int,m) = ::Math_obj::round(mIdeal);
HXLINE(1578)		HX_VARI( ::Array< Float >,sizes) = ::Array_obj< Float >::__new(0);
HXLINE(1580)		{
HXLINE(1580)			int _g = 0;
HXDLIN(1580)			int _g1 = n;
HXDLIN(1580)			while((_g < _g1)){
HXLINE(1580)				_g = (_g + 1);
HXDLIN(1580)				HX_VARI( int,i) = (_g - 1);
...
int ImageDataUtil_obj::_hx___pixelCompare(int n1,int n2){
            	...
            	HX_STACK_ARG(n2,"n2")
HXLINE(1589)
HXLINE(1590)		HX_VARI( int,tmp1) = (::hx::UShr(n1,24) & 255);
HXLINE(1591)		HX_VARI( int,tmp2) = (::hx::UShr(n2,24) & 255);
...
void ImageDataUtil_obj::_hx___translatePixel( ::lime::utils::ArrayBufferView imgB, ::lime::math::Rectangle sourceRect, ::lime::math::Rectangle destRect, ::lime::math::Vector2 destPoint,int destX,int destY,Float strength){
            	...
            	HX_STACK_ARG(strength,"strength")
HXLINE(1638)
HXLINE(1639)		HX_VARI( int,d) = (4 * ((destY * ::Std_obj::_hx_int(destRect->width)) + destX));
...
HXDLIN(1640)		HX_VARI( int,s) = offset;
HXLINE(1642)		if ((s < 0)) {
...
HXDLIN(1652)			HX_VARI_NAME( int,a1,"a") = ::Std_obj::_hx_int((a * strength));
HXLINE(1653)			{

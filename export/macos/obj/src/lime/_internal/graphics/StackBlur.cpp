...
void StackBlur_obj::_hx___stackBlurCanvasRGBA( ::lime::graphics::Image image,int width,int height,Float blurX,Float blurY,int quality){
            	...
            	HX_STACK_ARG(quality,"quality")
HXLINE(  38)
HXLINE(  42)		HX_VARI( int,radiusX) = (::Math_obj::round(blurX) >> 1);
HXLINE(  43)		HX_VARI( int,radiusY) = (::Math_obj::round(blurY) >> 1);
...
HXLINE(  50)		HX_VARI( int,iterations) = quality;
...
HXLINE(  54)		HX_VARI(  ::lime::utils::ArrayBufferView,px) = image->get_data();
HXLINE(  55)		HX_VAR( int,x);
HXDLIN(  55)		HX_VAR( int,y);
HXDLIN(  55)		HX_VAR( int,i);
HXDLIN(  55)		HX_VAR( int,p);
HXDLIN(  55)		HX_VAR( int,yp);
HXDLIN(  55)		HX_VAR( int,yi);
HXDLIN(  55)		HX_VAR( int,yw);
HXLINE(  56)		HX_VAR( int,r);
HXDLIN(  56)		HX_VAR( int,g);
HXDLIN(  56)		HX_VAR( int,b);
HXDLIN(  56)		HX_VAR( int,a);
HXDLIN(  56)		HX_VAR( int,pr);
HXDLIN(  56)		HX_VAR( int,pg);
HXDLIN(  56)		HX_VAR( int,pb);
HXDLIN(  56)		HX_VAR( int,pa);
HXLINE(  57)		HX_VAR( Float,f);
HXLINE(  59)		HX_VARI( int,divx) = ((radiusX + radiusX) + 1);
HXLINE(  60)		HX_VARI( int,divy) = ((radiusY + radiusY) + 1);
HXLINE(  61)		HX_VARI( int,w) = width;
HXLINE(  62)		HX_VARI( int,h) = height;
HXLINE(  64)		HX_VARI( int,w1) = (w - 1);
HXLINE(  65)		HX_VARI( int,h1) = (h - 1);
HXLINE(  66)		HX_VARI( int,rxp1) = (radiusX + 1);
HXLINE(  67)		HX_VARI( int,ryp1) = (radiusY + 1);
HXLINE(  69)		HX_VARI(  ::lime::_internal::graphics::BlurStack,ssx) =  ::lime::_internal::graphics::BlurStack_obj::__alloc( HX_CTX );
HXLINE(  70)		HX_VARI(  ::lime::_internal::graphics::BlurStack,sx) = ssx;
HXLINE(  71)		{
HXLINE(  71)			int _g = 1;
HXDLIN(  71)			int _g1 = divx;
HXDLIN(  71)			while((_g < _g1)){
HXLINE(  71)				_g = (_g + 1);
HXDLIN(  71)				HX_VARI_NAME( int,i1,"i") = (_g - 1);
HXLINE(  73)				sx = (sx->n =  ::lime::_internal::graphics::BlurStack_obj::__alloc( HX_CTX ));
            			}
            		}
HXLINE(  75)		sx->n = ssx;
HXLINE(  77)		HX_VARI(  ::lime::_internal::graphics::BlurStack,ssy) =  ::lime::_internal::graphics::BlurStack_obj::__alloc( HX_CTX );
HXLINE(  78)		HX_VARI(  ::lime::_internal::graphics::BlurStack,sy) = ssy;
HXLINE(  79)		{
HXLINE(  79)			int _g2 = 1;
HXDLIN(  79)			int _g3 = divy;
HXDLIN(  79)			while((_g2 < _g3)){
HXLINE(  79)				_g2 = (_g2 + 1);
HXDLIN(  79)				HX_VARI_NAME( int,i2,"i") = (_g2 - 1);
HXLINE(  81)				sy = (sy->n =  ::lime::_internal::graphics::BlurStack_obj::__alloc( HX_CTX ));
            			}
            		}
HXLINE(  83)		sy->n = ssy;
HXLINE(  85)		HX_VARI(  ::lime::_internal::graphics::BlurStack,si) = null();
HXLINE(  87)		HX_VARI( int,mtx) = ::lime::_internal::graphics::StackBlur_obj::MUL_TABLE->__get(radiusX);
HXLINE(  88)		HX_VARI( int,stx) = ::lime::_internal::graphics::StackBlur_obj::SHG_TABLE->__get(radiusX);
HXLINE(  89)		HX_VARI( int,mty) = ::lime::_internal::graphics::StackBlur_obj::MUL_TABLE->__get(radiusY);
HXLINE(  90)		HX_VARI( int,sty) = ::lime::_internal::graphics::StackBlur_obj::SHG_TABLE->__get(radiusY);
HXLINE(  92)		while((iterations > 0)){
HXLINE(  94)			iterations = (iterations - 1);
HXLINE(  95)			yi = 0;
HXDLIN(  95)			yw = yi;
HXLINE(  96)			HX_VARI( int,ms) = mtx;
HXLINE(  97)			HX_VARI( int,ss) = stx;
HXLINE(  98)			y = h;
HXLINE(  99)			do {
...
HXDLIN( 117)						HX_VARI_NAME( int,i3,"i") = (_g4 - 1);
HXLINE( 119)						int p1;
HXDLIN( 119)						if ((w1 < i3)) {
HXLINE( 119)							p1 = w1;
            						}
...
HXDLIN( 128)						HX_VARI_NAME( int,x1,"x") = (_g6 - 1);
HXLINE( 130)						{
HXLINE( 130)							yi = (yi + 1);
...
HXDLIN( 147)					HX_VARI_NAME( int,x2,"x") = (_g8 - 1);
HXLINE( 149)					yi = (x2 << 2);
...
HXDLIN( 155)							HX_VARI_NAME( int,i4,"i") = (_g10 - 1);
HXLINE( 157)							sy->r = pr;
HXLINE( 158)							sy->g = pg;
HXLINE( 159)							sy->b = pb;
HXLINE( 160)							sy->a = pa;
...
HXDLIN( 164)							HX_VARI_NAME( int,i5,"i") = (_g12 - 1);
...
HXDLIN( 182)							HX_VARI_NAME( int,y1,"y") = (_g14 - 1);
HXLINE( 184)							p = (yi << 2);
HXLINE( 185)							{
...
HXDLIN( 207)							HX_VARI_NAME( int,y2,"y") = (_g16 - 1);
HXLINE( 209)							p = (yi << 2);
HXLINE( 210)							{

...
HXLINE(  29)		HX_VARI( int,fileHeaderLength) = 14;
HXLINE(  30)		HX_VARI( int,infoHeaderLength) = 40;
HXLINE(  31)		HX_VARI( int,pixelValuesLength) = ((image->width * image->height) * 4);
...
HXLINE(  48)		HX_VARI(  ::haxe::io::Bytes,data) = ::haxe::io::Bytes_obj::alloc(((fileHeaderLength + infoHeaderLength) + pixelValuesLength));
HXLINE(  49)		HX_VARI( int,position) = 0;
...
HXLINE( 110)		HX_VARI(  ::haxe::io::Bytes,pixels) = image->getPixels( ::lime::math::Rectangle_obj::__alloc( HX_CTX ,0,0,image->width,image->height),1);
HXLINE( 111)		HX_VARI( int,readPosition) = 0;
HXLINE( 112)		HX_VAR( int,a);
HXDLIN( 112)		HX_VAR( int,r);
HXDLIN( 112)		HX_VAR( int,g);
HXDLIN( 112)		HX_VAR( int,b);
...
HXDLIN( 170)						HX_VARI( int,y) = (_g1 - 1);
...
HXDLIN( 174)								HX_VARI( int,x) = (_g3 - 1);
...
HXDLIN( 186)								HX_VARI_NAME( int,i1,"i") = (_g5 - 1);
HXLINE( 188)								{
...
HXDLIN( 117)						HX_VARI_NAME( int,y1,"y") = (_g7 - 1);
...
HXDLIN( 121)								HX_VARI_NAME( int,x1,"x") = (_g9 - 1);
...
HXDLIN( 131)									data->b[(position - 1)] = ( (unsigned char)(a) );
            				...
            				break;
            				case (int)2: {
HXLINE( 136)					HX_VARI(  ::haxe::io::Bytes,andMask) = ::haxe::io::Bytes_obj::alloc((image->width * image->height));
HXLINE( 137)					HX_VARI( int,maskPosition) = 0;
HXLINE( 139)					{
HXLINE( 139)						int _g11 = 0;
HXDLIN( 139)						int _g12 = image->height;
HXDLIN( 139)						while((_g11 < _g12)){
HXLINE( 139)							_g11 = (_g11 + 1);
HXDLIN( 139)							HX_VARI_NAME( int,y2,"y") = (_g11 - 1);
...
HXDLIN( 143)									HX_VARI_NAME( int,x2,"x") = (_g13 - 1);

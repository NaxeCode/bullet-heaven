...
HXDLIN(  33)		HX_VARI_NAME(  ::hx::Object *,buffer2,"buffer") = buffer(::hx::DynamicPtr(bytes),decodeData,::hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,null(),null(),null(),null())));
...
HXDLIN(  58)		HX_VARI_NAME(  ::hx::Object *,buffer2,"buffer") = buffer(path,decodeData,::hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,null(),null(),null(),null())));

...
HXLINE(  61)						HX_VARI(  ::Dynamic,buffer) = _g1->__get(_g);
HXDLIN(  61)						_g = (_g + 1);
...
HXLINE( 103)			HX_VARI(  ::lime::media::vorbis::VorbisFile,vorbisFile) = this->parent->buffer->_hx___srcVorbisFile;
...
HXDLIN( 215)		HX_VARI_NAME(  ::lime::utils::ArrayBufferView,buffer1,"buffer") = this1;
HXLINE( 216)		HX_VARI( int,read) = 0;
HXDLIN( 216)		HX_VARI( int,total) = 0;
HXDLIN( 216)		HX_VAR( int,readMax);
HXLINE( 218)		{
HXLINE( 218)			int _g = 0;
HXDLIN( 218)			int _g1 = (::lime::_internal::backend::native::NativeAudioSource_obj::STREAM_NUM_BUFFERS - 1);
HXDLIN( 218)			while((_g < _g1)){
HXLINE( 218)				_g = (_g + 1);
HXDLIN( 218)				HX_VARI( int,i) = (_g - 1);
...
HXLINE( 252)
HXLINE( 254)		HX_VARI(  ::lime::media::vorbis::VorbisFile,vorbisFile) = null();
HXLINE( 255)		HX_VARI( int,position) = 0;
HXLINE( 257)		if (::hx::IsNull( buffers )) {
HXLINE( 259)			HX_VARI( int,buffersProcessed) = ( (int)(::lime::media::openal::AL_obj::getSourcei(this->handle,4118)) );
...
HXLINE( 281)			HX_VARI( int,numBuffers) = 0;
HXLINE( 282)			HX_VAR(  ::lime::utils::ArrayBufferView,data);
HXLINE( 284)			{
HXLINE( 284)				int _g = 0;
HXDLIN( 284)				while((_g < buffers->get_length())){
HXLINE( 284)					HX_VARI(  ::Dynamic,buffer) = buffers->__get(_g);
HXDLIN( 284)					_g = (_g + 1);
...
HXDLIN( 374)					HX_VARI_NAME( int,time2,"time") = (time1 - this->parent->offset);
...
HXLINE( 380)					HX_VARI( int,offset) = ( (int)(::lime::media::openal::AL_obj::getSourcei(this->handle,4134)) );
HXLINE( 381)					HX_VARI( Float,ratio) = (( (Float)(offset) ) / ( (Float)(this->dataLength) ));
HXLINE( 382)					HX_VARI( Float,totalSeconds) = (( (Float)(this->samples) ) / ( (Float)(this->parent->buffer->sampleRate) ));
HXLINE( 384)					int time3 = ::Std_obj::_hx_int(((totalSeconds * ratio) * ( (Float)(1000) )));
HXDLIN( 384)					HX_VARI_NAME( int,time4,"time") = (time3 - this->parent->offset);
...
HXLINE( 421)					HX_VARI( Float,secondOffset) = (( (Float)((value + this->parent->offset)) ) / ( (Float)(1000) ));
HXLINE( 422)					HX_VARI( Float,totalSeconds) = (( (Float)(this->samples) ) / ( (Float)(this->parent->buffer->sampleRate) ));
...
HXLINE( 427)					HX_VARI( Float,ratio) = (secondOffset / totalSeconds);
HXLINE( 428)					HX_VARI( int,totalOffset) = ::Std_obj::_hx_int((( (Float)(this->dataLength) ) * ratio));
...
HXDLIN( 442)			HX_VARI_NAME( int,timeRemaining1,"timeRemaining") = ::Std_obj::_hx_int((( (Float)(timeRemaining) ) / this->getPitch()));
...
HXDLIN( 501)			HX_VARI_NAME( int,timeRemaining1,"timeRemaining") = ::Std_obj::_hx_int((( (Float)(timeRemaining) ) / this->getPitch()));
...
HXDLIN( 544)			HX_VARI_NAME( int,timeRemaining1,"timeRemaining") = ::Std_obj::_hx_int((( (Float)((timeRemaining - this->getCurrentTime())) ) / value));
...
HXLINE( 566)			HX_VARI( ::Array< Float >,value) = ::lime::media::openal::AL_obj::getSource3f(this->handle,4100);

...
HXLINE( 108)		HX_VARI(  ::haxe::io::Bytes,data) = ( ( ::haxe::io::Bytes)(this->parent->__Field(HX_("data",2a,56,63,42),::hx::paccDynamic)) );
HXLINE( 109)		HX_VARI( ::String,query) = HX_("",00,00,00,00);
HXLINE( 111)		if (::hx::IsNull( data )) {
HXLINE( 113)			{
HXLINE( 113)				HX_VARI(  ::Dynamic,key) = ( ( ::haxe::ds::StringMap)( ::Dynamic(this->parent->__Field(HX_("formData",8e,d5,80,56),::hx::paccDynamic))) )->keys();
HXDLIN( 113)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 113)					HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 189)		HX_VARI( ::Array< ::String >,headers) = ::Array_obj< ::String >::__new(0);
HXLINE( 190)		headers->push(HX_("Expect: ",df,c4,e1,19));
HXLINE( 192)		HX_VARI( ::String,contentType) = null();
HXLINE( 194)		{
HXLINE( 194)			int _g = 0;
...
HXLINE( 194)				HX_VARI(  ::Dynamic,header) = _g1->__get(_g);
HXDLIN( 194)				_g = (_g + 1);
...
HXLINE( 246)					HX_VARI( ::String,cookie) = _g3->__get(_g2);
...
HXLINE( 275)		HX_VARI(  ::lime::app::Promise_haxe_io_Bytes,promise) =  ::lime::app::Promise_haxe_io_Bytes_obj::__alloc( HX_CTX );
...
HXDLIN( 358)				promise1->complete(bytes->getString(0,bytes->length,null()));
            	...
            	HX_STACK_ARG(uri,"uri")
HXLINE( 343)
HXLINE( 344)		HX_VARI(  ::lime::app::Promise_String,promise) =  ::lime::app::Promise_String_obj::__alloc( HX_CTX );
HXLINE( 345)		HX_VARI(  ::lime::app::Future,future) = this->loadData(uri,false);
...
HXLINE( 372)
HXLINE( 373)		HX_VARI( ::Array< ::String >,parts) = header.split(HX_(": ",a6,32,00,00));
...
HXLINE( 403)
HXLINE( 404)		HX_VARI(  ::lime::_internal::backend::native::NativeHTTPRequest,instance) = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(state->__Field(HX_("instance",95,1f,e1,59),::hx::paccDynamic)) );
HXLINE( 405)		HX_VARI( ::String,path) = ( (::String)(state->__Field(HX_("uri",6c,2b,59,00),::hx::paccDynamic)) );
HXLINE( 407)		HX_VARI( int,index) = path.indexOf(HX_("?",3f,00,00,00),null());
...
void NativeHTTPRequest_obj::localThreadPool_onComplete( ::Dynamic state){
            	...
            	HX_STACK_ARG(state,"state")
HXLINE( 448)
HXLINE( 449)		HX_VARI(  ::lime::app::Promise_haxe_io_Bytes,promise) = ( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),::hx::paccDynamic)) );
...
HXLINE( 453)		HX_VARI(  ::lime::_internal::backend::native::NativeHTTPRequest,instance) = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(state->__Field(HX_("instance",95,1f,e1,59),::hx::paccDynamic)) );
...
void NativeHTTPRequest_obj::localThreadPool_onError( ::Dynamic state){
            	...
            	HX_STACK_ARG(state,"state")
HXLINE( 466)
HXLINE( 467)		HX_VARI(  ::lime::app::Promise_haxe_io_Bytes,promise) = ( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),::hx::paccDynamic)) );
...
HXLINE( 470)		HX_VARI(  ::lime::_internal::backend::native::NativeHTTPRequest,instance) = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(state->__Field(HX_("instance",95,1f,e1,59),::hx::paccDynamic)) );
...
void NativeHTTPRequest_obj::localThreadPool_onProgress( ::Dynamic state){
            	...
            	HX_STACK_ARG(state,"state")
HXLINE( 489)
HXLINE( 490)		HX_VARI(  ::lime::app::Promise_haxe_io_Bytes,promise) = ( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),::hx::paccDynamic)) );
...
HXLINE( 500)			HX_VARI(  ::lime::net::curl::CURL,curl) = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiAddHandle->pop(false).StaticCast<  ::lime::net::curl::CURL >();
HXLINE( 501)			if (::hx::IsNotNull( curl )) {
HXLINE( 501)				::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->addHandle(curl);
            			}
HXLINE( 504)			HX_VARI( int,code) = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->wait(1000);
HXLINE( 506)			if ((code == 0)) {
HXLINE( 508)				::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->perform();
HXLINE( 509)				HX_VARI(  ::lime::net::curl::CURLMultiMessage,message) = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->infoRead();
...
HXLINE( 519)					HX_VARI_NAME(  ::lime::net::curl::CURL,curl1,"curl") = message->curl;
HXLINE( 520)					HX_VARI(  ::Dynamic,status) = curl1->getInfo(2097154);
...
void NativeHTTPRequest_obj::multiThreadPool_onComplete( ::Dynamic _){
            	...
            	HX_STACK_ARG(_,"_")
HXLINE( 536)
HXLINE( 538)		HX_VARI(  ::lime::net::curl::CURL,curl) = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiAddHandle->pop(false).StaticCast<  ::lime::net::curl::CURL >();
...
HXLINE( 562)			HX_VARI(  ::lime::_internal::backend::native::NativeHTTPRequest,instance) = ( ( ::lime::_internal::backend::native::NativeHTTPRequest)(::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->get( ::Dynamic(state->__Field(HX_("curl",ec,4a,c9,41),::hx::paccDynamic)))) );
...
HXLINE( 579)						HX_VARI( ::String,error) = instance->bytes->getString(0,instance->bytes->length,null());
HXLINE( 580)						HX_VARI(  ::haxe::io::Bytes,responseData) = instance->buildBuffer();
...
HXLINE( 585)						HX_VARI_NAME( ::String,error1,"error") = ( (::String)((HX_("Status ",8e,8c,bf,03) + state->__Field(HX_("status",32,e7,fb,05),::hx::paccDynamic))) );
HXLINE( 586)						HX_VARI_NAME(  ::haxe::io::Bytes,responseData1,"responseData") = instance->buildBuffer();
...
HXLINE( 592)				HX_VARI_NAME( ::String,error2,"error") = ::lime::net::curl::CURL_obj::strerror(( (int)(state->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic)) ));
...
HXDLIN( 611)			HX_VARI(  ::lime::_internal::backend::native::NativeHTTPRequest,instance) = _g1->__get(_g).StaticCast<  ::lime::_internal::backend::native::NativeHTTPRequest >();
HXDLIN( 611)			_g = (_g + 1);

...
HXDLIN(  69)		HX_VARI(  ::Dynamic,init) = ::hx::ClassOf< ::lime::_internal::backend::native::NativeCFFI >();
            	}
...
HXDLIN(  95)			HX_VARI_NAME( int,offset1,"offset") = (offset - this->pauseTimer);
HXLINE(  96)			{
HXLINE(  96)				int _g = 0;
HXDLIN(  96)				int _g1 = ::haxe::Timer_obj::sRunningTimers->length;
HXDLIN(  96)				while((_g < _g1)){
HXLINE(  96)					_g = (_g + 1);
HXDLIN(  96)					HX_VARI( int,i) = (_g - 1);
...
HXLINE( 146)		HX_VARI( int,result) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_application_exec(::hx::DynamicPtr(this->handle));
...
HXDLIN( 188)			HX_VARI(  ::lime::ui::Window,window) = _g1->__get(_g).StaticCast<  ::lime::ui::Window >();
HXDLIN( 188)			_g = (_g + 1);
...
HXDLIN( 196)		switch((int)(this->gamepadEventInfo->type)){
            			case (int)0: {
HXLINE( 199)				HX_VARI(  ::lime::ui::Gamepad,gamepad) = ( ( ::lime::ui::Gamepad)(::lime::ui::Gamepad_obj::devices->get(this->gamepadEventInfo->id)) );
...
HXLINE( 200)					gamepad->onAxisMove->dispatch(this->gamepadEventInfo->axis,this->gamepadEventInfo->axisValue);
            			...
            			break;
            			case (int)1: {
HXLINE( 203)				HX_VARI_NAME(  ::lime::ui::Gamepad,gamepad1,"gamepad") = ( ( ::lime::ui::Gamepad)(::lime::ui::Gamepad_obj::devices->get(this->gamepadEventInfo->id)) );
...
HXLINE( 204)					gamepad1->onButtonDown->dispatch(this->gamepadEventInfo->button);
            			...
            			break;
            			case (int)2: {
HXLINE( 207)				HX_VARI_NAME(  ::lime::ui::Gamepad,gamepad2,"gamepad") = ( ( ::lime::ui::Gamepad)(::lime::ui::Gamepad_obj::devices->get(this->gamepadEventInfo->id)) );
...
HXDLIN( 220)		switch((int)(this->joystickEventInfo->type)){
            			case (int)0: {
HXLINE( 223)				HX_VARI(  ::lime::ui::Joystick,joystick) = ( ( ::lime::ui::Joystick)(::lime::ui::Joystick_obj::devices->get(this->joystickEventInfo->id)) );
...
HXLINE( 224)					joystick->onAxisMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->x);
            			...
            			break;
            			case (int)1: {
HXLINE( 227)				HX_VARI_NAME(  ::lime::ui::Joystick,joystick1,"joystick") = ( ( ::lime::ui::Joystick)(::lime::ui::Joystick_obj::devices->get(this->joystickEventInfo->id)) );
...
HXLINE( 228)					joystick1->onHatMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->eventValue);
            			...
            			break;
            			case (int)2: {
HXLINE( 231)				HX_VARI_NAME(  ::lime::ui::Joystick,joystick2,"joystick") = ( ( ::lime::ui::Joystick)(::lime::ui::Joystick_obj::devices->get(this->joystickEventInfo->id)) );
...
HXLINE( 232)					joystick2->onTrackballMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->x,this->joystickEventInfo->y);
            			...
            			break;
            			case (int)3: {
HXLINE( 235)				HX_VARI_NAME(  ::lime::ui::Joystick,joystick3,"joystick") = ( ( ::lime::ui::Joystick)(::lime::ui::Joystick_obj::devices->get(this->joystickEventInfo->id)) );
...
HXLINE( 236)					joystick3->onButtonDown->dispatch(this->joystickEventInfo->index);
            			...
            			break;
            			case (int)4: {
HXLINE( 239)				HX_VARI_NAME(  ::lime::ui::Joystick,joystick4,"joystick") = ( ( ::lime::ui::Joystick)(::lime::ui::Joystick_obj::devices->get(this->joystickEventInfo->id)) );
...
void NativeApplication_obj::handleKeyEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 251)
HXLINE( 252)		HX_VARI(  ::lime::ui::Window,window) = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->keyEventInfo->windowID)) );
HXLINE( 254)		if (::hx::IsNotNull( window )) {
HXLINE( 256)			HX_VARI( int,type) = this->keyEventInfo->type;
HXLINE( 257)			HX_VARI( Float,int32) = this->keyEventInfo->keyCode;
HXLINE( 258)			HX_VARI( int,keyCode) = ::Std_obj::_hx_int(int32);
HXLINE( 259)			HX_VARI( int,modifier) = this->keyEventInfo->modifier;
...
void NativeApplication_obj::handleMouseEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 330)
HXLINE( 331)		HX_VARI(  ::lime::ui::Window,window) = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->mouseEventInfo->windowID)) );
...
HXDLIN( 363)			HX_VARI(  ::lime::ui::Window,window) = _g1->__get(_g).StaticCast<  ::lime::ui::Window >();
HXDLIN( 363)			_g = (_g + 1);
...
HXLINE( 390)							HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = window->context->gl;
...
void NativeApplication_obj::handleSensorEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 415)
HXLINE( 416)		HX_VARI(  ::lime::_hx_system::Sensor,sensor) = ( ( ::lime::_hx_system::Sensor)(::lime::_hx_system::Sensor_obj::sensorByID->get(this->sensorEventInfo->id)) );
...
void NativeApplication_obj::handleTextEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 425)
HXLINE( 426)		HX_VARI(  ::lime::ui::Window,window) = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->textEventInfo->windowID)) );
...
HXDLIN( 446)		switch((int)(this->touchEventInfo->type)){
            			case (int)0: {
HXLINE( 449)				HX_VARI(  ::lime::ui::Touch,touch) = this->unusedTouchesPool->pop().StaticCast<  ::lime::ui::Touch >();
...
HXLINE( 469)				::lime::ui::Touch_obj::onStart->dispatch(touch);
            			...
            			break;
            			case (int)1: {
HXLINE( 472)				HX_VARI_NAME(  ::lime::ui::Touch,touch1,"touch") = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
...
HXLINE( 485)					this->unusedTouchesPool->add(touch1);
            			...
            			break;
            			case (int)2: {
HXLINE( 489)				HX_VARI_NAME(  ::lime::ui::Touch,touch2,"touch") = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
...
void NativeApplication_obj::handleWindowEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 507)
HXLINE( 508)		HX_VARI(  ::lime::ui::Window,window) = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->windowEventInfo->windowID)) );
...
HXLINE( 583)			HX_VARI( int,currentTime) = ::lime::_hx_system::System_obj::getTimer();
HXLINE( 584)			HX_VARI( bool,foundNull) = false;
HXLINE( 585)			HX_VAR(  ::haxe::Timer,timer);
HXLINE( 587)			{
HXLINE( 587)				int _g = 0;
HXDLIN( 587)				int _g1 = ::haxe::Timer_obj::sRunningTimers->length;
HXDLIN( 587)				while((_g < _g1)){
HXLINE( 587)					_g = (_g + 1);
HXDLIN( 587)					HX_VARI( int,i) = (_g - 1);

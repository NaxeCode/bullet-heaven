...
HXLINE(  63)		HX_VARI(  ::Dynamic,attributes) = parent->_hx___attributes;
HXLINE(  64)		HX_VAR(  ::Dynamic,contextAttributes);
...
HXLINE( 105)		HX_VAR(  ::Dynamic,width);
...
HXLINE( 106)		HX_VAR(  ::Dynamic,height);
...
HXLINE( 123)		HX_VARI(  ::lime::graphics::RenderContext,context) =  ::lime::graphics::RenderContext_obj::__alloc( HX_CTX );
HXLINE( 124)		context->window = parent;
HXLINE( 129)		HX_VARI( ::String,contextType) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_window_get_context_type(::hx::DynamicPtr(this->handle))) );
HXLINE( 132)		if ((contextType == HX_("opengl",6f,64,94,21))) {
HXLINE( 135)			HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) =  ::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::__alloc( HX_CTX );
...
HXLINE( 253)			HX_VARI( int,index) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_window_get_display(::hx::DynamicPtr(this->handle));
...
HXLINE( 273)			HX_VARI(  ::Dynamic,data) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_window_get_display_mode(::hx::DynamicPtr(this->handle))) );
...
HXLINE( 337)
HXLINE( 338)		HX_VARI(  ::lime::graphics::ImageBuffer,imageBuffer) = null();
...
HXLINE( 343)			HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->parent->context->webgl;
HXLINE( 344)			HX_VARI( int,windowWidth) = ::Std_obj::_hx_int((( (Float)(this->parent->_hx___width) ) * this->parent->_hx___scale));
HXLINE( 345)			HX_VARI( int,windowHeight) = ::Std_obj::_hx_int((( (Float)(this->parent->_hx___height) ) * this->parent->_hx___scale));
HXLINE( 347)			HX_VAR( int,x);
HXDLIN( 347)			HX_VAR( int,y);
HXDLIN( 347)			HX_VAR( int,width);
HXDLIN( 347)			HX_VAR( int,height);
...
HXDLIN( 364)			HX_VARI(  ::lime::utils::ArrayBufferView,data) = this1;
HXLINE( 366)			{
...
HXLINE( 370)			HX_VARI( int,rowLength) = (width * 4);
HXLINE( 371)			HX_VARI( int,srcPosition) = ((height - 1) * rowLength);
HXLINE( 372)			HX_VARI( int,destPosition) = 0;
HXLINE( 374)			HX_VARI(  ::haxe::io::Bytes,temp) = ::haxe::io::Bytes_obj::alloc(rowLength);
HXLINE( 375)			HX_VARI_NAME(  ::haxe::io::Bytes,buffer1,"buffer") = data->buffer;
HXLINE( 376)			HX_VARI( int,rows) = ::Std_obj::_hx_int((( (Float)(height) ) / ( (Float)(2) )));
...
HXLINE( 427)			HX_VARI(  ::Dynamic,lock) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_window_context_lock(::hx::DynamicPtr(this->handle))) );
...
HXLINE( 543)			HX_VARI(  ::Dynamic,data) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_window_set_display_mode(::hx::DynamicPtr(this->handle),::hx::DynamicPtr(value))) );

...
HXDLIN(  81)		HX_VARI(  ::Dynamic,_init) = ::hx::ClassOf< ::lime::_internal::backend::native::NativeApplication >();
            	}
...
HXLINE( 134)
HXLINE( 135)		HX_VARI(  ::lime::ui::Window,window) = this->_hx___createWindow(attributes);
...
HX_DEFINE_DYNAMIC_FUNC1(Application_obj,_hx___addWindow,(void))
 ...
 ::lime::ui::Window Application_obj::_hx___createWindow( ::Dynamic attributes){
            	...
            	HX_STACK_ARG(attributes,"attributes")
HXLINE( 507)
HXLINE( 508)		HX_VARI(  ::lime::ui::Window,window) =  ::lime::ui::Window_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),attributes);
...
HXLINE( 519)		{
HXLINE( 519)			HX_VARI(  ::Dynamic,gamepad) = ::lime::ui::Gamepad_obj::devices->iterator();
HXDLIN( 519)			while(( (bool)(gamepad->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 519)				HX_VARI_NAME(  ::lime::ui::Gamepad,gamepad1,"gamepad") = ( ( ::lime::ui::Gamepad)(gamepad->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 526)		{
HXLINE( 526)			HX_VARI(  ::Dynamic,joystick) = ::lime::ui::Joystick_obj::devices->iterator();
HXDLIN( 526)			while(( (bool)(joystick->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 526)				HX_VARI_NAME(  ::lime::ui::Joystick,joystick1,"joystick") = ( ( ::lime::ui::Joystick)(joystick->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );

...
HXLINE( 154)				HX_VARI_NAME(  ::Dynamic,callback1,"callback") = parameter;
...
HXLINE( 189)				HX_VARI_NAME(  ::Dynamic,callback2,"callback") = parameter;
...
HXLINE( 161)				HX_VARI_NAME(  ::Dynamic,callback3,"callback") = parameter;

...
bool _HTTPRequest_String_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::app::Future _HTTPRequest_String_obj::load(::String uri){
            		...
            		void _hx_run( ::lime::net::_HTTPRequestErrorResponse errorResponse){
            			...
            			HX_STACK_ARG(errorResponse,"errorResponse")
HXLINE( 148)
...
HXLINE( 143)		HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__alloc( HX_CTX );
HXLINE( 144)		HX_VARI(  ::lime::app::Future,future) = this->_hx___backend->loadText(this->uri);

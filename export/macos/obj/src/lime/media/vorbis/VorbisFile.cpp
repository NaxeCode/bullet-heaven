...
HX_DEFINE_DYNAMIC_FUNC0(VorbisFile_obj,clear,(void))
 ...
 ::lime::media::vorbis::VorbisComment VorbisFile_obj::comment(::hx::Null< int >  __o_bitstream){
            	...
            	HX_STACK_ARG(bitstream,"bitstream")
HXLINE(  49)
HXLINE(  51)		HX_VARI(  ::hx::Object *,data) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_vorbis_file_comment(::hx::DynamicPtr(this->handle),bitstream);
HXLINE(  53)		if (::hx::IsNotNull( data )) {
HXLINE(  55)			HX_VARI(  ::lime::media::vorbis::VorbisComment,comment) =  ::lime::media::vorbis::VorbisComment_obj::__alloc( HX_CTX );
...
HX_DEFINE_DYNAMIC_FUNC1(VorbisFile_obj,crosslap,return )
 ...
 ::lime::media::vorbis::VorbisInfo VorbisFile_obj::info(::hx::Null< int >  __o_bitstream){
            	...
            	HX_STACK_ARG(bitstream,"bitstream")
HXLINE( 103)
HXLINE( 105)		HX_VARI(  ::hx::Object *,data) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_vorbis_file_info(::hx::DynamicPtr(this->handle),bitstream);
HXLINE( 107)		if (::hx::IsNotNull( data )) {
HXLINE( 109)			HX_VARI(  ::lime::media::vorbis::VorbisInfo,info) =  ::lime::media::vorbis::VorbisInfo_obj::__alloc( HX_CTX );
...
::cpp::Int64 VorbisFile_obj::pcmTell(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 160)
HXLINE( 162)		HX_VARI(  ::hx::Object *,data) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_vorbis_file_pcm_tell(::hx::DynamicPtr(this->handle));
...
::cpp::Int64 VorbisFile_obj::pcmTotal(::hx::Null< int >  __o_bitstream){
            	...
            	HX_STACK_ARG(bitstream,"bitstream")
HXLINE( 174)
HXLINE( 176)		HX_VARI(  ::hx::Object *,data) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_vorbis_file_pcm_total(::hx::DynamicPtr(this->handle),bitstream);
...
::cpp::Int64 VorbisFile_obj::rawTell(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 206)
HXLINE( 208)		HX_VARI(  ::hx::Object *,data) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_vorbis_file_raw_tell(::hx::DynamicPtr(this->handle));
...
::cpp::Int64 VorbisFile_obj::rawTotal(::hx::Null< int >  __o_bitstream){
            	...
            	HX_STACK_ARG(bitstream,"bitstream")
HXLINE( 220)
HXLINE( 222)		HX_VARI(  ::hx::Object *,data) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_vorbis_file_raw_total(::hx::DynamicPtr(this->handle),bitstream);
...
HXLINE( 234)
HXLINE( 236)		HX_VARI(  ::hx::Object *,data) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_vorbis_file_read(::hx::DynamicPtr(this->handle),::hx::DynamicPtr(buffer),position,length,bigEndianPacking,wordSize,_hx_signed);
...
HXLINE( 247)
HXLINE( 249)		HX_VARI(  ::hx::Object *,data) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_vorbis_file_read_float(::hx::DynamicPtr(this->handle),::hx::DynamicPtr(pcmChannels),samples);
...
HXLINE(  75)
HXLINE(  77)		HX_VARI(  ::hx::Object *,handle) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_vorbis_file_from_bytes(::hx::DynamicPtr(bytes));
...
HXLINE(  89)
HXLINE(  91)		HX_VARI(  ::hx::Object *,handle) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_vorbis_file_from_file(path);

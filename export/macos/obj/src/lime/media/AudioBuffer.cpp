...
HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,set_src,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromBase64(::String base64String){
            	...
            	HX_STACK_ARG(base64String,"base64String")
HXLINE(  70)
HXLINE(  71)		if (::hx::IsNull( base64String )) {
HXLINE(  71)			return null();
            		}
HXLINE(  86)		HX_VARI( ::Array< ::String >,base64StringSplit) = base64String.split(HX_(",",2c,00,00,00));
HXLINE(  87)		HX_VARI( ::String,base64StringNoEncoding) = base64StringSplit->__get((base64StringSplit->length - 1));
HXLINE(  88)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::lime::_internal::format::Base64_obj::decode(base64StringNoEncoding);
HXLINE(  89)		HX_VARI(  ::lime::media::AudioBuffer,audioBuffer) =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
...
HXLINE( 126)		HX_VARI(  ::lime::media::AudioBuffer,audioBuffer) =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
...
HXLINE( 175)		HX_VARI(  ::lime::media::AudioBuffer,audioBuffer) =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
...
HXLINE( 200)
HXLINE( 212)		HX_VARI(  ::lime::media::AudioBuffer,buffer) = null();
HXLINE( 214)		{
HXLINE( 214)			int _g = 0;
HXDLIN( 214)			while((_g < paths->length)){
HXLINE( 214)				HX_VARI( ::String,path) = paths->__get(_g);
HXDLIN( 214)				_g = (_g + 1);
...
HXLINE( 229)		HX_VARI(  ::lime::media::vorbis::VorbisInfo,info) = vorbisFile->info(null());
HXLINE( 231)		HX_VARI(  ::lime::media::AudioBuffer,audioBuffer) =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
...
HXLINE( 298)			return null();
            	...
            	HX_STACK_ARG(path,"path")
HXLINE( 247)
HXLINE( 295)		HX_VARI(  ::lime::net::_HTTPRequest_lime_media_AudioBuffer,request) =  ::lime::net::_HTTPRequest_lime_media_AudioBuffer_obj::__alloc( HX_CTX ,null());
...
HXLINE( 336)			return ::lime::media::AudioBuffer_obj::fromFiles(paths);
            	...
            	HX_STACK_ARG(paths,"paths")
HXLINE( 311)
HXLINE( 312)		HX_VARI(  ::lime::app::Promise_lime_media_AudioBuffer,promise) =  ::lime::app::Promise_lime_media_AudioBuffer_obj::__alloc( HX_CTX );
...
::String AudioBuffer_obj::_hx___getCodec( ::haxe::io::Bytes bytes){
            	...
            	HX_STACK_ARG(bytes,"bytes")
HXLINE( 343)
HXLINE( 344)		HX_VARI( ::String,signature) = bytes->getString(0,4,null());

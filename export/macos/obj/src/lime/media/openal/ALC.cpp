...
HXLINE(  46)
HXLINE(  58)		HX_VARI(  ::hx::Object *,handle) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_create_context(::hx::DynamicPtr(device),::hx::DynamicPtr(attrlist));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ALC_obj,destroyContext,(void))
 ...
 ::Dynamic ALC_obj::getContextsDevice( ::Dynamic context){
            	...
            	HX_STACK_ARG(context,"context")
HXLINE(  77)
HXLINE(  78)		HX_VARI(  ::Dynamic,handle) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_contexts_device(::hx::DynamicPtr(context))) );
...
HXLINE(  90)
HXLINE(  92)		HX_VARI(  ::Dynamic,handle) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_current_context()) );
...
HXLINE( 126)
HXLINE( 128)		HX_VARI(  ::hx::Object *,result) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_integerv(::hx::DynamicPtr(device),param,size);
...
::String ALC_obj::getString( ::Dynamic device,int param){
            	...
            	HX_STACK_ARG(param,"param")
HXLINE( 144)
HXLINE( 146)		HX_VARI(  ::hx::Object *,result) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_string(::hx::DynamicPtr(device),param);
...
HXLINE( 166)
HXLINE( 168)		HX_VARI(  ::hx::Object *,handle) = ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_open_device(deviceName);

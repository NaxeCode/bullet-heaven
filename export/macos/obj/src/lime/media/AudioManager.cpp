...
HXLINE(  34)					HX_VARI(  ::lime::media::OpenALAudioContext,alc) = context->openal;
HXLINE(  36)					HX_VARI(  ::Dynamic,device) = alc->openDevice(null());
HXLINE(  37)					HX_VARI(  ::Dynamic,ctx) = alc->createContext(device,null());
...
HXLINE(  47)			HX_VARI(  ::haxe::Timer,timer) =  ::haxe::Timer_obj::__alloc( HX_CTX ,( (Float)(100) ));
...
HXLINE(  61)			HX_VARI(  ::lime::media::OpenALAudioContext,alc) = ::lime::media::AudioManager_obj::context->openal;
HXLINE(  62)			HX_VARI(  ::Dynamic,currentContext) = alc->getCurrentContext();
HXLINE(  64)			if (::hx::IsNotNull( currentContext )) {
HXLINE(  66)				HX_VARI(  ::Dynamic,device) = alc->getContextsDevice(currentContext);
...
HXLINE(  79)			HX_VARI(  ::lime::media::OpenALAudioContext,alc) = ::lime::media::AudioManager_obj::context->openal;
HXLINE(  80)			HX_VARI(  ::Dynamic,currentContext) = alc->getCurrentContext();
HXLINE(  82)			if (::hx::IsNotNull( currentContext )) {
HXLINE(  84)				HX_VARI(  ::Dynamic,device) = alc->getContextsDevice(currentContext);
...
HXLINE( 104)			HX_VARI(  ::lime::media::OpenALAudioContext,alc) = ::lime::media::AudioManager_obj::context->openal;
...
HXLINE( 110)				HX_VARI(  ::Dynamic,device) = alc->getContextsDevice(currentContext);

...
HXLINE(  26)
HXLINE(  27)		HX_VARI(  ::lime::graphics::opengl::GLObject,vertexShader) = ::lime::graphics::opengl::_GLShader::GLShader_Impl__obj::fromSource(gl,vertexSource,gl->VERTEX_SHADER);
HXLINE(  28)		HX_VARI(  ::lime::graphics::opengl::GLObject,fragmentShader) = ::lime::graphics::opengl::_GLShader::GLShader_Impl__obj::fromSource(gl,fragmentSource,gl->FRAGMENT_SHADER);
HXLINE(  30)		HX_VARI(  ::lime::graphics::opengl::GLObject,program) = gl->createProgram();
...
HXLINE(  37)			HX_VARI( ::String,message) = HX_("Unable to initialize the shader program",f0,86,8b,39);

...
HXLINE(  25)
HXLINE(  26)		HX_VARI(  ::lime::graphics::opengl::GLObject,shader) = gl->createShader(type);
HXLINE(  27)		gl->shaderSource(shader,source);
HXLINE(  28)		gl->compileShader(shader);
HXLINE(  29)		HX_VARI( ::String,shaderInfoLog) = gl->getShaderInfoLog(shader);
HXLINE(  30)		HX_VARI( int,compileStatus) = ( (int)(gl->getShaderParameter(shader,gl->COMPILE_STATUS)) );
...
HXLINE(  34)			HX_VAR( ::String,message);

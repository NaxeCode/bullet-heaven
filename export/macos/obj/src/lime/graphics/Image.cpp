...
HXDLIN( 300)			HX_VARI_NAME(  ::lime::graphics::Image,image1,"image") =  ::lime::graphics::Image_obj::__alloc( HX_CTX ,image,this->offsetX,this->offsetY,this->width,this->height,null(),this->type);
...
HXLINE( 368)				::lime::_internal::graphics::ImageDataUtil_obj::copyChannel(::hx::ObjectPtr<OBJ_>(this),sourceImage,sourceRect,destPoint,sourceChannel,destChannel);
            			...
            			break;
            			case (int)2: {
HXLINE( 371)				HX_VAR( int,srcChannel);
...
HXLINE( 379)				HX_VAR( int,dstChannel);
...
HXLINE( 749)				return ::lime::_internal::graphics::ImageDataUtil_obj::getColorBoundsRect(::hx::ObjectPtr<OBJ_>(this),mask,color,findColor,( (int)(format) ));
            			...
            			break;
            			case (int)2: {
HXLINE( 752)				HX_VARI(  ::Dynamic,rect) = this->buffer->_hx___srcBitmapData->__Field(HX_("getColorBoundsRect",86,ad,e8,80),::hx::paccDynamic)(mask,color,findColor);
...
HXLINE( 781)				return ::lime::_internal::graphics::ImageDataUtil_obj::getPixel(::hx::ObjectPtr<OBJ_>(this),x,y,( (int)(format) ));
            			...
            			break;
            			case (int)2: {
HXLINE( 784)				HX_VARI( int,color) = ( (int)(this->buffer->_hx___srcBitmapData->__Field(HX_("getPixel",10,d6,7a,22),::hx::paccDynamic)((x + this->offsetX),(y + this->offsetY))) );
...
HXDLIN( 793)					HX_VARI_NAME( int,rgba1,"rgba") = rgba;
...
HXDLIN( 790)						HX_VARI_NAME( int,bgra1,"bgra") = bgra;
...
HXDLIN( 793)						HX_VARI_NAME( int,rgba3,"rgba") = rgba2;
...
HXLINE( 823)				return ::lime::_internal::graphics::ImageDataUtil_obj::getPixel32(::hx::ObjectPtr<OBJ_>(this),x,y,( (int)(format) ));
            			...
            			break;
            			case (int)2: {
HXLINE( 826)				HX_VARI( int,color) = ( (int)(this->buffer->_hx___srcBitmapData->__Field(HX_("getPixel32",af,a6,68,d7),::hx::paccDynamic)((x + this->offsetX),(y + this->offsetY))) );
...
HXDLIN( 835)					HX_VARI_NAME( int,rgba1,"rgba") = rgba;
...
HXDLIN( 832)						HX_VARI_NAME( int,bgra1,"bgra") = bgra;
...
HXDLIN( 835)						HX_VARI_NAME( int,rgba3,"rgba") = rgba2;
...
bool Image_obj::_hx___fromBytes( ::haxe::io::Bytes bytes, ::Dynamic onload){
            	...
            	HX_STACK_ARG(onload,"onload")
HXLINE(1453)
HXLINE(1478)		HX_VARI(  ::lime::graphics::ImageBuffer,imageBuffer) = null();
...
HXLINE(1510)
HXLINE(1551)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) = null();
...
HXLINE(1727)			HX_VARI( int,newWidth) = 1;
HXLINE(1728)			HX_VARI( int,newHeight) = 1;
...
HXLINE( 615)		HX_VARI(  ::lime::graphics::Image,image) =  ::lime::graphics::Image_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null());
...
HXLINE( 654)		HX_VARI(  ::lime::graphics::Image,image) =  ::lime::graphics::Image_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null());
...
HXLINE( 674)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,null(),canvas->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic),canvas->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic),null(),null());
HXLINE( 675)		buffer->set_src(canvas);
HXLINE( 676)		HX_VARI(  ::lime::graphics::Image,image) =  ::lime::graphics::Image_obj::__alloc( HX_CTX ,buffer,null(),null(),null(),null(),null(),null());
...
HXLINE( 697)		HX_VARI(  ::lime::graphics::Image,image) =  ::lime::graphics::Image_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null());
...
HXLINE( 717)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,null(),image->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic),image->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic),null(),null());
HXLINE( 718)		buffer->set_src(image);
HXLINE( 719)		HX_VARI(  ::lime::graphics::Image,_image) =  ::lime::graphics::Image_obj::__alloc( HX_CTX ,buffer,null(),null(),null(),null(),null(),null());
...
HXLINE(1036)		HX_VARI(  ::lime::net::_HTTPRequest_lime_graphics_Image,request) =  ::lime::net::_HTTPRequest_lime_graphics_Image_obj::__alloc( HX_CTX ,null());
...
HXLINE(1645)		HX_VARI( ::String,header) = bytes->getString(0,6,null());

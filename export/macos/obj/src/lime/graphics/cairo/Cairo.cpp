...
HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,set_antialias,return )
 ...
 ::lime::math::Vector2 Cairo_obj::get_currentPoint(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 459)
HXLINE( 464)		HX_VARI(  ::Dynamic,vec) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_get_current_point(::hx::DynamicPtr(this->handle))) );
...
::Array< Float > Cairo_obj::get_dash(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 473)
HXLINE( 483)		HX_VARI(  ::Dynamic,result) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_get_dash(::hx::DynamicPtr(this->handle))) );
...
HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,set_lineWidth,return )
 ...
 ::lime::math::Matrix3 Cairo_obj::get_matrix(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 643)
HXLINE( 648)		HX_VARI(  ::Dynamic,m) = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_get_matrix(::hx::DynamicPtr(this->handle))) );

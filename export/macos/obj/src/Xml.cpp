...
HXLINE( 309)				HX_VARI(  ::Xml,child) = _g2->__get(_g1).StaticCast<  ::Xml >();
...
HXDLIN( 309)		HX_VARI( ::Array< ::Dynamic>,ret) = _g;
...
HXLINE( 320)				HX_VARI(  ::Xml,child) = _g2->__get(_g1).StaticCast<  ::Xml >();
...
HXLINE( 319)		HX_VARI( ::Array< ::Dynamic>,ret) = _g;
...
HXLINE( 339)				HX_VARI(  ::Xml,child) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN( 339)				_g = (_g + 1);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,parse,return )
 ...
 ::Xml Xml_obj::createElement(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 182)
HXLINE( 183)		HX_VARI(  ::Xml,xml) =  ::Xml_obj::__alloc( HX_CTX ,::Xml_obj::Element);
HXLINE( 184)		{
...
HXLINE( 191)
HXLINE( 192)		HX_VARI(  ::Xml,xml) =  ::Xml_obj::__alloc( HX_CTX ,::Xml_obj::PCData);
HXLINE( 193)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createPCData,return )
 ...
 ::Xml Xml_obj::createCData(::String data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 200)
HXLINE( 201)		HX_VARI(  ::Xml,xml) =  ::Xml_obj::__alloc( HX_CTX ,::Xml_obj::CData);
HXLINE( 202)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createCData,return )
 ...
 ::Xml Xml_obj::createComment(::String data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 209)
HXLINE( 210)		HX_VARI(  ::Xml,xml) =  ::Xml_obj::__alloc( HX_CTX ,::Xml_obj::Comment);
HXLINE( 211)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createComment,return )
 ...
 ::Xml Xml_obj::createDocType(::String data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 218)
HXLINE( 219)		HX_VARI(  ::Xml,xml) =  ::Xml_obj::__alloc( HX_CTX ,::Xml_obj::DocType);
HXLINE( 220)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Xml_obj,createDocType,return )
 ...
 ::Xml Xml_obj::createProcessingInstruction(::String data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 227)
HXLINE( 228)		HX_VARI(  ::Xml,xml) =  ::Xml_obj::__alloc( HX_CTX ,::Xml_obj::ProcessingInstruction);
HXLINE( 229)		{

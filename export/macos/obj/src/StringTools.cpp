...
HXLINE( 158)
HXLINE( 159)		HX_VARI(  ::StringBuf,buf) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 160)		{
...
HXDLIN( 160)				HX_VARI( int,code) = c1;
...
HXLINE( 251)
HXLINE( 267)		HX_VARI( int,elen) = end.length;
HXLINE( 268)		HX_VARI( int,slen) = s.length;
...
HXLINE( 282)
HXLINE( 287)		HX_VARI(  ::Dynamic,c) = s.charCodeAt(pos);
...
::String StringTools_obj::ltrim(::String s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE( 300)
HXLINE( 304)		HX_VARI( int,l) = s.length;
HXLINE( 305)		HX_VARI( int,r) = 0;
...
::String StringTools_obj::rtrim(::String s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE( 325)
HXLINE( 329)		HX_VARI( int,l) = s.length;
HXLINE( 330)		HX_VARI( int,r) = 0;
...
HXLINE( 373)		HX_VARI(  ::StringBuf,buf) =  ::StringBuf_obj::__alloc( HX_CTX );
...
HXLINE( 438)
HXLINE( 444)		HX_VARI( ::String,s) = HX_("",00,00,00,00);
HXLINE( 445)		HX_VARI( ::String,hexChars) = HX_("0123456789ABCDEF",68,2a,58,a2);
HXLINE( 446)		do {

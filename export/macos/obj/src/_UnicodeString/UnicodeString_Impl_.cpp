...
HXLINE( 175)		HX_VARI( int,unicodeOffset) = 0;
HXLINE( 176)		HX_VARI( int,nativeOffset) = 0;
...
HXDLIN( 178)			HX_VARI_NAME( int,c1,"c") = c;
...
HXLINE( 335)		HX_VARI( int,unicodeOffset) = 0;
HXLINE( 336)		HX_VARI( int,nativeOffset) = 0;
HXLINE( 337)		HX_VARI( int,fromOffset) = -1;
HXLINE( 338)		HX_VARI( int,subLength) = 0;
...
HXDLIN( 340)			HX_VARI_NAME( int,c1,"c") = c;
...
HXLINE( 351)					HX_VAR( int,lastOffset);
...
HXDLIN( 422)				HX_VARI_NAME( int,c2,"c") = c1;
HXLINE( 423)				l = (l + 1);
            			}
            		}
HXLINE( 425)		return l;

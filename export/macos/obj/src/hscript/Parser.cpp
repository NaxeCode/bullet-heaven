...
HXLINE( 138)						HX_VARI( ::String,x) = _g3->__get(_g2);
...
HXLINE( 142)		{
HXLINE( 142)			{
HXLINE( 142)				HX_VARI( ::String,x1) = HX_("!",21,00,00,00);
HXLINE( 143)				{
...
HXLINE( 142)			{
HXLINE( 142)				HX_VARI( ::String,x2) = HX_("++",a0,25,00,00);
HXLINE( 143)				{
...
HXLINE( 142)			{
HXLINE( 142)				HX_VARI( ::String,x3) = HX_("--",60,27,00,00);
HXLINE( 143)				{
...
HXLINE( 142)			{
HXLINE( 142)				HX_VARI( ::String,x4) = HX_("~",7e,00,00,00);
HXLINE( 143)				{
...
HXDLIN( 179)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
HXLINE( 187)		HX_VARI( ::Array< ::Dynamic>,a) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 188)		while(true){
HXLINE( 189)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
void Parser_obj::ensure( ::hscript::Token tk){
            	...
            	HX_STACK_ARG(tk,"tk")
HXLINE( 212)
HXLINE( 213)		HX_VARI(  ::hscript::Token,t) = this->token();
...
void Parser_obj::ensureToken( ::hscript::Token tk){
            	...
            	HX_STACK_ARG(tk,"tk")
HXLINE( 217)
HXLINE( 218)		HX_VARI(  ::hscript::Token,t) = this->token();
...
bool Parser_obj::maybe( ::hscript::Token tk){
            	...
            	HX_STACK_ARG(tk,"tk")
HXLINE( 222)
HXLINE( 223)		HX_VARI(  ::hscript::Token,t) = this->token();
...
::String Parser_obj::getIdent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 230)
HXLINE( 231)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 233)				HX_VARI( ::String,id) = tk->_hx_getString(0);
...
HXDLIN( 280)				HX_VARI(  ::hscript::CType,t) = _g->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 280)				HX_VARI_NAME(  ::hscript::Expr,e1,"e") = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 282)				HX_VARI_NAME(  ::hscript::Expr,e2,"e") = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 282)				return this->isBlock(e2);
            			}
            			break;
            			case (int)7: {
HXLINE( 283)				::String _g6 = _g->_hx_getString(0);
HXDLIN( 283)				HX_VARI( bool,prefix) = _g->_hx_getBool(1);
HXDLIN( 283)				HX_VARI_NAME(  ::hscript::Expr,e3,"e") = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 281)				HX_VARI_NAME(  ::hscript::Expr,e11,"e1") = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 281)				HX_VARI_NAME(  ::hscript::Expr,e21,"e2") = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 284)				HX_VARI_NAME(  ::hscript::Expr,e4,"e") = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 286)				HX_VARI_NAME(  ::hscript::Expr,e5,"e") = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 279)				HX_VARI_NAME(  ::hscript::Expr,e6,"e") = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 279)				return this->isBlock(e6);
            			}
            			break;
            			case (int)15: {
HXLINE( 287)				HX_VARI_NAME(  ::hscript::Expr,e7,"e") = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 288)				HX_VARI_NAME(  ::hscript::Expr,e8,"e") = _g->_hx_getObject(3).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 285)				HX_VARI_NAME(  ::hscript::Expr,e9,"e") = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 289)				HX_VARI_NAME(  ::hscript::Expr,e10,"e") = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 294)
HXLINE( 295)		HX_VARI(  ::hscript::Expr,e) = this->parseExpr();
HXLINE( 296)		exprs->push(e);
HXLINE( 298)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,parseFullExpr,(void))
 ...
 ::hscript::Expr Parser_obj::parseObject( ::Dynamic p1){
            	...
            	HX_STACK_ARG(p1,"p1")
HXLINE( 314)
HXLINE( 316)		HX_VARI( ::Array< ::Dynamic>,fl) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 317)		while(true){
HXLINE( 318)			HX_VARI(  ::hscript::Token,tk) = this->token();
HXLINE( 319)			HX_VARI( ::String,id) = null();
...
HXLINE( 320)				switch((int)(tk->_hx_getIndex())){
            					case (int)1: {
HXLINE( 322)						HX_VARI(  ::hscript::Const,c) = tk->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXDLIN( 322)						{
HXLINE( 323)							if (!(this->allowJSON)) {
HXLINE( 324)								this->unexpected(tk);
            							}
HXLINE( 325)							if ((c->_hx_getIndex() == 2)) {
HXLINE( 326)								HX_VARI( ::String,s) = c->_hx_getString(0);
HXDLIN( 326)								id = s;
            							}
            							else {
HXLINE( 327)								this->unexpected(tk);
            					...
            					break;
            					case (int)2: {
HXLINE( 321)						HX_VARI( ::String,i) = tk->_hx_getString(0);
HXDLIN( 321)						id = i;
            					}
            					break;
            					case (int)7: {
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,parseObject,return )
 ...
 ::hscript::Expr Parser_obj::parseExpr(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 349)
HXLINE( 350)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 354)			switch((int)(tk->_hx_getIndex())){
            				case (int)1: {
HXLINE( 360)					HX_VARI(  ::hscript::Const,c) = tk->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXLINE( 361)					return this->parseExprNext(::hscript::Expr_obj::EConst(c));
            				}
            				break;
            				case (int)2: {
HXLINE( 355)					HX_VARI( ::String,id) = tk->_hx_getString(0);
HXLINE( 356)					HX_VARI(  ::hscript::Expr,e) = this->parseStructure(id);
...
HXLINE( 359)					return this->parseExprNext(e);
            				...
            				break;
            				case (int)3: {
HXLINE( 439)					HX_VARI( ::String,op) = tk->_hx_getString(0);
HXLINE( 440)					if ((op == HX_("-",2d,00,00,00))) {
HXLINE( 441)						HX_VARI( int,start) = 0;
HXLINE( 442)						HX_VARI_NAME(  ::hscript::Expr,e1,"e") = this->parseExpr();
...
HXDLIN( 448)							switch((int)(_g1->_hx_getIndex())){
            								case (int)0: {
HXLINE( 446)									HX_VARI( int,i) = _g1->_hx_getInt(0);
HXLINE( 447)									return ::hscript::Expr_obj::EConst(::hscript::Const_obj::CInt(-(i)));
            								}
            								break;
            								case (int)1: {
HXLINE( 448)									HX_VARI( Float,f) = _g1->_hx_getFloat(0);
...
HXLINE( 366)						HX_VARI(  ::hscript::Expr,eret) = this->parseExpr();
...
HXLINE( 370)					HX_VARI_NAME(  ::hscript::Expr,e2,"e") = this->parseExpr();
...
HXLINE( 390)									HX_VARI( ::String,v) = _g2->_hx_getString(0);
HXDLIN( 390)									return this->parseLambda(::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(::hx::Anon_obj::Create(1)
            							...
            							break;
            							case (int)14: {
HXLINE( 376)								HX_VARI_NAME(  ::hscript::CType,t1,"t") = this->parseType();
...
HXLINE( 383)												HX_VARI_NAME( ::String,v1,"v") = _g3->_hx_getString(0);
...
HXLINE( 398)						switch((int)(tk->_hx_getIndex())){
            							case (int)1: {
HXLINE( 410)								HX_VARI_NAME(  ::hscript::Const,c1,"c") = tk->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXLINE( 411)								if (this->allowJSON) {
HXLINE( 412)									if ((c1->_hx_getIndex() == 2)) {
HXLINE( 413)										::String _g4 = c1->_hx_getString(0);
HXDLIN( 413)										{
HXLINE( 414)											HX_VARI(  ::hscript::Token,tk2) = this->token();
HXLINE( 415)											{
...
HXDLIN( 401)								{
HXLINE( 402)									HX_VARI_NAME(  ::hscript::Token,tk21,"tk2") = this->token();
HXLINE( 403)									{
...
HXLINE( 430)					HX_VARI( ::Array< ::Dynamic>,a) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 438)					return ::hscript::Expr_obj::EBlock(a);
            				...
            				break;
            				case (int)11: {
HXLINE( 458)					HX_VARI_NAME( ::Array< ::Dynamic>,a1,"a") = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 470)								HX_VARI( ::String,tmp) = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 471)								HX_VARI_NAME(  ::hscript::Expr,e3,"e") = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hscript::Expr_obj::EVar(tmp,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp,a1->__get(0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp)));
...
HXLINE( 470)								HX_VARI_NAME( ::String,tmp1,"tmp") = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 471)								HX_VARI_NAME(  ::hscript::Expr,e4,"e") = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hscript::Expr_obj::EVar(tmp1,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp1,a1->__get(0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp1)));
...
HXLINE( 470)								HX_VARI_NAME( ::String,tmp2,"tmp") = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 471)								HX_VARI_NAME(  ::hscript::Expr,e5,"e") = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hscript::Expr_obj::EVar(tmp2,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp2,a1->__get(0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp2)));
...
HXLINE( 479)					return this->parseExprNext(::hscript::Expr_obj::EArrayDecl(a1));
            				...
            				break;
            				case (int)15: {
HXLINE( 480)					HX_VARI_NAME( ::String,id1,"id") = tk->_hx_getString(0);
HXDLIN( 480)					if (this->allowMetadata) {
HXLINE( 481)						HX_VARI( ::Array< ::Dynamic>,args) = this->parseMetaArgs();
...
HXLINE( 490)			HX_VARI( ::String,id) = this->getIdent();
HXLINE( 491)			HX_VAR(  ::hscript::CType,t);
...
HXLINE( 492)			args->push( ::Dynamic(::hx::Anon_obj::Create(2)
            				...
            				->setFixed(1,HX_("name",4b,72,ff,48),id)));
HXLINE( 493)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 504)		HX_VARI(  ::hscript::Expr,eret) = this->parseExpr();
...
::Array< ::Dynamic> Parser_obj::parseMetaArgs(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 508)
HXLINE( 509)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 514)		HX_VARI( ::Array< ::Dynamic>,args) = ::Array_obj< ::Dynamic>::__new(0);
...
HXLINE( 524)						HX_VARI_NAME(  ::hscript::Token,tk1,"tk") = _g;
...
HXLINE( 523)								goto _hx_goto_41;
            							...
            							break;
            							default:{
HXLINE( 524)								HX_VARI_NAME(  ::hscript::Token,tk2,"tk") = _g;
...
HXLINE( 534)		HX_VAR(  ::hscript::Expr,edef);
HXDLIN( 534)		switch((int)(e->_hx_getIndex())){
            			case (int)3: {
HXLINE( 545)				HX_VARI(  ::hscript::Expr,e2) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 543)					HX_VARI_NAME(  ::hscript::Expr,e1,"e") = _g->__get(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 534)					edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)9: {
HXLINE( 541)				HX_VARI(  ::hscript::Expr,cond) = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 541)				HX_VARI_NAME(  ::hscript::Expr,e11,"e1") = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 541)				HX_VARI_NAME(  ::hscript::Expr,e21,"e2") = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 534)					edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)10: {
HXLINE( 537)				HX_VARI_NAME(  ::hscript::Expr,cond1,"cond") = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 537)				HX_VARI_NAME(  ::hscript::Expr,e22,"e2") = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 534)				edef = ::hscript::Expr_obj::EWhile(cond1,this->mapCompr(tmp,e22));
            			}
            			break;
            			case (int)11: {
HXLINE( 535)				HX_VARI( ::String,v) = e->_hx_getString(0);
HXDLIN( 535)				HX_VARI(  ::hscript::Expr,it) = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 535)				HX_VARI_NAME(  ::hscript::Expr,e23,"e2") = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 534)				edef = ::hscript::Expr_obj::EFor(v,it,this->mapCompr(tmp,e23));
            			}
            			break;
            			case (int)24: {
HXLINE( 539)				HX_VARI_NAME(  ::hscript::Expr,cond2,"cond") = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 539)				HX_VARI_NAME(  ::hscript::Expr,e24,"e2") = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 556)		switch((int)(_g->_hx_getIndex())){
            			case (int)6: {
HXLINE( 557)				HX_VARI( ::String,bop) = _g->_hx_getString(0);
HXDLIN( 557)				HX_VARI(  ::hscript::Expr,e1) = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 557)				HX_VARI(  ::hscript::Expr,e2) = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 557)				return ::hscript::Expr_obj::EBinop(bop,this->makeUnop(op,e1),e2);
            			}
            			break;
            			case (int)22: {
HXLINE( 558)				HX_VARI_NAME(  ::hscript::Expr,e11,"e1") = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 558)				HX_VARI_NAME(  ::hscript::Expr,e21,"e2") = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 558)				HX_VARI(  ::hscript::Expr,e3) = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 566)		switch((int)(_g->_hx_getIndex())){
            			case (int)6: {
HXLINE( 567)				HX_VARI( ::String,op2) = _g->_hx_getString(0);
HXDLIN( 567)				HX_VARI(  ::hscript::Expr,e2) = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 567)				HX_VARI(  ::hscript::Expr,e3) = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 571)					return ::hscript::Expr_obj::EBinop(op,e1,e);
            			...
            			break;
            			case (int)22: {
HXLINE( 572)				HX_VARI_NAME(  ::hscript::Expr,e21,"e2") = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 572)				HX_VARI_NAME(  ::hscript::Expr,e31,"e3") = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 572)				HX_VARI(  ::hscript::Expr,e4) = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 625)			HX_VARI(  ::hscript::Expr,e) = this->parseExpr();
HXLINE( 626)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 632)			HX_VARI(  ::hscript::Expr,econd) = this->parseExpr();
...
HXLINE( 636)			HX_VARI( ::String,vname) = this->getIdent();
HXLINE( 637)			{
...
HXLINE( 638)			HX_VARI(  ::hscript::Expr,eiter) = this->parseExpr();
HXLINE( 639)			{
...
HXLINE( 640)			HX_VARI_NAME(  ::hscript::Expr,e1,"e") = this->parseExpr();
...
HXLINE( 649)			HX_VARI_NAME(  ::hscript::Token,tk1,"tk") = this->token();
HXLINE( 650)			HX_VARI( ::String,name) = null();
...
HXLINE( 652)					HX_VARI_NAME( ::String,id1,"id") = tk1->_hx_getString(0);
HXDLIN( 652)					name = id1;
            				}
            				else {
...
HXLINE( 655)			HX_VARI(  ::Dynamic,inf) = this->parseFunctionDecl();
...
HXLINE( 589)			HX_VARI(  ::hscript::Expr,cond) = this->parseExpr();
HXLINE( 590)			{
...
HXLINE( 591)			HX_VARI_NAME(  ::hscript::Expr,e11,"e1") = this->parseExpr();
HXLINE( 592)			HX_VARI(  ::hscript::Expr,e2) = null();
HXLINE( 593)			HX_VARI( bool,semic) = false;
HXLINE( 594)			HX_VARI_NAME(  ::hscript::Token,tk2,"tk") = this->token();
...
HXLINE( 663)			HX_VARI( ::Array< ::String >,a) = ::Array_obj< ::String >::__new();
HXLINE( 664)			a->push(this->getIdent());
HXLINE( 665)			while(true){
HXLINE( 666)				HX_VARI_NAME(  ::hscript::Token,tk3,"tk") = this->token();
...
HXLINE( 674)							goto _hx_goto_47;
            			...
            			_hx_goto_47:;
HXLINE( 677)			HX_VARI( ::Array< ::Dynamic>,args) = this->parseExprList(::hscript::Token_obj::TPClose_dyn());
...
HXLINE( 658)			HX_VARI_NAME(  ::hscript::Token,tk4,"tk") = this->token();
HXLINE( 659)			{
...
HXLINE( 660)			HX_VAR_NAME(  ::hscript::Expr,e3,"e");
...
HXLINE( 697)			HX_VARI_NAME(  ::hscript::Expr,e4,"e") = this->parseExpr();
HXLINE( 698)			HX_VARI(  ::hscript::Expr,def) = null();
HXDLIN( 698)			HX_VARI( ::Array< ::Dynamic>,cases) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 699)			{
...
HXLINE( 701)				HX_VARI_NAME(  ::hscript::Token,tk5,"tk") = this->token();
...
HXLINE( 704)								HX_VARI(  ::Dynamic,c) =  ::Dynamic(::hx::Anon_obj::Create(2)
...
HXLINE( 707)									HX_VARI_NAME(  ::hscript::Expr,e5,"e") = this->parseExpr();
...
HXLINE( 717)												goto _hx_goto_50;
            								...
            								_hx_goto_50:;
HXLINE( 720)								HX_VARI( ::Array< ::Dynamic>,exprs) = ::Array_obj< ::Dynamic>::__new(0);
...
HXLINE( 742)								HX_VARI_NAME( ::Array< ::Dynamic>,exprs1,"exprs") = ::Array_obj< ::Dynamic>::__new(0);
...
HXLINE( 680)			HX_VARI_NAME(  ::hscript::Expr,e6,"e") = this->parseExpr();
HXLINE( 681)			return ::hscript::Expr_obj::EThrow(e6);
HXLINE( 679)			goto _hx_goto_46;
            		}
            		if (  (_hx_switch_0==HX_("try",3b,69,58,00)) ){
HXLINE( 683)			HX_VARI_NAME(  ::hscript::Expr,e7,"e") = this->parseExpr();
HXLINE( 684)			{
...
HXLINE( 686)			HX_VARI_NAME( ::String,vname1,"vname") = this->getIdent();
HXLINE( 687)			{
...
HXLINE( 688)			HX_VARI_NAME(  ::hscript::CType,t10,"t") = null();
...
HXLINE( 694)			HX_VARI(  ::hscript::Expr,ec) = this->parseExpr();
HXLINE( 695)			return ::hscript::Expr_obj::ETry(e7,vname1,t10,ec);
HXLINE( 682)			goto _hx_goto_46;
            		}
            		if (  (_hx_switch_0==HX_("var",e7,de,59,00)) ){
HXLINE( 607)			HX_VARI( ::String,ident) = this->getIdent();
HXLINE( 608)			HX_VARI_NAME(  ::hscript::Token,tk6,"tk") = this->token();
HXLINE( 609)			HX_VARI_NAME(  ::hscript::CType,t13,"t") = null();
...
HXLINE( 614)			HX_VARI_NAME(  ::hscript::Expr,e8,"e") = null();
...
HXLINE( 621)			HX_VARI_NAME(  ::hscript::Expr,econd1,"econd") = this->parseExpr();
HXLINE( 622)			HX_VARI_NAME(  ::hscript::Expr,e9,"e") = this->parseExpr();
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,parseStructure,return )
 ...
 ::hscript::Expr Parser_obj::parseExprNext( ::hscript::Expr e1){
            	...
            	HX_STACK_ARG(e1,"e1")
HXLINE( 774)
HXLINE( 775)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE( 776)			switch((int)(tk->_hx_getIndex())){
            				case (int)3: {
HXLINE( 777)					HX_VARI( ::String,op) = tk->_hx_getString(0);
HXLINE( 779)					if ((op == HX_("->",71,27,00,00))) {
HXLINE( 781)						switch((int)(e1->_hx_getIndex())){
            							case (int)1: {
HXLINE( 782)								HX_VARI( ::String,i) = e1->_hx_getString(0);
HXLINE( 783)								HX_VARI(  ::hscript::Expr,eret) = this->parseExpr();
...
HXLINE( 782)									HX_VARI_NAME( ::String,i1,"i") = _hx_tmp->_hx_getString(0);
HXLINE( 783)									HX_VARI_NAME(  ::hscript::Expr,eret1,"eret") = this->parseExpr();
HXLINE( 784)									return ::hscript::Expr_obj::EFunction(::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 785)									HX_VARI_NAME( ::String,i2,"i") = _hx_tmp1->_hx_getString(0);
HXDLIN( 785)									HX_VARI(  ::hscript::CType,t) = e1->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXLINE( 786)									HX_VARI_NAME(  ::hscript::Expr,eret2,"eret") = this->parseExpr();
...
HXLINE( 805)					return this->parseExprNext(::hscript::Expr_obj::ECall(e1,this->parseExprList(::hscript::Token_obj::TPClose_dyn())));
            				...
            				break;
            				case (int)8: {
HXLINE( 802)					HX_VARI( ::String,field) = this->getIdent();
HXLINE( 803)					return this->parseExprNext(::hscript::Expr_obj::EField(e1,field));
            				}
            				break;
            				case (int)11: {
HXLINE( 807)					HX_VARI(  ::hscript::Expr,e2) = this->parseExpr();
HXLINE( 808)					{
...
HXLINE( 809)					return this->parseExprNext(::hscript::Expr_obj::EArray(e1,e2));
            				...
            				break;
            				case (int)13: {
HXLINE( 811)					HX_VARI_NAME(  ::hscript::Expr,e21,"e2") = this->parseExpr();
HXLINE( 812)					{
...
HXLINE( 813)					HX_VARI(  ::hscript::Expr,e3) = this->parseExpr();
...
::Array< ::Dynamic> Parser_obj::parseFunctionArgs(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 821)
HXLINE( 822)		HX_VARI( ::Array< ::Dynamic>,args) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 823)		HX_VARI(  ::hscript::Token,tk) = this->token();
HXLINE( 824)		if (::hx::IsPointerNotEq( tk,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 825)			HX_VARI( bool,done) = false;
HXLINE( 826)			while(!(done)){
HXLINE( 827)				HX_VARI( ::String,name) = null();
HXDLIN( 827)				HX_VARI( bool,opt) = false;
...
HXLINE( 835)						HX_VARI( ::String,id) = tk->_hx_getString(0);
HXDLIN( 835)						name = id;
            					}
            					else {
HXLINE( 837)						this->unexpected(tk);
...
HXLINE( 840)				HX_VARI(  ::Dynamic,arg) =  ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 865)		HX_VARI( ::Array< ::Dynamic>,args) = this->parseFunctionArgs();
HXLINE( 866)		HX_VARI(  ::hscript::CType,ret) = null();
HXLINE( 867)		if (this->allowTypes) {
HXLINE( 868)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
::Array< ::String > Parser_obj::parsePath(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 877)
HXLINE( 878)		HX_VARI( ::Array< ::String >,path) = ::Array_obj< ::String >::__new(1)->init(0,this->getIdent());
HXLINE( 879)		while(true){
HXLINE( 880)			HX_VARI(  ::hscript::Token,t) = this->token();
...
HXLINE( 891)		HX_VARI(  ::hscript::Token,t) = this->token();
...
HXLINE( 892)			switch((int)(t->_hx_getIndex())){
            				case (int)2: {
HXLINE( 893)					HX_VARI( ::String,v) = t->_hx_getString(0);
HXLINE( 894)					{
...
HXLINE( 895)					HX_VARI( ::Array< ::String >,path) = this->parsePath();
HXLINE( 896)					HX_VARI( ::Array< ::Dynamic>,params) = null();
...
HXLINE( 899)							HX_VARI( ::String,op) = t->_hx_getString(0);
...
HXLINE( 905)										switch((int)(t->_hx_getIndex())){
            											case (int)3: {
HXLINE( 907)												HX_VARI_NAME( ::String,op1,"op") = t->_hx_getString(0);
HXDLIN( 907)												{
...
HXLINE( 929)					HX_VARI(  ::hscript::Token,a) = this->token();
HXDLIN( 929)					HX_VARI(  ::hscript::Token,b) = this->token();
HXLINE( 932)					{
...
HXLINE( 935)					HX_VARI(  ::Dynamic,withReturn) =  ::Dynamic(new _hx_Closure_0(_gthis));
HXLINE( 944)					if (::hx::IsNull( a )) {
HXLINE( 960)						HX_VARI_NAME(  ::hscript::CType,t1,"t") = this->parseType();
HXLINE( 961)						 ::hscript::Token _g = this->token();
HXDLIN( 961)						if (::hx::IsNull( _g )) {
HXLINE( 973)							HX_VARI_NAME(  ::hscript::Token,t2,"t") = _g;
...
HXLINE( 972)									return this->parseTypeNext(::hscript::CType_obj::CTParent(t1));
            								...
            								break;
            								case (int)9: {
HXLINE( 963)									HX_VARI( ::Array< ::Dynamic>,args) = ::Array_obj< ::Dynamic>::__new(1)->init(0,t1);
HXLINE( 965)									do {
...
HXLINE( 970)									return withReturn(args);
            								...
            								break;
            								default:{
HXLINE( 973)									HX_VARI_NAME(  ::hscript::Token,t4,"t") = _g;
...
HXLINE( 960)									HX_VARI_NAME(  ::hscript::CType,t5,"t") = this->parseType();
HXLINE( 961)									 ::hscript::Token _g2 = this->token();
HXDLIN( 961)									if (::hx::IsNull( _g2 )) {
HXLINE( 973)										HX_VARI_NAME(  ::hscript::Token,t6,"t") = _g2;
...
HXLINE( 972)												return this->parseTypeNext(::hscript::CType_obj::CTParent(t5));
            											...
            											break;
            											case (int)9: {
HXLINE( 963)												HX_VARI_NAME( ::Array< ::Dynamic>,args1,"args") = ::Array_obj< ::Dynamic>::__new(1)->init(0,t5);
HXLINE( 965)												do {
...
HXLINE( 970)												return withReturn(args1);
            											...
            											break;
            											default:{
HXLINE( 973)												HX_VARI_NAME(  ::hscript::Token,t8,"t") = _g2;
...
HXLINE( 947)												HX_VARI(  ::Dynamic,arg) = _g5->__get(_g4);
...
HXLINE( 950)														HX_VARI_NAME(  ::hscript::Expr,v1,"v") = _g6;
...
HXLINE( 947)										HX_VARI_NAME( ::Array< ::Dynamic>,args2,"args") = _g3;
HXLINE( 957)										return withReturn(args2);
            									}
            									else {
HXLINE( 960)										HX_VARI_NAME(  ::hscript::CType,t9,"t") = this->parseType();
HXLINE( 961)										 ::hscript::Token _g7 = this->token();
HXDLIN( 961)										if (::hx::IsNull( _g7 )) {
HXLINE( 973)											HX_VARI_NAME(  ::hscript::Token,t10,"t") = _g7;
...
HXLINE( 972)													return this->parseTypeNext(::hscript::CType_obj::CTParent(t9));
            												...
            												break;
            												case (int)9: {
HXLINE( 963)													HX_VARI_NAME( ::Array< ::Dynamic>,args3,"args") = ::Array_obj< ::Dynamic>::__new(1)->init(0,t9);
HXLINE( 965)													do {
...
HXLINE( 970)													return withReturn(args3);
            												...
            												break;
            												default:{
HXLINE( 973)													HX_VARI_NAME(  ::hscript::Token,t12,"t") = _g7;
...
HXLINE( 947)										HX_VARI_NAME(  ::Dynamic,arg1,"arg") = _g10->__get(_g9);
...
HXLINE( 950)												HX_VARI_NAME(  ::hscript::Expr,v2,"v") = _g11;
HXLINE( 951)												if (!(this->resumeErrors)) {
HXLINE( 951)													HX_STACK_DO_THROW(::hscript::Error_obj::ECustom(HX_("Default values not allowed in function types",28,46,7a,e6)));
            												}
            											}
...
HXLINE( 947)								HX_VARI_NAME( ::Array< ::Dynamic>,args4,"args") = _g8;
HXLINE( 957)								return withReturn(args4);
            							}
            							break;
            							default:{
HXLINE( 960)								HX_VARI_NAME(  ::hscript::CType,t13,"t") = this->parseType();
HXLINE( 961)								 ::hscript::Token _g12 = this->token();
HXDLIN( 961)								if (::hx::IsNull( _g12 )) {
HXLINE( 973)									HX_VARI_NAME(  ::hscript::Token,t14,"t") = _g12;
...
HXLINE( 972)											return this->parseTypeNext(::hscript::CType_obj::CTParent(t13));
            										...
            										break;
            										case (int)9: {
HXLINE( 963)											HX_VARI_NAME( ::Array< ::Dynamic>,args5,"args") = ::Array_obj< ::Dynamic>::__new(1)->init(0,t13);
HXLINE( 965)											do {
...
HXLINE( 970)											return withReturn(args5);
            										...
            										break;
            										default:{
HXLINE( 973)											HX_VARI_NAME(  ::hscript::Token,t16,"t") = _g12;
HXDLIN( 973)											return this->unexpected(t16);
            				...
            				break;
            				case (int)6: {
HXLINE( 977)					HX_VARI( ::Array< ::Dynamic>,fields) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 978)					HX_VARI( ::Array< ::Dynamic>,meta) = null();
...
HXLINE( 984)										HX_VARI( ::String,name) = this->getIdent();
HXLINE( 985)										{
...
HXLINE( 989)										HX_VARI_NAME( ::String,name1,"name") = _g13;
HXDLIN( 989)										{
HXLINE( 990)											{
...
HXLINE( 982)									goto _hx_goto_69;
            								...
            								break;
            								case (int)15: {
HXLINE( 998)									HX_VARI_NAME( ::String,name2,"name") = t->_hx_getString(0);
HXDLIN( 998)									{
...
HX_DEFINE_DYNAMIC_FUNC0(Parser_obj,parseType,return )
 ...
 ::hscript::CType Parser_obj::parseTypeNext( ::hscript::CType t){
            	...
            	HX_STACK_ARG(t,"t")
HXLINE(1012)
HXLINE(1013)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE(1015)				HX_VARI( ::String,op) = tk->_hx_getString(0);
...
HXLINE(1024)		HX_VARI(  ::hscript::CType,t2) = this->parseType();
HXLINE(1025)		if ((t2->_hx_getIndex() == 1)) {
HXLINE(1026)			 ::hscript::CType _g = t2->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN(1026)			HX_VARI( ::Array< ::Dynamic>,args) = t2->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE(1034)
HXLINE(1035)		HX_VARI( ::Array< ::Dynamic>,args) = ::Array_obj< ::Dynamic>::__new();
HXLINE(1036)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE(1062)		HX_VARI( ::Array< ::Dynamic>,decls) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1063)		while(true){
HXLINE(1064)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
::Array< ::Dynamic> Parser_obj::parseMetadata(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1072)
HXLINE(1073)		HX_VARI( ::Array< ::Dynamic>,meta) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1074)		while(true){
HXLINE(1075)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE(1077)					HX_VARI( ::String,name) = tk->_hx_getString(0);
...
HX_DEFINE_DYNAMIC_FUNC0(Parser_obj,parseParams,return )
 ...
 ::hscript::ModuleDecl Parser_obj::parseModuleDecl(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1093)
HXLINE(1094)		HX_VARI( ::Array< ::Dynamic>,meta) = this->parseMetadata();
HXLINE(1095)		HX_VARI( ::String,ident) = this->getIdent();
HXLINE(1096)		HX_VARI( bool,isPrivate) = false;
HXDLIN(1096)		HX_VARI( bool,isExtern) = false;
...
HXLINE(1135)			HX_VARI( ::String,name) = this->getIdent();
HXLINE(1136)			HX_VARI(  ::Dynamic,params) = this->parseParams();
HXLINE(1137)			HX_VARI(  ::hscript::CType,extend) = null();
HXLINE(1138)			HX_VARI( ::Array< ::Dynamic>,implement) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1140)			while(true){
HXLINE(1141)				HX_VARI(  ::hscript::Token,t) = this->token();
...
HXLINE(1149)						goto _hx_goto_83;
            			...
            			_hx_goto_83:;
HXLINE(1153)			HX_VARI( ::Array< ::Dynamic>,fields) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1154)			{
...
HXLINE(1114)			HX_VARI( ::Array< ::String >,path) = ::Array_obj< ::String >::__new(1)->init(0,this->getIdent());
HXLINE(1115)			HX_VARI( bool,star) = false;
HXLINE(1116)			while(true){
HXLINE(1117)				HX_VARI_NAME(  ::hscript::Token,t2,"t") = this->token();
...
HXLINE(1123)					switch((int)(t2->_hx_getIndex())){
            						case (int)2: {
HXLINE(1124)							HX_VARI( ::String,id) = t2->_hx_getString(0);
...
HXLINE(1110)			HX_VARI_NAME( ::Array< ::String >,path1,"path") = this->parsePath();
HXLINE(1111)			{
...
HXLINE(1169)			HX_VARI_NAME( ::String,name1,"name") = this->getIdent();
HXLINE(1170)			HX_VARI_NAME(  ::Dynamic,params1,"params") = this->parseParams();
HXLINE(1171)			{
...
HXLINE(1172)			HX_VARI_NAME(  ::hscript::CType,t6,"t") = this->parseType();
...
HX_DEFINE_DYNAMIC_FUNC0(Parser_obj,parseModuleDecl,return )
 ...
 ::Dynamic Parser_obj::parseField(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1186)
HXLINE(1187)		HX_VARI( ::Array< ::Dynamic>,meta) = this->parseMetadata();
HXLINE(1188)		HX_VARI( ::Array< ::Dynamic>,access) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1189)		while(true){
HXLINE(1190)			HX_VARI( ::String,id) = this->getIdent();
HXLINE(1191)			::String _hx_switch_0 = id;
            			if (  (_hx_switch_0==HX_("function",18,ab,52,14)) ){
HXLINE(1205)				HX_VARI( ::String,name) = this->getIdent();
HXLINE(1206)				HX_VARI(  ::Dynamic,inf) = this->parseFunctionDecl();
...
HXDLIN(1201)				goto _hx_goto_89;
            			...
            			if (  (_hx_switch_0==HX_("var",e7,de,59,00)) ){
HXLINE(1218)				HX_VARI_NAME( ::String,name1,"name") = this->getIdent();
HXLINE(1219)				HX_VARI( ::String,get) = null();
HXDLIN(1219)				HX_VARI( ::String,set) = null();
...
HXLINE(1226)				HX_VAR(  ::hscript::CType,type);
...
HXLINE(1227)				HX_VAR(  ::hscript::Expr,expr);
...
HXLINE(1264)
HXLINE(1265)		HX_VARI( int,c) = 0;
HXLINE(1266)		HX_VARI(  ::StringBuf,b) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE(1267)		HX_VARI( bool,esc) = false;
HXLINE(1268)		HX_VARI( int,old) = this->line;
HXLINE(1269)		HX_VARI( ::String,s) = this->input;
HXLINE(1273)		while(true){
HXLINE(1274)			HX_VARI_NAME( int,c1,"c") = this->input.cca(this->readPos++);
HXLINE(1275)			if ((c1 == 0)) {
...
HXLINE(1290)						HX_VARI( int,k) = 0;
HXLINE(1291)						{
HXLINE(1291)							int _g = 0;
HXDLIN(1291)							while((_g < 4)){
HXLINE(1291)								_g = (_g + 1);
HXDLIN(1291)								HX_VARI( int,i) = (_g - 1);
HXLINE(1292)								k = (k << 4);
HXLINE(1293)								HX_VARI_NAME( int,_hx_char,"char") = this->input.cca(this->readPos++);
...
HXLINE(1345)		HX_VAR_NAME( int,_hx_char,"char");
...
HXLINE(1514)						HX_VARI( ::String,id) = ::String::fromCharCode(_hx_char);
...
HXLINE(1477)							return ::hscript::Token_obj::TOp(HX_("...",ee,0f,23,00));
            						...
            						break;
            						case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1460)							HX_VARI( int,n) = (_hx_char - 48);
HXLINE(1461)							HX_VARI( int,exp) = 1;
...
HXLINE(1480)							return ::hscript::Token_obj::TDot_dyn();
            				...
            				break;
            				case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1369)					HX_VARI_NAME( Float,n1,"n") = (( (Float)((_hx_char - 48)) ) * ((Float)1.0));
HXLINE(1370)					HX_VARI_NAME( Float,exp1,"exp") = ((Float)0.);
...
HXLINE(1399)										HX_VARI( int,i) = ::Std_obj::_hx_int(n1);
...
HXLINE(1378)								HX_VARI(  ::hscript::Token,tk) = this->token();
HXLINE(1379)								HX_VARI(  ::Dynamic,pow) = null();
...
HXLINE(1381)												HX_VARI( int,e) = _g->_hx_getInt(0);
HXDLIN(1381)												pow = e;
            											}
            											else {
...
HXLINE(1385)															HX_VARI_NAME( int,e1,"e") = _g1->_hx_getInt(0);
HXDLIN(1385)															pow = -(e1);
            														}
            														else {
...
HXLINE(1410)								HX_VARI_NAME( int,n2,"n") = 0;
...
HXLINE(1448)								HX_VARI_NAME( int,i1,"i") = ::Std_obj::_hx_int(n1);
...
HXLINE(1500)						HX_VARI_NAME( ::String,id1,"id") = ::String::fromCharCode(_hx_char);
...
HXLINE(1527)						HX_VARI( ::String,op) = ::String::fromCharCode(_hx_char);
...
HXLINE(1535)							HX_VARI( ::String,pop) = op;
...
HXLINE(1546)						HX_VARI_NAME( ::String,id2,"id") = ::String::fromCharCode(_hx_char);
...
HX_DEFINE_DYNAMIC_FUNC1(Parser_obj,preprocValue,return )
 ...
 ::hscript::Expr Parser_obj::parsePreproCond(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1570)
HXLINE(1571)		HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE(1572)			switch((int)(tk->_hx_getIndex())){
            				case (int)2: {
HXLINE(1576)					HX_VARI( ::String,id) = tk->_hx_getString(0);
...
HXDLIN(1586)		switch((int)(e->_hx_getIndex())){
            			case (int)1: {
HXLINE(1587)				HX_VARI( ::String,id) = e->_hx_getString(0);
HXLINE(1588)				return ::hx::IsNotNull( this->preprocValue(id) );
            			}
            			break;
            			case (int)3: {
HXLINE(1591)				HX_VARI_NAME(  ::hscript::Expr,e1,"e") = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE(1593)					HX_VARI_NAME(  ::hscript::Expr,e11,"e1") = _g;
HXDLIN(1593)					HX_VARI(  ::hscript::Expr,e2) = _g1;
...
HXLINE(1595)					HX_VARI_NAME(  ::hscript::Expr,e12,"e1") = _g;
HXDLIN(1595)					HX_VARI_NAME(  ::hscript::Expr,e21,"e2") = _g1;
...
HXLINE(1589)					HX_VARI_NAME(  ::hscript::Expr,e3,"e") = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE(1628)			goto _hx_goto_108;
            		...
            		if (  (_hx_switch_0==HX_("if",dd,5b,00,00)) ){
HXLINE(1606)			HX_VARI(  ::hscript::Expr,e) = this->parsePreproCond();
...
void Parser_obj::skipTokens(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1636)
HXLINE(1637)		HX_VARI( int,spos) = (this->preprocStack->length - 1);
HXLINE(1638)		HX_VARI(  ::Dynamic,obj) = this->preprocStack->__get(spos);
HXLINE(1639)		HX_VARI( int,pos) = this->readPos;
HXLINE(1640)		while(true){
HXLINE(1641)			HX_VARI(  ::hscript::Token,tk) = this->token();
...
HXLINE(1651)
HXLINE(1652)		HX_VARI(  ::Dynamic,c) = op.charCodeAt(1);
HXLINE(1653)		HX_VARI( ::String,s) = this->input;
...
HXLINE(1663)			HX_VARI( int,old) = this->line;
...
HXDLIN(1694)		switch((int)(c->_hx_getIndex())){
            			case (int)0: {
HXLINE(1695)				HX_VARI( int,v) = c->_hx_getInt(0);
HXDLIN(1695)				return ::Std_obj::string(v);
            			}
            			break;
            			case (int)1: {
HXLINE(1696)				HX_VARI( Float,f) = c->_hx_getFloat(0);
HXDLIN(1696)				return ::Std_obj::string(f);
            			}
            			break;
            			case (int)2: {
HXLINE(1697)				HX_VARI( ::String,s) = c->_hx_getString(0);
...
HXLINE(1706)				return HX_("<eof>",3e,ee,21,cf);
            			...
            			break;
            			case (int)1: {
HXLINE(1707)				HX_VARI(  ::hscript::Const,c) = t->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXDLIN(1707)				return this->constString(c);
            			}
            			break;
            			case (int)2: {
HXLINE(1708)				HX_VARI( ::String,s) = t->_hx_getString(0);
HXDLIN(1708)				return s;
            			}
            			break;
            			case (int)3: {
HXLINE(1709)				HX_VARI_NAME( ::String,s1,"s") = t->_hx_getString(0);
...
HXLINE(1720)				return HX_(":",3a,00,00,00);
            			...
            			break;
            			case (int)15: {
HXLINE(1721)				HX_VARI( ::String,id) = t->_hx_getString(0);
HXDLIN(1721)				return (HX_("@",40,00,00,00) + id);
            			}
            			break;
            			case (int)16: {
HXLINE(1722)				HX_VARI_NAME( ::String,id1,"id") = t->_hx_getString(0);

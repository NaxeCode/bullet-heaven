...
bool TextFormat_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::text::TextFormat TextFormat_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 276)
HXLINE( 277)		HX_VARI(  ::openfl::text::TextFormat,newFormat) =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,this->font,this->size,this->color,this->bold,this->italic,this->underline,this->url,this->target,null(),null(),null(),null(),null());

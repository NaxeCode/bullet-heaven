...
void StyleSheet_obj::parseCSS(::String CSSText){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(CSSText,"CSSText")
HXLINE( 113)
HXLINE( 114)		 ::haxe::ds::StringMap _g =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXDLIN( 114)		_g->set(HX_("silent",95,76,cd,b7),true);
HXDLIN( 114)		HX_VARI(  ::openfl::text::_internal::CSSParser,parser) =  ::openfl::text::_internal::CSSParser_obj::__alloc( HX_CTX ,_g);
HXLINE( 115)		HX_VARI(  ::haxe::ds::StringMap,ast) = parser->parse(CSSText);
HXLINE( 116)		if (::hx::IsNotNull( ast )) {
HXLINE( 118)			HX_VARI( ::Array< ::Dynamic>,rules) = ( (::Array< ::Dynamic>)(ast->get(HX_("rules",f7,63,56,f1))) );
HXLINE( 119)			{
HXLINE( 119)				int _g1 = 0;
HXDLIN( 119)				while((_g1 < rules->length)){
HXLINE( 119)					HX_VARI(  ::haxe::ds::StringMap,rule) = rules->__get(_g1).StaticCast<  ::haxe::ds::StringMap >();
HXDLIN( 119)					_g1 = (_g1 + 1);
HXLINE( 121)					HX_VAR( ::String,styleName);
...
HXLINE( 131)						HX_VARI(  ::Dynamic,object) = this->_hx___styles->get(styleName);
HXLINE( 132)						HX_VARI( ::Array< ::Dynamic>,declarations) = ( (::Array< ::Dynamic>)(rule->get(HX_("declarations",39,36,ad,ea))) );
HXLINE( 133)						if (::hx::IsNotNull( declarations )) {
HXLINE( 135)							int _g2 = 0;
HXDLIN( 135)							while((_g2 < declarations->length)){
HXLINE( 135)								HX_VARI(  ::haxe::ds::StringMap,declaration) = declarations->__get(_g2).StaticCast<  ::haxe::ds::StringMap >();
HXDLIN( 135)								_g2 = (_g2 + 1);
HXLINE( 137)								HX_VARI( ::String,property) = declaration->get_string(HX_("property",55,48,38,ac));
HXLINE( 138)								HX_VARI( ::String,value) = ::Std_obj::string(declaration->get_string(HX_("value",71,7f,b8,31)));
...
void StyleSheet_obj::setStyle(::String styleName, ::Dynamic styleObject){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(styleName,"styleName")
            	HX_STACK_ARG(styleObject,"styleObject")
HXLINE( 187)
...
HXLINE( 198)			HX_VARI(  ::Dynamic,object) =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE( 199)			{
HXLINE( 199)				int _g = 0;
HXDLIN( 199)				::Array< ::String > _g1 = ::Reflect_obj::fields(styleObject);
HXDLIN( 199)				while((_g < _g1->length)){
HXLINE( 199)					HX_VARI( ::String,field) = _g1->__get(_g);
HXDLIN( 199)					_g = (_g + 1);
...
HX_DEFINE_DYNAMIC_FUNC2(StyleSheet_obj,setStyle,(void))
 ...
 ::openfl::text::TextFormat StyleSheet_obj::transform( ::Dynamic formatObject){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(formatObject,"formatObject")
HXLINE( 215)
HXLINE( 216)		HX_VARI(  ::openfl::text::TextFormat,format) =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE( 226)			HX_VARI(  ::Dynamic,style) = this->_hx___styles->get(styleName);
...
HXLINE( 235)			HX_VARI(  ::EReg,hex) =  ::EReg_obj::__alloc( HX_CTX ,HX_("[0-9A-Fa-f]+",cf,38,92,17),HX_("",00,00,00,00));
HXLINE( 236)			HX_VARI(  ::EReg,numeric) =  ::EReg_obj::__alloc( HX_CTX ,HX_("[0-9]+",8f,d9,9f,23),HX_("",00,00,00,00));
...
HXLINE( 357)			{
HXLINE( 357)				HX_VARI(  ::Dynamic,style) = this->_hx___styles->keys();
HXDLIN( 357)				while(( (bool)(style->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 357)					HX_VARI_NAME( ::String,style1,"style") = ( (::String)(style->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );

...
HXLINE(  82)			HX_VARI( ::Array< ::Dynamic>,_allFonts) = ::openfl::text::Font_obj::_hx___registeredFonts->copy();
HXLINE(  83)			HX_VARI( ::Array< ::String >,files) = ::sys::FileSystem_obj::readDirectory(::lime::_hx_system::System_obj::get_fontsDirectory());
HXLINE(  84)			{
HXLINE(  84)				int _g = 0;
HXDLIN(  84)				while((_g < files->length)){
HXLINE(  84)					HX_VARI( ::String,file) = files->__get(_g);
HXDLIN(  84)					_g = (_g + 1);
...
HXLINE( 119)
HXLINE( 120)		HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
...
HXLINE( 143)		HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
...
HXLINE( 180)
HXLINE( 181)			HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
 ...
 ::lime::app::Future Font_obj::loadFromFile(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::text::Font limeFont){
            			...
            			HX_STACK_ARG(limeFont,"limeFont")
HXLINE( 204)
HXLINE( 205)			HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
 ...
 ::lime::app::Future Font_obj::loadFromName(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::text::Font limeFont){
            			...
            			HX_STACK_ARG(limeFont,"limeFont")
HXLINE( 230)
HXLINE( 231)			HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
...
void Font_obj::registerFont( ::Dynamic font){
            	...
            	HX_STACK_ARG(font,"font")
HXLINE( 246)
HXLINE( 247)		HX_VARI(  ::openfl::text::Font,instance) = null();

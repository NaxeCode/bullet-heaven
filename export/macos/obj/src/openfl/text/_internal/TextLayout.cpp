...
HXLINE( 158)			HX_VARI( ::Array< ::Dynamic>,_info) = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphInfo(this->_hx___hbBuffer);
HXLINE( 159)			HX_VARI( ::Array< ::Dynamic>,_positions) = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphPositions(this->_hx___hbBuffer);
...
HXLINE( 163)				HX_VAR(  ::lime::text::harfbuzz::HBGlyphInfo,info);
HXDLIN( 163)				HX_VAR(  ::lime::text::harfbuzz::HBGlyphPosition,position);
HXLINE( 164)				HX_VARI( int,lastCluster) = -1;
HXLINE( 166)				HX_VARI( int,length) = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(_info->length) ),( (Float)(_positions->length) )));
HXLINE( 168)				{
HXLINE( 168)					int _g = 0;
HXDLIN( 168)					int _g1 = length;
HXDLIN( 168)					while((_g < _g1)){
HXLINE( 168)						_g = (_g + 1);
HXDLIN( 168)						HX_VARI( int,i) = (_g - 1);
...
HXDLIN( 173)								HX_VARI( int,j) = (_g2 - 1);
...
::Array< int > TextLayout_obj::get_glyphs(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 228)
HXLINE( 229)		HX_VARI( ::Array< int >,glyphs) = ::Array_obj< int >::__new(0);
HXLINE( 231)		{
HXLINE( 231)			int _g = 0;
HXDLIN( 231)			::Array< ::Dynamic> _g1 = this->get_positions();
HXDLIN( 231)			while((_g < _g1->length)){
HXLINE( 231)				HX_VARI(  ::openfl::text::_internal::GlyphPosition,position) = _g1->__get(_g).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN( 231)				_g = (_g + 1);

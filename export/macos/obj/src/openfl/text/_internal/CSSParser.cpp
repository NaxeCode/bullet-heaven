...
HXLINE(  35)
HXLINE(  36)		HX_VARI(  ::EReg,regex) =  ::EReg_obj::__alloc( HX_CTX ,this->commentRegex,HX_("ig",de,5b,00,00));
...
HXLINE(  48)
HXLINE(  50)		HX_VARI(  ::EReg,rulesReg) =  ::EReg_obj::__alloc( HX_CTX ,HX_("(\\*?[-#/\\*\\\\\\w]+(\\[[0-9a-z_-]+\\])?)+((?:'(?:\\\\'|.)*?'|\"(?:\\\\\"|.)*?\"|\\([^\\)]*?\\)|[^};])+)",53,76,86,d6),HX_("g",67,00,00,00));
HXLINE(  51)		HX_VARI( ::Array< ::String >,arr) = this->getMatches(rulesReg,rules,null());
HXLINE(  52)		HX_VARI( ::Array< ::Dynamic>,ret) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  53)		{
HXLINE(  53)			int _g = 0;
HXDLIN(  53)			int _g1 = arr->length;
HXDLIN(  53)			while((_g < _g1)){
HXLINE(  53)				_g = (_g + 1);
HXDLIN(  53)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(  71)				HX_VARI( ::String,line) = rules;
HXLINE(  74)				line = ::StringTools_obj::trim(line);
HXLINE(  75)				if ((line.indexOf(HX_(":",3a,00,00,00),null()) != -1)) {
HXLINE(  80)					HX_VARI( ::String,directive) = ::StringTools_obj::trim(line.split(HX_(":",3a,00,00,00))->__get(0));
HXLINE(  82)					HX_VARI( ::String,value) = ::StringTools_obj::trim(line.split(HX_(":",3a,00,00,00))->__get(1));
...
HXLINE( 100)						HX_VARI( ::String,_line) = (line + ::StringTools_obj::trim(line));
...
HX_DEFINE_DYNAMIC_FUNC1(CSSParser_obj,parseRules,return )
 ...
 ::haxe::ds::StringMap CSSParser_obj::findCorrespondingRule(::Array< ::Dynamic> rules,::String directive, ::Dynamic value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(rules,"rules")
            	HX_STACK_ARG(directive,"directive")
            	HX_STACK_ARG(value,"value")
HXLINE( 122)
HXLINE( 123)		HX_VARI(  ::haxe::ds::StringMap,ret) = null();
HXLINE( 124)		{
HXLINE( 124)			int _g = 0;
...
::Array< ::Dynamic> CSSParser_obj::findBySelector(::Array< ::Dynamic> objectArray,::String selector,::hx::Null< bool >  __o_contains){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(objectArray,"objectArray")
            	HX_STACK_ARG(selector,"selector")
            	HX_STACK_ARG(contains,"contains")
HXLINE( 144)
HXLINE( 145)		HX_VARI( ::Array< ::Dynamic>,found) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 147)		{
HXLINE( 147)			int _g = 0;
HXDLIN( 147)			int _g1 = objectArray->length;
HXDLIN( 147)			while((_g < _g1)){
HXLINE( 147)				_g = (_g + 1);
HXDLIN( 147)				HX_VARI( int,i) = (_g - 1);
...
HXLINE( 171)			HX_VARI(  ::haxe::ds::StringMap,base) = found->__get(0).StaticCast<  ::haxe::ds::StringMap >();
HXLINE( 172)			{
HXLINE( 172)				int _g2 = 0;
HXDLIN( 172)				int _g3 = found->length;
HXDLIN( 172)				while((_g2 < _g3)){
HXLINE( 172)					_g2 = (_g2 + 1);
HXDLIN( 172)					HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
::Array< ::Dynamic> CSSParser_obj::deleteBySelector(::Array< ::Dynamic> objectArray,::String selector){
            	...
            	HX_STACK_ARG(selector,"selector")
HXLINE( 185)
HXLINE( 186)		HX_VARI( ::Array< ::Dynamic>,ret) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 187)		{
HXLINE( 187)			int _g = 0;
HXDLIN( 187)			int _g1 = objectArray->length;
HXDLIN( 187)			while((_g < _g1)){
HXLINE( 187)				_g = (_g + 1);
HXDLIN( 187)				HX_VARI( int,i) = (_g - 1);
...
::Array< ::Dynamic> CSSParser_obj::compress(::Array< ::Dynamic> objectArray){
            	...
            	HX_STACK_ARG(objectArray,"objectArray")
HXLINE( 202)
HXLINE( 203)		HX_VARI( ::Array< ::Dynamic>,compressed) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 204)		HX_VARI(  ::haxe::ds::StringMap,done) =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 206)		{
HXLINE( 206)			int _g = 0;
HXDLIN( 206)			int _g1 = objectArray->length;
HXDLIN( 206)			while((_g < _g1)){
HXLINE( 206)				_g = (_g + 1);
HXDLIN( 206)				HX_VARI( int,i) = (_g - 1);
HXLINE( 208)				HX_VARI(  ::haxe::ds::StringMap,obj) = objectArray->__get(i).StaticCast<  ::haxe::ds::StringMap >();
HXLINE( 210)				if (::hx::IsEq( done->get(obj->get(HX_("selector",1f,33,6d,b1))),true )) {
HXLINE( 212)					continue;
            				}
HXLINE( 215)				HX_VARI( ::Array< ::Dynamic>,found) = this->findBySelector(objectArray,obj->get_string(HX_("selector",1f,33,6d,b1)),null());
...
HXDLIN( 254)		HX_VARI(  ::haxe::ds::StringMap,diff) = _g;
HXLINE( 259)		HX_VARI(  ::haxe::ds::StringMap,rule1) =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 260)		HX_VARI(  ::haxe::ds::StringMap,rule2) =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 262)		HX_VARI( int,_length) = ::hx::TCast< ::cpp::VirtualArray >::cast(object1->get(HX_("rules",f7,63,56,f1)))->get_length();
HXLINE( 263)		HX_VARI( int,_length2) = ::hx::TCast< ::cpp::VirtualArray >::cast(object2->get(HX_("rules",f7,63,56,f1)))->get_length();
HXLINE( 265)		{
HXLINE( 265)			int _g1 = 0;
HXDLIN( 265)			int _g2 = _length;
HXDLIN( 265)			while((_g1 < _g2)){
HXLINE( 265)				_g1 = (_g1 + 1);
HXDLIN( 265)				HX_VARI( int,i) = (_g1 - 1);
...
HXDLIN( 288)				HX_VARI_NAME( int,i1,"i") = (_g3 - 1);
...
void CSSParser_obj::intelligentMerge(::Array< ::Dynamic> objectArray,::Array< ::Dynamic> newArray,::hx::Null< bool >  __o_reverse){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(objectArray,"objectArray")
            	HX_STACK_ARG(newArray,"newArray")
...
HXDLIN( 323)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 325)				HX_VARI(  ::haxe::ds::StringMap,cobj) = objectArray->__get(i1).StaticCast<  ::haxe::ds::StringMap >();
...
void CSSParser_obj::intelligentCSSPush(::Array< ::Dynamic> objectArray, ::haxe::ds::StringMap minimalObject,::hx::Null< bool >  __o_reverse){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(objectArray,"objectArray")
            	HX_STACK_ARG(minimalObject,"minimalObject")
            	HX_STACK_ARG(reverse,"reverse")
HXLINE( 343)
HXLINE( 344)		HX_VARI(  ::Dynamic,pushSelector) = minimalObject->get(HX_("selector",1f,33,6d,b1));
HXLINE( 346)		HX_VARI(  ::haxe::ds::StringMap,cssObject) = null();
HXLINE( 347)		if ((reverse == false)) {
HXLINE( 349)			int _g = 0;
HXDLIN( 349)			int _g1 = objectArray->length;
HXDLIN( 349)			while((_g < _g1)){
HXLINE( 349)				_g = (_g + 1);
HXDLIN( 349)				HX_VARI( int,i) = (_g - 1);
...
HXLINE( 360)			HX_VARI( int,j) = (objectArray->length - 1);
...
HXLINE( 379)				HX_VARI( ::Array< ::Dynamic>,mRules) = ( (::Array< ::Dynamic>)(minimalObject->get(HX_("rules",f7,63,56,f1))) );
HXLINE( 380)				{
HXLINE( 380)					int _g2 = 0;
HXDLIN( 380)					int _g3 = mRules->length;
HXDLIN( 380)					while((_g2 < _g3)){
HXLINE( 380)						_g2 = (_g2 + 1);
HXDLIN( 380)						HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 382)						HX_VARI(  ::haxe::ds::StringMap,rule) = mRules->__get(i1).StaticCast<  ::haxe::ds::StringMap >();
HXLINE( 384)						 ::Dynamic oldRule = cssObject->get(HX_("rules",f7,63,56,f1));
HXDLIN( 384)						HX_VARI_NAME(  ::haxe::ds::StringMap,oldRule1,"oldRule") = this->findCorrespondingRule(( (::Array< ::Dynamic>)(oldRule) ),rule->get_string(HX_("directive",4f,68,40,10)),null());
HXLINE( 385)						if (::hx::IsNull( oldRule1 )) {
HXLINE( 387)							HX_VARI( ::Array< ::Dynamic>,cRules) = ( (::Array< ::Dynamic>)(cssObject->get(HX_("rules",f7,63,56,f1))) );
...
::Array< ::Dynamic> CSSParser_obj::compactRules(::Array< ::Dynamic> rules){
            	...
            	HX_STACK_ARG(rules,"rules")
HXLINE( 416)
HXLINE( 417)		HX_VARI( ::Array< ::Dynamic>,newRules) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 418)		{
HXLINE( 418)			int _g = 0;
...
::cpp::VirtualArray CSSParser_obj::getImports(::Array< ::Dynamic> objectArray){
            	...
            	HX_STACK_ARG(objectArray,"objectArray")
HXLINE( 434)
HXLINE( 435)		HX_VARI( ::cpp::VirtualArray,imps) = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 436)		{
HXLINE( 436)			int _g = 0;
...
HXLINE( 464)		HX_VARI( ::Array< ::Dynamic>,css) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 466)		HX_VARI( bool,m) = this->importRegex->match(source);
HXLINE( 467)		while(m){
HXLINE( 469)			HX_VARI( ::String,imports) = this->importRegex->matched(0);
...
HXLINE( 485)		HX_VARI(  ::EReg,keyframesRegex) =  ::EReg_obj::__alloc( HX_CTX ,this->keyframeRegex,HX_("gi",22,5a,00,00));
HXLINE( 487)		HX_VARI( ::Array< ::String >,arr) = null();
...
HXLINE( 506)		HX_VARI(  ::EReg,unified) =  ::EReg_obj::__alloc( HX_CTX ,this->combinedCSSRegex,HX_("gi",22,5a,00,00));
...
HXLINE( 516)			HX_VARI( ::String,selector) = HX_("",00,00,00,00);
HXLINE( 521)			{
HXLINE( 521)				int _g2 = 0;
HXDLIN( 521)				int _g3 = arr->length;
HXDLIN( 521)				while((_g2 < _g3)){
HXLINE( 521)					_g2 = (_g2 + 1);
HXDLIN( 521)					HX_VARI( int,i) = (_g2 - 1);
HXLINE( 523)					HX_VARI(  ::EReg,selReg) =  ::EReg_obj::__alloc( HX_CTX ,HX_("^([^{]+)",4d,c8,98,53),HX_("",00,00,00,00));
...
HXLINE( 539)						HX_VARI(  ::EReg,commentsRegex) =  ::EReg_obj::__alloc( HX_CTX ,this->commentRegex,HX_("gi",22,5a,00,00));
HXLINE( 540)						HX_VARI( ::Array< ::String >,comments) = this->getMatches(commentsRegex,selector,null());
...
HXDLIN( 556)							HX_VARI(  ::haxe::ds::StringMap,object) = _g4;
...
HXLINE( 574)								HX_VARI( ::Array< ::Dynamic>,rules) = this->parseRules(selReg->matchedRight());
...
HXDLIN( 576)								HX_VARI(  ::haxe::ds::StringMap,styleObject) = _g5;
...
HXDLIN( 600)		HX_VARI(  ::haxe::ds::StringMap,ret) = _g6;
...
HXLINE( 606)
HXLINE( 607)		HX_VARI( ::Array< ::String >,matches) = ::Array_obj< ::String >::__new(0);
HXLINE( 608)		while(ereg->match(input)){
HXLINE( 610)			HX_VARI( ::String,match) = ::StringTools_obj::trim(ereg->matched(index));

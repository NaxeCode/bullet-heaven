...
HXLINE(  47)
HXLINE(  48)			HX_VARI( ::String,decimalStr) = ereg->matched(1);
HXLINE(  49)			HX_VARI( ::String,hexStr) = ereg->matched(2);
HXLINE(  50)			if (::hx::IsNotNull( decimalStr )) {
HXLINE(  52)				HX_VARI(  ::Dynamic,decimal) = ::Std_obj::parseInt(decimalStr);
HXLINE(  53)				if (::hx::IsNotNull( decimal )) {
HXLINE(  55)					return ::String::fromCharCode(( (int)(decimal) ));
            				}
            			}
HXLINE(  58)			if (::hx::IsNotNull( hexStr )) {
HXLINE(  60)				HX_VARI(  ::Dynamic,hex) = ::Std_obj::parseInt((HX_("0",30,00,00,00) + hexStr));
...
HXLINE(  67)			return ereg->matched(0);
            	...
            	HX_STACK_ARG(multiline,"multiline")
            	HX_STACK_ARG(styleSheet,"styleSheet")
            	HX_STACK_ARG(textFormat,"textFormat")
            	HX_STACK_ARG(textFormatRanges,"textFormatRanges")
HXLINE(  34)
...
HXLINE(  72)		HX_VARI( ::Array< ::String >,segments) = value.split(HX_("<",3c,00,00,00));
...
HXLINE(  83)			HX_VARI(  ::openfl::text::_internal::TextFormatRange,range) = textFormatRanges->get(0).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
...
HXLINE(  97)			HX_VARI( ::Array< ::Dynamic>,formatStack) = ::Array_obj< ::Dynamic>::__new(1)->init(0,textFormat->clone());
HXLINE(  98)			HX_VARI( ::Array< ::String >,tagStack) = ::Array_obj< ::String >::__new(0);
HXLINE(  99)			HX_VAR( ::String,sub);
HXLINE( 100)			HX_VARI( bool,noLineBreak) = false;
HXLINE( 102)			{
HXLINE( 102)				int _g = 0;
HXDLIN( 102)				while((_g < segments->length)){
HXLINE( 102)					HX_VARI( ::String,segment) = segments->__get(_g);
HXDLIN( 102)					_g = (_g + 1);
HXLINE( 104)					if ((segment == HX_("",00,00,00,00))) {
HXLINE( 104)						continue;
            					}
HXLINE( 106)					HX_VARI( bool,isClosingTag) = (segment.substr(0,1) == HX_("/",2f,00,00,00));
HXLINE( 107)					HX_VARI( int,tagEndIndex) = segment.indexOf(HX_(">",3e,00,00,00),null());
HXLINE( 108)					HX_VARI( int,start) = (tagEndIndex + 1);
HXLINE( 109)					HX_VARI( int,spaceIndex) = segment.indexOf(HX_(" ",20,00,00,00),null());
...
HXDLIN( 110)					HX_VARI_NAME( ::String,tagName3,"tagName") = segment.substring(tagName,tagName1).toLowerCase();
HXLINE( 112)					HX_VAR(  ::openfl::text::TextFormat,format);
...
HXLINE( 214)									HX_VARI( ::String,sizeAttr) = ::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexSize);
HXLINE( 215)									HX_VARI(  ::Dynamic,firstChar) = sizeAttr.charCodeAt(0);
...
HXLINE( 219)										HX_VAR(  ::openfl::text::TextFormat,parentFormat);
...
HXLINE( 194)								HX_VARI( ::String,bullet) = HX_W(u"\u2022 ",e61c,95c3);
HXLINE( 196)								HX_VARI(  ::openfl::text::TextFormat,bulletFormat) = format->clone();
...
HXLINE( 185)									HX_VARI( ::String,align) = ::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexAlign).toLowerCase();
...
HXLINE( 265)									HX_VARI( ::Array< ::String >,values) = ::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexTabStops).split(HX_(" ",20,00,00,00));
HXLINE( 266)									HX_VARI( ::Array< ::Dynamic>,tabStops) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 268)									{
HXLINE( 268)										int _g1 = 0;
HXDLIN( 268)										while((_g1 < values->length)){
HXLINE( 268)											HX_VARI( ::String,stop) = values->__get(_g1);

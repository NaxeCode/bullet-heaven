...
HXLINE(  38)
HXLINE(  39)		HX_VARI( ::String,formatKey) = formatRange->format->_hx___cacheKey;
HXLINE(  41)		HX_VARI( ::String,wordKey) = getPositions->text;
...
HXLINE(  59)			HX_VARI(  ::haxe::ds::StringMap,formatMap) = ( ( ::haxe::ds::StringMap)(this->_hx___shortWordMap->get(formatKey)) );
...
HXLINE(  75)			HX_VARI_NAME(  ::haxe::ds::StringMap,formatMap1,"formatMap") =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
...
::Array< ::Dynamic> ShapeCache_obj::_hx___cacheLongWord(::String wordKey,::String formatKey, ::openfl::text::_internal::TextLayout getPositions){
            	...
            	HX_STACK_ARG(getPositions,"getPositions")
HXLINE(  91)
HXLINE(  92)		HX_VARI( int,hash) = ::openfl::text::_internal::ShapeCache_obj::hashFunction(wordKey);
HXLINE(  93)		if (this->_hx___longWordMap->exists(formatKey)) {
HXLINE(  95)			HX_VARI(  ::haxe::ds::IntMap,formatMap) = ( ( ::haxe::ds::IntMap)(this->_hx___longWordMap->get(formatKey)) );
HXLINE(  96)			if (formatMap->exists(hash)) {
HXLINE(  98)				HX_VARI(  ::openfl::text::_internal::CacheMeasurement,measurement) = ( ( ::openfl::text::_internal::CacheMeasurement)(formatMap->get(hash)) );
...
HXLINE( 110)				HX_VARI_NAME(  ::openfl::text::_internal::CacheMeasurement,measurement1,"measurement") =  ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions());
HXLINE( 111)				formatMap->set(hash,measurement1);
            			}
            		}
            		else {
HXLINE( 116)			HX_VARI_NAME(  ::haxe::ds::IntMap,formatMap1,"formatMap") =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 117)			HX_VARI_NAME(  ::openfl::text::_internal::CacheMeasurement,measurement2,"measurement") =  ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions());
...
HXLINE(  26)				_g = (_g + 1);
HXDLIN(  26)				HX_VARI_NAME( int,i1,"i") = (_g - 1);

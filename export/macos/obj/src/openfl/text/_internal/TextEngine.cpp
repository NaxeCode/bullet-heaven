...
HXLINE( 173)
HXLINE( 174)		HX_VARI(  ::EReg,declinedRange) =  ::EReg_obj::__alloc( HX_CTX ,HX_("\\^([^\\^]+)",d0,bc,3c,14),HX_("gu",2e,5a,00,00));
HXLINE( 175)		HX_VARI( ::Array< ::String >,declined) = ::Array_obj< ::String >::fromData( _hx_array_data_7e808804_3,1);
HXLINE( 177)		HX_VARI( ::Array< bool >,accepting) = ::Array_obj< bool >::fromData( _hx_array_data_7e808804_4,1);
HXLINE( 178)		HX_VARI( ::String,accepted) = declinedRange->map(restrict, ::Dynamic(new _hx_Closure_0(declined,accepting)));
HXLINE( 190)		HX_VARI( ::Array< ::String >,testRegexpParts) = ::Array_obj< ::String >::__new(0);
...
HXLINE( 274)		HX_VARI( Float,x) = this->width;
HXDLIN( 274)		HX_VARI( Float,y) = this->height;
HXLINE( 276)		HX_VARI( int,lastIndex) = (this->layoutGroups->get_length() - 1);
HXLINE( 277)		{
HXLINE( 277)			int _g = 0;
...
HXLINE( 279)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group) = this->layoutGroups->get(i).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXLINE( 576)		HX_VARI( int,index) = -1;
HXLINE( 578)		HX_VARI( int,cr) = -1;
HXDLIN( 578)		HX_VARI( int,lf) = -1;
...
HXLINE( 593)
HXLINE( 594)		{
HXLINE( 594)			HX_VARI(  ::Dynamic,lineBreak) = this->lineBreaks->iterator();
HXDLIN( 594)			while(( (bool)(lineBreak->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 594)				HX_VARI_NAME( int,lineBreak1,"lineBreak") = ( (int)(lineBreak->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 610)		HX_VARI( Float,currentLineAscent) = ((Float)0.0);
HXLINE( 611)		HX_VARI( Float,currentLineDescent) = ((Float)0.0);
HXLINE( 612)		HX_VARI(  ::Dynamic,currentLineLeading) = null();
HXLINE( 613)		HX_VARI( Float,currentLineHeight) = ((Float)0.0);
HXLINE( 614)		HX_VARI( Float,currentLineWidth) = ((Float)0.0);
HXLINE( 615)		HX_VARI( Float,currentTextHeight) = ((Float)0.0);
...
HXLINE( 622)		HX_VARI( int,lastIndex) = (this->layoutGroups->get_length() - 1);
HXLINE( 623)		{
HXLINE( 623)			int _g = 0;
HXDLIN( 623)			int _g1 = this->layoutGroups->get_length();
HXDLIN( 623)			while((_g < _g1)){
HXLINE( 623)				_g = (_g + 1);
HXDLIN( 623)				HX_VARI( int,i) = (_g - 1);
HXLINE( 625)				HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group) = this->layoutGroups->get(i).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
...
HXLINE( 680)			HX_VARI(  ::openfl::text::TextFormat,currentFormat) = this->textField->_hx___textFormat;
HXLINE( 681)			HX_VAR( Float,ascent);
HXDLIN( 681)			HX_VAR( Float,descent);
HXLINE( 683)			HX_VARI(  ::openfl::text::Font,font) = ::openfl::text::_internal::TextEngine_obj::getFontInstance(currentFormat);
...
HXLINE( 681)			HX_VARI(  ::Dynamic,leading) = currentFormat->leading;
HXDLIN( 681)			HX_VARI( int,heightValue) = ::Math_obj::ceil(((ascent + descent) + leading));
...
HXLINE( 767)		HX_VARI( int,rangeIndex) = -1;
HXLINE( 768)		HX_VARI(  ::openfl::text::_internal::TextFormatRange,formatRange) = null();
HXLINE( 769)		HX_VARI(  ::lime::text::Font,font) = null();
HXLINE( 771)		HX_VARI(  ::openfl::text::TextFormat,currentFormat) = ::openfl::text::TextField_obj::_hx___defaultTextFormat->clone();
HXLINE( 774)		HX_VARI( int,leading) = 0;
HXLINE( 775)		HX_VARI( Float,ascent) = ((Float)0.0);
HXDLIN( 775)		HX_VARI( Float,maxAscent) = ((Float)0.0);
HXLINE( 776)		HX_VARI( Float,descent) = ((Float)0.0);
HXLINE( 779)		HX_VARI(  ::Dynamic,align) = 3;
HXLINE( 780)		HX_VARI( int,blockIndent) = 0;
HXLINE( 781)		HX_VARI( bool,bullet) = false;
HXLINE( 782)		HX_VARI( int,indent) = 0;
HXLINE( 783)		HX_VARI( int,leftMargin) = 0;
HXLINE( 784)		HX_VARI( int,rightMargin) = 0;
HXLINE( 785)		HX_VARI( bool,firstLineOfParagraph) = true;
HXLINE( 787)		HX_VARI(  ::Dynamic,tabStops) = null();
HXLINE( 789)		HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,layoutGroup) = null();
HXDLIN( 789)		HX_VARI( ::Array< ::Dynamic>,positions) = null();
HXLINE( 790)		HX_VARI( Float,widthValue) = ((Float)0.0);
HXDLIN( 790)		HX_VARI( int,heightValue) = 0;
HXDLIN( 790)		HX_VARI( int,maxHeightValue) = 0;
HXLINE( 791)		HX_VARI( int,previousSpaceIndex) = -2;
HXLINE( 792)		HX_VARI( int,previousBreakIndex) = -1;
HXLINE( 793)		HX_VARI( int,spaceIndex) = this->text.indexOf(HX_(" ",20,00,00,00),null());
HXLINE( 794)		HX_VARI( int,breakCount) = 0;
HXLINE( 795)		HX_VAR( int,breakIndex);
...
HXLINE( 797)		HX_VARI( Float,offsetX) = ((Float)0.0);
HXLINE( 798)		HX_VARI( Float,offsetY) = ((Float)0.0);
HXLINE( 799)		HX_VARI( int,textIndex) = 0;
HXLINE( 800)		HX_VARI( int,lineIndex) = 0;
...
HXLINE(1360)		HX_VAR( bool,wrap);
HXLINE(1361)		HX_VARI( int,maxLoops) = (this->text.length + 1);
...
HXLINE(1420)						HX_VARI_NAME( int,endIndex2,"endIndex") = -1;
...
HXLINE(1450)								HX_VARI( Float,spaceWidth) = positions->shift().StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
...
HXLINE(1460)								HX_VARI_NAME( Float,spaceWidth1,"spaceWidth") = positions->pop().StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
...
HXLINE(1475)									HX_VARI(  ::openfl::text::_internal::GlyphPosition,lastPosition) = positions->__get((positions->length - 1)).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXLINE(1476)									HX_VARI_NAME( Float,spaceWidth2,"spaceWidth") = lastPosition->advance->x;
...
HXLINE(1490)								HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,previous) = layoutGroup;
...
HXLINE(1501)							HX_VARI_NAME( int,i3,"i") = (this->layoutGroups->get_length() - 1);
HXLINE(1502)							HX_VARI( int,offsetCount) = 0;
...
HXDLIN(1529)								HX_VARI( Float,bumpX) = ( ( ::openfl::_Vector::ObjectVector)(this2) )->get((this->layoutGroups->get_length() - offsetCount)).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >()->offsetX;
HXLINE(1531)								{
...
HXDLIN(1531)										HX_VARI_NAME( int,i5,"i") = (_g15 - 1);
...
HXLINE(1567)									HX_VAR_NAME( int,tempRangeEnd17,"tempRangeEnd");
...
HXLINE(1615)						HX_VARI( int,nextSpaceIndex) = this->text.indexOf(HX_(" ",20,00,00,00),textIndex);
...
void TextEngine_obj::setTextAlignment(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1716)
HXLINE(1717)		HX_VARI( int,lineIndex) = -1;
HXLINE(1718)		HX_VARI( Float,offsetX) = ((Float)0.0);
HXLINE(1719)		HX_VARI( Float,totalWidth) = (this->width - ( (Float)(4) ));
HXLINE(1720)		HX_VAR(  ::openfl::text::_internal::TextLayoutGroup,group);
HXDLIN(1720)		HX_VAR( int,lineLength);
HXLINE(1721)		HX_VARI( bool,lineMeasurementsDirty) = false;
HXLINE(1723)		{
HXLINE(1723)			int _g = 0;
HXDLIN(1723)			int _g1 = this->layoutGroups->get_length();
HXDLIN(1723)			while((_g < _g1)){
HXLINE(1723)				_g = (_g + 1);
HXDLIN(1723)				HX_VARI( int,i) = (_g - 1);
...
HXDLIN(1759)									HX_VARI( int,j) = (_g2 - 1);
...
HXLINE(1778)								HX_VARI(  ::Dynamic,endChar) = this->text.charCodeAt(group->endIndex);
...
HXLINE(1784)									HX_VARI_NAME( int,j1,"j") = 1;
HXLINE(1785)									do {
...
HXLINE(1877)			HX_VARI( int,ret) = this->lineHeights->get_length();
HXLINE(1879)			HX_VAR( Float,tempHeight);
...
HXDLIN(1881)					HX_VARI( int,i) = (_g1 - 1);
HXLINE(1883)					HX_VARI( Float,lineHeight) = this->lineHeights->get(i);
...
HXLINE(1924)			HX_VARI( int,i) = (this->numLines - 1);
HXDLIN(1924)			HX_VARI( Float,tempHeight) = ((Float)0.0);
HXLINE(1925)			HX_VARI( int,j) = i;
...
HXLINE(1983)		HX_VARI( int,max) = this->get_maxScrollV();
...
HXLINE( 210)				HX_VARI(  ::openfl::text::Font,registeredFont) = _g1->__get(_g).StaticCast<  ::openfl::text::Font >();
HXDLIN( 210)				_g = (_g + 1);
...
HXLINE( 229)		HX_VARI(  ::openfl::text::Font,font) = ::openfl::text::Font_obj::fromFile(name);
...
HXLINE( 243)
HXLINE( 244)		HX_VARI( ::String,fontName) = format->font;
HXLINE( 245)		HX_VARI(  ::Dynamic,bold) = format->bold;
HXLINE( 246)		HX_VARI(  ::Dynamic,italic) = format->italic;
HXLINE( 248)		if (::hx::IsNull( fontName )) {
HXLINE( 248)			fontName = HX_("_serif",be,66,15,76);
            		}
HXLINE( 249)		HX_VARI( ::String,fontNamePrefix) = ::StringTools_obj::replace(::StringTools_obj::replace(fontName,HX_(" Normal",67,be,ac,97),HX_("",00,00,00,00)),HX_(" Regular",1c,be,27,76),HX_("",00,00,00,00));
...
HXLINE( 309)
HXLINE( 310)				HX_VARI(  ::openfl::text::Font,font) = null();
HXLINE( 311)				{
HXLINE( 311)					int _g = 0;
HXDLIN( 311)					while((_g < list->length)){
HXLINE( 311)						HX_VARI( ::String,path) = list->__get(_g);
HXDLIN( 311)						_g = (_g + 1);
...
HXLINE( 306)			HX_VARI( ::String,systemFontDirectory) = ::lime::_hx_system::System_obj::get_fontsDirectory();
HXLINE( 308)			HX_VARI(  ::Dynamic,processFontList) =  ::Dynamic(new _hx_Closure_0());
HXLINE( 332)			HX_VARI(  ::openfl::text::Font,sans) = ( ( ::openfl::text::Font)(processFontList(::Array_obj< ::String >::__new(9)->init(0,(systemFontDirectory + HX_("/Arial.ttf",0c,14,61,7a)))->init(1,(systemFontDirectory + HX_("/Helvetica.ttf",5a,6c,ff,0c)))->init(2,(systemFontDirectory + HX_("/Cache/Arial.ttf",5f,69,b5,54)))->init(3,(systemFontDirectory + HX_("/Cache/Helvetica.ttf",2d,67,e4,7a)))->init(4,(systemFontDirectory + HX_("/Core/Arial.ttf",ba,c6,65,25)))->init(5,(systemFontDirectory + HX_("/Core/Helvetica.ttf",08,0e,fe,0c)))->init(6,(systemFontDirectory + HX_("/CoreAddition/Arial.ttf",d6,48,2f,75)))->init(7,(systemFontDirectory + HX_("/CoreAddition/Helvetica.ttf",24,ce,e8,ab)))->init(8,HX_("/System/Library/Fonts/Supplemental/Arial.ttf",40,75,29,52)))) );
HXLINE( 343)			HX_VARI(  ::openfl::text::Font,sansBold) = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Arial Bold.ttf",f5,90,42,25));
HXLINE( 344)			HX_VARI(  ::openfl::text::Font,sansItalic) = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Arial Italic.ttf",e0,1d,06,bf));
HXLINE( 345)			HX_VARI(  ::openfl::text::Font,sansBoldItalic) = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Arial Bold Italic.ttf",cb,12,c1,33));
HXLINE( 347)			{
HXLINE( 347)				::Dynamic this1 = ::openfl::text::_internal::TextEngine_obj::_hx___defaultFonts;
HXDLIN( 347)				( ( ::haxe::ds::StringMap)(this1) )->set(HX_("_sans",32,a0,5e,ff), ::openfl::text::_internal::_TextEngine::DefaultFontSet_obj::__alloc( HX_CTX ,sans,sansBold,sansItalic,sansBoldItalic));
            			}
HXLINE( 349)			HX_VARI(  ::openfl::text::Font,serif) = ( ( ::openfl::text::Font)(processFontList(::Array_obj< ::String >::__new(13)->init(0,(systemFontDirectory + HX_("/Georgia.ttf",67,ae,93,4b)))->init(1,(systemFontDirectory + HX_("/Times.ttf",0f,38,17,67)))->init(2,(systemFontDirectory + HX_("/Times New Roman.ttf",2c,b8,6d,0c)))->init(3,(systemFontDirectory + HX_("/Cache/Georgia.ttf",7a,3e,a6,a3)))->init(4,(systemFontDirectory + HX_("/Cache/Times.ttf",62,8d,6b,41)))->init(5,(systemFontDirectory + HX_("/Cache/Times New Roman.ttf",3f,13,7b,39)))->init(6,(systemFontDirectory + HX_("/Core/Georgia.ttf",95,e8,2c,47)))->init(7,(systemFontDirectory + HX_("/Core/Times.ttf",bd,ea,1b,12)))->init(8,(systemFontDirectory + HX_("/Core/Times New Roman.ttf",5a,d0,31,62)))->init(9,(systemFontDirectory + HX_("/CoreAddition/Georgia.ttf",b1,29,f0,3d)))->init(10,(systemFontDirectory + HX_("/CoreAddition/Times.ttf",d9,6c,e5,61)))->init(11,(systemFontDirectory + HX_("/CoreAddition/Times New Roman.ttf",76,8d,05,b2)))->init(12,HX_("/System/Library/Fonts/Supplemental/Times New Roman.ttf",60,22,07,e2)))) );
HXLINE( 364)			HX_VARI(  ::openfl::text::Font,serifBold) = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Times New Roman Bold.ttf",d5,4f,1d,7d));
HXLINE( 365)			HX_VARI(  ::openfl::text::Font,serifItalic) = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Times New Roman Italic.ttf",c0,54,36,d2));
HXLINE( 366)			HX_VARI(  ::openfl::text::Font,serifBoldItalic) = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Times New Roman Bold Italic.ttf",eb,ef,fd,67));
HXLINE( 368)			{
HXLINE( 368)				::Dynamic this2 = ::openfl::text::_internal::TextEngine_obj::_hx___defaultFonts;
HXDLIN( 368)				( ( ::haxe::ds::StringMap)(this2) )->set(HX_("_serif",be,66,15,76), ::openfl::text::_internal::_TextEngine::DefaultFontSet_obj::__alloc( HX_CTX ,serif,serifBold,serifItalic,serifBoldItalic));
            			}
HXLINE( 370)			HX_VARI(  ::openfl::text::Font,typewriter) = ( ( ::openfl::text::Font)(processFontList(::Array_obj< ::String >::__new(9)->init(0,(systemFontDirectory + HX_("/Courier New.ttf",d6,e1,80,a0)))->init(1,(systemFontDirectory + HX_("/Courier.ttf",b6,7e,38,40)))->init(2,(systemFontDirectory + HX_("/Cache/Courier New.ttf",69,77,b8,0d)))->init(3,(systemFontDirectory + HX_("/Cache/Courier.ttf",c9,0e,4b,98)))->init(4,(systemFontDirectory + HX_("/Core/Courier New.ttf",04,cb,ad,96)))->init(5,(systemFontDirectory + HX_("/Core/Courier.ttf",e4,b8,d1,3b)))->init(6,(systemFontDirectory + HX_("/CoreAddition/Courier New.ttf",20,ca,dd,d5)))->init(7,(systemFontDirectory + HX_("/CoreAddition/Courier.ttf",00,fa,94,32)))->init(8,HX_("/System/Library/Fonts/Supplemental/Courier New.ttf",0a,22,a4,92)))) );
HXLINE( 381)			HX_VARI(  ::openfl::text::Font,typewriterBold) = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Courier New Bold.ttf",eb,47,af,10));
HXLINE( 382)			HX_VARI(  ::openfl::text::Font,typewriterItalic) = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Courier New Italic.ttf",56,fe,46,e8));
HXLINE( 383)			HX_VARI(  ::openfl::text::Font,typewriterBoldItalic) = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Courier New Bold Italic.ttf",95,c6,70,a1));
HXLINE( 385)			{
HXLINE( 385)				::Dynamic this3 = ::openfl::text::_internal::TextEngine_obj::_hx___defaultFonts;
HXDLIN( 385)				( ( ::haxe::ds::StringMap)(this3) )->set(HX_("_typewriter",0c,5e,52,94), ::openfl::text::_internal::_TextEngine::DefaultFontSet_obj::__alloc( HX_CTX ,typewriter,typewriterBold,typewriterItalic,typewriterBoldItalic));
            			}
            		}
HXLINE( 422)		HX_VARI(  ::openfl::text::_internal::_TextEngine::DefaultFontSet,fontSet) = ( ( ::openfl::text::_internal::_TextEngine::DefaultFontSet)(::openfl::text::_internal::TextEngine_obj::_hx___defaultFonts->get(name)) );
...
Float TextEngine_obj::getFormatHeight( ::openfl::text::TextFormat format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 429)
HXLINE( 430)		HX_VAR( Float,ascent);
HXDLIN( 430)		HX_VAR( Float,descent);
HXLINE( 440)		HX_VARI(  ::openfl::text::Font,font) = ::openfl::text::_internal::TextEngine_obj::getFontInstance(format);
...
HXLINE( 430)		HX_VARI( int,leading) = ( (int)(format->leading) );
...
::String TextEngine_obj::getFont( ::openfl::text::TextFormat format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 469)
HXLINE( 470)		HX_VARI( ::String,fontName) = format->font;
HXLINE( 471)		HX_VARI(  ::Dynamic,bold) = format->bold;
HXLINE( 472)		HX_VARI(  ::Dynamic,italic) = format->italic;
HXLINE( 474)		if (::hx::IsNull( fontName )) {
HXLINE( 474)			fontName = HX_("_serif",be,66,15,76);
            		}
HXLINE( 475)		HX_VARI( ::String,fontNamePrefix) = ::StringTools_obj::replace(::StringTools_obj::replace(fontName,HX_(" Normal",67,be,ac,97),HX_("",00,00,00,00)),HX_(" Regular",1c,be,27,76),HX_("",00,00,00,00));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(TextEngine_obj,getFont,return )
 ...
 ::openfl::text::Font TextEngine_obj::getFontInstance( ::openfl::text::TextFormat format){
            	...
            	HX_STACK_ARG(format,"format")
HXLINE( 527)
HXLINE( 531)		HX_VARI(  ::openfl::text::Font,instance) = null();
HXLINE( 532)		HX_VARI(  ::Dynamic,fontList) = null();

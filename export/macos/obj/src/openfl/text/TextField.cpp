...
HXLINE( 895)		HX_VARI(  ::openfl::geom::Rectangle,rect) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
...
HXLINE( 925)				_g = (_g + 1);
HXDLIN( 925)				HX_VARI( int,i) = (_g - 1);
HXLINE( 927)				y = (y + this->_hx___textEngine->lineHeights->get(i));
            			}
            		}
HXLINE( 930)		{
HXLINE( 930)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN( 930)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 930)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1022)				_g = (_g + 1);
HXDLIN(1022)				HX_VARI( int,i) = (_g - 1);
HXLINE(1024)				y = (y + this->_hx___textEngine->lineHeights->get(i));
            			}
            		}
HXLINE(1027)		{
HXLINE(1027)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1027)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1027)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1054)		{
HXLINE(1054)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1054)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1054)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1078)		HX_VARI( int,startIndex) = -1;
HXLINE(1079)		HX_VARI( int,endIndex) = -1;
HXLINE(1081)		{
HXLINE(1081)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1081)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1081)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1109)		HX_VARI( Float,ascender) = this->_hx___textEngine->lineAscents->get(lineIndex);
HXLINE(1110)		HX_VARI( Float,descender) = this->_hx___textEngine->lineDescents->get(lineIndex);
HXLINE(1111)		HX_VARI( Float,leading) = this->_hx___textEngine->lineLeadings->get(lineIndex);
HXLINE(1112)		HX_VARI( Float,lineHeight) = this->_hx___textEngine->lineHeights->get(lineIndex);
HXLINE(1113)		HX_VARI( Float,lineWidth) = this->_hx___textEngine->lineWidths->get(lineIndex);
HXLINE(1117)		HX_VAR( Float,margin);
...
HXLINE(1142)		{
HXLINE(1142)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1142)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1142)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1168)		HX_VARI( int,startIndex) = -1;
HXLINE(1169)		HX_VARI( int,endIndex) = -1;
HXLINE(1171)		{
HXLINE(1171)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1171)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1171)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1205)		HX_VARI( int,startIndex) = this->getFirstCharInParagraph(charIndex);
HXLINE(1207)		if ((charIndex >= this->get_text().length)) {
HXLINE(1207)			return ((this->get_text().length - startIndex) + 1);
            		}
HXLINE(1209)		HX_VARI( int,endIndex) = (this->_hx___textEngine->getLineBreakIndex(charIndex) + 1);
...
HXLINE(1241)
HXLINE(1242)		HX_VARI(  ::openfl::text::TextFormat,format) = null();
...
HXLINE(1252)		{
HXLINE(1252)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->textFormatRanges->iterator();
HXDLIN(1252)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1252)				HX_VARI_NAME(  ::openfl::text::_internal::TextFormatRange,group1,"group") = ( ( ::openfl::text::_internal::TextFormatRange)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
void TextField_obj::setTextFormat( ::openfl::text::TextFormat format,::hx::Null< int >  __o_beginIndex,::hx::Null< int >  __o_endIndex){
            	...
            	HX_STACK_ARG(endIndex,"endIndex")
HXLINE(1439)
HXLINE(1440)		HX_VARI( int,max) = this->get_text().length;
HXLINE(1441)		HX_VAR(  ::openfl::text::_internal::TextFormatRange,range);
...
HXLINE(1484)			HX_VARI( int,index) = 0;
HXLINE(1485)			HX_VAR(  ::openfl::text::_internal::TextFormatRange,newRange);
...
void TextField_obj::_hx___caretBeginningOfNextLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1623)
HXLINE(1624)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
void TextField_obj::_hx___caretBeginningOfPreviousLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1637)
HXLINE(1638)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
HXLINE(1640)		if ((lineIndex > 0)) {
HXLINE(1642)			HX_VARI( int,index) = this->getLineOffset(this->getLineIndexOfChar(this->_hx___caretIndex));
...
void TextField_obj::_hx___caretEndOfLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1656)
HXLINE(1657)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
void TextField_obj::_hx___caretNextLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1678)
HXLINE(1679)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
void TextField_obj::_hx___caretPreviousLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1696)
HXLINE(1697)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
HXLINE(1724)			HX_VARI_NAME(  ::openfl::events::MouseEvent,event1,"event") = ( ( ::openfl::events::MouseEvent)(event) );
HXLINE(1725)			Float group = this->get_mouseX();
HXDLIN(1725)			HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = this->_hx___getGroup(group,this->get_mouseY(),true);
HXLINE(1727)			if (::hx::IsNotNull( group1 )) {
HXLINE(1729)				HX_VARI( ::String,url) = group1->format->url;
...
HXLINE(1755)			HX_VARI(  ::openfl::geom::Rectangle,bounds) = this->getBounds(this->stage);
HXLINE(1756)			HX_VARI(  ::lime::math::Rectangle,limeRect) =  ::lime::math::Rectangle_obj::__alloc( HX_CTX ,bounds->x,bounds->y,bounds->width,bounds->height);
...
HXLINE(1806)		HX_VARI(  ::openfl::geom::Rectangle,bounds) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE(1822)		{
HXLINE(1822)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1822)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1822)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXDLIN(1836)						HX_VAR( Float,lastPosition);
...
HXLINE(1853)		HX_VARI(  ::Dynamic,x) = null();
HXDLIN(1853)		HX_VARI(  ::Dynamic,y) = null();
HXLINE(1855)		{
HXLINE(1855)			HX_VARI(  ::Dynamic,group) = this->_hx___textEngine->layoutGroups->iterator();
HXDLIN(1855)			while(( (bool)(group->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1855)				HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(1861)							_g = (_g + 1);
HXDLIN(1861)							HX_VARI( int,i) = (_g - 1);
...
HXDLIN(1873)							HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
HXDLIN(1887)		HX_VARI_NAME(  ::openfl::text::_internal::TextLayoutGroup,group1,"group") = this->_hx___getGroup(group,this->get_mouseY(),true);
...
HXLINE(1907)				_g = (_g + 1);
HXDLIN(1907)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(1914)		HX_VARI( bool,firstGroup) = true;
HXLINE(1915)		HX_VAR(  ::openfl::text::_internal::TextLayoutGroup,group);
HXDLIN(1915)		HX_VAR(  ::openfl::text::_internal::TextLayoutGroup,nextGroup);
HXLINE(1917)		{
...
HXDLIN(1917)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
int TextField_obj::_hx___getPosition(Float x,Float y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE(1951)
HXLINE(1952)		HX_VARI(  ::openfl::text::_internal::TextLayoutGroup,group) = this->_hx___getGroup(x,y,null());
HXLINE(1954)		if (::hx::IsNull( group )) {
HXLINE(1956)			return this->_hx___text.length;
            		}
HXLINE(1959)		HX_VARI( Float,advance) = ((Float)0.0);
HXLINE(1961)		{
HXLINE(1961)			int _g = 0;
HXDLIN(1961)			int _g1 = group->positions->length;
HXDLIN(1961)			while((_g < _g1)){
HXLINE(1961)				_g = (_g + 1);
HXDLIN(1961)				HX_VARI( int,i) = (_g - 1);
...
void TextField_obj::_hx___replaceSelectedText(::String value,::hx::Null< bool >  __o_restrict){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
            	HX_STACK_ARG(restrict,"restrict")
HXLINE(2023)
...
HXLINE(2027)		HX_VAR( int,startIndex);
...
HXLINE(2028)		HX_VAR( int,endIndex);
...
HXLINE(2036)			HX_VARI( int,cache) = endIndex;
...
HXLINE(2055)				HX_VARI( int,removeLength) = (endIndex - beginIndex);
HXLINE(2056)				HX_VARI( int,maxLength) = ((this->_hx___textEngine->maxChars - this->_hx___text.length) + removeLength);
...
HXLINE(2071)		HX_VARI( int,offset) = (newText.length - (endIndex - beginIndex));
HXLINE(2073)		HX_VARI( int,i) = 0;
HXLINE(2074)		HX_VAR(  ::openfl::text::_internal::TextFormatRange,range);
...
HXLINE(2202)		HX_VARI( bool,enableInput) = true;
...
void TextField_obj::_hx___stopTextInput(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2227)
HXLINE(2228)		HX_VARI( bool,disableInput) = true;
...
HXLINE(2240)			HX_VARI( Float,cacheWidth) = this->_hx___textEngine->width;
...
HXLINE(2272)		HX_VARI(  ::openfl::geom::Rectangle,bounds) = this->getBounds(::hx::ObjectPtr<OBJ_>(this));
...
HXLINE(2304)		HX_VARI(  ::openfl::geom::Rectangle,bounds) = this->getBounds(::hx::ObjectPtr<OBJ_>(this));
HXLINE(2306)		Float _hx_tmp = this->get_textWidth();
HXDLIN(2306)		if ((_hx_tmp <= (bounds->width - ( (Float)(4) )))) {
HXLINE(2308)			this->set_scrollH(0);
HXLINE(2309)			return;
            		}
HXLINE(2312)		HX_VARI( int,tempScrollH) = this->get_scrollH();
...
HXLINE(2323)			HX_VARI(  ::openfl::geom::Rectangle,caret) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(2324)			HX_VARI( bool,written) = false;
...
HXLINE(2353)			HX_VARI( int,lineLength) = this->getLineLength(this->getLineIndexOfChar(this->_hx___caretIndex));
...
HXLINE(2384)		HX_VARI( int,lineIndex) = this->getLineIndexOfChar(this->_hx___caretIndex);
...
HXLINE(2398)				HX_VARI( int,i) = lineIndex;
HXDLIN(2398)				HX_VARI( Float,tempHeight) = ((Float)0.0);
...
HXLINE(2484)			HX_VARI( int,length) = this->get_text().length;
HXLINE(2485)			HX_VARI( ::String,mask) = HX_("",00,00,00,00);
HXLINE(2487)			{
HXLINE(2487)				int _g = 0;
HXDLIN(2487)				int _g1 = length;
HXDLIN(2487)				while((_g < _g1)){
HXLINE(2487)					_g = (_g + 1);
HXDLIN(2487)					HX_VARI( int,i) = (_g - 1);
...
HXLINE(3009)		HX_VARI( ::String,utfValue) = value;
HXLINE(3010)		HX_VARI(  ::openfl::text::_internal::TextFormatRange,range) = this->_hx___textEngine->textFormatRanges->get(0).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
...
HXLINE(3035)		{
HXLINE(3035)			HX_VARI(  ::Dynamic,range) = this->_hx___textEngine->textFormatRanges->iterator();
HXDLIN(3035)			while(( (bool)(range->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(3035)				HX_VARI_NAME(  ::openfl::text::_internal::TextFormatRange,range1,"range") = ( ( ::openfl::text::_internal::TextFormatRange)(range->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXDLIN(3168)			HX_VARI_NAME( int,position2,"position") = this->_hx___getPosition(position1,this->get_mouseY());
HXLINE(3170)			if ((position2 != this->_hx___caretIndex)) {
HXLINE(3172)				this->_hx___caretIndex = position2;
HXLINE(3174)				HX_VARI( bool,setDirty) = true;
...
void TextField_obj::stage_onMouseUp( ::openfl::events::MouseEvent event){
            	...
            	HX_STACK_ARG(event,"event")
HXLINE(3197)
HXLINE(3198)		HX_VARI(  ::openfl::display::Stage,stage) = ( ( ::openfl::display::Stage)(event->currentTarget) );
...
HXDLIN(3211)			HX_VARI_NAME( int,upPos2,"upPos") = this->_hx___getPosition(upPos1,this->get_mouseY());
HXLINE(3212)			HX_VARI( int,leftPos) = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(this->_hx___selectionIndex) ),( (Float)(upPos2) )));
HXLINE(3213)			HX_VARI( int,rightPos) = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(this->_hx___selectionIndex) ),( (Float)(upPos2) )));
...
HXLINE(3330)			HX_VARI( ::Array< ::String >,delimiters) = ::Array_obj< ::String >::fromData( _hx_array_data_efd5a8ca_158,13);
HXLINE(3332)			HX_VARI( ::String,txtStr) = this->_hx___text;
HXLINE(3333)			HX_VARI( int,leftPos) = -1;
HXLINE(3334)			HX_VARI( int,rightPos) = txtStr.length;
HXLINE(3335)			HX_VARI( int,pos) = 0;
HXLINE(3336)			HX_VARI( int,startPos) = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(this->_hx___caretIndex) ),( (Float)(1) )));
...
HXLINE(3339)						HX_VARI( ::String,c) = delimiters->__get(_g);
HXDLIN(3339)						_g = (_g + 1);
...
HXLINE(3352)					HX_VARI( bool,setDirty) = true;
...
HXLINE(3594)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
HXLINE(3596)						this->setSelection(0,this->_hx___text.length);
            			...
            			break;
            			case (int)99: {
HXLINE(3543)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
HXLINE(3545)					bool _hx_tmp1;
HXDLIN(3545)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3545)						_hx_tmp1 = !(this->get_displayAsPassword());
            					}
            					else {
HXLINE(3545)						_hx_tmp1 = false;
            					}
HXDLIN(3545)					if (_hx_tmp1) {
HXLINE(3547)						::lime::_hx_system::Clipboard_obj::set_text(this->_hx___text.substring(this->_hx___caretIndex,this->_hx___selectionIndex));
            			...
            			break;
            			case (int)118: {
HXLINE(3569)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
HXLINE(3571)					if (::hx::IsNotNull( ::lime::_hx_system::Clipboard_obj::get_text() )) {
HXLINE(3573)						HX_VARI(  ::openfl::events::TextEvent,te) =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,::lime::_hx_system::Clipboard_obj::get_text());
...
HXDLIN(3588)					( ( ::openfl::_Vector::ObjectVector)(this1) )->get((this->_hx___textEngine->textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->end = this->_hx___text.length;
            			...
            			break;
            			case (int)120: {
HXLINE(3554)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
HXLINE(3556)					bool _hx_tmp2;
HXDLIN(3556)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3556)						_hx_tmp2 = !(this->get_displayAsPassword());
            					}
            					else {
HXLINE(3556)						_hx_tmp2 = false;
            					}
HXDLIN(3556)					if (_hx_tmp2) {
...
HXLINE(3561)						this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),true,null()));
            			...
            			break;
            			case (int)127: {
HXLINE(3421)				bool _hx_tmp3;
HXDLIN(3421)				if ((this->_hx___selectionIndex == this->_hx___caretIndex)) {
HXLINE(3421)					_hx_tmp3 = (this->_hx___caretIndex < this->_hx___text.length);
            				}
            				else {
...
HXLINE(3508)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3525)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3457)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3474)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3491)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier)) {
...
HXLINE(3384)					HX_VARI_NAME(  ::openfl::events::TextEvent,te1,"te") =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,HX_("\n",0a,00,00,00));

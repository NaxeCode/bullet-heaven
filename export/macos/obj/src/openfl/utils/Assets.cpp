...
HXLINE(  96)			HX_VARI(  ::openfl::display::BitmapData,bitmapData) = ::openfl::utils::IAssetCache_obj::getBitmapData(::openfl::utils::Assets_obj::cache,id);
HXLINE(  98)			if (::openfl::utils::Assets_obj::isValidBitmapData(bitmapData)) {
HXLINE( 100)				return bitmapData;
            			}
            		}
HXLINE( 104)		HX_VARI(  ::lime::graphics::Image,image) = ::lime::utils::Assets_obj::getImage(id,false);
HXLINE( 106)		if (::hx::IsNotNull( image )) {
HXLINE( 111)			HX_VARI_NAME(  ::openfl::display::BitmapData,bitmapData1,"bitmapData") = ::openfl::display::BitmapData_obj::fromImage(image,null());
...
HXLINE( 156)		HX_VARI(  ::lime::text::Font,limeFont) = ::lime::utils::Assets_obj::getFont(id,false);
HXLINE( 158)		if (::hx::IsNotNull( limeFont )) {
HXLINE( 163)			HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Assets_obj,getLibrary,return )
 ...
 ::openfl::display::MovieClip Assets_obj::getMovieClip(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 195)
HXLINE( 197)		HX_VARI( ::String,libraryName) = id.substring(0,id.indexOf(HX_(":",3a,00,00,00),null()));
HXLINE( 198)		HX_VARI( ::String,symbolName) = id.substr((id.indexOf(HX_(":",3a,00,00,00),null()) + 1),null());
HXLINE( 199)		HX_VARI(  ::lime::utils::AssetLibrary,limeLibrary) = ::openfl::utils::Assets_obj::getLibrary(libraryName);
HXLINE( 201)		if (::hx::IsNotNull( limeLibrary )) {
HXLINE( 203)			if (::Std_obj::isOfType(limeLibrary,::hx::ClassOf< ::openfl::utils::AssetLibrary >())) {
HXLINE( 205)				HX_VARI(  ::openfl::utils::AssetLibrary,library) = ( ( ::openfl::utils::AssetLibrary)(limeLibrary) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Assets_obj,getMovieClip,return )
 ...
 ::openfl::media::Sound Assets_obj::getMusic(::String id,::hx::Null< bool >  __o_useCache){
            	...
            	HX_STACK_ARG(useCache,"useCache")
HXLINE( 233)
HXLINE( 235)		HX_VARI( ::String,path) = ::openfl::utils::Assets_obj::getPath(id);
HXLINE( 237)		HX_VARI(  ::lime::media::vorbis::VorbisFile,vorbisFile) = ::lime::media::vorbis::VorbisFile_obj::fromFile(path);
HXLINE( 238)		HX_VARI(  ::lime::media::AudioBuffer,buffer) = ::lime::media::AudioBuffer_obj::fromVorbisFile(vorbisFile);
...
HXLINE( 273)			HX_VARI(  ::openfl::media::Sound,sound) = ::openfl::utils::IAssetCache_obj::getSound(::openfl::utils::Assets_obj::cache,id);
HXLINE( 275)			if (::openfl::utils::Assets_obj::isValidSound(sound)) {
HXLINE( 277)				return sound;
            			}
            		}
HXLINE( 281)		HX_VARI(  ::lime::media::AudioBuffer,buffer) = ::lime::utils::Assets_obj::getAudioBuffer(id,false);
HXLINE( 283)		if (::hx::IsNotNull( buffer )) {
HXLINE( 288)			HX_VARI_NAME(  ::openfl::media::Sound,sound1,"sound") = ::openfl::media::Sound_obj::fromAudioBuffer(buffer);
...
HXLINE( 346)			HX_VARI(  ::openfl::utils::AssetLibrary,library) = ( ( ::openfl::utils::AssetLibrary)(::openfl::utils::Assets_obj::libraryBindings->get(className)) );
...
HXLINE( 399)		HX_VARI( ::String,libraryName) = id.substring(0,id.indexOf(HX_(":",3a,00,00,00),null()));
HXLINE( 400)		HX_VARI( ::String,symbolName) = id.substr((id.indexOf(HX_(":",3a,00,00,00),null()) + 1),null());
HXLINE( 401)		HX_VARI(  ::lime::utils::AssetLibrary,library) = ::openfl::utils::Assets_obj::getLibrary(libraryName);
...
HXLINE( 489)				HX_VARI(  ::openfl::display::BitmapData,bitmapData) = ::openfl::display::BitmapData_obj::fromImage(image,null());
...
HXLINE( 501)				promise->error(((HX_("[Assets] Could not load Image \"",f0,0b,f7,ed) + id) + HX_("\"",22,00,00,00)));
            	...
            	HX_STACK_ARG(useCache,"useCache")
HXLINE( 465)
HXDLIN( 465)		HX_VARI_NAME( ::Array< ::Dynamic>,useCache1,"useCache") = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 466)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 466)			useCache1[0] = true;
            		}
HXLINE( 469)		HX_VARI(  ::lime::app::Promise_openfl_display_BitmapData,promise) =  ::lime::app::Promise_openfl_display_BitmapData_obj::__alloc( HX_CTX );
...
HXLINE( 473)			HX_VARI(  ::openfl::display::BitmapData,bitmapData) = ::openfl::utils::IAssetCache_obj::getBitmapData(::openfl::utils::Assets_obj::cache,id);
...
HXLINE( 525)			promise->error(msg);
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 518)
HXLINE( 520)		HX_VARI(  ::lime::app::Promise_openfl_utils_ByteArray,promise) =  ::lime::app::Promise_openfl_utils_ByteArray_obj::__alloc( HX_CTX );
HXLINE( 521)		HX_VARI(  ::lime::app::Future,future) = ::lime::utils::Assets_obj::loadBytes(id);
...
HXLINE( 555)
HXLINE( 559)			HX_VARI(  ::openfl::text::Font,font) =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
...
HXLINE( 568)			promise->complete(font);
            	...
            	HX_STACK_ARG(useCache,"useCache")
HXLINE( 541)
HXDLIN( 541)		HX_VARI_NAME( ::Array< ::Dynamic>,useCache1,"useCache") = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 542)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 542)			useCache1[0] = true;
            		}
HXLINE( 545)		HX_VARI(  ::lime::app::Promise_openfl_text_Font,promise) =  ::lime::app::Promise_openfl_text_Font_obj::__alloc( HX_CTX );
...
HXLINE( 588)
HXLINE( 589)			HX_VARI(  ::openfl::utils::AssetLibrary,_library) = null();
...
HXLINE( 639)				HX_VARI(  ::openfl::media::Sound,sound) = ::openfl::media::Sound_obj::fromAudioBuffer(buffer);
...
HXLINE( 651)				promise->error(((HX_("[Assets] Could not load Sound \"",64,be,27,e3) + id) + HX_("\"",22,00,00,00)));
            	...
            	HX_STACK_ARG(useCache,"useCache")
HXLINE( 624)
HXDLIN( 624)		HX_VARI_NAME( ::Array< ::Dynamic>,useCache1,"useCache") = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 625)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 625)			useCache1[0] = true;
            		}
HXLINE( 629)		HX_VARI(  ::lime::app::Promise_openfl_media_Sound,promise) =  ::lime::app::Promise_openfl_media_Sound_obj::__alloc( HX_CTX );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Assets_obj,loadMusic,return )
 ...
 ::lime::app::Future Assets_obj::loadMovieClip(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 674)
HXLINE( 676)		HX_VARI(  ::lime::app::Promise_openfl_display_MovieClip,promise) =  ::lime::app::Promise_openfl_display_MovieClip_obj::__alloc( HX_CTX );
HXLINE( 678)		HX_VARI( ::String,libraryName) = id.substring(0,id.indexOf(HX_(":",3a,00,00,00),null()));
HXLINE( 679)		HX_VARI( ::String,symbolName) = id.substr((id.indexOf(HX_(":",3a,00,00,00),null()) + 1),null());
HXLINE( 680)		HX_VARI(  ::lime::utils::AssetLibrary,limeLibrary) = ::openfl::utils::Assets_obj::getLibrary(libraryName);
HXLINE( 682)		if (::hx::IsNotNull( limeLibrary )) {
HXLINE( 684)			if (::Std_obj::isOfType(limeLibrary,::hx::ClassOf< ::openfl::utils::AssetLibrary >())) {
HXLINE( 686)				HX_VARI(  ::openfl::utils::AssetLibrary,library) = ( ( ::openfl::utils::AssetLibrary)(limeLibrary) );
...
HXLINE( 730)				HX_VARI(  ::openfl::media::Sound,sound) = ::openfl::media::Sound_obj::fromAudioBuffer(buffer);
...
HXLINE( 742)				promise->error(((HX_("[Assets] Could not load Sound \"",64,be,27,e3) + id) + HX_("\"",22,00,00,00)));
            	...
            	HX_STACK_ARG(useCache,"useCache")
HXLINE( 716)
HXDLIN( 716)		HX_VARI_NAME( ::Array< ::Dynamic>,useCache1,"useCache") = ::Array_obj< ::Dynamic>::__new(1)->init(0,useCache);
HXLINE( 717)		if (::hx::IsNull( useCache1->__get(0) )) {
HXLINE( 717)			useCache1[0] = true;
            		}
HXLINE( 720)		HX_VARI(  ::lime::app::Promise_openfl_media_Sound,promise) =  ::lime::app::Promise_openfl_media_Sound_obj::__alloc( HX_CTX );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Assets_obj,loadSound,return )
 ...
 ::lime::app::Future Assets_obj::loadText(::String id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 761)
HXLINE( 763)		HX_VARI(  ::lime::app::Future,future) = ::lime::utils::Assets_obj::loadText(id);
...
::hx::Class Assets_obj::resolveEnum(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE( 803)
HXLINE( 804)		HX_VARI( ::hx::Class,value) = ::Type_obj::resolveEnum(name);

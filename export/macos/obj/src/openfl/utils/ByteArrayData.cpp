...
HXLINE(1109)
HXLINE(1110)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc(length);
...
HXLINE(1141)
HXLINE(1163)		HX_VARI(  ::haxe::io::Bytes,limeBytes) = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(1165)		HX_VAR(  ::haxe::io::Bytes,bytes);
...
int ByteArrayData_obj::readByte(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1237)
HXLINE(1238)		HX_VARI( int,value) = this->readUnsignedByte();
...
HXLINE(1283)			HX_VARI( int,ch1) = this->readInt();
HXLINE(1284)			HX_VARI( int,ch2) = this->readInt();
...
int ByteArrayData_obj::readInt(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1310)
HXLINE(1311)		HX_VARI( int,ch1) = this->readUnsignedByte();
HXLINE(1312)		HX_VARI( int,ch2) = this->readUnsignedByte();
HXLINE(1313)		HX_VARI( int,ch3) = this->readUnsignedByte();
HXLINE(1314)		HX_VARI( int,ch4) = this->readUnsignedByte();
...
HXDLIN(1333)		switch((int)(this->objectEncoding)){
            			case (int)10: {
HXLINE(1352)				HX_VARI( ::String,data) = this->readUTF();
HXLINE(1353)				return ::haxe::Unserializer_obj::run(data);
            			}
            			break;
            			case (int)12: {
HXLINE(1356)				HX_VARI_NAME( ::String,data1,"data") = this->readUTF();
...
int ByteArrayData_obj::readShort(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1447)
HXLINE(1448)		HX_VARI( int,ch1) = this->readUnsignedByte();
HXLINE(1449)		HX_VARI( int,ch2) = this->readUnsignedByte();
HXLINE(1451)		HX_VAR( int,value);
...
int ByteArrayData_obj::readUnsignedInt(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1486)
HXLINE(1487)		HX_VARI( int,ch1) = this->readUnsignedByte();
HXLINE(1488)		HX_VARI( int,ch2) = this->readUnsignedByte();
HXLINE(1489)		HX_VARI( int,ch3) = this->readUnsignedByte();
HXLINE(1490)		HX_VARI( int,ch4) = this->readUnsignedByte();
...
int ByteArrayData_obj::readUnsignedShort(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1503)
HXLINE(1504)		HX_VARI( int,ch1) = this->readUnsignedByte();
HXLINE(1505)		HX_VARI( int,ch2) = this->readUnsignedByte();
...
::String ByteArrayData_obj::readUTF(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1518)
HXLINE(1519)		HX_VARI( int,bytesCount) = this->readUnsignedShort();
...
void ByteArrayData_obj::uncompress( ::Dynamic __o_algorithm){
            	...
            	HX_STACK_ARG(algorithm,"algorithm")
HXLINE(1536)
HXLINE(1558)		HX_VARI(  ::haxe::io::Bytes,limeBytes) = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(1560)		HX_VAR(  ::haxe::io::Bytes,bytes);
...
void ByteArrayData_obj::writeDouble(Float value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE(1606)
HXLINE(1607)		HX_VARI( ::cpp::Int64,int64) = ::haxe::io::FPHelper_obj::doubleToI64(value);
...
HXLINE(1631)			HX_VARI_NAME( int,_hx_int,"int") = ::haxe::io::FPHelper_obj::floatToI32(value);
...
HXDLIN(1663)		switch((int)(this->objectEncoding)){
            			case (int)10: {
HXLINE(1682)				HX_VARI( ::String,value) = ::haxe::Serializer_obj::run(object);
...
HXDLIN(1686)				HX_VARI_NAME( ::String,value1,"value") = ::haxe::format::JsonPrinter_obj::print(object,replacer,space);
...
void ByteArrayData_obj::writeUTF(::String value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE(1716)
HXLINE(1717)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::ofString(value,null());
...
void ByteArrayData_obj::writeUTFBytes(::String value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE(1724)
HXLINE(1725)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::ofString(value,null());
...
HXLINE(1743)			HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc((((size + 1) * 3) >> 1));
HXLINE(1745)			bytes->fill(this->__length,(size - this->__length),0);
HXLINE(1748)			if ((this->__length > 0)) {
HXLINE(1750)				HX_VARI( int,cacheLength) = this->length;
...
int ByteArrayData_obj::defaultObjectEncoding;
 ...
 ::openfl::utils::ByteArrayData ByteArrayData_obj::fromBytes( ::haxe::io::Bytes bytes){
            	...
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(1200)
HXLINE(1201)		HX_VARI(  ::openfl::utils::ByteArrayData,result) =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,null());

...
HXLINE(  50)
HXLINE(  52)		HX_VARI(  ::lime::utils::AssetLibrary,library) = ::lime::utils::AssetLibrary_obj::fromBundle(bundle);
...
HXLINE(  62)				HX_VARI(  ::openfl::utils::AssetLibrary,_library) =  ::openfl::utils::AssetLibrary_obj::__alloc( HX_CTX );
...
HXLINE(  95)
HXLINE(  97)		HX_VARI(  ::lime::utils::AssetLibrary,library) = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
...
HXLINE( 107)				HX_VARI(  ::openfl::utils::AssetLibrary,_library) =  ::openfl::utils::AssetLibrary_obj::__alloc( HX_CTX );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(AssetLibrary_obj,loadFromFile,return )
 ...
 ::lime::app::Future AssetLibrary_obj::loadFromManifest( ::lime::utils::AssetManifest manifest){
            	...
            	HX_STACK_ARG(manifest,"manifest")
HXLINE( 347)
HXLINE( 349)		HX_VARI(  ::openfl::utils::AssetLibrary,library) = ::openfl::utils::AssetLibrary_obj::fromManifest(manifest);

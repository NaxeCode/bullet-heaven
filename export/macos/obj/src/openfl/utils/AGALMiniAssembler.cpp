...
HXDLIN( 548)									HX_VARI_NAME( int,k1,"k") = (_g2 - 1);
...
HXLINE( 555)									HX_VARI(  ::openfl::utils::_AGALMiniAssembler::Sampler,optfound) = ( ( ::openfl::utils::_AGALMiniAssembler::Sampler)(::openfl::utils::AGALMiniAssembler_obj::SAMPLEMAP->get(opts->__get(k1))) );
...
HXLINE( 612)			HX_VARI_NAME( int,j1,"j") = 0;
...
HXDLIN( 640)					HX_VARI( int,index) = (_g4 - 1);

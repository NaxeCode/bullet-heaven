 ...
 ::lime::app::Future ByteArray_Impl__obj::loadFromBytes( ::haxe::io::Bytes bytes){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::haxe::io::Bytes limeBytes){
            			...
            			HX_STACK_ARG(limeBytes,"limeBytes")
HXLINE( 436)
HXLINE( 437)			HX_VARI(  ::openfl::utils::ByteArrayData,byteArray) = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromLimeBytes(limeBytes);
 ...
 ::lime::app::Future ByteArray_Impl__obj::loadFromFile(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::haxe::io::Bytes limeBytes){
            			...
            			HX_STACK_ARG(limeBytes,"limeBytes")
HXLINE( 458)
HXLINE( 459)			HX_VARI(  ::openfl::utils::ByteArrayData,byteArray) = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromLimeBytes(limeBytes);

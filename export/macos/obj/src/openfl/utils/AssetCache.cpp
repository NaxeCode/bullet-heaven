...
HXLINE(  90)			HX_VARI(  ::Dynamic,keys) = this->bitmapData->keys();
HXLINE(  92)			{
HXLINE(  92)				HX_VARI(  ::Dynamic,key) = keys;
HXDLIN(  92)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  92)					HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  94)					if (::StringTools_obj::startsWith(key1,prefix)) {
HXLINE(  96)						this->removeBitmapData(key1);
            					}
            				}
            			}
HXLINE( 100)			HX_VARI_NAME(  ::Dynamic,keys1,"keys") = this->font->keys();
HXLINE( 102)			{
HXLINE( 102)				HX_VARI_NAME(  ::Dynamic,key2,"key") = keys1;
HXDLIN( 102)				while(( (bool)(key2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 102)					HX_VARI_NAME( ::String,key3,"key") = ( (::String)(key2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 104)					if (::StringTools_obj::startsWith(key3,prefix)) {
HXLINE( 106)						this->removeFont(key3);
            					}
            				}
            			}
HXLINE( 110)			HX_VARI_NAME(  ::Dynamic,keys2,"keys") = this->sound->keys();
HXLINE( 112)			{
HXLINE( 112)				HX_VARI_NAME(  ::Dynamic,key4,"key") = keys2;
HXDLIN( 112)				while(( (bool)(key4->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 112)					HX_VARI_NAME( ::String,key5,"key") = ( (::String)(key4->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );

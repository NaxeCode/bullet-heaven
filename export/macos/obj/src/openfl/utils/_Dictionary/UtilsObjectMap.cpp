...
HX_DEFINE_DYNAMIC_FUNC0(UtilsObjectMap_obj,clear,(void))
 ...
 ::openfl::utils::_Dictionary::UtilsObjectMap UtilsObjectMap_obj::copy(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 489)
HXLINE( 490)		HX_VARI(  ::openfl::utils::_Dictionary::UtilsObjectMap,copied) =  ::openfl::utils::_Dictionary::UtilsObjectMap_obj::__alloc( HX_CTX );
HXLINE( 491)		{
HXLINE( 491)			HX_VARI(  ::Dynamic,key) = this->keys();
HXDLIN( 491)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 491)				HX_VARI_NAME(  ::Dynamic,key1,"key") = key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();

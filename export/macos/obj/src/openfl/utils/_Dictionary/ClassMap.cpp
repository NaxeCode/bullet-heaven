...
HX_DEFINE_DYNAMIC_FUNC0(ClassMap_obj,clear,(void))
 ...
 ::openfl::utils::_Dictionary::ClassMap ClassMap_obj::copy(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 226)
HXLINE( 227)		HX_VARI(  ::openfl::utils::_Dictionary::ClassMap,copied) =  ::openfl::utils::_Dictionary::ClassMap_obj::__alloc( HX_CTX );
HXLINE( 228)		{
HXLINE( 228)			HX_VARI(  ::Dynamic,key) = this->keys();
HXDLIN( 228)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 228)				HX_VARI_NAME(  ::Dynamic,key1,"key") = key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
...
bool ClassMap_obj::remove( ::Dynamic key){
            	...
            	HX_STACK_ARG(key,"key")
HXLINE( 262)
HXLINE( 263)		HX_VARI( ::String,name) = ::Type_obj::getClassName(key);
...
HXLINE( 268)
HXLINE( 269)		HX_VARI( ::String,name) = ::Type_obj::getClassName(key);

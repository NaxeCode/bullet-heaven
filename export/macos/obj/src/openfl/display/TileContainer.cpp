...
HXLINE( 118)				HX_VARI(  ::openfl::display::Tile,tile) = tiles->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 118)				_g = (_g + 1);
...
HX_DEFINE_DYNAMIC_FUNC1(TileContainer_obj,addTiles,return )
 ...
 ::openfl::display::Tile TileContainer_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 127)
HXLINE( 128)		HX_VARI(  ::openfl::display::TileContainer,group) =  ::openfl::display::TileContainer_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null());
HXLINE( 129)		{
HXLINE( 129)			int _g = 0;
HXDLIN( 129)			::Array< ::Dynamic> _g1 = this->_hx___tiles;
HXDLIN( 129)			while((_g < _g1->length)){
HXLINE( 129)				HX_VARI(  ::openfl::display::Tile,tile) = _g1->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 129)				_g = (_g + 1);
...
HXLINE( 159)
HXLINE( 160)		HX_VARI(  ::openfl::geom::Rectangle,result) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE( 161)		HX_VARI(  ::openfl::geom::Rectangle,rect) = null();
HXLINE( 163)		{
HXLINE( 163)			int _g = 0;
HXDLIN( 163)			::Array< ::Dynamic> _g1 = this->_hx___tiles;
HXDLIN( 163)			while((_g < _g1->length)){
HXLINE( 163)				HX_VARI(  ::openfl::display::Tile,tile) = _g1->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 163)				_g = (_g + 1);
...
HXLINE( 260)		HX_VARI( ::Array< ::Dynamic>,removed) = this->_hx___tiles->splice(beginIndex,((endIndex - beginIndex) + 1));
HXLINE( 261)		{
HXLINE( 261)			int _g = 0;
HXDLIN( 261)			while((_g < removed->length)){
HXLINE( 261)				HX_VARI(  ::openfl::display::Tile,tile) = removed->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 261)				_g = (_g + 1);
...
void TileContainer_obj::sortTiles( ::Dynamic compareFunction){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(compareFunction,"compareFunction")
HXLINE( 328)
...
void TileContainer_obj::swapTiles( ::openfl::display::Tile tile1, ::openfl::display::Tile tile2){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(tile1,"tile1")
            	HX_STACK_ARG(tile2,"tile2")
HXLINE( 343)
...
HXLINE( 345)			HX_VARI( int,index1) = this->_hx___tiles->indexOf(tile1,null());
HXLINE( 346)			HX_VARI( int,index2) = this->_hx___tiles->indexOf(tile2,null());
...
HXLINE( 364)
HXLINE( 365)		HX_VARI(  ::openfl::display::Tile,swap) = this->_hx___tiles->__get(index1).StaticCast<  ::openfl::display::Tile >();
...
Float TileContainer_obj::get_height(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 380)
HXLINE( 381)		HX_VARI(  ::openfl::geom::Rectangle,result) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 382)		HX_VARI(  ::openfl::geom::Rectangle,rect) = null();
HXLINE( 384)		{
HXLINE( 384)			int _g = 0;
HXDLIN( 384)			::Array< ::Dynamic> _g1 = this->_hx___tiles;
HXDLIN( 384)			while((_g < _g1->length)){
HXLINE( 384)				HX_VARI(  ::openfl::display::Tile,tile) = _g1->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 384)				_g = (_g + 1);
...
HXLINE( 398)		HX_VARI( Float,h) = result->height;
...
HXLINE( 407)
HXLINE( 408)		HX_VARI(  ::openfl::geom::Rectangle,result) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 409)		HX_VARI(  ::openfl::geom::Rectangle,rect) = null();
HXLINE( 411)		{
HXLINE( 411)			int _g = 0;
HXDLIN( 411)			::Array< ::Dynamic> _g1 = this->_hx___tiles;
HXDLIN( 411)			while((_g < _g1->length)){
HXLINE( 411)				HX_VARI(  ::openfl::display::Tile,tile) = _g1->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 411)				_g = (_g + 1);
...
Float TileContainer_obj::get_width(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 436)
HXLINE( 437)		HX_VARI(  ::openfl::geom::Rectangle,result) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 438)		HX_VARI(  ::openfl::geom::Rectangle,rect) = null();
HXLINE( 440)		{
HXLINE( 440)			int _g = 0;
HXDLIN( 440)			::Array< ::Dynamic> _g1 = this->_hx___tiles;
HXDLIN( 440)			while((_g < _g1->length)){
HXLINE( 440)				HX_VARI(  ::openfl::display::Tile,tile) = _g1->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 440)				_g = (_g + 1);
...
HXLINE( 454)		HX_VARI( Float,w) = result->width;
...
Float TileContainer_obj::set_width(Float value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 463)
HXLINE( 464)		HX_VARI(  ::openfl::geom::Rectangle,result) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 465)		HX_VARI(  ::openfl::geom::Rectangle,rect) = null();
HXLINE( 467)		{
HXLINE( 467)			int _g = 0;
HXDLIN( 467)			::Array< ::Dynamic> _g1 = this->_hx___tiles;
HXDLIN( 467)			while((_g < _g1->length)){
HXLINE( 467)				HX_VARI(  ::openfl::display::Tile,tile) = _g1->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 467)				_g = (_g + 1);

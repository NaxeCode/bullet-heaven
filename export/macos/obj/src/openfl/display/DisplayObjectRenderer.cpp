...
HXLINE( 106)
HXLINE( 107)		HX_VARI(  ::openfl::display::DisplayObjectRenderer,renderer) = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 121)				HX_VARI_NAME(  ::openfl::display::OpenGLRenderer,renderer1,"renderer") = ( ( ::openfl::display::OpenGLRenderer)(renderer) );
...
HXLINE( 156)				HX_VARI_NAME(  ::openfl::display::OpenGLRenderer,renderer2,"renderer") = ( ( ::openfl::display::OpenGLRenderer)(renderer) );
...
HXLINE( 180)						HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 180)						_g = (_g + 1);
...
HXLINE( 215)		HX_VARI(  ::openfl::display::DisplayObjectRenderer,renderer) = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 217)		switch((int)(displayObject->_hx___drawableType)){
            			case (int)2: {
HXLINE( 220)				HX_VARI(  ::openfl::display::Bitmap,bitmap) = ( ( ::openfl::display::Bitmap)(displayObject) );
...
HXLINE( 224)					force = false;
            			...
            			break;
            			case (int)7: {
HXLINE( 227)				HX_VARI(  ::openfl::text::TextField,textField) = ( ( ::openfl::text::TextField)(displayObject) );
...
HXLINE( 231)					force = true;
            			...
            			break;
            			case (int)9: {
HXLINE( 234)				HX_VARI(  ::openfl::display::Tilemap,tilemap) = ( ( ::openfl::display::Tilemap)(displayObject) );
...
HXLINE( 246)		HX_VARI(  ::openfl::geom::ColorTransform,colorTransform) = ::openfl::geom::ColorTransform_obj::_hx___pool->get().StaticCast<  ::openfl::geom::ColorTransform >();
...
HXLINE( 249)		HX_VARI( bool,updated) = false;
...
HXLINE( 256)			HX_VARI(  ::openfl::geom::Rectangle,rect) = null();
HXLINE( 258)			HX_VAR( bool,needRender);
...
HXLINE( 261)			HX_VAR( bool,softwareDirty);
...
HXLINE( 264)			HX_VAR( bool,hardwareDirty);
...
HXLINE( 266)			HX_VARI( ::String,renderType) = renderer->_hx___type;
...
HXLINE( 288)			HX_VAR( bool,updateTransform);
...
HXLINE( 289)			HX_VARI( bool,hasFilters) = ::hx::IsNotNull( displayObject->_hx___filters );
...
HXLINE( 300)					HX_VARI(  ::openfl::filters::BitmapFilter,filter) = _g1->__get(_g).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 300)					_g = (_g + 1);
...
HXLINE( 315)			HX_VAR(  ::openfl::geom::Matrix,bitmapMatrix);
...
HXLINE( 338)				HX_VARI(  ::openfl::display::DisplayObject,current) = displayObject;
...
HXLINE( 357)			HX_VARI( int,bitmapWidth) = 0;
HXDLIN( 357)			HX_VARI( int,bitmapHeight) = 0;
HXLINE( 358)			HX_VARI( int,filterWidth) = 0;
HXDLIN( 358)			HX_VARI( int,filterHeight) = 0;
HXLINE( 359)			HX_VARI( Float,offsetX) = ((Float)0.);
HXDLIN( 359)			HX_VARI( Float,offsetY) = ((Float)0.);
HXLINE( 364)			HX_VARI( Float,pixelRatio) = this->_hx___pixelRatio;
...
HXLINE( 407)					HX_VAR( bool,needsFill);
...
HXLINE( 409)					HX_VAR( int,fillColor);
...
HXLINE( 410)					HX_VAR( int,bitmapColor);
...
HXLINE( 411)					HX_VARI( bool,allowFramebuffer) = (renderer->_hx___type == HX_("opengl",6f,64,94,21));
...
HXLINE( 446)						HX_VARI_NAME(  ::openfl::text::TextField,textField1,"textField") = ( ( ::openfl::text::TextField)(displayObject) );
...
HXLINE( 555)					HX_VARI(  ::openfl::display::OpenGLRenderer,parentRenderer) = ( ( ::openfl::display::OpenGLRenderer)(renderer) );
HXLINE( 556)					HX_VARI(  ::openfl::display::OpenGLRenderer,childRenderer) = ( ( ::openfl::display::OpenGLRenderer)(displayObject->_hx___cacheBitmapRenderer) );
HXLINE( 558)					HX_VARI(  ::openfl::display3D::Context3D,context) = childRenderer->_hx___context3D;
HXLINE( 560)					HX_VARI(  ::openfl::display3D::textures::TextureBase,cacheRTT) = context->_hx___state->renderToTexture;
HXLINE( 561)					HX_VARI( bool,cacheRTTDepthStencil) = context->_hx___state->renderToTextureDepthStencil;
HXLINE( 562)					HX_VARI( int,cacheRTTAntiAlias) = context->_hx___state->renderToTextureAntiAlias;
HXLINE( 563)					HX_VARI( int,cacheRTTSurfaceSelector) = context->_hx___state->renderToTextureSurfaceSelector;
HXLINE( 567)					HX_VARI(  ::Dynamic,cacheBlendMode) = parentRenderer->_hx___blendMode;
...
HXLINE( 582)						HX_VARI( bool,needSecondBitmapData) = true;
HXLINE( 583)						HX_VARI( bool,needCopyOfOriginal) = false;
HXLINE( 585)						{
HXLINE( 585)							int _g2 = 0;
HXDLIN( 585)							::Array< ::Dynamic> _g3 = displayObject->_hx___filters;
HXDLIN( 585)							while((_g2 < _g3->length)){
HXLINE( 585)								HX_VARI_NAME(  ::openfl::filters::BitmapFilter,filter1,"filter") = _g3->__get(_g2).StaticCast<  ::openfl::filters::BitmapFilter >();
...
HXLINE( 596)						HX_VARI_NAME(  ::openfl::display::BitmapData,bitmap1,"bitmap") = displayObject->_hx___cacheBitmapData;
HXLINE( 597)						HX_VARI(  ::openfl::display::BitmapData,bitmap2) = null();
HXLINE( 598)						HX_VARI(  ::openfl::display::BitmapData,bitmap3) = null();
...
HXLINE( 649)						HX_VAR(  ::openfl::display::Shader,shader);
HXDLIN( 649)						HX_VAR(  ::openfl::display::BitmapData,cacheBitmap);
HXLINE( 651)						{
HXLINE( 651)							int _g4 = 0;
HXDLIN( 651)							::Array< ::Dynamic> _g5 = displayObject->_hx___filters;
HXDLIN( 651)							while((_g4 < _g5->length)){
HXLINE( 651)								HX_VARI_NAME(  ::openfl::filters::BitmapFilter,filter2,"filter") = _g5->__get(_g4).StaticCast<  ::openfl::filters::BitmapFilter >();
...
HXDLIN( 659)										HX_VARI( int,i) = (_g6 - 1);
...
HXLINE( 708)						HX_VARI_NAME( bool,needSecondBitmapData1,"needSecondBitmapData") = false;
HXLINE( 709)						HX_VARI_NAME( bool,needCopyOfOriginal1,"needCopyOfOriginal") = false;
HXLINE( 711)						{
HXLINE( 711)							int _g8 = 0;
HXDLIN( 711)							::Array< ::Dynamic> _g9 = displayObject->_hx___filters;
HXDLIN( 711)							while((_g8 < _g9->length)){
HXLINE( 711)								HX_VARI_NAME(  ::openfl::filters::BitmapFilter,filter3,"filter") = _g9->__get(_g8).StaticCast<  ::openfl::filters::BitmapFilter >();
...
HXLINE( 723)						HX_VARI_NAME(  ::openfl::display::BitmapData,bitmap4,"bitmap") = displayObject->_hx___cacheBitmapData;
HXLINE( 724)						HX_VARI_NAME(  ::openfl::display::BitmapData,bitmap21,"bitmap2") = null();
HXLINE( 725)						HX_VARI_NAME(  ::openfl::display::BitmapData,bitmap31,"bitmap3") = null();
...
HXLINE( 764)						HX_VARI(  ::openfl::geom::Point,destPoint) = displayObject->_hx___tempPoint;
HXLINE( 765)						HX_VAR_NAME(  ::openfl::display::BitmapData,cacheBitmap1,"cacheBitmap");
HXDLIN( 765)						HX_VAR(  ::openfl::display::BitmapData,lastBitmap);
HXLINE( 767)						{
HXLINE( 767)							int _g10 = 0;
HXDLIN( 767)							::Array< ::Dynamic> _g11 = displayObject->_hx___filters;
HXDLIN( 767)							while((_g10 < _g11->length)){
HXLINE( 767)								HX_VARI_NAME(  ::openfl::filters::BitmapFilter,filter4,"filter") = _g11->__get(_g10).StaticCast<  ::openfl::filters::BitmapFilter >();
...
HXLINE( 830)					HX_VARI(  ::openfl::display::DOMRenderer,domRenderer) = ( ( ::openfl::display::DOMRenderer)(renderer) );
...
HXLINE( 848)			HX_VARI_NAME(  ::openfl::text::TextField,textField2,"textField") = ( ( ::openfl::text::TextField)(displayObject) );

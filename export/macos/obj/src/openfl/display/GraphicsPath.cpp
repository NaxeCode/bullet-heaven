...
HXLINE( 221)		HX_VARI( Float,xe) = (x + width);
HXDLIN( 221)		HX_VARI( Float,ye) = (y + height);
HXDLIN( 221)		HX_VARI( Float,cx1) = (-(ellipseWidth) + (ellipseWidth * ((Float)0.70710678118654752440084436210485)));
HXDLIN( 221)		HX_VARI( Float,cx2) = (-(ellipseWidth) + (ellipseWidth * ((Float)0.4142135623730950488016887242097)));
HXDLIN( 221)		HX_VARI( Float,cy1) = (-(ellipseHeight) + (ellipseHeight * ((Float)0.70710678118654752440084436210485)));
HXDLIN( 221)		HX_VARI( Float,cy2) = (-(ellipseHeight) + (ellipseHeight * ((Float)0.4142135623730950488016887242097)));

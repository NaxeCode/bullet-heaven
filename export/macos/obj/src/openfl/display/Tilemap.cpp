...
HXLINE( 320)				HX_VARI(  ::openfl::display::Tile,tile) = _g1->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 320)				_g = (_g + 1);
...
HXLINE( 325)				HX_VARI_NAME(  ::openfl::display::Tile,tile1,"tile") = _g3->__get(_g2).StaticCast<  ::openfl::display::Tile >();
...
HXLINE( 390)
HXLINE( 391)		HX_VARI(  ::openfl::geom::Rectangle,bounds) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();

...
HXLINE( 347)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 347)				_g = (_g + 1);
...
HXLINE( 438)						HX_VARI(  ::openfl::display::FrameLabel,frameLabel) = _g1->__get(_g).StaticCast<  ::openfl::display::FrameLabel >();
HXDLIN( 438)						_g = (_g + 1);
...
HX_DEFINE_DYNAMIC_FUNC0(MovieClip_obj,get_totalFrames,return )
 ...
 ::openfl::display::MovieClip MovieClip_obj::fromTimeline( ::openfl::display::Timeline timeline){
            	...
            	HX_STACK_ARG(timeline,"timeline")
HXLINE( 222)
HXLINE( 223)		HX_VARI(  ::openfl::display::MovieClip,movieClip) =  ::openfl::display::MovieClip_obj::__alloc( HX_CTX );

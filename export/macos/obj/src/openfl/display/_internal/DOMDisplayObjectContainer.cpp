...
HXLINE(   8)
HXLINE(   9)		{
HXLINE(   9)			HX_VARI(  ::Dynamic,orphan) = displayObjectContainer->_hx___removedChildren->iterator();
HXDLIN(   9)			while(( (bool)(orphan->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(   9)				HX_VARI_NAME(  ::openfl::display::DisplayObject,orphan1,"orphan") = ( ( ::openfl::display::DisplayObject)(orphan->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(  23)					HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  23)					_g = (_g + 1);
...
HXLINE(  37)					HX_VARI_NAME(  ::openfl::display::DisplayObject,child1,"child") = _g3->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  37)					_g2 = (_g2 + 1);
...
HXLINE(  47)				HX_VARI_NAME(  ::openfl::display::DisplayObject,child2,"child") = _g5->__get(_g4).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  47)				_g4 = (_g4 + 1);
...
HXLINE(  57)
HXLINE(  58)		{
HXLINE(  58)			HX_VARI(  ::Dynamic,orphan) = displayObjectContainer->_hx___removedChildren->iterator();
HXDLIN(  58)			while(( (bool)(orphan->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  58)				HX_VARI_NAME(  ::openfl::display::DisplayObject,orphan1,"orphan") = ( ( ::openfl::display::DisplayObject)(orphan->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(  68)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  68)				_g = (_g + 1);

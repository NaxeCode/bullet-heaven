...
HXLINE(  30)			HX_VARI(  ::openfl::display3D::Context3D,context) = renderer->_hx___context3D;
HXLINE(  32)			renderer->_hx___setBlendMode(bitmap->_hx___worldBlendMode);
HXLINE(  33)			renderer->_hx___pushMaskObject(bitmap,null());
HXLINE(  36)			HX_VARI(  ::openfl::display::Shader,shader) = renderer->_hx___initDisplayShader(bitmap->_hx___worldShader);
...
HXLINE(  44)			HX_VARI(  ::openfl::display3D::VertexBuffer3D,vertexBuffer) = bitmap->_hx___bitmapData->getVertexBuffer(context,null(),null());
...
HXLINE(  47)			HX_VARI(  ::openfl::display3D::IndexBuffer3D,indexBuffer) = bitmap->_hx___bitmapData->getIndexBuffer(context,null());
...
HXLINE(  92)			HX_VARI(  ::openfl::display3D::Context3D,context) = renderer->_hx___context3D;
HXLINE(  94)			HX_VARI(  ::openfl::display::_internal::Context3DMaskShader,shader) = renderer->_hx___maskShader;
...
HXLINE( 100)			HX_VARI(  ::openfl::display3D::VertexBuffer3D,vertexBuffer) = bitmap->_hx___bitmapData->getVertexBuffer(context,null(),null());
...
HXLINE( 103)			HX_VARI(  ::openfl::display3D::IndexBuffer3D,indexBuffer) = bitmap->_hx___bitmapData->getIndexBuffer(context,null());

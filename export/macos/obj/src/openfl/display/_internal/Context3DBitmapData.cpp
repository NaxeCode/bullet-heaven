...
HXLINE(  18)
HXLINE(  19)		HX_VARI(  ::openfl::display3D::Context3D,context) = renderer->_hx___context3D;
HXLINE(  20)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
HXLINE(  22)		renderer->_hx___setBlendMode(10);
HXLINE(  24)		HX_VARI(  ::openfl::display::DisplayObjectShader,shader) = renderer->_hx___defaultDisplayShader;
...
HXLINE(  34)		HX_VARI(  ::openfl::display3D::VertexBuffer3D,vertexBuffer) = bitmapData->getVertexBuffer(context,null(),null());
...
HXLINE(  37)		HX_VARI(  ::openfl::display3D::IndexBuffer3D,indexBuffer) = bitmapData->getIndexBuffer(context,null());
...
HXLINE(  50)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
HXLINE(  52)		HX_VARI(  ::openfl::display::_internal::Context3DMaskShader,shader) = renderer->_hx___maskShader;
...
HXLINE(  58)		HX_VARI(  ::openfl::display3D::VertexBuffer3D,vertexBuffer) = bitmapData->getVertexBuffer(context,null(),null());
...
HXLINE(  61)		HX_VARI(  ::openfl::display3D::IndexBuffer3D,indexBuffer) = bitmapData->getIndexBuffer(context,null());

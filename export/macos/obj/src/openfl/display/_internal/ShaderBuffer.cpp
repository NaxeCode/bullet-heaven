...
HXLINE( 126)		HX_VAR(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input);
HXLINE( 128)		{
HXLINE( 128)			int _g = 0;
...
HXLINE( 138)		HX_VARI( int,boolCount) = shader->_hx___paramBool->length;
HXLINE( 139)		HX_VARI( int,floatCount) = shader->_hx___paramFloat->length;
HXLINE( 140)		HX_VARI( int,intCount) = shader->_hx___paramInt->length;
...
HXLINE( 146)		HX_VARI( int,length) = 0;
HXDLIN( 146)		HX_VARI( int,p) = 0;
HXLINE( 147)		HX_VAR(  ::openfl::display::ShaderParameter_Bool,param);
HXLINE( 149)		{
HXLINE( 149)			int _g2 = 0;
HXDLIN( 149)			int _g3 = boolCount;
HXDLIN( 149)			while((_g2 < _g3)){
HXLINE( 149)				_g2 = (_g2 + 1);
HXDLIN( 149)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
HXLINE( 163)		HX_VAR_NAME(  ::openfl::display::ShaderParameter_Float,param1,"param");
HXLINE( 165)		{
HXLINE( 165)			int _g4 = 0;
HXDLIN( 165)			int _g5 = floatCount;
HXDLIN( 165)			while((_g4 < _g5)){
HXLINE( 165)				_g4 = (_g4 + 1);
HXDLIN( 165)				HX_VARI_NAME( int,i2,"i") = (_g4 - 1);
...
HXLINE( 179)		HX_VAR_NAME(  ::openfl::display::ShaderParameter_Int,param2,"param");
HXLINE( 181)		{
HXLINE( 181)			int _g6 = 0;
HXDLIN( 181)			int _g7 = intCount;
HXDLIN( 181)			while((_g6 < _g7)){
HXLINE( 181)				_g6 = (_g6 + 1);
HXDLIN( 181)				HX_VARI_NAME( int,i3,"i") = (_g6 - 1);
...
HXDLIN( 203)					HX_VARI(  ::lime::utils::ArrayBufferView,data) = this2;
HXLINE( 204)					{
...
HXLINE( 209)		HX_VARI( int,boolIndex) = 0;
HXLINE( 210)		HX_VARI( int,floatIndex) = 0;
HXLINE( 211)		HX_VARI( int,intIndex) = 0;
HXLINE( 213)		HX_VARI( int,paramPosition) = 0;
HXLINE( 214)		HX_VAR(  ::openfl::display::ShaderParameter_Bool,boolParam);
HXDLIN( 214)		HX_VAR(  ::openfl::display::ShaderParameter_Float,floatParam);
HXDLIN( 214)		HX_VAR(  ::openfl::display::ShaderParameter_Int,intParam);
HXDLIN( 214)		HX_VAR_NAME( int,length1,"length");
HXLINE( 216)		{
HXLINE( 216)			int _g8 = 0;
HXDLIN( 216)			int _g9 = this->paramCount;
HXDLIN( 216)			while((_g8 < _g9)){
HXLINE( 216)				_g8 = (_g8 + 1);
HXDLIN( 216)				HX_VARI_NAME( int,i4,"i") = (_g8 - 1);
...
HXDLIN( 225)							HX_VARI( int,j) = (_g10 - 1);
HXLINE( 227)							{
...
HXDLIN( 236)								HX_VARI_NAME( int,j1,"j") = (_g12 - 1);
HXLINE( 238)								{
...
HXDLIN( 247)								HX_VARI_NAME( int,j2,"j") = (_g14 - 1);
HXLINE( 249)								{

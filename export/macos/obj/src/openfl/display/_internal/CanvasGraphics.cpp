...
HXLINE( 467)
HXLINE( 468)		HX_VARI( Float,max) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 469)		HX_VARI( Float,tmp) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 470)		HX_VARI( int,len) = uvt->get_length();
HXLINE( 472)		{
HXLINE( 472)			int _g = 1;
HXDLIN( 472)			int _g1 = (len + 1);
HXDLIN( 472)			while((_g < _g1)){
HXLINE( 472)				_g = (_g + 1);
HXDLIN( 472)				HX_VARI( int,t) = (_g - 1);
...
HXDLIN( 492)		HX_VARI(  ::openfl::_Vector::FloatVector,result) =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,array,true);
HXLINE( 494)		{
HXLINE( 494)			int _g2 = 1;
HXDLIN( 494)			int _g3 = (len + 1);
HXDLIN( 494)			while((_g2 < _g3)){
HXLINE( 494)				_g2 = (_g2 + 1);
HXDLIN( 494)				HX_VARI_NAME( int,t1,"t") = (_g2 - 1);

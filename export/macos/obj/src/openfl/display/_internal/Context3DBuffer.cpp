...
void Context3DBuffer_obj::__construct( ::openfl::display3D::Context3D context3D, ::openfl::display::_internal::Context3DElementType elementType,int elementCount,int dataPerVertex){
            	...
            	HX_STACK_ARG(elementType,"elementType")
...
HXLINE(  55)				HX_VARI( int,end) = (start + length);
HXLINE(  57)				while((start < end)){
HXLINE(  59)					HX_VARI( int,arrayBufferIndex) = ::Math_obj::floor((( (Float)(start) ) / ( (Float)(10922) )));
...
HXLINE( 100)		HX_VARI( int,numVertices) = 0;
...
HXLINE( 117)		HX_VARI( int,vertexLength) = (numVertices * dataPerVertex);
...
HXLINE( 126)				HX_VARI(  ::lime::utils::ArrayBufferView,cacheBufferData) = this->vertexBufferData;

...
int AbstractNoise_obj::stitching( ::openfl::display::BitmapData bitmap,int color,int px,int py,int stitch_w,int stitch_h,int width,int height){
            	...
            	HX_STACK_ARG(px,"px")
            	HX_STACK_ARG(py,"py")
            	HX_STACK_ARG(stitch_w,"stitch_w")
            	HX_STACK_ARG(stitch_h,"stitch_h")
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(  50)
HXLINE(  51)		HX_VARI( int,r) = ((color >> 16) & 255);
HXLINE(  52)		HX_VARI( int,g) = ((color >> 8) & 255);
HXLINE(  53)		HX_VARI( int,b) = (color & 255);
HXLINE(  55)		if (((width - stitch_w) < px)) {
HXLINE(  57)			HX_VARI( int,dest) = bitmap->getPixel32((width - px),py);
HXLINE(  58)			HX_VARI( int,dest_r) = ((dest >> 16) & 255);
HXLINE(  59)			HX_VARI( int,dest_g) = ((dest >> 8) & 255);
HXLINE(  60)			HX_VARI( int,dest_b) = (dest & 255);
HXLINE(  62)			HX_VARI( Float,u) = (( (Float)((width - px)) ) / ( (Float)(stitch_w) ));
HXLINE(  63)			HX_VARI( Float,uu) = (u * u);
...
HXLINE(  72)			HX_VARI_NAME( int,dest1,"dest") = bitmap->getPixel32(px,(height - py));
HXLINE(  73)			HX_VARI_NAME( int,dest_r1,"dest_r") = ((dest1 >> 16) & 255);
HXLINE(  74)			HX_VARI_NAME( int,dest_g1,"dest_g") = ((dest1 >> 8) & 255);
HXLINE(  75)			HX_VARI_NAME( int,dest_b1,"dest_b") = (dest1 & 255);
HXLINE(  77)			HX_VARI_NAME( Float,u1,"u") = (( (Float)((height - py)) ) / ( (Float)(stitch_h) ));
HXLINE(  78)			HX_VARI_NAME( Float,uu1,"uu") = (u1 * u1);
...
int AbstractNoise_obj::color( ::Dynamic r_noise, ::Dynamic g_noise, ::Dynamic b_noise){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(r_noise,"r_noise")
            	HX_STACK_ARG(g_noise,"g_noise")
            	HX_STACK_ARG(b_noise,"b_noise")
HXLINE(  89)
HXLINE(  90)		HX_VARI( int,color_r) = 0;
HXLINE(  91)		HX_VARI( int,color_g) = 0;
HXLINE(  92)		HX_VARI( int,color_b) = 0;
...
HXLINE( 148)
HXLINE( 149)		HX_VAR( Float,fFreq);
HXDLIN( 149)		HX_VAR( Float,fPers);

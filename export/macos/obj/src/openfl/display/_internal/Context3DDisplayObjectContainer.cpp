...
HXLINE(  28)						HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  28)						_g = (_g + 1);
...
HXLINE(  38)					HX_VARI_NAME(  ::openfl::display::DisplayObject,child1,"child") = _g3->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  38)					_g2 = (_g2 + 1);
...
HXLINE(  62)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  62)				_g = (_g + 1);

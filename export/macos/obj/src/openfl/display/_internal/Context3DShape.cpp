...
HXLINE(  42)				HX_VARI(  ::openfl::display3D::Context3D,context) = renderer->_hx___context3D;
HXLINE(  43)				HX_VARI(  ::openfl::geom::Rectangle,scale9Grid) = shape->_hx___worldScale9Grid;
HXLINE(  45)				HX_VARI(  ::openfl::display::Shader,shader) = renderer->_hx___initDisplayShader(shape->_hx___worldShader);
HXLINE(  46)				renderer->setShader(shader);
HXLINE(  47)				renderer->applyBitmapData(graphics->_hx___bitmap,true,null());
HXLINE(  49)				HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
HXLINE(  63)				HX_VARI(  ::openfl::display3D::VertexBuffer3D,vertexBuffer) = graphics->_hx___bitmap->getVertexBuffer(context,null(),null());
...
HXLINE(  66)				HX_VARI(  ::openfl::display3D::IndexBuffer3D,indexBuffer) = graphics->_hx___bitmap->getIndexBuffer(context,null());
...
void Context3DShape_obj::renderMask( ::openfl::display::DisplayObject shape, ::openfl::display::OpenGLRenderer renderer){
            	...
            	HX_STACK_ARG(renderer,"renderer")
HXLINE(  82)
HXLINE(  83)		HX_VARI(  ::openfl::display::Graphics,graphics) = shape->_hx___graphics;
...
HXLINE(  93)				HX_VARI(  ::openfl::display3D::Context3D,context) = renderer->_hx___context3D;
HXLINE(  95)				HX_VARI(  ::openfl::display::_internal::Context3DMaskShader,shader) = renderer->_hx___maskShader;
...
HXLINE( 101)				HX_VARI(  ::openfl::display3D::VertexBuffer3D,vertexBuffer) = graphics->_hx___bitmap->getVertexBuffer(context,null(),null());
...
HXLINE( 104)				HX_VARI(  ::openfl::display3D::IndexBuffer3D,indexBuffer) = graphics->_hx___bitmap->getIndexBuffer(context,null());

...
HXLINE(  20)		HX_VARI(  ::lime::graphics::cairo::Cairo,cairo) = renderer->cairo;
HXLINE(  22)		renderer->applyMatrix(bitmapData->_hx___renderTransform,cairo);
HXLINE(  24)		HX_VARI(  ::Dynamic,surface) = bitmapData->getSurface();
HXLINE(  26)		if (::hx::IsNotNull( surface )) {
HXLINE(  28)			HX_VARI(  ::Dynamic,pattern) = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(surface);

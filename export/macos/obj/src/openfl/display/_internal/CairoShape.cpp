...
HXLINE(  31)		HX_VARI( Float,alpha) = renderer->_hx___getAlpha(shape->_hx___worldAlpha);
HXLINE(  32)		if ((alpha <= 0)) {
HXLINE(  32)			return;
            		}
HXLINE(  34)		HX_VARI(  ::openfl::display::Graphics,graphics) = shape->_hx___graphics;
HXLINE(  36)		if (::hx::IsNotNull( graphics )) {
HXLINE(  38)			::openfl::display::_internal::CairoGraphics_obj::render(graphics,renderer);
HXLINE(  40)			HX_VARI( int,width) = graphics->_hx___width;
HXLINE(  41)			HX_VARI( int,height) = graphics->_hx___height;
HXLINE(  42)			HX_VARI(  ::lime::graphics::cairo::Cairo,cairo) = renderer->cairo;
...
HXLINE(  46)				HX_VARI(  ::openfl::geom::Matrix,transform) = graphics->_hx___worldTransform;
HXLINE(  47)				HX_VARI(  ::openfl::geom::Rectangle,scale9Grid) = shape->_hx___worldScale9Grid;
...
HXDLIN(  52)				if (_hx_tmp3) {
            					...
            					void _hx_run(Float sx,Float sy,Float sWidth,Float sHeight,Float dx,Float dy,Float dWidth,Float dHeight){
            						...
            						HX_STACK_ARG(dx,"dx")
            						HX_STACK_ARG(dy,"dy")
            						HX_STACK_ARG(dWidth,"dWidth")
            						HX_STACK_ARG(dHeight,"dHeight")
HXLINE(  96)
...
HXLINE(  57)					HX_VARI( Float,pixelRatio) = renderer->_hx___pixelRatio;
HXLINE(  60)					HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
HXLINE(  67)					HX_VARI(  ::openfl::geom::Rectangle,bounds) = graphics->_hx___bounds;
HXLINE(  69)					HX_VARI(  ::openfl::geom::Matrix,renderTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE(  71)					HX_VARI( Float,scaleX) = (graphics->_hx___renderTransform->a / graphics->_hx___bitmapScale);
HXLINE(  72)					HX_VARI( Float,scaleY) = (graphics->_hx___renderTransform->d / graphics->_hx___bitmapScale);
HXLINE(  73)					HX_VARI( Float,renderScaleX) = (scaleX * transform->a);
HXLINE(  74)					HX_VARI( Float,renderScaleY) = (scaleY * transform->d);
HXLINE(  76)					HX_VARI( Float,left) = ::Math_obj::max(( (Float)(1) ),( (Float)(::Math_obj::round((scale9Grid->x * scaleX))) ));
HXLINE(  77)					HX_VARI( int,top) = ::Math_obj::round((scale9Grid->y * scaleY));
HXLINE(  78)					Float right = bounds->get_right();
HXDLIN(  78)					HX_VARI_NAME( Float,right1,"right") = ::Math_obj::max(( (Float)(1) ),( (Float)(::Math_obj::round(((right - scale9Grid->get_right()) * scaleX))) ));
HXLINE(  79)					Float bottom = bounds->get_bottom();
HXDLIN(  79)					HX_VARI_NAME( int,bottom1,"bottom") = ::Math_obj::round(((bottom - scale9Grid->get_bottom()) * scaleY));
HXLINE(  80)					HX_VARI( int,centerWidth) = ::Math_obj::round((scale9Grid->width * scaleX));
HXLINE(  81)					HX_VARI( int,centerHeight) = ::Math_obj::round((scale9Grid->height * scaleY));
HXLINE(  83)					HX_VARI( int,renderLeft) = ::Math_obj::round((left / pixelRatio));
HXLINE(  84)					HX_VARI( int,renderTop) = ::Math_obj::round((( (Float)(top) ) / pixelRatio));
HXLINE(  85)					HX_VARI( int,renderRight) = ::Math_obj::round((right1 / pixelRatio));
HXLINE(  86)					HX_VARI( int,renderBottom) = ::Math_obj::round((( (Float)(bottom1) ) / pixelRatio));
HXLINE(  87)					HX_VARI( Float,renderCenterWidth) = (((bounds->width * renderScaleX) - ( (Float)(renderLeft) )) - ( (Float)(renderRight) ));
HXLINE(  88)					HX_VARI( Float,renderCenterHeight) = (((bounds->height * renderScaleY) - ( (Float)(renderTop) )) - ( (Float)(renderBottom) ));
HXLINE(  90)					HX_VARI(  ::Dynamic,pattern) = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(graphics->_hx___cairo->get_target());
HXLINE(  92)					::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,3);
HXLINE(  95)					HX_VARI(  ::Dynamic,drawImage) =  ::Dynamic(new _hx_Closure_0(alpha,renderer,cairo,pattern,transform,renderTransform));
...
HXLINE( 144)							HX_VARI( Float,renderWidth) = ((renderLeft + renderCenterWidth) + renderRight);
...
HXLINE( 152)								HX_VARI( Float,renderHeight) = ((renderTop + renderCenterHeight) + renderBottom);
...
HXLINE( 163)					HX_VARI_NAME(  ::openfl::geom::Matrix,renderTransform1,"renderTransform") = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();

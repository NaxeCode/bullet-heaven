...
HXLINE(  37)		HX_VARI( Float,alpha) = renderer->_hx___getAlpha(tilemap->_hx___worldAlpha);
...
HXLINE(  43)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE(  62)
HXLINE(  64)		HX_VARI(  ::lime::graphics::cairo::Cairo,cairo) = renderer->cairo;
HXLINE(  66)		HX_VARI(  ::openfl::geom::Matrix,tileTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE(  68)		HX_VARI( ::Array< ::Dynamic>,tiles) = group->_hx___tiles;
HXLINE(  70)		HX_VAR(  ::Dynamic,tile);
HXDLIN(  70)		HX_VAR(  ::openfl::display::Tileset,tileset);
HXDLIN(  70)		HX_VAR( Float,alpha);
HXDLIN(  70)		HX_VAR( bool,visible);
HXDLIN(  70)		HX_VARI(  ::Dynamic,blendMode) = null();
HXDLIN(  70)		HX_VAR( int,id);
HXDLIN(  70)		HX_VAR(  ::openfl::display::_Tileset::TileData,tileData);
HXDLIN(  70)		HX_VAR(  ::openfl::geom::Rectangle,tileRect);
HXDLIN(  70)		HX_VAR(  ::openfl::display::BitmapData,bitmapData);
HXLINE(  80)		{
HXLINE(  80)			int _g = 0;
HXDLIN(  80)			while((_g < tiles->length)){
HXLINE(  80)				HX_VARI_NAME(  ::openfl::display::Tile,tile1,"tile") = tiles->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN(  80)				_g = (_g + 1);

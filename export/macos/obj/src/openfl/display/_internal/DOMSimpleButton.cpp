...
HXLINE(  12)		{
HXLINE(  12)			HX_VARI(  ::Dynamic,previousState) = simpleButton->_hx___previousStates->iterator();
HXDLIN(  12)			while(( (bool)(previousState->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  12)				HX_VARI_NAME(  ::openfl::display::DisplayObject,previousState1,"previousState") = ( ( ::openfl::display::DisplayObject)(previousState->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );

...
HXLINE(  26)		HX_VARI( Float,alpha) = renderer->_hx___getAlpha(bitmap->_hx___worldAlpha);
...
HXLINE(  32)			HX_VARI(  ::lime::graphics::cairo::Cairo,cairo) = renderer->cairo;
...
HXLINE(  39)			HX_VARI(  ::Dynamic,surface) = bitmap->_hx___bitmapData->getSurface();
HXLINE(  41)			if (::hx::IsNotNull( surface )) {
HXLINE(  43)				HX_VARI(  ::Dynamic,pattern) = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(surface);
...
HXLINE(  71)		HX_VARI_NAME(  ::openfl::display::BitmapData,_hx___bitmapData,"__bitmapData") = bitmap->_hx___bitmapData;
HXLINE(  72)		HX_VARI_NAME(  ::openfl::display::Bitmap,_hx___cacheBitmap,"__cacheBitmap") = bitmap->_hx___cacheBitmap;

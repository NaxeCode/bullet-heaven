...
HXLINE(  65)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(  66)		HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE(  67)		HX_VARI(  ::openfl::geom::Matrix,parentTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
HXLINE(  94)
HXLINE(  95)			HX_VARI( ::Array< ::Dynamic>,_tiles) = _group->_hx___tiles;
HXLINE(  96)			HX_VARI( int,totalLength) = 0;
HXLINE(  97)			{
HXLINE(  97)				int _g = 0;
HXDLIN(  97)				while((_g < _tiles->length)){
HXLINE(  97)					HX_VARI(  ::openfl::display::Tile,tile) = _tiles->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN(  97)					_g = (_g + 1);
...
HXLINE( 103)			return totalLength;
            	...
            	HX_STACK_ARG(defaultTileset,"defaultTileset")
            	HX_STACK_ARG(alphaEnabled,"alphaEnabled")
            	HX_STACK_ARG(worldAlpha,"worldAlpha")
            	HX_STACK_ARG(colorTransformEnabled,"colorTransformEnabled")
            	HX_STACK_ARG(defaultColorTransform,"defaultColorTransform")
            	HX_STACK_ARG(cacheBitmapData,"cacheBitmapData")
            	HX_STACK_ARG(rect,"rect")
            	HX_STACK_ARG(matrix,"matrix")
            	HX_STACK_ARG(isTopLevel,"isTopLevel")
HXLINE(  86)
HXLINE(  87)		HX_VARI(  ::openfl::geom::Matrix,tileTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE(  88)		HX_VARI( bool,roundPixels) = renderer->_hx___roundPixels;
HXLINE(  90)		HX_VARI( ::Array< ::Dynamic>,tiles) = group->_hx___tiles;
HXLINE(  91)		HX_VARI( int,length) = group->__length;
HXLINE(  93)		HX_VARI( ::Array< ::Dynamic>,getLength) = ::Array_obj< ::Dynamic>::__new(1)->init(0,null());
...
HXLINE( 111)		HX_VAR(  ::Dynamic,tile);
HXDLIN( 111)		HX_VAR(  ::openfl::display::Tileset,tileset);
HXDLIN( 111)		HX_VAR( Float,alpha);
HXDLIN( 111)		HX_VAR( bool,visible);
HXDLIN( 111)		HX_VARI(  ::openfl::geom::ColorTransform,colorTransform) = null();
HXDLIN( 111)		HX_VAR( int,id);
HXDLIN( 111)		HX_VAR(  ::openfl::display::_Tileset::TileData,tileData);
HXDLIN( 111)		HX_VAR(  ::openfl::geom::Rectangle,tileRect);
HXDLIN( 111)		HX_VAR(  ::openfl::display::BitmapData,bitmapData);
HXLINE( 120)		HX_VAR( Float,tileWidth);
HXDLIN( 120)		HX_VAR( Float,tileHeight);
HXDLIN( 120)		HX_VAR( Float,uvX);
HXDLIN( 120)		HX_VAR( Float,uvY);
HXDLIN( 120)		HX_VAR( Float,uvHeight);
HXDLIN( 120)		HX_VAR( Float,uvWidth);
HXDLIN( 120)		HX_VAR( int,vertexOffset);
HXLINE( 121)		HX_VAR( Float,x);
HXDLIN( 121)		HX_VAR( Float,y);
HXDLIN( 121)		HX_VAR( Float,x2);
HXDLIN( 121)		HX_VAR( Float,y2);
HXDLIN( 121)		HX_VAR( Float,x3);
HXDLIN( 121)		HX_VAR( Float,y3);
HXDLIN( 121)		HX_VAR( Float,x4);
HXDLIN( 121)		HX_VAR( Float,y4);
HXLINE( 123)		HX_VARI( int,alphaPosition) = 4;
HXLINE( 124)		HX_VAR( int,ctPosition);
...
HXLINE( 126)				HX_VARI_NAME(  ::openfl::display::Tile,tile1,"tile") = tiles->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 126)				_g = (_g + 1);
...
HXDLIN( 264)								HX_VARI( int,i) = (_g1 - 1);
HXLINE( 266)								{
...
HXDLIN( 279)								HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 281)								{
...
HXLINE( 311)			HX_VARI(  ::openfl::display::Shader,shader) = renderer->_hx___initDisplayShader(::openfl::display::_internal::Context3DTilemap_obj::currentShader);
...
HXLINE( 342)			HX_VARI(  ::openfl::display3D::VertexBuffer3D,vertexBuffer) = tilemap->_hx___buffer->vertexBuffer;
HXLINE( 343)			HX_VARI( int,vertexBufferPosition) = ((::openfl::display::_internal::Context3DTilemap_obj::lastFlushedPosition * ::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex) * 4);
HXLINE( 344)			HX_VARI( int,length) = (::openfl::display::_internal::Context3DTilemap_obj::bufferPosition - ::openfl::display::_internal::Context3DTilemap_obj::lastFlushedPosition);
...
HXLINE( 371)					HX_VAR( int,position);
...
HXLINE( 425)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
void Context3DTilemap_obj::renderTileContainer( ::openfl::display::Tilemap tilemap, ::openfl::display::OpenGLRenderer renderer, ::openfl::display::TileContainer group, ::openfl::display::Shader defaultShader, ::openfl::display::Tileset defaultTileset,Float worldAlpha,bool blendModeEnabled, ::Dynamic defaultBlendMode, ::openfl::display::BitmapData cacheBitmapData){
            	...
            	HX_STACK_ARG(renderer,"renderer")
            	HX_STACK_ARG(group,"group")
            	HX_STACK_ARG(defaultShader,"defaultShader")
            	HX_STACK_ARG(defaultTileset,"defaultTileset")
            	HX_STACK_ARG(worldAlpha,"worldAlpha")
            	HX_STACK_ARG(blendModeEnabled,"blendModeEnabled")
            	HX_STACK_ARG(defaultBlendMode,"defaultBlendMode")
            	HX_STACK_ARG(cacheBitmapData,"cacheBitmapData")
HXLINE( 475)
HXLINE( 476)		HX_VARI( ::Array< ::Dynamic>,tiles) = group->_hx___tiles;
HXLINE( 478)		HX_VAR(  ::Dynamic,tile);
HXDLIN( 478)		HX_VAR(  ::openfl::display::Tileset,tileset);
HXDLIN( 478)		HX_VAR( Float,alpha);
HXDLIN( 478)		HX_VAR( bool,visible);
HXDLIN( 478)		HX_VARI(  ::Dynamic,blendMode) = null();
HXDLIN( 478)		HX_VAR( int,id);
HXDLIN( 478)		HX_VAR(  ::openfl::display::_Tileset::TileData,tileData);
HXDLIN( 478)		HX_VAR(  ::openfl::geom::Rectangle,tileRect);
HXDLIN( 478)		HX_VAR(  ::openfl::display::Shader,shader);
HXDLIN( 478)		HX_VAR(  ::openfl::display::BitmapData,bitmapData);
HXLINE( 489)		{
HXLINE( 489)			int _g = 0;
HXDLIN( 489)			while((_g < tiles->length)){
HXLINE( 489)				HX_VARI_NAME(  ::openfl::display::Tile,tile1,"tile") = tiles->__get(_g).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 489)				_g = (_g + 1);

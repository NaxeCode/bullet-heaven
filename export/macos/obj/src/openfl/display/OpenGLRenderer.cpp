...
HXLINE( 168)			return  ::openfl::display::Shape_obj::__alloc( HX_CTX );
            	...
            	HX_STACK_ARG(defaultRenderTarget,"defaultRenderTarget")
HXLINE( 107)
...
HXLINE( 245)
HXLINE( 246)		HX_VAR( bool,enabled);
...
HXLINE( 322)			HX_VARI( ::Array< Float >,values) = this->_hx___getMatrix(transform,1);
HXLINE( 324)			{
...
HXLINE( 494)
HXLINE( 495)		HX_VARI(  ::openfl::geom::Matrix,_matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
HXLINE( 600)		HX_VARI(  ::openfl::display::DisplayObject,mask) = this->_hx___maskObjects->pop().StaticCast<  ::openfl::display::DisplayObject >();
...
HXLINE( 688)				HX_VARI(  ::openfl::display::Shape,shape) = this->_hx___scrollRectMasks->get().StaticCast<  ::openfl::display::Shape >();
...
HXLINE( 716)		HX_VARI(  ::openfl::geom::Matrix,_matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 717)		_matrix->copyFrom(transform);
HXLINE( 718)		_matrix->concat(this->_hx___worldTransform);
HXLINE( 720)		HX_VARI(  ::openfl::geom::Rectangle,clipRect) = this->_hx___clipRects->__get(this->_hx___numClipRects).StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 721)		rect->_hx___transform(clipRect,_matrix);
HXLINE( 723)		if ((this->_hx___numClipRects > 0)) {
HXLINE( 725)			HX_VARI(  ::openfl::geom::Rectangle,parentClipRect) = this->_hx___clipRects->__get((this->_hx___numClipRects - 1)).StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE( 827)			HX_VARI(  ::openfl::display::DisplayObject,cacheMask) = ( ( ::openfl::display::DisplayObject)(object->__Field(HX_("__mask",0c,a4,4e,f7),::hx::paccDynamic)) );
HXLINE( 828)			HX_VARI(  ::openfl::geom::Rectangle,cacheScrollRect) = ( ( ::openfl::geom::Rectangle)(object->__Field(HX_("__scrollRect",f1,56,fa,41),::hx::paccDynamic)) );
...
HXLINE( 898)		HX_VARI(  ::openfl::display3D::textures::TextureBase,cacheRTT) = this->_hx___context3D->_hx___state->renderToTexture;
HXLINE( 899)		HX_VARI( bool,cacheRTTDepthStencil) = this->_hx___context3D->_hx___state->renderToTextureDepthStencil;
HXLINE( 900)		HX_VARI( int,cacheRTTAntiAlias) = this->_hx___context3D->_hx___state->renderToTextureAntiAlias;
HXLINE( 901)		HX_VARI( int,cacheRTTSurfaceSelector) = this->_hx___context3D->_hx___state->renderToTextureSurfaceSelector;
...
HXLINE( 910)		HX_VARI_NAME(  ::openfl::display::Shader,shader1,"shader") = this->_hx___initShader(shader);
...
HXLINE( 918)		HX_VARI(  ::openfl::display3D::VertexBuffer3D,vertexBuffer) = source->getVertexBuffer(this->_hx___context3D,null(),null());
...
HXLINE( 921)		HX_VARI(  ::openfl::display3D::IndexBuffer3D,indexBuffer) = source->getIndexBuffer(this->_hx___context3D,null());
...
void OpenGLRenderer_obj::_hx___resumeClipAndMask( ::openfl::display::OpenGLRenderer childRenderer){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(childRenderer,"childRenderer")
HXLINE( 954)
...
HXLINE( 980)			HX_VARI( int,x) = ::Math_obj::floor(clipRect->x);
HXLINE( 981)			HX_VARI( int,y) = ::Math_obj::floor(clipRect->y);
HXLINE( 982)			HX_VAR( int,width);

...
HXLINE( 267)		HX_VARI(  ::openfl::geom::Rectangle,clipRect) = this->_hx___clipRects->__get(this->_hx___numClipRects).StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 268)		rect->_hx___transform(clipRect,transform);
HXLINE( 270)		if ((this->_hx___numClipRects > 0)) {
HXLINE( 272)			HX_VARI(  ::openfl::geom::Rectangle,parentClipRect) = this->_hx___clipRects->__get((this->_hx___numClipRects - 1)).StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE( 472)			HX_VARI(  ::openfl::geom::Rectangle,clip) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 473)			HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();

...
HXLINE( 391)		HX_VARI(  ::openfl::events::Event,openEvent) =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("open",ca,03,b4,49),null(),null());
...
HXLINE( 400)			HX_VARI( ::String,extension) = HX_("",00,00,00,00);
HXLINE( 401)			this->_hx___path = request->url;
HXLINE( 403)			HX_VARI( int,queryIndex) = this->_hx___path.indexOf(HX_("?",3f,00,00,00),null());
...
HXLINE( 428)			HX_VARI( int,extIndex) = this->_hx___path.lastIndexOf(HX_(".",2e,00,00,00),null());
...
HXLINE( 465)		HX_VARI(  ::openfl::net::URLLoader,loader) =  ::openfl::net::URLLoader_obj::__alloc( HX_CTX ,null());
...
HXLINE( 705)
HXLINE( 706)		HX_VARI(  ::openfl::events::IOErrorEvent,event) =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),null(),null(),null(),null());
...
HXLINE( 751)
HXLINE( 752)		HX_VARI(  ::openfl::events::ProgressEvent,event) =  ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,HX_("progress",ad,f7,2a,86),null(),null(),null(),null());
...
HXLINE( 762)		HX_VARI(  ::openfl::net::URLLoader,loader) = ( ( ::openfl::net::URLLoader)(event->target) );
...
HXDLIN( 767)			HX_VARI(  ::lime::utils::AssetManifest,manifest) = ::lime::utils::AssetManifest_obj::parse(( (::String)(loader1) ),::haxe::io::Path_obj::directory(this->_hx___path));
HXLINE( 769)			if (::hx::IsNull( manifest )) {
HXLINE( 771)				this->_hx___dispatchError(HX_("Cannot parse asset manifest",49,e5,68,e9));
HXLINE( 772)				return;
            			}
HXLINE( 775)			HX_VARI(  ::lime::utils::AssetLibrary,library) = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
...
HXLINE( 795)					HX_VARI(  ::openfl::display::MovieClip,clip) = _gthis->_hx___library->getMovieClip(HX_("",00,00,00,00));

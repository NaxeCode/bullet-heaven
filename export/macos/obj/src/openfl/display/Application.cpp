...
HXLINE(  61)
HXLINE(  62)		HX_VARI(  ::openfl::display::Window,window) =  ::openfl::display::Window_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),attributes);
...
HXLINE( 102)			HX_VARI(  ::openfl::display::NativeWindowInitOptions,initOptions) =  ::openfl::display::NativeWindowInitOptions_obj::__alloc( HX_CTX );
...
HXLINE( 122)				HX_VARI( ::Array< ::String >,args) = ::Sys_obj::args();
HXLINE( 123)				HX_VARI(  ::openfl::filesystem::File,cwd) =  ::openfl::filesystem::File_obj::__alloc( HX_CTX ,::Sys_obj::getCwd());
HXLINE( 124)				HX_VARI(  ::openfl::events::InvokeEvent,invokeEvent) =  ::openfl::events::InvokeEvent_obj::__alloc( HX_CTX ,HX_("invoke",78,77,e0,9f),false,false,cwd,args,null());
...
HXLINE( 148)		HX_VARI(  ::openfl::events::Event,exitingEvent) =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("exiting",84,dc,da,24),false,true);
HXLINE( 149)		HX_VARI( bool,result) = ::openfl::desktop::NativeApplication_obj::get_nativeApplication()->dispatchEvent(exitingEvent);

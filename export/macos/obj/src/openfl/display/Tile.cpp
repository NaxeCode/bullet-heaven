...
bool Tile_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::Tile Tile_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 311)
HXLINE( 312)		HX_VARI(  ::openfl::display::Tile,tile) =  ::openfl::display::Tile_obj::__alloc( HX_CTX ,this->_hx___id,null(),null(),null(),null(),null(),null(),null());
...
HXLINE( 347)
HXLINE( 348)		HX_VARI(  ::openfl::geom::Rectangle,result) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE( 350)		this->_hx___findTileRect(result);
HXLINE( 353)		HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
HXLINE( 358)			HX_VARI(  ::openfl::geom::Matrix,targetMatrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
HXLINE( 438)			HX_VARI(  ::openfl::geom::Rectangle,currentBounds) = this->getBounds(::hx::ObjectPtr<OBJ_>(this));
HXLINE( 439)			HX_VARI(  ::openfl::geom::Rectangle,targetBounds) = obj->getBounds(::hx::ObjectPtr<OBJ_>(this));
...
HXLINE( 465)				HX_VARI(  ::openfl::display::Tileset,parentTileset) = this->parent->_hx___findTileset();
...
HXLINE( 477)						HX_VARI(  ::openfl::geom::Rectangle,not_null) = _g;
...
HX_DEFINE_DYNAMIC_FUNC0(Tile_obj,_hx___findTileset,return )
 ...
 ::openfl::geom::Matrix Tile_obj::_hx___getWorldTransform(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 512)
HXLINE( 513)		HX_VARI(  ::openfl::geom::Matrix,retval) = this->get_matrix()->clone();
...
Float Tile_obj::get_height(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 588)
HXLINE( 589)		HX_VARI(  ::openfl::geom::Rectangle,result) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 591)		this->_hx___findTileRect(result);
HXLINE( 593)		this->_hx___getBounds(result,this->get_matrix());
HXLINE( 594)		HX_VARI( Float,h) = result->height;
...
Float Tile_obj::set_height(Float value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 602)
HXLINE( 603)		HX_VARI(  ::openfl::geom::Rectangle,result) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE( 711)				HX_VARI( Float,radians) = (::Math_obj::atan2(this->_hx___matrix->d,this->_hx___matrix->c) - (::Math_obj::PI / ( (Float)(2) )));
...
HXLINE( 727)			HX_VARI( Float,radians) = (value * (::Math_obj::PI / ( (Float)(180) )));
HXLINE( 728)			this->_hx___rotationSine = ::Math_obj::sin(radians);
HXLINE( 729)			this->_hx___rotationCosine = ::Math_obj::cos(radians);
HXLINE( 731)			HX_VARI_NAME( Float,_hx___scaleX,"__scaleX") = this->get_scaleX();
HXLINE( 732)			HX_VARI_NAME( Float,_hx___scaleY,"__scaleY") = this->get_scaleY();
...
HXLINE( 774)				HX_VARI( Float,rotation) = this->get_rotation();
HXLINE( 776)				HX_VARI( Float,a) = (this->_hx___rotationCosine * value);
HXLINE( 777)				HX_VARI( Float,b) = (this->_hx___rotationSine * value);
...
HXLINE( 818)				HX_VARI( Float,rotation) = this->get_rotation();
HXLINE( 820)				HX_VARI( Float,c) = (-(this->_hx___rotationSine) * value);
HXLINE( 821)				HX_VARI( Float,d) = (this->_hx___rotationCosine * value);
...
Float Tile_obj::get_width(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 882)
HXLINE( 884)		HX_VARI(  ::openfl::geom::Rectangle,result) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 886)		this->_hx___findTileRect(result);
HXLINE( 888)		this->_hx___getBounds(result,this->get_matrix());
HXLINE( 889)		HX_VARI( Float,w) = result->width;
...
Float Tile_obj::set_width(Float value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 897)
HXLINE( 898)		HX_VARI(  ::openfl::geom::Rectangle,result) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();

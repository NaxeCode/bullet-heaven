...
void NativeWindow_obj::__construct( ::openfl::display::NativeWindowInitOptions initOptions){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(initOptions,"initOptions")
HXLINE(  71)
...
HXLINE( 186)			HX_VARI(  ::openfl::display::Application,app) = ::openfl::Lib_obj::get_application();
...
void NativeWindow_obj::window_onMove(Float x,Float y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE(1120)
HXLINE(1121)		HX_VARI(  ::openfl::geom::Rectangle,beforeBounds) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,this->_hx___previousX,this->_hx___previousY,this->_hx___window->_hx___width,this->_hx___window->_hx___height);
HXLINE(1122)		HX_VARI(  ::openfl::geom::Rectangle,afterBounds) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,this->_hx___window->_hx___x,this->_hx___window->_hx___y,this->_hx___window->_hx___width,this->_hx___window->_hx___height);
...
HXLINE(1129)
HXLINE(1130)		HX_VARI(  ::openfl::geom::Rectangle,beforeBounds) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,this->_hx___window->_hx___x,this->_hx___window->_hx___y,this->_hx___previousWidth,this->_hx___previousHeight);
HXLINE(1131)		HX_VARI(  ::openfl::geom::Rectangle,afterBounds) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,this->_hx___window->_hx___x,this->_hx___window->_hx___y,this->_hx___window->_hx___width,this->_hx___window->_hx___height);
...
void NativeWindow_obj::window_onMinimize(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1138)
HXLINE(1139)		HX_VARI(  ::Dynamic,beforeDisplayState) = this->_hx___previousDisplayState;
HXLINE(1140)		HX_VARI(  ::Dynamic,afterDisplayState) = 2;
...
void NativeWindow_obj::window_onMaximize(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1147)
HXLINE(1148)		HX_VARI(  ::Dynamic,beforeDisplayState) = this->_hx___previousDisplayState;
HXLINE(1149)		HX_VARI(  ::Dynamic,afterDisplayState) = 1;
...
void NativeWindow_obj::window_onRestore(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1156)
HXLINE(1157)		HX_VARI(  ::Dynamic,beforeDisplayState) = this->_hx___previousDisplayState;
HXLINE(1158)		HX_VARI(  ::Dynamic,afterDisplayState) = 0;
...
HXLINE(1169)			HX_VARI(  ::openfl::display::NativeWindow,childWindow) = this->_hx___ownedWindows->pop().StaticCast<  ::openfl::display::NativeWindow >();
...
HXLINE(1178)			HX_VARI( int,index) = this->_hx___initOptions->owner->_hx___ownedWindows->indexOf(::hx::ObjectPtr<OBJ_>(this),0);
...
HXLINE(1184)		HX_VARI_NAME( int,index1,"index") = ::openfl::desktop::NativeApplication_obj::get_nativeApplication()->_hx___openedWindows->indexOf(::hx::ObjectPtr<OBJ_>(this),null());

...
HXLINE( 163)			HX_VARI(  ::openfl::utils::AssetLibrary,library) = this->_hx___pendingBindLibrary;
HXLINE( 164)			HX_VARI( ::String,className) = this->_hx___pendingBindClassName;
...
HXLINE( 171)				HX_VARI(  ::Dynamic,method) = ::openfl::display::Sprite_obj::_hx___constructor;
...
HXLINE( 299)			HX_VARI(  ::openfl::geom::Point,point) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
...
HXLINE( 337)				HX_VARI( bool,hitTest) = this->hitArea->_hx___hitTest(x,y,shapeFlag,null(),true,hitObject);
...
HXLINE( 184)
HXLINE( 185)		HX_VARI(  ::openfl::display::Sprite,sprite) =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );

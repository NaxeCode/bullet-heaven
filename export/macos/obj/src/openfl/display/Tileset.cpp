...
HXLINE(  76)				HX_VARI(  ::openfl::geom::Rectangle,rect) = rects->__get(_g).StaticCast<  ::openfl::geom::Rectangle >();
HXDLIN(  76)				_g = (_g + 1);
...
HXLINE(  98)		HX_VARI(  ::openfl::display::_Tileset::TileData,tileData) =  ::openfl::display::_Tileset::TileData_obj::__alloc( HX_CTX ,rect);
...
HX_DEFINE_DYNAMIC_FUNC1(Tileset_obj,addRect,return )
 ...
 ::openfl::display::Tileset Tileset_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 111)
HXLINE( 112)		HX_VARI(  ::openfl::display::Tileset,tileset) =  ::openfl::display::Tileset_obj::__alloc( HX_CTX ,this->_hx___bitmapData,null());
HXLINE( 113)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 115)		{
HXLINE( 115)			int _g = 0;
HXDLIN( 115)			::Array< ::Dynamic> _g1 = this->_hx___data;
HXDLIN( 115)			while((_g < _g1->length)){
HXLINE( 115)				HX_VARI(  ::openfl::display::_Tileset::TileData,tileData) = _g1->__get(_g).StaticCast<  ::openfl::display::_Tileset::TileData >();
HXDLIN( 115)				_g = (_g + 1);
...
HXLINE( 138)				HX_VARI(  ::openfl::display::_Tileset::TileData,tileData) = _g1->__get(_g).StaticCast<  ::openfl::display::_Tileset::TileData >();
HXDLIN( 138)				_g = (_g + 1);
...
HX_DEFINE_DYNAMIC_FUNC1(Tileset_obj,getRect,return )
 ...
 ::Dynamic Tileset_obj::getRectID( ::openfl::geom::Rectangle rect){
            	...
            	HX_STACK_ARG(rect,"rect")
HXLINE( 178)
HXLINE( 179)		HX_VAR(  ::openfl::display::_Tileset::TileData,tileData);
HXLINE( 181)		{
HXLINE( 181)			int _g = 0;
HXDLIN( 181)			int _g1 = this->_hx___data->length;
HXDLIN( 181)			while((_g < _g1)){
HXLINE( 181)				_g = (_g + 1);
HXDLIN( 181)				HX_VARI( int,i) = (_g - 1);
...
HXLINE( 204)				HX_VARI(  ::openfl::display::_Tileset::TileData,data) = _g1->__get(_g).StaticCast<  ::openfl::display::_Tileset::TileData >();
HXDLIN( 204)				_g = (_g + 1);

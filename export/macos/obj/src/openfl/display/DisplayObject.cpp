...
HXLINE(1097)			HX_VARI( ::Array< ::Dynamic>,dispatchers) = ( (::Array< ::Dynamic>)(::openfl::display::DisplayObject_obj::_hx___broadcastEvents->get(type)) );
...
HXLINE(1123)			HX_VARI(  ::openfl::events::MouseEvent,mouseEvent) = ( ( ::openfl::events::MouseEvent)(event) );
...
HXLINE(1129)				HX_VARI(  ::openfl::events::TouchEvent,touchEvent) = ( ( ::openfl::events::TouchEvent)(event) );
...
HXLINE(1164)
HXLINE(1165)		HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
HXLINE(1171)			HX_VARI(  ::openfl::geom::Matrix,targetMatrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
HXLINE(1185)		HX_VARI(  ::openfl::geom::Rectangle,bounds) =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
...
HXLINE(1253)			HX_VARI(  ::openfl::geom::Rectangle,currentBounds) = this->getBounds(::hx::ObjectPtr<OBJ_>(this));
HXLINE(1254)			HX_VARI(  ::openfl::geom::Rectangle,targetBounds) = obj->getBounds(::hx::ObjectPtr<OBJ_>(this));
...
HXLINE(1400)			HX_VARI( bool,result) = this->super::_hx___dispatchEvent(event);
...
bool DisplayObject_obj::_hx___dispatchEvent( ::openfl::events::Event event){
            	...
            	HX_STACK_ARG(event,"event")
HXLINE(1416)
HXLINE(1417)		HX_VAR(  ::openfl::display::DisplayObjectContainer,parent);
...
HXLINE(1418)		HX_VARI( bool,result) = this->super::_hx___dispatchEvent(event);
...
HXLINE(1457)				HX_VARI(  ::openfl::_Vector::ObjectVector,stack) = ::openfl::display::DisplayObject_obj::_hx___tempStack->get().StaticCast<  ::openfl::_Vector::ObjectVector >();
HXLINE(1458)				HX_VARI(  ::openfl::display::DisplayObjectContainer,parent) = this->parent;
HXLINE(1459)				HX_VARI( int,i) = 0;
...
HXLINE(1468)						_g = (_g + 1);
HXDLIN(1468)						HX_VARI( int,j) = (_g - 1);
...
HXLINE(1503)			HX_VARI(  ::openfl::geom::Rectangle,extension) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(1505)			{
HXLINE(1505)				int _g = 0;
HXDLIN(1505)				::Array< ::Dynamic> _g1 = this->_hx___filters;
HXDLIN(1505)				while((_g < _g1->length)){
HXLINE(1505)					HX_VARI(  ::openfl::filters::BitmapFilter,filter) = _g1->__get(_g).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN(1505)					_g = (_g + 1);
...
HXLINE(1553)			HX_VARI(  ::openfl::geom::Rectangle,r) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HX_DEFINE_DYNAMIC_FUNC0(DisplayObject_obj,_hx___getRenderTransform,return )
 ...
 ::openfl::geom::Matrix DisplayObject_obj::_hx___getWorldTransform(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1568)
HXLINE(1569)		HX_VAR( bool,transformDirty);
...
HXLINE(1573)			HX_VARI( ::Array< ::Dynamic>,list) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1574)			HX_VARI(  ::openfl::display::DisplayObject,current) = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE(1591)			HX_VARI( int,i) = list->length;
...
void DisplayObject_obj::_hx___setParentRenderDirty(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1662)
HXLINE(1663)		HX_VAR(  ::openfl::display::DisplayObject,renderParent);
...
HXLINE(1704)
HXLINE(1705)		HX_VAR(  ::openfl::display::DisplayObject,renderParent);
...
HXLINE(1829)
HXLINE(1830)		HX_VARI( bool,overrided) = ::hx::IsNotNull( overrideTransform );
HXLINE(1831)		HX_VAR(  ::openfl::geom::Matrix,local);
...
HXLINE(1843)		HX_VAR(  ::openfl::display::DisplayObject,renderParent);
...
HXLINE(1939)			HX_VARI( ::Array< ::Dynamic>,clonedFilters) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1941)			{
HXLINE(1941)				int _g = 0;
HXDLIN(1941)				while((_g < value->length)){
HXLINE(1941)					HX_VARI(  ::openfl::filters::BitmapFilter,filter) = value->__get(_g).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN(1941)					_g = (_g + 1);
HXLINE(1943)					HX_VARI(  ::openfl::filters::BitmapFilter,clonedFilter) = filter->clone();
...
Float DisplayObject_obj::get_height(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1964)
HXLINE(1965)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(1966)		this->_hx___getLocalBounds(rect);
HXLINE(1967)		HX_VARI( Float,height) = rect->height;
...
Float DisplayObject_obj::set_height(Float value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE(1973)
HXLINE(1974)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(1975)		HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
...
Float DisplayObject_obj::get_mouseX(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2047)
HXLINE(2048)		HX_VAR( Float,mouseX);
...
HXLINE(2049)		HX_VAR( Float,mouseY);
...
Float DisplayObject_obj::get_mouseY(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2055)
HXLINE(2056)		HX_VAR( Float,mouseX);
...
HXLINE(2057)		HX_VAR( Float,mouseY);
...
HXLINE(2092)			HX_VARI( Float,radians) = (this->_hx___rotation * (::Math_obj::PI / ( (Float)(180) )));
...
HXLINE(2155)				HX_VARI( Float,a) = (this->_hx___rotationCosine * value);
HXLINE(2156)				HX_VARI( Float,b) = (this->_hx___rotationSine * value);
...
HXLINE(2189)				HX_VARI( Float,c) = (-(this->_hx___rotationSine) * value);
HXLINE(2190)				HX_VARI( Float,d) = (this->_hx___rotationCosine * value);
...
Float DisplayObject_obj::get_width(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2299)
HXLINE(2300)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(2301)		this->_hx___getLocalBounds(rect);
HXLINE(2302)		HX_VARI( Float,width) = rect->width;
...
Float DisplayObject_obj::set_width(Float value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE(2308)
HXLINE(2309)		HX_VARI(  ::openfl::geom::Rectangle,rect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(2310)		HX_VARI(  ::openfl::geom::Matrix,matrix) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();

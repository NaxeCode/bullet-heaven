...
HXLINE( 271)				HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
HXDLIN( 271)				_g = (_g + 1);
...
HXLINE( 276)				HX_VARI_NAME(  ::openfl::display::ShaderParameter_Float,parameter1,"parameter") = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 281)				HX_VARI_NAME(  ::openfl::display::ShaderParameter_Int,parameter2,"parameter") = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
HXLINE( 318)
HXLINE( 319)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 321)		HX_VARI(  ::lime::graphics::opengl::GLObject,shader) = gl->createShader(type);
HXLINE( 322)		gl->shaderSource(shader,source);
HXLINE( 323)		gl->compileShader(shader);
HXLINE( 324)		HX_VARI( ::String,shaderInfoLog) = gl->getShaderInfoLog(shader);
HXLINE( 325)		HX_VAR( bool,hasInfoLog);
...
HXLINE( 326)		HX_VARI( int,compileStatus) = ( (int)(gl->getShaderParameter(shader,gl->COMPILE_STATUS)) );
...
HXLINE( 330)			HX_VAR( ::String,message);
...
HXLINE( 342)
HXLINE( 343)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 345)		HX_VARI(  ::lime::graphics::opengl::GLObject,vertexShader) = this->_hx___createGLShader(vertexSource,gl->VERTEX_SHADER);
HXLINE( 346)		HX_VARI(  ::lime::graphics::opengl::GLObject,fragmentShader) = this->_hx___createGLShader(fragmentSource,gl->FRAGMENT_SHADER);
HXLINE( 348)		HX_VARI(  ::lime::graphics::opengl::GLObject,program) = gl->createProgram();
HXLINE( 351)		{
HXLINE( 351)			int _g = 0;
HXDLIN( 351)			::Array< ::Dynamic> _g1 = this->_hx___paramFloat;
HXDLIN( 351)			while((_g < _g1->length)){
HXLINE( 351)				HX_VARI(  ::openfl::display::ShaderParameter_Float,param) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 351)				_g = (_g + 1);
...
HXLINE( 366)			HX_VARI( ::String,message) = HX_("Unable to initialize the shader program",f0,86,8b,39);
...
void Shader_obj::_hx___disableGL(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 383)
HXLINE( 384)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 386)		HX_VARI( int,textureCount) = 0;
HXLINE( 388)		{
HXLINE( 388)			int _g = 0;
HXDLIN( 388)			::Array< ::Dynamic> _g1 = this->_hx___inputBitmapData;
HXDLIN( 388)			while((_g < _g1->length)){
HXLINE( 388)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 388)				_g = (_g + 1);
...
HXLINE( 395)				HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
...
HXLINE( 400)				HX_VARI_NAME(  ::openfl::display::ShaderParameter_Float,parameter1,"parameter") = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 405)				HX_VARI_NAME(  ::openfl::display::ShaderParameter_Int,parameter2,"parameter") = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
void Shader_obj::_hx___enableGL(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 431)
HXLINE( 432)		HX_VARI( int,textureCount) = 0;
HXLINE( 434)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 436)		{
HXLINE( 436)			int _g = 0;
HXDLIN( 436)			::Array< ::Dynamic> _g1 = this->_hx___inputBitmapData;
HXDLIN( 436)			while((_g < _g1->length)){
HXLINE( 436)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 436)				_g = (_g + 1);
...
HXLINE( 482)			HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 487)			HX_VARI_NAME( ::String,prefix1,"prefix") = ((HX_("#ifdef GL_ES\n",3d,09,5c,91) + prefix) + HX_("#endif\n\n",75,fd,e5,0e));
HXLINE( 496)			HX_VARI( ::String,vertex) = (prefix1 + this->get_glVertexSource());
HXLINE( 497)			HX_VARI( ::String,fragment) = (prefix1 + this->get_glFragmentSource());
HXLINE( 499)			HX_VARI( ::String,id) = (vertex + fragment);
...
HXLINE( 520)						HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 520)						_g = (_g + 1);
...
HXLINE( 532)						HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
...
HXLINE( 544)						HX_VARI_NAME(  ::openfl::display::ShaderParameter_Float,parameter1,"parameter") = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 556)						HX_VARI_NAME(  ::openfl::display::ShaderParameter_Int,parameter2,"parameter") = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
HXLINE( 572)
HXLINE( 573)		HX_VARI( int,lastMatch) = 0;
HXDLIN( 573)		HX_VAR(  ::Dynamic,position);
HXDLIN( 573)		HX_VAR(  ::EReg,regex);
HXDLIN( 573)		HX_VAR( ::String,name);
HXDLIN( 573)		HX_VAR( ::String,type);
...
HXLINE( 594)			HX_VARI( bool,isUniform) = (storageType == HX_("uniform",34,41,64,b5));
HXLINE( 596)			if (::StringTools_obj::startsWith(type,HX_("sampler",08,c5,c9,83))) {
HXLINE( 598)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) =  ::openfl::display::ShaderInput_openfl_display_BitmapData_obj::__alloc( HX_CTX );
...
HXLINE( 617)					HX_VAR(  ::Dynamic,parameterType);
...
HXLINE( 643)						length = 1;
            					...
            					_hx_goto_26:;
HXLINE( 653)					HX_VAR( int,arrayLength);
...
HXLINE( 664)						HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) =  ::openfl::display::ShaderParameter_Bool_obj::__alloc( HX_CTX );
...
HXLINE( 682)						HX_VARI_NAME(  ::openfl::display::ShaderParameter_Int,parameter1,"parameter") =  ::openfl::display::ShaderParameter_Int_obj::__alloc( HX_CTX );
...
HXLINE( 681)						goto _hx_goto_29;
            					...
            					/* default */{
HXLINE( 694)						HX_VARI_NAME(  ::openfl::display::ShaderParameter_Float,parameter2,"parameter") =  ::openfl::display::ShaderParameter_Float_obj::__alloc( HX_CTX );
...
void Shader_obj::_hx___updateFromBuffer( ::openfl::display::_internal::ShaderBuffer shaderBuffer,int bufferOffset){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shaderBuffer,"shaderBuffer")
...
void Shader_obj::_hx___updateGL(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 748)
HXLINE( 749)		HX_VARI( int,textureCount) = 0;
HXLINE( 751)		{
HXLINE( 751)			int _g = 0;
HXDLIN( 751)			::Array< ::Dynamic> _g1 = this->_hx___inputBitmapData;
HXDLIN( 751)			while((_g < _g1->length)){
HXLINE( 751)				HX_VARI(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input) = _g1->__get(_g).StaticCast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >();
HXDLIN( 751)				_g = (_g + 1);
...
HXLINE( 757)				HX_VARI(  ::openfl::display::ShaderParameter_Bool,parameter) = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
...
HXLINE( 762)				HX_VARI_NAME(  ::openfl::display::ShaderParameter_Float,parameter1,"parameter") = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
...
HXLINE( 767)				HX_VARI_NAME(  ::openfl::display::ShaderParameter_Int,parameter2,"parameter") = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
...
void Shader_obj::_hx___updateGLFromBuffer( ::openfl::display::_internal::ShaderBuffer shaderBuffer,int bufferOffset){
            	...
            	HX_STACK_ARG(bufferOffset,"bufferOffset")
HXLINE( 774)
HXLINE( 775)		HX_VARI( int,textureCount) = 0;
HXLINE( 776)		HX_VAR(  ::openfl::display::ShaderInput_openfl_display_BitmapData,input);
HXDLIN( 776)		HX_VAR(  ::openfl::display::BitmapData,inputData);
HXDLIN( 776)		HX_VAR(  ::Dynamic,inputFilter);
HXDLIN( 776)		HX_VAR(  ::Dynamic,inputMipFilter);
HXDLIN( 776)		HX_VAR(  ::Dynamic,inputWrap);
HXLINE( 778)		{
HXLINE( 778)			int _g = 0;
HXDLIN( 778)			int _g1 = shaderBuffer->inputCount;
HXDLIN( 778)			while((_g < _g1)){
HXLINE( 778)				_g = (_g + 1);
HXDLIN( 778)				HX_VARI( int,i) = (_g - 1);
...
HXLINE( 793)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 814)		HX_VARI( int,boolIndex) = 0;
HXLINE( 815)		HX_VARI( int,floatIndex) = 0;
HXLINE( 816)		HX_VARI( int,intIndex) = 0;
HXLINE( 818)		HX_VARI( int,boolCount) = shaderBuffer->paramBoolCount;
HXLINE( 819)		HX_VARI( int,floatCount) = shaderBuffer->paramFloatCount;
HXLINE( 820)		HX_VARI(  ::lime::utils::ArrayBufferView,paramData) = shaderBuffer->paramData;
HXLINE( 822)		HX_VAR(  ::openfl::display::ShaderParameter_Bool,boolRef);
HXDLIN( 822)		HX_VAR(  ::openfl::display::ShaderParameter_Float,floatRef);
HXDLIN( 822)		HX_VAR(  ::openfl::display::ShaderParameter_Int,intRef);
HXDLIN( 822)		HX_VAR( bool,hasOverride);
HXLINE( 823)		HX_VARI( ::Array< bool >,overrideBoolValue) = null();
HXDLIN( 823)		HX_VARI( ::Array< Float >,overrideFloatValue) = null();
HXDLIN( 823)		HX_VARI( ::Array< int >,overrideIntValue) = null();
HXLINE( 827)		{
HXLINE( 827)			int _g2 = 0;
HXDLIN( 827)			int _g3 = shaderBuffer->paramCount;
HXDLIN( 827)			while((_g2 < _g3)){
HXLINE( 827)				_g2 = (_g2 + 1);
HXDLIN( 827)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
HXDLIN( 835)							HX_VARI( int,j) = (_g4 - 1);
...
HXDLIN( 860)								HX_VARI_NAME( int,j1,"j") = (_g6 - 1);
...
HXDLIN( 885)								HX_VARI_NAME( int,j2,"j") = (_g8 - 1);

...
HXLINE( 188)			HX_VARI(  ::Dynamic,method) = ::openfl::display::SimpleButton_obj::_hx___constructor;
...
HXLINE( 199)		HX_VARI(  ::openfl::geom::Matrix,childWorldTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 201)		{
...
HXLINE( 220)		HX_VARI(  ::openfl::geom::Matrix,childWorldTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 222)		{
...
HXLINE( 236)
HXLINE( 237)		HX_VARI( bool,hitTest) = false;
...
bool SimpleButton_obj::_hx___hitTestMask(Float x,Float y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE( 285)
HXLINE( 286)		HX_VARI( bool,hitTest) = false;

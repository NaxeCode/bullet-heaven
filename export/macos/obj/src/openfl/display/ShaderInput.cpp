...
HXLINE( 155)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
...
HXLINE( 161)
HXLINE( 162)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
HXLINE( 163)		HX_VAR(  ::Dynamic,input);
...
HXLINE( 164)		HX_VAR(  ::Dynamic,filter);
...
HXLINE( 165)		HX_VAR(  ::Dynamic,mipFilter);
...
HXLINE( 166)		HX_VAR(  ::Dynamic,wrap);
...
HXLINE( 172)			HX_VARI(  ::openfl::display::BitmapData,bitmapData) = ( ( ::openfl::display::BitmapData)(input) );

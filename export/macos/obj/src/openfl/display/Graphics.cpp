...
HXDLIN( 315)					HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
HXLINE( 325)				HX_VARI( Float,alpha) = alphas->__get(_g4);
...
HXLINE( 392)			HX_VARI(  ::openfl::display::_internal::ShaderBuffer,shaderBuffer) = this->_hx___shaderBufferPool->get().StaticCast<  ::openfl::display::_internal::ShaderBuffer >();
...
HXDLIN( 409)				HX_VARI(  ::openfl::display::_internal::ShaderBuffer,shaderBuffer) = val;
...
HXLINE( 494)
HXLINE( 495)		HX_VARI(  ::Dynamic,xs) = this->_hx___findExtrema(this->_hx___positionX,controlX1,controlX2,anchorX);
HXLINE( 496)		HX_VARI(  ::Dynamic,ys) = this->_hx___findExtrema(this->_hx___positionY,controlY1,controlY2,anchorY);
...
HXLINE( 546)		HX_VAR( Float,ix);
HXDLIN( 546)		HX_VAR( Float,iy);
...
HXLINE( 554)			HX_VARI( Float,tx) = ((this->_hx___positionX - controlX) / ((this->_hx___positionX - (( (Float)(2) ) * controlX)) + anchorX));
...
HXLINE( 564)			HX_VARI( Float,ty) = ((this->_hx___positionY - controlY) / ((this->_hx___positionY - (( (Float)(2) ) * controlY)) + anchorY));
...
HXLINE( 635)
HXLINE( 636)		HX_VAR(  ::openfl::display::GraphicsSolidFill,fill);
HXLINE( 637)		HX_VAR(  ::openfl::display::GraphicsBitmapFill,bitmapFill);
HXLINE( 638)		HX_VAR(  ::openfl::display::GraphicsGradientFill,gradientFill);
HXLINE( 639)		HX_VAR(  ::openfl::display::GraphicsShaderFill,shaderFill);
HXLINE( 640)		HX_VAR(  ::openfl::display::GraphicsStroke,stroke);
HXLINE( 641)		HX_VAR(  ::openfl::display::GraphicsPath,path);
HXLINE( 642)		HX_VAR(  ::openfl::display::GraphicsTrianglePath,trianglePath);
HXLINE( 643)		HX_VAR(  ::openfl::display::GraphicsQuadPath,quadPath);
HXLINE( 645)		{
HXLINE( 645)			HX_VARI(  ::Dynamic,graphics) = graphicsData->iterator();
HXDLIN( 645)			while(( (bool)(graphics->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 645)				HX_VARI_NAME( ::Dynamic,graphics1,"graphics") = graphics->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
...
HXLINE( 671)							HX_VARI(  ::Dynamic,thickness) = stroke->thickness;
...
HXLINE( 766)
HXLINE( 767)		HX_VARI( int,dataIndex) = 0;
HXLINE( 769)		if (::hx::IsEq( winding,1 )) {
HXLINE( 769)			this->_hx___commands->windingNonZero();
            		}
HXLINE( 771)		{
HXLINE( 771)			HX_VARI(  ::Dynamic,command) = commands->iterator();
HXDLIN( 771)			while(( (bool)(command->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 771)				HX_VARI_NAME( int,command1,"command") = ( (int)(command->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 842)		HX_VARI( bool,hasIndices) = ::hx::IsNotNull( indices );
HXLINE( 843)		HX_VARI( bool,transformABCD) = false;
HXDLIN( 843)		HX_VARI( bool,transformXY) = false;
HXLINE( 845)		HX_VAR( int,length);
...
HXLINE( 865)		HX_VARI(  ::openfl::geom::Rectangle,tileRect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 866)		HX_VARI(  ::openfl::geom::Matrix,tileTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 868)		HX_VARI( Float,minX) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 869)		HX_VARI( Float,minY) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 870)		HX_VARI( Float,maxX) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 871)		HX_VARI( Float,maxY) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 873)		HX_VAR( int,ri);
HXDLIN( 873)		HX_VAR( int,ti);
HXLINE( 875)		{
HXLINE( 875)			int _g = 0;
HXDLIN( 875)			int _g1 = length;
HXDLIN( 875)			while((_g < _g1)){
HXLINE( 875)				_g = (_g + 1);
HXDLIN( 875)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(1012)		HX_VARI( Float,xw) = (x + width);
HXLINE(1013)		HX_VARI( Float,yh) = (y + height);
HXLINE(1014)		HX_VAR( Float,minSize);
...
HXLINE(1020)		HX_VARI( Float,anchor) = (( (Float)(1) ) - ::Math_obj::sin((( (Float)(45) ) * (::Math_obj::PI / ( (Float)(180) )))));
HXLINE(1021)		HX_VARI( Float,control) = (( (Float)(1) ) - ::Math_obj::tan((((Float)22.5) * (::Math_obj::PI / ( (Float)(180) )))));
HXLINE(1023)		HX_VARI( Float,a) = (bottomRightRadius * anchor);
HXLINE(1024)		HX_VARI( Float,s) = (bottomRightRadius * control);
...
HXLINE(1074)		HX_VARI( int,vertLength) = ::Std_obj::_hx_int((( (Float)(vertices->get_length()) ) / ( (Float)(2) )));
...
HXLINE(1087)					_g = (_g + 1);
HXDLIN(1087)					HX_VARI( int,i) = (_g - 1);
...
HXLINE(1098)		HX_VAR( Float,x);
HXDLIN(1098)		HX_VAR( Float,y);
HXLINE(1099)		HX_VARI( Float,minX) = ::Math_obj::POSITIVE_INFINITY;
HXLINE(1100)		HX_VARI( Float,minY) = ::Math_obj::POSITIVE_INFINITY;
HXLINE(1101)		HX_VARI( Float,maxX) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE(1102)		HX_VARI( Float,maxY) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE(1104)		{
HXLINE(1104)			int _g2 = 0;
HXDLIN(1104)			int _g3 = vertLength;
HXDLIN(1104)			while((_g2 < _g3)){
HXLINE(1104)				_g2 = (_g2 + 1);
HXDLIN(1104)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
HXLINE(1254)					_g = (_g + 1);
HXDLIN(1254)					HX_VARI( int,i) = (_g - 1);
...
HXDLIN(1264)					HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
HXDLIN(1598)		HX_VARI(  ::openfl::_Vector::ObjectVector,graphicsData) =  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,length,fixed,array,true);
...
Float Graphics_obj::_hx___calculateBezierCubicPoint(Float t,Float p1,Float p2,Float p3,Float p4){
            	...
            	HX_STACK_ARG(p4,"p4")
HXLINE(1605)
HXLINE(1606)		HX_VARI( Float,iT) = (( (Float)(1) ) - t);
...
Float Graphics_obj::_hx___calculateBezierQuadPoint(Float t,Float p1,Float p2,Float p3){
            	...
            	HX_STACK_ARG(p3,"p3")
HXLINE(1612)
HXLINE(1613)		HX_VARI( Float,iT) = (( (Float)(1) ) - t);
...
HXLINE(1647)		HX_VARI(  ::openfl::geom::Rectangle,bounds) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HX_DEFINE_DYNAMIC_FUNC4(Graphics_obj,_hx___hitTest,return )
 ...
 ::Dynamic Graphics_obj::_hx___findExtrema(Float p1,Float p2,Float p3,Float p4){
            	...
            	HX_STACK_ARG(p4,"p4")
HXLINE(1678)
HXLINE(1679)		HX_VARI( ::Array< Float >,solutions) = ::Array_obj< Float >::__new(0);
...
HXLINE(1684)			HX_VARI( Float,a) = (((-(p1) + (( (Float)(3) ) * p2)) + p4) - (( (Float)(3) ) * p3));
HXLINE(1685)			HX_VARI( Float,b) = (((( (Float)(2) ) * p1) - (( (Float)(4) ) * p2)) + (( (Float)(2) ) * p3));
HXLINE(1686)			HX_VARI( Float,c) = (p2 - p1);
HXLINE(1688)			HX_VARI( Float,d) = ((b * b) - ((( (Float)(4) ) * a) * c));
HXLINE(1689)			if ((a == 0)) {
HXLINE(1691)				HX_VARI( Float,t) = (-(c) / b);
...
HXLINE(1697)				if ((d >= 0)) {
HXLINE(1699)					HX_VARI( Float,t1) = ((-(b) + ::Math_obj::sqrt(d)) / (( (Float)(2) ) * a));
HXLINE(1700)					HX_VARI( Float,t2) = ((-(b) - ::Math_obj::sqrt(d)) / (( (Float)(2) ) * a));
...
HXLINE(1711)		HX_VARI( Float,min) = p1;
HXLINE(1712)		HX_VARI( Float,max) = p1;
HXLINE(1713)		solutions->push(p4);
HXLINE(1714)		{
HXLINE(1714)			int _g = 0;
HXDLIN(1714)			while((_g < solutions->length)){
HXLINE(1714)				HX_VARI( Float,val) = solutions->__get(_g);
HXDLIN(1714)				_g = (_g + 1);
...
void Graphics_obj::_hx___readGraphicsData( ::openfl::_Vector::ObjectVector graphicsData){
            	...
            	HX_STACK_ARG(graphicsData,"graphicsData")
HXLINE(1763)
HXLINE(1764)		HX_VARI(  ::openfl::display::_internal::DrawCommandReader,data) =  ::openfl::display::_internal::DrawCommandReader_obj::__alloc( HX_CTX ,this->_hx___commands);
HXLINE(1765)		HX_VARI(  ::openfl::display::GraphicsPath,path) = null();
HXDLIN(1765)		HX_VAR(  ::openfl::display::GraphicsStroke,stroke);
HXLINE(1767)		{
HXLINE(1767)			int _g = 0;
HXDLIN(1767)			::Array< ::Dynamic> _g1 = this->_hx___commands->types;
HXDLIN(1767)			while((_g < _g1->length)){
HXLINE(1767)				HX_VARI(  ::openfl::display::_internal::DrawCommandType,type) = _g1->__get(_g).StaticCast<  ::openfl::display::_internal::DrawCommandType >();
HXDLIN(1767)				_g = (_g + 1);
...
HXDLIN(1847)						HX_VARI(  ::openfl::display::_internal::DrawCommandReader,c) = data;
...
HXDLIN(1851)						HX_VARI_NAME(  ::openfl::display::_internal::DrawCommandReader,c1,"c") = data;
...
HXDLIN(1855)						HX_VARI_NAME(  ::openfl::display::_internal::DrawCommandReader,c2,"c") = data;
...
HXDLIN(1788)						HX_VARI_NAME(  ::openfl::display::_internal::DrawCommandReader,c3,"c") = data;
...
HXDLIN(1792)						HX_VARI_NAME(  ::openfl::display::_internal::DrawCommandReader,c4,"c") = data;
...
HXDLIN(1804)						HX_VARI_NAME(  ::openfl::display::_internal::DrawCommandReader,c5,"c") = data;
...
HXDLIN(1808)						HX_VARI_NAME(  ::openfl::display::_internal::DrawCommandReader,c6,"c") = data;
...
HXDLIN(1812)						HX_VARI_NAME(  ::openfl::display::_internal::DrawCommandReader,c7,"c") = data;
...
HXDLIN(1816)						HX_VARI_NAME(  ::openfl::display::_internal::DrawCommandReader,c8,"c") = data;
...
HXDLIN(1830)						HX_VARI_NAME(  ::openfl::display::_internal::DrawCommandReader,c9,"c") = data;
...
HXDLIN(1822)						HX_VARI_NAME(  ::openfl::display::_internal::DrawCommandReader,c10,"c") = data;
            					}
            					break;
            					case (int)16: {
...
HXDLIN(1837)						HX_VARI_NAME(  ::openfl::display::_internal::DrawCommandReader,c11,"c") = data;
...
HXDLIN(1796)						HX_VARI_NAME(  ::openfl::display::_internal::DrawCommandReader,c12,"c") = data;
...
HXDLIN(1800)						HX_VARI_NAME(  ::openfl::display::_internal::DrawCommandReader,c13,"c") = data;
...
HXLINE(1876)		HX_VARI(  ::openfl::geom::Matrix,parentTransform) = this->_hx___owner->_hx___renderTransform;
HXLINE(1877)		if (::hx::IsNull( parentTransform )) {
HXLINE(1877)			return;
            		}
HXLINE(1879)		HX_VARI( Float,scaleX) = pixelRatio;
HXDLIN(1879)		HX_VARI( Float,scaleY) = pixelRatio;
...
HXLINE(1928)		HX_VARI( Float,width) = (this->_hx___bounds->width * scaleX);
HXLINE(1929)		HX_VARI( Float,height) = (this->_hx___bounds->height * scaleY);
...
HXLINE(1951)		HX_VAR( Float,inverseA);
HXDLIN(1951)		HX_VAR( Float,inverseD);
...
HXLINE(1974)		HX_VARI( Float,x) = this->_hx___bounds->x;
HXLINE(1975)		HX_VARI( Float,y) = this->_hx___bounds->y;
HXLINE(1976)		HX_VARI( Float,tx) = (((x * parentTransform->a) + (y * parentTransform->c)) + parentTransform->tx);
HXLINE(1977)		HX_VARI( Float,ty) = (((x * parentTransform->b) + (y * parentTransform->d)) + parentTransform->ty);
HXLINE(1984)		if ((pixelRatio > ((Float)1.0))) {
HXLINE(1990)			HX_VARI( Float,nativePixelSize) = (( (Float)(1) ) / pixelRatio);
...
HXLINE(2009)		HX_VARI( int,newWidth) = ::Math_obj::ceil((width + ((Float)1.0)));
HXLINE(2010)		HX_VARI( int,newHeight) = ::Math_obj::ceil((height + ((Float)1.0)));

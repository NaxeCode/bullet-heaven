...
HXLINE( 120)		HX_VARI( int,backgroundColor) = this->getBackgroundColor();
HXLINE( 121)		HX_VARI( int,r) = ((backgroundColor >> 16) & 255);
HXLINE( 122)		HX_VARI( int,g) = ((backgroundColor >> 8) & 255);
HXLINE( 123)		HX_VARI( int,b) = (backgroundColor & 255);
HXLINE( 124)		HX_VARI( Float,perceivedLuminosity) = (((((Float)0.299) * ( (Float)(r) )) + (((Float)0.587) * ( (Float)(g) ))) + (((Float)0.114) * ( (Float)(b) )));
HXLINE( 125)		HX_VARI( int,color) = 0;
HXLINE( 127)		if ((perceivedLuminosity < 70)) {
HXLINE( 129)			color = 16777215;
            		}
HXLINE( 132)		HX_VARI( int,x) = 30;
HXLINE( 133)		HX_VARI( int,height) = 7;
HXLINE( 134)		HX_VARI( Float,y) = ((this->getHeight() / ( (Float)(2) )) - (( (Float)(height) ) / ( (Float)(2) )));
HXLINE( 135)		HX_VARI( Float,width) = (this->getWidth() - ( (Float)((x * 2)) ));
HXLINE( 137)		HX_VARI( int,padding) = 2;
...
int DefaultPreloader_obj::getBackgroundColor(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 163)
HXLINE( 164)		HX_VARI(  ::Dynamic,attributes) = ::openfl::Lib_obj::get_current()->stage->window->context->attributes;
...
Float DefaultPreloader_obj::getHeight(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 177)
HXLINE( 178)		HX_VARI( int,height) = ::openfl::Lib_obj::get_current()->stage->window->_hx___height;
...
Float DefaultPreloader_obj::getWidth(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 191)
HXLINE( 192)		HX_VARI( int,width) = ::openfl::Lib_obj::get_current()->stage->window->_hx___width;
...
HXLINE( 217)
HXLINE( 218)		HX_VARI( Float,percentLoaded) = ((Float)0.0);
...
HXDLIN( 257)		HX_VARI_NAME( int,elapsed1,"elapsed") = (elapsed - this->startAnimation);
HXLINE( 258)		HX_VARI( int,total) = (this->endAnimation - this->startAnimation);
HXLINE( 260)		HX_VARI( Float,percent) = (( (Float)(elapsed1) ) / ( (Float)(total) ));

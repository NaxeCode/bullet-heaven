...
void Timeline_obj::attachMovieClip( ::openfl::display::MovieClip movieClip){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(movieClip,"movieClip")
HXLINE(  89)
            	}
...
HXLINE( 118)		HX_VARI( int,frame) = (index + 1);
...
HXLINE( 147)					HX_VARI(  ::openfl::display::Scene,scene) = _g1->__get(_g).StaticCast<  ::openfl::display::Scene >();
HXDLIN( 147)					_g = (_g + 1);
...
HXLINE( 164)					HX_VARI(  ::openfl::display::FrameScript,script) = _g3->__get(_g2).StaticCast<  ::openfl::display::FrameScript >();
...
HXLINE( 169)						HX_VARI(  ::Dynamic,existing) = this->_hx___frameScripts->get(script->frame);
HXLINE( 170)						HX_VARI(  ::Dynamic,append) = script->script;
...
HXLINE( 191)			HX_VARI( int,nextFrame) = this->_hx___getNextFrame(deltaTime);
...
bool Timeline_obj::_hx___evaluateFrameScripts(int advanceToFrame){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(advanceToFrame,"advanceToFrame")
HXLINE( 225)
...
HXLINE( 228)				_g = (_g + 1);
HXDLIN( 228)				HX_VARI( int,frame) = (_g - 1);
...
HXLINE( 238)					HX_VARI(  ::Dynamic,script) = this->_hx___frameScripts->get(frame);
...
int Timeline_obj::_hx___getNextFrame(int deltaTime){
            	...
            	HX_STACK_ARG(deltaTime,"deltaTime")
HXLINE( 257)
HXLINE( 258)		HX_VARI( int,nextFrame) = 0;
...
HXLINE( 349)				HX_VARI( ::String,label) = ( (::String)(frame) );
HXLINE( 351)				{
HXLINE( 351)					int _g = 0;
HXDLIN( 351)					::Array< ::Dynamic> _g1 = this->_hx___currentLabels;
HXDLIN( 351)					while((_g < _g1->length)){
HXLINE( 351)						HX_VARI(  ::openfl::display::FrameLabel,frameLabel) = _g1->__get(_g).StaticCast<  ::openfl::display::FrameLabel >();
HXDLIN( 351)						_g = (_g + 1);
...
HXLINE( 374)				HX_VARI(  ::openfl::display::FrameLabel,label) = _g1->__get(_g).StaticCast<  ::openfl::display::FrameLabel >();
HXDLIN( 374)				_g = (_g + 1);
...
void Timeline_obj::_hx___updateSymbol(int targetFrame){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(targetFrame,"targetFrame")
HXLINE( 394)

...
HXLINE( 200)				HX_VARI_NAME(  ::openfl::errors::ArgumentError,error1,"error") =  ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("Error #3783: A Stage object cannot be added as the child of another object.",fa,51,93,42));
...
HXLINE( 369)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 369)				_g = (_g + 1);
...
::Array< ::Dynamic> DisplayObjectContainer_obj::getObjectsUnderPoint( ::openfl::geom::Point point){
            	...
            	HX_STACK_ARG(point,"point")
HXLINE( 415)
HXLINE( 416)		HX_VARI( ::Array< ::Dynamic>,stack) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 449)			HX_VARI(  ::openfl::events::Event,event) =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("removed",a0,1f,00,f3),true,null());
...
HXLINE( 459)				HX_VARI_NAME(  ::openfl::events::Event,event1,"event") =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("removedFromStage",34,21,76,ba),false,false);
...
HXLINE( 538)		HX_VARI( int,numRemovals) = (endIndex - beginIndex);
...
HXLINE( 550)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 550)				_g = (_g + 1);
...
HXLINE( 634)			HX_VARI( int,index1) = this->_hx___children->indexOf(child1,null());
HXLINE( 635)			HX_VARI( int,index2) = this->_hx___children->indexOf(child2,null());
...
HXLINE( 654)
HXLINE( 655)		HX_VARI(  ::openfl::display::DisplayObject,swap) = this->_hx___children->__get(index1).StaticCast<  ::openfl::display::DisplayObject >();
...
HXLINE( 666)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 666)				_g = (_g + 1);
...
HXLINE( 675)
HXLINE( 676)		{
HXLINE( 676)			HX_VARI(  ::Dynamic,orphan) = this->_hx___removedChildren->iterator();
HXDLIN( 676)			while(( (bool)(orphan->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 676)				HX_VARI_NAME(  ::openfl::display::DisplayObject,orphan1,"orphan") = ( ( ::openfl::display::DisplayObject)(orphan->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 691)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 691)				_g = (_g + 1);
...
HXDLIN( 707)			HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 707)			_g = (_g + 1);
...
HXLINE( 719)		HX_VARI(  ::openfl::geom::Matrix,childWorldTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 721)		{
HXLINE( 721)			int _g = 0;
HXDLIN( 721)			::Array< ::Dynamic> _g1 = this->_hx___children;
HXDLIN( 721)			while((_g < _g1->length)){
HXLINE( 721)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 721)				_g = (_g + 1);
...
HXLINE( 740)		HX_VARI(  ::openfl::geom::Matrix,childWorldTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 742)		{
HXLINE( 742)			int _g = 0;
HXDLIN( 742)			::Array< ::Dynamic> _g1 = this->_hx___children;
HXDLIN( 742)			while((_g < _g1->length)){
HXLINE( 742)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 742)				_g = (_g + 1);
...
HXLINE( 748)				HX_VARI(  ::openfl::geom::Rectangle,childRect) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE( 773)		HX_VARI(  ::openfl::geom::Matrix,childWorldTransform) = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 775)		{
HXLINE( 775)			int _g = 0;
HXDLIN( 775)			::Array< ::Dynamic> _g1 = this->_hx___children;
HXDLIN( 775)			while((_g < _g1->length)){
HXLINE( 775)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 775)				_g = (_g + 1);
...
HXLINE( 795)			HX_VARI(  ::openfl::geom::Point,point) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
...
HXLINE( 808)		HX_VARI( int,i) = this->_hx___children->length;
...
HXLINE( 828)					HX_VARI( int,length) = stack->length;
HXLINE( 830)					HX_VARI( bool,interactive) = false;
HXLINE( 831)					HX_VARI( bool,hitTest) = false;
...
HXLINE( 860)			HX_VARI_NAME( bool,hitTest1,"hitTest") = false;
...
bool DisplayObjectContainer_obj::_hx___hitTestMask(Float x,Float y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE( 878)
HXLINE( 879)		HX_VARI( int,i) = this->_hx___children->length;
...
HXLINE( 898)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 898)				_g = (_g + 1);
...
HXLINE( 911)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 911)				_g = (_g + 1);
...
HXLINE( 926)					HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 926)					_g = (_g + 1);
...
HXDLIN( 936)			HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 936)			_g = (_g + 1);
...
HXLINE( 948)		HX_VARI( bool,interactive) = false;
HXLINE( 949)		HX_VARI(  ::openfl::display::InteractiveObject,interactiveObject) = null();
HXLINE( 951)		{
HXLINE( 951)			int _g = 0;
HXDLIN( 951)			::Array< ::Dynamic> _g1 = this->_hx___children;
HXDLIN( 951)			while((_g < _g1->length)){
HXLINE( 951)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 951)				_g = (_g + 1);
...
HXLINE( 969)				HX_VARI(  ::openfl::display::DisplayObject,child) = _g1->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 969)				_g = (_g + 1);

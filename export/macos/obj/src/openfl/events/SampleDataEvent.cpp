...
bool SampleDataEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event SampleDataEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 156)
HXLINE( 157)		HX_VARI(  ::openfl::events::SampleDataEvent,event) =  ::openfl::events::SampleDataEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable);
...
HXDLIN( 182)		HX_VARI_NAME( int,bufferSize2,"bufferSize") = ::Std_obj::_hx_int(((bufferSize / bufferSize1) / ( (Float)(2) )));
...
void SampleDataEvent_obj::getSamples( ::openfl::utils::ByteArrayData outputBuffer){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(outputBuffer,"outputBuffer")
HXLINE( 198)
HXLINE( 199)		HX_VARI( int,bytesLength) = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(this->data);
HXLINE( 200)		HX_VAR( Float,tempFloat);

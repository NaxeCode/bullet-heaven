...
bool ProgressEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ProgressEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 131)
HXLINE( 132)		HX_VARI(  ::openfl::events::ProgressEvent,event) =  ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->bytesLoaded,this->bytesTotal);

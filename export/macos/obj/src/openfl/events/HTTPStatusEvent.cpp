...
bool HTTPStatusEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event HTTPStatusEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 134)
HXLINE( 135)		HX_VARI(  ::openfl::events::HTTPStatusEvent,event) =  ::openfl::events::HTTPStatusEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->status,this->redirected);

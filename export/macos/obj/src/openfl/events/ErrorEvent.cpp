...
bool ErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  82)
HXLINE(  83)		HX_VARI(  ::openfl::events::ErrorEvent,event) =  ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text,this->errorID);

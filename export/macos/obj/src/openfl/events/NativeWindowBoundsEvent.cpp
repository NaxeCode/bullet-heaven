...
void NativeWindowBoundsEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable, ::openfl::geom::Rectangle beforeBounds, ::openfl::geom::Rectangle afterBounds){
            	...
            	HX_STACK_ARG(beforeBounds,"beforeBounds")
            	HX_STACK_ARG(afterBounds,"afterBounds")
HXLINE( 106)
...
bool NativeWindowBoundsEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event NativeWindowBoundsEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 113)
HXLINE( 114)		HX_VARI(  ::openfl::events::NativeWindowBoundsEvent,event) =  ::openfl::events::NativeWindowBoundsEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->beforeBounds,this->afterBounds);

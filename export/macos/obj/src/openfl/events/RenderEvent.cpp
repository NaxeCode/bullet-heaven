...
void RenderEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable, ::openfl::geom::Matrix objectMatrix, ::openfl::geom::ColorTransform objectColorTransform,::hx::Null< bool >  __o_allowSmoothing){
            	...
            	HX_STACK_ARG(objectMatrix,"objectMatrix")
            	HX_STACK_ARG(objectColorTransform,"objectColorTransform")
            	HX_STACK_ARG(allowSmoothing,"allowSmoothing")
HXLINE( 154)
...
HXDLIN( 164)		HX_VARI_NAME(  ::openfl::events::RenderEvent,event5,"event") =  ::openfl::events::RenderEvent_obj::__alloc( HX_CTX ,event,event1,event2,event3,event4,this->allowSmoothing);

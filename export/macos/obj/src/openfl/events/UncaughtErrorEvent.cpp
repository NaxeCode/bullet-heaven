...
bool UncaughtErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event UncaughtErrorEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 186)
HXLINE( 187)		HX_VARI(  ::openfl::events::UncaughtErrorEvent,event) =  ::openfl::events::UncaughtErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->error);

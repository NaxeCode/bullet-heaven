...
HXLINE( 194)			HX_VARI( ::Array< ::Dynamic>,list) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 197)			HX_VARI(  ::openfl::events::_EventDispatcher::DispatchIterator,iterator) =  ::openfl::events::_EventDispatcher::DispatchIterator_obj::__alloc( HX_CTX ,list);
...
HXLINE( 204)			HX_VARI_NAME( ::Array< ::Dynamic>,list1,"list") = ( (::Array< ::Dynamic>)(this->_hx___eventMap->get(type)) );
HXLINE( 206)			{
HXLINE( 206)				int _g = 0;
...
HXLINE( 211)			HX_VARI( ::Array< ::Dynamic>,iterators) = ( (::Array< ::Dynamic>)(this->_hx___iterators->get(type)) );
HXLINE( 213)			{
HXLINE( 213)				int _g2 = 0;
HXDLIN( 213)				while((_g2 < iterators->length)){
HXLINE( 213)					HX_VARI_NAME(  ::openfl::events::_EventDispatcher::DispatchIterator,iterator1,"iterator") = iterators->__get(_g2).StaticCast<  ::openfl::events::_EventDispatcher::DispatchIterator >();
...
HXLINE( 300)		HX_VARI( ::Array< ::Dynamic>,list) = ( (::Array< ::Dynamic>)(this->_hx___eventMap->get(type)) );
HXLINE( 301)		if (::hx::IsNull( list )) {
HXLINE( 301)			return;
            		}
HXLINE( 303)		HX_VARI( ::Array< ::Dynamic>,iterators) = ( (::Array< ::Dynamic>)(this->_hx___iterators->get(type)) );
HXLINE( 305)		{
HXLINE( 305)			int _g = 0;
...
HXLINE( 309)							HX_VARI(  ::openfl::events::_EventDispatcher::DispatchIterator,iterator) = iterators->__get(_g2).StaticCast<  ::openfl::events::_EventDispatcher::DispatchIterator >();
...
::String EventDispatcher_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 333)
HXLINE( 334)		HX_VARI( ::String,full) = ::Type_obj::getClassName(::Type_obj::getClass(::hx::ObjectPtr<OBJ_>(this)));
HXLINE( 335)		HX_VARI_NAME( ::String,_hx_short,"short") = ( (::String)(full.split(HX_(".",2e,00,00,00))->pop()) );
...
HXLINE( 368)		HX_VARI( ::String,type) = event->type;
HXLINE( 370)		HX_VARI( ::Array< ::Dynamic>,list) = ( (::Array< ::Dynamic>)(this->_hx___eventMap->get(type)) );
...
HXLINE( 387)		HX_VARI( bool,capture) = (event->eventPhase == 1);
HXLINE( 389)		HX_VARI( ::Array< ::Dynamic>,iterators) = ( (::Array< ::Dynamic>)(this->_hx___iterators->get(type)) );
HXLINE( 390)		HX_VARI(  ::openfl::events::_EventDispatcher::DispatchIterator,iterator) = iterators->__get(0).StaticCast<  ::openfl::events::_EventDispatcher::DispatchIterator >();
...
HXLINE( 400)		{
HXLINE( 400)			HX_VARI(  ::openfl::events::_EventDispatcher::DispatchIterator,listener) = iterator;
HXDLIN( 400)			while(listener->hasNext()){
HXLINE( 400)				HX_VARI_NAME(  ::openfl::events::_EventDispatcher::Listener,listener1,"listener") = listener->next();
HXLINE( 402)				if (::hx::IsNull( listener1 )) {
HXLINE( 402)					continue;
            				}
HXLINE( 404)				if ((listener1->useCapture == capture)) {
HXLINE( 427)					if (listener1->useWeakReference) {
HXLINE( 429)						HX_VARI(  ::Dynamic,weakCallback) = listener1->weakRefCallback->get();
HXLINE( 430)						if (::hx::IsNull( weakCallback )) {
HXLINE( 433)							HX_VARI( int,indexToRemove) = (iterator->index - 1);
...
void EventDispatcher_obj::_hx___addListenerByPriority(::Array< ::Dynamic> list, ::openfl::events::_EventDispatcher::Listener listener){
            	...
            	HX_STACK_ARG(listener,"listener")
HXLINE( 479)
HXLINE( 480)		HX_VARI( int,numElements) = list->length;
HXLINE( 481)		HX_VARI( int,addAtPosition) = numElements;
HXLINE( 483)		{
HXLINE( 483)			int _g = 0;
HXDLIN( 483)			int _g1 = numElements;
HXDLIN( 483)			while((_g < _g1)){
HXLINE( 483)				_g = (_g + 1);
HXDLIN( 483)				HX_VARI( int,i) = (_g - 1);

...
bool ActivityEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ActivityEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  70)
HXLINE(  71)		HX_VARI(  ::openfl::events::ActivityEvent,event) =  ::openfl::events::ActivityEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->activating);

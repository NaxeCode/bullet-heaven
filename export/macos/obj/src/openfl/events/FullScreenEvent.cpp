...
bool FullScreenEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event FullScreenEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  95)
HXLINE(  96)		HX_VARI(  ::openfl::events::FullScreenEvent,event) =  ::openfl::events::FullScreenEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->fullScreen,this->interactive);

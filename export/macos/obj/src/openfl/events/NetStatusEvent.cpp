...
bool NetStatusEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event NetStatusEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 157)
HXLINE( 158)		HX_VARI(  ::openfl::events::NetStatusEvent,event) =  ::openfl::events::NetStatusEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->info);

...
bool Event_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event Event_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 794)
HXLINE( 795)		HX_VARI(  ::openfl::events::Event,event) =  ::openfl::events::Event_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable);
...
::String Event_obj::formatToString(::String className,::String p1,::String p2,::String p3,::String p4,::String p5){
            	...
            	HX_STACK_ARG(p5,"p5")
HXLINE( 827)
HXLINE( 828)		HX_VARI( ::Array< ::String >,parameters) = ::Array_obj< ::String >::__new(0);
...
HXLINE( 915)
HXLINE( 918)		HX_VARI( ::String,output) = (HX_("[",5b,00,00,00) + className);
HXLINE( 919)		HX_VARI(  ::Dynamic,arg) = null();
HXLINE( 921)		{
HXLINE( 921)			int _g = 0;
HXDLIN( 921)			while((_g < parameters->length)){
HXLINE( 921)				HX_VARI( ::String,param) = parameters->__get(_g);
HXDLIN( 921)				_g = (_g + 1);

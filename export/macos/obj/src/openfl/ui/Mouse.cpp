...
HXLINE( 100)				HX_VARI(  ::lime::ui::Window,window) = _g1->__get(_g).StaticCast<  ::lime::ui::Window >();
HXDLIN( 100)				_g = (_g + 1);
...
HXLINE( 131)		HX_VARI( ::String,cacheCursor) = ::openfl::ui::Mouse_obj::_hx___cursor;
...
HXLINE( 155)		HX_VARI(  ::lime::ui::MouseCursor,setCursor) = null();
...
HXLINE( 188)				HX_VARI(  ::lime::ui::Window,window) = _g1->__get(_g).StaticCast<  ::lime::ui::Window >();
HXDLIN( 188)				_g = (_g + 1);

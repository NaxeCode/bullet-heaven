...
HXLINE( 101)				HX_VARI(  ::openfl::ui::GameInputDevice,device) = _g1->__get(_g).StaticCast<  ::openfl::ui::GameInputDevice >();
HXDLIN( 101)				_g = (_g + 1);
...
HXDLIN( 138)			HX_VARI_NAME(  ::openfl::ui::GameInputDevice,device1,"device") =  ::openfl::ui::GameInputDevice_obj::__alloc( HX_CTX ,device,( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_get_device_name(gamepad->id)) )) ));
...
HXLINE( 150)
HXLINE( 151)		HX_VARI(  ::openfl::ui::GameInputDevice,device) = ::openfl::ui::GameInput_obj::_hx___getDevice(gamepad);
...
HXDLIN( 158)				HX_VARI_NAME(  ::openfl::ui::GameInputControl,control1,"control") =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,device,(HX_("AXIS_",9e,28,6e,a7) + control),( (Float)(-1) ),( (Float)(1) ),null());
HXLINE( 159)				device->_hx___axis->set(axis,control1);
HXLINE( 160)				device->_hx___controls->push(control1);
            			}
HXLINE( 163)			HX_VARI_NAME(  ::openfl::ui::GameInputControl,control2,"control") = ( ( ::openfl::ui::GameInputControl)(device->_hx___axis->get(axis)) );
...
HXLINE( 172)
HXLINE( 173)		HX_VARI(  ::openfl::ui::GameInputDevice,device) = ::openfl::ui::GameInput_obj::_hx___getDevice(gamepad);
...
HXDLIN( 180)				HX_VARI_NAME(  ::openfl::ui::GameInputControl,control1,"control") =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,device,(HX_("BUTTON_",2d,26,49,4a) + control),( (Float)(0) ),( (Float)(1) ),null());
HXLINE( 181)				device->_hx___button->set(button,control1);
HXLINE( 182)				device->_hx___controls->push(control1);
            			}
HXLINE( 185)			HX_VARI_NAME(  ::openfl::ui::GameInputControl,control2,"control") = ( ( ::openfl::ui::GameInputControl)(device->_hx___button->get(button)) );
...
void GameInput_obj::_hx___onGamepadButtonUp( ::lime::ui::Gamepad gamepad,int button){
            	...
            	HX_STACK_ARG(button,"button")
HXLINE( 194)
HXLINE( 195)		HX_VARI(  ::openfl::ui::GameInputDevice,device) = ::openfl::ui::GameInput_obj::_hx___getDevice(gamepad);
...
HXDLIN( 202)				HX_VARI_NAME(  ::openfl::ui::GameInputControl,control1,"control") =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,device,(HX_("BUTTON_",2d,26,49,4a) + control),( (Float)(0) ),( (Float)(1) ),null());
HXLINE( 203)				device->_hx___button->set(button,control1);
HXLINE( 204)				device->_hx___controls->push(control1);
            			}
HXLINE( 207)			HX_VARI_NAME(  ::openfl::ui::GameInputControl,control2,"control") = ( ( ::openfl::ui::GameInputControl)(device->_hx___button->get(button)) );
...
void GameInput_obj::_hx___onGamepadConnect( ::lime::ui::Gamepad gamepad){
            	...
            	HX_STACK_ARG(gamepad,"gamepad")
HXLINE( 216)
HXLINE( 217)		HX_VARI(  ::openfl::ui::GameInputDevice,device) = ::openfl::ui::GameInput_obj::_hx___getDevice(gamepad);
...
HXLINE( 220)				HX_VARI(  ::openfl::ui::GameInput,instance) = _g1->__get(_g).StaticCast<  ::openfl::ui::GameInput >();
HXDLIN( 220)				_g = (_g + 1);
...
void GameInput_obj::_hx___onGamepadDisconnect( ::lime::ui::Gamepad gamepad){
            	...
            	HX_STACK_ARG(gamepad,"gamepad")
HXLINE( 229)
HXLINE( 230)		HX_VARI(  ::openfl::ui::GameInputDevice,device) = ( ( ::openfl::ui::GameInputDevice)(::openfl::ui::GameInput_obj::_hx___devices->get(gamepad)) );
...
HXLINE( 242)					HX_VARI(  ::openfl::ui::GameInput,instance) = _g1->__get(_g).StaticCast<  ::openfl::ui::GameInput >();
HXDLIN( 242)					_g = (_g + 1);

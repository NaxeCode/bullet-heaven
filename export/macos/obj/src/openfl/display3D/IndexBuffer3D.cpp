...
HXLINE(  43)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
void IndexBuffer3D_obj::dispose(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  54)
HXLINE(  55)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE(  80)
HXLINE(  82)		HX_VARI( int,offset) = (byteArrayOffset + (startOffset * 2));
...
HXLINE(  97)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 123)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 125)		HX_VARI( int,length) = (startOffset + count);
HXLINE( 126)		HX_VARI(  ::lime::utils::ArrayBufferView,existingUInt16Array) = this->_hx___tempUInt16Array;

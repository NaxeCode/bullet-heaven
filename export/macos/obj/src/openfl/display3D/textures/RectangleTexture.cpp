...
HXLINE(  57)		HX_VARI(  ::lime::graphics::Image,image) = this->_hx___getImage(source);
...
void RectangleTexture_obj::uploadFromTypedArray( ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 115)
HXLINE( 116)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 127)			HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 129)			if ((::openfl::display3D::Context3D_obj::_hx___glMaxTextureMaxAnisotropy != 0)) {
HXLINE( 131)				HX_VAR( int,aniso);

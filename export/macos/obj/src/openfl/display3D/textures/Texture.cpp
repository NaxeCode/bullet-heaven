...
HXLINE(  44)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE(  99)				HX_VARI(  ::openfl::events::Event,event) = null();
...
HXLINE( 150)		HX_VARI( int,width) = (this->_hx___width >> miplevel);
HXLINE( 151)		HX_VARI( int,height) = (this->_hx___height >> miplevel);
...
HXLINE( 160)			HX_VARI(  ::openfl::display::BitmapData,copy) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,0);
HXLINE( 161)			copy->draw(source,null(),null(),null(),null(),null());
HXLINE( 162)			source = copy;
            		}
HXLINE( 165)		HX_VARI(  ::lime::graphics::Image,image) = this->_hx___getImage(source);
...
HXLINE( 247)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 249)		HX_VARI( int,width) = (this->_hx___width >> miplevel);
HXLINE( 250)		HX_VARI( int,height) = (this->_hx___height >> miplevel);
...
HXLINE( 266)			HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 313)
HXLINE( 314)			HX_VAR(  ::Dynamic,format);
HXDLIN( 314)			if (alpha) {
...
HXLINE( 323)				HX_VARI( int,size) = ::Std_obj::_hx_int((( (Float)(blockLength) ) / ( (Float)(2) )));
...
HXLINE( 328)				HX_VARI(  ::openfl::display3D::textures::Texture,alphaTexture) =  ::openfl::display3D::textures::Texture_obj::__alloc( HX_CTX ,_gthis->_hx___context,_gthis->_hx___width,_gthis->_hx___height,3,_gthis->_hx___optimizeForRenderToTexture,_gthis->_hx___streamingLevels);
...
HXLINE( 301)		HX_VARI(  ::openfl::display3D::_internal::ATFReader,reader) =  ::openfl::display3D::_internal::ATFReader_obj::__alloc( HX_CTX ,data,byteArrayOffset);
HXLINE( 302)		HX_VARI( bool,alpha) = reader->readHeader(this->_hx___width,this->_hx___height,false);
HXLINE( 304)		HX_VARI(  ::openfl::display3D::Context3D,context) = this->_hx___context;
HXLINE( 305)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
HXLINE( 307)		this->_hx___context->_hx___bindGLTexture2D(this->_hx___textureID);
HXLINE( 309)		HX_VARI( ::Array< bool >,hasTexture) = ::Array_obj< bool >::fromData( _hx_array_data_f13028fe_10,1);
...
HXDLIN( 348)			HX_VARI_NAME(  ::lime::utils::ArrayBufferView,data1,"data") = this1;
HXLINE( 349)			{

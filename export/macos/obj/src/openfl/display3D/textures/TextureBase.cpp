...
HXLINE(  65)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE(  75)			HX_VARI(  ::Dynamic,bgraExtension) = null();
...
HXLINE( 109)			HX_VARI(  ::Dynamic,dxtExtension) = gl->getExtension(HX_("EXT_texture_compression_s3tc",6a,86,aa,80));
HXLINE( 110)			HX_VARI(  ::Dynamic,etc1Extension) = gl->getExtension(HX_("OES_compressed_ETC1_RGB8_texture",cd,f1,a0,b8));
HXLINE( 111)			HX_VARI(  ::Dynamic,pvrtcExtension) = gl->getExtension(HX_("IMG_texture_compression_pvrtc",02,61,85,d1));
...
void TextureBase_obj::dispose(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 150)
HXLINE( 151)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 186)
HXLINE( 187)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 197)				HX_VARI( int,code) = gl->checkFramebufferStatus(gl->FRAMEBUFFER);
...
HXLINE( 235)				HX_VARI_NAME( int,code1,"code") = gl->checkFramebufferStatus(gl->FRAMEBUFFER);
...
HXLINE( 251)
HXLINE( 252)		HX_VARI(  ::lime::graphics::Image,image) = bitmapData->image;
...
HXLINE( 312)			HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 318)			HX_VARI( int,wrapModeS) = 0;
HXDLIN( 318)			HX_VARI( int,wrapModeT) = 0;
...
HXLINE( 335)				HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("wrap bad enum",52,1c,4c,59),null()));
            			...
            			_hx_goto_5:;
HXLINE( 338)			HX_VARI( int,magFilter) = 0;
HXDLIN( 338)			HX_VARI( int,minFilter) = 0;
...
HXLINE( 382)
HXLINE( 383)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 384)		HX_VAR( int,internalFormat);
HXDLIN( 384)		HX_VAR( int,format);

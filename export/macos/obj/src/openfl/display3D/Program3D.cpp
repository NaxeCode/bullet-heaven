...
HXDLIN( 473)				HX_VARI_NAME( int,i1,"i") = (_g3 - 1);
...
HXDLIN( 558)										HX_VARI( int,reg) = (_g2 - 1);
...
HXDLIN( 672)					HX_VARI_NAME(  ::openfl::display3D::Uniform,sampler1,"sampler") = val1;
...
HXLINE( 878)			HX_VARI_NAME( ::String,message1,"message") = HX_("Error compiling fragment shader",4d,d0,be,e3);
...
HXLINE( 904)				HX_VARI_NAME( ::String,name1,"name") = _g2->__get(_g1);
...
HXLINE( 920)			HX_VARI_NAME( ::String,message2,"message") = HX_("Unable to initialize the shader program",f0,86,8b,39);

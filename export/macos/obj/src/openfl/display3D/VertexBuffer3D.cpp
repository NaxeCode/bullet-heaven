...
HXLINE(  70)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
void VertexBuffer3D_obj::dispose(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  82)
HXLINE(  83)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
void VertexBuffer3D_obj::uploadFromByteArray( ::openfl::utils::ByteArrayData data,int byteArrayOffset,int startVertex,int numVertices){
            	...
            	HX_STACK_ARG(numVertices,"numVertices")
HXLINE( 108)
HXLINE( 110)		HX_VARI( int,offset) = (byteArrayOffset + (startVertex * this->_hx___stride));
HXLINE( 111)		HX_VARI( int,length) = (numVertices * this->_hx___vertexSize);
...
HXLINE( 129)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
...
HXLINE( 156)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = this->_hx___context->gl;
HXLINE( 160)		HX_VARI( int,start) = (startVertex * this->_hx___vertexSize);
HXLINE( 161)		HX_VARI( int,count) = (numVertices * this->_hx___vertexSize);
HXLINE( 162)		HX_VARI( int,length) = (start + count);
HXLINE( 164)		HX_VARI(  ::lime::utils::ArrayBufferView,existingFloat32Array) = this->_hx___tempFloat32Array;

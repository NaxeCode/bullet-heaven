...
void Context3D_obj::__construct( ::openfl::display::Stage stage, ::openfl::display3D::_internal::Context3DState contextState, ::openfl::display::Stage3D stage3D){
            	...
            	HX_STACK_ARG(contextState,"contextState")
...
HXLINE( 324)			HX_VARI(  ::Dynamic,extension) = this->gl->getExtension(HX_("EXT_texture_filter_anisotropic",4c,4c,32,3d));
...
HXLINE( 357)				HX_VARI(  ::Dynamic,extension1) = this->gl->getExtension(HX_("OES_packed_depth_stencil",7b,19,31,fc));
...
HXLINE( 380)			HX_VARI(  ::Dynamic,extension2) = this->gl->getExtension(HX_("NVX_gpu_memory_info",6a,ad,9a,42));
...
HXLINE( 391)			HX_VARI( ::String,vendor) = ( (::String)(this->gl->getParameter(this->gl->VENDOR)) );
HXLINE( 392)			HX_VARI( ::String,version) = ( (::String)(this->gl->getParameter(this->gl->VERSION)) );
HXLINE( 393)			HX_VARI( ::String,renderer) = ( (::String)(this->gl->getParameter(this->gl->RENDERER)) );
HXLINE( 394)			HX_VARI( ::String,glslVersion) = ( (::String)(this->gl->getParameter(this->gl->SHADING_LANGUAGE_VERSION)) );
...
HXDLIN( 405)		HX_VARI(  ::lime::utils::ArrayBufferView,data) = this2;
HXLINE( 407)		HX_VARI( int,index) = 0;
HXLINE( 408)		HX_VARI( int,vertex) = 0;
HXLINE( 410)		{
HXLINE( 410)			int _g = 0;
HXDLIN( 410)			int _g1 = this->_hx___quadIndexBufferElements;
HXDLIN( 410)			while((_g < _g1)){
HXLINE( 410)				_g = (_g + 1);
HXDLIN( 410)				HX_VARI( int,i) = (_g - 1);
...
HXLINE( 466)		HX_VARI( int,clearMask) = 0;
...
HXLINE( 619)				HX_VAR( int,scaledWidth);
...
HXLINE( 620)				HX_VAR( int,scaledHeight);
...
HXDLIN( 632)					HX_VARI(  ::openfl::_Vector::IntVector,indexData) =  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length1,fixed1,::Array_obj< int >::fromData( _hx_array_data_2fa0bfa7_5,6));
...
void Context3D_obj::dispose(::hx::Null< bool >  __o_recreate){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(recreate,"recreate")
HXLINE(1023)
...
HXLINE(1074)		HX_VAR(  ::lime::math::Rectangle,sourceRect);
...
HXLINE(1075)		HX_VAR(  ::lime::math::Vector2,destVector);
...
HXLINE(1086)				HX_VARI(  ::lime::graphics::Image,image) = this->_hx___stage->window->readPixels(null());
...
HXLINE(1092)				HX_VARI(  ::openfl::display3D::textures::TextureBase,cacheRenderToTexture) = this->_hx___state->renderToTexture;
...
HXDLIN(1100)				HX_VARI(  ::lime::utils::ArrayBufferView,data) = this1;
HXLINE(1101)				{
...
HXLINE(1103)				HX_VARI_NAME(  ::lime::graphics::Image,image1,"image") =  ::lime::graphics::Image_obj::__alloc( HX_CTX , ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,data,this->backBufferWidth,this->backBufferHeight,32,2),null(),null(),null(),null(),null(),null());
...
HXLINE(1254)			HX_VARI(  ::openfl::display3D::textures::RectangleTexture,cacheBuffer) = this->_hx___backBufferTexture;
...
void Context3D_obj::setBlendFactorsSeparate( ::Dynamic sourceRGBFactor, ::Dynamic destinationRGBFactor, ::Dynamic sourceAlphaFactor, ::Dynamic destinationAlphaFactor){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sourceRGBFactor,"sourceRGBFactor")
            	HX_STACK_ARG(destinationRGBFactor,"destinationRGBFactor")
            	HX_STACK_ARG(sourceAlphaFactor,"sourceAlphaFactor")
            	HX_STACK_ARG(destinationAlphaFactor,"destinationAlphaFactor")
HXLINE(1305)
...
HXLINE(1394)				_g = (_g + 1);
HXDLIN(1394)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(1445)			HX_VARI( bool,isVertex) = ::hx::IsEq( programType,1 );
HXLINE(1446)			HX_VAR(  ::lime::utils::ArrayBufferView,dest);
...
HXDLIN(1448)			HX_VARI(  ::lime::utils::ArrayBufferView,floatData) = this1;
HXLINE(1449)			HX_VARI( int,outOffset) = (firstRegister * 4);
...
HXDLIN(1450)			HX_VARI_NAME( int,inOffset2,"inOffset") = ::Std_obj::_hx_int((inOffset / inOffset1));
HXLINE(1452)			{
HXLINE(1452)				int _g = 0;
HXDLIN(1452)				int _g1 = (numRegisters * 4);
HXDLIN(1452)				while((_g < _g1)){
HXLINE(1452)					_g = (_g + 1);
HXDLIN(1452)					HX_VARI( int,i) = (_g - 1);
HXLINE(1454)					{
...
HXDLIN(1493)			HX_VARI(  ::lime::utils::ArrayBufferView,data) =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,16,8);
HXLINE(1494)			{
HXLINE(1496)				{
...
HXLINE(1503)			HX_VARI( bool,isVertex) = ::hx::IsEq( programType,1 );
HXLINE(1504)			HX_VAR(  ::lime::utils::ArrayBufferView,dest);
...
HXLINE(1505)			HX_VARI(  ::openfl::_Vector::FloatVector,source) = matrix->rawData;
HXLINE(1506)			HX_VARI( int,i) = (firstRegister * 4);
...
HXLINE(1596)			HX_VARI( bool,isVertex) = ::hx::IsEq( programType,1 );
HXLINE(1597)			HX_VAR(  ::lime::utils::ArrayBufferView,dest);
...
HXLINE(1598)			HX_VARI(  ::openfl::_Vector::FloatVector,source) = data;
HXLINE(1600)			HX_VARI( int,sourceIndex) = 0;
HXLINE(1601)			HX_VARI( int,destIndex) = (firstRegister * 4);
HXLINE(1603)			{
HXLINE(1603)				int _g = 0;
HXDLIN(1603)				int _g1 = numRegisters;
HXDLIN(1603)				while((_g < _g1)){
HXLINE(1603)					_g = (_g + 1);
HXDLIN(1603)					HX_VARI( int,i) = (_g - 1);
HXLINE(1605)					{
...
HXLINE(1706)		HX_VARI(  ::openfl::display::_internal::SamplerState,state) = this->_hx___state->samplerStates->__get(sampler).StaticCast<  ::openfl::display::_internal::SamplerState >();
...
HXLINE(1906)		HX_VARI( int,byteOffset) = (bufferOffset * 4);
...
void Context3D_obj::_hx___flushGLDepth(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2121)
HXLINE(2122)		HX_VAR( bool,depthMask);
...
HXLINE(2166)				HX_VARI(  ::lime::graphics::opengl::GLObject,framebuffer) = this->_hx___state->renderToTexture->_hx___getGLFramebuffer(this->_hx___state->renderToTextureDepthStencil,this->_hx___state->renderToTextureAntiAlias,this->_hx___state->renderToTextureSurfaceSelector);
...
void Context3D_obj::_hx___flushGLProgram(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2207)
HXLINE(2208)		HX_VARI(  ::openfl::display::Shader,shader) = this->_hx___state->shader;
HXLINE(2209)		HX_VARI(  ::openfl::display3D::Program3D,program) = this->_hx___state->program;
...
HXLINE(2265)			HX_VARI( int,scissorX) = ::Std_obj::_hx_int(this->_hx___state->scissorRectangle->x);
HXLINE(2266)			HX_VARI( int,scissorY) = ::Std_obj::_hx_int(this->_hx___state->scissorRectangle->y);
HXLINE(2267)			HX_VARI( int,scissorWidth) = ::Std_obj::_hx_int(this->_hx___state->scissorRectangle->width);
HXLINE(2268)			HX_VARI( int,scissorHeight) = ::Std_obj::_hx_int(this->_hx___state->scissorRectangle->height);
...
HXLINE(2281)				HX_VARI( int,contextHeight) = ::Std_obj::_hx_int((( (Float)(this->_hx___stage->window->_hx___height) ) * this->_hx___stage->window->_hx___scale));
...
void Context3D_obj::_hx___flushGLTextures(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2330)
HXLINE(2331)		HX_VARI( int,sampler) = 0;
HXLINE(2332)		HX_VAR(  ::openfl::display3D::textures::TextureBase,texture);
HXDLIN(2332)		HX_VAR(  ::openfl::display::_internal::SamplerState,samplerState);
HXLINE(2334)		{
HXLINE(2334)			int _g = 0;
HXDLIN(2334)			int _g1 = this->_hx___state->textures->length;
HXDLIN(2334)			while((_g < _g1)){
HXLINE(2334)				_g = (_g + 1);
HXDLIN(2334)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(2421)				HX_VARI( int,scaledBackBufferWidth) = this->backBufferWidth;
HXLINE(2422)				HX_VARI( int,scaledBackBufferHeight) = this->backBufferHeight;
...
HXDLIN(2431)				HX_VARI_NAME( int,y2,"y") = ::Std_obj::_hx_int((y - y1));
...
HXLINE(2441)			HX_VARI( int,width) = 0;
HXDLIN(2441)			HX_VARI( int,height) = 0;
HXLINE(2444)			if (::Std_obj::isOfType(this->_hx___state->renderToTexture,::hx::ClassOf< ::openfl::display3D::textures::Texture >())) {
HXLINE(2446)				HX_VARI(  ::openfl::display3D::textures::Texture,texture2D) = ( ( ::openfl::display3D::textures::Texture)(this->_hx___state->renderToTexture) );
...
HXLINE(2452)					HX_VARI(  ::openfl::display3D::textures::RectangleTexture,rectTexture) = ( ( ::openfl::display3D::textures::RectangleTexture)(this->_hx___state->renderToTexture) );
...
HXLINE(2458)						HX_VARI(  ::openfl::display3D::textures::CubeTexture,cubeTexture) = ( ( ::openfl::display3D::textures::CubeTexture)(this->_hx___state->renderToTexture) );
...
int Context3D_obj::_hx___getGLBlend( ::Dynamic blendFactor){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(blendFactor,"blendFactor")
HXLINE(2469)
...
void Context3D_obj::_hx___renderStage3D( ::openfl::display::Stage3D stage3D){
            	...
            	HX_STACK_ARG(stage3D,"stage3D")
HXLINE(2543)
HXLINE(2546)		HX_VARI(  ::openfl::display3D::Context3D,context) = stage3D->context3D;
...
HXLINE(2559)				HX_VARI(  ::openfl::utils::AGALMiniAssembler,vertexAssembler) =  ::openfl::utils::AGALMiniAssembler_obj::__alloc( HX_CTX ,null());
...
HXLINE(2562)				HX_VARI(  ::openfl::utils::AGALMiniAssembler,fragmentAssembler) =  ::openfl::utils::AGALMiniAssembler_obj::__alloc( HX_CTX ,null());
...
void Context3D_obj::_hx___setGLFrontFace(bool counterClockWise){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(counterClockWise,"counterClockWise")
HXLINE(2648)
...
HXLINE(2703)			HX_VARI( int,current) = ( (int)(this->gl->getParameter(::openfl::display3D::Context3D_obj::_hx___glMemoryCurrentAvailable)) );
HXLINE(2704)			HX_VARI( int,total) = ( (int)(this->gl->getParameter(::openfl::display3D::Context3D_obj::_hx___glMemoryTotalAvailable)) );

...
HXDLIN( 882)		HX_VARI_NAME( ::String,str1,"str") = (str + this->n);
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toGLSL,return )
 ...
 ::openfl::display::_internal::SamplerState SamplerRegister_obj::toSamplerState(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 887)
HXLINE( 888)		HX_VAR(  ::Dynamic,wrap);
HXLINE( 889)		HX_VAR(  ::Dynamic,filter);
HXLINE( 890)		HX_VAR(  ::Dynamic,mipfilter);
...
HXLINE( 934)		HX_VARI( bool,ignoreSampler) = ((this->s & 4) == 4);
HXLINE( 935)		HX_VARI( bool,centroid) = ((this->s & 1) == 1);
HXLINE( 936)		HX_VARI( bool,textureAlpha) = (this->t == 2);
HXLINE( 939)		HX_VARI( Float,lodBias) = (( (Float)(((this->b << 24) >> 24)) ) / ((Float)8.0));
...
HXLINE( 865)
HXLINE( 866)		HX_VARI(  ::openfl::display3D::_internal::_AGALConverter::SamplerRegister,sr) =  ::openfl::display3D::_internal::_AGALConverter::SamplerRegister_obj::__alloc( HX_CTX );

...
HXLINE(  42)		HX_VARI( ::String,signature) = data->readUTFBytes(3);
...
HXLINE(  50)		HX_VARI( int,length) = 0;
...
bool ATFReader_obj::readHeader(int _hx___width,int _hx___height,bool cubeMap){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_hx___width,"__width")
            	HX_STACK_ARG(_hx___height,"__height")
            	HX_STACK_ARG(cubeMap,"cubeMap")
HXLINE(  75)
HXLINE(  76)		HX_VARI( int,tdata) = this->data->readUnsignedByte();
HXLINE(  77)		HX_VARI( int,type) = ::hx::UShr(tdata,7);
...
void ATFReader_obj::readTextures( ::Dynamic uploadCallback){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(uploadCallback,"uploadCallback")
HXLINE( 113)
HXLINE( 116)		HX_VAR( int,gpuFormats);
...
HXLINE( 117)		HX_VAR( int,sideCount);
...
HXLINE( 134)									HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc(blockLength);
HXLINE( 135)									{
...
int ATFReader_obj::_hx___readUInt24( ::openfl::utils::ByteArrayData data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 145)
HXLINE( 146)		HX_VARI( int,value) = (data->readUnsignedByte() << 16);
...
int ATFReader_obj::_hx___readUInt32( ::openfl::utils::ByteArrayData data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 154)
HXLINE( 155)		HX_VARI( int,value) = (data->readUnsignedByte() << 24);

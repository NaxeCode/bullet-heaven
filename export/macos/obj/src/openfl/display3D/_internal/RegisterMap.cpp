...
HXLINE( 607)				HX_VARI(  ::openfl::display3D::_internal::_AGALConverter::RegisterMapEntry,entry) = _g1->__get(_g).StaticCast<  ::openfl::display3D::_internal::_AGALConverter::RegisterMapEntry >();
HXDLIN( 607)				_g = (_g + 1);
...
HXLINE( 620)		HX_VARI_NAME(  ::openfl::display3D::_internal::_AGALConverter::RegisterMapEntry,entry1,"entry") =  ::openfl::display3D::_internal::_AGALConverter::RegisterMapEntry_obj::__alloc( HX_CTX );
...
HXLINE( 662)				HX_VARI(  ::openfl::display3D::_internal::_AGALConverter::RegisterMapEntry,entry) = _g1->__get(_g).StaticCast<  ::openfl::display3D::_internal::_AGALConverter::RegisterMapEntry >();
HXDLIN( 662)				_g = (_g + 1);
...
HXLINE( 680)		HX_VAR(  ::openfl::display3D::_internal::_AGALConverter::RegisterMapEntry,entry);
HXLINE( 682)		this->mEntries->sort( ::Dynamic(new _hx_Closure_1()));
HXLINE( 687)		HX_VARI(  ::StringBuf,sb) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 689)		{
HXLINE( 689)			int _g = 0;
HXDLIN( 689)			int _g1 = this->mEntries->length;
HXDLIN( 689)			while((_g < _g1)){
HXLINE( 689)				_g = (_g + 1);
HXDLIN( 689)				HX_VARI( int,i) = (_g - 1);

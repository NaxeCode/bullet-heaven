...
HXLINE(  47)
HXLINE(  48)		HX_VARI( int,low) = byteArray->readInt();
HXLINE(  49)		HX_VARI( int,high) = byteArray->readInt();
...
HXLINE(  58)		HX_VARI( int,magic) = (agal->readByte() & 255);
...
HXLINE(  71)		HX_VARI( int,version) = agal->readInt();
...
HXLINE(  78)		HX_VARI( int,shaderTypeID) = (agal->readByte() & 255);
...
HXLINE(  85)		HX_VAR(  ::openfl::display3D::_internal::_AGALConverter::ProgramType,programType);
...
HXLINE(  87)		HX_VARI(  ::openfl::display3D::_internal::RegisterMap,map) =  ::openfl::display3D::_internal::RegisterMap_obj::__alloc( HX_CTX );
HXLINE(  88)		HX_VARI(  ::StringBuf,sb) =  ::StringBuf_obj::__alloc( HX_CTX );
...
HXLINE(  93)			HX_VARI( int,opcode) = agal->readInt();
HXLINE(  94)			HX_VARI( int,dest) = agal->readUnsignedInt();
HXLINE(  95)			HX_VARI( ::cpp::Int64,source1) = ::openfl::display3D::_internal::AGALConverter_obj::readUInt64(agal);
HXLINE(  96)			HX_VARI( ::cpp::Int64,source2) = ::openfl::display3D::_internal::AGALConverter_obj::readUInt64(agal);
HXLINE(  99)			HX_VARI(  ::openfl::display3D::_internal::_AGALConverter::DestRegister,dr) = ::openfl::display3D::_internal::_AGALConverter::DestRegister_obj::parse(dest,programType);
HXLINE( 100)			HX_VARI(  ::openfl::display3D::_internal::_AGALConverter::SourceRegister,sr1) = ::openfl::display3D::_internal::_AGALConverter::SourceRegister_obj::parse(source1,programType,dr->mask);
HXLINE( 101)			HX_VARI(  ::openfl::display3D::_internal::_AGALConverter::SourceRegister,sr2) = ::openfl::display3D::_internal::_AGALConverter::SourceRegister_obj::parse(source2,programType,dr->mask);
HXLINE( 104)			{
...
HXLINE( 140)					map->addSR(sr2,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn(),null());
            				...
            				break;
            				case (int)5: {
HXLINE( 144)					HX_VARI( ::String,sr) = sr1->toGLSL(null(),null());
...
HXLINE( 268)					map->addSR(sr1,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn(),null());
            				...
            				break;
            				case (int)23: {
HXLINE( 276)					HX_VARI(  ::openfl::display3D::_internal::_AGALConverter::RegisterUsage,existingUsage) = map->getRegisterUsage(sr2);
...
HXLINE( 296)						map->addSR(sr2,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn(),2);
            				...
            				break;
            				case (int)24: {
HXLINE( 307)					HX_VARI_NAME(  ::openfl::display3D::_internal::_AGALConverter::RegisterUsage,existingUsage1,"existingUsage") = map->getRegisterUsage(sr2);
...
HXLINE( 342)					HX_VARI_NAME(  ::openfl::display3D::_internal::_AGALConverter::RegisterUsage,existingUsage2,"existingUsage") = map->getRegisterUsage(sr2);
...
HXLINE( 374)					map->addSR(sr1,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn(),null());
            				...
            				break;
            				case (int)40: {
HXLINE( 379)					HX_VARI(  ::openfl::display3D::_internal::_AGALConverter::SamplerRegister,sampler) = ::openfl::display3D::_internal::_AGALConverter::SamplerRegister_obj::parse(source2,programType);
...
HXLINE( 479)			HX_VARI_NAME( ::String,version1,"version") = ( (::String)(::lime::graphics::opengl::GL_obj::context->getParameter(7938)) );
...
HXLINE( 485)		HX_VARI(  ::StringBuf,glsl) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 486)		{

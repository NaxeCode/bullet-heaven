...
HXLINE(1047)		HX_VARI( int,total) = 0;
HXLINE(1049)		{
HXLINE(1049)			int _g = 0;
HXDLIN(1049)			::Array< ::Dynamic> _g1 = this->_hx___uniforms;
HXDLIN(1049)			while((_g < _g1->length)){
HXLINE(1049)				HX_VARI(  ::openfl::display3D::Uniform,uniform) = _g1->__get(_g).StaticCast<  ::openfl::display3D::Uniform >();
HXDLIN(1049)				_g = (_g + 1);
...
HXLINE(1059)				HX_VARI_NAME(  ::openfl::display3D::Uniform,uniform1,"uniform") = _g3->__get(_g2).StaticCast<  ::openfl::display3D::Uniform >();
...
HXDLIN(1061)						HX_VARI( int,i) = (_g4 - 1);
...
HXLINE(1074)					HX_VARI(  ::openfl::display3D::Uniform,uniform) = _g1->__get(_g).StaticCast<  ::openfl::display3D::Uniform >();
HXDLIN(1074)					_g = (_g + 1);
...
HXLINE(1100)		HX_VARI( int,end) = (start + count);
HXLINE(1102)		if ((end > this->_hx___registerLookup->get_length())) {
HXLINE(1104)			end = this->_hx___registerLookup->get_length();
            		}
HXLINE(1107)		HX_VARI( int,index) = start;
HXLINE(1109)		while((index < end)){
HXLINE(1111)			HX_VARI(  ::openfl::display3D::Uniform,uniform) = this->_hx___registerLookup->get(index).StaticCast<  ::openfl::display3D::Uniform >();

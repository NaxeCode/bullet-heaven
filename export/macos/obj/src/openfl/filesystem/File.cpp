...
HXLINE( 463)			HX_VARI( ::Array< ::String >,dirs) = ::haxe::io::Path_obj::directory(this->_hx___path).split(this->_hx___sep);
...
bool File_obj::browse(::Array< ::Dynamic> typeFilter){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(typeFilter,"typeFilter")
HXLINE( 472)
...
void File_obj::canonicalize(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 754)
HXLINE( 755)		HX_VARI( ::Array< ::String >,segs) = this->_hx___path.split(this->_hx___sep);
...
HXDLIN( 757)		HX_VARI_NAME( ::String,cPath3,"cPath") = cPath->__get(cPath1->indexOf((cPath2 + this->_hx___sep),null()));
HXLINE( 758)		HX_VARI( int,start) = 1;
...
HX_DEFINE_DYNAMIC_FUNC0(File_obj,canonicalize,(void))
 ...
 ::openfl::filesystem::File File_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 781)
HXLINE( 782)		HX_VARI( ::hx::Class,fileClass) = ::hx::ClassOf< ::openfl::filesystem::File >();
HXLINE( 784)		HX_VARI(  ::Dynamic,fileClone) = ::Type_obj::createEmptyInstance(fileClass);
HXLINE( 786)		HX_VARI( ::Array< ::String >,fields) = ::Type_obj::getInstanceFields(fileClass);
HXLINE( 787)		{
HXLINE( 787)			int _g = 0;
HXDLIN( 787)			while((_g < fields->length)){
HXLINE( 787)				HX_VARI( ::String,field) = fields->__get(_g);
HXDLIN( 787)				_g = (_g + 1);
HXLINE( 789)				try {
...
void File_obj::copyTo( ::openfl::net::FileReference newLocation,::hx::Null< bool >  __o_overwrite){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(newLocation,"newLocation")
...
HXLINE( 859)		HX_VARI( ::String,newPath) = newLocation->_hx___path;
HXLINE( 883)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 885)			if (this->get_isDirectory()) {
HXLINE( 887)				::sys::FileSystem_obj::createDirectory(newPath);
HXLINE( 888)				HX_VARI( ::Array< ::Dynamic>,files) = this->getDirectoryListing();
HXLINE( 889)				{
HXLINE( 889)					int _g = 0;
HXDLIN( 889)					while((_g < files->length)){
HXLINE( 889)						HX_VARI(  ::openfl::filesystem::File,file) = files->__get(_g).StaticCast<  ::openfl::filesystem::File >();
HXDLIN( 889)						_g = (_g + 1);
HXLINE( 891)						HX_VARI(  ::openfl::filesystem::File,newFile) =  ::openfl::filesystem::File_obj::__alloc( HX_CTX ,::haxe::io::Path_obj::join(::Array_obj< ::String >::__new(2)->init(0,newPath)->init(1,file->get_name())));
HXLINE( 892)						file->copyTo(newFile,null());
            					}
            				}
            			}
            			else {
HXLINE( 897)				HX_VARI( ::String,newDirectory) = ::haxe::io::Path_obj::directory(newPath);
...
HXDLIN( 971)					HX_VARI(  ::Dynamic,e) = _g;
HXLINE( 973)					HX_VARI(  ::openfl::events::IOErrorEvent,ioErrorEvent) = _gthis->_hx___createIoErrorEvent(e);
...
void File_obj::deleteDirectory(::hx::Null< bool >  __o_deleteDirectoryContents){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(deleteDirectoryContents,"deleteDirectoryContents")
HXLINE(1042)
HXLINE(1043)		if (deleteDirectoryContents) {
HXLINE(1045)			HX_VARI( ::Array< ::Dynamic>,files) = this->getDirectoryListing();
HXLINE(1047)			{
HXLINE(1047)				int _g = 0;
HXDLIN(1047)				while((_g < files->length)){
HXLINE(1047)					HX_VARI(  ::openfl::filesystem::File,file) = files->__get(_g).StaticCast<  ::openfl::filesystem::File >();
HXDLIN(1047)					_g = (_g + 1);
...
HXDLIN(1094)					HX_VARI(  ::Dynamic,e) = _g;
HXLINE(1096)					HX_VARI(  ::openfl::events::IOErrorEvent,ioErrorEvent) = _gthis->_hx___createIoErrorEvent(e);
...
HXDLIN(1165)					HX_VARI(  ::Dynamic,e) = _g;
HXLINE(1167)					HX_VARI(  ::openfl::events::IOErrorEvent,ioErrorEvent) = _gthis->_hx___createIoErrorEvent(e);
...
HXLINE(1212)		HX_VARI( ::Array< ::String >,directories) = ::sys::FileSystem_obj::readDirectory(this->_hx___path);
HXLINE(1213)		HX_VARI( ::Array< ::Dynamic>,files) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1215)		{
HXLINE(1215)			int _g = 0;
HXDLIN(1215)			while((_g < directories->length)){
HXLINE(1215)				HX_VARI( ::String,directory) = directories->__get(_g);
HXDLIN(1215)				_g = (_g + 1);
...
HXLINE(1267)			_gthis->dispatchEvent(event);
            		...
            		void _hx_run( ::Dynamic m){
            			...
            			HX_STACK_ARG(m,"m")
HXLINE(1270)
HXLINE(1271)			HX_VARI( ::Array< ::String >,directories) = null();
HXLINE(1272)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXDLIN(1276)					HX_VARI(  ::Dynamic,e) = _g;
HXLINE(1278)					HX_VARI(  ::openfl::events::IOErrorEvent,ioErrorEvent) = _gthis->_hx___createIoErrorEvent(e);
...
HXLINE(1289)			HX_VARI( ::Array< ::Dynamic>,files) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1290)			{
HXLINE(1290)				int _g1 = 0;
HXDLIN(1290)				while((_g1 < directories->length)){
HXLINE(1290)					HX_VARI( ::String,directory) = directories->__get(_g1);
...
::String File_obj::getRelativePath( ::openfl::net::FileReference ref,::hx::Null< bool >  __o_useDotDot){
            		...
            		::Array< ::String > _hx_run(::String path){
            			...
            			HX_STACK_ARG(path,"path")
HXLINE(1323)
HXLINE(1324)			HX_VARI( ::Array< ::String >,dirs) = ::Array_obj< ::String >::__new(0);
HXLINE(1325)			HX_VARI( int,lastBreak) = 0;
HXLINE(1327)			{
HXLINE(1327)				int _g = 0;
HXDLIN(1327)				int _g1 = path.length;
HXDLIN(1327)				while((_g < _g1)){
HXLINE(1327)					_g = (_g + 1);
HXDLIN(1327)					HX_VARI( int,i) = (_g - 1);
HXLINE(1329)					HX_VARI_NAME( ::String,_hx_char,"char") = path.charAt(i);
...
HXLINE(1342)			return dirs;
            	...
            	HX_STACK_ARG(useDotDot,"useDotDot")
HXLINE(1319)
HXLINE(1322)		HX_VARI(  ::Dynamic,breakPath) =  ::Dynamic(new _hx_Closure_0());
HXLINE(1345)		HX_VARI( ::Array< ::String >,thisPath) = ( (::Array< ::String >)(breakPath(this->_hx___path)) );
HXLINE(1346)		HX_VARI( ::Array< ::String >,refPath) = ( (::Array< ::String >)(breakPath(ref->_hx___path)) );
HXLINE(1348)		HX_VARI( ::Array< ::String >,relatives) = ::Array_obj< ::String >::__new(0);
...
HXLINE(1352)				_g = (_g + 1);
HXDLIN(1352)				HX_VARI( int,j) = (_g - 1);
HXLINE(1354)				if (useDotDot) {
HXLINE(1356)					HX_VARI( ::String,thisSeg) = thisPath->__get(j);
HXLINE(1357)					HX_VARI( ::String,refSeg) = refPath->__get(j);
...
HXDLIN(1379)				HX_VARI_NAME( int,j1,"j") = (_g2 - 1);
HXLINE(1381)				HX_VARI_NAME( ::String,thisSeg1,"thisSeg") = thisPath->__get(j1);
HXLINE(1382)				HX_VARI_NAME( ::String,refSeg1,"refSeg") = refPath->__get(j1);
...
HXDLIN(1546)					HX_VARI(  ::Dynamic,e) = _g;
HXLINE(1548)					HX_VARI(  ::openfl::events::IOErrorEvent,ioErrorEvent) = _gthis->_hx___createIoErrorEvent(e);
...
HX_DEFINE_DYNAMIC_FUNC0(File_obj,openWithDefaultApplication,(void))
 ...
 ::openfl::filesystem::File File_obj::resolvePath(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE(1607)
HXLINE(1608)		HX_VARI( ::String,directoryPath) = ::haxe::io::Path_obj::removeTrailingSlashes(this->_hx___path);
...
::String File_obj::_hx___canonicalize(::String cpath,::String seg){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(cpath,"cpath")
            	HX_STACK_ARG(seg,"seg")
HXLINE(1705)
HXLINE(1706)		seg = seg.toLowerCase();
HXLINE(1707)		HX_VARI( ::Array< ::String >,items) = ::sys::FileSystem_obj::readDirectory(::haxe::io::Path_obj::directory(cpath));
...
HXLINE(1712)				HX_VARI( ::String,item) = items->__get(_g);
HXDLIN(1712)				_g = (_g + 1);
...
void File_obj::_hx___dispatchSelectMultiple(::Array< ::String > filepaths){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(filepaths,"filepaths")
HXLINE(1746)
HXLINE(1747)		if (::hx::IsNotNull( this->_hx___fileDialog )) {
HXLINE(1749)			this->_hx___fileDialog = null();
            		}
HXLINE(1752)		HX_VARI( ::Array< ::Dynamic>,files) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1754)		{
HXLINE(1754)			int _g = 0;
HXDLIN(1754)			while((_g < filepaths->length)){
HXLINE(1754)				HX_VARI( ::String,filepath) = filepaths->__get(_g);
HXDLIN(1754)				_g = (_g + 1);
...
HXLINE(1768)				HX_VARI(  ::openfl::errors::Error,error) = ( ( ::openfl::errors::Error)(e) );
...
::String File_obj::_hx___formatPath(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE(1780)
HXLINE(1781)		HX_VARI( ::Array< ::String >,dirs) = ::Array_obj< ::String >::__new(0);
HXLINE(1782)		HX_VARI( int,lastBreak) = 0;
HXLINE(1784)		{
HXLINE(1784)			int _g = 0;
HXDLIN(1784)			int _g1 = path.length;
HXDLIN(1784)			while((_g < _g1)){
HXLINE(1784)				_g = (_g + 1);
HXDLIN(1784)				HX_VARI( int,i) = (_g - 1);
HXLINE(1786)				HX_VARI_NAME( ::String,_hx_char,"char") = path.charAt(i);
...
HXLINE(1805)				HX_VARI( ::String,dir) = dirs->__get(_g2);
...
::String File_obj::_hx___getFilterTypes(::Array< ::Dynamic> typeFilter){
            	...
            	HX_STACK_ARG(typeFilter,"typeFilter")
HXLINE(1814)
HXLINE(1815)		HX_VARI( ::String,filterString) = null();
HXLINE(1816)		HX_VARI( ::Array< ::String >,filters) = ::Array_obj< ::String >::__new(0);
HXLINE(1818)		if (::hx::IsNotNull( typeFilter )) {
HXLINE(1820)			{
HXLINE(1820)				int _g = 0;
HXDLIN(1820)				while((_g < typeFilter->length)){
HXLINE(1820)					HX_VARI(  ::openfl::net::FileFilter,filter) = typeFilter->__get(_g).StaticCast<  ::openfl::net::FileFilter >();
HXDLIN(1820)					_g = (_g + 1);
HXLINE(1822)					HX_VARI( ::Array< ::String >,types) = filter->extension.split(HX_(";",3b,00,00,00));
HXLINE(1824)					{
HXLINE(1824)						int _g1 = 0;
HXDLIN(1824)						while((_g1 < types->length)){
HXLINE(1824)							HX_VARI( ::String,type) = types->__get(_g1);
...
bool File_obj::_hx___winGetHiddenAttr(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1905)
HXLINE(1908)		HX_VARI(  ::sys::io::Process,process) =  ::sys::io::Process_obj::__alloc( HX_CTX ,((HX_("attrib \"",cc,e9,9c,ce) + this->get_nativePath()) + HX_("\"",22,00,00,00)),null(),null());
HXLINE(1909)		HX_VARI( ::String,r) = process->_hx_stdout->readLine();
HXLINE(1911)		process->close();
HXLINE(1913)		HX_VARI( ::String,s) = r.split(this->get_nativePath())->__get(0);
HXLINE(1914)		HX_VARI( bool,flag) = (s.indexOf(HX_(" H ",f8,86,18,00),null()) > -1);
...
HXLINE(1928)			HX_VARI(  ::Dynamic,fileInfo) = ::sys::FileSystem_obj::stat(path);
...
HX_DEFINE_DYNAMIC_FUNC0(File_obj,get_isDirectory,return )
 ...
 ::openfl::filesystem::File File_obj::get_parent(){
            	...
            	HX_STACK_THIS(this)
HXLINE(2080)
HXLINE(2082)		HX_VARI( ::String,path) = ::haxe::io::Path_obj::removeTrailingSlashes(this->_hx___path);
HXLINE(2084)		HX_VARI( int,lastIndex) = path.lastIndexOf(this->_hx___sep,null());
...
HXLINE(1692)
HXLINE(1693)		HX_VARI( ::Array< ::Dynamic>,rootDirs) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1694)		{
...
HXLINE(1694)				HX_VARI( ::String,letter) = _g1->__get(_g);
HXDLIN(1694)				_g = (_g + 1);
...
HXLINE(1841)
HXLINE(1842)		HX_VARI( ::String,path) = HX_("",00,00,00,00);
...
HXLINE(1858)		HX_VARI( ::String,tempPath) = HX_("",00,00,00,00);
HXLINE(1860)		do {

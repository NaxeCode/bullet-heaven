...
Float Vector3D_obj::normalize(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 399)
HXLINE( 400)		HX_VARI( Float,l) = this->get_length();
HXLINE( 402)		if ((l != 0)) {
...
Float Vector3D_obj::angleBetween( ::openfl::geom::Vector3D a, ::openfl::geom::Vector3D b){
            	...
            	HX_STACK_ARG(b,"b")
HXLINE( 197)
HXLINE( 198)		HX_VARI( Float,la) = a->get_length();
HXLINE( 199)		HX_VARI( Float,lb) = b->get_length();
HXLINE( 200)		HX_VARI( Float,dot) = a->dotProduct(b);
HXLINE( 202)		if ((la != 0)) {
...
HXLINE( 285)
HXLINE( 286)		HX_VARI( Float,x) = (pt2->x - pt1->x);
HXLINE( 287)		HX_VARI( Float,y) = (pt2->y - pt1->y);
HXLINE( 288)		HX_VARI( Float,z) = (pt2->z - pt1->z);

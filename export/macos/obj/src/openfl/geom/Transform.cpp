...
HXLINE( 261)			HX_VARI(  ::openfl::geom::Matrix,matrix) = this->_hx___displayObject->_hx___transform;
...
HXLINE( 290)			HX_VARI(  ::openfl::geom::Matrix,transform) = this->_hx___displayObject->_hx___transform;
...
HXLINE( 296)			HX_VARI( Float,scaleX) = ((Float)0.0);
HXLINE( 297)			HX_VARI( Float,scaleY) = ((Float)0.0);
HXLINE( 299)			if ((b == 0)) {
HXLINE( 301)				scaleX = a;
            			}
            			else {
...
HXLINE( 320)			HX_VARI( Float,rotation) = (((( (Float)(180) ) / ::Math_obj::PI) * ::Math_obj::atan2(d,c)) - ( (Float)(90) ));
...
HXLINE( 325)				HX_VARI( Float,radians) = (rotation * (::Math_obj::PI / ( (Float)(180) )));

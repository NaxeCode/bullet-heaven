...
HXLINE( 181)			HX_VARI( Float,norm) = (thickness / ::Math_obj::sqrt(((this->x * this->x) + (this->y * this->y))));
...
HXLINE( 121)
HXLINE( 122)		HX_VARI( Float,dx) = (pt1->x - pt2->x);
HXLINE( 123)		HX_VARI( Float,dy) = (pt1->y - pt2->y);

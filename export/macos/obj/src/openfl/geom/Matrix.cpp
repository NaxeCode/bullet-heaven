...
void Matrix_obj::concat( ::openfl::geom::Matrix m){
            	...
            	HX_STACK_ARG(m,"m")
HXLINE( 191)
HXLINE( 192)		HX_VARI( Float,a1) = ((this->a * m->a) + (this->b * m->c));
HXLINE( 193)		this->b = ((this->a * m->b) + (this->b * m->d));
HXLINE( 194)		this->a = a1;
HXLINE( 196)		HX_VARI( Float,c1) = ((this->c * m->a) + (this->d * m->c));
HXLINE( 197)		this->d = ((this->c * m->b) + (this->d * m->d));
HXLINE( 198)		this->c = c1;
HXLINE( 200)		HX_VARI( Float,tx1) = (((this->tx * m->a) + (this->ty * m->c)) + m->tx);
...
HXLINE( 379)			HX_VARI( Float,cos) = ::Math_obj::cos(rotation);
HXLINE( 380)			HX_VARI( Float,sin) = ::Math_obj::sin(rotation);
...
HXLINE( 441)			HX_VARI( Float,cos) = ::Math_obj::cos(rotation);
HXLINE( 442)			HX_VARI( Float,sin) = ::Math_obj::sin(rotation);
...
HX_DEFINE_DYNAMIC_FUNC0(Matrix_obj,identity,(void))
 ...
 ::openfl::geom::Matrix Matrix_obj::invert(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 509)
HXLINE( 510)		HX_VARI( Float,norm) = ((this->a * this->d) - (this->b * this->c));
...
HXLINE( 521)			HX_VARI( Float,a1) = (this->d * norm);
...
HXLINE( 527)			HX_VARI( Float,tx1) = ((-(this->a) * this->tx) - (this->c * this->ty));
...
HXLINE( 548)
HXLINE( 562)		HX_VARI( Float,cos) = ::Math_obj::cos(theta);
HXLINE( 564)		HX_VARI( Float,sin) = ::Math_obj::sin(theta);
HXLINE( 566)		HX_VARI( Float,a1) = ((this->a * cos) - (this->b * sin));
HXLINE( 567)		this->b = ((this->a * sin) + (this->b * cos));
HXLINE( 568)		this->a = a1;
HXLINE( 570)		HX_VARI( Float,c1) = ((this->c * cos) - (this->d * sin));
HXLINE( 571)		this->d = ((this->c * sin) + (this->d * cos));
HXLINE( 572)		this->c = c1;
HXLINE( 574)		HX_VARI( Float,tx1) = ((this->tx * cos) - (this->ty * sin));
...
void Matrix_obj::_hx___transformInversePoint( ::openfl::geom::Point point){
            	...
            	HX_STACK_ARG(point,"point")
HXLINE( 758)
HXLINE( 759)		HX_VARI( Float,norm) = ((this->a * this->d) - (this->b * this->c));
HXLINE( 761)		if ((norm == 0)) {
HXLINE( 763)			point->x = -(this->tx);
HXLINE( 764)			point->y = -(this->ty);
            		}
            		else {
HXLINE( 768)			HX_VARI( Float,px) = ((((Float)1.0) / norm) * ((this->c * (this->ty - point->y)) + (this->d * (point->x - this->tx))));
...
Float Matrix_obj::_hx___transformInverseX(Float px,Float py){
            	...
            	HX_STACK_ARG(py,"py")
HXLINE( 775)
HXLINE( 776)		HX_VARI( Float,norm) = ((this->a * this->d) - (this->b * this->c));
...
Float Matrix_obj::_hx___transformInverseY(Float px,Float py){
            	...
            	HX_STACK_ARG(py,"py")
HXLINE( 789)
HXLINE( 790)		HX_VARI( Float,norm) = ((this->a * this->d) - (this->b * this->c));
...
void Matrix_obj::_hx___transformPoint( ::openfl::geom::Point point){
            	...
            	HX_STACK_ARG(point,"point")
HXLINE( 803)
HXLINE( 804)		HX_VARI( Float,px) = point->x;
HXLINE( 805)		HX_VARI( Float,py) = point->y;

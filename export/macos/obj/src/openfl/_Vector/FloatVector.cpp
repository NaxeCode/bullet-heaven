...
HXLINE(1006)			HX_VARI(  ::openfl::_Vector::FloatVector,other) = ( ( ::openfl::_Vector::FloatVector)(a) );
...
HXLINE(1036)				_g = (_g + 1);
HXDLIN(1036)				HX_VARI( int,i) = (_g - 1);

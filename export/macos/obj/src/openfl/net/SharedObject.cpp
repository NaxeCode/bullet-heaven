...
HXDLIN(1001)			HX_VARI_NAME(  ::openfl::net::SharedObject,sharedObject1,"sharedObject") = ( ( ::openfl::net::SharedObject)(sharedObject->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );

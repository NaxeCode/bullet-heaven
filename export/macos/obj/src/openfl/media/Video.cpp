...
HXLINE( 288)
HXLINE( 289)		HX_VARI(  ::openfl::geom::Rectangle,bounds) = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
...
HXLINE( 299)
HXLINE( 301)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
...
HX_DEFINE_DYNAMIC_FUNC1(Video_obj,_hx___getTexture,return )
 ...
 ::openfl::display3D::VertexBuffer3D Video_obj::_hx___getVertexBuffer( ::openfl::display3D::Context3D context){
            	...
            	HX_STACK_ARG(context,"context")
HXLINE( 353)
HXLINE( 355)		HX_VARI(  ::lime::_internal::backend::native::NativeOpenGLRenderContext,gl) = context->gl;
...
HXLINE( 381)			HX_VARI( int,uvWidth) = 1;
HXLINE( 382)			HX_VARI( int,uvHeight) = 1;
...
bool Video_obj::_hx___hitTestMask(Float x,Float y){
            	...
            	HX_STACK_ARG(y,"y")
HXLINE( 430)
HXLINE( 431)		HX_VARI(  ::openfl::geom::Point,point) = ::openfl::geom::Point_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Point >();
HXLINE( 432)		point->setTo(x,y);
HXLINE( 434)		this->_hx___globalToLocal(point,point);
HXLINE( 436)		HX_VAR( bool,hit);

...
void SoundChannel_obj::__construct( ::openfl::media::Sound sound, ::lime::media::AudioSource audioSource, ::openfl::media::SoundTransform soundTransform){
            	...
            	HX_STACK_ARG(audioSource,"audioSource")
...
HXLINE( 160)			HX_VARI(  ::lime::media::OpenALAudioContext,alAudioContext) = this->_hx___sound->_hx___alAudioContext;
...
HXLINE( 220)		HX_VARI(  ::lime::media::OpenALAudioContext,alAudioContext) = this->_hx___sound->_hx___alAudioContext;
...
HXLINE( 225)			HX_VARI( int,bufferSize) = this->_hx___sampleDataEvent->getBufferSize();
...
HXLINE( 328)			HX_VARI( Float,pan) = (::openfl::media::SoundMixer_obj::_hx___soundTransform->pan + this->_hx___soundTransform->pan);
HXLINE( 330)			if ((pan < -1)) {
...
HXLINE( 333)			HX_VARI( Float,volume) = (::openfl::media::SoundMixer_obj::_hx___soundTransform->volume * this->_hx___soundTransform->volume);
HXLINE( 335)			if (this->_hx___isValid) {
HXLINE( 338)				this->_hx___audioSource->set_gain(volume);
HXLINE( 340)				HX_VARI(  ::lime::math::Vector4,position) = this->_hx___audioSource->get_position();
...
void SoundChannel_obj::watchBuffers(int i){
            	...
            	HX_STACK_ARG(i,"i")
HXLINE( 391)
HXLINE( 392)		HX_VARI(  ::lime::media::OpenALAudioContext,alAudioContext) = this->_hx___sound->_hx___alAudioContext;
HXLINE( 393)		HX_VARI( bool,hasSampleData) = true;
HXLINE( 395)		if (::hx::IsNotNull( alAudioContext )) {
HXLINE( 397)			HX_VARI( int,bufferState) = ( (int)(alAudioContext->getSourcei(this->_hx___alSource,alAudioContext->BUFFERS_PROCESSED)) );

...
HXLINE( 606)
HXLINE( 610)		HX_VARI(  ::flixel::graphics::tile::FlxDrawQuadsItem,itemToReturn) = null();
HXLINE( 611)		HX_VARI( int,blendInt) = ::flixel::graphics::tile::FlxDrawBaseItem_obj::blendToInt(blend);
...
HXLINE( 629)			HX_VARI(  ::flixel::graphics::tile::FlxDrawQuadsItem,newHead) = ( ( ::flixel::graphics::tile::FlxDrawQuadsItem)(::flixel::FlxCamera_obj::_storageTilesHead->nextTyped) );
...
HX_DEFINE_DYNAMIC_FUNC6(FlxCamera_obj,startQuadBatch,return )
 ...
 ::flixel::graphics::tile::FlxDrawTrianglesItem FlxCamera_obj::startTrianglesBatch( ::flixel::graphics::FlxGraphic graphic,::hx::Null< bool >  __o_smoothing,::hx::Null< bool >  __o_isColored, ::Dynamic blend, ::Dynamic hasColorOffsets, ::flixel::graphics::tile::FlxGraphicsShader shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE( 667)
HXLINE( 668)		HX_VARI( int,blendInt) = ::flixel::graphics::tile::FlxDrawBaseItem_obj::blendToInt(blend);
...
HX_DEFINE_DYNAMIC_FUNC6(FlxCamera_obj,startTrianglesBatch,return )
 ...
 ::flixel::graphics::tile::FlxDrawTrianglesItem FlxCamera_obj::getNewDrawTrianglesItem( ::flixel::graphics::FlxGraphic graphic,::hx::Null< bool >  __o_smoothing,::hx::Null< bool >  __o_isColored, ::Dynamic blend, ::Dynamic hasColorOffsets, ::flixel::graphics::tile::FlxGraphicsShader shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE( 690)
HXLINE( 691)		HX_VARI(  ::flixel::graphics::tile::FlxDrawTrianglesItem,itemToReturn) = null();
HXLINE( 692)		HX_VARI( int,blendInt) = ::flixel::graphics::tile::FlxDrawBaseItem_obj::blendToInt(blend);
...
HXLINE( 697)			HX_VARI(  ::flixel::graphics::tile::FlxDrawTrianglesItem,newHead) = ( ( ::flixel::graphics::tile::FlxDrawTrianglesItem)(::flixel::FlxCamera_obj::_storageTrianglesHead->nextTyped) );
...
void FlxCamera_obj::clearDrawStack(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 735)
HXLINE( 736)		HX_VARI(  ::flixel::graphics::tile::FlxDrawQuadsItem,currTiles) = this->_headTiles;
HXLINE( 737)		HX_VAR(  ::flixel::graphics::tile::FlxDrawQuadsItem,newTilesHead);
...
HXLINE( 748)		HX_VARI(  ::flixel::graphics::tile::FlxDrawTrianglesItem,currTriangles) = this->_headTriangles;
HXLINE( 749)		HX_VAR(  ::flixel::graphics::tile::FlxDrawTrianglesItem,newTrianglesHead);
...
void FlxCamera_obj::render(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 768)
HXLINE( 769)		HX_VARI(  ::flixel::graphics::tile::FlxDrawBaseItem,currItem) = this->_headOfDrawStack;
...
HXLINE( 797)			HX_VAR( bool,isColored);
...
HXLINE( 798)			HX_VAR( bool,hasColorOffsets);
...
HXLINE( 803)			HX_VARI(  ::flixel::graphics::tile::FlxDrawQuadsItem,drawItem) = this->startQuadBatch(frame->parent,isColored,hasColorOffsets,blend,smoothing,shader);
...
HXLINE( 841)			HX_VAR( bool,isColored);
...
HXLINE( 842)			HX_VAR( bool,hasColorOffsets);
...
HXLINE( 845)			HX_VARI(  ::flixel::graphics::tile::FlxDrawQuadsItem,drawItem) = this->startQuadBatch(frame->parent,isColored,hasColorOffsets,blend,smoothing,shader);
...
HXLINE( 863)			HX_VARI( int,verticesLength) = vertices->get_length();
HXLINE( 864)			HX_VARI( int,currentVertexPosition) = 0;
HXLINE( 866)			HX_VAR( Float,tempX);
HXDLIN( 866)			HX_VAR( Float,tempY);
HXLINE( 867)			HX_VARI( int,i) = 0;
...
HXDLIN( 868)			HX_VARI(  ::flixel::math::FlxRect,bounds) = _this1;
HXLINE( 869)			{
...
HXLINE( 917)					HX_VARI(  ::openfl::display::Graphics,gfx) = ::flixel::util::FlxSpriteUtil_obj::flashGfx;
...
HXLINE( 932)			HX_VAR( bool,isColored);
...
HXLINE( 935)			HX_VAR( bool,hasColorOffsets);
...
HXLINE( 937)			HX_VARI(  ::flixel::graphics::tile::FlxDrawTrianglesItem,drawItem) = this->startTrianglesBatch(graphic,smoothing,isColored,blend,hasColorOffsets,shader);
...
HXLINE(1107)						_g = (_g + 1);
HXDLIN(1107)						HX_VARI( int,i) = (_g - 1);
...
HX_DEFINE_DYNAMIC_FUNC0(FlxCamera_obj,updateScroll,(void))
 ...
 ::flixel::math::FlxBasePoint FlxCamera_obj::bindScrollPos( ::flixel::math::FlxBasePoint scrollPos){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(scrollPos,"scrollPos")
HXLINE(1181)
HXLINE(1182)		HX_VAR(  ::Dynamic,minX);
...
HXLINE(1183)		HX_VAR(  ::Dynamic,maxX);
...
HXLINE(1184)		HX_VAR(  ::Dynamic,minY);
...
HXLINE(1185)		HX_VAR(  ::Dynamic,maxY);
...
HXLINE(1209)			HX_VAR( Float,edge);
HXLINE(1210)			HX_VARI( Float,targetX) = (this->target->x + this->targetOffset->x);
HXLINE(1211)			HX_VARI( Float,targetY) = (this->target->y + this->targetOffset->y);
...
HXLINE(1345)				HX_VAR(  ::Dynamic,pixelPerfect);
...
HXDLIN(1348)					HX_VARI_NAME( Float,shakePixels1,"shakePixels") = ((shakePixels * this->_fxShakeIntensity) * ( (Float)(this->width) ));
...
HXDLIN(1357)					HX_VARI_NAME( Float,shakePixels3,"shakePixels") = ((shakePixels2 * this->_fxShakeIntensity) * ( (Float)(this->height) ));
...
void FlxCamera_obj::updateScrollRect(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1399)
HXLINE(1400)		HX_VAR(  ::openfl::geom::Rectangle,rect);
...
HXLINE(1476)		HX_VAR( Float,helper);
HXLINE(1477)		HX_VARI( Float,w) = ( (Float)(0) );
HXLINE(1478)		HX_VARI( Float,h) = ( (Float)(0) );
...
HXDLIN(1489)				this->deadzone = rect;
            			...
            			break;
            			case (int)1: {
HXLINE(1492)				HX_VARI_NAME( Float,w1,"w") = (( (Float)(this->width) ) / ( (Float)(8) ));
HXLINE(1493)				HX_VARI_NAME( Float,h1,"h") = (( (Float)(this->height) ) / ( (Float)(3) ));
...
HXLINE(1679)			HX_VAR(  ::openfl::display::Graphics,targetGraphics);
...
void FlxCamera_obj::drawFX(){
            	...
            	HX_STACK_THIS(this)
HXLINE(1694)
HXLINE(1695)		HX_VAR( Float,alphaComponent);
...
HXLINE(1735)				HX_VARI(  ::flixel::graphics::FlxGraphic,oldBuffer) = this->screen->graphic;
...
bool FlxCamera_obj::containsPoint( ::flixel::math::FlxBasePoint point,::hx::Null< Float >  __o_width,::hx::Null< Float >  __o_height){
            	...
            	HX_STACK_ARG(height,"height")
HXLINE(1909)
HXLINE(1910)		HX_VAR( bool,contained);
...
bool FlxCamera_obj::containsRect( ::flixel::math::FlxRect rect){
            	...
            	HX_STACK_ARG(rect,"rect")
HXLINE(1921)
HXLINE(1922)		HX_VAR( bool,contained);
...
HXLINE(1994)		HX_VAR(  ::openfl::geom::ColorTransform,colorTransform);

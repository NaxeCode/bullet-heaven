...
HXLINE(  57)		HX_VARI(  ::flixel::effects::FlxFlicker,flicker) = ::flixel::effects::FlxFlicker_obj::_pool->get().StaticCast<  ::flixel::effects::FlxFlicker >();
...
void FlxFlicker_obj::stopFlickering( ::flixel::FlxObject Object){
            	...
            	HX_STACK_ARG(Object,"Object")
HXLINE(  78)
HXLINE(  79)		HX_VARI(  ::flixel::effects::FlxFlicker,boundFlicker) = ( ( ::flixel::effects::FlxFlicker)(::flixel::effects::FlxFlicker_obj::_boundObjects->get(Object)) );

...
HXLINE( 338)		HX_VARI(  ::flixel::math::FlxBasePoint,node) = this->_nodes->__get(this->nodeIndex).StaticCast<  ::flixel::math::FlxBasePoint >();
HXLINE( 339)		HX_VARI( Float,deltaX) = (node->x - ::flixel::path::FlxPath_obj::_point->x);
HXLINE( 340)		HX_VARI( Float,deltaY) = (node->y - ::flixel::path::FlxPath_obj::_point->y);
HXLINE( 342)		HX_VARI( bool,horizontalOnly) = (this->axes == 1);
HXLINE( 343)		HX_VARI( bool,verticalOnly) = (this->axes == 16);
...
HXDLIN( 427)				HX_VARI(  ::flixel::math::FlxBasePoint,velocity) = this2;
HXLINE( 428)				{
...
HXLINE( 439)
HXLINE( 440)		if (snap) {
HXLINE( 442)			HX_VARI(  ::flixel::math::FlxBasePoint,oldNode) = this->_nodes->__get(this->nodeIndex).StaticCast<  ::flixel::math::FlxBasePoint >();
...
HXLINE( 460)		HX_VARI( bool,callComplete) = false;
...
HX_DEFINE_DYNAMIC_FUNC3(FlxPath_obj,addPointAt,return )
 ...
 ::flixel::math::FlxBasePoint FlxPath_obj::remove( ::flixel::math::FlxBasePoint node){
            	...
            	HX_STACK_ARG(node,"node")
HXLINE( 667)
HXLINE( 668)		HX_VARI( int,index) = this->_nodes->indexOf(node,null());
...
HXLINE( 745)		HX_VARI(  ::openfl::display::Graphics,gfx) = null();
...
HXLINE( 759)		HX_VARI( int,length) = this->_nodes->length;
HXLINE( 760)		{
HXLINE( 760)			int _g = 0;
HXDLIN( 760)			int _g1 = length;
HXDLIN( 760)			while((_g < _g1)){
HXLINE( 760)				_g = (_g + 1);
HXDLIN( 760)				HX_VARI( int,i) = (_g - 1);
HXLINE( 763)				HX_VARI(  ::flixel::math::FlxBasePoint,node) = this->_nodes->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >();
...
HXLINE( 772)				HX_VARI( int,nodeSize) = this->debugDrawData->nodeSize;
HXLINE( 773)				HX_VARI( int,nodeColor) = this->debugDrawData->nodeColor;
...
HXLINE( 791)				HX_VARI( int,nodeOffset) = ::Math_obj::floor((( (Float)(nodeSize) ) * ((Float)0.5)));
...
HXLINE( 796)				HX_VAR(  ::flixel::math::FlxBasePoint,nextNode);
...
HXLINE( 807)				HX_VARI( Float,lineOffset) = (( (Float)(this->debugDrawData->lineSize) ) / ( (Float)(2) ));

...
HXLINE( 441)
HXLINE( 442)			HX_VAR_NAME( bool,condition1,"condition");
...
HXLINE( 427)
HXDLIN( 427)		HX_VARI(  ::flixel::path::FlxTypedPathfinderData,data) = ( ( ::flixel::path::FlxTypedPathfinderData)(_tmp_data) );
HXDLIN( 427)		 ::flixel::path::FlxDiagonalPathfinder _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 428)		HX_VARI( ::Array< int >,neighbors) = ::Array_obj< int >::__new(0);
HXLINE( 429)		HX_VARI( int,inBound) = this->getInBoundDirections(data,from);
HXLINE( 430)		int dir = 256;
HXDLIN( 430)		HX_VARI( bool,up) = ((inBound & dir) == dir);
HXLINE( 431)		int dir1 = 4096;
HXDLIN( 431)		HX_VARI( bool,down) = ((inBound & dir1) == dir1);
HXLINE( 432)		int dir2 = 1;
HXDLIN( 432)		HX_VARI( bool,left) = ((inBound & dir2) == dir2);
HXLINE( 433)		int dir3 = 16;
HXDLIN( 433)		HX_VARI( bool,right) = ((inBound & dir3) == dir3);
HXLINE( 440)		HX_VARI(  ::Dynamic,addIf) =  ::Dynamic(new _hx_Closure_0(_gthis,neighbors,data));
HXLINE( 449)		HX_VARI( int,columns) = ( ( ::flixel::tile::FlxBaseTilemap)(data->map) )->widthInTiles;
...
int FlxDiagonalPathfinder_obj::getInBoundDirections( ::flixel::path::FlxTypedPathfinderData data,int from){
            	...
            	HX_STACK_ARG(from,"from")
HXLINE( 477)
HXLINE( 478)		HX_VARI( int,x) = ::hx::Mod(from,( ( ::flixel::tile::FlxBaseTilemap)(data->map) )->widthInTiles);
HXLINE( 479)		HX_VARI( int,y) = ::Std_obj::_hx_int((( (Float)(from) ) / ( (Float)(( ( ::flixel::tile::FlxBaseTilemap)(data->map) )->widthInTiles) )));
...
int FlxDiagonalPathfinder_obj::getDistance( ::Dynamic _tmp_data,int from,int to){
            	...
            	HX_STACK_ARG(to,"to")
HXLINE( 503)
HXLINE( 504)		HX_VARI(  ::flixel::path::FlxTypedPathfinderData,data) = ( ( ::flixel::path::FlxTypedPathfinderData)(_tmp_data) );

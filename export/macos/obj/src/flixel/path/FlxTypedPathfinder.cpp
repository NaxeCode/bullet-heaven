...
HXLINE(  61)
HXLINE(  63)		HX_VARI( int,startIndex) = ( ( ::flixel::tile::FlxBaseTilemap)(map) )->getTileIndexByCoords(start);
HXLINE(  64)		HX_VARI( int,endIndex) = ( ( ::flixel::tile::FlxBaseTilemap)(map) )->getTileIndexByCoords(end);
HXLINE(  66)		HX_VARI(  ::Dynamic,data) = this->createData(map,startIndex,endIndex);
HXLINE(  67)		HX_VARI( ::Array< int >,indices) = this->findPathIndicesHelper(data);
HXLINE(  68)		if (::hx::IsNull( indices )) {
HXLINE(  69)			return null();
            		}
HXLINE(  71)		HX_VARI( ::Array< ::Dynamic>,path) = this->getPathPointsFromIndices(data,indices);
HXLINE(  74)		{
...
HXLINE(  96)
HXLINE(  97)		HX_VARI(  ::Dynamic,data) = this->createData(map,startIndex,endIndex);
HXLINE(  98)		HX_VARI( ::Array< int >,indices) = this->findPathIndicesHelper(data);
...
HXLINE( 137)				this->simplifyRay(data,points);
            			...
            			break;
            			case (int)3: {
HXLINE( 138)				HX_VARI( Float,resolution) = simplify->_hx_getFloat(0);
HXDLIN( 138)				this->simplifyRayStep(data,points,resolution);
            			}
            			break;
            			case (int)4: {
HXLINE( 139)				HX_VARI( Float,width) = simplify->_hx_getFloat(0);
HXDLIN( 139)				HX_VARI( Float,height) = simplify->_hx_getFloat(1);
HXDLIN( 139)				this->simplifyRayBox(data,points,width,height);
            			}
            			break;
            			case (int)5: {
HXLINE( 140)				HX_VARI(  ::Dynamic,method) = simplify->_hx_getObject(0);
...
void FlxTypedPathfinder_obj::simplifyLine( ::Dynamic data,::Array< ::Dynamic> points){
            	...
            	HX_STACK_ARG(points,"points")
HXLINE( 152)
HXLINE( 154)		HX_VARI( int,i) = (points->length - 1);
HXLINE( 155)		while(true){
HXLINE( 155)			i = (i - 1);
HXDLIN( 155)			if (!(((i + 1) > 1))) {
HXLINE( 155)				goto _hx_goto_8;
            			}
HXLINE( 157)			HX_VARI(  ::flixel::math::FlxBasePoint,node) = points->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >();
HXLINE( 158)			HX_VARI(  ::flixel::math::FlxBasePoint,next) = points->__get((i + 1)).StaticCast<  ::flixel::math::FlxBasePoint >();
HXLINE( 159)			HX_VARI(  ::flixel::math::FlxBasePoint,last) = points->__get((i - 1)).StaticCast<  ::flixel::math::FlxBasePoint >();
HXLINE( 160)			HX_VARI( Float,deltaLast) = ((node->x - last->x) / (node->y - last->y));
HXLINE( 161)			HX_VARI( Float,deltaNext) = ((node->x - next->x) / (node->y - next->y));
...
HXDLIN( 178)		HX_VARI(  ::flixel::math::FlxBasePoint,tempPoint) = point;
HXLINE( 180)		HX_VARI( int,i) = 1;
...
HXDLIN( 211)		HX_VARI(  ::flixel::math::FlxBasePoint,p1) = point;
...
HXDLIN( 212)		HX_VARI(  ::flixel::math::FlxBasePoint,p2) = point1;
HXLINE( 214)		HX_VARI( int,i) = 1;
...
HXDLIN( 248)		HX_VARI(  ::flixel::math::FlxBasePoint,tempPoint) = point;
HXLINE( 250)		HX_VARI( int,i) = 1;
...
HXLINE( 294)		HX_VARI( ::Array< int >,current) = ::Array_obj< int >::__new(1)->init(0,( ( ::flixel::path::FlxTypedPathfinderData)(data) )->startIndex);
HXLINE( 295)		while((current->length > 0)){
HXLINE( 297)			HX_VARI( ::Array< int >,neighbors) = ::Array_obj< int >::__new();
HXLINE( 300)			{
HXLINE( 300)				int _g = 0;
HXDLIN( 300)				while((_g < current->length)){
HXLINE( 300)					HX_VARI( int,currentIndex) = current->__get(_g);
HXDLIN( 300)					_g = (_g + 1);
HXLINE( 303)					HX_VARI( ::Array< int >,cellNeighbors) = this->getNeighbors(data,currentIndex);
HXLINE( 306)					HX_VARI( int,distanceSoFar) = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->distances->__get(currentIndex);
HXLINE( 307)					{
HXLINE( 307)						int _g1 = 0;
HXDLIN( 307)						while((_g1 < cellNeighbors->length)){
HXLINE( 307)							HX_VARI( int,neighbor) = cellNeighbors->__get(_g1);
HXDLIN( 307)							_g1 = (_g1 + 1);
HXLINE( 309)							HX_VARI( int,oldDistance) = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->distances->__get(neighbor);
...
HXLINE( 317)							HX_VARI( int,distance) = (distanceSoFar + this->getDistance(data,currentIndex,neighbor));
...
HXLINE( 329)					HX_VARI_NAME( int,neighbor1,"neighbor") = neighbors->__get(_g2);

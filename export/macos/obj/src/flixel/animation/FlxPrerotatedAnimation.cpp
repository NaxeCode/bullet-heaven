...
HXLINE(  28)		HX_VARI( int,oldIndex) = this->curIndex;
HXLINE(  29)		HX_VARI( int,angleHelper) = ::Math_obj::floor(::hx::Mod(Value,360));
HXLINE(  31)		while((angleHelper < 0)){
HXLINE(  33)			angleHelper = (angleHelper + 360);
            		}
HXLINE(  36)		HX_VARI( int,newIndex) = ::Math_obj::floor(((( (Float)(angleHelper) ) / this->baked) + ((Float)0.5)));

...
HXLINE( 112)		{
HXLINE( 112)			HX_VARI(  ::Dynamic,anim) = controller->_animations->iterator();
HXDLIN( 112)			while(( (bool)(anim->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 112)				HX_VARI_NAME(  ::flixel::animation::FlxAnimation,anim1,"anim") = ( ( ::flixel::animation::FlxAnimation)(anim->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 173)			HX_VAR(  ::flixel::animation::FlxAnimation,anim);
HXLINE( 174)			{
HXLINE( 174)				HX_VARI(  ::Dynamic,key) = this->_animations->keys();
HXDLIN( 174)				while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 174)					HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 207)		HX_VARI( ::Array< int >,framesToAdd) = frames;
HXLINE( 208)		HX_VARI( bool,hasInvalidFrames) = false;
HXLINE( 209)		HX_VARI( int,i) = framesToAdd->length;
HXLINE( 210)		while(true){
HXLINE( 210)			i = (i - 1);
HXDLIN( 210)			if (!(((i + 1) >= 0))) {
HXLINE( 210)				goto _hx_goto_11;
            			}
HXLINE( 212)			HX_VARI( int,frame) = framesToAdd->__get(i);
...
HXLINE( 229)			HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),name,framesToAdd,frameRate,looped,flipX,flipY);
...
void FlxAnimationController_obj::remove(::String Name){
            	...
            	HX_STACK_ARG(Name,"Name")
HXLINE( 245)
HXLINE( 246)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
void FlxAnimationController_obj::append(::String name,::Array< int > frames){
            	...
            	HX_STACK_ARG(frames,"frames")
HXLINE( 263)
HXLINE( 264)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(name)) );
...
HXLINE( 272)		HX_VARI( bool,hasInvalidFrames) = false;
HXLINE( 275)		{
HXLINE( 275)			int _g = 0;
HXDLIN( 275)			while((_g < frames->length)){
HXLINE( 275)				HX_VARI( int,frame) = frames->__get(_g);
HXDLIN( 275)				_g = (_g + 1);
...
HXLINE( 301)			HX_VARI( ::Array< int >,indices) = ::Array_obj< int >::__new();
HXLINE( 302)			this->byNamesHelper(indices,FrameNames);
HXLINE( 304)			if ((indices->length > 0)) {
HXLINE( 306)				HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,indices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByNames(::String name,::Array< ::String > frameNames){
            	...
            	HX_STACK_ARG(frameNames,"frameNames")
HXLINE( 321)
HXLINE( 322)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(name)) );
...
HXLINE( 353)			HX_VARI( ::Array< int >,frameIndices) = ::Array_obj< int >::__new();
HXLINE( 355)			this->byStringIndicesHelper(frameIndices,Prefix,Indices,Postfix);
HXLINE( 357)			if ((frameIndices->length > 0)) {
HXLINE( 359)				HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByStringIndices(::String name,::String prefix,::Array< ::String > indices,::String suffix){
            	...
            	HX_STACK_ARG(prefix,"prefix")
            	HX_STACK_ARG(indices,"indices")
            	HX_STACK_ARG(suffix,"suffix")
HXLINE( 377)
HXLINE( 378)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(name)) );
...
HXLINE( 409)			HX_VARI( ::Array< int >,frameIndices) = ::Array_obj< int >::__new();
HXLINE( 411)			this->byIndicesHelper(frameIndices,Prefix,Indices,Postfix);
HXLINE( 413)			if ((frameIndices->length > 0)) {
HXLINE( 415)				HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),Name,frameIndices,FrameRate,Looped,FlipX,FlipY);
...
void FlxAnimationController_obj::appendByIndices(::String name,::String prefix,::Array< int > indices,::String suffix){
            	...
            	HX_STACK_ARG(suffix,"suffix")
HXLINE( 434)
HXLINE( 435)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(name)) );
...
int FlxAnimationController_obj::findSpriteFrame(::String prefix,int index,::String postfix){
            	...
            	HX_STACK_ARG(postfix,"postfix")
HXLINE( 456)
HXLINE( 457)		HX_VARI( ::Array< ::Dynamic>,frames) = this->_sprite->frames->frames;
HXLINE( 458)		{
HXLINE( 458)			int _g = 0;
HXDLIN( 458)			int _g1 = frames->length;
HXDLIN( 458)			while((_g < _g1)){
HXLINE( 458)				_g = (_g + 1);
HXDLIN( 458)				HX_VARI( int,i) = (_g - 1);
HXLINE( 460)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = frames->__get(i).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXLINE( 461)				HX_VARI( ::String,name) = frame->name;
...
HXLINE( 464)					HX_VARI(  ::Dynamic,frameIndex) = ::Std_obj::parseInt(name.substring(prefix.length,(name.length - postfix.length)));
...
HXLINE( 488)			HX_VARI( ::Array< ::Dynamic>,animFrames) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 489)			this->findByPrefix(animFrames,prefix,null());
HXLINE( 491)			if ((animFrames->length > 0)) {
HXLINE( 493)				HX_VARI( ::Array< int >,frameIndices) = ::Array_obj< int >::__new(0);
HXLINE( 494)				this->byPrefixHelper(frameIndices,animFrames,prefix);
HXLINE( 495)				HX_VARI(  ::flixel::animation::FlxAnimation,anim) =  ::flixel::animation::FlxAnimation_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),name,frameIndices,frameRate,looped,flipX,flipY);
...
void FlxAnimationController_obj::appendByPrefix(::String name,::String prefix){
            	...
            	HX_STACK_ARG(prefix,"prefix")
HXLINE( 514)
HXLINE( 515)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(name)) );
...
HXLINE( 524)			HX_VARI( ::Array< ::Dynamic>,animFrames) = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 564)		HX_VARI( bool,oldFlipX) = false;
HXLINE( 565)		HX_VARI( bool,oldFlipY) = false;
...
HXDLIN( 691)			HX_VARI( ::String,frameName) = frameNames->__get(_g);
HXDLIN( 691)			_g = (_g + 1);
HXLINE( 693)			if (this->_sprite->frames->framesByName->exists(frameName)) {
HXLINE( 695)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frameToAdd) = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesByName->get(frameName)) );
...
HXDLIN( 703)			HX_VARI( ::String,index) = indices->__get(_g);
HXDLIN( 703)			_g = (_g + 1);
HXLINE( 705)			HX_VARI( ::String,name) = ((prefix + index) + suffix);
HXLINE( 706)			if (this->_sprite->frames->framesByName->exists(name)) {
HXLINE( 708)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frameToAdd) = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesByName->get(name)) );
...
HXDLIN( 716)			HX_VARI( int,index) = indices->__get(_g);
HXDLIN( 716)			_g = (_g + 1);
HXLINE( 718)			HX_VARI( int,indexToAdd) = this->findSpriteFrame(prefix,index,suffix);
...
void FlxAnimationController_obj::byPrefixHelper(::Array< int > addTo,::Array< ::Dynamic> frames,::String prefix){
            	...
            	HX_STACK_ARG(prefix,"prefix")
HXLINE( 725)
HXLINE( 726)		HX_VARI( ::String,name) = frames->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name;
HXLINE( 727)		HX_VARI( int,postIndex) = name.indexOf(HX_(".",2e,00,00,00),prefix.length);
...
HXDLIN( 728)		HX_VARI_NAME( ::String,postFix1,"postFix") = name.substring(postFix,name.length);
...
HXLINE( 731)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = frames->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 731)				_g = (_g + 1);
...
HXLINE( 739)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 739)				_g = (_g + 1);
...
HXLINE( 748)		HX_VARI( ::Array< ::Dynamic>,invalidFrames) = this->removeInvalidFrames(animFrames);
...
HXDLIN( 753)		HX_VARI( ::String,names) = result->join(HX_(", ",74,26,00,00));
...
::Array< ::Dynamic> FlxAnimationController_obj::removeInvalidFrames(::Array< ::Dynamic> frames){
            	...
            	HX_STACK_ARG(frames,"frames")
HXLINE( 759)
HXLINE( 760)		HX_VARI( ::Array< ::Dynamic>,invalid) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 761)		HX_VARI( int,i) = frames->length;
HXLINE( 762)		while(true){
HXLINE( 762)			i = (i - 1);
HXDLIN( 762)			if (!(((i + 1) > 0))) {
HXLINE( 762)				goto _hx_goto_48;
            			}
HXLINE( 764)			HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = frames->__get(i).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXLINE( 800)			HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesByName->get(Value)) );
...
::String FlxAnimationController_obj::get_name(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 811)
HXLINE( 812)		HX_VARI( ::String,animName) = null();
...
::Array< ::Dynamic> FlxAnimationController_obj::getAnimationList(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 833)
HXLINE( 834)		HX_VARI( ::Array< ::Dynamic>,animList) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 836)		{
HXLINE( 836)			HX_VARI(  ::Dynamic,anims) = this->_animations->iterator();
HXDLIN( 836)			while(( (bool)(anims->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 836)				HX_VARI_NAME(  ::flixel::animation::FlxAnimation,anims1,"anims") = ( ( ::flixel::animation::FlxAnimation)(anims->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
::Array< ::String > FlxAnimationController_obj::getNameList(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 851)
HXLINE( 852)		HX_VARI( ::Array< ::String >,namesList) = ::Array_obj< ::String >::__new(0);
HXLINE( 853)		{
HXLINE( 853)			HX_VARI(  ::Dynamic,names) = this->_animations->keys();
HXDLIN( 853)			while(( (bool)(names->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 853)				HX_VARI_NAME( ::String,names1,"names") = ( (::String)(names->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
void FlxAnimationController_obj::rename(::String oldName,::String newName){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(oldName,"oldName")
            	HX_STACK_ARG(newName,"newName")
HXLINE( 878)
HXLINE( 879)		HX_VARI(  ::flixel::animation::FlxAnimation,anim) = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(oldName)) );
...
bool FlxAnimationController_obj::get_paused(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 913)
HXLINE( 914)		HX_VARI( bool,paused) = false;
...
bool FlxAnimationController_obj::get_finished(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 939)
HXLINE( 940)		HX_VARI( bool,finished) = true;

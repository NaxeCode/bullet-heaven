...
HXLINE( 148)		HX_VARI( int,maxFrameIndex) = (this->frames->length - 1);
...
HXLINE( 205)
HXLINE( 206)		HX_VARI( Float,curFrameDuration) = this->getCurrentFrameDuration();
...
Float FlxAnimation_obj::getCurrentFrameDuration(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 238)
HXLINE( 239)		HX_VARI( Float,curframeDuration) = this->parent->getFrameDuration(this->frames->__get(this->curFrame));
...
int FlxAnimation_obj::set_curFrame(int frame){
            	...
            	HX_STACK_ARG(frame,"frame")
HXLINE( 256)
HXLINE( 257)		HX_VARI( int,maxFrameIndex) = (this->frames->length - 1);
HXLINE( 258)		HX_VAR( int,tempFrame);

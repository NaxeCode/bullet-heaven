...
HXLINE( 378)
HXLINE( 379)		HX_VARI(  ::flixel::FlxState,stateOnCall) = ::flixel::FlxG_obj::game->_state;
...
HXLINE( 435)		HX_VARI(  ::flixel::_hx_system::FlxQuadTree,quadTree) = ::flixel::_hx_system::FlxQuadTree_obj::recycle(::flixel::FlxG_obj::worldBounds->x,::flixel::FlxG_obj::worldBounds->y,::flixel::FlxG_obj::worldBounds->width,::flixel::FlxG_obj::worldBounds->height,null());
HXLINE( 436)		quadTree->load(objectOrGroup1,objectOrGroup2,notifyCallback,processCallback);
HXLINE( 437)		HX_VARI( bool,result) = quadTree->execute();
...
HXLINE( 493)
HXLINE( 494)		HX_VARI( int,index) = ::flixel::FlxG_obj::game->getChildIndex(::flixel::FlxG_obj::game->_inputContainer);
HXLINE( 495)		HX_VARI( int,max) = ::flixel::FlxG_obj::game->get_numChildren();
...
HXLINE( 697)		HX_VARI( ::String,name) = ::openfl::Lib_obj::get_current()->stage->application->meta->get_string(HX_("file",7c,ce,bb,43));
...
HXLINE( 743)		HX_VARI(  ::flixel::input::mouse::FlxMouse,oldMouse) = ::flixel::FlxG_obj::mouse;
HXLINE( 744)		HX_VARI(  ::flixel::input::mouse::FlxMouse,result) = ::flixel::FlxG_obj::inputs->replace_flixel_input_mouse_FlxMouse(oldMouse,NewMouse);

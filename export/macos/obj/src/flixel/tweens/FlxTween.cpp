...
HXLINE( 709)		HX_VARI( int,type) = (this->type & ~(16));
...
HXLINE( 838)
HXLINE( 839)		HX_VARI( Float,dly) = ::Math_obj::abs(value);
...
Float FlxTween_obj::set_loopDelay( ::Dynamic value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 848)
HXLINE( 849)		HX_VARI( Float,dly) = ::Math_obj::abs(( (Float)(value) ));

...
HXLINE(  60)					HX_VARI(  ::Dynamic,info) = _g1->__get(_g);
HXDLIN(  60)					_g = (_g + 1);
...
void VarTween_obj::initializeVars(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  66)
HXLINE(  67)		HX_VAR( ::Array< ::String >,fieldPaths);
...
HXLINE(  73)				HX_VARI( ::String,fieldPath) = fieldPaths->__get(_g);
HXDLIN(  73)				_g = (_g + 1);
HXLINE(  75)				HX_VARI(  ::Dynamic,target) = this->_object;
HXLINE(  76)				HX_VARI( ::Array< ::String >,path) = fieldPath.split(HX_(".",2e,00,00,00));
HXLINE(  77)				HX_VARI( ::String,field) = ( (::String)(path->pop()) );
HXLINE(  78)				{
HXLINE(  78)					int _g1 = 0;
HXDLIN(  78)					while((_g1 < path->length)){
HXLINE(  78)						HX_VARI( ::String,component) = path->__get(_g1);
HXDLIN(  78)						_g1 = (_g1 + 1);
...
HXDLIN(  96)			HX_VARI(  ::Dynamic,info) = _g1->__get(_g);
HXDLIN(  96)			_g = (_g + 1);
...
HXLINE( 101)			HX_VARI(  ::Dynamic,value) = ::Reflect_obj::getProperty( ::Dynamic(info->__Field(HX_("object",bf,7e,3f,15),::hx::paccDynamic)),( (::String)(info->__Field(HX_("field",ba,94,93,00),::hx::paccDynamic)) ));
...
HXLINE( 123)				HX_VARI(  ::Dynamic,property) = _g1->__get(_g);
HXDLIN( 123)				_g = (_g + 1);

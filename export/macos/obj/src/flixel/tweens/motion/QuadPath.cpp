...
HXLINE(  44)				HX_VARI(  ::flixel::math::FlxBasePoint,point) = _g1->__get(_g).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN(  44)				_g = (_g + 1);
...
HXLINE( 177)		HX_VARI( int,i) = 0;
HXLINE( 178)		HX_VARI( int,j) = 0;
...
HXLINE( 189)		i = 0;
HXLINE( 190)		HX_VARI( Float,d) = ( (Float)(0) );
...
HXDLIN( 202)		HX_VARI(  ::flixel::math::FlxBasePoint,p1) = point;
...
HXDLIN( 203)		HX_VARI(  ::flixel::math::FlxBasePoint,p2) = point1;
...
HXLINE( 209)		HX_VARI( Float,a) = (( (Float)(4) ) * ((p1->x * p1->x) + (p1->y * p1->y)));
HXDLIN( 209)		HX_VARI( Float,b) = (( (Float)(4) ) * ((p1->x * p2->x) + (p1->y * p2->y)));
HXDLIN( 209)		HX_VARI( Float,c) = ((p2->x * p2->x) + (p2->y * p2->y));
HXDLIN( 209)		HX_VARI( Float,abc) = (( (Float)(2) ) * ::Math_obj::sqrt(((a + b) + c)));
HXDLIN( 209)		HX_VARI( Float,a2) = ::Math_obj::sqrt(a);
HXDLIN( 209)		HX_VARI( Float,a32) = ((( (Float)(2) ) * a) * a2);
HXDLIN( 209)		HX_VARI( Float,c2) = (( (Float)(2) ) * ::Math_obj::sqrt(c));
HXDLIN( 209)		HX_VARI( Float,ba) = (b / a2);
HXLINE( 218)		p1->put();
HXLINE( 219)		p2->put();

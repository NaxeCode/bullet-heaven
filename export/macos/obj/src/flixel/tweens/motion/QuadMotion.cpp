...
HXDLIN(  77)		HX_VARI(  ::flixel::math::FlxBasePoint,p1) = point;
...
HXDLIN(  78)		HX_VARI(  ::flixel::math::FlxBasePoint,p2) = point1;
...
HXLINE(  83)		HX_VARI( Float,a) = (( (Float)(4) ) * ((p1->x * p1->x) + (p1->y * p1->y)));
HXDLIN(  83)		HX_VARI( Float,b) = (( (Float)(4) ) * ((p1->x * p2->x) + (p1->y * p2->y)));
HXDLIN(  83)		HX_VARI( Float,c) = ((p2->x * p2->x) + (p2->y * p2->y));
HXDLIN(  83)		HX_VARI( Float,abc) = (( (Float)(2) ) * ::Math_obj::sqrt(((a + b) + c)));
HXDLIN(  83)		HX_VARI( Float,a2) = ::Math_obj::sqrt(a);
HXDLIN(  83)		HX_VARI( Float,a32) = ((( (Float)(2) ) * a) * a2);
HXDLIN(  83)		HX_VARI( Float,c2) = (( (Float)(2) ) * ::Math_obj::sqrt(c));
HXDLIN(  83)		HX_VARI( Float,ba) = (b / a2);
HXLINE(  92)		p1->put();
HXLINE(  93)		p2->put();

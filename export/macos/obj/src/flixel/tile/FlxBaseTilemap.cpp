...
HX_DEFINE_DYNAMIC_FUNC4(FlxBaseTilemap_obj,rayStep,return )
 ...
 ::flixel::math::FlxBasePoint FlxBaseTilemap_obj::calcRayEntry( ::flixel::math::FlxBasePoint start, ::flixel::math::FlxBasePoint end, ::flixel::math::FlxBasePoint result){
            	...
            	HX_STACK_ARG(result,"result")
HXLINE( 204)
HXLINE( 205)		HX_VARI(  ::flixel::math::FlxRect,bounds) = this->getBounds(null());
...
HXLINE( 288)		HX_VAR( ::Array< ::String >,columns);
HXLINE( 290)		HX_VARI(  ::EReg,regex) =  ::EReg_obj::__alloc( HX_CTX ,HX_("[ \t]*((\r\n)|\r|\n)[ \t]*",22,2c,8d,6d),HX_("g",67,00,00,00));
HXLINE( 291)		HX_VARI( ::Array< ::String >,lines) = regex->split(mapData);
...
HXDLIN( 292)		HX_VARI( ::Array< ::String >,rows) = _g;
HXLINE( 294)		this->heightInTiles = rows->length;
HXLINE( 295)		this->widthInTiles = 0;
HXLINE( 297)		HX_VARI( int,row) = 0;
HXLINE( 298)		while((row < this->heightInTiles)){
HXLINE( 300)			HX_VARI( ::String,rowString) = rows->__get(row);
...
HXLINE( 315)			HX_VARI( int,column) = 0;
HXLINE( 316)			while((column < this->widthInTiles)){
HXLINE( 319)				HX_VARI( ::String,columnString) = columns->__get(column);
HXLINE( 320)				HX_VARI(  ::Dynamic,curTile) = ::Std_obj::parseInt(columnString);
...
HX_DEFINE_DYNAMIC_FUNC8(FlxBaseTilemap_obj,loadMapFrom2DArray,return )
 ...
 ::flixel::tile::FlxBaseTilemap FlxBaseTilemap_obj::loadMapFromGraphic( ::Dynamic mapGraphic,::hx::Null< bool >  __o_invert,::hx::Null< int >  __o_scale,::Array< int > colorMap, ::Dynamic tileGraphic,::hx::Null< int >  __o_tileWidth,::hx::Null< int >  __o_tileHeight, ::flixel::tile::FlxTilemapAutoTiling autoTile,::hx::Null< int >  __o_startingIndex,::hx::Null< int >  __o_drawIndex,::hx::Null< int >  __o_collideIndex){
            	...
            	HX_STACK_ARG(collideIndex,"collideIndex")
HXLINE( 421)
HXLINE( 422)		HX_VARI(  ::openfl::display::BitmapData,mapBitmap) = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(mapGraphic);
HXLINE( 423)		HX_VARI( ::String,mapData) = ::flixel::util::FlxStringUtil_obj::bitmapToCSV(mapBitmap,invert,scale,colorMap);
...
void FlxBaseTilemap_obj::applyCustomRemap(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 479)
HXLINE( 480)		HX_VARI( int,i) = 0;
HXLINE( 482)		if (::hx::IsNotNull( this->customTileRemap )) {
HXLINE( 484)			while((i < this->totalTiles)){
HXLINE( 486)				HX_VARI( int,oldIndex) = this->_data->__get(i);
HXLINE( 487)				HX_VARI( int,newIndex) = oldIndex;
...
void FlxBaseTilemap_obj::randomizeIndices(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 499)
HXLINE( 500)		HX_VARI( int,i) = 0;
HXLINE( 502)		if (::hx::IsNotNull( this->_randomIndices )) {
HXLINE( 504)			HX_VAR(  ::Dynamic,randLambda);
...
HXLINE( 511)				HX_VARI( int,oldIndex) = this->_data->__get(i);
HXLINE( 512)				HX_VARI( int,j) = 0;
HXLINE( 513)				HX_VARI( int,newIndex) = oldIndex;
HXLINE( 514)				{
HXLINE( 514)					int _g = 0;
HXDLIN( 514)					::Array< int > _g1 = this->_randomIndices;
HXDLIN( 514)					while((_g < _g1->length)){
HXLINE( 514)						HX_VARI( int,rand) = _g1->__get(_g);
HXDLIN( 514)						_g = (_g + 1);
HXLINE( 516)						if ((oldIndex == rand)) {
HXLINE( 518)							Float k = ( (Float)(randLambda()) );
HXDLIN( 518)							HX_VARI_NAME( int,k1,"k") = ::Std_obj::_hx_int((k * ( (Float)(this->_randomChoices->__get(j).StaticCast< ::Array< int > >()->length) )));
...
HXLINE( 609)		HX_VARI( bool,wallUp) = ((index - this->widthInTiles) < 0);
HXLINE( 610)		HX_VARI( bool,wallRight) = (::hx::Mod(index,this->widthInTiles) >= (this->widthInTiles - 1));
HXLINE( 611)		int wallDown = ::Std_obj::_hx_int(( (Float)((index + this->widthInTiles)) ));
HXDLIN( 611)		HX_VARI_NAME( bool,wallDown1,"wallDown") = (wallDown >= this->totalTiles);
HXLINE( 612)		HX_VARI( bool,wallLeft) = (::hx::Mod(index,this->widthInTiles) <= 0);
HXLINE( 614)		HX_VAR( bool,up);
...
HXLINE( 615)		HX_VAR( bool,upRight);
...
HXLINE( 617)		HX_VAR( bool,rightDown);
...
HXLINE( 619)		HX_VAR( bool,downLeft);
...
::Array< int > FlxBaseTilemap_obj::getTileInstances(int index){
            	...
            	HX_STACK_ARG(index,"index")
HXLINE( 707)
HXLINE( 708)		HX_VARI( ::Array< int >,array) = null();
HXLINE( 709)		HX_VARI( int,i) = 0;
HXLINE( 710)		HX_VARI( int,l) = (this->widthInTiles * this->heightInTiles);
...
HXLINE( 762)		HX_VARI( bool,ok) = true;
...
HXLINE( 779)		HX_VAR( int,i);
HXLINE( 780)		HX_VARI( int,row) = (::Std_obj::_hx_int((( (Float)(index) ) / ( (Float)(this->widthInTiles) ))) - 1);
HXLINE( 781)		HX_VARI( int,rowLength) = (row + 3);
HXLINE( 782)		HX_VARI( int,column) = (::hx::Mod(index,this->widthInTiles) - 1);
HXLINE( 783)		HX_VARI( int,columnHeight) = (column + 3);
...
HXLINE( 822)		HX_VARI( int,maxIndex) = this->_tileObjects->get_length();
HXLINE( 823)		HX_VARI( int,end) = (tile + range);
HXLINE( 824)		if ((maxIndex == 0)) {
HXLINE( 826)			HX_VAR( ::String,rangeDisplay);
...
HXLINE( 834)			HX_VAR_NAME( ::String,rangeDisplay1,"rangeDisplay");
...
HXLINE( 839)				_g = (_g + 1);
HXDLIN( 839)				HX_VARI( int,i) = (_g - 1);
HXLINE( 841)				HX_VARI(  ::Dynamic,tileData) = this->_tileObjects->__get(i);
...
HXLINE( 862)		HX_VARI( int,i) = 0;
HXLINE( 863)		HX_VARI( int,l) = this->_data->length;
HXLINE( 864)		HX_VARI( ::Array< int >,data) = ::Array_obj< int >::__new();
...
::Array< ::Dynamic> FlxBaseTilemap_obj::findPathCustom( ::flixel::path::FlxTypedPathfinder pathfinder, ::flixel::math::FlxBasePoint start, ::flixel::math::FlxBasePoint end, ::flixel::path::FlxPathSimplifier __o_simplify){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pathfinder,"pathfinder")
            	HX_STACK_ARG(start,"start")
            	HX_STACK_ARG(end,"end")
            	HX_STACK_ARG(simplify,"simplify")
HXLINE( 916)
...
HXLINE( 930)
HXLINE( 931)		HX_VARI(  ::flixel::path::FlxTypedPathfinderData,data) = this->computePathData(startIndex,endIndex,diagonalPolicy,stopOnEnd);
...
HXLINE( 973)
HXLINE( 974)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(objectOrGroup);
...
bool FlxBaseTilemap_obj::overlapsAt(Float x,Float y, ::flixel::FlxBasic objectOrGroup,::hx::Null< bool >  __o_inScreenSpace, ::flixel::FlxCamera camera){
            	...
            	HX_STACK_ARG(camera,"camera")
HXLINE(1007)
HXLINE(1008)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(objectOrGroup);
...
HXLINE(1050)
HXLINE(1051)		HX_VARI( int,tileIndex) = this->getTileIndexByCoords(point);

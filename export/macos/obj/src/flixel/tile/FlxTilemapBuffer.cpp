...
HXLINE( 122)			HX_VARI( int,newWidth) = ::Std_obj::_hx_int(( (Float)((this->columns * tileWidth)) ));
HXLINE( 123)			HX_VARI( int,newHeight) = ::Std_obj::_hx_int(( (Float)((this->rows * tileHeight)) ));

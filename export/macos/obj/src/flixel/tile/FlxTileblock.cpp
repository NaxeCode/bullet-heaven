...
HXLINE(  63)		HX_VARI( int,total) = (this->tileSprite->get_numFrames() + empties);
...
HXLINE(  90)		HX_VARI( int,row) = 0;
HXLINE(  91)		HX_VAR( int,column);
HXLINE(  92)		HX_VAR( int,destinationX);
HXLINE(  93)		HX_VARI( int,destinationY) = 0;
HXLINE(  94)		HX_VARI( int,widthInTiles) = ::Std_obj::_hx_int((this->get_width() / ( (Float)(spriteWidth) )));
HXLINE(  95)		HX_VARI( int,heightInTiles) = ::Std_obj::_hx_int((this->get_height() / ( (Float)(spriteHeight) )));

...
HXLINE(  48)
HXLINE(  50)		HX_VAR( bool,advanced);
...
HXLINE(  74)		HX_VARI(  ::openfl::display::BitmapData,testA) = contact->framePixels;
HXLINE(  75)		HX_VARI(  ::openfl::display::BitmapData,testB) = target->framePixels;
HXLINE(  77)		HX_VARI( int,overlapWidth) = ::Std_obj::_hx_int(::flixel::util::FlxCollision_obj::intersect->width);
HXLINE(  78)		HX_VARI( int,overlapHeight) = ::Std_obj::_hx_int(::flixel::util::FlxCollision_obj::intersect->height);
...
HXLINE(  96)			HX_VARI(  ::openfl::display::BitmapData,testA2) = ::flixel::util::FlxBitmapDataPool_obj::get(::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsA->width),::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsA->height),true,0,false);
...
HXLINE( 109)			HX_VARI(  ::openfl::display::BitmapData,testB2) = ::flixel::util::FlxBitmapDataPool_obj::get(::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsB->width),::Math_obj::floor(::flixel::util::FlxCollision_obj::boundsB->height),true,0,false);
...
HXLINE( 125)		HX_VARI(  ::openfl::utils::ByteArrayData,pixelsA) = testA->getPixels(::flixel::util::FlxCollision_obj::flashRect);
HXLINE( 127)		{
...
HXLINE( 128)		HX_VARI(  ::openfl::utils::ByteArrayData,pixelsB) = testB->getPixels(::flixel::util::FlxCollision_obj::flashRect);
HXLINE( 130)		HX_VARI( bool,hit) = false;
HXLINE( 133)		HX_VARI( int,alphaA) = 0;
HXLINE( 134)		HX_VARI( int,alphaB) = 0;
HXLINE( 135)		HX_VARI( int,overlapPixels) = (overlapWidth * overlapHeight);
HXLINE( 136)		HX_VARI( int,alphaIdx) = 0;
HXLINE( 139)		{
HXLINE( 139)			int _g = 0;
HXDLIN( 139)			int _g1 = ::Math_obj::ceil((( (Float)(overlapPixels) ) / ( (Float)(2) )));
HXDLIN( 139)			while((_g < _g1)){
HXLINE( 139)				_g = (_g + 1);
HXDLIN( 139)				HX_VARI( int,i) = (_g - 1);
...
HXDLIN( 156)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
bool FlxCollision_obj::pixelPerfectPointCheck(int worldX,int worldY, ::flixel::FlxSprite target,::hx::Null< int >  __o_alphaTolerance){
            	...
            	HX_STACK_ARG(worldX,"worldX")
            	HX_STACK_ARG(worldY,"worldY")
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(alphaTolerance,"alphaTolerance")
HXLINE( 194)
...
HXLINE( 211)
HXLINE( 212)		HX_VARI(  ::flixel::tile::FlxTileblock,left) = null();
HXLINE( 213)		HX_VARI(  ::flixel::tile::FlxTileblock,right) = null();
HXLINE( 214)		HX_VARI(  ::flixel::tile::FlxTileblock,top) = null();
HXLINE( 215)		HX_VARI(  ::flixel::tile::FlxTileblock,bottom) = null();
...
HXLINE( 243)		HX_VARI(  ::flixel::group::FlxTypedGroup,result) =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
...
HXLINE( 270)
HXDLIN( 270)		HX_VARI_NAME( ::Array< ::Dynamic>,result1,"result") = ::Array_obj< ::Dynamic>::__new(1)->init(0,result);
HXLINE( 282)		HX_VARI(  ::Dynamic,getResult) =  ::Dynamic(new _hx_Closure_0(rect,start,end,result1));
HXLINE( 293)		HX_VARI(  ::Dynamic,nullResult) =  ::Dynamic(new _hx_Closure_1(rect,start,end));
...
HXLINE( 323)		HX_VARI( Float,m) = ((start->y - end->y) / (start->x - end->x));
HXLINE( 325)		HX_VARI( Float,b) = (start->y - (m * start->x));
HXLINE( 327)		HX_VARI( Float,leftY) = ((m * rect->x) + b);
HXLINE( 328)		HX_VARI( Float,rightY) = ((m * (rect->x + rect->width)) + b);

...
bool FlxSave_obj::mergeDataFrom(::String name,::String path,::hx::Null< bool >  __o_overwrite,::hx::Null< bool >  __o_eraseSave,::hx::Null< int >  __o_minFileSize){
            	...
            	HX_STACK_ARG(eraseSave,"eraseSave")
            	HX_STACK_ARG(minFileSize,"minFileSize")
HXLINE( 192)
HXLINE( 193)		if (!(this->checkStatus())) {
HXLINE( 194)			return false;
            		}
HXLINE( 196)		HX_VARI(  ::flixel::util::FlxSave,oldSave) =  ::flixel::util::FlxSave_obj::__alloc( HX_CTX );
HXLINE( 198)		if (oldSave->bind(name,path)) {
HXLINE( 200)			HX_VARI( bool,success) = this->mergeData(oldSave->data,overwrite,minFileSize);
...
bool FlxSave_obj::mergeData( ::Dynamic sourceData,::hx::Null< bool >  __o_overwrite,::hx::Null< int >  __o_minFileSize){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sourceData,"sourceData")
            	HX_STACK_ARG(overwrite,"overwrite")
            	HX_STACK_ARG(minFileSize,"minFileSize")
HXLINE( 224)
HXLINE( 225)		HX_VARI( bool,hasAnyField) = false;
HXLINE( 226)		{
HXLINE( 226)			int _g = 0;
HXDLIN( 226)			::Array< ::String > _g1 = ::Reflect_obj::fields(sourceData);
HXDLIN( 226)			while((_g < _g1->length)){
HXLINE( 226)				HX_VARI( ::String,field) = _g1->__get(_g);
HXDLIN( 226)				_g = (_g + 1);
...
bool FlxSave_obj::close(::hx::Null< int >  __o_minFileSize){
            	...
            	HX_STACK_ARG(minFileSize,"minFileSize")
HXLINE( 250)
HXLINE( 251)		HX_VARI( bool,success) = this->flush(minFileSize);
...
HXLINE( 267)		try {
            			HX_STACK_CATCHABLE( ::openfl::errors::Error, 0);
HXLINE( 269)			HX_VARI(  ::Dynamic,result) = this->_sharedObject->flush(minFileSize);
...
HXLINE( 311)					::flixel::FlxG_obj::log->advanced(HX_("You must call FlxSave.bind() before you can read or write data.",15,79,e0,84),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            				...
            				break;
            				case (int)2: {
HXLINE( 312)					HX_VARI( ::String,msg) = _g->_hx_getString(0);
...
HXDLIN( 325)			HX_VARI( ::String,n) = _g->_hx_getString(0);
HXDLIN( 325)			return n;
            		}
            		else {
...
HXDLIN( 335)			HX_VARI( ::String,p) = _g->_hx_getString(1);
HXDLIN( 335)			return p;
            		}
            		else {
...
::String FlxSave_obj::validateAndWarn(::String str,::String fieldId){
            	...
            	HX_STACK_ARG(str,"str")
            	HX_STACK_ARG(fieldId,"fieldId")
HXLINE(  92)
HXLINE(  93)		HX_VARI( ::String,newStr) = ::flixel::util::FlxSave_obj::validate(str);

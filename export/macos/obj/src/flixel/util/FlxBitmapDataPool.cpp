...
HXLINE(  41)
HXLINE(  42)		HX_VARI(  ::openfl::display::BitmapData,res) = null();
...
HXLINE(  48)			HX_VARI(  ::openfl::display::BitmapData,bmd) = node->bmd;
...
HXLINE(  96)			HX_VARI(  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode,last) = ::flixel::util::FlxBitmapDataPool_obj::_tail;
...
HXLINE( 107)		HX_VARI(  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode,node) =  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode_obj::__alloc( HX_CTX ,bmd,null(),null());
...
HXLINE( 125)
HXLINE( 126)		HX_VARI(  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode,node) = ::flixel::util::FlxBitmapDataPool_obj::_head;
HXLINE( 127)		while(::hx::IsNotNull( node )){
HXLINE( 129)			HX_VARI(  ::openfl::display::BitmapData,bmd) = node->bmd;
...
HXLINE( 142)			HX_VARI(  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode,node) = ::flixel::util::FlxBitmapDataPool_obj::_tail;
...
HXLINE( 145)				HX_VARI(  ::openfl::display::BitmapData,bmd) = node->bmd;

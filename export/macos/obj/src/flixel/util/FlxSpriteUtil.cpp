...
HXLINE(  58)
HXLINE(  59)		HX_VARI(  ::openfl::display::BitmapData,data) = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(source);
HXLINE(  60)		HX_VARI(  ::openfl::display::BitmapData,maskData) = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(mask);
...
HXLINE(  89)		HX_VARI(  ::openfl::display::BitmapData,data) = sprite->get_pixels()->clone();
...
HXLINE( 173)		HX_VARI(  ::flixel::math::FlxRect,spriteBounds) = sprite->getScreenBounds(null(),camera);
...
HXDLIN( 174)		HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point;
...
HXLINE( 209)		HX_VARI(  ::flixel::math::FlxRect,spriteBounds) = sprite->getScreenBounds(null(),camera);
...
HXDLIN( 210)		HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point;
...
HXLINE( 244)
HXLINE( 245)		HX_VARI( Float,prevWidth) = ( (Float)(0) );
HXLINE( 246)		HX_VARI( Float,runningX) = ( (Float)(0) );
...
HXLINE( 261)		HX_VARI( Float,prevHeight) = ( (Float)(0) );
HXLINE( 262)		HX_VARI( Float,runningY) = ( (Float)(0) );
...
HXLINE( 287)		HX_VARI( Float,curX) = ( (Float)(0) );
HXLINE( 288)		HX_VARI( Float,curY) = ( (Float)(0) );
HXLINE( 290)		{
HXLINE( 290)			int _g = 1;
...
HXLINE( 292)				HX_VARI(  ::flixel::FlxObject,object) = objects->__get(i).StaticCast<  ::flixel::FlxObject >();
...
HXLINE( 474)			HX_VARI(  ::flixel::math::FlxBasePoint,midPoint) = sprite->getGraphicMidpoint(null());
HXLINE( 476)			if ((X == -1)) {
...
HXLINE( 486)			HX_VARI( Float,minVal) = ::Math_obj::min(( (Float)(sprite->frameWidth) ),( (Float)(sprite->frameHeight) ));
...
HXLINE( 556)		HX_VARI(  ::flixel::math::FlxBasePoint,p) = Vertices->shift().StaticCast<  ::flixel::math::FlxBasePoint >();
HXLINE( 557)		::flixel::util::FlxSpriteUtil_obj::flashGfx->moveTo(p->x,p->y);
HXLINE( 558)		{
HXLINE( 558)			int _g = 0;
HXDLIN( 558)			while((_g < Vertices->length)){
HXLINE( 558)				HX_VARI_NAME(  ::flixel::math::FlxBasePoint,p1,"p") = Vertices->__get(_g).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 558)				_g = (_g + 1);
...
HXLINE( 634)			HX_VAR(  ::Dynamic,color);
...
void FlxSpriteUtil_obj::setTint( ::flixel::FlxSprite sprite,int tint){
            	...
            	HX_STACK_ARG(sprite,"sprite")
            	HX_STACK_ARG(tint,"tint")
HXLINE( 768)
HXLINE( 769)		HX_VARI( Float,strength) = (( (Float)(((tint >> 24) & 255)) ) / ( (Float)(255) ));
HXLINE( 775)		HX_VARI( Float,mult) = (( (Float)(1) ) - strength);
...
HXDLIN( 803)				sprite->setColorTransform(mult,mult,mult,((Float)1.0),::Math_obj::round((( (Float)(((color->__get(0) >> 16) & 255)) ) * strength2)),::Math_obj::round((( (Float)(((color->__get(0) >> 8) & 255)) ) * strength2)),::Math_obj::round((( (Float)((color->__get(0) & 255)) ) * strength2)),null());
            	...
            	HX_STACK_ARG(onComplete,"onComplete")
HXLINE( 793)
HXDLIN( 793)		HX_VARI_NAME( ::Array< ::Dynamic>,func1,"func") = ::Array_obj< ::Dynamic>::__new(1)->init(0,func);
HXLINE( 794)		HX_VAR(  ::Dynamic,options);
...
HXLINE( 798)		HX_VARI( ::Array< int >,color) = ::Array_obj< int >::__new(1)->init(0,(tint & 16777215));
HXLINE( 799)		HX_VARI( Float,strength) = (( (Float)(((tint >> 24) & 255)) ) / ( (Float)(255) ));
...
HXLINE( 818)
HXLINE( 819)		HX_VARI( Float,mult) = (((Float)1.0) - ::Math_obj::abs(brightness));
HXLINE( 820)		HX_VARI( int,offset) = ::Math_obj::round(::Math_obj::max(( (Float)(0) ),(( (Float)(255) ) * brightness)));

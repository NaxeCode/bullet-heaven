...
HXLINE( 616)		HX_VARI( ::String,encodedData) = ::haxe::Serializer_obj::run(this->data);
HXLINE( 618)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 620)			HX_VARI( ::String,path) = ::flixel::util::_FlxSave::FlxSharedObject_obj::getPath(this->_hx___localPath,this->_hx___name);
HXLINE( 621)			HX_VARI( ::String,directory) = ::haxe::io::Path_obj::directory(path);
HXLINE( 623)			if (!(::sys::FileSystem_obj::exists(directory))) {
HXLINE( 624)				::openfl::net::SharedObject_obj::_hx___mkdir(directory);
            			}
HXLINE( 626)			HX_VARI(  ::sys::io::FileOutput,output) = ::sys::io::File_obj::write(path,false);
...
HXLINE( 642)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 644)			HX_VARI( ::String,path) = ::flixel::util::_FlxSave::FlxSharedObject_obj::getPath(this->_hx___localPath,this->_hx___name);
...
HXLINE( 397)			HX_VARI(  ::lime::app::Application,app) = ::lime::app::Application_obj::current;
...
void FlxSharedObject_obj::onExit(int _){
            	...
            	HX_STACK_ARG(_,"_")
HXLINE( 405)
HXDLIN( 405)		HX_VARI(  ::Dynamic,sharedObject) = ::flixel::util::_FlxSave::FlxSharedObject_obj::all->iterator();
HXDLIN( 405)		while(( (bool)(sharedObject->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 405)			HX_VARI_NAME(  ::flixel::util::_FlxSave::FlxSharedObject,sharedObject1,"sharedObject") = ( ( ::flixel::util::_FlxSave::FlxSharedObject)(sharedObject->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 413)
HXLINE( 414)		HX_VARI(  ::haxe::ds::StringMap,meta) = ::openfl::Lib_obj::get_current()->stage->application->meta;
HXLINE( 415)		HX_VARI( ::String,path) = meta->get_string(HX_("company",3d,15,69,83));
...
HXLINE( 432)		HX_VARI( ::String,id) = ((localPath + HX_("/",2f,00,00,00)) + name);
...
HXLINE( 438)			HX_VARI( ::String,encodedData) = null();
HXLINE( 440)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXLINE( 452)			HX_VARI(  ::flixel::util::_FlxSave::FlxSharedObject,sharedObject) =  ::flixel::util::_FlxSave::FlxSharedObject_obj::__alloc( HX_CTX );
...
HXLINE( 459)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 461)					HX_VARI(  ::haxe::Unserializer,unserializer) =  ::haxe::Unserializer_obj::__alloc( HX_CTX ,encodedData);
HXLINE( 462)					HX_VARI(  ::Dynamic,resolver) =  ::Dynamic(::hx::Anon_obj::Create(2)
...
::String FlxSharedObject_obj::getData(::String name,::String localPath){
            	...
            	HX_STACK_ARG(localPath,"localPath")
HXLINE( 528)
HXLINE( 529)		HX_VARI( ::String,path) = ::flixel::util::_FlxSave::FlxSharedObject_obj::getPath(localPath,name);
...
HXLINE( 547)		HX_VARI( ::String,directory) = ::lime::_hx_system::System_obj::get_applicationStorageDirectory();
HXLINE( 548)		HX_VARI( ::String,path) = (::haxe::io::Path_obj::normalize((((HX_("",00,00,00,00) + directory) + HX_("/../../../",80,8e,9b,1e)) + localPath)) + HX_("/",2f,00,00,00));
...
HXLINE( 565)			HX_VARI( ::Array< ::String >,split) = name.split(HX_("/",2f,00,00,00));

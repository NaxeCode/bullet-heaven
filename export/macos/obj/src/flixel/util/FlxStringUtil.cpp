...
HXLINE(  97)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXDLIN( 471)							HX_VARI( int,j) = (_g2 - 1);
...
HXDLIN( 493)				HX_VARI_NAME( int,i1,"i") = (_g8 - 1);
...
::String FlxStringUtil_obj::toUnderscoreCase(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE( 656)
HXLINE( 657)		HX_VARI(  ::EReg,regex) =  ::EReg_obj::__alloc( HX_CTX ,HX_("[^a-z0-9]+",5f,51,30,53),HX_("g",67,00,00,00));
...
::String FlxStringUtil_obj::toTitleCase(::String str){
            	...
            	HX_STACK_ARG(str,"str")
HXLINE( 666)
HXLINE( 667)		HX_VARI( ::Array< ::String >,exempt) = ::Array_obj< ::String >::fromData( _hx_array_data_03bd21cb_47,16);
HXLINE( 668)		HX_VARI(  ::EReg,roman) =  ::EReg_obj::__alloc( HX_CTX ,HX_("^(?=[MDCLXVI])M*(C[MD]|D?C*)(X[CL]|L?X*)(I[XV]|V?I*)$",19,35,5b,b5),HX_("i",69,00,00,00));
HXLINE( 669)		HX_VARI( ::Array< ::String >,words) = str.toLowerCase().split(HX_(" ",20,00,00,00));
HXLINE( 671)		{
HXLINE( 671)			int _g = 0;
HXDLIN( 671)			int _g1 = words->length;
HXDLIN( 671)			while((_g < _g1)){
HXLINE( 671)				_g = (_g + 1);
HXDLIN( 671)				HX_VARI( int,i) = (_g - 1);

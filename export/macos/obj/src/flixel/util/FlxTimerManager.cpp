...
HXLINE( 271)
HXLINE( 272)		HX_VARI( ::Array< ::Dynamic>,loopedTimers) = null();
HXLINE( 274)		{
HXLINE( 274)			int _g = 0;
HXDLIN( 274)			::Array< ::Dynamic> _g1 = this->_timers;
HXDLIN( 274)			while((_g < _g1->length)){
HXLINE( 274)				HX_VARI(  ::flixel::util::FlxTimer,timer) = _g1->__get(_g).StaticCast<  ::flixel::util::FlxTimer >();
HXDLIN( 274)				_g = (_g + 1);
...
HXLINE( 278)					HX_VARI( int,timerLoops) = timer->_loopsCounter;
...
void FlxTimerManager_obj::completeAll(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 330)
HXLINE( 331)		HX_VARI( ::Array< ::Dynamic>,timersToFinish) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 332)		{
HXLINE( 332)			int _g = 0;
HXDLIN( 332)			::Array< ::Dynamic> _g1 = this->_timers;
HXDLIN( 332)			while((_g < _g1->length)){
HXLINE( 332)				HX_VARI(  ::flixel::util::FlxTimer,timer) = _g1->__get(_g).StaticCast<  ::flixel::util::FlxTimer >();
HXDLIN( 332)				_g = (_g + 1);
...
HXLINE( 336)				HX_VARI_NAME(  ::flixel::util::FlxTimer,timer1,"timer") = timersToFinish->__get(_g2).StaticCast<  ::flixel::util::FlxTimer >();
...
HXDLIN( 362)			HX_VARI(  ::flixel::util::FlxTimer,timer) = _g1->__get(_g).StaticCast<  ::flixel::util::FlxTimer >();
HXDLIN( 362)			_g = (_g + 1);

...
HXLINE(  56)					_g2 = (_g2 + 1);
HXDLIN(  56)					HX_VARI( int,ri) = (_g2 - 1);
...
HXDLIN( 135)			HX_VARI_NAME(  ::openfl::display::Bitmap,tempBitmap2,"tempBitmap") =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,::Std_obj::_hx_int((tempBitmap / tempBitmap1)),true,0),null(),null());
...
HXDLIN( 145)			HX_VARI_NAME(  ::openfl::geom::Rectangle,remainingRect3,"remainingRect") =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,remainingRect,remainingRect1,(remainingRect2 - b));

...
HXDLIN( 124)						HX_VARI( int,j) = (_g2 - 1);
...
HXDLIN( 194)								HX_VARI( int,j) = (_g2 - 1);
...
HXDLIN( 363)		HX_VARI_NAME(  ::openfl::display::BitmapData,result1,"result") =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,result,::Std_obj::_hx_int(((region->height + ((numVerticalFrames - 1) * spaceY)) + ((2 * numVerticalFrames) * borderY))),true,0);
...
HXDLIN( 376)						HX_VARI( int,j) = (_g2 - 1);
...
HXDLIN( 418)						HX_VARI( int,j) = (_g2 - 1);
...
HXDLIN( 426)						HX_VARI_NAME( int,j1,"j") = (_g4 - 1);
...
HXDLIN( 435)				HX_VARI_NAME( int,i1,"i") = (_g6 - 1);
...
HXDLIN( 439)						HX_VARI_NAME( int,j2,"j") = (_g8 - 1);
...
HXDLIN( 447)						HX_VARI_NAME( int,j3,"j") = (_g10 - 1);

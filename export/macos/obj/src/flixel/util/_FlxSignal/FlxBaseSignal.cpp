...
HXLINE( 133)			HX_VARI(  ::flixel::util::_FlxSignal::FlxSignalHandler,handler) = this->getHandler(listener);
...
HXLINE( 167)
HXLINE( 168)		HX_VARI(  ::flixel::util::_FlxSignal::FlxSignalHandler,handler) = this->getHandler(listener);
...
HXLINE( 189)				HX_VARI(  ::flixel::util::_FlxSignal::FlxSignalHandler,handler) = _g1->__get(_g).StaticCast<  ::flixel::util::_FlxSignal::FlxSignalHandler >();
HXDLIN( 189)				_g = (_g + 1);

...
void FlxPreloader_obj::create(){
            		...
            		void _hx_run( ::openfl::display::Bitmap logoLight){
            			...
            			HX_STACK_ARG(logoLight,"logoLight")
HXLINE(  59)
...
HXLINE( 101)		HX_VARI(  ::openfl::display::Bitmap,bitmap) =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->_width,this->_height,false,16777215),null(),null());
HXLINE( 102)		HX_VARI( int,i) = 0;
HXLINE( 103)		HX_VARI( int,j) = 0;

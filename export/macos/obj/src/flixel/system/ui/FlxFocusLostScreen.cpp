...
void FlxFocusLostScreen_obj::draw(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  30)
HXLINE(  31)		HX_VARI(  ::openfl::display::Graphics,gfx) = this->get_graphics();
HXLINE(  33)		HX_VARI( int,screenWidth) = ::Std_obj::_hx_int(( (Float)(::openfl::Lib_obj::get_current()->stage->stageWidth) ));
HXLINE(  34)		HX_VARI( int,screenHeight) = ::Std_obj::_hx_int(( (Float)(::openfl::Lib_obj::get_current()->stage->stageHeight) ));
HXLINE(  37)		gfx->clear();
...
HXLINE(  44)		HX_VARI( int,halfWidth) = ::Std_obj::_hx_int((( (Float)(screenWidth) ) / ( (Float)(2) )));
HXLINE(  45)		HX_VARI( int,halfHeight) = ::Std_obj::_hx_int((( (Float)(screenHeight) ) / ( (Float)(2) )));
HXLINE(  46)		HX_VARI( int,helper) = ::Std_obj::_hx_int((::Math_obj::min(( (Float)(halfWidth) ),( (Float)(halfHeight) )) / ( (Float)(3) )));

...
HXLINE(  67)		HX_VARI(  ::openfl::display::Bitmap,tmp) =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->_width,30,true,(int)2130706432),null(),null());
HXLINE(  68)		this->screenCenter();
HXLINE(  69)		this->addChild(tmp);
HXLINE(  71)		HX_VARI(  ::openfl::text::TextField,text) =  ::openfl::text::TextField_obj::__alloc( HX_CTX );
...
HXLINE(  84)		HX_VARI(  ::openfl::text::TextFormat,dtf) =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,10,16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE(  91)		HX_VARI( int,bx) = 10;
HXLINE(  92)		HX_VARI( int,by) = 14;
HXLINE(  93)		this->_bars = ::Array_obj< ::Dynamic>::__new();
HXLINE(  95)		{
HXLINE(  95)			int _g = 0;
HXDLIN(  95)			while((_g < 10)){
HXLINE(  95)				_g = (_g + 1);
HXDLIN(  95)				HX_VARI( int,i) = (_g - 1);
...
HXDLIN( 151)			HX_VARI_NAME(  ::openfl::media::Sound,sound1,"sound") = ::flixel::_hx_system::FlxAssets_obj::getSound(sound);
...
HXLINE( 160)		HX_VARI( int,globalVolume) = ::Math_obj::round((::flixel::FlxG_obj::sound->volume * ( (Float)(10) )));

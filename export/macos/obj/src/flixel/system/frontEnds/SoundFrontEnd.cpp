...
void SoundFrontEnd_obj::playMusic( ::Dynamic embeddedMusic,::hx::Null< Float >  __o_volume,::hx::Null< bool >  __o_looped, ::flixel::sound::FlxSoundGroup group){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(embeddedMusic,"embeddedMusic")
...
HXLINE( 149)		HX_VARI(  ::flixel::sound::FlxSound,sound) = this->list->recycle(::hx::ClassOf< ::flixel::sound::FlxSound >(),null(),null(),null()).StaticCast<  ::flixel::sound::FlxSound >();
...
HXLINE( 161)			HX_VARI(  ::Dynamic,loadCallback) = onLoad;
...
HXDLIN( 216)			HX_VARI( ::String,id) = _g1->__get(_g);
HXDLIN( 216)			_g = (_g + 1);
...
HXLINE( 240)		HX_VARI(  ::flixel::sound::FlxSound,sound) = this->list->recycle(::hx::ClassOf< ::flixel::sound::FlxSound >(),null(),null(),null()).StaticCast<  ::flixel::sound::FlxSound >()->loadEmbedded(embeddedSound,looped,autoDestroy,onComplete);
...
HXLINE( 274)				HX_VARI(  ::flixel::sound::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::sound::FlxSound >();
HXDLIN( 274)				_g = (_g + 1);
...
HXLINE( 293)				HX_VARI(  ::flixel::sound::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::sound::FlxSound >();
HXDLIN( 293)				_g = (_g + 1);
...
HXLINE( 315)				HX_VARI(  ::flixel::sound::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::sound::FlxSound >();
HXDLIN( 315)				_g = (_g + 1);
...
HXLINE( 407)				HX_VARI(  ::flixel::sound::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::sound::FlxSound >();
HXDLIN( 407)				_g = (_g + 1);
...
HXLINE( 424)				HX_VARI(  ::flixel::sound::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::sound::FlxSound >();
HXDLIN( 424)				_g = (_g + 1);

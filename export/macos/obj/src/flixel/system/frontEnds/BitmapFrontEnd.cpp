...
void BitmapFrontEnd_obj::onAssetsReload( ::Dynamic _){
            	...
            	HX_STACK_ARG(_,"_")
HXLINE(  53)
HXDLIN(  53)		HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN(  53)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN(  53)			HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  55)			HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
void BitmapFrontEnd_obj::onContext(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  69)
HXDLIN(  69)		HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN(  69)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN(  69)			HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  71)			HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
void BitmapFrontEnd_obj::dumpCache(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  86)
HXDLIN(  86)		HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN(  86)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN(  86)			HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  88)			HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
void BitmapFrontEnd_obj::undumpCache(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 103)
HXDLIN( 103)		HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN( 103)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 103)			HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 105)			HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
HXLINE( 195)
HXLINE( 196)		{
HXLINE( 196)			HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN( 196)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 196)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 198)				HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
::String BitmapFrontEnd_obj::generateKey(::String systemKey,::String userKey,::hx::Null< bool >  __o_unique){
            	...
            	HX_STACK_ARG(unique,"unique")
HXLINE( 225)
HXLINE( 226)		HX_VARI( ::String,key) = userKey;
...
HXLINE( 250)		HX_VARI( int,i) = this->_lastUniqueKeyIndex;
HXLINE( 251)		HX_VAR( ::String,uniqueKey);
HXLINE( 252)		do {
HXLINE( 254)			i = (i + 1);
...
HXLINE( 274)
HXLINE( 275)		HX_VARI( ::String,result) = baseKey;
...
HXLINE( 313)			HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key)) );
...
HXLINE( 339)		{
HXLINE( 339)			HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN( 339)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 339)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 341)				HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
HXLINE( 370)		{
HXLINE( 370)			HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN( 370)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 370)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 372)				HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
void BitmapFrontEnd_obj::clearUnused(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 386)
HXDLIN( 386)		HX_VARI(  ::Dynamic,key) = this->_cache->keys();
HXDLIN( 386)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 386)			HX_VARI_NAME( ::String,key1,"key") = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 388)			HX_VARI(  ::flixel::graphics::FlxGraphic,obj) = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
HXLINE( 407)			HX_VARI(  ::openfl::display::BitmapData,bd) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,10,10,true,-1);
HXLINE( 408)			HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->add(bd,true,HX_("whitePixels",b6,92,ba,9e));

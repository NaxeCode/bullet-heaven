...
HXLINE(  29)				HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN(  29)				_g = (_g + 1);
...
HXLINE(  50)				HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN(  50)				_g = (_g + 1);
...
HX_DEFINE_DYNAMIC_FUNC1(PluginFrontEnd_obj,get,return )
 ...
 ::Dynamic PluginFrontEnd_obj::remove( ::Dynamic Plugin){
            	...
            	HX_STACK_ARG(Plugin,"Plugin")
HXLINE(  68)
HXLINE(  70)		HX_VARI( int,i) = (this->list->length - 1);
HXLINE(  72)		while((i >= 0)){
...
bool PluginFrontEnd_obj::removeType(::hx::Class ClassType){
            	...
            	HX_STACK_ARG(ClassType,"ClassType")
HXLINE(  92)
HXLINE(  94)		HX_VARI( bool,results) = false;
HXLINE(  95)		HX_VARI( int,i) = (this->list->length - 1);
HXLINE(  97)		while((i >= 0)){
...
HXDLIN( 124)			HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN( 124)			_g = (_g + 1);
...
HXDLIN( 139)			HX_VARI(  ::flixel::FlxBasic,plugin) = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN( 139)			_g = (_g + 1);

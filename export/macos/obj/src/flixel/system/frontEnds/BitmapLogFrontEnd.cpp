...
HXLINE(  46)		{
HXLINE(  46)			HX_VARI(  ::Dynamic,cachedGraphic) = ::flixel::FlxG_obj::bitmap->_cache->iterator();
HXDLIN(  46)			while(( (bool)(cachedGraphic->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  46)				HX_VARI_NAME(  ::flixel::graphics::FlxGraphic,cachedGraphic1,"cachedGraphic") = ( ( ::flixel::graphics::FlxGraphic)(cachedGraphic->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  48)				{

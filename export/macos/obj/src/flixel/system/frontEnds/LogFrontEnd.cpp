...
HXLINE(  66)					HX_VARI(  ::openfl::media::Sound,sound) = ::flixel::_hx_system::FlxAssets_obj::getSound(style->errorSound);
...
HXLINE( 113)
HXLINE( 114)		HX_VARI( ::cpp::VirtualArray,paramArray) = ::cpp::VirtualArray_obj::__new(1)->init(0,data);
...
HXLINE( 118)				HX_VARI(  ::Dynamic,i) = _g1->__get(_g);
HXDLIN( 118)				_g = (_g + 1);

...
bool CameraFrontEnd_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic CameraFrontEnd_obj::add( ::Dynamic NewCamera,::hx::Null< bool >  __o_DefaultDrawTarget){
            	...
            	HX_STACK_ARG(DefaultDrawTarget,"DefaultDrawTarget")
HXLINE(  66)
...
HXLINE(  85)
HXLINE(  86)		HX_VARI( int,index) = this->list->indexOf(Camera,null());
...
HXLINE( 130)		HX_VARI( int,index) = this->defaults->indexOf(camera,null());
...
HXDLIN( 168)			HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 168)			_g = (_g + 1);
...
HXDLIN( 185)			HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 185)			_g = (_g + 1);
...
HXDLIN( 202)			HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 202)			_g = (_g + 1);
...
HXDLIN( 220)			HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 220)			_g = (_g + 1);
...
HXLINE( 264)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 264)				_g = (_g + 1);
...
HXDLIN( 280)			HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 280)			_g = (_g + 1);
...
HXDLIN( 307)			HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 307)			_g = (_g + 1);
...
HXDLIN( 322)			HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 322)			_g = (_g + 1);
...
HXLINE( 335)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 335)				_g = (_g + 1);

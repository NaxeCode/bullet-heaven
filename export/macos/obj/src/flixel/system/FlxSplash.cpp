...
HXLINE(  57)				HX_VARI( Float,time) = _g1->__get(_g);
HXDLIN(  57)				_g = (_g + 1);
HXLINE(  59)				 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(time,this->timerCallback_dyn(),null());
            			}
            		}
HXLINE(  62)		HX_VARI( int,stageWidth) = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXLINE(  63)		HX_VARI( int,stageHeight) = ::openfl::Lib_obj::get_current()->stage->stageHeight;
...
HXLINE(  72)		HX_VARI(  ::openfl::text::TextFormat,dtf) =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,16,16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());

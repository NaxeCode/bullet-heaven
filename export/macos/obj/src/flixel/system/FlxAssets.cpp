...
HXLINE( 367)
HXLINE( 368)		HX_VARI(  ::flixel::_hx_system::GraphicVirtualInput,bitmapData) =  ::flixel::_hx_system::GraphicVirtualInput_obj::__alloc( HX_CTX ,0,0,null(),null());
HXLINE( 373)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::graphics::FlxGraphic_obj::fromBitmapData(bitmapData,null(),null(),null());

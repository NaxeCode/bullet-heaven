...
HXDLIN(  70)			_g = (_g + 1);
HXDLIN(  70)			HX_VARI( int,i) = (_g - 1);
HXLINE(  72)			HX_VARI(  ::flixel::_hx_system::debug::completion::CompletionListEntry,entry) =  ::flixel::_hx_system::debug::completion::CompletionListEntry_obj::__alloc( HX_CTX );
...
HXLINE( 121)		HX_VARI( int,range) = (this->upperVisibleIndex - this->lowerVisibleIndex);

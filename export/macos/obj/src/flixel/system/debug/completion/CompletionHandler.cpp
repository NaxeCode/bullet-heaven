...
HXLINE(  65)				this->completionList->close();
            			...
            			break;
            			default:{
HXLINE(  71)				::String _hx_tmp2 = this->getPathBeforeDot(text);
HXDLIN(  71)				this->invokeCompletion(_hx_tmp2,(e->keyCode == 190));
HXLINE(  73)				if (this->completionList->get_visible()) {
HXLINE(  74)					 ::flixel::_hx_system::debug::completion::CompletionList _hx_tmp3 = this->completionList;
HXDLIN(  74)					_hx_tmp3->set_filter(this->getWordAfterDot(text));
            				}
            			}
            		}
            	}

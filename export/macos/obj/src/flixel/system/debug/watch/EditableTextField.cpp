...
void EditableTextField_obj::cycleNumericValue(Float modifier){
            	...
            	HX_STACK_ARG(modifier,"modifier")
HXLINE( 112)
HXLINE( 113)		HX_VARI( Float,value) = ::Std_obj::parseFloat(this->get_text());
...
void EditableTextField_obj::cycleEnumValue(::hx::Class e,int modifier){
            	...
            	HX_STACK_ARG(modifier,"modifier")
HXLINE( 123)
HXLINE( 124)		HX_VARI( ::Array< ::String >,values) = ::Type_obj::getEnumConstructs(e);
HXLINE( 125)		HX_VARI( int,index) = values->indexOf(this->get_text(),null());
...
void EditableTextField_obj::submit(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 142)
HXLINE( 143)		HX_VAR(  ::Dynamic,value);
...
HXLINE( 143)						value = this->get_text();
            			...
            			break;
            			case (int)7: {
HXLINE( 151)				HX_VARI( ::hx::Class,e) = _g->_hx_getObject(0).StaticCast< ::hx::Class >();
HXLINE( 152)				try {

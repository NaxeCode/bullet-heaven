...
HXLINE( 224)				HX_VARI(  ::flixel::_hx_system::debug::watch::TrackerProfile,profile) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::TrackerProfile >();
HXDLIN( 224)				_g = (_g + 1);
...
HXLINE( 245)				HX_VARI( ::hx::Class,extension) = _g1->__get(_g).StaticCast< ::hx::Class >();
HXDLIN( 245)				_g = (_g + 1);
HXLINE( 247)				if (::hx::IsNull( extension )) {
HXLINE( 248)					continue;
            				}
HXLINE( 250)				HX_VARI(  ::flixel::_hx_system::debug::watch::TrackerProfile,extensionProfile) = this->findProfileByClass(extension);
...
HXLINE( 264)				HX_VARI( ::String,variable) = Variables->__get(_g);
HXDLIN( 264)				_g = (_g + 1);
...
HXLINE(  66)		HX_VARI(  ::flixel::_hx_system::debug::watch::TrackerProfile,lastMatchingProfile) = null();
HXLINE(  67)		{
HXLINE(  67)			int _g = 0;
HXDLIN(  67)			::Array< ::Dynamic> _g1 = ::flixel::_hx_system::debug::watch::Tracker_obj::profiles;
HXDLIN(  67)			while((_g < _g1->length)){
HXLINE(  67)				HX_VARI(  ::flixel::_hx_system::debug::watch::TrackerProfile,profile) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::TrackerProfile >();
HXDLIN(  67)				_g = (_g + 1);

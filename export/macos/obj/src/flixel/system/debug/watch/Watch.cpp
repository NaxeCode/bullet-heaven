...
HXLINE(  41)		HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,existing) = this->getExistingEntry(displayName,data);
...
HXDLIN(  58)		switch((int)(data->_hx_getIndex())){
            			case (int)0: {
HXLINE(  60)				HX_VARI(  ::Dynamic,object) = data->_hx_getObject(0);
HXDLIN(  60)				HX_VARI( ::String,field) = data->_hx_getString(1);
...
HXLINE(  60)					return true;
            			...
            			break;
            			case (int)1: {
HXLINE(  61)				HX_VARI( ::String,value) = data->_hx_getString(0);
...
HXDLIN(  63)				HX_VARI( ::String,expression) = data->_hx_getString(0);
...
HXLINE(  64)					return true;
            			...
            			break;
            			case (int)3: {
HXLINE(  65)				HX_VARI(  ::Dynamic,func) = data->_hx_getObject(0);
...
HXLINE(  72)				HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
HXDLIN(  72)				_g = (_g + 1);
...
void Watch_obj::addEntry(::String displayName, ::flixel::_hx_system::debug::watch::WatchEntryData data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(  86)
HXLINE(  87)		HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) =  ::flixel::_hx_system::debug::watch::WatchEntry_obj::__alloc( HX_CTX ,displayName,data,this->removeEntry_dyn());
...
void Watch_obj::remove(::String displayName, ::flixel::_hx_system::debug::watch::WatchEntryData data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE(  94)
HXLINE(  95)		HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,existing) = this->getExistingEntry(displayName,data);
...
HXLINE( 110)				_g = (_g + 1);
HXDLIN( 110)				HX_VARI( int,i) = (_g - 1);
HXLINE( 112)				HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = this->entries->__get(i).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
...
HXDLIN( 122)			HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
HXDLIN( 122)			_g = (_g + 1);
...
HXLINE( 137)			HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = this->entries->__get(i).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
...
HXLINE( 154)
HXLINE( 155)		HX_VARI( Float,max) = ((Float)0.0);
HXLINE( 156)		{
HXLINE( 156)			int _g = 0;
HXDLIN( 156)			::Array< ::Dynamic> _g1 = this->entries;
HXDLIN( 156)			while((_g < _g1->length)){
HXLINE( 156)				HX_VARI(  ::flixel::_hx_system::debug::watch::WatchEntry,entry) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
HXDLIN( 156)				_g = (_g + 1);
HXLINE( 158)				HX_VARI( Float,value) = ( (Float)(getValue(entry)) );

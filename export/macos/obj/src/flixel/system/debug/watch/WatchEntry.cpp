...
HXLINE(  44)		HX_VARI(  ::ValueType,expectedType) = ::Type_obj::_hx_typeof(this->getValue());
...
HXLINE(  76)
HXLINE(  77)		HX_VARI( Float,textWidth) = ((windowWidth - this->removeButton->get_width()) - ( (Float)(4) ));
...
HXDLIN(  93)			switch((int)(_g->_hx_getIndex())){
            				case (int)0: {
HXLINE(  95)					HX_VARI(  ::Dynamic,object) = _g->_hx_getObject(0);
HXDLIN(  95)					HX_VARI( ::String,field) = _g->_hx_getString(1);
...
HXDLIN(  97)					{
HXLINE(  97)						HX_VARI( ::String,expression) = _g->_hx_getString(0);
...
HXLINE( 107)		HX_VARI( Float,currentWidth) = (this->nameText->get_textWidth() + 4);
...
HXDLIN( 113)		switch((int)(_g->_hx_getIndex())){
            			case (int)0: {
HXLINE( 115)				HX_VARI(  ::Dynamic,object) = _g->_hx_getObject(0);
HXDLIN( 115)				HX_VARI( ::String,field) = _g->_hx_getString(1);
HXLINE( 116)				return ::Reflect_obj::getProperty(object,field);
            			}
            			break;
            			case (int)1: {
HXLINE( 123)				HX_VARI( ::String,value) = _g->_hx_getString(0);
HXLINE( 124)				return value;
            			}
            			break;
            			case (int)2: {
HXLINE( 117)				::String _g1 = _g->_hx_getString(0);
HXDLIN( 117)				HX_VARI(  ::hscript::Expr,parsedExpr) = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE( 119)				return ::flixel::_hx_system::debug::console::ConsoleUtil_obj::runExpr(parsedExpr);
            			}
            			break;
            			case (int)3: {
HXLINE( 125)				HX_VARI(  ::Dynamic,func) = _g->_hx_getObject(0);
...
::String WatchEntry_obj::getFormattedValue(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 131)
HXLINE( 132)		HX_VARI(  ::Dynamic,value) = this->getValue();
...
HXLINE( 142)			HX_VARI(  ::Dynamic,object) = _g->_hx_getObject(0);
HXDLIN( 142)			HX_VARI( ::String,field) = _g->_hx_getString(1);

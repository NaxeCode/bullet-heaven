...
HXDLIN(  70)		HX_VARI_NAME( ::String,text1,"text") = ::flixel::util::FlxStringUtil_obj::htmlFormat(text,style->size,style->color,style->bold,style->italic,style->underlined);
HXLINE(  76)		if (fireOnce) {
HXLINE(  78)			int _g = 0;
HXDLIN(  78)			::Array< ::String > _g1 = this->_lines;
HXDLIN(  78)			while((_g < _g1->length)){
HXLINE(  78)				HX_VARI( ::String,line) = _g1->__get(_g);
HXDLIN(  78)				_g = (_g + 1);
...
HXLINE(  98)			HX_VARI( ::String,newText) = HX_("",00,00,00,00);
HXLINE(  99)			{
HXLINE(  99)				int _g2 = 0;
HXDLIN(  99)				int _g3 = this->_lines->length;
HXDLIN(  99)				while((_g2 < _g3)){
HXLINE(  99)					_g2 = (_g2 + 1);
HXDLIN(  99)					HX_VARI( int,i) = (_g2 - 1);

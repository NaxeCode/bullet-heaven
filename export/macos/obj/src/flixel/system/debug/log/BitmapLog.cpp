...
HXDLIN( 155)			HX_VARI(  ::flixel::math::FlxBasePoint,delta) = point;
HXLINE( 156)			{
...
HXDLIN( 175)		HX_VARI_NAME( int,newWidth1,"newWidth") = ::Std_obj::_hx_int((( (Float)(newWidth) ) - this->_canvasBitmap->get_x()));
HXLINE( 176)		int newHeight = this->_height;
HXDLIN( 176)		Float newHeight1 = (( (Float)(newHeight) ) - this->_canvasBitmap->get_y());
HXDLIN( 176)		HX_VARI_NAME( int,newHeight2,"newHeight") = ::Std_obj::_hx_int((newHeight1 - this->_footer->get_height()));
...
HXLINE( 333)		HX_VARI( ::String,entryName) = ( (::String)(this->_entries->__get(this->_curIndex)->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) );
HXLINE( 334)		HX_VAR( ::String,name);
...
HXLINE( 341)
HXLINE( 342)		HX_VARI(  ::openfl::display::Graphics,gfx) = ::flixel::util::FlxSpriteUtil_obj::flashGfx;
HXLINE( 343)		gfx->clear();
HXLINE( 344)		gfx->lineStyle(1,-65536,((Float)0.75),false,1,null(),null(),null());
HXLINE( 345)		HX_VARI( Float,offset) = (( (Float)(1) ) / this->zoom);

...
HXLINE(  97)		HX_VAR( int,minHeight);
...
HXLINE( 103)		HX_VARI( int,gutter) = 5;
HXLINE( 104)		HX_VARI( int,graphX) = gutter;
HXLINE( 105)		HX_VARI( int,graphY) = (::Std_obj::_hx_int(this->_header->get_height()) + gutter);
HXLINE( 106)		HX_VARI( int,graphHeight) = 40;
HXLINE( 107)		HX_VARI( int,graphWidth) = 140;
...
HXLINE( 138)		HX_VARI( ::String,drawMethod) = HX_("",00,00,00,00);
...
HXLINE( 231)		HX_VARI( int,time) = (this->_currentTime = ::flixel::FlxG_obj::game->ticks);
HXLINE( 233)		HX_VARI( int,elapsed) = (time - this->_lastTime);
...
HXLINE( 248)			 ::flixel::_hx_system::debug::stats::StatsGraph _hx_tmp1 = this->memoryGraph;
HXDLIN( 248)			_hx_tmp1->update(((( (Float)(::openfl::_hx_system::System_obj::get_totalMemory()) ) / ( (Float)(1024) )) / ( (Float)(1000) )));
...
HXLINE( 255)					_g = (_g + 1);
HXDLIN( 255)					HX_VARI( int,i) = (_g - 1);
HXLINE( 257)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 257)					_hx_tmp2->updateTime = (_hx_tmp2->updateTime + this->_update->__get(i));
            				}
            			}
HXLINE( 260)			{
...
HXDLIN( 260)					HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 262)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 262)					_hx_tmp3->activeCount = (_hx_tmp3->activeCount + this->_activeObject->__get(i1));
            				}
            			}
...
HXDLIN( 267)					HX_VARI_NAME( int,i2,"i") = (_g4 - 1);
HXLINE( 269)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 269)					_hx_tmp4->drawTime = (_hx_tmp4->drawTime + this->_draw->__get(i2));
            				}
            			}
HXLINE( 272)			{
...
HXDLIN( 272)					HX_VARI_NAME( int,i3,"i") = (_g6 - 1);
HXLINE( 274)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 274)					_hx_tmp5->visibleCount = (_hx_tmp5->visibleCount + this->_visibleObject->__get(i3));
            				}
            			}
...
HXLINE( 280)				{
HXLINE( 280)					int _g8 = 0;
HXDLIN( 280)					int _g9 = this->_drawCallsMarker;
HXDLIN( 280)					while((_g8 < _g9)){
HXLINE( 280)						_g8 = (_g8 + 1);
HXDLIN( 280)						HX_VARI_NAME( int,i4,"i") = (_g8 - 1);
HXLINE( 282)						 ::flixel::_hx_system::debug::stats::Stats _hx_tmp6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 282)						_hx_tmp6->drawCallsCount = (_hx_tmp6->drawCallsCount + this->_drawCalls->__get(i4));
            					}
            				}
...
HXLINE( 296)			 ::flixel::_hx_system::debug::stats::Stats _hx_tmp7 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 296)			_hx_tmp7->_updateTimer = (_hx_tmp7->_updateTimer - 250);
            		}
            	}
...
void Stats_obj::updateTexts(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 301)
HXLINE( 302)		HX_VARI( Float,updTime) = ::flixel::math::FlxMath_obj::roundDecimal(this->divide(( (Float)(this->updateTime) ),( (Float)(this->_updateMarker) )),1);
HXLINE( 303)		HX_VARI( Float,drwTime) = ::flixel::math::FlxMath_obj::roundDecimal(this->divide(( (Float)(this->drawTime) ),( (Float)(this->_drawMarker) )),1);
...
HXLINE( 433)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp1 = this->_toggleSizeButton;
HXDLIN( 433)			_hx_tmp1->changeIcon( ::flixel::_hx_system::debug::stats::_Stats::GraphicMaximizeButton_obj::__alloc( HX_CTX ,0,0,null(),null()));
            		}

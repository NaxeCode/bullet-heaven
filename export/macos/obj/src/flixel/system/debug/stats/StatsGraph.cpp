...
HXLINE( 101)		HX_VARI( Float,inc) = (( (Float)(this->_width) ) / ( (Float)(29) ));
HXLINE( 102)		HX_VARI( Float,range) = ::Math_obj::max((this->maxValue - this->minValue),(this->maxValue * ((Float)0.1)));
HXLINE( 103)		HX_VARI( Float,graphX) = (this->_axis->get_x() + 1);
HXLINE( 105)		{
HXLINE( 105)			int _g = 0;
HXDLIN( 105)			int _g1 = this->history->length;
HXDLIN( 105)			while((_g < _g1)){
HXLINE( 105)				_g = (_g + 1);
HXDLIN( 105)				HX_VARI( int,i) = (_g - 1);
HXLINE( 107)				HX_VARI( Float,value) = ((this->history->__get(i) - this->minValue) / range);
HXLINE( 109)				HX_VARI( Float,pointY) = (((-(value) * ( (Float)(this->_height) )) - ( (Float)(1) )) + this->_height);
HXLINE( 110)				if ((i == 0)) {
...
Float StatsGraph_obj::average(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 141)
HXLINE( 142)		HX_VARI( Float,sum) = ( (Float)(0) );
HXLINE( 143)		{
HXLINE( 143)			int _g = 0;

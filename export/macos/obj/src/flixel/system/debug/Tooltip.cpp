...
HXLINE(  27)
HXLINE(  28)		HX_VARI(  ::flixel::_hx_system::debug::TooltipOverlay,tooltip) =  ::flixel::_hx_system::debug::TooltipOverlay_obj::__alloc( HX_CTX ,element,text,null(),null());
...
HXLINE(  43)					HX_VARI(  ::flixel::_hx_system::debug::TooltipOverlay,tooltip) = ::flixel::_hx_system::debug::Tooltip_obj::_tooltips->splice(i,1)->__get(0).StaticCast<  ::flixel::_hx_system::debug::TooltipOverlay >();

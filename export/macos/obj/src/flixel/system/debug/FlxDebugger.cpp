...
HXLINE( 137)		HX_VARI(  ::openfl::text::TextField,txt) =  ::openfl::text::TextField_obj::__alloc( HX_CTX );
...
HXLINE( 143)		HX_VARI(  ::openfl::text::TextFormat,format) =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,12,16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE( 169)		HX_VARI(  ::flixel::_hx_system::ui::FlxSystemButton,drawDebugButton) = this->addButton(::flixel::util::FlxHorizontalAlign_obj::RIGHT_dyn(), ::flixel::_hx_system::debug::_FlxDebugger::GraphicDrawDebug_obj::__alloc( HX_CTX ,0,0,null(),null()),this->toggleDrawDebug_dyn(),true,null());
...
HXDLIN( 240)			HX_VARI(  ::flixel::_hx_system::debug::Window,window) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::Window >();
HXDLIN( 240)			_g = (_g + 1);
...
HXLINE( 343)				HX_VARI(  ::flixel::_hx_system::debug::Window,window) = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::Window >();
HXDLIN( 343)				_g = (_g + 1);
...
HXLINE( 353)
HXLINE( 354)		HX_VARI( Float,width) = ( (Float)(0) );
HXLINE( 355)		HX_VARI( Float,last) = LeftOffset;
HXLINE( 357)		{
HXLINE( 357)			int _g = 0;
...
HXLINE( 359)				HX_VARI(  ::openfl::display::Sprite,o) = Sprites->__get(i).StaticCast<  ::flixel::_hx_system::ui::FlxSystemButton >();
...
HXDLIN( 376)		HX_VARI_NAME( Float,offset1,"offset") = (offset - (this->hAlignButtons(( (::Array< ::Dynamic>)(this->_buttons->get(::flixel::util::FlxHorizontalAlign_obj::CENTER_dyn())) ),10,false,null()) * ((Float)0.5)));
...
HXDLIN( 379)		HX_VARI_NAME( Float,offset3,"offset") = (( (Float)(offset2) ) - this->hAlignButtons(( (::Array< ::Dynamic>)(this->_buttons->get(::flixel::util::FlxHorizontalAlign_obj::RIGHT_dyn())) ),10,false,null()));
...
HXLINE( 395)
HXLINE( 396)		HX_VARI(  ::flixel::_hx_system::ui::FlxSystemButton,button) =  ::flixel::_hx_system::ui::FlxSystemButton_obj::__alloc( HX_CTX ,Icon,UpHandler,ToggleMode);
...
void FlxDebugger_obj::addWindowToggleButton( ::flixel::_hx_system::debug::Window window,::hx::Class icon){
            	...
            	HX_STACK_ARG(icon,"icon")
HXLINE( 427)
HXLINE( 428)		HX_VARI(  ::flixel::_hx_system::ui::FlxSystemButton,button) = this->addButton(::flixel::util::FlxHorizontalAlign_obj::RIGHT_dyn(),( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(icon,::cpp::VirtualArray_obj::__new(2)->init(0,0)->init(1,0))) ),window->toggleVisible_dyn(),true,true);
...
HXLINE( 453)
HXLINE( 454)		HX_VARI(  ::openfl::display::DisplayObject,result) = this->super::addChild(child);
...
void FlxDebugger_obj::openGitHub(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 515)
HXLINE( 516)		HX_VARI( ::String,url) = HX_("https://github.com/HaxeFlixel/flixel",bf,0c,67,11);

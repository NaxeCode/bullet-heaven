...
void Pointer_obj::stopSelection(::hx::Null< bool >  __o_findItems){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(findItems,"findItems")
HXLINE( 130)
...
void Pointer_obj::handleItemAddition(::Array< ::Dynamic> itemsInSelectionArea){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(itemsInSelectionArea,"itemsInSelectionArea")
HXLINE( 162)
HXLINE( 164)		HX_VARI( bool,adding) = this->_brain->keyPressed(17);
HXLINE( 165)		HX_VARI(  ::flixel::group::FlxTypedGroup,selectedItems) = this->_brain->selectedItems;
...
HXLINE( 175)				HX_VARI(  ::flixel::FlxBasic,item) = itemsInSelectionArea->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN( 175)				_g = (_g + 1);
...
void Pointer_obj::draw(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 185)
HXLINE( 186)		HX_VARI(  ::openfl::display::Graphics,gfx) = this->_brain->getDebugGraphics();

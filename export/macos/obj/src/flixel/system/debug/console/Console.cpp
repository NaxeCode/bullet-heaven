...
HXLINE( 234)			HX_VARI( ::String,text) = ::StringTools_obj::trim(this->input->get_text());
HXLINE( 238)			if (::hx::IsNotNull( this->registeredFunctions->get(text) )) {
HXLINE( 239)				text = (text + HX_("()",01,23,00,00));
            			}
HXLINE( 242)			HX_VARI(  ::Dynamic,output) = ::flixel::_hx_system::debug::console::ConsoleUtil_obj::runCommand(text);
...
HXDLIN( 256)				HX_VARI(  ::Dynamic,e) = _g;
HXLINE( 259)				{
...
void Console_obj::removeObject( ::Dynamic object){
            	...
            	HX_STACK_ARG(object,"object")
HXLINE( 328)
HXDLIN( 328)		HX_VARI(  ::Dynamic,alias) = this->registeredObjects->keys();
HXDLIN( 328)		while(( (bool)(alias->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 328)			HX_VARI_NAME( ::String,alias1,"alias") = ( (::String)(alias->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
void Console_obj::removeFunction( ::Dynamic func){
            	...
            	HX_STACK_ARG(func,"func")
HXLINE( 351)
HXDLIN( 351)		HX_VARI(  ::Dynamic,alias) = this->registeredFunctions->keys();
HXDLIN( 351)		while(( (bool)(alias->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 351)			HX_VARI_NAME( ::String,alias1,"alias") = ( (::String)(alias->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );

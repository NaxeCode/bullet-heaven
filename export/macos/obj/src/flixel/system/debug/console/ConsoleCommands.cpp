...
HXLINE(  84)			HX_VARI( ::String,output) = HX_("System classes and commands: ",42,07,6a,e4);
HXLINE(  85)			{
HXLINE(  85)				HX_VARI(  ::Dynamic,obj) = this->_console->registeredObjects->keys();
HXDLIN(  85)				while(( (bool)(obj->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  85)					HX_VARI_NAME( ::String,obj1,"obj") = ( (::String)(obj->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  87)					output = (output + (obj1 + HX_(", ",74,26,00,00)));
            				}
            			}
HXLINE(  89)			{
HXLINE(  89)				HX_VARI(  ::Dynamic,func) = this->_console->registeredFunctions->keys();
HXDLIN(  89)				while(( (bool)(func->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  89)					HX_VARI_NAME( ::String,func1,"func") = ( (::String)(func->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 119)		HX_VARI(  ::flixel::FlxObject,obj) = ( ( ::flixel::FlxObject)(::Type_obj::createInstance(ObjClass,Params)) );
...
HXLINE( 139)		HX_VARI( ::String,name) = (HX_("Object_",a0,90,a0,4f) + this->_console->objectStack->length);

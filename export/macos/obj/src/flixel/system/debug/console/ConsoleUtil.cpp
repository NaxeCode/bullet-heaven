...
::Array< ::String > ConsoleUtil_obj::getFields( ::Dynamic Object){
            	...
            	HX_STACK_ARG(Object,"Object")
HXLINE( 114)
HXLINE( 115)		HX_VARI( ::Array< ::String >,fields) = ::Array_obj< ::String >::__new(0);
...
HXLINE( 126)		HX_VARI( ::Array< ::String >,filteredFields) = ::Array_obj< ::String >::__new(0);
HXLINE( 127)		{
HXLINE( 127)			int _g = 0;
HXDLIN( 127)			while((_g < fields->length)){
HXLINE( 127)				HX_VARI( ::String,field) = fields->__get(_g);
HXDLIN( 127)				_g = (_g + 1);
...
HXLINE( 132)					HX_VARI( ::String,name) = field.substr(4,null());
...
HXLINE( 145)
HXLINE( 146)		HX_VARI( ::Array< ::String >,underscoreList) = ::Array_obj< ::String >::__new(0);

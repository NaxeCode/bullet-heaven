...
HXLINE( 187)
HXLINE( 188)		HX_VARI( ::cpp::VirtualArray,array) = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 189)		{
HXLINE( 189)			HX_VARI(  ::Dynamic,element) = iterator;
HXDLIN( 189)			while(( (bool)(element->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 189)				HX_VARI_NAME(  ::Dynamic,element1,"element") = element->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();

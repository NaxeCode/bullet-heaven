...
HXLINE( 288)			HX_VAR(  ::flixel::_hx_system::FlxLinkedList,iterator);
HXLINE( 289)			HX_VAR(  ::flixel::_hx_system::FlxLinkedList,ot);
...
HXLINE( 409)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
HXLINE( 410)		if (::hx::IsNotNull( group )) {
HXLINE( 412)			HX_VARI( int,i) = 0;
HXLINE( 413)			HX_VAR(  ::flixel::FlxBasic,basic);
HXLINE( 414)			HX_VARI( ::Array< ::Dynamic>,members) = group->members;
HXLINE( 415)			HX_VARI( int,l) = group->length;
...
void FlxQuadTree_obj::addToList(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 552)
HXLINE( 553)		HX_VAR(  ::flixel::_hx_system::FlxLinkedList,ot);
...
bool FlxQuadTree_obj::execute(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 602)
HXLINE( 603)		HX_VARI( bool,overlapProcessed) = false;
HXLINE( 605)		if (::hx::IsNotNull( this->_headA->object )) {
HXLINE( 607)			HX_VARI(  ::flixel::_hx_system::FlxLinkedList,iterator) = this->_headA;
...
HXLINE( 663)		HX_VARI( bool,overlapProcessed) = false;
HXLINE( 664)		HX_VAR(  ::flixel::FlxObject,checkObject);
...
HXLINE( 250)			HX_VARI(  ::flixel::_hx_system::FlxQuadTree,cachedTree) = ::flixel::_hx_system::FlxQuadTree_obj::_cachedTreesHead;
...
HXLINE( 269)			HX_VARI(  ::flixel::_hx_system::FlxQuadTree,node) = ::flixel::_hx_system::FlxQuadTree_obj::_cachedTreesHead;

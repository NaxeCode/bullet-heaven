...
HXDLIN( 166)		HX_VARI_NAME( Float,time1,"time") = (time - this->_startTime);
HXLINE( 167)		HX_VARI( Float,min) = (this->minDisplayTime * ( (Float)(1000) ));
HXLINE( 168)		HX_VARI( Float,percent) = this->_percent;
...
HXLINE( 217)
HXLINE( 223)		HX_VARI(  ::openfl::display::Bitmap,bmp) =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(bitmapDataClass,::cpp::VirtualArray_obj::__new(2)->init(0,0)->init(1,0))) ),null(),null());
...
HX_DEFINE_DYNAMIC_FUNC2(FlxBasePreloader_obj,createBitmap,return )
 ...
 ::openfl::display::BitmapData FlxBasePreloader_obj::loadBitmapData(::hx::Class bitmapDataClass, ::Dynamic onLoad){
            	...
            	HX_STACK_ARG(onLoad,"onLoad")
HXLINE( 241)
HXLINE( 245)		HX_VARI(  ::openfl::display::BitmapData,bmpData) = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(bitmapDataClass,::cpp::VirtualArray_obj::__new(2)->init(0,0)->init(1,0))) );

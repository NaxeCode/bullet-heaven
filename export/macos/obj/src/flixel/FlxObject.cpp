...
HXDLIN( 889)		HX_VARI_NAME( Float,velocityDelta1,"velocityDelta") = (((Float)0.5) * (velocityDelta - this->angularVelocity));
...
HXLINE( 896)		HX_VARI( Float,delta) = (this->velocity->x * elapsed);
...
HXLINE( 933)
HXLINE( 934)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(objectOrGroup);
...
HXLINE( 944)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(objectOrGroup) );
HXLINE( 945)			return tilemap->overlaps(::hx::ObjectPtr<OBJ_>(this),inScreenSpace,camera);
            		}
HXLINE( 948)		HX_VARI(  ::flixel::FlxObject,object) = ( ( ::flixel::FlxObject)(objectOrGroup) );
...
HXLINE( 958)		HX_VARI(  ::flixel::math::FlxBasePoint,objectScreenPos) = object->getScreenPosition(null(),camera);
...
bool FlxObject_obj::overlapsAt(Float x,Float y, ::flixel::FlxBasic objectOrGroup,::hx::Null< bool >  __o_inScreenSpace, ::flixel::FlxCamera camera){
            	...
            	HX_STACK_ARG(camera,"camera")
HXLINE( 992)
HXLINE( 993)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(objectOrGroup);
...
HXLINE(1005)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(objectOrGroup) );
HXLINE(1006)			return tilemap->overlapsAt((tilemap->x - (x - this->x)),(tilemap->y - (y - this->y)),::hx::ObjectPtr<OBJ_>(this),inScreenSpace,camera);
            		}
HXLINE(1009)		HX_VARI(  ::flixel::FlxObject,object) = ( ( ::flixel::FlxObject)(objectOrGroup) );
...
HXLINE(1019)		HX_VARI(  ::flixel::math::FlxBasePoint,objectScreenPos) = object->getScreenPosition(null(),camera);
...
HXLINE(1053)		HX_VARI( Float,xPos) = (point->x - camera->scroll->x);
HXLINE(1054)		HX_VARI( Float,yPos) = (point->y - camera->scroll->y);
...
HXLINE(1256)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(1256)				_g = (_g + 1);
...
HXLINE(1276)		HX_VARI(  ::flixel::math::FlxRect,rect) = this->getBoundingBox(camera);
HXLINE(1277)		HX_VAR(  ::openfl::display::Graphics,gfx);
...
HXLINE(1283)
HXLINE(1285)		HX_VARI(  ::Dynamic,color) = this->debugBoundingBoxColor;
...
HXLINE( 174)
HXLINE( 175)		HX_VARI( bool,separatedX) = ::flixel::FlxObject_obj::separateX(object1,object2);
HXLINE( 176)		HX_VARI( bool,separatedY) = ::flixel::FlxObject_obj::separateY(object1,object2);
...
bool FlxObject_obj::updateTouchingFlags( ::flixel::FlxObject Object1, ::flixel::FlxObject Object2){
            	...
            	HX_STACK_ARG(Object2,"Object2")
HXLINE( 189)
HXLINE( 190)		HX_VARI( bool,touchingX) = ::flixel::FlxObject_obj::updateTouchingFlagsX(Object1,Object2);
HXLINE( 191)		HX_VARI( bool,touchingY) = ::flixel::FlxObject_obj::updateTouchingFlagsY(Object1,Object2);
...
HXLINE( 213)
HXLINE( 214)		HX_VARI( Float,overlap) = ( (Float)(0) );
HXLINE( 216)		HX_VARI( Float,obj1delta) = (object1->x - object1->last->x);
HXLINE( 217)		HX_VARI( Float,obj2delta) = (object2->x - object2->last->x);
HXLINE( 219)		if ((obj1delta != obj2delta)) {
HXLINE( 222)			HX_VAR( Float,obj1deltaAbs);
...
HXLINE( 223)			HX_VAR( Float,obj2deltaAbs);
...
HXDLIN( 225)			HX_VARI(  ::flixel::math::FlxRect,obj1rect) = _this;
...
HXDLIN( 227)			HX_VARI(  ::flixel::math::FlxRect,obj2rect) = _this1;
...
HXLINE( 235)				HX_VAR( Float,maxOverlap);
...
bool FlxObject_obj::separateX( ::flixel::FlxObject object1, ::flixel::FlxObject object2){
            	...
            	HX_STACK_ARG(object2,"object2")
HXLINE( 281)
HXLINE( 283)		HX_VARI( bool,immovable1) = object1->immovable;
HXLINE( 284)		HX_VARI( bool,immovable2) = object2->immovable;
...
HXLINE( 293)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(object1) );
...
HXLINE( 298)			HX_VARI_NAME(  ::flixel::tile::FlxBaseTilemap,tilemap1,"tilemap") = ( ( ::flixel::tile::FlxBaseTilemap)(object2) );
HXLINE( 299)			return tilemap1->overlapsWithCallback(object1,::flixel::FlxObject_obj::separateX_dyn(),true,null());
            		}
HXLINE( 302)		HX_VARI( Float,overlap) = ::flixel::FlxObject_obj::computeOverlapX(object1,object2,null());
HXLINE( 304)		if ((overlap != 0)) {
HXLINE( 306)			HX_VARI( Float,delta1) = (object1->x - object1->last->x);
HXLINE( 307)			HX_VARI( Float,delta2) = (object2->x - object2->last->x);
HXLINE( 308)			HX_VARI( Float,vel1) = object1->velocity->x;
HXLINE( 309)			HX_VARI( Float,vel2) = object2->velocity->x;
HXLINE( 310)			HX_VARI( Float,mass1) = object1->mass;
HXLINE( 311)			HX_VARI( Float,mass2) = object2->mass;
HXLINE( 312)			HX_VARI( Float,massSum) = (mass1 + mass2);
HXLINE( 313)			HX_VARI( Float,elasticity1) = object1->elasticity;
HXLINE( 314)			HX_VARI( Float,elasticity2) = object2->elasticity;
...
HXLINE( 334)				HX_VARI( Float,momentum) = ((mass1 * vel1) + (mass2 * vel2));
HXLINE( 335)				HX_VARI( Float,newVel1) = ((momentum + ((elasticity1 * mass2) * (vel2 - vel1))) / massSum);
HXLINE( 336)				HX_VARI( Float,newVel2) = ((momentum + ((elasticity2 * mass1) * (vel1 - vel2))) / massSum);
...
HXLINE( 376)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(object1) );
...
HXLINE( 381)			HX_VARI_NAME(  ::flixel::tile::FlxBaseTilemap,tilemap1,"tilemap") = ( ( ::flixel::tile::FlxBaseTilemap)(object2) );
...
Float FlxObject_obj::computeOverlapY( ::flixel::FlxObject object1, ::flixel::FlxObject object2,::hx::Null< bool >  __o_checkMaxOverlap){
            	...
            	HX_STACK_ARG(checkMaxOverlap,"checkMaxOverlap")
HXLINE( 395)
HXLINE( 396)		HX_VARI( Float,overlap) = ( (Float)(0) );
HXLINE( 398)		HX_VARI( Float,obj1delta) = (object1->y - object1->last->y);
HXLINE( 399)		HX_VARI( Float,obj2delta) = (object2->y - object2->last->y);
HXLINE( 401)		if ((obj1delta != obj2delta)) {
HXLINE( 404)			HX_VAR( Float,obj1deltaAbs);
...
HXLINE( 405)			HX_VAR( Float,obj2deltaAbs);
...
HXDLIN( 407)			HX_VARI(  ::flixel::math::FlxRect,obj1rect) = _this;
...
HXDLIN( 409)			HX_VARI(  ::flixel::math::FlxRect,obj2rect) = _this1;
...
HXLINE( 417)				HX_VAR( Float,maxOverlap);
...
bool FlxObject_obj::separateY( ::flixel::FlxObject object1, ::flixel::FlxObject object2){
            	...
            	HX_STACK_ARG(object2,"object2")
HXLINE( 463)
HXLINE( 465)		HX_VARI( bool,immovable1) = object1->immovable;
HXLINE( 466)		HX_VARI( bool,immovable2) = object2->immovable;
...
HXLINE( 475)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(object1) );
...
HXLINE( 480)			HX_VARI_NAME(  ::flixel::tile::FlxBaseTilemap,tilemap1,"tilemap") = ( ( ::flixel::tile::FlxBaseTilemap)(object2) );
HXLINE( 481)			return tilemap1->overlapsWithCallback(object1,::flixel::FlxObject_obj::separateY_dyn(),true,null());
            		}
HXLINE( 484)		HX_VARI( Float,overlap) = ::flixel::FlxObject_obj::computeOverlapY(object1,object2,null());
HXLINE( 486)		if ((overlap != 0)) {
HXLINE( 488)			HX_VARI( Float,delta1) = (object1->y - object1->last->y);
HXLINE( 489)			HX_VARI( Float,delta2) = (object2->y - object2->last->y);
HXLINE( 490)			HX_VARI( Float,vel1) = object1->velocity->y;
HXLINE( 491)			HX_VARI( Float,vel2) = object2->velocity->y;
HXLINE( 492)			HX_VARI( Float,mass1) = object1->mass;
HXLINE( 493)			HX_VARI( Float,mass2) = object2->mass;
HXLINE( 494)			HX_VARI( Float,massSum) = (mass1 + mass2);
HXLINE( 495)			HX_VARI( Float,elasticity1) = object1->elasticity;
HXLINE( 496)			HX_VARI( Float,elasticity2) = object2->elasticity;
...
HXLINE( 516)				HX_VARI( Float,momentum) = ((mass1 * vel1) + (mass2 * vel2));
HXLINE( 517)				HX_VARI( Float,newVel1) = ((momentum + ((elasticity1 * mass2) * (vel2 - vel1))) / massSum);
HXLINE( 518)				HX_VARI( Float,newVel2) = ((momentum + ((elasticity2 * mass1) * (vel1 - vel2))) / massSum);
...
HXLINE( 558)			HX_VARI(  ::flixel::tile::FlxBaseTilemap,tilemap) = ( ( ::flixel::tile::FlxBaseTilemap)(object1) );
...
HXLINE( 563)			HX_VARI_NAME(  ::flixel::tile::FlxBaseTilemap,tilemap1,"tilemap") = ( ( ::flixel::tile::FlxBaseTilemap)(object2) );

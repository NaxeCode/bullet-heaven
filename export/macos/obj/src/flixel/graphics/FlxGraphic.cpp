...
void FlxGraphic_obj::undump(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 439)
HXLINE( 440)		HX_VARI(  ::openfl::display::BitmapData,newBitmap) = this->getBitmapFromSystem();
...
HXLINE( 469)		HX_VARI( bool,dumped) = this->isDumped;
...
HXLINE( 497)		HX_VAR( ::Array< ::Dynamic>,collections);
HXLINE( 498)		{
HXLINE( 498)			int _g = 0;
HXDLIN( 498)			::Array< ::Dynamic> _g1 = this->frameCollectionTypes;
HXDLIN( 498)			while((_g < _g1->length)){
HXLINE( 498)				HX_VARI(  ::flixel::graphics::frames::FlxFrameCollectionType,collectionType) = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrameCollectionType >();
HXDLIN( 498)				_g = (_g + 1);
...
HXDLIN( 517)			HX_VARI_NAME( ::cpp::VirtualArray,collections1,"collections") = collections;
...
HXLINE( 529)
HXLINE( 530)		HX_VARI( ::cpp::VirtualArray,collections) = ( (::cpp::VirtualArray)(this->frameCollections->get(type)) );
...
HXLINE( 547)
HXLINE( 548)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) =  ::flixel::graphics::frames::FlxFrame_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),null(),null(),null(),null());
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,getEmptyFrame,return )
 ...
 ::openfl::display::BitmapData FlxGraphic_obj::getBitmapFromSystem(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 583)
HXLINE( 584)		HX_VARI(  ::openfl::display::BitmapData,newBitmap) = null();
...
HXLINE(  41)
HXLINE(  42)		HX_VARI(  ::openfl::display::BitmapData,bitmap) = null();
HXLINE(  44)		if (!(Cache)) {
...
HXLINE(  52)		HX_VARI( ::String,key) = ::flixel::FlxG_obj::bitmap->generateKey(Source,Key,Unique);
HXLINE(  53)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxGraphic_obj,fromAssetKey,return )
 ...
 ::flixel::graphics::FlxGraphic FlxGraphic_obj::fromClass(::hx::Class Source,::hx::Null< bool >  __o_Unique,::String Key,::hx::Null< bool >  __o_Cache){
            	...
            	HX_STACK_ARG(Cache,"Cache")
HXLINE(  77)
HXLINE(  78)		HX_VARI(  ::openfl::display::BitmapData,bitmap) = null();
HXLINE(  79)		if (!(Cache)) {
...
HXDLIN(  85)		HX_VARI( ::String,key) = ::Type_obj::getClassName(Source);
HXLINE(  86)		key = ::flixel::FlxG_obj::bitmap->generateKey(key,Key,Unique);
HXLINE(  87)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
...
HXLINE( 153)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxGraphic_obj,fromGraphic,return )
 ...
 ::flixel::graphics::FlxGraphic FlxGraphic_obj::fromRectangle(int Width,int Height,int Color,::hx::Null< bool >  __o_Unique,::String Key){
            	...
            	HX_STACK_ARG(Key,"Key")
HXLINE( 214)
HXLINE( 215)		HX_VARI( ::String,systemKey) = ((((Width + HX_("x",78,00,00,00)) + Height) + HX_(":",3a,00,00,00)) + Color);
HXLINE( 216)		HX_VARI( ::String,key) = ::flixel::FlxG_obj::bitmap->generateKey(systemKey,Key,Unique);
HXLINE( 218)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
HXLINE( 219)		if (::hx::IsNotNull( graphic )) {
HXLINE( 220)			return graphic;
            		}
HXLINE( 222)		HX_VARI(  ::openfl::display::BitmapData,bitmap) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,Width,Height,true,Color);
...
HXLINE( 251)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = null();
HXLINE( 253)		if (Cache) {

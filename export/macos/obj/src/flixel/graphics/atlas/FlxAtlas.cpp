...
HXDLIN( 239)				HX_VARI_NAME( int,nodeWithRotationArea1,"nodeWithRotationArea") = (nodeWithRotationArea * ::Std_obj::_hx_int(nodeToInsertWithRotation->rect->height));
...
HXDLIN( 569)		HX_VARI_NAME(  ::openfl::display::BitmapData,newBitmapData1,"newBitmapData") =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,newBitmapData,::Std_obj::_hx_int(this->root->rect->height),true,0);
...
HXLINE( 666)				HX_VARI_NAME(  ::flixel::graphics::atlas::FlxNode,node1,"node") = ( ( ::flixel::graphics::atlas::FlxNode)(node->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 682)			HX_VAR(  ::flixel::math::FlxBasePoint,sourceSize);
...
HXDLIN( 684)			HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point2;
...
HXLINE( 860)				HX_VARI_NAME(  ::flixel::graphics::atlas::FlxNode,node1,"node") = ( ( ::flixel::graphics::atlas::FlxNode)(node->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );

...
HXDLIN( 122)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = ( ( ::flixel::graphics::frames::FlxFrame)(_this->framesByName->get(this->key)) );
HXLINE( 124)		if (::hx::IsNotNull( frame )) {
HXLINE( 126)			HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,tileFrames) = ::flixel::graphics::frames::FlxTileFrames_obj::fromFrame(frame,tileSize,tileSpacing);
...
HXDLIN( 143)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = ( ( ::flixel::graphics::frames::FlxFrame)(_this->framesByName->get(this->key)) );

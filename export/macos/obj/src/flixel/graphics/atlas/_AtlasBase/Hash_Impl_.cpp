...
HXLINE(  76)
HXLINE(  77)			HX_VARI( ::String,key) = ( (::String)(keys->array->__get(keys->current++)) );
...
HXLINE(  71)
HXLINE(  72)		HX_VARI(  ::haxe::iterators::ArrayIterator,keys) =  ::haxe::iterators::ArrayIterator_obj::__alloc( HX_CTX ,::Reflect_obj::fields(this1));

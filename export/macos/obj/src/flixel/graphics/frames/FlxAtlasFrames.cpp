...
HXDLIN( 412)		HX_VARI(  ::flixel::math::FlxBasePoint,resultBorder) = this2;
HXLINE( 413)		HX_VARI(  ::flixel::graphics::frames::FlxAtlasFrames,atlasFrames) = ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(this->parent,resultBorder);
...
HXLINE( 419)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 419)				_g = (_g + 1);
...
HXLINE( 422)		return atlasFrames;
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::addAtlas( ::flixel::graphics::frames::FlxAtlasFrames collection,::hx::Null< bool >  __o_overwriteHash){
            	...
            	HX_STACK_ARG(overwriteHash,"overwriteHash")
HXLINE( 435)
HXLINE( 436)		{
HXLINE( 436)			int _g = 0;
HXDLIN( 436)			::Array< ::Dynamic> _g1 = collection->frames;
HXDLIN( 436)			while((_g < _g1->length)){
HXLINE( 436)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 436)				_g = (_g + 1);
...
HX_DEFINE_DYNAMIC_FUNC2(FlxAtlasFrames_obj,addAtlas,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::concat( ::flixel::graphics::frames::FlxAtlasFrames collection,::hx::Null< bool >  __o_overwriteHash){
            	...
            	HX_STACK_ARG(overwriteHash,"overwriteHash")
HXLINE( 458)
HXLINE( 459)		HX_VARI(  ::flixel::graphics::frames::FlxAtlasFrames,newCollection) =  ::flixel::graphics::frames::FlxAtlasFrames_obj::__alloc( HX_CTX ,this->parent,null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxAtlasFrames_obj,fromAseprite,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::fromTexturePackerJson( ::Dynamic source, ::Dynamic description,::hx::Null< bool >  __o_useFrameDuration){
            	...
            	HX_STACK_ARG(source,"source")
            	HX_STACK_ARG(description,"description")
            	HX_STACK_ARG(useFrameDuration,"useFrameDuration")
HXLINE(  68)
...
HXLINE(  74)		HX_VARI(  ::flixel::graphics::frames::FlxAtlasFrames,frames) = ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(graphic,null());
...
HXLINE(  83)		HX_VARI(  ::Dynamic,data) = ::flixel::_hx_system::_FlxAssets::FlxJsonAsset_Impl__obj::getData(description);
HXLINE(  86)		if (::Std_obj::isOfType( ::Dynamic(data->__Field(HX_("frames",a6,af,85,ac),::hx::paccDynamic)),::hx::ArrayBase::__mClass)) {
HXLINE(  88)			HX_VARI( ::Array< ::Dynamic>,frameArray) = ( (::Array< ::Dynamic>)(data->__Field(HX_("frames",a6,af,85,ac),::hx::paccDynamic)) );
HXLINE(  89)			{
HXLINE(  89)				int _g = 0;
HXDLIN(  89)				while((_g < frameArray->length)){
HXLINE(  89)					HX_VARI(  ::Dynamic,frame) = frameArray->__get(_g);
HXDLIN(  89)					_g = (_g + 1);
...
HXLINE(  95)			HX_VARI(  ::Dynamic,frameHash) =  ::Dynamic(data->__Field(HX_("frames",a6,af,85,ac),::hx::paccDynamic));
HXLINE(  96)			{
...
HXDLIN(  96)					HX_VARI( ::String,name) = ( (::String)(_g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic)) );
HXDLIN(  96)					HX_VARI_NAME(  ::Dynamic,frame1,"frame") = _g1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic);
...
void FlxAtlasFrames_obj::texturePackerHelper(::String frameName, ::Dynamic frameData, ::flixel::graphics::frames::FlxAtlasFrames frames,::hx::Null< bool >  __o_useFrameDuration){
            	...
            	HX_STACK_ARG(useFrameDuration,"useFrameDuration")
HXLINE( 111)
HXLINE( 112)		HX_VARI( bool,rotated) = ( (bool)(frameData->__Field(HX_("rotated",a9,49,1d,f1),::hx::paccDynamic)) );
HXLINE( 113)		HX_VARI( int,angle) = 0;
HXLINE( 114)		HX_VARI(  ::flixel::math::FlxRect,frameRect) = null();
HXLINE( 116)		HX_VARI(  ::Dynamic,frame) = frameData->__Field(HX_("frame",2d,78,83,06),::hx::paccDynamic);
...
HXDLIN( 127)		HX_VARI(  ::flixel::math::FlxBasePoint,sourceSize) = point;
...
HXDLIN( 128)		HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point1;
HXLINE( 129)		HX_VAR( Float,duration);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxAtlasFrames_obj,texturePackerHelper,(void))
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::fromLibGdx( ::Dynamic source,::String description){
            	...
            	HX_STACK_ARG(description,"description")
HXLINE( 143)
HXLINE( 144)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->add(source,null(),null());
HXLINE( 145)		if (::hx::IsNull( graphic )) {
HXLINE( 146)			return null();
            		}
HXLINE( 149)		HX_VARI(  ::flixel::graphics::frames::FlxAtlasFrames,frames) = ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(graphic,null());
...
HXLINE( 161)		HX_VARI( ::String,pack) = ::StringTools_obj::trim(description);
HXLINE( 162)		HX_VARI( ::Array< ::String >,lines) = pack.split(HX_("\n",0a,00,00,00));
HXLINE( 165)		HX_VAR( int,repeatLine);
...
HXLINE( 168)		HX_VARI( int,numElementsPerImage) = 7;
HXLINE( 169)		HX_VARI( int,numImages) = ::Std_obj::_hx_int((( (Float)(lines->length) ) / ( (Float)(numElementsPerImage) )));
HXLINE( 171)		{
HXLINE( 171)			int _g = 0;
HXDLIN( 171)			int _g1 = numImages;
HXDLIN( 171)			while((_g < _g1)){
HXLINE( 171)				_g = (_g + 1);
HXDLIN( 171)				HX_VARI( int,i) = (_g - 1);
HXLINE( 173)				HX_VARI( int,curIndex) = (i * numElementsPerImage);
HXLINE( 175)				curIndex = (curIndex + 1);
HXDLIN( 175)				HX_VARI( ::String,name) = lines->__get((curIndex - 1));
HXLINE( 176)				curIndex = (curIndex + 1);
HXDLIN( 176)				HX_VARI( bool,rotated) = (lines->__get((curIndex - 1)).indexOf(HX_("true",4e,a7,03,4d),null()) >= 0);
HXLINE( 177)				HX_VAR( int,angle);
...
HXDLIN( 179)				HX_VARI( ::String,tempString) = lines->__get((curIndex - 1));
HXLINE( 180)				HX_VARI(  ::Dynamic,size) = ::flixel::graphics::frames::FlxAtlasFrames_obj::getDimensions(tempString);
HXLINE( 182)				HX_VARI( int,imageX) = ( (int)(size->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) );
HXLINE( 183)				HX_VARI( int,imageY) = ( (int)(size->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) );
...
HXLINE( 188)				HX_VARI( int,imageWidth) = ( (int)(size->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) );
HXLINE( 189)				HX_VARI( int,imageHeight) = ( (int)(size->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) );
...
HXDLIN( 191)				HX_VARI_NAME(  ::flixel::math::FlxRect,rect1,"rect") = rect;
...
HXDLIN( 196)				HX_VARI(  ::flixel::math::FlxBasePoint,sourceSize) = point;
...
HXLINE( 202)				HX_VARI(  ::Dynamic,index) = ::Std_obj::parseInt(tempString.split(HX_(":",3a,00,00,00))->__get(1));
...
HXDLIN( 211)				HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point1;
...
HXLINE( 222)
HXLINE( 223)		HX_VARI( int,colonPosition) = line.indexOf(HX_(":",3a,00,00,00),null());
HXLINE( 224)		HX_VARI( int,comaPosition) = line.indexOf(HX_(",",2c,00,00,00),null());
...
HXLINE( 242)
HXLINE( 243)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->add(source,null(),null());
HXLINE( 244)		if (::hx::IsNull( graphic )) {
HXLINE( 245)			return null();
            		}
HXLINE( 247)		HX_VARI(  ::flixel::graphics::frames::FlxAtlasFrames,frames) = ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(graphic,null());
...
HXLINE( 258)				HX_VARI(  ::Xml,texture) = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN( 258)				_g = (_g + 1);
HXLINE( 260)				HX_VARI( ::String,name) = ::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("name",4b,72,ff,48));
HXLINE( 261)				HX_VARI( bool,trimmed) = ::haxe::xml::_Access::HasAttribAccess_Impl__obj::resolve(texture,HX_("frameX",8b,af,85,ac));
HXLINE( 262)				HX_VAR( bool,rotated);
...
HXDLIN( 266)				HX_VARI_NAME(  ::flixel::math::FlxRect,rect1,"rect") = rect;
HXLINE( 269)				HX_VAR(  ::openfl::geom::Rectangle,size);
...
HXDLIN( 281)				HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point;
...
HXDLIN( 282)				HX_VARI(  ::flixel::math::FlxBasePoint,sourceSize) = point1;
...
HXLINE( 317)		HX_VARI(  ::Xml,data) = ::flixel::_hx_system::_FlxAssets::FlxXmlAsset_Impl__obj::getXml(xml);
HXLINE( 319)		{
HXLINE( 319)			HX_VARI(  ::Dynamic,sprite) = data->firstElement()->elements();
HXDLIN( 319)			while(( (bool)(sprite->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 319)				HX_VARI_NAME(  ::Xml,sprite1,"sprite") = ( ( ::Xml)(sprite->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 321)				HX_VAR( bool,trimmed);
...
HXLINE( 322)				HX_VAR( bool,rotated);
...
HXLINE( 324)				HX_VARI( ::String,name) = sprite1->get(HX_("n",6e,00,00,00));
...
HXDLIN( 325)				HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point;
...
HXDLIN( 326)				HX_VARI_NAME(  ::flixel::math::FlxRect,rect1,"rect") = rect;
...
HXDLIN( 327)				HX_VARI(  ::flixel::math::FlxBasePoint,sourceSize) = point1;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxAtlasFrames_obj,fromTexturePackerXml,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::fromSpriteSheetPacker( ::Dynamic Source,::String Description){
            	...
            	HX_STACK_ARG(Description,"Description")
HXLINE( 351)
HXLINE( 352)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->add(Source,null(),null());
HXLINE( 353)		if (::hx::IsNull( graphic )) {
HXLINE( 354)			return null();
            		}
HXLINE( 357)		HX_VARI(  ::flixel::graphics::frames::FlxAtlasFrames,frames) = ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(graphic,null());
...
HXLINE( 369)		HX_VARI( ::String,pack) = ::StringTools_obj::trim(Description);
HXLINE( 370)		HX_VARI( ::Array< ::String >,lines) = pack.split(HX_("\n",0a,00,00,00));
HXLINE( 372)		{
HXLINE( 372)			int _g = 0;
HXDLIN( 372)			int _g1 = lines->length;
HXDLIN( 372)			while((_g < _g1)){
HXLINE( 372)				_g = (_g + 1);
HXDLIN( 372)				HX_VARI( int,i) = (_g - 1);
HXLINE( 374)				HX_VARI( ::Array< ::String >,currImageData) = lines->__get(i).split(HX_("=",3d,00,00,00));
HXLINE( 375)				HX_VARI( ::String,name) = ::StringTools_obj::trim(currImageData->__get(0));
HXLINE( 376)				HX_VARI( ::Array< ::String >,currImageRegion) = ::StringTools_obj::trim(currImageData->__get(1)).split(HX_(" ",20,00,00,00));
...
HXDLIN( 378)				HX_VARI_NAME(  ::flixel::math::FlxRect,rect1,"rect") = rect;
...
HXDLIN( 380)				HX_VARI(  ::flixel::math::FlxBasePoint,sourceSize) = point;
...
HXDLIN( 381)				HX_VARI(  ::flixel::math::FlxBasePoint,offset) = point1;
...
HXDLIN( 401)		HX_VARI( ::Array< ::Dynamic>,atlasFrames) = collections;
HXLINE( 403)		{
HXLINE( 403)			int _g = 0;
HXDLIN( 403)			while((_g < atlasFrames->length)){
HXLINE( 403)				HX_VARI(  ::flixel::graphics::frames::FlxAtlasFrames,atlas) = atlasFrames->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxAtlasFrames >();
HXDLIN( 403)				_g = (_g + 1);

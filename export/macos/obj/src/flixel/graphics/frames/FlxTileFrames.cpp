...
HXDLIN( 517)		HX_VARI(  ::flixel::math::FlxBasePoint,resultBorder) = this2;
...
HXDLIN( 518)		HX_VARI(  ::flixel::math::FlxBasePoint,resultSize) = this4;
HXLINE( 519)		HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,tileFrames) = ::flixel::graphics::frames::FlxTileFrames_obj::findFrame(this->parent,resultSize,this->region,this->atlasFrame,this->tileSpacing,resultBorder);
...
HXLINE( 532)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 532)				_g = (_g + 1);
...
HXLINE( 546)		this->tileSpacing = ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->tileSpacing)) );
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::fromBitmapAddSpacesAndBorders( ::Dynamic source, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxBasePoint tileSpacing, ::flixel::math::FlxBasePoint tileBorder, ::flixel::math::FlxRect region){
            	...
            	HX_STACK_ARG(region,"region")
HXLINE(  72)
HXLINE(  73)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->add(source,false,null());
HXLINE(  74)		if (::hx::IsNull( graphic )) {
HXLINE(  75)			return null();
            		}
HXLINE(  77)		HX_VARI( ::String,key) = ::flixel::FlxG_obj::bitmap->getKeyWithSpacesAndBorders(graphic->key,tileSize,tileSpacing,tileBorder,region);
HXLINE(  78)		HX_VARI(  ::flixel::graphics::FlxGraphic,result) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
HXLINE(  79)		if (::hx::IsNull( result )) {
HXLINE(  81)			HX_VARI(  ::openfl::display::BitmapData,bitmap) = ::flixel::util::FlxBitmapDataUtil_obj::addSpacesAndBorders(graphic->bitmap,tileSize,tileSpacing,tileBorder,region);
HXLINE(  82)			result = ::flixel::FlxG_obj::bitmap->add(bitmap,false,key);
            		}
HXLINE(  85)		HX_VARI( int,borderX) = 0;
HXLINE(  86)		HX_VARI( int,borderY) = 0;
...
HXDLIN(  94)		HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,tileFrames) = ::flixel::graphics::frames::FlxTileFrames_obj::fromGraphic(result,this2,null(),tileSpacing);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC5(FlxTileFrames_obj,fromBitmapAddSpacesAndBorders,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::fromFrameAddSpacesAndBorders( ::flixel::graphics::frames::FlxFrame frame, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxBasePoint tileSpacing, ::flixel::math::FlxBasePoint tileBorder){
            	...
            	HX_STACK_ARG(tileBorder,"tileBorder")
HXLINE( 114)
HXLINE( 115)		HX_VARI(  ::openfl::display::BitmapData,bitmap) = frame->paint(null(),null(),null(),null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxTileFrames_obj,fromFrameAddSpacesAndBorders,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::fromFrame( ::flixel::graphics::frames::FlxFrame frame, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxBasePoint tileSpacing){
            	...
            	HX_STACK_ARG(tileSpacing,"tileSpacing")
HXLINE( 131)
HXLINE( 132)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = frame->parent;
HXLINE( 134)		HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,tileFrames) = ::flixel::graphics::frames::FlxTileFrames_obj::findFrame(graphic,tileSize,null(),frame,tileSpacing,null());
...
HXLINE( 150)		HX_VARI( Float,spacedWidth) = (tileSize->x + tileSpacing->x);
HXLINE( 151)		HX_VARI( Float,spacedHeight) = (tileSize->y + tileSpacing->y);
HXLINE( 153)		HX_VAR( int,numRows);
...
HXLINE( 184)
HXLINE( 185)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,firstFrame) = Frames->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXLINE( 186)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = firstFrame->parent;
HXLINE( 188)		{
HXLINE( 188)			int _g = 0;
HXDLIN( 188)			while((_g < Frames->length)){
HXLINE( 188)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = Frames->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 188)				_g = (_g + 1);
...
HXLINE( 197)		HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,tileFrames) =  ::flixel::graphics::frames::FlxTileFrames_obj::__alloc( HX_CTX ,graphic,null());
...
HXLINE( 206)				HX_VARI_NAME(  ::flixel::graphics::frames::FlxFrame,frame1,"frame") = Frames->__get(_g1).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXLINE( 227)
HXLINE( 228)		HX_VARI( ::Array< ::Dynamic>,framesToAdd) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 230)		{
HXLINE( 230)			int _g = 0;
HXDLIN( 230)			::Array< ::Dynamic> _g1 = Frames->frames;
HXDLIN( 230)			while((_g < _g1->length)){
HXLINE( 230)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 230)				_g = (_g + 1);
...
HXLINE( 238)			HX_VARI( ::String,name) = framesToAdd->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name;
HXLINE( 239)			HX_VARI( int,postIndex) = name.indexOf(HX_(".",2e,00,00,00),Prefix.length);
...
HXDLIN( 240)			HX_VARI_NAME( ::String,postFix1,"postFix") = name.substring(postFix,name.length);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxTileFrames_obj,fromGraphic,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::fromRectangle( ::Dynamic source, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxRect region, ::flixel::math::FlxBasePoint tileSpacing){
            	...
            	HX_STACK_ARG(tileSpacing,"tileSpacing")
HXLINE( 327)
HXLINE( 328)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->add(source,false,null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxTileFrames_obj,fromRectangle,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::combineTileSets(::Array< ::Dynamic> bitmaps, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxBasePoint spacing, ::flixel::math::FlxBasePoint border){
            	...
            	HX_STACK_ARG(border,"border")
HXLINE( 355)
HXLINE( 356)		HX_VARI( ::Array< ::Dynamic>,framesCollections) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 358)		{
HXLINE( 358)			int _g = 0;
HXDLIN( 358)			while((_g < bitmaps->length)){
HXLINE( 358)				HX_VARI(  ::openfl::display::BitmapData,bitmap) = bitmaps->__get(_g).StaticCast<  ::openfl::display::BitmapData >();
HXDLIN( 358)				_g = (_g + 1);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxTileFrames_obj,combineTileSets,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::combineTileFrames(::Array< ::Dynamic> tileframes, ::flixel::math::FlxBasePoint spacing, ::flixel::math::FlxBasePoint border){
            	...
            	HX_STACK_ARG(border,"border")
HXLINE( 384)
HXLINE( 386)		HX_VARI( int,totalArea) = 0;
HXLINE( 387)		HX_VARI( int,rows) = 0;
HXLINE( 388)		HX_VARI( int,cols) = 0;
HXLINE( 390)		HX_VARI( int,tileWidth) = ::Std_obj::_hx_int(tileframes->__get(0).StaticCast<  ::flixel::graphics::frames::FlxTileFrames >()->frames->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->sourceSize->x);
HXLINE( 391)		HX_VARI( int,tileHeight) = ::Std_obj::_hx_int(tileframes->__get(0).StaticCast<  ::flixel::graphics::frames::FlxTileFrames >()->frames->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->sourceSize->y);
HXLINE( 393)		HX_VARI( int,spaceX) = 0;
HXLINE( 394)		HX_VARI( int,spaceY) = 0;
HXLINE( 396)		if (::hx::IsNotNull( spacing )) {
HXLINE( 398)			spaceX = ::Std_obj::_hx_int(spacing->x);
HXLINE( 399)			spaceY = ::Std_obj::_hx_int(spacing->y);
            		}
HXLINE( 402)		HX_VARI( int,borderX) = 0;
HXLINE( 403)		HX_VARI( int,borderY) = 0;
...
HXLINE( 411)				HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,collection) = tileframes->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxTileFrames >();
HXDLIN( 411)				_g = (_g + 1);
...
HXLINE( 418)		HX_VARI( Float,side) = ::Math_obj::sqrt(( (Float)(totalArea) ));
...
HXLINE( 421)		HX_VARI( int,width) = (::Std_obj::_hx_int(( (Float)((cols * (tileWidth + (2 * borderX)))) )) + ((cols - 1) * spaceX));
HXLINE( 422)		HX_VARI( int,height) = (::Std_obj::_hx_int(( (Float)((rows * (tileHeight + (2 * borderY)))) )) + ((rows - 1) * spaceY));
HXLINE( 425)		HX_VARI(  ::openfl::display::BitmapData,combined) =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,0);
HXLINE( 426)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->add(combined,null(),null());
HXLINE( 427)		HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,result) =  ::flixel::graphics::frames::FlxTileFrames_obj::__alloc( HX_CTX ,graphic,null());
HXLINE( 428)		HX_VARI(  ::openfl::geom::Point,destPoint) =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,borderX,borderY);
...
HXLINE( 437)				HX_VARI_NAME(  ::flixel::graphics::frames::FlxTileFrames,collection1,"collection") = tileframes->__get(_g1).StaticCast<  ::flixel::graphics::frames::FlxTileFrames >();
HXDLIN( 437)				_g1 = (_g1 + 1);
HXLINE( 439)				{
HXLINE( 439)					int _g2 = 0;
HXDLIN( 439)					::Array< ::Dynamic> _g3 = collection1->frames;
HXDLIN( 439)					while((_g2 < _g3->length)){
HXLINE( 439)						HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _g3->__get(_g2).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXDLIN( 473)		HX_VARI( ::Array< ::Dynamic>,tileFrames) = collections;
HXLINE( 475)		{
HXLINE( 475)			int _g = 0;
HXDLIN( 475)			while((_g < tileFrames->length)){
HXLINE( 475)				HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,sheet) = tileFrames->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxTileFrames >();
HXDLIN( 475)				_g = (_g + 1);

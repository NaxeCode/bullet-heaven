...
HX_DEFINE_DYNAMIC_FUNC2(FlxFrame_obj,prepareBlitMatrix,return )
 ...
 ::flixel::math::FlxMatrix FlxFrame_obj::rotateAndFlip( ::flixel::math::FlxMatrix mat,::hx::Null< int >  __o_rotation,::hx::Null< bool >  __o_flipX,::hx::Null< bool >  __o_flipY){
            	...
            	HX_STACK_ARG(flipY,"flipY")
HXLINE( 194)
HXLINE( 195)		HX_VARI( int,w) = ::Std_obj::_hx_int(this->sourceSize->x);
HXLINE( 196)		HX_VARI( int,h) = ::Std_obj::_hx_int(this->sourceSize->y);
HXLINE( 199)		if ((rotation != 0)) {
HXLINE( 201)			HX_VARI( int,t) = w;
HXLINE( 202)			w = h;
HXLINE( 203)			h = t;
...
HXLINE( 272)		HX_VARI( bool,doFlipX) = (flipX != this->flipX);
HXLINE( 273)		HX_VARI( bool,doFlipY) = (flipY != this->flipY);
...
HXLINE( 357)		HX_VARI( bool,doFlipX) = (flipX != this->flipX);
HXLINE( 358)		HX_VARI( bool,doFlipY) = (flipY != this->flipY);
...
HX_DEFINE_DYNAMIC_FUNC7(FlxFrame_obj,paintRotatedAndFlipped,return )
 ...
 ::openfl::display::BitmapData FlxFrame_obj::checkInputBitmap( ::openfl::display::BitmapData bmd, ::openfl::geom::Point point,::hx::Null< int >  __o_rotation,::hx::Null< bool >  __o_mergeAlpha,::hx::Null< bool >  __o_disposeIfNotEqual){
            	...
            	HX_STACK_ARG(disposeIfNotEqual,"disposeIfNotEqual")
HXLINE( 383)
HXLINE( 384)		HX_VARI( bool,flipXY) = (rotation != 0);
HXLINE( 385)		Float w;
...
HXDLIN( 385)		HX_VARI_NAME( int,w1,"w") = ::Std_obj::_hx_int(w);
HXLINE( 386)		Float h;
...
HXDLIN( 386)		HX_VARI_NAME( int,h1,"h") = ::Std_obj::_hx_int(h);
...
HXDLIN( 418)		HX_VARI(  ::flixel::math::FlxBasePoint,p1) = point1;
...
HXDLIN( 419)		HX_VARI(  ::flixel::math::FlxBasePoint,p2) = point3;
HXLINE( 421)		{
...
HXDLIN( 424)		HX_VARI(  ::flixel::math::FlxRect,flxRect) = _this3;
HXLINE( 425)		{
...
HXDLIN( 460)		HX_VARI(  ::flixel::math::FlxRect,clippedRect) = _this1;
HXLINE( 461)		if ((this->angle != 0)) {
HXLINE( 463)			clippedRect->width = this->frame->height;
HXLINE( 464)			clippedRect->height = this->frame->width;
            		}
HXLINE( 467)		HX_VARI( Float,ox) = ::Math_obj::max(this->offset->x,( (Float)(0) ));
HXLINE( 468)		HX_VARI( Float,oy) = ::Math_obj::max(this->offset->y,( (Float)(0) ));
HXLINE( 470)		{
...
HXLINE( 471)		HX_VARI(  ::flixel::math::FlxRect,frameRect) = clippedRect->intersection(rect,null());
...
HXDLIN( 487)			HX_VARI(  ::flixel::math::FlxBasePoint,p1) = point2;
...
HXDLIN( 488)			HX_VARI(  ::flixel::math::FlxBasePoint,p2) = point4;
...
HXDLIN( 527)		HX_VARI_NAME(  ::flixel::math::FlxRect,rect1,"rect") = rect;
...
HXDLIN( 566)		HX_VARI(  ::flixel::math::FlxRect,clippedRect) = _this1;
...
HXLINE( 574)		HX_VARI(  ::flixel::math::FlxRect,frameRect) = clippedRect->intersection(clip,null());
...
HXDLIN( 589)			HX_VARI(  ::flixel::math::FlxBasePoint,p1) = point2;
...
HXDLIN( 590)			HX_VARI(  ::flixel::math::FlxBasePoint,p2) = point4;
...
int FlxFrame_obj::sortByName( ::flixel::graphics::frames::FlxFrame frame1, ::flixel::graphics::frames::FlxFrame frame2,int prefixLength,int postfixLength){
            	...
            	HX_STACK_ARG(postfixLength,"postfixLength")
HXLINE(  47)
HXLINE(  48)		HX_VARI( ::String,name1) = frame1->name;
HXLINE(  49)		HX_VARI( ::String,name2) = frame2->name;
HXLINE(  50)		HX_VARI(  ::Dynamic,num1) = ::Std_obj::parseInt(name1.substring(prefixLength,(name1.length - postfixLength)));
HXLINE(  51)		HX_VARI(  ::Dynamic,num2) = ::Std_obj::parseInt(name2.substring(prefixLength,(name2.length - postfixLength)));

...
HXDLIN( 237)		HX_VARI(  ::flixel::math::FlxBasePoint,resultBorder) = this2;
HXLINE( 239)		 ::flixel::graphics::FlxGraphic imageFrame = this->parent;
HXDLIN( 239)		HX_VARI_NAME(  ::flixel::graphics::frames::FlxImageFrame,imageFrame1,"imageFrame") = ::flixel::graphics::frames::FlxImageFrame_obj::findFrame(imageFrame,this->get_frame()->frame,resultBorder);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxImageFrame_obj,fromRectangle,return )
 ...
 ::flixel::graphics::frames::FlxImageFrame FlxImageFrame_obj::fromBitmapAddSpacesAndBorders( ::Dynamic source, ::flixel::math::FlxBasePoint border, ::flixel::math::FlxRect region){
            	...
            	HX_STACK_ARG(region,"region")
HXLINE( 151)
HXLINE( 152)		HX_VARI(  ::flixel::graphics::FlxGraphic,graphic) = ::flixel::FlxG_obj::bitmap->add(source,false,null());
...
HXLINE( 157)		HX_VARI(  ::flixel::graphics::FlxGraphic,result) = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );

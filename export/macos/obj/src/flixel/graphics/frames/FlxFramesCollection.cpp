...
HXLINE( 149)
HXLINE( 150)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) =  ::flixel::graphics::frames::FlxFrame_obj::__alloc( HX_CTX ,this->parent,null(),null(),null(),null());
...
HXLINE( 165)
HXLINE( 166)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) =  ::flixel::graphics::frames::FlxFrame_obj::__alloc( HX_CTX ,this->parent,null(),null(),null(),null());
...
HXLINE( 194)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,texFrame) =  ::flixel::graphics::frames::FlxFrame_obj::__alloc( HX_CTX ,this->parent,angle,flipX,flipY,duration);
...
HXLINE( 213)
HXLINE( 214)		HX_VARI( ::Array< ::Dynamic>,list) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 215)		{
...
void FlxFramesCollection_obj::forEachByPrefix(::String prefix, ::Dynamic func,::hx::Null< bool >  __o_warnIfEmpty,::String warningMsg){
            	...
            	HX_STACK_ARG(warnIfEmpty,"warnIfEmpty")
            	HX_STACK_ARG(warningMsg,"warningMsg")
HXLINE( 230)
HXLINE( 231)		HX_VARI( bool,warn) = warnIfEmpty;
HXLINE( 232)		{
...
HXDLIN( 232)				HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _g_value;
...
HXLINE( 364)
HXLINE( 365)		HX_VARI( ::String,name) = frameObj->name;

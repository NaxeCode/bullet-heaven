...
HXLINE(  62)		HX_VAR(  ::flixel::graphics::tile::FlxGraphicsShader,shader);
...
HXLINE(  94)			HX_VARI(  ::openfl::display::Graphics,gfx) = camera->debugLayer->get_graphics();
...
HXLINE( 148)		HX_VARI( int,verticesLength) = vertices->get_length();
HXLINE( 149)		HX_VARI( int,prevVerticesLength) = this->vertices->get_length();
HXLINE( 150)		HX_VARI( int,numberOfVertices) = ::Std_obj::_hx_int((( (Float)(verticesLength) ) / ( (Float)(2) )));
HXLINE( 151)		HX_VARI( int,prevIndicesLength) = this->indices->get_length();
HXLINE( 152)		HX_VARI( int,prevUVTDataLength) = this->uvtData->get_length();
HXLINE( 153)		HX_VARI( int,prevColorsLength) = this->colors->get_length();
HXLINE( 154)		HX_VARI( int,prevNumberOfVertices) = this->get_numVertices();
HXLINE( 156)		HX_VAR( Float,tempX);
HXDLIN( 156)		HX_VAR( Float,tempY);
HXLINE( 157)		HX_VARI( int,i) = 0;
HXLINE( 158)		HX_VARI( int,currentVertexPosition) = prevVerticesLength;
...
HXLINE( 186)			HX_VARI( int,uvtDataLength) = uvtData->get_length();
HXLINE( 187)			{
HXLINE( 187)				int _g = 0;
HXDLIN( 187)				int _g1 = uvtDataLength;
HXDLIN( 187)				while((_g < _g1)){
HXLINE( 187)					_g = (_g + 1);
HXDLIN( 187)					HX_VARI_NAME( int,i1,"i") = (_g - 1);
HXLINE( 189)					{
...
HXDLIN( 200)						HX_VARI_NAME( int,i3,"i") = (_g4 - 1);
HXLINE( 202)						{
...
HXDLIN( 216)				HX_VARI( int,_) = (_g6 - 1);
...
HXDLIN( 231)					HX_VARI_NAME( int,_1,"_") = (_g8 - 1);
...
void FlxDrawTrianglesItem_obj::addQuad( ::flixel::graphics::frames::FlxFrame frame, ::flixel::math::FlxMatrix matrix, ::openfl::geom::ColorTransform transform){
            	...
            	HX_STACK_ARG(transform,"transform")
HXLINE( 297)
HXLINE( 298)		HX_VARI( int,prevVerticesPos) = this->verticesPosition;
HXLINE( 299)		HX_VARI( int,prevIndicesPos) = this->indicesPosition;
HXLINE( 300)		HX_VARI( int,prevColorsPos) = this->colorsPosition;
HXLINE( 301)		HX_VARI( int,prevNumberOfVertices) = this->get_numVertices();
...
HXDLIN( 303)		HX_VARI_NAME(  ::flixel::math::FlxBasePoint,point1,"point") = point;
HXLINE( 304)		{
...
HXLINE( 350)			HX_VARI( Float,red) = ((Float)1.0);
HXLINE( 351)			HX_VARI( Float,green) = ((Float)1.0);
HXLINE( 352)			HX_VARI( Float,blue) = ((Float)1.0);
HXLINE( 353)			HX_VARI( Float,alpha) = ((Float)1.0);
...
HXDLIN( 366)			HX_VARI_NAME( int,color5,"color") = color;

...
HXLINE( 116)		HX_VARI( ::Array< bool >,result) = ::Array_obj< bool >::fromData( _hx_array_data_c28ed6c1_6,1);
HXLINE( 118)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
...
HXLINE( 133)			HX_VARI(  ::flixel::FlxObject,object) = ( ( ::flixel::FlxObject)(ObjectOrGroup) );

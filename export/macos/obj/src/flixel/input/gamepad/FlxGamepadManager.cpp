...
void FlxGamepadManager_obj::removeByID(int GamepadID){
            	...
            	HX_STACK_ARG(GamepadID,"GamepadID")
HXLINE(  81)
HXLINE(  82)		HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = this->_gamepads->__get(GamepadID).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXLINE(  84)		if (::hx::IsNotNull( gamepad )) {
HXLINE(  86)			this->_gamepads[GamepadID] = null();
HXLINE(  88)			HX_VARI( int,i) = this->_activeGamepads->indexOf(gamepad,null());
HXLINE(  89)			if ((i != -1)) {
...
HXLINE( 106)
HXLINE( 107)		HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = this->_gamepads->__get(GamepadID).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
...
HXLINE( 114)			HX_VARI( bool,nullFound) = false;
HXLINE( 115)			{
HXLINE( 115)				int _g = 0;
...
HXLINE( 147)				HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXDLIN( 147)				_g = (_g + 1);
...
HXLINE( 165)				HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXDLIN( 165)				_g = (_g + 1);
...
int FlxGamepadManager_obj::getFirstActiveGamepadID(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 177)
HXLINE( 178)		HX_VARI(  ::flixel::input::gamepad::FlxGamepad,firstActive) = this->getFirstActiveGamepad();
...
HXLINE( 188)				HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXDLIN( 188)				_g = (_g + 1);
...
HXLINE( 200)				HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXDLIN( 200)				_g = (_g + 1);
...
HXLINE( 212)				HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXDLIN( 212)				_g = (_g + 1);
...
HXLINE( 245)				HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXDLIN( 245)				_g = (_g + 1);
...
HXLINE( 260)				HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXDLIN( 260)				_g = (_g + 1);
HXLINE( 262)				if (::hx::IsNull( gamepad )) {
HXLINE( 263)					continue;
            				}
HXLINE( 265)				HX_VARI( Float,value) = gamepad->getAnalogXAxisValue(RawAxisID);
...
HXLINE( 281)				HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXDLIN( 281)				_g = (_g + 1);
HXLINE( 283)				if (::hx::IsNull( gamepad )) {
HXLINE( 284)					continue;
            				}
HXLINE( 286)				HX_VARI( Float,value) = gamepad->getYAxisRaw(RawAxisID);
...
HXDLIN( 318)			HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXDLIN( 318)			_g = (_g + 1);
...
HXLINE( 374)		HX_VARI( int,id) = this->findGamepadIndex(Device);
HXLINE( 376)		if ((id < 0)) {
HXLINE( 377)			return;
            		}
HXLINE( 379)		HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = this->createByID(id,this->getModelFromDeviceName(Device->name));
...
HXLINE( 435)				_g = (_g + 1);
HXDLIN( 435)				HX_VARI( int,i) = (_g - 1);
HXLINE( 437)				HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = this->_gamepads->__get(i).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
...
HXDLIN( 577)			HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXDLIN( 577)			_g = (_g + 1);
...
int FlxGamepadManager_obj::get_numActiveGamepads(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 590)
HXLINE( 591)		HX_VARI( int,count) = 0;
HXLINE( 592)		{
HXLINE( 592)			int _g = 0;
HXDLIN( 592)			::Array< ::Dynamic> _g1 = this->_gamepads;
HXDLIN( 592)			while((_g < _g1->length)){
HXLINE( 592)				HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXDLIN( 592)				_g = (_g + 1);

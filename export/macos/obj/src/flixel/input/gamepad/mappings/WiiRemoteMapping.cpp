...
HXLINE(  55)					HX_VARI_NAME( int,id1,"id") = rawID;
HXDLIN(  55)					if ((id1 == this->leftStick->rawDown)) {
HXLINE(  55)						return 36;
            					}
            					else {
HXLINE(  56)						HX_VARI_NAME( int,id2,"id") = rawID;
HXDLIN(  56)						if ((id2 == this->leftStick->rawLeft)) {
HXLINE(  56)							return 37;
            						}
            						else {
HXLINE(  57)							HX_VARI_NAME( int,id3,"id") = rawID;
HXDLIN(  57)							if ((id3 == this->leftStick->rawRight)) {
HXLINE(  57)								return 35;
            							}
            							else {
HXLINE(  58)								HX_VARI_NAME( int,id4,"id") = rawID;
HXDLIN(  58)								if ((id4 == this->rightStick->rawUp)) {
HXLINE(  58)									return 38;
            								}
            								else {
HXLINE(  59)									HX_VARI_NAME( int,id5,"id") = rawID;
HXDLIN(  59)									if ((id5 == this->rightStick->rawDown)) {
HXLINE(  59)										return 40;
            									}
            									else {
HXLINE(  60)										HX_VARI_NAME( int,id6,"id") = rawID;
HXDLIN(  60)										if ((id6 == this->rightStick->rawLeft)) {
HXLINE(  60)											return 41;
            										}
            										else {
HXLINE(  61)											HX_VARI_NAME( int,id7,"id") = rawID;
...
::String WiiRemoteMapping_obj::getInputLabel(int id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 283)
HXLINE( 284)		HX_VARI( ::String,label) = ::flixel::input::gamepad::mappings::WiiRemoteMapping_obj::getWiiInputLabel(id,this->attachment);

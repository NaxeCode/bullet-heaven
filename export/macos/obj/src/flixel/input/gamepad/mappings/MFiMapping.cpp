...
HXLINE(  32)				return 14;
            			...
            			break;
            			default:{
HXLINE(  33)				HX_VARI( int,id) = rawID;
HXDLIN(  33)				if ((id == this->leftStick->rawUp)) {
HXLINE(  33)					return 34;
            				}
            				else {
HXLINE(  34)					HX_VARI_NAME( int,id1,"id") = rawID;
HXDLIN(  34)					if ((id1 == this->leftStick->rawDown)) {
HXLINE(  34)						return 36;
            					}
            					else {
HXLINE(  35)						HX_VARI_NAME( int,id2,"id") = rawID;
HXDLIN(  35)						if ((id2 == this->leftStick->rawLeft)) {
HXLINE(  35)							return 37;
            						}
            						else {
HXLINE(  36)							HX_VARI_NAME( int,id3,"id") = rawID;
HXDLIN(  36)							if ((id3 == this->leftStick->rawRight)) {
HXLINE(  36)								return 35;
            							}
            							else {
HXLINE(  37)								HX_VARI_NAME( int,id4,"id") = rawID;
HXDLIN(  37)								if ((id4 == this->rightStick->rawUp)) {
HXLINE(  37)									return 38;
            								}
            								else {
HXLINE(  38)									HX_VARI_NAME( int,id5,"id") = rawID;
HXDLIN(  38)									if ((id5 == this->rightStick->rawDown)) {
HXLINE(  38)										return 40;
            									}
            									else {
HXLINE(  39)										HX_VARI_NAME( int,id6,"id") = rawID;
HXDLIN(  39)										if ((id6 == this->rightStick->rawLeft)) {
HXLINE(  39)											return 41;
            										}
            										else {
HXLINE(  40)											HX_VARI_NAME( int,id7,"id") = rawID;

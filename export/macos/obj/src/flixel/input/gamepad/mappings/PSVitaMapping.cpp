...
HXLINE(  29)				return 14;
            			...
            			break;
            			default:{
HXLINE(  30)				HX_VARI( int,id) = rawID;
HXDLIN(  30)				if ((id == this->leftStick->rawUp)) {
HXLINE(  30)					return 34;
            				}
            				else {
HXLINE(  31)					HX_VARI_NAME( int,id1,"id") = rawID;
HXDLIN(  31)					if ((id1 == this->leftStick->rawDown)) {
HXLINE(  31)						return 34;
            					}
            					else {
HXLINE(  32)						HX_VARI_NAME( int,id2,"id") = rawID;
HXDLIN(  32)						if ((id2 == this->leftStick->rawLeft)) {
HXLINE(  32)							return 37;
            						}
            						else {
HXLINE(  33)							HX_VARI_NAME( int,id3,"id") = rawID;
HXDLIN(  33)							if ((id3 == this->leftStick->rawRight)) {
HXLINE(  33)								return 35;
            							}
            							else {
HXLINE(  34)								HX_VARI_NAME( int,id4,"id") = rawID;
HXDLIN(  34)								if ((id4 == this->rightStick->rawUp)) {
HXLINE(  34)									return 38;
            								}
            								else {
HXLINE(  35)									HX_VARI_NAME( int,id5,"id") = rawID;
HXDLIN(  35)									if ((id5 == this->rightStick->rawDown)) {
HXLINE(  35)										return 40;
            									}
            									else {
HXLINE(  36)										HX_VARI_NAME( int,id6,"id") = rawID;
HXDLIN(  36)										if ((id6 == this->rightStick->rawLeft)) {
HXLINE(  36)											return 41;
            										}
            										else {
HXLINE(  37)											HX_VARI_NAME( int,id7,"id") = rawID;

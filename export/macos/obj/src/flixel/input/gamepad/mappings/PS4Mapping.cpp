...
HXLINE(  49)				return 14;
            			...
            			break;
            			default:{
HXLINE(  50)				HX_VARI( int,id) = rawID;
HXDLIN(  50)				if ((id == this->leftStick->rawUp)) {
HXLINE(  50)					return 34;
            				}
            				else {
HXLINE(  51)					HX_VARI_NAME( int,id1,"id") = rawID;
HXDLIN(  51)					if ((id1 == this->leftStick->rawDown)) {
HXLINE(  51)						return 36;
            					}
            					else {
HXLINE(  52)						HX_VARI_NAME( int,id2,"id") = rawID;
HXDLIN(  52)						if ((id2 == this->leftStick->rawLeft)) {
HXLINE(  52)							return 37;
            						}
            						else {
HXLINE(  53)							HX_VARI_NAME( int,id3,"id") = rawID;
HXDLIN(  53)							if ((id3 == this->leftStick->rawRight)) {
HXLINE(  53)								return 35;
            							}
            							else {
HXLINE(  54)								HX_VARI_NAME( int,id4,"id") = rawID;
HXDLIN(  54)								if ((id4 == this->rightStick->rawUp)) {
HXLINE(  54)									return 38;
            								}
            								else {
HXLINE(  55)									HX_VARI_NAME( int,id5,"id") = rawID;
HXDLIN(  55)									if ((id5 == this->rightStick->rawDown)) {
HXLINE(  55)										return 40;
            									}
            									else {
HXLINE(  56)										HX_VARI_NAME( int,id6,"id") = rawID;
HXDLIN(  56)										if ((id6 == this->rightStick->rawLeft)) {
HXLINE(  56)											return 41;
            										}
            										else {
HXLINE(  57)											HX_VARI_NAME( int,id7,"id") = rawID;

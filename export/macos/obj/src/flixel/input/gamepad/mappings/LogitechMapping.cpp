...
HXLINE(  44)					HX_VARI_NAME( int,id1,"id") = rawID;
HXDLIN(  44)					if ((id1 == this->leftStick->rawDown)) {
HXLINE(  44)						return 36;
            					}
            					else {
HXLINE(  45)						HX_VARI_NAME( int,id2,"id") = rawID;
HXDLIN(  45)						if ((id2 == this->leftStick->rawLeft)) {
HXLINE(  45)							return 37;
            						}
            						else {
HXLINE(  46)							HX_VARI_NAME( int,id3,"id") = rawID;
HXDLIN(  46)							if ((id3 == this->leftStick->rawRight)) {
HXLINE(  46)								return 35;
            							}
            							else {
HXLINE(  47)								HX_VARI_NAME( int,id4,"id") = rawID;
HXDLIN(  47)								if ((id4 == this->rightStick->rawUp)) {
HXLINE(  47)									return 38;
            								}
            								else {
HXLINE(  48)									HX_VARI_NAME( int,id5,"id") = rawID;
HXDLIN(  48)									if ((id5 == this->rightStick->rawDown)) {
HXLINE(  48)										return 40;
            									}
            									else {
HXLINE(  49)										HX_VARI_NAME( int,id6,"id") = rawID;
HXDLIN(  49)										if ((id6 == this->rightStick->rawLeft)) {
HXLINE(  49)											return 41;
            										}
            										else {
HXLINE(  50)											HX_VARI_NAME( int,id7,"id") = rawID;

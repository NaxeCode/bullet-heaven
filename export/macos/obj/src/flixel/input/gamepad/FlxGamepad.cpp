...
HXLINE( 177)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,gamepadButton) = this->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
...
void FlxGamepad_obj::update(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 199)
HXLINE( 201)		HX_VAR(  ::openfl::ui::GameInputControl,control);
HXLINE( 202)		HX_VAR(  ::flixel::input::gamepad::FlxGamepadButton,button);
...
HXLINE( 221)				HX_VARI( Float,value) = ::Math_obj::abs(control->value);
...
HXLINE( 255)				HX_VARI_NAME(  ::flixel::input::gamepad::FlxGamepadButton,button1,"button") = _g3->__get(_g2).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
...
HXLINE( 266)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 266)				_g = (_g + 1);
...
bool FlxGamepad_obj::checkStatusRaw(int RawID,int Status){
            	...
            	HX_STACK_ARG(Status,"Status")
HXLINE( 329)
HXLINE( 330)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = this->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
...
HXLINE( 348)				HX_VARI( int,code) = IDArray->__get(_g);
HXDLIN( 348)				_g = (_g + 1);
...
HXLINE( 371)				HX_VARI( int,code) = IDArray->__get(_g);
HXDLIN( 371)				_g = (_g + 1);
...
int FlxGamepad_obj::firstPressedID(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 451)
HXLINE( 452)		HX_VARI( int,id) = this->firstPressedRawID();
HXLINE( 453)		if ((id < 0)) {
...
HXLINE( 465)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 465)				_g = (_g + 1);
...
int FlxGamepad_obj::firstJustPressedID(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 480)
HXLINE( 481)		HX_VARI( int,id) = this->firstJustPressedRawID();
HXLINE( 482)		if ((id < 0)) {
...
HXLINE( 494)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 494)				_g = (_g + 1);
...
int FlxGamepad_obj::firstJustReleasedID(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 509)
HXLINE( 510)		HX_VARI( int,id) = this->firstJustReleasedRawID();
HXLINE( 511)		if ((id < 0)) {
...
HXLINE( 523)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 523)				_g = (_g + 1);
...
HXLINE( 569)
HXLINE( 570)		HX_VARI( Float,axisValue) = this->getAxisValue(RawAxisID);
...
HXLINE( 579)
HXLINE( 580)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,leftStick) = this->mapping->leftStick;
HXLINE( 581)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,rightStick) = this->mapping->rightStick;
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGamepad_obj,isAxisForAnalogStick,return )
 ...
 ::flixel::input::gamepad::FlxGamepadAnalogStick FlxGamepad_obj::getAnalogStickByAxis(int AxisIndex){
            	...
            	HX_STACK_ARG(AxisIndex,"AxisIndex")
HXLINE( 597)
HXLINE( 598)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,leftStick) = this->mapping->leftStick;
HXLINE( 599)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,rightStick) = this->mapping->rightStick;
...
HXLINE( 659)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 659)				_g = (_g + 1);
...
HXLINE( 677)		HX_VARI( int,numAxis) = this->axis->length;
HXLINE( 679)		{
HXLINE( 679)			int _g = 0;
HXDLIN( 679)			int _g1 = numAxis;
HXDLIN( 679)			while((_g < _g1)){
HXLINE( 679)				_g = (_g + 1);
HXDLIN( 679)				HX_VARI( int,i) = (_g - 1);
...
Float FlxGamepad_obj::getAxisValue(int AxisID){
            	...
            	HX_STACK_ARG(AxisID,"AxisID")
HXLINE( 703)
HXLINE( 704)		HX_VARI( Float,axisValue) = ( (Float)(0) );
...
HXLINE( 756)		HX_VARI( Float,xAxis) = this->getAxisValue(stick->x);
HXLINE( 757)		HX_VARI( Float,yAxis) = this->getAxisValue(stick->y);
...
HXDLIN( 759)		HX_VARI(  ::flixel::math::FlxBasePoint,vector) = point;
HXLINE( 760)		HX_VARI( Float,length) = ::Math_obj::sqrt(((vector->x * vector->x) + (vector->y * vector->y)));
...
Float FlxGamepad_obj::getAnalogAxisValueIndependent(int axisID){
            	...
            	HX_STACK_ARG(axisID,"axisID")
HXLINE( 771)
HXLINE( 772)		HX_VARI( Float,axisValue) = this->getAxisValue(axisID);
...
HXDLIN( 784)		HX_VARI_NAME(  ::flixel::input::gamepad::FlxGamepadAnalogStick,stick5,"stick") = stick;
...
HXLINE( 798)
HXLINE( 799)		HX_VARI( int,digitalButton) = -1;
...
HXLINE( 810)		HX_VARI( Float,threshold) = stick->digitalThreshold;
HXLINE( 811)		HX_VARI( Float,valueSign) = (value * sign);
HXLINE( 812)		HX_VARI( Float,oldValueSign) = (oldValue * sign);
...
HXLINE( 816)			HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,btn) = this->getButton(digitalButton);
...
HXLINE( 822)				HX_VARI_NAME(  ::flixel::input::gamepad::FlxGamepadButton,btn1,"btn") = this->getButton(digitalButton);

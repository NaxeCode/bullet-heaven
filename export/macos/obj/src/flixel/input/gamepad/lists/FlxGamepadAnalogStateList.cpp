...
bool FlxGamepadAnalogStateList_obj::checkXY(int id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE(  56)
HXLINE(  57)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,stick) = this->gamepad->mapping->getAnalogStick(id);
...
HXDLIN(  78)			HX_VAR( bool,yReleased);
...
HXDLIN(  79)			HX_VAR( bool,yJustReleased);
...
HXDLIN(  88)			HX_VAR( bool,xReleased);
...
HXDLIN(  89)			HX_VAR( bool,xJustReleased);
...
bool FlxGamepadAnalogStateList_obj::checkX(int id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 100)
HXLINE( 101)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,stick) = this->gamepad->mapping->getAnalogStick(id);
...
bool FlxGamepadAnalogStateList_obj::checkY(int id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 108)
HXLINE( 109)		HX_VARI(  ::flixel::input::gamepad::FlxGamepadAnalogStick,stick) = this->gamepad->mapping->getAnalogStick(id);

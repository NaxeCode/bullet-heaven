...
HXLINE(  47)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN(  47)				_g = (_g + 1);
...
HXLINE(  62)				HX_VARI(  ::flixel::input::gamepad::FlxGamepadButton,button) = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN(  62)				_g = (_g + 1);

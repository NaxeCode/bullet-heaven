...
HXLINE(  72)		HX_VARI( ::Array< ::Dynamic>,currentOverObjects) = ::Array_obj< ::Dynamic>::__new();
HXLINE(  74)		{
HXLINE(  74)			int _g = 0;
HXDLIN(  74)			::Array< ::Dynamic> _g1 = this->_list;
HXDLIN(  74)			while((_g < _g1->length)){
HXLINE(  74)				HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = _g1->__get(_g).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
HXDLIN(  74)				_g = (_g + 1);
...
HXLINE(  93)				HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,over) = _g3->__get(_g2).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
HXDLIN(  93)				_g2 = (_g2 + 1);
...
HXLINE( 107)				HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,current) = currentOverObjects->__get(_g4).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 127)				HX_VARI_NAME(  ::flixel::input::mouse::FlxMouseEvent,current1,"current") = currentOverObjects->__get(_g5).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 137)				HX_VARI_NAME(  ::flixel::input::mouse::FlxMouseEvent,current2,"current") = currentOverObjects->__get(_g6).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 141)						HX_VARI( int,buttonID) = _g8->__get(_g7);
...
HXLINE( 154)				HX_VARI_NAME(  ::flixel::input::mouse::FlxMouseEvent,current3,"current") = currentOverObjects->__get(_g9).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 166)				HX_VARI_NAME(  ::flixel::input::mouse::FlxMouseEvent,current4,"current") = currentOverObjects->__get(_g10).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 170)						HX_VARI_NAME( int,buttonID1,"buttonID") = _g12->__get(_g11);
...
HXLINE( 191)			HX_VARI( ::Array< ::Dynamic>,previousClickedObjects) = this->_clickList;
...
HXLINE( 198)					HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,down) = _g14->__get(_g13).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 234)				HX_VARI_NAME(  ::flixel::input::mouse::FlxMouseEvent,current5,"current") = currentOverObjects->__get(_g15).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
...
HXLINE( 256)			HX_VARI( int,index) = 0;
...
HXLINE( 285)
HXLINE( 286)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) =  ::flixel::input::mouse::FlxMouseEvent_obj::__alloc( HX_CTX ,object,onMouseDown,onMouseUp,onMouseOver,onMouseOut,mouseChildren,mouseEnabled,pixelPerfect,mouseButtons);
...
HXLINE( 297)				HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = _g1->__get(_g).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
HXDLIN( 297)				_g = (_g + 1);
...
HXLINE( 315)				HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = _g1->__get(_g).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
HXDLIN( 315)				_g = (_g + 1);
...
void FlxMouseEventManager_obj::reorder(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 335)
HXLINE( 336)		HX_VARI( ::Array< ::Dynamic>,orderedObjects) = ::Array_obj< ::Dynamic>::__new();
...
void FlxMouseEventManager_obj::setMouseDownCallback( ::Dynamic object, ::Dynamic onMouseDown){
            	...
            	HX_STACK_ARG(onMouseDown,"onMouseDown")
HXLINE( 353)
HXLINE( 354)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setMouseUpCallback( ::Dynamic object, ::Dynamic onMouseUp){
            	...
            	HX_STACK_ARG(onMouseUp,"onMouseUp")
HXLINE( 369)
HXLINE( 370)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setMouseClickCallback( ::Dynamic object, ::Dynamic onMouseClick){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(object,"object")
            	HX_STACK_ARG(onMouseClick,"onMouseClick")
HXLINE( 386)
HXLINE( 387)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setMouseDoubleClickCallback( ::Dynamic object, ::Dynamic onMouseDoubleClick){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(object,"object")
            	HX_STACK_ARG(onMouseDoubleClick,"onMouseDoubleClick")
HXLINE( 403)
HXLINE( 404)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setMouseOverCallback( ::Dynamic object, ::Dynamic onMouseOver){
            	...
            	HX_STACK_ARG(onMouseOver,"onMouseOver")
HXLINE( 419)
HXLINE( 420)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setMouseOutCallback( ::Dynamic object, ::Dynamic onMouseOut){
            	...
            	HX_STACK_ARG(onMouseOut,"onMouseOut")
HXLINE( 435)
HXLINE( 436)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setMouseMoveCallback( ::Dynamic object, ::Dynamic onMouseMove){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(object,"object")
            	HX_STACK_ARG(onMouseMove,"onMouseMove")
HXLINE( 452)
HXLINE( 453)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setMouseWheelCallback( ::Dynamic object, ::Dynamic onMouseWheel){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(object,"object")
            	HX_STACK_ARG(onMouseWheel,"onMouseWheel")
HXLINE( 469)
HXLINE( 470)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setObjectMouseEnabled( ::Dynamic object,bool MouseEnabled){
            	...
            	HX_STACK_ARG(MouseEnabled,"MouseEnabled")
HXLINE( 484)
HXLINE( 485)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
bool FlxMouseEventManager_obj::isObjectMouseEnabled( ::Dynamic object){
            	...
            	HX_STACK_ARG(object,"object")
HXLINE( 497)
HXLINE( 498)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setObjectMouseChildren( ::Dynamic object,bool mouseChildren){
            	...
            	HX_STACK_ARG(mouseChildren,"mouseChildren")
HXLINE( 516)
HXLINE( 517)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
HXLINE( 530)				HX_VARI( int,index) = 0;
...
bool FlxMouseEventManager_obj::isObjectMouseChildren( ::Dynamic object){
            	...
            	HX_STACK_ARG(object,"object")
HXLINE( 544)
HXLINE( 545)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
void FlxMouseEventManager_obj::setObjectMouseButtons( ::Dynamic object,::Array< int > mouseButtons){
            	...
            	HX_STACK_ARG(mouseButtons,"mouseButtons")
HXLINE( 561)
HXLINE( 562)		HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(object,null());
...
HXDLIN( 573)			HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 573)			_g = (_g + 1);
HXLINE( 575)			HX_VARI_NAME(  ::flixel::group::FlxTypedGroup,group1,"group") = ::flixel::group::FlxTypedGroup_obj::resolveGroup(( ( ::flixel::FlxBasic)(basic) ));
...
HXLINE( 582)				HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = this->get(( ( ::flixel::FlxObject)(basic) ),null());
...
HXLINE( 599)				HX_VARI(  ::flixel::input::mouse::FlxMouseEvent,event) = list->__get(_g).StaticCast<  ::flixel::input::mouse::FlxMouseEvent >();
HXDLIN( 599)				_g = (_g + 1);
...
HXLINE( 635)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 635)				_g = (_g + 1);

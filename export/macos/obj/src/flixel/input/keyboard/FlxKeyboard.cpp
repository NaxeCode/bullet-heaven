...
HXLINE(  32)		{
HXLINE(  32)			HX_VARI(  ::Dynamic,code) = ::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::fromStringMap->iterator();
HXDLIN(  32)			while(( (bool)(code->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  32)				HX_VARI_NAME( int,code1,"code") = ( (int)(code->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE(  36)					HX_VARI(  ::flixel::input::FlxInput,input) =  ::flixel::input::FlxInput_obj::__alloc( HX_CTX ,code1);
...
int FlxKeyboard_obj::resolveKeyCode( ::openfl::events::KeyboardEvent e){
            	...
            	HX_STACK_ARG(e,"e")
HXLINE( 124)
HXLINE( 128)		HX_VARI(  ::Dynamic,code) = this->_nativeCorrection->get(((e->charCode + HX_("_",5f,00,00,00)) + e->keyCode));
...
::Array< ::Dynamic> FlxKeyboard_obj::record(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 142)
HXLINE( 143)		HX_VARI( ::Array< ::Dynamic>,data) = null();
HXLINE( 145)		{
HXLINE( 145)			int _g = 0;
HXDLIN( 145)			::Array< ::Dynamic> _g1 = this->_keyListArray;
HXDLIN( 145)			while((_g < _g1->length)){
HXLINE( 145)				HX_VARI(  ::flixel::input::FlxInput,key) = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
HXDLIN( 145)				_g = (_g + 1);
...
HXLINE( 171)
HXLINE( 172)		HX_VARI( int,i) = 0;
HXLINE( 173)		HX_VARI( int,l) = Record->length;
HXLINE( 175)		while((i < l)){
HXLINE( 177)			i = (i + 1);
HXDLIN( 177)			HX_VARI(  ::flixel::_hx_system::replay::CodeValuePair,o) = Record->__get((i - 1)).StaticCast<  ::flixel::_hx_system::replay::CodeValuePair >();
HXLINE( 178)			HX_VARI(  ::flixel::input::FlxInput,o2) = ( ( ::flixel::input::FlxInput)(this->_keyListMap->get(o->code)) );

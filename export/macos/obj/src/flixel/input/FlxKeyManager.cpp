...
void FlxKeyManager_obj::__construct( ::Dynamic createKeyList){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(createKeyList,"createKeyList")
HXLINE(  14)
...
HXLINE( 100)				HX_VARI(  ::flixel::input::FlxInput,key) = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
HXDLIN( 100)				_g = (_g + 1);
...
HXLINE( 117)				HX_VARI(  ::flixel::input::FlxInput,key) = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
HXDLIN( 117)				_g = (_g + 1);
...
HXLINE( 134)				HX_VARI(  ::flixel::input::FlxInput,key) = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
HXDLIN( 134)				_g = (_g + 1);
...
::Array< ::Dynamic> FlxKeyManager_obj::getIsDown(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 213)
HXLINE( 214)		HX_VARI( ::Array< ::Dynamic>,keysDown) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 216)		{
HXLINE( 216)			int _g = 0;
HXDLIN( 216)			::Array< ::Dynamic> _g1 = this->_keyListArray;
HXDLIN( 216)			while((_g < _g1->length)){
HXLINE( 216)				HX_VARI(  ::flixel::input::FlxInput,key) = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
HXDLIN( 216)				_g = (_g + 1);
...
HXDLIN( 240)			HX_VARI(  ::flixel::input::FlxInput,key) = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
HXDLIN( 240)			_g = (_g + 1);
...
HXDLIN( 265)			HX_VARI(  ::flixel::input::FlxInput,key) = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
HXDLIN( 265)			_g = (_g + 1);
...
HXLINE( 288)				HX_VARI(  ::Dynamic,code) = KeyArray->__get(_g);
HXDLIN( 288)				_g = (_g + 1);
...
HXLINE( 301)
HXLINE( 302)		HX_VARI( int,c) = this->resolveKeyCode(event);
...
void FlxKeyManager_obj::onKeyDown( ::openfl::events::KeyboardEvent event){
            	...
            	HX_STACK_ARG(event,"event")
HXLINE( 315)
HXLINE( 316)		HX_VARI( int,c) = this->resolveKeyCode(event);
...
void FlxKeyManager_obj::handlePreventDefaultKeys(int keyCode, ::openfl::events::KeyboardEvent event){
            	...
            	HX_STACK_ARG(event,"event")
HXLINE( 326)
HXLINE( 327)		HX_VARI(  ::flixel::input::FlxInput,key) = ( ( ::flixel::input::FlxInput)(this->_keyListMap->get(keyCode)) );
...
HXLINE( 350)			HX_VARI( int,code) = this->resolveKeyCode(Event);
HXLINE( 351)			{
HXLINE( 351)				int _g = 0;
HXDLIN( 351)				while((_g < KeyArray->get_length())){
HXLINE( 351)					HX_VARI(  ::Dynamic,key) = KeyArray->__get(_g);
HXDLIN( 351)					_g = (_g + 1);
...
HXLINE( 371)
HXLINE( 372)		HX_VARI(  ::flixel::input::FlxInput,key) = ( ( ::flixel::input::FlxInput)(this->_keyListMap->get(KeyCode)) );

...
HXLINE( 115)			HX_VARI( int,i) = 0;
HXLINE( 116)			HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
HXLINE( 134)
HXLINE( 135)		HX_VARI( int,i) = 0;
HXLINE( 136)		HX_VARI(  ::flixel::FlxBasic,basic) = null();
...
void FlxTypedGroup_obj::draw(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 153)
HXLINE( 154)		HX_VARI( ::Array< ::Dynamic>,oldDefaultCameras) = ::flixel::FlxCamera_obj::_defaultCameras;
...
HXLINE( 160)				HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 160)				_g = (_g + 1);
...
HXLINE( 192)		HX_VARI( int,index) = this->getFirstNull();
...
HXLINE( 317)			HX_VARI(  ::Dynamic,basic) = this->members->__get(this->_marker++);
...
HXLINE( 329)		HX_VARI_NAME(  ::Dynamic,basic1,"basic") = this->getFirstAvailable(objectClass,force);
...
HXLINE( 353)		HX_VARI( int,index) = this->members->indexOf(basic,null());
...
HXLINE( 381)
HXLINE( 382)		HX_VARI( int,index) = this->members->indexOf(oldObject,null());
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTypedGroup_obj,getFirst,return )
 ...
 ::Dynamic FlxTypedGroup_obj::getFirstHelper( ::Dynamic func){
            	...
            	HX_STACK_ARG(func,"func")
HXLINE( 423)
HXLINE( 424)		HX_VARI(  ::Dynamic,result) = null();
HXLINE( 425)		{
HXLINE( 425)			int _g = 0;
HXDLIN( 425)			::cpp::VirtualArray _g1 = this->members;
HXDLIN( 425)			while((_g < _g1->get_length())){
HXLINE( 425)				HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 425)				_g = (_g + 1);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTypedGroup_obj,getFirstHelper,return )
 ...
 ::Dynamic FlxTypedGroup_obj::getLast( ::Dynamic func){
            	...
            	HX_STACK_ARG(func,"func")
HXLINE( 442)
HXLINE( 443)		HX_VARI(  ::Dynamic,result) = null();
HXLINE( 444)		HX_VARI( int,i) = this->members->get_length();
HXLINE( 445)		while(true){
HXLINE( 445)			i = (i - 1);
HXDLIN( 445)			if (!(((i + 1) > 0))) {
HXLINE( 445)				goto _hx_goto_18;
            			}
HXLINE( 447)			HX_VARI(  ::Dynamic,basic) = this->members->__get(i);
...
int FlxTypedGroup_obj::getFirstIndex( ::Dynamic func){
            	...
            	HX_STACK_ARG(func,"func")
HXLINE( 463)
HXLINE( 464)		HX_VARI( int,result) = -1;
HXLINE( 465)		{
...
HXDLIN( 465)				HX_VARI( int,i) = _g_key;
HXDLIN( 465)				HX_VARI(  ::Dynamic,basic) = _g_value;
...
int FlxTypedGroup_obj::getLastIndex( ::Dynamic func){
            	...
            	HX_STACK_ARG(func,"func")
HXLINE( 482)
HXLINE( 483)		HX_VARI( int,result) = -1;
HXLINE( 484)		HX_VARI( int,i) = this->members->get_length();
HXLINE( 485)		while(true){
HXLINE( 485)			i = (i - 1);
HXDLIN( 485)			if (!(((i + 1) > 0))) {
HXLINE( 485)				goto _hx_goto_22;
            			}
HXLINE( 487)			HX_VARI(  ::Dynamic,basic) = this->members->__get(i);
...
HXLINE( 504)				HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 504)				_g = (_g + 1);
...
HXLINE( 519)				HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 519)				_g = (_g + 1);
...
HXLINE( 538)				HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 538)				_g = (_g + 1);
...
HXLINE( 671)				HX_VARI(  ::Dynamic,member) = _g1->__get(_g);
HXDLIN( 671)				_g = (_g + 1);
...
HXDLIN( 687)			HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 687)			_g = (_g + 1);
...
HXDLIN( 711)			HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 711)			_g = (_g + 1);
...
HXDLIN( 752)			HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 752)			_g = (_g + 1);
HXLINE( 754)			if (::hx::IsNotNull( basic )) {
HXLINE( 756)				if (recurse) {
HXLINE( 758)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(( ( ::flixel::FlxBasic)(basic) ));
...
HXDLIN( 776)			HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 776)			_g = (_g + 1);
...
HXLINE( 782)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(( ( ::flixel::FlxBasic)(basic) ));
...
HXDLIN( 800)			HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 800)			_g = (_g + 1);
...
HXLINE( 806)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(( ( ::flixel::FlxBasic)(basic) ));
...
HXDLIN( 824)			HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 824)			_g = (_g + 1);
...
HXLINE( 830)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(( ( ::flixel::FlxBasic)(basic) ));
...
HXDLIN( 849)			HX_VARI(  ::Dynamic,basic) = _g1->__get(_g);
HXDLIN( 849)			_g = (_g + 1);
HXLINE( 851)			if (::hx::IsNotNull( basic )) {
HXLINE( 853)				if (recurse) {
HXLINE( 855)					HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(( ( ::flixel::FlxBasic)(basic) ));
...
HXLINE( 880)			HX_VARI(  ::Dynamic,basic) = this->members->splice((this->maxSize - 1),1)->__get(0);

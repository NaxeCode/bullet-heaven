...
HXLINE( 624)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 624)				_g = (_g + 1);
...
HXLINE( 643)		HX_VARI( int,numProps) = FunctionArray->length;
HXLINE( 644)		if ((numProps > ValueArray->length)) {
HXLINE( 645)			return;
            		}
HXLINE( 647)		HX_VAR(  ::Dynamic,lambda);
HXLINE( 648)		{
HXLINE( 648)			int _g = 0;
HXDLIN( 648)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 648)			while((_g < _g1->length)){
HXLINE( 648)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 648)				_g = (_g + 1);
...
HXDLIN( 652)						HX_VARI( int,i) = (_g2 - 1);
...
HXLINE( 124)		this->super::destroy();
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 133)
HXLINE( 134)		HX_VARI(  ::flixel::group::FlxTypedSpriteGroup,newGroup) =  ::flixel::group::FlxTypedSpriteGroup_obj::__alloc( HX_CTX ,this->x,this->y,this->group->maxSize);
HXLINE( 135)		{
HXLINE( 135)			int _g = 0;
HXDLIN( 135)			::cpp::VirtualArray _g1 = this->group->members;
HXDLIN( 135)			while((_g < _g1->get_length())){
HXLINE( 135)				HX_VARI(  ::Dynamic,sprite) = _g1->__get(_g);
HXDLIN( 135)				_g = (_g + 1);
...
HXLINE( 153)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 153)				_g = (_g + 1);
...
bool FlxTypedSpriteGroup_obj::overlapsPoint( ::flixel::math::FlxBasePoint point,::hx::Null< bool >  __o_InScreenSpace, ::flixel::FlxCamera Camera){
            	...
            	HX_STACK_ARG(Camera,"Camera")
HXLINE( 171)
HXLINE( 172)		HX_VARI( bool,result) = false;
HXLINE( 173)		{
HXLINE( 173)			int _g = 0;
HXDLIN( 173)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 173)			while((_g < _g1->length)){
HXLINE( 173)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 173)				_g = (_g + 1);
...
bool FlxTypedSpriteGroup_obj::pixelsOverlapPoint( ::flixel::math::FlxBasePoint point,::hx::Null< int >  __o_Mask, ::flixel::FlxCamera Camera){
            	...
            	HX_STACK_ARG(Camera,"Camera")
HXLINE( 194)
HXLINE( 195)		HX_VARI( bool,result) = false;
HXLINE( 196)		{
HXLINE( 196)			int _g = 0;
HXDLIN( 196)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 196)			while((_g < _g1->length)){
HXLINE( 196)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 196)				_g = (_g + 1);
...
HXLINE( 235)
HXLINE( 236)		HX_VARI( int,Color) = _tmp_Color;
HXDLIN( 236)		HX_VARI( int,NewColor) = _tmp_NewColor;
HXDLIN( 236)		HX_VARI( ::Array< ::Dynamic>,positions) = null();
HXLINE( 237)		if (FetchPositions) {
HXLINE( 239)			positions = ::Array_obj< ::Dynamic>::__new();
            		}
HXLINE( 242)		HX_VAR( ::Array< ::Dynamic>,spritePositions);
HXLINE( 243)		{
HXLINE( 243)			int _g = 0;
HXDLIN( 243)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 243)			while((_g < _g1->length)){
HXLINE( 243)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 243)				_g = (_g + 1);
...
void FlxTypedSpriteGroup_obj::preAdd( ::Dynamic Sprite){
            	...
            	HX_STACK_ARG(Sprite,"Sprite")
HXLINE( 292)
HXLINE( 293)		HX_VARI(  ::flixel::FlxSprite,sprite) = ( ( ::flixel::FlxSprite)(Sprite) );
...
HXLINE( 342)
HXLINE( 343)		HX_VARI(  ::flixel::FlxSprite,sprite) = ( ( ::flixel::FlxSprite)(Sprite) );
...
HXLINE( 569)				HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 569)				_g = (_g + 1);
...
void FlxTypedSpriteGroup_obj::setPosition(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y){
            	...
            	HX_STACK_ARG(Y,"Y")
HXLINE( 598)
HXLINE( 600)		HX_VARI( Float,dx) = (X - this->x);
HXLINE( 601)		HX_VARI( Float,dy) = (Y - this->y);
...
HXLINE( 732)			HX_VAR( Float,factor);
...
int FlxTypedSpriteGroup_obj::set_facing(int _tmp_Value){
            	...
            	HX_STACK_THIS(this)
HXLINE( 742)
HXLINE( 743)		HX_VARI( int,Value) = _tmp_Value;
...
int FlxTypedSpriteGroup_obj::set_color(int _tmp_Value){
            	...
            	HX_STACK_THIS(this)
HXLINE( 784)
HXLINE( 785)		HX_VARI( int,Value) = _tmp_Value;
...
Float FlxTypedSpriteGroup_obj::findMinXHelper(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 839)
HXLINE( 840)		HX_VARI( Float,value) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 841)		{
HXLINE( 841)			int _g = 0;
HXDLIN( 841)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 841)			while((_g < _g1->length)){
HXLINE( 841)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 841)				_g = (_g + 1);
HXLINE( 843)				if (::hx::IsNull( member )) {
HXLINE( 844)					continue;
            				}
HXLINE( 846)				HX_VAR( Float,minX);
...
Float FlxTypedSpriteGroup_obj::findMaxXHelper(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 870)
HXLINE( 871)		HX_VARI( Float,value) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 872)		{
HXLINE( 872)			int _g = 0;
HXDLIN( 872)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 872)			while((_g < _g1->length)){
HXLINE( 872)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 872)				_g = (_g + 1);
HXLINE( 874)				if (::hx::IsNull( member )) {
HXLINE( 875)					continue;
            				}
HXLINE( 877)				HX_VAR( Float,maxX);
...
Float FlxTypedSpriteGroup_obj::findMinYHelper(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 917)
HXLINE( 918)		HX_VARI( Float,value) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 919)		{
HXLINE( 919)			int _g = 0;
HXDLIN( 919)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 919)			while((_g < _g1->length)){
HXLINE( 919)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 919)				_g = (_g + 1);
HXLINE( 921)				if (::hx::IsNull( member )) {
HXLINE( 922)					continue;
            				}
HXLINE( 924)				HX_VAR( Float,minY);
...
Float FlxTypedSpriteGroup_obj::findMaxYHelper(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 948)
HXLINE( 949)		HX_VARI( Float,value) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 950)		{
HXLINE( 950)			int _g = 0;
HXDLIN( 950)			::Array< ::Dynamic> _g1 = this->_sprites;
HXDLIN( 950)			while((_g < _g1->length)){
HXLINE( 950)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 950)				_g = (_g + 1);
HXLINE( 952)				if (::hx::IsNull( member )) {
HXLINE( 953)					continue;
            				}
HXLINE( 955)				HX_VAR( Float,maxY);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTypedSpriteGroup_obj,scrollFactorCallback,(void))
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::loadGraphicFromSprite( ::flixel::FlxSprite Sprite){
            	...
            	HX_STACK_ARG(Sprite,"Sprite")
HXLINE(1099)
HXDLIN(1099)		HX_STACK_DO_THROW(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91));
...
HXDLIN(1111)		return ::hx::ObjectPtr<OBJ_>(this);
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::loadRotatedGraphic( ::Dynamic Graphic,::hx::Null< int >  __o_Rotations,::hx::Null< int >  __o_Frame,::hx::Null< bool >  __o_AntiAliasing,::hx::Null< bool >  __o_AutoBuffer,::String Key){
            	...
            	HX_STACK_ARG(Key,"Key")
HXLINE(1122)
HXDLIN(1122)		HX_STACK_DO_THROW(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91));
HXDLIN(1122)		return null();
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::makeGraphic(int Width,int Height,::hx::Null< int >  __o__tmp_Color,::hx::Null< bool >  __o_Unique,::String Key){
            	...
            	HX_STACK_ARG(Key,"Key")
HXLINE(1134)
HXDLIN(1134)		HX_VARI( int,Color) = _tmp_Color;
HXDLIN(1134)		HX_STACK_DO_THROW(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91));

...
HXLINE( 357)
HXLINE( 358)		HX_VARI(  ::flixel::graphics::atlas::FlxNode,buttonNode) = atlas->addNode(this->graphic->bitmap,this->graphic->key);
HXLINE( 359)		HX_VARI( bool,result) = ::hx::IsNotNull( buttonNode );
HXLINE( 361)		if (::hx::IsNotNull( buttonNode )) {
HXLINE( 363)			HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,buttonFrames) = ( ( ::flixel::graphics::frames::FlxTileFrames)(this->frames) );
...
HXDLIN( 364)			HX_VARI(  ::flixel::math::FlxBasePoint,tileSize) = point;
HXLINE( 365)			HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,tileFrames) = buttonNode->getTileFrames(tileSize,null(),null());
...
HXLINE( 371)			HX_VARI(  ::flixel::graphics::atlas::FlxNode,labelNode) = atlas->addNode(( ( ::flixel::FlxSprite)(this->label) )->graphic->bitmap,( ( ::flixel::FlxSprite)(this->label) )->graphic->key);
...
void FlxTypedButton_obj::updateButton(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 386)
HXLINE( 388)		HX_VARI( bool,overlapFound) = this->checkMouseOverlap();
...
bool FlxTypedButton_obj::checkMouseOverlap(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 404)
HXLINE( 405)		HX_VARI( bool,overlap) = false;
HXLINE( 407)		{
HXLINE( 407)			int _g = 0;
HXDLIN( 407)			::Array< ::Dynamic> _g1 = this->get_cameras();
HXDLIN( 407)			while((_g < _g1->length)){
HXLINE( 407)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 407)				_g = (_g + 1);
HXLINE( 409)				{
HXLINE( 409)					int _g2 = 0;
HXDLIN( 409)					::Array< int > _g3 = this->mouseButtons;
HXDLIN( 409)					while((_g2 < _g3->length)){
HXLINE( 409)						HX_VARI( int,buttonID) = _g3->__get(_g2);
HXDLIN( 409)						_g2 = (_g2 + 1);
HXLINE( 411)						HX_VARI(  ::flixel::input::mouse::FlxMouseButton,button) = ::flixel::input::mouse::FlxMouseButton_obj::getByID(buttonID);
...
bool FlxTypedButton_obj::checkTouchOverlap(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 423)
HXLINE( 424)		HX_VARI( bool,overlap) = false;

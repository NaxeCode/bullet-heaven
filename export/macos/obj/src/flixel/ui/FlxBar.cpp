...
HXDLIN( 355)			HX_VARI_NAME( ::String,emptyKey5,"emptyKey") = (emptyKey + (emptyKey4 + ::StringTools_obj::hex((empty & 255),2)));
...
HXLINE( 361)				HX_VARI(  ::openfl::display::BitmapData,emptyBar) = null();
...
HXDLIN( 408)			HX_VARI_NAME( ::String,filledKey5,"filledKey") = (filledKey + (filledKey4 + ::StringTools_obj::hex((fill & 255),2)));
...
HXLINE( 414)				HX_VARI(  ::openfl::display::BitmapData,filledBar) = null();
...
HXLINE( 484)			HX_VARI( ::String,emptyKey) = ((((HX_("Gradient:",2a,58,e6,6e) + this->barWidth) + HX_("x",78,00,00,00)) + this->barHeight) + HX_(",colors:[",bd,d0,85,cb));
HXLINE( 485)			{
HXLINE( 485)				int _g = 0;
HXDLIN( 485)				while((_g < empty->length)){
HXLINE( 485)					HX_VARI( int,col) = empty->__get(_g);
HXDLIN( 485)					_g = (_g + 1);
...
HXLINE( 498)				HX_VARI(  ::openfl::display::BitmapData,emptyBar) = null();
...
HXLINE( 549)			HX_VARI( ::String,filledKey) = ((((HX_("Gradient:",2a,58,e6,6e) + this->barWidth) + HX_("x",78,00,00,00)) + this->barHeight) + HX_(",colors:[",bd,d0,85,cb));
HXLINE( 550)			{
HXLINE( 550)				int _g = 0;
HXDLIN( 550)				while((_g < fill->length)){
HXLINE( 550)					HX_VARI( int,col) = fill->__get(_g);
HXDLIN( 550)					_g = (_g + 1);
...
HXLINE( 563)				HX_VARI(  ::openfl::display::BitmapData,filledBar) = null();
...
HXLINE( 630)			HX_VARI(  ::flixel::graphics::FlxGraphic,emptyGraphic) = ::flixel::FlxG_obj::bitmap->add(empty,null(),null());
...
HXLINE( 672)			HX_VARI(  ::flixel::graphics::FlxGraphic,filledGraphic) = ::flixel::FlxG_obj::bitmap->add(fill,null(),null());
...
HXDLIN( 752)		HX_VARI_NAME( Float,fraction1,"fraction") = ((fraction - this->min) / this->range);
HXLINE( 753)		HX_VARI( Float,percent) = (fraction1 * ( (Float)(this->_maxPercent) ));
HXLINE( 754)		HX_VAR( Float,maxScale);
...
HXLINE( 755)		HX_VARI( Float,scaleInterval) = (maxScale / ( (Float)(this->numDivisions) ));
HXLINE( 756)		HX_VARI( Float,interval) = ( (Float)(::Math_obj::round((( (Float)(::Std_obj::_hx_int(((fraction1 * maxScale) / scaleInterval))) ) * scaleInterval))) );
...
HXLINE( 853)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 853)				_g = (_g + 1);

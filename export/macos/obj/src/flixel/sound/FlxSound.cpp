...
HXLINE( 290)		HX_VARI( Float,radialMultiplier) = ((Float)1.0);
HXLINE( 293)		if (::hx::IsNotNull( this->_target )) {
HXLINE( 295)			HX_VARI(  ::flixel::math::FlxBasePoint,targetPosition) = this->_target->getPosition(null());
...
HXLINE( 302)				HX_VARI( Float,d) = ((this->x - this->_target->x) / this->_radius);
...
HXLINE( 387)		HX_VARI( ::Array< ::Dynamic>,loadCallback) = ::Array_obj< ::Dynamic>::__new(1)->init(0,null());
...
HXLINE( 710)			HX_VARI(  ::flixel::sound::FlxSoundGroup,oldGroup) = this->group;

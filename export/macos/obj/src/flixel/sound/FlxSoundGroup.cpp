...
HXDLIN(  64)			HX_VARI(  ::flixel::sound::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::sound::FlxSound >();
HXDLIN(  64)			_g = (_g + 1);
...
HXDLIN(  74)			HX_VARI(  ::flixel::sound::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::sound::FlxSound >();
HXDLIN(  74)			_g = (_g + 1);
...
HXLINE(  81)				HX_VARI(  ::flixel::sound::FlxSound,sound) = _g1->__get(_g).StaticCast<  ::flixel::sound::FlxSound >();
HXDLIN(  81)				_g = (_g + 1);

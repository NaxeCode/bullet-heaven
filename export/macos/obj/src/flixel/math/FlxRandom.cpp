...
HXDLIN( 267)						HX_VARI( int,i) = (_g1 - 1);
...
HXDLIN( 291)					HX_VARI_NAME( int,i1,"i") = (_g4 - 1);
...
HXLINE(  87)					HX_VARI( int,result) = 0;
HXLINE(  89)					do {
...
Float FlxRandom_obj::_hx_float(::hx::Null< Float >  __o_Min,::hx::Null< Float >  __o_Max,::Array< Float > Excludes){
            	...
            	HX_STACK_ARG(Excludes,"Excludes")
HXLINE( 110)
HXLINE( 111)		HX_VARI( Float,result) = ( (Float)(0) );
...
HXLINE( 170)			HX_VARI( Float,scale) = (StdDev * this->_floatNormalRho);
HXLINE( 171)			return (Mean + (scale * this->_floatNormalRand2));
            		}
HXLINE( 174)		this->_hasFloatNormalSpare = true;
HXLINE( 176)		HX_VARI( Float,theta) = (this->_twoPI * ((this->internalSeed = ::hx::Mod((this->internalSeed * ((Float)48271.0)),(int)2147483647)) / ( (Float)((int)2147483647) )));
...
HXLINE( 178)		HX_VARI_NAME( Float,scale1,"scale") = (StdDev * this->_floatNormalRho);
...
int FlxRandom_obj::weightedPick(::Array< Float > WeightsArray){
            	...
            	HX_STACK_ARG(WeightsArray,"WeightsArray")
HXLINE( 222)
HXLINE( 223)		HX_VARI( Float,totalWeight) = ( (Float)(0) );
HXLINE( 224)		HX_VARI( int,pick) = 0;
HXLINE( 226)		{
HXLINE( 226)			int _g = 0;
...
HXDLIN( 233)				HX_VARI_NAME( int,i1,"i") = (_g1 - 1);

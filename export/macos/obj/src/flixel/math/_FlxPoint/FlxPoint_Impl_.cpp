...
HXDLIN( 113)		HX_VARI(  ::flixel::math::FlxBasePoint,result) = point;
...
HXDLIN( 126)		HX_VARI(  ::flixel::math::FlxBasePoint,result) = point;
...
HXDLIN( 140)		HX_VARI(  ::flixel::math::FlxBasePoint,result) = point;
...
HXDLIN( 153)		HX_VARI(  ::flixel::math::FlxBasePoint,result) = point;
...
HXDLIN( 197)		HX_VARI(  ::flixel::math::FlxBasePoint,result) = point;
...
HXDLIN( 209)		HX_VARI(  ::flixel::math::FlxBasePoint,result) = point;
...
HXDLIN( 221)		HX_VARI(  ::flixel::math::FlxBasePoint,result) = point;
...
Float FlxPoint_Impl__obj::distanceTo( ::flixel::math::FlxBasePoint this1, ::flixel::math::FlxBasePoint point){
            	...
            	HX_STACK_ARG(point,"point")
HXLINE( 627)
HXLINE( 628)		HX_VARI( Float,dx) = (this1->x - point->x);
HXLINE( 629)		HX_VARI( Float,dy) = (this1->y - point->y);
...
Float FlxPoint_Impl__obj::angleBetween( ::flixel::math::FlxBasePoint this1, ::flixel::math::FlxBasePoint point){
            	...
            	HX_STACK_ARG(point,"point")
HXLINE( 701)
HXLINE( 702)		HX_VARI( Float,x) = (point->x - this1->x);
HXLINE( 703)		HX_VARI( Float,y) = (point->y - this1->y);
HXLINE( 704)		HX_VARI( Float,angle) = ( (Float)(0) );
...
HXLINE( 708)			HX_VARI( Float,c1) = (::Math_obj::PI * ((Float)0.25));
HXLINE( 709)			HX_VARI( Float,c2) = (( (Float)(3) ) * c1);
HXLINE( 710)			HX_VAR( Float,ay);
HXDLIN( 710)			if ((y < 0)) {
HXLINE( 710)				ay = -(y);
            			}
            			else {
...
HXLINE( 742)
HXLINE( 743)		HX_VARI( Float,x1) = (((this1->x * matrix->a) + (this1->y * matrix->c)) + matrix->tx);
HXLINE( 744)		HX_VARI( Float,y1) = (((this1->x * matrix->b) + (this1->y * matrix->d)) + matrix->ty);
...
Float FlxPoint_Impl__obj::dotProduct( ::flixel::math::FlxBasePoint this1, ::flixel::math::FlxBasePoint p){
            	...
            	HX_STACK_ARG(p,"p")
HXLINE( 767)
HXLINE( 768)		HX_VARI( Float,dp) = ((this1->x * p->x) + (this1->y * p->y));
...
HXDLIN( 793)		HX_VARI(  ::flixel::math::FlxBasePoint,normalized) = ::flixel::math::_FlxPoint::FlxPoint_Impl__obj::normalize(p1);
...
Float FlxPoint_Impl__obj::crossProductLength( ::flixel::math::FlxBasePoint this1, ::flixel::math::FlxBasePoint p){
            	...
            	HX_STACK_ARG(p,"p")
HXLINE( 816)
HXLINE( 817)		HX_VARI( Float,cp) = ((this1->x * p->y) - (this1->y * p->x));
...
bool FlxPoint_Impl__obj::isParallel( ::flixel::math::FlxBasePoint this1, ::flixel::math::FlxBasePoint p){
            	...
            	HX_STACK_ARG(p,"p")
HXLINE( 841)
HXLINE( 842)		HX_VARI( bool,pp) = (::Math_obj::abs(((this1->x * p->y) - (this1->y * p->x))) < ((Float)9.99999999999999841e-15));
...
HXLINE( 905)
HXLINE( 906)		HX_VARI( Float,s) = ::Math_obj::sin(rads);
HXLINE( 907)		HX_VARI( Float,c) = ::Math_obj::cos(rads);
HXLINE( 908)		HX_VARI( Float,tempX) = this1->x;
...
HXLINE( 935)
HXLINE( 936)		HX_VARI( Float,tempX) = this1->x;
...
HXLINE(1022)
HXLINE(1023)		HX_VARI( Float,dp) = ((this1->x * p->x) + (this1->y * p->y));
HXLINE(1024)		HX_VARI( Float,lenSq) = ((p->x * p->x) + (p->y * p->y));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxPoint_Impl__obj,projectToNormalized,return )
 ...
 ::flixel::math::FlxBasePoint FlxPoint_Impl__obj::projectToNormalizedWeak( ::flixel::math::FlxBasePoint this1, ::flixel::math::FlxBasePoint p, ::flixel::math::FlxBasePoint proj){
            	...
            	HX_STACK_ARG(proj,"proj")
HXLINE(1059)
HXLINE(1060)		HX_VARI( Float,dp) = ((this1->x * p->x) + (this1->y * p->y));
...
Float FlxPoint_Impl__obj::perpProduct( ::flixel::math::FlxBasePoint this1, ::flixel::math::FlxBasePoint p){
            	...
            	HX_STACK_ARG(p,"p")
HXLINE(1074)
HXLINE(1075)		HX_VARI( Float,pp) = ((this1->y * p->x) + (-(this1->x) * p->y));
...
Float FlxPoint_Impl__obj::radiansBetween( ::flixel::math::FlxBasePoint this1, ::flixel::math::FlxBasePoint p){
            	...
            	HX_STACK_ARG(p,"p")
HXLINE(1210)
HXLINE(1211)		HX_VARI( Float,rads) = ::Math_obj::acos((((this1->x * p->x) + (this1->y * p->y)) / (::Math_obj::sqrt(((this1->x * this1->x) + (this1->y * this1->y))) * ::Math_obj::sqrt(((p->x * p->x) + (p->y * p->y))))));
...
int FlxPoint_Impl__obj::sign( ::flixel::math::FlxBasePoint this1, ::flixel::math::FlxBasePoint a, ::flixel::math::FlxBasePoint b){
            	...
            	HX_STACK_ARG(b,"b")
HXLINE(1234)
HXLINE(1235)		HX_VARI( Float,signFl) = (((a->x - this1->x) * (b->y - this1->y)) - ((a->y - this1->y) * (b->x - this1->x)));
...
Float FlxPoint_Impl__obj::distSquared( ::flixel::math::FlxBasePoint this1, ::flixel::math::FlxBasePoint p){
            	...
            	HX_STACK_ARG(p,"p")
HXLINE(1257)
HXLINE(1258)		HX_VARI( Float,dx) = (p->x - this1->x);
HXLINE(1259)		HX_VARI( Float,dy) = (p->y - this1->y);
...
HXLINE(1272)
HXLINE(1273)		HX_VARI( Float,d) = ((1 + bounceCoeff) * ((this1->x * normal->x) + (this1->y * normal->y)));
...
HXDLIN(1290)		HX_VARI(  ::flixel::math::FlxBasePoint,p1) = proj;
...
HXDLIN(1291)		HX_VARI(  ::flixel::math::FlxBasePoint,p2) = proj1;
HXLINE(1292)		HX_VARI( Float,bounceX) = -(p2->x);
HXLINE(1293)		HX_VARI( Float,bounceY) = -(p2->y);
HXLINE(1294)		HX_VARI( Float,frictionX) = p1->x;
HXLINE(1295)		HX_VARI( Float,frictionY) = p1->y;
...
HXLINE(1368)			HX_VARI( Float,a) = ::flixel::math::_FlxPoint::FlxPoint_Impl__obj::get_radians(this1);
...
Float FlxPoint_Impl__obj::set_radians( ::flixel::math::FlxBasePoint this1,Float rads){
            	...
            	HX_STACK_ARG(rads,"rads")
HXLINE(1397)
HXLINE(1398)		HX_VARI( Float,len) = ::Math_obj::sqrt(((this1->x * this1->x) + (this1->y * this1->y)));

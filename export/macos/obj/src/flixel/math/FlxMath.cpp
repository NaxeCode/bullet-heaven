...
HXLINE(  69)
HXLINE(  70)		HX_VARI( Float,mult) = ( (Float)(1) );
HXLINE(  71)		{
HXLINE(  71)			int _g = 0;
HXDLIN(  71)			int _g1 = Precision;
HXDLIN(  71)			while((_g < _g1)){
HXLINE(  71)				_g = (_g + 1);
HXDLIN(  71)				HX_VARI( int,i) = (_g - 1);
...
HXLINE(  89)
HXLINE(  90)		HX_VAR( Float,lowerBound);
...
int FlxMath_obj::wrap(int value,int min,int max){
            	...
            	HX_STACK_ARG(max,"max")
HXLINE( 270)
HXLINE( 271)		HX_VARI( int,range) = ((max - min) + 1);
...
HXLINE( 325)
HXLINE( 326)		HX_VARI( Float,dx) = ((SpriteA->x + SpriteA->origin->x) - (SpriteB->x + SpriteB->origin->x));
HXLINE( 327)		HX_VARI( Float,dy) = ((SpriteA->y + SpriteA->origin->y) - (SpriteB->y + SpriteB->origin->y));
...
HXLINE( 342)
HXLINE( 343)		HX_VARI( Float,dx) = ((SpriteA->x + SpriteA->origin->x) - (SpriteB->x + SpriteB->origin->x));
HXLINE( 344)		HX_VARI( Float,dy) = ((SpriteA->y + SpriteA->origin->y) - (SpriteB->y + SpriteB->origin->y));
...
HXLINE( 361)
HXLINE( 362)		HX_VARI( Float,dx) = ((Sprite->x + Sprite->origin->x) - Target->x);
HXLINE( 363)		HX_VARI( Float,dy) = ((Sprite->y + Sprite->origin->y) - Target->y);
...
bool FlxMath_obj::isDistanceToPointWithin( ::flixel::FlxSprite Sprite, ::flixel::math::FlxBasePoint Target,Float Distance,::hx::Null< bool >  __o_IncludeEqual){
            	...
            	HX_STACK_ARG(IncludeEqual,"IncludeEqual")
HXLINE( 380)
HXLINE( 381)		HX_VARI( Float,dx) = ((Sprite->x + Sprite->origin->x) - Target->x);
HXLINE( 382)		HX_VARI( Float,dy) = ((Sprite->y + Sprite->origin->y) - Target->y);
...
int FlxMath_obj::distanceToMouse( ::flixel::FlxSprite Sprite){
            	...
            	HX_STACK_ARG(Sprite,"Sprite")
HXLINE( 400)
HXLINE( 401)		HX_VARI( Float,dx) = ((Sprite->x + Sprite->origin->x) - ( (Float)(::flixel::FlxG_obj::mouse->screenX) ));
HXLINE( 402)		HX_VARI( Float,dy) = ((Sprite->y + Sprite->origin->y) - ( (Float)(::flixel::FlxG_obj::mouse->screenY) ));
...
bool FlxMath_obj::isDistanceToMouseWithin( ::flixel::FlxSprite Sprite,Float Distance,::hx::Null< bool >  __o_IncludeEqual){
            	...
            	HX_STACK_ARG(IncludeEqual,"IncludeEqual")
HXLINE( 416)
HXLINE( 417)		HX_VARI( Float,dx) = ((Sprite->x + Sprite->origin->x) - ( (Float)(::flixel::FlxG_obj::mouse->screenX) ));
HXLINE( 418)		HX_VARI( Float,dy) = ((Sprite->y + Sprite->origin->y) - ( (Float)(::flixel::FlxG_obj::mouse->screenY) ));
...
int FlxMath_obj::getDecimals(Float n){
            	...
            	HX_STACK_ARG(n,"n")
HXLINE( 468)
HXLINE( 469)		HX_VARI( ::Array< ::String >,helperArray) = ::Std_obj::string(n).split(HX_(".",2e,00,00,00));
HXLINE( 470)		HX_VARI( int,decimals) = 0;

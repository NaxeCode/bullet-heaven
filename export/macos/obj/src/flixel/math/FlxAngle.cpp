...
Float FlxAngle_obj::angleBetween( ::flixel::FlxSprite SpriteA, ::flixel::FlxSprite SpriteB,::hx::Null< bool >  __o_AsDegrees){
            	...
            	HX_STACK_ARG(AsDegrees,"AsDegrees")
HXLINE( 153)
HXLINE( 154)		HX_VARI( Float,dx) = ((SpriteB->x + SpriteB->origin->x) - (SpriteA->x + SpriteA->origin->x));
HXLINE( 155)		HX_VARI( Float,dy) = ((SpriteB->y + SpriteB->origin->y) - (SpriteA->y + SpriteA->origin->y));
...
Float FlxAngle_obj::angleBetweenPoint( ::flixel::FlxSprite Sprite, ::flixel::math::FlxBasePoint Target,::hx::Null< bool >  __o_AsDegrees){
            	...
            	HX_STACK_ARG(AsDegrees,"AsDegrees")
HXLINE( 196)
HXLINE( 197)		HX_VARI( Float,dx) = (Target->x - (Sprite->x + Sprite->origin->x));
HXLINE( 198)		HX_VARI( Float,dy) = (Target->y - (Sprite->y + Sprite->origin->y));
...
HXLINE( 247)		HX_VARI(  ::flixel::math::FlxBasePoint,p) = Object->getScreenPosition(null(),null());
HXLINE( 249)		HX_VARI( Float,dx) = (( (Float)(::flixel::FlxG_obj::mouse->screenX) ) - p->x);
HXLINE( 250)		HX_VARI( Float,dy) = (( (Float)(::flixel::FlxG_obj::mouse->screenY) ) - p->y);
HXLINE( 252)		p->put();
...
Float FlxAngle_obj::angleFromFacing(int Facing,::hx::Null< bool >  __o_AsDegrees){
            	...
            	HX_STACK_ARG(AsDegrees,"AsDegrees")
HXLINE( 345)
HXLINE( 346)		HX_VARI( Float,degrees) = ::flixel::util::_FlxDirectionFlags::FlxDirectionFlags_Impl__obj::get_degrees(Facing);
...
HXLINE( 360)
HXLINE( 361)		HX_VARI(  ::flixel::math::FlxBasePoint,p) = point;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxAngle_obj,getCartesianCoords,return )
 ...
 ::flixel::math::FlxBasePoint FlxAngle_obj::getPolarCoords(Float X,Float Y, ::flixel::math::FlxBasePoint point){
            	...
            	HX_STACK_ARG(point,"point")
HXLINE( 380)
HXLINE( 381)		HX_VARI(  ::flixel::math::FlxBasePoint,p) = point;

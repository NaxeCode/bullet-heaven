...
HXLINE(  24)
HXLINE(  25)		HX_VARI( Float,a) = ::flixel::math::FlxAngle_obj::angleBetween(Source,Dest,null());
...
HXDLIN(  29)			HX_VARI( int,d) = ::Std_obj::_hx_int(::Math_obj::sqrt(((dx * dx) + (dy * dy))));
...
HXLINE(  50)
HXLINE(  51)		HX_VARI( Float,a) = ::flixel::math::FlxAngle_obj::angleBetween(Source,Dest,null());
HXLINE(  52)		{
...
HXDLIN(  72)			HX_VARI( int,d) = ::Std_obj::_hx_int(::Math_obj::sqrt(((dx * dx) + (dy * dy))));
...
HXDLIN( 165)			HX_VARI( int,d) = ::Std_obj::_hx_int(::Math_obj::sqrt(((dx * dx) + (dy * dy))));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxVelocity_obj,accelerateTowardsPoint,(void))
 ...
 ::flixel::math::FlxBasePoint FlxVelocity_obj::velocityFromAngle(Float Angle,Float Speed){
            	...
            	HX_STACK_ARG(Speed,"Speed")
HXLINE( 204)
HXLINE( 205)		HX_VARI( Float,a) = (Angle * (::Math_obj::PI / ( (Float)(180) )));
...
HXLINE( 240)				HX_VARI( Float,drag) = (Drag * Elapsed);
...
HXLINE( 279)
HXLINE( 280)		HX_VARI( Float,sinA) = ::Math_obj::sin(radians);
HXLINE( 281)		HX_VARI( Float,cosA) = ::Math_obj::cos(radians);

...
HXLINE(  44)
HXLINE(  45)		HX_VARI(  ::sys::io::FileOutput,f) = ::sys::io::File_obj::write(path,null());
...
HXLINE(  69)
HXLINE(  70)		HX_VARI(  ::sys::io::FileInput,s) = ::sys::io::File_obj::read(srcPath,true);
HXLINE(  71)		HX_VARI(  ::sys::io::FileOutput,d) = ::sys::io::File_obj::write(dstPath,true);

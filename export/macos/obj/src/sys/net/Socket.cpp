...
HX_LOCAL_STACK_FRAME(_hx_pos_4dbbe9fd0d3b97ed_195_listen,"sys.net.Socket","listen",0x81cfc410,"sys.net.Socket.listen","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",195,0x0bdbd1d5)
HX_LOCAL_STACK_FRAME(_hx_pos_4dbbe9fd0d3b97ed_203_bind,"sys.net.Socket","bind",0xfd253d46,"sys.net.Socket.bind","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",203,0x0bdbd1d5)
HX_LOCAL_STACK_FRAME(_hx_pos_4dbbe9fd0d3b97ed_216_accept,"sys.net.Socket","accept",0x9cdc8ed1,"sys.net.Socket.accept","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",216,0x0bdbd1d5)
...
HXLINE( 183)					HX_VARI_NAME( ::String,s1,"s") = ( (::String)(_g->value) );
HXLINE( 184)					if ((s1 == HX_("Invalid socket handle",6c,15,f9,09))) {
HXLINE( 185)						HX_STACK_DO_THROW((((HX_("Failed to connect on ",a9,2b,e3,45) + host->toString()) + HX_(":",3a,00,00,00)) + port));
            					}
            					else {
...
void Socket_obj::listen(int connections){
            	HX_STACKFRAME(&_hx_pos_4dbbe9fd0d3b97ed_195_listen)
            	HX_STACK_THIS(this)
...
void Socket_obj::bind( ::sys::net::Host host,int port){
            	HX_STACKFRAME(&_hx_pos_4dbbe9fd0d3b97ed_203_bind)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(host,"host")
            	HX_STACK_ARG(port,"port")
HXLINE( 203)
...
HX_DEFINE_DYNAMIC_FUNC2(Socket_obj,bind,(void))
 ...
 ::sys::net::Socket Socket_obj::accept(){
            	HX_GC_STACKFRAME(&_hx_pos_4dbbe9fd0d3b97ed_216_accept)
            	HX_STACK_THIS(this)
HXLINE( 216)

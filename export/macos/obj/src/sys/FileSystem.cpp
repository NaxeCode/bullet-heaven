...
HX_LOCAL_STACK_FRAME(_hx_pos_4ebd30807fe7ed8d_97_deleteDirectory,"sys.FileSystem","deleteDirectory",0x052a5cc0,"sys.FileSystem.deleteDirectory","/usr/local/lib/haxe/std/cpp/_std/sys/FileSystem.hx",97,0x1f6d7d6f)
...
void FileSystem_obj::createDirectory(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE(  78)
HXLINE(  79)		HX_VARI_NAME( ::String,path1,"path") = ::haxe::io::Path_obj::addTrailingSlash(path);
HXLINE(  80)		HX_VARI( ::String,_p) = null();
HXLINE(  81)		HX_VARI( ::Array< ::String >,parts) = ::Array_obj< ::String >::__new(0);
...
HXLINE(  86)				HX_VARI( ::String,part) = parts->__get(_g);
HXDLIN(  86)				_g = (_g + 1);
...
void FileSystem_obj::deleteDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_4ebd30807fe7ed8d_97_deleteDirectory)
            	HX_STACK_ARG(path,"path")
HXLINE(  97)

...
HXLINE( 146)			goto _hx_goto_6;
            		...
            		/* default */{
HXDLIN( 146)			if (_g4) {
HXLINE( 150)				HX_VARI( Float,time) = _g5;
HXDLIN( 150)				return ::sys::thread::NextEventTime_obj::AnyTime(time);
            			}
            			else {
HXLINE( 151)				HX_VARI_NAME( Float,time1,"time") = _g5;
...
void EventLoop_obj::loop(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 179)
HXLINE( 180)		HX_VARI( ::Array< ::Dynamic>,recycleRegular) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 181)		HX_VARI( ::Array< ::Dynamic>,recycleOneTimers) = ::Array_obj< ::Dynamic>::__new(0);
...
HXLINE( 184)					goto _hx_goto_14;
            				...
            				/* default */{
HXLINE( 190)					HX_VARI( Float,time) = _g5;
HXDLIN( 190)					{
HXLINE( 191)						HX_VARI( Float,timeout) = (time - ::Sys_obj::time());

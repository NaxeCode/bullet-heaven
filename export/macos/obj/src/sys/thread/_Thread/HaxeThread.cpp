...
HX_DEFINE_STACK_FRAME(_hx_pos_a14e377470428d6e_73_new,"sys.thread._Thread.HaxeThread","new",0x28e1daea,"sys.thread._Thread.HaxeThread.new","/usr/local/lib/haxe/std/cpp/_std/sys/thread/Thread.hx",73,0x29fdb453)
...
void HaxeThread_obj::__construct( ::Dynamic h){
            	HX_GC_STACKFRAME(&_hx_pos_a14e377470428d6e_73_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(h,"h")
HXLINE(  73)
...
HXLINE(  91)
HXLINE(  92)		HX_VARI(  ::Dynamic,handle) =  ::__hxcpp_thread_current();
...
HXLINE(  97)		HX_VARI(  ::sys::thread::_Thread::HaxeThread,thread) = null();
HXLINE(  98)		{
HXLINE(  98)			int _g = 0;
HXDLIN(  98)			::Array< ::Dynamic> _g1 = ::sys::thread::_Thread::HaxeThread_obj::threads;
HXDLIN(  98)			while((_g < _g1->length)){
HXLINE(  98)				HX_VARI(  ::Dynamic,item) = _g1->__get(_g);
HXDLIN(  98)				_g = (_g + 1);
...
HXLINE( 127)					( ( ::sys::thread::_Thread::HaxeThread)(item->__Field(HX_("thread",ca,7a,b9,8e),::hx::paccDynamic)) )->events->loop();
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE( 128)					HX_VARI(  ::haxe::Exception,e) = ::haxe::Exception_obj::caught(_g);
...
HXLINE( 132)			::sys::thread::_Thread::HaxeThread_obj::dropThread(item,index);
            	...
            	HX_STACK_ARG(withEventLoop,"withEventLoop")
HXLINE( 112)
HXLINE( 113)		HX_VARI(  ::Dynamic,item) =  ::Dynamic(::hx::Anon_obj::Create(2)
...
HXLINE( 115)		HX_VARI( int,index) = ::sys::thread::_Thread::HaxeThread_obj::threads->push(item);
...
void HaxeThread_obj::dropThread( ::Dynamic item,int probableIndex){
            	...
            	HX_STACK_ARG(probableIndex,"probableIndex")
HXLINE( 155)
...
HXDLIN( 160)				HX_VARI( int,i) = _g_key;
HXDLIN( 160)				HX_VARI(  ::Dynamic,item2) = _g_value;

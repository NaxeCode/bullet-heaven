...
HX_LOCAL_STACK_FRAME(_hx_pos_03b80f763c8d9d0d_51_readMessage,"sys.thread._Thread.Thread_Impl_","readMessage",0x4f379df5,"sys.thread._Thread.Thread_Impl_.readMessage","/usr/local/lib/haxe/std/cpp/_std/sys/thread/Thread.hx",51,0x29fdb453)
...
bool Thread_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Thread_Impl__obj::readMessage(bool block){
            	HX_STACKFRAME(&_hx_pos_03b80f763c8d9d0d_51_readMessage)

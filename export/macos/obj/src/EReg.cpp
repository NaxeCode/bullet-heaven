...
HXLINE(  28)
HXLINE(  29)		HX_VARI( ::Array< ::String >,a) = opt.split(HX_("g",67,00,00,00));
...
bool EReg_obj::match(::String s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE(  36)
HXLINE(  37)		HX_VARI( bool,p) = _hx_regexp_match(this->r,s,0,s.length);
HXLINE(  38)		if (p) {
...
::String EReg_obj::matched(int n){
            	...
            	HX_STACK_ARG(n,"n")
HXLINE(  45)
HXLINE(  46)		HX_VARI( ::String,m) = _hx_regexp_matched(this->r,n);
HXLINE(  47)		return m;
            	}
...
::String EReg_obj::matchedRight(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  55)
HXLINE(  56)		HX_VARI(  ::Dynamic,p) = _hx_regexp_matched_pos(this->r,0);
HXLINE(  57)		HX_VARI( int,sz) = ( (int)((p->__Field(HX_("pos",94,5d,55,00),::hx::paccDynamic) + p->__Field(HX_("len",d5,4b,52,00),::hx::paccDynamic))) );
...
HXDLIN(  66)		HX_VARI_NAME( bool,p1,"p") = _hx_regexp_match(this->r,s,pos,p);
HXLINE(  67)		if (p1) {
...
::Array< ::String > EReg_obj::split(::String s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE(  74)
HXLINE(  75)		HX_VARI( int,pos) = 0;
HXLINE(  76)		HX_VARI( int,len) = s.length;
HXLINE(  77)		HX_VARI( ::Array< ::String >,a) = ::Array_obj< ::String >::__new();
HXLINE(  78)		HX_VARI( bool,first) = true;
HXLINE(  79)		while(_hx_regexp_match(this->r,s,pos,len)){
HXLINE(  82)			HX_VARI(  ::Dynamic,p) = _hx_regexp_matched_pos(this->r,0);
...
HXLINE(  89)			HX_VARI( int,tot) = (( (int)((p->__Field(HX_("pos",94,5d,55,00),::hx::paccDynamic) + p->__Field(HX_("len",d5,4b,52,00),::hx::paccDynamic))) ) - pos);
...
::String EReg_obj::replace(::String s,::String by){
            	...
            	HX_STACK_ARG(by,"by")
HXLINE(  98)
HXLINE(  99)		HX_VARI(  ::StringBuf,b) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 100)		HX_VARI( int,pos) = 0;
HXLINE( 101)		HX_VARI( int,len) = s.length;
HXLINE( 102)		HX_VARI( ::Array< ::String >,a) = by.split(HX_("$",24,00,00,00));
HXLINE( 103)		HX_VARI( bool,first) = true;
HXLINE( 104)		while(_hx_regexp_match(this->r,s,pos,len)){
HXLINE( 107)			HX_VARI(  ::Dynamic,p) = _hx_regexp_matched_pos(this->r,0);
...
HXLINE( 116)			HX_VARI( int,i) = 1;
HXLINE( 117)			while((i < a->length)){
HXLINE( 118)				HX_VARI( ::String,k) = a->__get(i);
HXLINE( 119)				HX_VARI(  ::Dynamic,c) = k.charCodeAt(0);
...
HXLINE( 122)					HX_VAR_NAME(  ::Dynamic,p2,"p");
HXDLIN( 122)					try {
...
HXLINE( 132)						i = (i + 1);
HXLINE( 133)						HX_VARI( ::String,k2) = a->__get(i);
...
HXLINE( 140)			HX_VARI( int,tot) = (( (int)((p->__Field(HX_("pos",94,5d,55,00),::hx::paccDynamic) + p->__Field(HX_("len",d5,4b,52,00),::hx::paccDynamic))) ) - pos);
...
::String EReg_obj::map(::String s, ::Dynamic f){
            	...
            	HX_STACK_ARG(f,"f")
HXLINE( 149)
HXLINE( 150)		HX_VARI( int,offset) = 0;
HXLINE( 151)		HX_VARI(  ::StringBuf,buf) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 152)		do {
...
HXLINE( 159)			HX_VARI(  ::Dynamic,p) = _hx_regexp_matched_pos(this->r,0);
HXLINE( 160)			{

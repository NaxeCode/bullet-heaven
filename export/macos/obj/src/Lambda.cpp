...
::cpp::VirtualArray Lambda_obj::array( ::Dynamic it){
            	...
            	HX_STACK_ARG(it,"it")
HXLINE(  45)
HXLINE(  46)		HX_VARI( ::cpp::VirtualArray,a) = ::cpp::VirtualArray_obj::__new();
HXLINE(  47)		{
HXLINE(  47)			HX_VARI(  ::Dynamic,i) = it->__Field(HX_("iterator",ee,49,9a,93),::hx::paccDynamic)();
HXDLIN(  47)			while(( (bool)(i->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  47)				HX_VARI_NAME(  ::Dynamic,i1,"i") = i->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXLINE(  48)				a->push(i1);
            			}
            		}
HXLINE(  49)		return a;

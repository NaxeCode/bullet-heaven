...
HXDLIN( 278)		HX_VARI(  ::Dynamic,init) = ::hx::ClassOf< ::lime::app::Application >();
            	}
...
HXLINE(  18)
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("bullet-heaven",06,ac,da,ad),::ApplicationMain_obj::create_dyn());
...
HXLINE(  31)
HXLINE(  32)		HX_VARI(  ::openfl::display::Application,app) =  ::openfl::display::Application_obj::__alloc( HX_CTX );
HXLINE(  35)		::ManifestResources_obj::init(config);
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("47",83,2d,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("HaxeFlixel",42,8f,0c,ac));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("bullet-heaven",06,ac,da,ad));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("bullet-heaven",06,ac,da,ad));
...
HXLINE(  49)		HX_VARI(  ::Dynamic,attributes) =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("bullet-heaven",06,ac,da,ad))
...
HXLINE(  84)					HX_VARI( ::String,field) = _g1->__get(_g);
HXDLIN(  84)					_g = (_g + 1);
...
HXLINE( 111)		HX_VARI(  ::openfl::display::Preloader,preloader) =  ::openfl::display::Preloader_obj::__alloc( HX_CTX , ::flixel::_hx_system::FlxPreloader_obj::__alloc( HX_CTX ,null(),null()));
...
HXLINE( 124)				HX_VARI(  ::lime::utils::AssetLibrary,library) = _g3->__get(_g2).StaticCast<  ::lime::utils::AssetLibrary >();
...
HXLINE( 209)				{
HXLINE( 210)					HX_VARI(  ::openfl::display::DisplayObject,current) = stage->getChildAt(0);
...
HXDLIN( 162)					HX_VARI(  ::Dynamic,e) = _g;
...
HXLINE( 209)			{
HXLINE( 210)				HX_VARI_NAME(  ::openfl::display::DisplayObject,current1,"current") = stage->getChildAt(0);

...
HXDLIN( 115)				return ::Date_obj::fromTime((_hx_tmp1 + (( (Float)(::Std_obj::parseInt(k->__get(2))) ) * ((Float)1000.))));
            			...
            			break;
            			case (int)10: {
HXLINE( 117)				HX_VARI_NAME( ::Array< ::String >,k1,"k") = s.split(HX_("-",2d,00,00,00));
...
HXDLIN( 118)				return  ::Date_obj::__alloc( HX_CTX ,( (int)(_hx_tmp2) ),_hx_tmp3,( (int)(::Std_obj::parseInt(k1->__get(2))) ),0,0,0);
            			...
            			break;
            			case (int)19: {
HXLINE( 120)				HX_VARI_NAME( ::Array< ::String >,k2,"k") = s.split(HX_(" ",20,00,00,00));
HXLINE( 121)				HX_VARI( ::Array< ::String >,y) = k2->__get(0).split(HX_("-",2d,00,00,00));
HXLINE( 122)				HX_VARI( ::Array< ::String >,t) = k2->__get(1).split(HX_(":",3a,00,00,00));

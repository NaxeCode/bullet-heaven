...
bool JsonParser_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JsonParser_obj::doParse(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  56)
HXLINE(  57)		HX_VARI(  ::Dynamic,result) = this->parseRec();
HXLINE(  58)		HX_VAR( int,c);
...
HXLINE(  72)			HX_VARI( int,c) = this->str.cca(this->pos++);
...
HXLINE( 145)							return f;
            				...
            				break;
            				case (int)91: {
HXLINE( 103)					HX_VARI( ::cpp::VirtualArray,arr) = ::cpp::VirtualArray_obj::__new(0);
HXDLIN( 103)					HX_VARI(  ::Dynamic,comma) = null();
HXLINE( 104)					while(true){
HXLINE( 105)						HX_VARI_NAME( int,c2,"c") = this->str.cca(this->pos++);
...
HXLINE( 118)								comma = true;
            				...
            				break;
            				case (int)102: {
HXLINE( 129)					HX_VARI( int,save) = this->pos;
...
HXLINE( 134)					return false;
            				...
            				break;
            				case (int)110: {
HXLINE( 136)					HX_VARI_NAME( int,save1,"save") = this->pos;
...
HXLINE( 141)					return null();
            				...
            				break;
            				case (int)116: {
HXLINE( 122)					HX_VARI_NAME( int,save2,"save") = this->pos;
...
HXLINE( 127)					return true;
            				...
            				break;
            				case (int)123: {
HXLINE(  77)					HX_VARI(  ::Dynamic,obj) =  ::Dynamic(::hx::Anon_obj::Create(0));
HXDLIN(  77)					HX_VARI( ::String,field) = null();
HXDLIN(  77)					HX_VARI_NAME(  ::Dynamic,comma1,"comma") = null();
HXLINE(  78)					while(true){
HXLINE(  79)						HX_VARI_NAME( int,c3,"c") = this->str.cca(this->pos++);
...
::String JsonParser_obj::parseString(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 152)
HXLINE( 153)		HX_VARI( int,start) = this->pos;
HXLINE( 154)		HX_VARI(  ::StringBuf,buf) = null();
HXLINE( 156)		HX_VARI( int,prev) = -1;
HXLINE( 163)		while(true){
HXLINE( 164)			HX_VARI( int,c) = this->str.cca(this->pos++);
HXLINE( 165)			if ((c == 34)) {
...
HXDLIN( 183)						buf->charBuf->push(9);
            					...
            					break;
            					case (int)117: {
HXLINE( 191)						HX_VARI( int,uc) = ( (int)(::Std_obj::parseInt((HX_("0x",48,2a,00,00) + this->str.substr(this->pos,4)))) );

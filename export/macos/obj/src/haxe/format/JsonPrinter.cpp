...
HXLINE(  94)						_this7->b->push(HX_("\"<fun>\"",09,3c,cc,8b));
            				...
            				break;
            				case (int)6: {
HXLINE(  95)					HX_VARI( ::hx::Class,c) = _g->_hx_getObject(0).StaticCast< ::hx::Class >();
...
HXLINE(  99)							HX_VARI_NAME( ::cpp::VirtualArray,v4,"v") = ( (::cpp::VirtualArray)(v) );
HXLINE( 100)							{
...
HXLINE( 102)							HX_VARI( int,len) = v4->get_length();
HXLINE( 103)							HX_VARI( int,last) = (len - 1);
HXLINE( 104)							{
HXLINE( 104)								int _g1 = 0;
HXDLIN( 104)								int _g2 = len;
HXDLIN( 104)								while((_g1 < _g2)){
HXLINE( 104)									_g1 = (_g1 + 1);
HXDLIN( 104)									HX_VARI( int,i) = (_g1 - 1);
HXLINE( 105)									if ((i > 0)) {
...
HXLINE( 120)								HX_VARI_NAME(  ::haxe::ds::StringMap,v7,"v") = ( ( ::haxe::ds::StringMap)(v) );
HXLINE( 121)								HX_VARI(  ::Dynamic,o) =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE( 122)								{
HXLINE( 122)									HX_VARI_NAME(  ::Dynamic,k1,"k") = v7->keys();
HXDLIN( 122)									while(( (bool)(k1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 122)										HX_VARI_NAME( ::String,k2,"k") = ( (::String)(k1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 126)									HX_VARI_NAME(  ::Date,v9,"v") = ( ( ::Date)(v) );
...
HXDLIN( 130)					{
HXLINE( 131)						HX_VARI_NAME( int,i1,"i") = _hx_getEnumValueIndex(v);
HXLINE( 132)						{
...
HXLINE( 167)		HX_VARI( int,len) = fields->length;
HXLINE( 168)		HX_VARI( int,last) = (len - 1);
HXLINE( 169)		HX_VARI( bool,first) = true;
HXLINE( 170)		{
HXLINE( 170)			int _g = 0;
HXDLIN( 170)			int _g1 = len;
HXDLIN( 170)			while((_g < _g1)){
HXLINE( 170)				_g = (_g + 1);
HXDLIN( 170)				HX_VARI( int,i) = (_g - 1);
HXLINE( 171)				HX_VARI( ::String,f) = fields->__get(i);
HXLINE( 172)				HX_VARI(  ::Dynamic,value) = ::Reflect_obj::field(v,f);
...
HXLINE( 204)		HX_VARI( int,i) = 0;
HXLINE( 205)		HX_VARI( int,length) = s.length;
HXLINE( 209)		while((i < length)){
HXLINE( 210)			i = (i + 1);
HXDLIN( 210)			HX_VARI( int,c) = s.cca((i - 1));

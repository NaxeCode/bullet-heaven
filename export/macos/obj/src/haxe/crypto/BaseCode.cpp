...
HXLINE(  33)
HXLINE(  34)		HX_VARI( int,len) = base->length;
HXLINE(  35)		HX_VARI( int,nbits) = 1;
...
void BaseCode_obj::initTable(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  72)
HXLINE(  73)		HX_VARI( ::Array< int >,tbl) = ::Array_obj< int >::__new();
HXLINE(  74)		{
HXLINE(  74)			int _g = 0;
HXDLIN(  74)			while((_g < 256)){
HXLINE(  74)				_g = (_g + 1);
HXDLIN(  74)				HX_VARI( int,i) = (_g - 1);
HXLINE(  75)				tbl[i] = -1;
            			}
            		}
HXLINE(  76)		{
...
HXLINE(  76)				_g1 = (_g1 + 1);
HXDLIN(  76)				HX_VARI_NAME( int,i1,"i") = (_g1 - 1);
...
HX_DEFINE_DYNAMIC_FUNC0(BaseCode_obj,initTable,(void))
 ...
 ::haxe::io::Bytes BaseCode_obj::decodeBytes( ::haxe::io::Bytes b){
            	...
            	HX_STACK_ARG(b,"b")
HXLINE(  81)
HXLINE(  85)		HX_VARI( int,nbits) = this->nbits;
HXLINE(  86)		HX_VARI(  ::haxe::io::Bytes,base) = this->base;
HXLINE(  87)		if (::hx::IsNull( this->tbl )) {
HXLINE(  88)			this->initTable();
            		}
HXLINE(  89)		HX_VARI( ::Array< int >,tbl) = this->tbl;
HXLINE(  90)		HX_VARI( int,size) = ((b->length * nbits) >> 3);
HXLINE(  91)		HX_VARI(  ::haxe::io::Bytes,out) = ::haxe::io::Bytes_obj::alloc(size);
HXLINE(  92)		HX_VARI( int,buf) = 0;
HXLINE(  93)		HX_VARI( int,curbits) = 0;
HXLINE(  94)		HX_VARI( int,pin) = 0;
HXLINE(  95)		HX_VARI( int,pout) = 0;
...
HXDLIN( 100)				HX_VARI( int,i) = tbl->__get(( (int)(b->b->__get((pin - 1))) ));
HXLINE( 101)				if ((i == -1)) {

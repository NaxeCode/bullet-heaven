...
HXLINE(  41)
HXLINE(  42)		HX_VARI( int,a1) = this->a1;
HXDLIN(  42)		HX_VARI( int,a2) = this->a2;
HXLINE(  43)		{
HXLINE(  43)			int _g = pos;
HXDLIN(  43)			int _g1 = (pos + len);
HXDLIN(  43)			while((_g < _g1)){
HXLINE(  43)				_g = (_g + 1);
HXDLIN(  43)				HX_VARI( int,p) = (_g - 1);
HXLINE(  44)				HX_VARI( int,c) = ( (int)(b->b->__get(p)) );
...
HX_DEFINE_DYNAMIC_FUNC1(Adler32_obj,equals,return )
 ...
 ::haxe::crypto::Adler32 Adler32_obj::read( ::haxe::io::Input i){
            	...
            	HX_STACK_ARG(i,"i")
HXLINE(  60)
HXLINE(  61)		HX_VARI(  ::haxe::crypto::Adler32,a) =  ::haxe::crypto::Adler32_obj::__alloc( HX_CTX );
HXLINE(  62)		HX_VARI( int,a2a) = i->readByte();
HXLINE(  63)		HX_VARI( int,a2b) = i->readByte();
HXLINE(  64)		HX_VARI( int,a1a) = i->readByte();
HXLINE(  65)		HX_VARI( int,a1b) = i->readByte();

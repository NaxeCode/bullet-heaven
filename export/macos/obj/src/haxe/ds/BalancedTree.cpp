...
bool BalancedTree_obj::exists( ::Dynamic key){
            	...
            	HX_STACK_ARG(key,"key")
HXLINE( 101)
HXLINE( 102)		HX_VARI(  ::haxe::ds::TreeNode,node) = this->root;
HXLINE( 103)		while(::hx::IsNotNull( node )){
HXLINE( 104)			HX_VARI( int,c) = this->compare(key,node->key);
HXLINE( 105)			if ((c == 0)) {
...
HX_DEFINE_DYNAMIC_FUNC1(BalancedTree_obj,exists,return )
 ...
 ::Dynamic BalancedTree_obj::iterator(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 120)
HXLINE( 121)		HX_VARI( ::cpp::VirtualArray,ret) = ::cpp::VirtualArray_obj::__new(0);
...
HX_DEFINE_DYNAMIC_FUNC0(BalancedTree_obj,keyValueIterator,return )
 ...
 ::Dynamic BalancedTree_obj::keys(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 138)
HXLINE( 139)		HX_VARI( ::cpp::VirtualArray,ret) = ::cpp::VirtualArray_obj::__new(0);
...
HXLINE( 153)		HX_VARI( int,c) = this->compare(k,node->key);
HXLINE( 154)		if ((c == 0)) {
...
HXLINE( 154)			if ((c < 0)) {
HXLINE( 155)				HX_VARI(  ::haxe::ds::TreeNode,nl) = this->setLoop(k,v,node->left);
HXLINE( 156)				return this->balance(nl,node->key,node->value,node->right);
            			}
            			else {
HXLINE( 158)				HX_VARI(  ::haxe::ds::TreeNode,nr) = this->setLoop(k,v,node->right);
...
HXLINE( 166)		HX_VARI( int,c) = this->compare(k,node->key);
HXLINE( 167)		if ((c == 0)) {
...
HXLINE( 193)		HX_VARI(  ::haxe::ds::TreeNode,t) = this->minBinding(t2);

...
HX_DEFINE_DYNAMIC_FUNC0(GenericStack_hscript_Token_obj,first,return )
 ...
 ::hscript::Token GenericStack_hscript_Token_obj::pop(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 130)
HXLINE( 131)		HX_VARI(  ::haxe::ds::GenericCell_hscript_Token,k) = this->head;
...
bool GenericStack_hscript_Token_obj::remove( ::hscript::Token v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE( 156)
HXLINE( 157)		HX_VARI(  ::haxe::ds::GenericCell_hscript_Token,prev) = null();
HXLINE( 158)		HX_VARI(  ::haxe::ds::GenericCell_hscript_Token,l) = this->head;
...
HXLINE( 205)		HX_VARI(  ::haxe::ds::GenericCell_hscript_Token,l) = this->head;

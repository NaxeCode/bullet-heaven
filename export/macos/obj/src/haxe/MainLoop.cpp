...
HXLINE(  71)
HXLINE(  72)		HX_VARI(  ::haxe::MainEvent,p) = ::haxe::MainLoop_obj::pending;
...
HXLINE( 104)
HXLINE( 108)		HX_VARI(  ::haxe::MainEvent,list) = ::haxe::MainLoop_obj::pending;
HXLINE( 110)		if (::hx::IsNull( list )) {
HXLINE( 111)			return;
            		}
HXLINE( 113)		HX_VARI( int,insize) = 1;
HXDLIN( 113)		HX_VAR( int,nmerges);
HXDLIN( 113)		HX_VARI( int,psize) = 0;
HXDLIN( 113)		HX_VARI( int,qsize) = 0;
HXLINE( 114)		HX_VAR(  ::haxe::MainEvent,p);
HXDLIN( 114)		HX_VAR(  ::haxe::MainEvent,q);
HXDLIN( 114)		HX_VAR(  ::haxe::MainEvent,e);
HXDLIN( 114)		HX_VAR(  ::haxe::MainEvent,tail);
...
HXLINE( 171)		HX_VARI(  ::haxe::MainEvent,e) = ::haxe::MainLoop_obj::pending;
HXLINE( 172)		int timer = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 172)		HX_VAR( Float,now);
...
HXLINE( 173)		HX_VARI( Float,wait) = ((Float)1e9);
HXLINE( 174)		while(::hx::IsNotNull( e )){
HXLINE( 175)			HX_VARI(  ::haxe::MainEvent,next) = e->next;
HXLINE( 176)			HX_VARI( Float,wt) = (e->nextRun - now);
HXLINE( 177)			if ((wt <= 0)) {

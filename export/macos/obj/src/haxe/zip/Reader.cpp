...
bool Reader_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Date Reader_obj::readZipDate(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  36)
HXLINE(  37)		HX_VARI( int,t) = this->i->readUInt16();
HXLINE(  38)		HX_VARI( int,hour) = ((t >> 11) & 31);
HXLINE(  39)		HX_VARI( int,min) = ((t >> 5) & 63);
HXLINE(  40)		HX_VARI( int,sec) = (t & 31);
HXLINE(  41)		HX_VARI( int,d) = this->i->readUInt16();
HXLINE(  42)		HX_VARI( int,year) = (d >> 9);
HXLINE(  43)		HX_VARI( int,month) = ((d >> 5) & 15);
HXLINE(  44)		HX_VARI( int,day) = (d & 31);
...
HXLINE(  48)
HXLINE(  49)		HX_VARI(  ::haxe::ds::List,fields) =  ::haxe::ds::List_obj::__alloc( HX_CTX );
HXLINE(  50)		while((length > 0)){
HXLINE(  51)			if ((length < 4)) {
HXLINE(  52)				HX_STACK_DO_THROW(HX_("Invalid extra fields data",18,88,a4,23));
            			}
HXLINE(  53)			HX_VARI( int,tag) = this->i->readUInt16();
HXLINE(  54)			HX_VARI( int,len) = this->i->readUInt16();
HXLINE(  55)			if ((length < len)) {
HXLINE(  56)				HX_STACK_DO_THROW(HX_("Invalid extra fields data",18,88,a4,23));
            			}
HXLINE(  57)			if ((tag == 28789)) {
HXLINE(  59)				HX_VARI( int,version) = this->i->readByte();
HXLINE(  60)				if ((version != 1)) {
HXLINE(  61)					HX_VARI(  ::haxe::io::BytesBuffer,data) =  ::haxe::io::BytesBuffer_obj::__alloc( HX_CTX );
...
HXLINE(  66)					HX_VARI( int,crc) = this->i->readInt32();
HXLINE(  67)					HX_VARI( ::String,name) = this->i->read((len - 5))->toString();
...
HX_DEFINE_DYNAMIC_FUNC1(Reader_obj,readExtraFields,return )
 ...
 ::Dynamic Reader_obj::readEntryHeader(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  78)
HXLINE(  79)		HX_VARI(  ::haxe::io::Input,i) = this->i;
HXLINE(  80)		HX_VARI( int,h) = i->readInt32();
...
HXLINE(  85)		HX_VARI( int,version) = i->readUInt16();
HXLINE(  86)		HX_VARI( int,flags) = i->readUInt16();
HXLINE(  87)		HX_VARI( bool,utf8) = ((flags & 2048) != 0);
HXLINE(  88)		if (((flags & 63473) != 0)) {
HXLINE(  89)			HX_STACK_DO_THROW((HX_("Unsupported flags ",24,93,26,a4) + flags));
            		}
HXLINE(  90)		HX_VARI( int,compression) = i->readUInt16();
HXLINE(  91)		HX_VARI( bool,compressed) = (compression != 0);
...
HXLINE(  94)		HX_VARI(  ::Date,mtime) = this->readZipDate();
HXLINE(  95)		HX_VARI(  ::Dynamic,crc32) = i->readInt32();
HXLINE(  96)		HX_VARI( int,csize) = i->readInt32();
HXLINE(  97)		HX_VARI( int,usize) = i->readInt32();
HXLINE(  98)		HX_VARI( int,fnamelen) = i->readInt16();
HXLINE(  99)		HX_VARI( int,elen) = i->readInt16();
HXLINE( 100)		HX_VARI( ::String,fname) = i->readString(fnamelen,null());
HXLINE( 101)		HX_VARI(  ::haxe::ds::List,fields) = this->readExtraFields(elen);
HXLINE( 102)		if (utf8) {
HXLINE( 103)			fields->push(::haxe::zip::ExtraField_obj::FUtf8_dyn());
            		}
HXLINE( 104)		HX_VARI(  ::haxe::io::Bytes,data) = null();
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,readEntryHeader,return )
 ...
 ::haxe::ds::List Reader_obj::read(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 121)
HXLINE( 122)		HX_VARI(  ::haxe::ds::List,l) =  ::haxe::ds::List_obj::__alloc( HX_CTX );
HXLINE( 123)		HX_VARI(  ::Dynamic,buf) = null();
HXLINE( 124)		HX_VARI(  ::haxe::io::Bytes,tmp) = null();
HXLINE( 125)		while(true){
HXLINE( 126)			HX_VARI(  ::Dynamic,e) = this->readEntryHeader();
...
HXLINE( 164)					HX_VARI( int,bufSize) = 65536;
HXLINE( 165)					if (::hx::IsNull( tmp )) {
HXLINE( 166)						tmp = ::haxe::io::Bytes_obj::alloc(bufSize);
            					}
HXLINE( 167)					HX_VARI(  ::haxe::io::BytesBuffer,out) =  ::haxe::io::BytesBuffer_obj::__alloc( HX_CTX );
HXLINE( 168)					HX_VARI(  ::haxe::zip::InflateImpl,z) =  ::haxe::zip::InflateImpl_obj::__alloc( HX_CTX ,this->i,false,false);
HXLINE( 169)					while(true){
HXLINE( 170)						HX_VARI( int,n) = z->readBytes(tmp,0,bufSize);
HXLINE( 171)						{
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,read,return )
 ...
 ::haxe::ds::List Reader_obj::readZip( ::haxe::io::Input i){
            	...
            	HX_STACK_ARG(i,"i")
HXLINE( 194)
HXLINE( 195)		HX_VARI(  ::haxe::zip::Reader,r) =  ::haxe::zip::Reader_obj::__alloc( HX_CTX ,i);

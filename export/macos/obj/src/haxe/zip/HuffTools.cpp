...
HXLINE(  98)				_g2 = (_g2 + 1);
HXDLIN(  98)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE(  99)				HX_VARI( int,p) = lengths->__get((i1 + pos));
...
HXDLIN( 105)				HX_VARI_NAME( int,i2,"i") = (_g4 - 1);
...
HXDLIN( 110)				HX_VARI_NAME( int,i3,"i") = (_g6 - 1);
HXLINE( 111)				HX_VARI( int,l) = lengths->__get((i3 + pos));
HXLINE( 112)				if ((l != 0)) {

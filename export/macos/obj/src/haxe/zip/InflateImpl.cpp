...
HXLINE( 152)		HX_VARI( ::Array< int >,a) = ::Array_obj< int >::__new();
HXLINE( 153)		{
HXLINE( 153)			int _g = 0;
HXDLIN( 153)			while((_g < 288)){
HXLINE( 153)				_g = (_g + 1);
HXDLIN( 153)				HX_VARI( int,n) = (_g - 1);
...
HXLINE( 173)		HX_VARI( int,b) = (this->bits & ((1 << n) - 1));
...
HXLINE( 184)		HX_VARI( bool,b) = ((this->bits & 1) == 1);
...
void InflateImpl_obj::addDistOne(int n){
            	...
            	HX_STACK_ARG(n,"n")
HXLINE( 218)
HXLINE( 219)		HX_VARI( int,c) = this->window->getLastChar();
HXLINE( 220)		{
HXLINE( 220)			int _g = 0;
HXDLIN( 220)			int _g1 = n;
HXDLIN( 220)			while((_g < _g1)){
HXLINE( 220)				_g = (_g + 1);
HXDLIN( 220)				HX_VARI( int,i) = (_g - 1);
...
HXDLIN( 229)		switch((int)(h->_hx_getIndex())){
            			case (int)0: {
HXLINE( 230)				HX_VARI( int,n) = h->_hx_getInt(0);
HXDLIN( 230)				return n;
            			}
            			break;
            			case (int)1: {
HXLINE( 231)				HX_VARI(  ::haxe::zip::Huffman,a) = h->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >();
HXDLIN( 231)				HX_VARI(  ::haxe::zip::Huffman,b) = h->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >();
...
HXDLIN( 231)				return this->applyHuffman(_hx_tmp);
            			...
            			break;
            			case (int)2: {
HXLINE( 232)				HX_VARI_NAME( int,n1,"n") = h->_hx_getInt(0);
HXDLIN( 232)				HX_VARI( ::Array< ::Dynamic>,tbl) = h->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE( 236)
HXLINE( 237)		HX_VARI( int,i) = 0;
HXLINE( 238)		HX_VARI( int,prev) = 0;
HXLINE( 239)		while((i < max)){
HXLINE( 240)			HX_VARI( int,n) = this->applyHuffman(this->huffman);
...
HXLINE( 245)					i = (i + 1);
            				...
            				break;
            				case (int)16: {
HXLINE( 247)					HX_VARI( int,end) = ((i + 3) + this->getBits(2));
...
HXDLIN( 269)		switch((int)(this->state->_hx_getIndex())){
            			case (int)0: {
HXLINE( 271)				HX_VARI( int,cmf) = this->input->readByte();
HXLINE( 272)				HX_VARI( int,cm) = (cmf & 15);
HXLINE( 273)				HX_VARI( int,cinfo) = (cmf >> 4);
HXLINE( 274)				if ((cm != 8)) {
HXLINE( 275)					HX_STACK_DO_THROW(HX_("Invalid data",13,38,70,89));
            				}
HXLINE( 276)				HX_VARI( int,flg) = this->input->readByte();
HXLINE( 278)				HX_VARI( bool,fdict) = ((flg & 32) != 0);
...
HXLINE( 305)						HX_VARI( int,nlen) = this->input->readUInt16();
...
HXLINE( 308)						HX_VARI( bool,r) = this->inflateLoop();
...
HXLINE( 315)						return true;
            					...
            					break;
            					case (int)2: {
HXLINE( 317)						HX_VARI( int,hlit) = (this->getBits(5) + 257);
HXLINE( 318)						HX_VARI( int,hdist) = (this->getBits(5) + 1);
HXLINE( 319)						HX_VARI( int,hclen) = (this->getBits(4) + 4);
HXLINE( 320)						{
HXLINE( 320)							int _g = 0;
HXDLIN( 320)							int _g1 = hclen;
HXDLIN( 320)							while((_g < _g1)){
HXLINE( 320)								_g = (_g + 1);
HXDLIN( 320)								HX_VARI( int,i) = (_g - 1);
...
HXDLIN( 322)								HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
...
HXLINE( 325)						HX_VARI( ::Array< int >,lengths) = ::Array_obj< int >::__new();
HXLINE( 326)						{
HXLINE( 326)							int _g4 = 0;
HXDLIN( 326)							int _g5 = (hlit + hdist);
HXDLIN( 326)							while((_g4 < _g5)){
HXLINE( 326)								_g4 = (_g4 + 1);
HXDLIN( 326)								HX_VARI_NAME( int,i2,"i") = (_g4 - 1);
...
HXLINE( 334)						HX_STACK_DO_THROW(HX_("Invalid data",13,38,70,89));
            			...
            			break;
            			case (int)2: {
HXLINE( 362)				HX_VARI( int,n) = this->applyHuffman(this->huffman);
HXLINE( 363)				if ((n < 256)) {
...
HXLINE( 370)						n = (n - 257);
HXLINE( 371)						HX_VARI( int,extra_bits) = ::haxe::zip::InflateImpl_obj::LEN_EXTRA_BITS_TBL->__get(n);
...
HXLINE( 375)						HX_VAR( int,dist_code);
...
HXLINE( 338)				HX_VARI(  ::haxe::io::Bytes,bytes) = this->input->read(rlen);
...
HXLINE( 343)				return (this->needed > 0);
            			...
            			break;
            			case (int)4: {
HXLINE( 287)				HX_VARI(  ::haxe::crypto::Adler32,calc) = this->window->checksum();
HXLINE( 288)				if (::hx::IsNull( calc )) {
HXLINE( 289)					this->state = ::haxe::zip::_InflateImpl::State_obj::Done_dyn();
HXLINE( 290)					return true;
            				}
HXLINE( 292)				HX_VARI(  ::haxe::crypto::Adler32,crc) = ::haxe::crypto::Adler32_obj::read(this->input);
...
HXLINE( 354)					HX_VAR_NAME( int,rlen1,"rlen");
...
HXLINE( 360)				return (this->needed > 0);
            			...
            			break;
            			case (int)6: {
HXLINE( 345)				HX_VAR_NAME( int,rlen2,"rlen");

...
HXLINE(  71)							HX_VARI(  ::Dynamic,c) = _g2;
HXDLIN(  71)							{
...
HXDLIN(  63)								goto _hx_goto_2;
            							...
            							/* default */{
HXLINE(  71)								HX_VARI_NAME(  ::Dynamic,c2,"c") = _g2;
HXDLIN(  71)								{
HXLINE(  73)									if ((bs_buf->get_length() > 0)) {
HXLINE(  74)										{
...
HXLINE(  93)			HX_VARI_NAME(  ::StringBuf,result9,"result") =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE(  94)			{
HXLINE(  94)				int _g3 = 0;
HXDLIN(  94)				int _g4 = argument.length;
HXDLIN(  94)				while((_g3 < _g4)){
HXLINE(  94)					_g3 = (_g3 + 1);
HXDLIN(  94)					HX_VARI_NAME( int,i1,"i") = (_g3 - 1);
HXLINE(  95)					HX_VARI_NAME(  ::Dynamic,c4,"c") = argument.charCodeAt(i1);

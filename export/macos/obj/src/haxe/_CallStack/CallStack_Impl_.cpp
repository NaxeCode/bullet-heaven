...
HXLINE( 125)							HX_VARI_NAME(  ::haxe::StackItem,item21,"item2") = item2->_hx_getObject(0).StaticCast<  ::haxe::StackItem >();
...
HXDLIN( 125)							HX_VARI_NAME(  ::haxe::StackItem,item11,"item1") = item1->_hx_getObject(0).StaticCast<  ::haxe::StackItem >();
...
HXDLIN( 161)							b1->push(::Std_obj::string(m));
            			...
            			break;
            			case (int)2: {
HXLINE( 162)				HX_VARI_NAME(  ::haxe::StackItem,s1,"s") = s->_hx_getObject(0).StaticCast<  ::haxe::StackItem >();

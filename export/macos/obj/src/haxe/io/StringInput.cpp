...
HX_DEFINE_STACK_FRAME(_hx_pos_c25abf0b118962a1_27_new,"haxe.io.StringInput","new",0x8fd1998b,"haxe.io.StringInput.new","/usr/local/lib/haxe/std/haxe/io/StringInput.hx",27,0x28f71462)
namespace haxe{
namespace io{

void StringInput_obj::__construct(::String s){
            	HX_STACKFRAME(&_hx_pos_c25abf0b118962a1_27_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(s,"s")
HXLINE(  27)

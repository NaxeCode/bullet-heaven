...
::String Path_obj::extension(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE( 161)
HXLINE( 162)		HX_VARI(  ::haxe::io::Path,s) =  ::haxe::io::Path_obj::__alloc( HX_CTX ,path);
...
HXLINE( 230)		HX_VARI( ::String,tmp) = target->join(slash);
HXLINE( 231)		HX_VARI(  ::StringBuf,acc) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 232)		HX_VARI( bool,colon) = false;
HXLINE( 233)		HX_VARI( bool,slashes) = false;
HXLINE( 235)		{
...
HXDLIN( 235)				HX_VARI_NAME( int,c2,"c") = c1;
...
HXLINE( 243)						colon = true;
            					...
            					break;
            					default:{
HXLINE( 246)						HX_VARI_NAME( int,i1,"i") = c2;
HXDLIN( 246)						{
HXLINE( 247)							colon = false;
HXLINE( 248)							if (slashes) {
HXLINE( 249)								{
...
HXLINE( 274)		HX_VARI( int,c1) = path.lastIndexOf(HX_("/",2f,00,00,00),null());
HXLINE( 275)		HX_VARI( int,c2) = path.lastIndexOf(HX_("\\",5c,00,00,00),null());
HXLINE( 276)		if ((c1 < c2)) {

...
void Output_obj::write( ::haxe::io::Bytes s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE( 103)
HXLINE( 104)		HX_VARI( int,l) = s->length;
HXLINE( 105)		HX_VARI( int,p) = 0;
HXLINE( 106)		while((l > 0)){
HXLINE( 107)			HX_VARI( int,k) = this->writeBytes(s,p,l);
HXLINE( 108)			if ((k == 0)) {
...
HXLINE( 257)		HX_VARI(  ::haxe::io::Bytes,buf) = ::haxe::io::Bytes_obj::alloc(( (int)(bufsize) ));
HXLINE( 258)		try {
            			HX_STACK_CATCHABLE( ::haxe::io::Eof, 0);
            			HX_STACK_CATCHABLE( ::haxe::ValueException, 1);
HXLINE( 259)			while(true){
HXLINE( 260)				HX_VARI( int,len) = i->readBytes(buf,0,( (int)(bufsize) ));
HXLINE( 261)				if ((len == 0)) {
HXLINE( 262)					HX_STACK_DO_THROW(::haxe::io::Error_obj::Blocked_dyn());
            				}
HXLINE( 263)				HX_VARI( int,p) = 0;
HXLINE( 264)				while((len > 0)){
HXLINE( 265)					HX_VARI( int,k) = this->writeBytes(buf,p,len);
HXLINE( 266)					if ((k == 0)) {

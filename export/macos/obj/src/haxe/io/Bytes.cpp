...
HXLINE( 402)		HX_VARI( ::String,result) = HX_("",00,00,00,00);
...
::String Bytes_obj::toHex(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 485)
HXLINE( 486)		HX_VARI(  ::StringBuf,s) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 487)		HX_VARI( ::Array< ::Dynamic>,chars) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 488)		HX_VARI( ::String,str) = HX_("0123456789abcdef",68,7e,d5,ef);
HXLINE( 489)		{
HXLINE( 489)			int _g = 0;
HXDLIN( 489)			int _g1 = str.length;
HXDLIN( 489)			while((_g < _g1)){
HXLINE( 489)				_g = (_g + 1);
HXDLIN( 489)				HX_VARI( int,i) = (_g - 1);
...
HXDLIN( 491)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 493)				HX_VARI( int,c) = ( (int)(this->b->__get(i1)) );
HXLINE( 494)				{
...
HX_DEFINE_DYNAMIC_FUNC0(Bytes_obj,getData,return )
 ...
 ::haxe::io::Bytes Bytes_obj::alloc(int length){
            	...
            	HX_STACK_ARG(length,"length")
HXLINE( 506)
HXLINE( 514)		HX_VARI( ::Array< unsigned char >,a) = ::Array_obj< unsigned char >::__new();
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,alloc,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofString(::String s, ::haxe::io::Encoding encoding){
            	...
            	HX_STACK_ARG(encoding,"encoding")
HXLINE( 536)
HXLINE( 544)		HX_VARI( ::Array< unsigned char >,a) = ::Array_obj< unsigned char >::__new();
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,ofData,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofHex(::String s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE( 615)
HXLINE( 616)		HX_VARI( int,len) = s.length;
HXLINE( 617)		if (((len & 1) != 0)) {
HXLINE( 617)			HX_STACK_DO_THROW(HX_("Not a hex string (odd number of digits)",96,4b,d1,a4));
            		}
HXLINE( 618)		HX_VARI(  ::haxe::io::Bytes,ret) = ::haxe::io::Bytes_obj::alloc((len >> 1));
HXLINE( 619)		{
HXLINE( 619)			int _g = 0;
HXDLIN( 619)			int _g1 = ret->length;
HXDLIN( 619)			while((_g < _g1)){
HXLINE( 619)				_g = (_g + 1);
HXDLIN( 619)				HX_VARI( int,i) = (_g - 1);
HXLINE( 621)				HX_VARI( int,high) = s.cca((i * 2));
HXLINE( 622)				HX_VARI( int,low) = s.cca(((i * 2) + 1));

...
HXLINE(  64)
HXLINE(  65)		HX_VARI( int,k) = len;
HXLINE(  66)		HX_VARI( ::Array< unsigned char >,b) = s->b;
...
HXLINE( 134)			HX_VARI( int,k) = this->readBytes(s,pos,len);
HXLINE( 135)			if ((k == 0)) {
...
HXLINE( 145)
HXLINE( 146)		HX_VARI(  ::haxe::io::Bytes,s) = ::haxe::io::Bytes_obj::alloc(nbytes);
HXLINE( 147)		HX_VARI( int,p) = 0;
HXLINE( 148)		while((nbytes > 0)){
HXLINE( 149)			HX_VARI( int,k) = this->readBytes(s,p,nbytes);
HXLINE( 150)			if ((k == 0)) {
...
::String Input_obj::readLine(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 176)
HXLINE( 177)		HX_VARI(  ::haxe::io::BytesBuffer,buf) =  ::haxe::io::BytesBuffer_obj::__alloc( HX_CTX );
HXLINE( 178)		HX_VAR( int,last);
HXLINE( 179)		HX_VAR( ::String,s);
HXLINE( 180)		try {
            			HX_STACK_CATCHABLE( ::haxe::io::Eof, 0);
            			HX_STACK_CATCHABLE( ::haxe::ValueException, 1);
...
HXLINE( 186)					HX_VARI_NAME(  ::haxe::io::Eof,e1,"e") = ( ( ::haxe::io::Eof)(_g->value) );
HXDLIN( 186)					{
HXLINE( 187)						s = buf->getBytes()->toString();
HXLINE( 188)						if ((s.length == 0)) {
HXLINE( 189)							HX_STACK_DO_THROW(e1);
...
int Input_obj::readInt16(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 229)
HXLINE( 230)		HX_VARI( int,ch1) = this->readByte();
HXLINE( 231)		HX_VARI( int,ch2) = this->readByte();
HXLINE( 232)		HX_VAR( int,n);
...
int Input_obj::readUInt16(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 243)
HXLINE( 244)		HX_VARI( int,ch1) = this->readByte();
HXLINE( 245)		HX_VARI( int,ch2) = this->readByte();
...
int Input_obj::readInt32(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 281)
HXLINE( 282)		HX_VARI( int,ch1) = this->readByte();
HXLINE( 283)		HX_VARI( int,ch2) = this->readByte();
HXLINE( 284)		HX_VARI( int,ch3) = this->readByte();
HXLINE( 285)		HX_VARI( int,ch4) = this->readByte();
...
HXLINE( 304)
HXLINE( 305)		HX_VARI(  ::haxe::io::Bytes,b) = ::haxe::io::Bytes_obj::alloc(len);

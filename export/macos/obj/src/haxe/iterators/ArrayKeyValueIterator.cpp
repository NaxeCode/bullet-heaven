...
HX_DEFINE_STACK_FRAME(_hx_pos_9c3f350a04ebe3b3_26_new,"haxe.iterators.ArrayKeyValueIterator","new",0x6bd8a13a,"haxe.iterators.ArrayKeyValueIterator.new","/usr/local/lib/haxe/std/haxe/iterators/ArrayKeyValueIterator.hx",26,0x1ff9229b)
HX_LOCAL_STACK_FRAME(_hx_pos_9c3f350a04ebe3b3_35_hasNext,"haxe.iterators.ArrayKeyValueIterator","hasNext",0x73cdeb47,"haxe.iterators.ArrayKeyValueIterator.hasNext","/usr/local/lib/haxe/std/haxe/iterators/ArrayKeyValueIterator.hx",35,0x1ff9229b)
HX_LOCAL_STACK_FRAME(_hx_pos_9c3f350a04ebe3b3_39_next,"haxe.iterators.ArrayKeyValueIterator","next",0xf1b472d9,"haxe.iterators.ArrayKeyValueIterator.next","/usr/local/lib/haxe/std/haxe/iterators/ArrayKeyValueIterator.hx",39,0x1ff9229b)
namespace haxe{
namespace iterators{

void ArrayKeyValueIterator_obj::__construct(::cpp::VirtualArray array){
            	HX_STACKFRAME(&_hx_pos_9c3f350a04ebe3b3_26_new)
            	HX_STACK_THIS(this)
...
bool ArrayKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_9c3f350a04ebe3b3_35_hasNext)
            	HX_STACK_THIS(this)
HXLINE(  35)
...
HX_DEFINE_DYNAMIC_FUNC0(ArrayKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic ArrayKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_9c3f350a04ebe3b3_39_next)
            	HX_STACK_THIS(this)
HXLINE(  39)

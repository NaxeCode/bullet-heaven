...
HXDLIN(  78)							HX_VARI(  ::Xml,child) = _g_array->__get((_g_current - 1)).StaticCast<  ::Xml >();
...
HXDLIN(  64)					HX_VARI_NAME(  ::Xml,child1,"child") = _g_array1->__get((_g_current1 - 1)).StaticCast<  ::Xml >();
...
HXDLIN( 115)				HX_VARI(  ::Xml,child) = _g_array->__get((_g_current - 1)).StaticCast<  ::Xml >();
...
::String Printer_obj::print( ::Xml xml, ::Dynamic __o_pretty){
            	...
            	HX_STACK_ARG(pretty,"pretty")
HXLINE(  35)
HXLINE(  36)		HX_VARI(  ::haxe::xml::Printer,printer) =  ::haxe::xml::Printer_obj::__alloc( HX_CTX ,( (bool)(pretty) ));

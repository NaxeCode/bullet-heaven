...
HXLINE(  75)
HXLINE(  76)		HX_VARI( ::Array< ::Dynamic>,l) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  77)		{
HXLINE(  77)			HX_VARI(  ::Dynamic,x) = this1->elementsNamed(name);
HXDLIN(  77)			while(( (bool)(x->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  77)				HX_VARI_NAME(  ::Xml,x1,"x") = ( ( ::Xml)(x->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );

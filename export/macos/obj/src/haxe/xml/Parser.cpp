...
HXLINE( 115)
HXLINE( 116)		HX_VARI(  ::Xml,doc) = ::Xml_obj::createDocument();
...
HXLINE( 121)
HXLINE( 122)		HX_VARI(  ::Xml,xml) = null();
HXLINE( 123)		HX_VARI( int,state) = 1;
HXLINE( 124)		HX_VARI( int,next) = 1;
HXLINE( 125)		HX_VARI( ::String,aname) = null();
HXLINE( 126)		HX_VARI( int,start) = 0;
HXLINE( 127)		HX_VARI( int,nsubs) = 0;
HXLINE( 128)		HX_VARI( int,nbrackets) = 0;
HXLINE( 129)		HX_VARI(  ::StringBuf,buf) =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 131)		HX_VARI( int,escapeNext) = 1;
HXLINE( 132)		HX_VARI( int,attrValQuote) = -1;
HXLINE( 137)		while((p < str.length)){
HXLINE( 138)			HX_VARI( int,c) = str.cca(p);
...
HXLINE( 237)						HX_VARI( ::String,tmp) = str.substr(start,(p - start));
...
HXLINE( 278)									HX_VARI( ::String,val) = buf->toString();
...
HXLINE( 278)								HX_VARI_NAME( ::String,val1,"val") = buf->toString();
HXLINE( 279)								buf =  ::StringBuf_obj::__alloc( HX_CTX );
...
HXLINE( 309)						HX_VARI( ::String,v) = str.substr(start,(p - start));
...
HXLINE( 160)						HX_VARI(  ::Xml,child) = ::Xml_obj::createPCData(buf->toString());
...
HXLINE( 337)						p = (p + 1);
HXLINE( 338)						HX_VARI_NAME( ::String,str1,"str") = str.substr((start + 1),((p - start) - 2));
HXLINE( 339)						{
...
HXLINE( 173)						HX_VARI_NAME(  ::Xml,child1,"child") = ::Xml_obj::createCData(str.substr(start,(p - start)));
HXLINE( 174)						{
...
HXLINE( 176)						state = 1;
            				...
            				case (int)18: {
HXLINE( 343)					if ((c == 59)) {
HXLINE( 344)						HX_VARI( ::String,s) = str.substr(start,(p - start));
HXLINE( 345)						if ((s.cca(0) == 35)) {
HXLINE( 346)							HX_VAR_NAME(  ::Dynamic,c1,"c");
...
HXLINE( 100)
HXLINE( 101)			HX_VARI(  ::haxe::ds::StringMap,h) =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );

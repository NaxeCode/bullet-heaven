...
::hxcpp::debug::jsonrpc::eval::FieldAccess FieldAccess_obj::AInline;

::hxcpp::debug::jsonrpc::eval::FieldAccess FieldAccess_obj::AMacro;

::hxcpp::debug::jsonrpc::eval::FieldAccess FieldAccess_obj::AOverride;

::hxcpp::debug::jsonrpc::eval::FieldAccess FieldAccess_obj::APrivate;

::hxcpp::debug::jsonrpc::eval::FieldAccess FieldAccess_obj::APublic;

::hxcpp::debug::jsonrpc::eval::FieldAccess FieldAccess_obj::AStatic;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("hxcpp.debug.jsonrpc.eval.FieldAccess",53,6b,93,6d), ::hx::TCanCast< FieldAccess_obj >,FieldAccess_obj_sStaticFields,0,

...
HXLINE(  27)		this->variables->set(HX_("null",87,9e,0e,49),null());
...
HXLINE(  81)				v = this->set(this->expr(e),f,v);
            			...
            			break;
            			case (int)16: {
HXLINE(  82)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e3,"e") = e1->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN(  82)				HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,index) = e1->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN(  82)				{
HXLINE(  83)					HX_VARI(  ::Dynamic,arr) = this->expr(e3);
HXLINE(  84)					HX_VARI_NAME(  ::Dynamic,index1,"index") = this->expr(index);
...
HXLINE(  88)						arr->__SetItem(( (int)(index1) ),v);
            			...
            			break;
            			default:{
HXLINE(  92)				 ::hxcpp::debug::jsonrpc::eval::Error e4 = ::hxcpp::debug::jsonrpc::eval::Error_obj::EInvalidOp(HX_("=",3d,00,00,00));
HXDLIN(  92)				HX_STACK_DO_THROW(e4);
            			}
            		}
HXLINE(  94)		return v;
            	}
...
HXLINE( 114)					 ::Dynamic v2 = this->get(obj,f);
HXDLIN( 114)					v = fop(v2,this->expr(e2));
HXLINE( 115)					v = this->set(obj,f,v);
            				}
            			}
            			break;
            			case (int)16: {
HXLINE( 116)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e3,"e") = e1->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 116)				HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,index) = e1->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 116)				{
HXLINE( 117)					HX_VARI(  ::Dynamic,arr) = this->expr(e3);
HXLINE( 118)					HX_VARI_NAME(  ::Dynamic,index1,"index") = this->expr(index);
HXLINE( 119)					if (::Std_obj::isOfType(arr,( ( ::Dynamic)(::hx::ClassOf< ::haxe::IMap >()) ))) {
HXLINE( 120)						 ::Dynamic v3 = ::haxe::IMap_obj::get( ::hx::interface_check(arr,0x09c2bd39),index1);
HXDLIN( 120)						v = fop(v3,this->expr(e2));
...
HXLINE( 124)						arr->__SetItem(( (int)(index1) ),v);
            			...
            			break;
            			default:{
HXLINE( 127)				 ::hxcpp::debug::jsonrpc::eval::Error e4 = ::hxcpp::debug::jsonrpc::eval::Error_obj::EInvalidOp(op);
HXDLIN( 127)				HX_STACK_DO_THROW(e4);
            			}
            		}
HXLINE( 129)		return v;
            	}
...
HXLINE( 147)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 148)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e1,"e") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 148)				HX_VARI( ::String,f) = e->_hx_getString(1);
HXLINE( 149)				HX_VARI(  ::Dynamic,obj) = this->expr(e1);
HXLINE( 150)				HX_VARI_NAME(  ::Dynamic,v1,"v") = this->get(obj,f);
HXLINE( 151)				if (prefix) {
HXLINE( 152)					v1 = (v1 + delta);
HXLINE( 153)					this->set(obj,f,v1);
            				}
            				else {
HXLINE( 155)					this->set(obj,f,(v1 + delta));
            				}
HXLINE( 156)				return v1;
            			}
            			break;
            			case (int)16: {
HXLINE( 157)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e2,"e") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 157)				HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,index) = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 158)				HX_VARI(  ::Dynamic,arr) = this->expr(e2);
HXLINE( 159)				HX_VARI_NAME(  ::Dynamic,index1,"index") = this->expr(index);
HXLINE( 160)				if (::Std_obj::isOfType(arr,( ( ::Dynamic)(::hx::ClassOf< ::haxe::IMap >()) ))) {
HXLINE( 161)					HX_VARI_NAME( int,v2,"v") = ( (int)(::haxe::IMap_obj::get( ::hx::interface_check(arr,0x09c2bd39),index1)) );
HXLINE( 162)					if (prefix) {
HXLINE( 163)						v2 = (v2 + delta);
HXLINE( 164)						::haxe::IMap_obj::set( ::hx::interface_check(arr,0x09c2bd39),index1,v2);
            					}
            					else {
HXLINE( 166)						::haxe::IMap_obj::set( ::hx::interface_check(arr,0x09c2bd39),index1,(v2 + delta));
            					}
HXLINE( 168)					return v2;
            				}
            				else {
HXLINE( 170)					HX_VARI_NAME( int,v3,"v") = ( (int)(arr->__GetItem(( (int)(index1) ))) );
HXLINE( 171)					if (prefix) {
HXLINE( 172)						v3 = (v3 + delta);
HXLINE( 173)						arr->__SetItem(( (int)(index1) ),v3);
            					}
            					else {
HXLINE( 175)						arr->__SetItem(( (int)(index1) ),(v3 + delta));
            					}
HXLINE( 176)					return v3;
            				}
            			}
            			break;
            			default:{
HXLINE( 179)				::String e3;
HXDLIN( 179)				if ((delta > 0)) {
HXLINE( 179)					e3 = HX_("++",a0,25,00,00);
            				}
            				else {
HXLINE( 179)					e3 = HX_("--",60,27,00,00);
            				}
HXDLIN( 179)				 ::hxcpp::debug::jsonrpc::eval::Error e4 = ::hxcpp::debug::jsonrpc::eval::Error_obj::EInvalidOp(e3);
HXDLIN( 179)				HX_STACK_DO_THROW(e4);
            			}
            		}
...
HXLINE( 191)
HXDLIN( 191)		try {
            			HX_STACK_CATCHABLE( ::hxcpp::debug::jsonrpc::eval::_Interp::Stop, 0);
            			HX_STACK_CATCHABLE( ::haxe::ValueException, 1);
HXLINE( 192)			return this->expr(e);
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::hxcpp::debug::jsonrpc::eval::_Interp::Stop >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::hxcpp::debug::jsonrpc::eval::_Interp::Stop e11 = _hx_e;
HXLINE( 194)				switch((int)(e11->_hx_getIndex())){
            					case (int)0: {
HXLINE( 196)						HX_STACK_DO_THROW(HX_("Invalid break",b6,ee,24,9d));
            					}
            					break;
            					case (int)1: {
HXLINE( 198)						HX_STACK_DO_THROW(HX_("Invalid continue",d0,6a,b7,3f));
            					}
            					break;
            					case (int)2: {
HXLINE( 200)						HX_VARI_NAME(  ::Dynamic,v1,"v") = this->returnValue;
HXLINE( 201)						this->returnValue = null();
HXLINE( 202)						return v1;
            					}
            					break;
            				}
            			}
...
HXLINE( 191)				if (::Std_obj::isOfType(_g->value,::hx::ClassOf< ::hxcpp::debug::jsonrpc::eval::_Interp::Stop >())) {
HXLINE( 193)					HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::_Interp::Stop,e11,"e1") = _g->value;
HXLINE( 194)					switch((int)(e11->_hx_getIndex())){
            						case (int)0: {
HXLINE( 196)							HX_STACK_DO_THROW(HX_("Invalid break",b6,ee,24,9d));
            						}
...
HXLINE( 210)				HX_VARI_NAME( ::String,k1,"k") = ( (::String)(k->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 224)			HX_STACK_DO_THROW(e);
            		}
            		else {
HXLINE( 226)			HX_STACK_DO_THROW(e);
            		}
...
void Interp_obj::rethrow( ::Dynamic e){
            	...
            	HX_STACK_ARG(e,"e")
HXLINE( 231)
HXDLIN( 231)		HX_STACK_DO_THROW(e);
            	}
...
HXDLIN( 242)				HX_STACK_DO_THROW(e);
            			}
            		}
HXLINE( 244)		return v;
            	}
...
HXDLIN( 257)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e1,"e") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
...
HXLINE( 260)				return null();
            			...
            			break;
            			case (int)3: {
HXLINE( 261)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e2,"e") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 262)				return this->expr(e2);
            			}
            			break;
            			case (int)4: {
...
HXLINE( 265)				HX_VARI_NAME(  ::Dynamic,v1,"v") = null();
HXLINE( 266)				{
HXLINE( 266)					int _g1 = 0;
HXDLIN( 266)					while((_g1 < exprs->length)){
HXLINE( 266)						HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e3,"e") = exprs->__get(_g1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 266)						_g1 = (_g1 + 1);
HXLINE( 267)						v1 = this->expr(e3);
            					}
            				}
HXLINE( 268)				this->restore(old);
HXLINE( 269)				return v1;
            			}
            			break;
            			case (int)5: {
HXLINE( 270)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e4,"e") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 270)				HX_VARI_NAME( ::String,f1,"f") = e->_hx_getString(1);
HXLINE( 271)				return this->get(this->expr(e4),f1);
            			}
            			break;
            			case (int)6: {
HXLINE( 272)				HX_VARI( ::String,op) = e->_hx_getString(0);
HXDLIN( 272)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e11,"e1") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 272)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e21,"e2") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 273)				HX_VARI(  ::Dynamic,fop) = this->binops->get(op);
HXLINE( 274)				if (::hx::IsNull( fop )) {
HXLINE( 275)					 ::hxcpp::debug::jsonrpc::eval::Error e5 = ::hxcpp::debug::jsonrpc::eval::Error_obj::EInvalidOp(op);
HXDLIN( 275)					HX_STACK_DO_THROW(e5);
            				}
HXLINE( 276)				return fop(e11,e21);
            			}
            			break;
            			case (int)7: {
HXLINE( 277)				HX_VARI_NAME( ::String,op1,"op") = e->_hx_getString(0);
HXDLIN( 277)				HX_VARI( bool,prefix) = e->_hx_getBool(1);
HXDLIN( 277)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e6,"e") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 278)				::String _hx_switch_0 = op1;
            				if (  (_hx_switch_0==HX_("!",21,00,00,00)) ){
HXLINE( 280)					return ::hx::IsNotEq( this->expr(e6),true );
HXDLIN( 280)					goto _hx_goto_48;
            				}
            				if (  (_hx_switch_0==HX_("++",a0,25,00,00)) ){
HXLINE( 284)					return this->increment(e6,prefix,1);
HXDLIN( 284)					goto _hx_goto_48;
            				}
            				if (  (_hx_switch_0==HX_("-",2d,00,00,00)) ){
HXLINE( 282)					return -(this->expr(e6));
HXDLIN( 282)					goto _hx_goto_48;
            				}
            				if (  (_hx_switch_0==HX_("--",60,27,00,00)) ){
HXLINE( 286)					return this->increment(e6,prefix,-1);
HXDLIN( 286)					goto _hx_goto_48;
            				}
            				if (  (_hx_switch_0==HX_("~",7e,00,00,00)) ){
HXLINE( 288)					return ~(( (int)(this->expr(e6)) ));
HXDLIN( 288)					goto _hx_goto_48;
            				}
            				/* default */{
HXLINE( 290)					 ::hxcpp::debug::jsonrpc::eval::Error e7 = ::hxcpp::debug::jsonrpc::eval::Error_obj::EInvalidOp(op1);
HXDLIN( 290)					HX_STACK_DO_THROW(e7);
            				}
            				_hx_goto_48:;
            			}
            			break;
            			case (int)8: {
HXLINE( 292)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e8,"e") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
...
HXDLIN( 294)					while((_g2 < params->length)){
HXLINE( 294)						HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,p) = params->__get(_g2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 294)						_g2 = (_g2 + 1);
HXLINE( 295)						args->push(this->expr(p));
            					}
            				}
HXLINE( 297)				if ((e8->_hx_getIndex() == 5)) {
HXLINE( 298)					HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e9,"e") = e8->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 298)					HX_VARI_NAME( ::String,f2,"f") = e8->_hx_getString(1);
HXLINE( 299)					HX_VARI(  ::Dynamic,obj) = this->expr(e9);
HXLINE( 300)					if (::hx::IsNull( obj )) {
HXLINE( 300)						 ::hxcpp::debug::jsonrpc::eval::Error e10 = ::hxcpp::debug::jsonrpc::eval::Error_obj::EInvalidAccess(f2);
HXDLIN( 300)						HX_STACK_DO_THROW(e10);
            					}
HXLINE( 301)					return this->fcall(obj,f2,args);
            				}
            				else {
HXLINE( 303)					return this->call(null(),this->expr(e8),args);
            				}
            			}
            			break;
            			case (int)9: {
HXLINE( 305)				HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,econd) = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 305)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e12,"e1") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 305)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e22,"e2") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 306)				if (::hx::IsEq( this->expr(econd),true )) {
HXLINE( 306)					return this->expr(e12);
            				}
            				else {
HXLINE( 306)					if (::hx::IsNull( e22 )) {
HXLINE( 306)						return null();
            					}
            					else {
HXLINE( 306)						return this->expr(e22);
            					}
            				}
            			}
            			break;
            			case (int)10: {
HXLINE( 307)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,econd1,"econd") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 307)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e13,"e") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 308)				this->whileLoop(econd1,e13);
HXLINE( 309)				return null();
            			}
            			break;
            			case (int)11: {
HXLINE( 313)				HX_VARI_NAME( ::String,v2,"v") = e->_hx_getString(0);
HXDLIN( 313)				HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,it) = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 313)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e14,"e") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 314)				this->forLoop(v2,it,e14);
HXLINE( 315)				return null();
            			}
            			break;
            			case (int)12: {
HXLINE( 317)				HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::_Interp::Stop_obj::SBreak_dyn());
            			}
            			break;
            			case (int)13: {
HXLINE( 319)				HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::_Interp::Stop_obj::SContinue_dyn());
            			}
            			break;
            			case (int)14: {
            				HX_BEGIN_LOCAL_FUNC_S7(::hx::LocalFunc,_hx_Closure_0,::String,name, ::hxcpp::debug::jsonrpc::eval::Expr,fexpr, ::hxcpp::debug::jsonrpc::eval::Interp,_gthis,::Array< int >,minParams, ::hxcpp::debug::jsonrpc::eval::Interp,me, ::haxe::ds::StringMap,capturedLocals,::Array< ::Dynamic>,params1) HXARGC(1)
            				 ::Dynamic _hx_run(::cpp::VirtualArray args){
            					HX_STACKFRAME(&_hx_pos_515bc5e2ef25e982_332_expr)
            					HX_STACK_ARG(args,"args")
HXLINE( 332)
HXLINE( 333)					if ((args->get_length() != params1->length)) {
...
HXLINE( 338)							HX_STACK_DO_THROW(str);
            						}
...
HXLINE( 344)						{
HXLINE( 344)							int _g = 0;
HXDLIN( 344)							while((_g < params1->length)){
HXLINE( 344)								HX_VARI(  ::Dynamic,p) = params1->__get(_g);
HXDLIN( 344)								_g = (_g + 1);
...
HXDLIN( 358)						int _g2 = params1->length;
HXDLIN( 358)						while((_g1 < _g2)){
HXLINE( 358)							_g1 = (_g1 + 1);
HXDLIN( 358)							HX_VARI( int,i) = (_g1 - 1);
HXLINE( 359)							me->locals->set(( (::String)(params1->__get(i)->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) ), ::Dynamic(::hx::Anon_obj::Create(1)
...
HXDLIN( 364)								HX_VARI(  ::Dynamic,e) = _g3;
HXLINE( 365)								me->locals = old;
HXLINE( 366)								me->depth = depth;
HXLINE( 367)								HX_STACK_DO_THROW(e);
            							}
            							else {
            								HX_STACK_DO_THROW(_hx_e);
            							}
...
HXLINE( 323)				 ::hxcpp::debug::jsonrpc::eval::CType _g3 = e->_hx_getObject(3).StaticCast<  ::hxcpp::debug::jsonrpc::eval::CType >();
HXDLIN( 323)				HX_VARI_NAME( ::Array< ::Dynamic>,params1,"params") = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXDLIN( 327)					while((_g4 < params1->length)){
HXLINE( 327)						HX_VARI_NAME(  ::Dynamic,p1,"p") = params1->__get(_g4);
HXDLIN( 327)						_g4 = (_g4 + 1);
HXLINE( 328)						if (( (bool)(p1->__Field(HX_("opt",33,9c,54,00),::hx::paccDynamic)) )) {
...
HXLINE( 332)				HX_VARI_NAME(  ::Dynamic,f3,"f") =  ::Dynamic(new _hx_Closure_0(name,fexpr,_gthis,minParams,me,capturedLocals,params1));
HXLINE( 374)				HX_VARI_NAME(  ::Dynamic,f4,"f") = ::Reflect_obj::makeVarArgs(f3);
HXLINE( 375)				if (::hx::IsNotNull( name )) {
HXLINE( 376)					if ((this->depth == 0)) {
HXLINE( 378)						this->variables->set(name,f4);
            					}
            					else {
HXLINE( 381)						::Array< ::Dynamic> _hx_tmp1 = this->declared;
HXDLIN( 381)						::String name1 = name;
HXDLIN( 381)						_hx_tmp1->push( ::Dynamic(::hx::Anon_obj::Create(2)
...
HXLINE( 387)				return f4;
            			}
            			break;
            			case (int)15: {
HXLINE( 320)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e15,"e") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 321)				 ::Dynamic _hx_tmp2;
HXDLIN( 321)				if (::hx::IsNull( e15 )) {
HXLINE( 321)					_hx_tmp2 = null();
            				}
            				else {
HXLINE( 321)					_hx_tmp2 = this->expr(e15);
            				}
HXDLIN( 321)				this->returnValue = _hx_tmp2;
HXLINE( 322)				HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::_Interp::Stop_obj::SReturn_dyn());
            			}
            			break;
            			case (int)16: {
HXLINE( 434)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e16,"e") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 434)				HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,index) = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 435)				HX_VARI(  ::Dynamic,arr) = this->expr(e16);
HXLINE( 436)				HX_VARI_NAME(  ::Dynamic,index1,"index") = this->expr(index);
...
HXLINE( 440)					return arr->__GetItem(( (int)(index1) ));
            			...
            			break;
            			case (int)17: {
HXLINE( 388)				HX_VARI_NAME( ::Array< ::Dynamic>,arr1,"arr") = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 389)				bool _hx_tmp3;
HXDLIN( 389)				if ((arr1->length > 0)) {
HXLINE( 389)					 ::hxcpp::debug::jsonrpc::eval::Expr _g5 = arr1->__get(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 389)					if ((_g5->_hx_getIndex() == 6)) {
HXLINE( 389)						 ::hxcpp::debug::jsonrpc::eval::Expr _g6 = _g5->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 389)						 ::hxcpp::debug::jsonrpc::eval::Expr _g7 = _g5->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 389)						if ((_g5->_hx_getString(0) == HX_("=>",61,35,00,00))) {
...
HXDLIN( 396)						while((_g8 < arr1->length)){
HXLINE( 396)							HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e17,"e") = arr1->__get(_g8).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 396)							_g8 = (_g8 + 1);
HXLINE( 397)							if ((e17->_hx_getIndex() == 6)) {
HXLINE( 398)								if ((e17->_hx_getString(0) == HX_("=>",61,35,00,00))) {
HXLINE( 398)									HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,eKey) = e17->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 398)									HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,eValue) = e17->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 398)									{
HXLINE( 399)										HX_VARI(  ::Dynamic,key) = this->expr(eKey);
HXLINE( 400)										HX_VARI_NAME(  ::Dynamic,value1,"value") = this->expr(eValue);
...
HXLINE( 406)										values->push(value1);
            									}
            								}
            								else {
HXLINE( 408)									HX_STACK_DO_THROW(HX_("=> expected",17,e5,65,e5));
            								}
            							}
            							else {
HXLINE( 408)								HX_STACK_DO_THROW(HX_("=> expected",17,e5,65,e5));
...
HXLINE( 421)									HX_STACK_DO_THROW(HX_("Inconsistent key types",af,4f,50,a9));
            								}
            							}
            						}
            					}
HXLINE( 423)					{
HXLINE( 423)						int _g9 = 0;
HXDLIN( 423)						int _g10 = keys->get_length();
HXDLIN( 423)						while((_g9 < _g10)){
HXLINE( 423)							_g9 = (_g9 + 1);
HXDLIN( 423)							HX_VARI_NAME( int,n1,"n") = (_g9 - 1);
HXLINE( 424)							::haxe::IMap_obj::set( ::hx::interface_check(map,0x09c2bd39),keys->__get(n1),values->__get(n1));
            						}
            					}
...
HXLINE( 429)					{
HXLINE( 429)						int _g11 = 0;
HXDLIN( 429)						while((_g11 < arr1->length)){
HXLINE( 429)							HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e18,"e") = arr1->__get(_g11).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 429)							_g11 = (_g11 + 1);
HXLINE( 430)							a->push(this->expr(e18));
            						}
            					}
HXLINE( 432)					return a;
            				}
...
HXDLIN( 442)				HX_VARI_NAME( ::Array< ::Dynamic>,params2,"params") = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 443)				HX_VARI_NAME( ::cpp::VirtualArray,a1,"a") = ::cpp::VirtualArray_obj::__new();
HXLINE( 444)				{
HXLINE( 444)					int _g12 = 0;
HXDLIN( 444)					while((_g12 < params2->length)){
HXLINE( 444)						HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e19,"e") = params2->__get(_g12).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 444)						_g12 = (_g12 + 1);
HXLINE( 445)						a1->push(this->expr(e19));
            					}
            				}
HXLINE( 446)				return this->cnew(cl,a1);
            			}
            			break;
            			case (int)19: {
HXLINE( 447)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e20,"e") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 448)				HX_STACK_DO_THROW(this->expr(e20));
            			}
            			break;
            			case (int)20: {
HXLINE( 449)				 ::hxcpp::debug::jsonrpc::eval::CType _g13 = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::CType >();
HXDLIN( 449)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e23,"e") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 449)				HX_VARI_NAME( ::String,n2,"n") = e->_hx_getString(1);
HXDLIN( 449)				HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,ecatch) = e->_hx_getObject(3).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 450)				HX_VARI_NAME( int,old1,"old") = this->declared->length;
...
HXLINE( 454)					HX_VARI_NAME(  ::Dynamic,v3,"v") = this->expr(e23);
HXLINE( 455)					this->restore(old1);
HXLINE( 456)					this->inTry = oldTry;
HXLINE( 457)					return v3;
            				} catch( ::Dynamic _hx_e) {
            					if (_hx_e.IsClass<  ::hxcpp::debug::jsonrpc::eval::_Interp::Stop >() ){
            						HX_STACK_BEGIN_CATCH
            						 ::hxcpp::debug::jsonrpc::eval::_Interp::Stop err1 = _hx_e;
HXLINE( 459)						this->inTry = oldTry;
HXLINE( 460)						HX_STACK_DO_THROW(err1);
            					}
            					else if (_hx_e.IsClass<  ::haxe::ValueException >() ){
            						HX_STACK_BEGIN_CATCH
...
HXLINE( 452)						if (::Std_obj::isOfType(_g14->value,::hx::ClassOf< ::hxcpp::debug::jsonrpc::eval::_Interp::Stop >())) {
HXLINE( 458)							HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::_Interp::Stop,err1,"err") = _g14->value;
HXLINE( 459)							this->inTry = oldTry;
HXLINE( 460)							HX_STACK_DO_THROW(err1);
            						}
            						else {
HXLINE( 452)							HX_STACK_DO_THROW(_g14);
            						}
            					}
...
HXDLIN( 461)						HX_VARI_NAME(  ::Dynamic,err2,"err") = _g15;
HXLINE( 463)						this->restore(old1);
HXLINE( 464)						this->inTry = oldTry;
HXLINE( 466)						::Array< ::Dynamic> _hx_tmp4 = this->declared;
HXDLIN( 466)						_hx_tmp4->push( ::Dynamic(::hx::Anon_obj::Create(2)
            							->setFixed(0,HX_("n",6e,00,00,00),n2)
            							->setFixed(1,HX_("old",a7,98,54,00),this->locals->get(n2))));
HXLINE( 467)						this->locals->set(n2, ::Dynamic(::hx::Anon_obj::Create(1)
            							->setFixed(0,HX_("r",72,00,00,00),err2)));
HXLINE( 468)						HX_VARI_NAME(  ::Dynamic,v4,"v") = this->expr(ecatch);
HXLINE( 469)						this->restore(old1);
HXLINE( 470)						return v4;
            					}
            					else {
            						HX_STACK_DO_THROW(_hx_e);
            					}
...
HXDLIN( 474)					while((_g16 < fl->length)){
HXLINE( 474)						HX_VARI_NAME(  ::Dynamic,f5,"f") = fl->__get(_g16);
HXDLIN( 474)						_g16 = (_g16 + 1);
HXLINE( 475)						::String f6 = ( (::String)(f5->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) );
HXDLIN( 475)						this->set(o,f6,this->expr(f5->__Field(HX_("e",65,00,00,00),::hx::paccDynamic)));
            					}
            				}
HXLINE( 476)				return o;
            			}
            			break;
            			case (int)22: {
HXLINE( 477)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,econd2,"econd") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 477)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e110,"e1") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 477)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e24,"e2") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 478)				if (::hx::IsEq( this->expr(econd2),true )) {
HXLINE( 478)					return this->expr(e110);
            				}
            				else {
HXLINE( 478)					return this->expr(e24);
            				}
            			}
            			break;
            			case (int)23: {
HXLINE( 479)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e25,"e") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
...
HXLINE( 480)				HX_VARI(  ::Dynamic,val) = this->expr(e25);
HXLINE( 481)				HX_VARI( bool,match) = false;
HXLINE( 482)				{
HXLINE( 482)					int _g17 = 0;
HXDLIN( 482)					while((_g17 < cases->length)){
HXLINE( 482)						HX_VARI_NAME(  ::Dynamic,c1,"c") = cases->__get(_g17);
HXDLIN( 482)						_g17 = (_g17 + 1);
HXLINE( 483)						{
HXLINE( 483)							int _g18 = 0;
HXDLIN( 483)							::Array< ::Dynamic> _g19 = ( (::Array< ::Dynamic>)(c1->__Field(HX_("values",e2,03,b7,4f),::hx::paccDynamic)) );
HXDLIN( 483)							while((_g18 < _g19->length)){
HXLINE( 483)								HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,v5,"v") = _g19->__get(_g18).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 483)								_g18 = (_g18 + 1);
HXLINE( 484)								if (::hx::IsEq( this->expr(v5),val )) {
...
HXLINE( 488)						if (match) {
HXLINE( 489)							val = this->expr(c1->__Field(HX_("expr",35,fd,1d,43),::hx::paccDynamic));
...
HXLINE( 495)				return val;
            			...
            			break;
            			case (int)24: {
HXLINE( 310)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,econd3,"econd") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 310)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e26,"e") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 311)				this->doWhileLoop(econd3,e26);
HXLINE( 312)				return null();
            			}
            			break;
            			case (int)25: {
HXLINE( 496)				::String _g20 = e->_hx_getString(0);
HXDLIN( 496)				::Array< ::Dynamic> _g21 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 496)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e27,"e") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 497)				return this->expr(e27);
            			}
            			break;
            			case (int)26: {
HXLINE( 498)				 ::hxcpp::debug::jsonrpc::eval::CType _g22 = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::CType >();
HXDLIN( 498)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e28,"e") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 499)				return this->expr(e28);
            			}
            			break;
            		}
...
HXLINE( 508)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::hxcpp::debug::jsonrpc::eval::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hxcpp::debug::jsonrpc::eval::_Interp::Stop err1 = _hx_e;
HXLINE( 510)					switch((int)(err1->_hx_getIndex())){
            						case (int)0: {
HXLINE( 513)							goto _hx_goto_63;
            						...
            						break;
            						case (int)2: {
HXLINE( 515)							HX_STACK_DO_THROW(err1);
            						}
            						break;
            					}
            				}
...
HXLINE( 507)					if (::Std_obj::isOfType(_g->value,::hx::ClassOf< ::hxcpp::debug::jsonrpc::eval::_Interp::Stop >())) {
HXLINE( 509)						HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::_Interp::Stop,err1,"err") = _g->value;
HXLINE( 510)						switch((int)(err1->_hx_getIndex())){
            							case (int)0: {
HXLINE( 513)								goto _hx_goto_63;
            							}
...
HXLINE( 526)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::hxcpp::debug::jsonrpc::eval::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hxcpp::debug::jsonrpc::eval::_Interp::Stop err1 = _hx_e;
HXLINE( 528)					switch((int)(err1->_hx_getIndex())){
            						case (int)0: {
HXLINE( 531)							goto _hx_goto_65;
            						...
            						break;
            						case (int)2: {
HXLINE( 533)							HX_STACK_DO_THROW(err1);
            						}
            						break;
            					}
            				}
...
HXLINE( 525)					if (::Std_obj::isOfType(_g->value,::hx::ClassOf< ::hxcpp::debug::jsonrpc::eval::_Interp::Stop >())) {
HXLINE( 527)						HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::_Interp::Stop,err1,"err") = _g->value;
HXLINE( 528)						switch((int)(err1->_hx_getIndex())){
            							case (int)0: {
HXLINE( 531)								goto _hx_goto_65;
            							}
...
HXDLIN( 551)		_hx_tmp->push( ::Dynamic(::hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("n",6e,00,00,00),n)
            			->setFixed(1,HX_("old",a7,98,54,00),this->locals->get(n))));
HXLINE( 552)		HX_VARI_NAME(  ::Dynamic,it1,"it") = this->makeIterator(this->expr(it));
...
HXLINE( 556)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::hxcpp::debug::jsonrpc::eval::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hxcpp::debug::jsonrpc::eval::_Interp::Stop err1 = _hx_e;
HXLINE( 558)					switch((int)(err1->_hx_getIndex())){
            						case (int)0: {
HXLINE( 561)							goto _hx_goto_68;
            						...
            						break;
            						case (int)2: {
HXLINE( 563)							HX_STACK_DO_THROW(err1);
            						}
            						break;
            					}
            				}
...
HXLINE( 555)					if (::Std_obj::isOfType(_g->value,::hx::ClassOf< ::hxcpp::debug::jsonrpc::eval::_Interp::Stop >())) {
HXLINE( 557)						HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::_Interp::Stop,err1,"err") = _g->value;
HXLINE( 558)						switch((int)(err1->_hx_getIndex())){
            							case (int)0: {
HXLINE( 561)								goto _hx_goto_68;
            							}
...
HXDLIN( 584)			HX_STACK_DO_THROW(e);
            		}
...
HXDLIN( 592)			HX_STACK_DO_THROW(e);
            		}

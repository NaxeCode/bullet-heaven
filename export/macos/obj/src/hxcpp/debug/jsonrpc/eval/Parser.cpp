...
HXLINE(  95)				{
HXLINE(  95)					int _g2 = 0;
HXDLIN(  95)					::Array< ::String > _g3 = priorities->__get(i).StaticCast< ::Array< ::String > >();
HXDLIN(  95)					while((_g2 < _g3->length)){
HXLINE(  95)						HX_VARI( ::String,x) = _g3->__get(_g2);
HXDLIN(  95)						_g2 = (_g2 + 1);
...
HXLINE( 100)		{
HXLINE( 100)			{
HXLINE( 100)				HX_VARI( ::String,x1) = HX_("!",21,00,00,00);
HXLINE( 101)				{
HXLINE( 101)					bool _hx_tmp;
HXDLIN( 101)					if ((x1 != HX_("++",a0,25,00,00))) {
HXLINE( 101)						_hx_tmp = (x1 == HX_("--",60,27,00,00));
            					}
            					else {
HXLINE( 101)						_hx_tmp = true;
            					}
HXDLIN( 101)					this->unops->set(x1,_hx_tmp);
            				}
            			}
HXLINE( 100)			{
HXLINE( 100)				HX_VARI( ::String,x2) = HX_("++",a0,25,00,00);
HXLINE( 101)				{
HXLINE( 101)					bool _hx_tmp1;
HXDLIN( 101)					if ((x2 != HX_("++",a0,25,00,00))) {
HXLINE( 101)						_hx_tmp1 = (x2 == HX_("--",60,27,00,00));
            					}
            					else {
HXLINE( 101)						_hx_tmp1 = true;
            					}
HXDLIN( 101)					this->unops->set(x2,_hx_tmp1);
            				}
            			}
HXLINE( 100)			{
HXLINE( 100)				HX_VARI( ::String,x3) = HX_("--",60,27,00,00);
HXLINE( 101)				{
HXLINE( 101)					bool _hx_tmp2;
HXDLIN( 101)					if ((x3 != HX_("++",a0,25,00,00))) {
HXLINE( 101)						_hx_tmp2 = (x3 == HX_("--",60,27,00,00));
            					}
            					else {
HXLINE( 101)						_hx_tmp2 = true;
            					}
HXDLIN( 101)					this->unops->set(x3,_hx_tmp2);
            				}
            			}
HXLINE( 100)			{
HXLINE( 100)				HX_VARI( ::String,x4) = HX_("-",2d,00,00,00);
HXLINE( 101)				{
HXLINE( 101)					bool _hx_tmp3;
HXDLIN( 101)					if ((x4 != HX_("++",a0,25,00,00))) {
HXLINE( 101)						_hx_tmp3 = (x4 == HX_("--",60,27,00,00));
            					}
            					else {
HXLINE( 101)						_hx_tmp3 = true;
            					}
HXDLIN( 101)					this->unops->set(x4,_hx_tmp3);
            				}
            			}
HXLINE( 100)			{
HXLINE( 100)				HX_VARI( ::String,x5) = HX_("~",7e,00,00,00);
HXLINE( 101)				{
HXLINE( 101)					bool _hx_tmp4;
HXDLIN( 101)					if ((x5 != HX_("++",a0,25,00,00))) {
HXLINE( 101)						_hx_tmp4 = (x5 == HX_("--",60,27,00,00));
            					}
            					else {
HXLINE( 101)						_hx_tmp4 = true;
            					}
HXDLIN( 101)					this->unops->set(x5,_hx_tmp4);
            				}
            			}
            		}
            	}
...
HXLINE( 105)
HXDLIN( 105)		HX_STACK_DO_THROW(err);
            	}
...
void Parser_obj::invalidChar(int c){
            	...
            	HX_STACK_ARG(c,"c")
HXLINE( 109)
HXDLIN( 109)		HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::Error_obj::EInvalidChar(c));
            	}
...
HXDLIN( 126)				HX_VARI_NAME( int,i1,"i") = (_g2 - 1);
HXLINE( 127)				this->idents[( (int)(this->identChars.charCodeAt(i1)) )] = true;
            			}
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(Parser_obj,parse,return )
 ...
 ::Dynamic Parser_obj::unexpected( ::hxcpp::debug::jsonrpc::eval::Token tk){
            	...
            	HX_STACK_ARG(tk,"tk")
HXLINE( 149)
HXDLIN( 149)		HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::Error_obj::EUnexpected(this->tokenString(tk)));
...
HXDLIN( 208)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e1,"e") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
...
HXLINE( 208)								::Array< ::Dynamic> _g1 = t->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE( 208)						return false;
            			...
            			break;
            			case (int)4: {
HXLINE( 206)				::Array< ::Dynamic> _g2 = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 206)				return true;
            			}
            			break;
            			case (int)6: {
HXLINE( 210)				::String _g3 = e->_hx_getString(0);
HXDLIN( 210)				 ::hxcpp::debug::jsonrpc::eval::Expr _g4 = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 210)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e2,"e") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 210)				return this->isBlock(e2);
            			}
            			break;
            			case (int)7: {
HXLINE( 211)				::String _g5 = e->_hx_getString(0);
HXDLIN( 211)				HX_VARI( bool,prefix) = e->_hx_getBool(1);
HXDLIN( 211)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e3,"e") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 211)				if (!(prefix)) {
HXLINE( 211)					return this->isBlock(e3);
            				}
            				else {
HXLINE( 211)					return false;
            			...
            			break;
            			case (int)9: {
HXLINE( 209)				 ::hxcpp::debug::jsonrpc::eval::Expr _g6 = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 209)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e11,"e1") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 209)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e21,"e2") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 209)				if (::hx::IsNotNull( e21 )) {
HXLINE( 209)					return this->isBlock(e21);
            				}
            				else {
HXLINE( 209)					return this->isBlock(e11);
            				}
            			}
            			break;
            			case (int)10: {
HXLINE( 212)				 ::hxcpp::debug::jsonrpc::eval::Expr _g7 = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 212)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e4,"e") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 212)				return this->isBlock(e4);
            			}
            			break;
            			case (int)11: {
HXLINE( 214)				::String _g8 = e->_hx_getString(0);
HXDLIN( 214)				 ::hxcpp::debug::jsonrpc::eval::Expr _g9 = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 214)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e5,"e") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 214)				return this->isBlock(e5);
            			}
            			break;
            			case (int)14: {
HXLINE( 207)				::Array< ::Dynamic> _g10 = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 207)				::String _g11 = e->_hx_getString(2);
HXDLIN( 207)				 ::hxcpp::debug::jsonrpc::eval::CType _g12 = e->_hx_getObject(3).StaticCast<  ::hxcpp::debug::jsonrpc::eval::CType >();
HXDLIN( 207)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e6,"e") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 207)				return this->isBlock(e6);
            			}
            			break;
            			case (int)15: {
HXLINE( 215)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e7,"e") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 215)				if (::hx::IsNotNull( e7 )) {
HXLINE( 215)					return this->isBlock(e7);
            				}
            				else {
HXLINE( 215)					return false;
            			...
            			break;
            			case (int)20: {
HXLINE( 216)				 ::hxcpp::debug::jsonrpc::eval::Expr _g13 = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 216)				::String _g14 = e->_hx_getString(1);
HXDLIN( 216)				 ::hxcpp::debug::jsonrpc::eval::CType _g15 = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::CType >();
HXDLIN( 216)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e8,"e") = e->_hx_getObject(3).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 216)				return this->isBlock(e8);
            			}
            			break;
            			case (int)21: {
HXLINE( 206)				::Array< ::Dynamic> _g16 = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 206)				return true;
            			}
            			break;
            			case (int)23: {
HXLINE( 206)				 ::hxcpp::debug::jsonrpc::eval::Expr _g17 = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 206)				::Array< ::Dynamic> _g18 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 206)				 ::hxcpp::debug::jsonrpc::eval::Expr _g19 = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 206)				return true;
            			}
            			break;
            			case (int)24: {
HXLINE( 213)				 ::hxcpp::debug::jsonrpc::eval::Expr _g20 = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 213)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e9,"e") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 213)				return this->isBlock(e9);
            			}
            			break;
            			case (int)25: {
HXLINE( 217)				::String _g21 = e->_hx_getString(0);
HXDLIN( 217)				::Array< ::Dynamic> _g22 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 217)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e10,"e") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 217)				return this->isBlock(e10);
            			}
            			break;
            			default:{
...
HXLINE( 228)				 ::hxcpp::debug::jsonrpc::eval::Expr _g = e;
HXDLIN( 228)				if ((_g->_hx_getIndex() == 2)) {
HXLINE( 228)					::String _g1 = _g->_hx_getString(0);
HXDLIN( 228)					 ::hxcpp::debug::jsonrpc::eval::CType _g2 = _g->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::CType >();
HXDLIN( 228)					 ::hxcpp::debug::jsonrpc::eval::Expr _g3 = _g->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
...
HXLINE( 234)			_hx_tmp1 = ::hx::IsPointerNotEq( tk,::hxcpp::debug::jsonrpc::eval::Token_obj::TEof_dyn() );
            		}
            		else {
...
HXLINE( 359)						HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e1,"e") = this->parseExpr();
HXLINE( 360)						if ((op == HX_("-",2d,00,00,00))) {
HXLINE( 361)							 ::hxcpp::debug::jsonrpc::eval::Expr _g = e1;
HXDLIN( 361)							if ((_g->_hx_getIndex() == 0)) {
HXLINE( 364)								 ::hxcpp::debug::jsonrpc::eval::Const _g1 = _g->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Const >();
HXDLIN( 364)								switch((int)(_g1->_hx_getIndex())){
            									case (int)0: {
HXLINE( 362)										HX_VARI( int,i) = _g1->_hx_getInt(0);
HXLINE( 363)										return ::hxcpp::debug::jsonrpc::eval::Expr_obj::EConst(::hxcpp::debug::jsonrpc::eval::Const_obj::CInt(-(i)));
            									}
            									break;
            									case (int)1: {
HXLINE( 364)										HX_VARI( Float,f) = _g1->_hx_getFloat(0);
...
HXLINE( 368)						return this->makeUnop(op,e1);
            					}
HXLINE( 370)					return this->unexpected(tk);
            				}
            				break;
            				case (int)4: {
HXLINE( 288)					HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e2,"e") = this->parseExpr();
HXLINE( 289)					tk = this->token();
HXLINE( 290)					if (::hx::IsNotNull( tk )) {
HXLINE( 290)						switch((int)(tk->_hx_getIndex())){
            							case (int)5: {
HXLINE( 292)								return this->parseExprNext(::hxcpp::debug::jsonrpc::eval::Expr_obj::EParent(e2));
            							}
            							break;
            							case (int)9: {
HXLINE( 307)								 ::hxcpp::debug::jsonrpc::eval::Expr _g2 = e2;
HXDLIN( 307)								if ((_g2->_hx_getIndex() == 1)) {
HXLINE( 308)									HX_VARI( ::String,v) = _g2->_hx_getString(0);
...
HXLINE( 296)									switch((int)(tk->_hx_getIndex())){
            										case (int)5: {
HXLINE( 298)											return this->parseExprNext(::hxcpp::debug::jsonrpc::eval::Expr_obj::ECheckType(e2,t));
            										}
            										break;
            										case (int)9: {
HXLINE( 300)											 ::hxcpp::debug::jsonrpc::eval::Expr _g3 = e2;
HXDLIN( 300)											if ((_g3->_hx_getIndex() == 1)) {
HXLINE( 301)												HX_VARI_NAME( ::String,v1,"v") = _g3->_hx_getString(0);
...
HXLINE( 316)						switch((int)(tk->_hx_getIndex())){
            							case (int)1: {
HXLINE( 328)								HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Const,c1,"c") = tk->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Const >();
HXLINE( 329)								if (this->allowJSON) {
HXLINE( 330)									if ((c1->_hx_getIndex() == 2)) {
HXLINE( 331)										::String _g4 = c1->_hx_getString(0);
HXDLIN( 331)										{
HXLINE( 332)											HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Token,tk2) = this->token();
HXLINE( 333)											{
HXLINE( 333)												 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this1 = this->tokens;
HXDLIN( 333)												_this1->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk2,_this1->head);
            											}
HXLINE( 334)											{
HXLINE( 334)												 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this2 = this->tokens;
HXDLIN( 334)												_this2->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this2->head);
            											}
...
HXLINE( 341)										 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this3 = this->tokens;
HXDLIN( 341)										_this3->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this3->head);
            									}
            								}
            								else {
HXLINE( 343)									 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this4 = this->tokens;
HXDLIN( 343)									_this4->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this4->head);
            								}
            							}
            							break;
            							case (int)2: {
HXLINE( 319)								::String _g5 = tk->_hx_getString(0);
HXDLIN( 319)								{
HXLINE( 320)									HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,tk21,"tk2") = this->token();
HXLINE( 321)									{
HXLINE( 321)										 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this5 = this->tokens;
HXDLIN( 321)										_this5->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk21,_this5->head);
            									}
HXLINE( 322)									{
HXLINE( 322)										 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this6 = this->tokens;
HXDLIN( 322)										_this6->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this6->head);
            									}
HXLINE( 323)									if (::hx::IsNotNull( tk21 )) {
HXLINE( 323)										if ((tk21->_hx_getIndex() == 14)) {
...
HXLINE( 318)								return this->parseExprNext(::hxcpp::debug::jsonrpc::eval::Expr_obj::EObject(::Array_obj< ::Dynamic>::__new(0)));
            							...
            							break;
            							default:{
HXLINE( 345)								 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this7 = this->tokens;
HXDLIN( 345)								_this7->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this7->head);
            							}
            						}
            					}
...
HXLINE( 353)						{
HXLINE( 353)							 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this8 = this->tokens;
HXDLIN( 353)							_this8->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this8->head);
            						}
            					}
            					_hx_goto_36:;
HXLINE( 355)					return ::hxcpp::debug::jsonrpc::eval::Expr_obj::EBlock(a);
            				...
            				break;
            				case (int)11: {
HXLINE( 372)					HX_VARI_NAME( ::Array< ::Dynamic>,a1,"a") = ::Array_obj< ::Dynamic>::__new();
HXLINE( 373)					tk = this->token();
HXLINE( 374)					while(::hx::IsPointerNotEq( tk,::hxcpp::debug::jsonrpc::eval::Token_obj::TBkClose_dyn() )){
HXLINE( 375)						{
HXLINE( 375)							 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this9 = this->tokens;
HXDLIN( 375)							_this9->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this9->head);
            						}
HXLINE( 376)						a1->push(this->parseExpr());
...
HXLINE( 381)					if ((a1->length == 1)) {
HXLINE( 382)						 ::hxcpp::debug::jsonrpc::eval::Expr _g6 = a1->__get(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 382)						switch((int)(_g6->_hx_getIndex())){
            							case (int)10: {
HXLINE( 383)								 ::hxcpp::debug::jsonrpc::eval::Expr _g7 = _g6->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 383)								 ::hxcpp::debug::jsonrpc::eval::Expr _g8 = _g6->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 384)								HX_VARI( ::String,tmp) = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 385)								HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e3,"e") = ::hxcpp::debug::jsonrpc::eval::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hxcpp::debug::jsonrpc::eval::Expr_obj::EVar(tmp,null(),::hxcpp::debug::jsonrpc::eval::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp,a1->__get(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >()))->init(2,::hxcpp::debug::jsonrpc::eval::Expr_obj::EIdent(tmp)));
HXLINE( 390)								return this->parseExprNext(e3);
            							}
            							break;
            							case (int)11: {
HXLINE( 383)								::String _g9 = _g6->_hx_getString(0);
HXDLIN( 383)								 ::hxcpp::debug::jsonrpc::eval::Expr _g10 = _g6->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 383)								 ::hxcpp::debug::jsonrpc::eval::Expr _g11 = _g6->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 384)								HX_VARI_NAME( ::String,tmp1,"tmp") = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 385)								HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e4,"e") = ::hxcpp::debug::jsonrpc::eval::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hxcpp::debug::jsonrpc::eval::Expr_obj::EVar(tmp1,null(),::hxcpp::debug::jsonrpc::eval::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp1,a1->__get(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >()))->init(2,::hxcpp::debug::jsonrpc::eval::Expr_obj::EIdent(tmp1)));
HXLINE( 390)								return this->parseExprNext(e4);
            							}
            							break;
            							case (int)24: {
HXLINE( 383)								 ::hxcpp::debug::jsonrpc::eval::Expr _g12 = _g6->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 383)								 ::hxcpp::debug::jsonrpc::eval::Expr _g13 = _g6->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 384)								HX_VARI_NAME( ::String,tmp2,"tmp") = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 385)								HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e5,"e") = ::hxcpp::debug::jsonrpc::eval::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hxcpp::debug::jsonrpc::eval::Expr_obj::EVar(tmp2,null(),::hxcpp::debug::jsonrpc::eval::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp2,a1->__get(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >()))->init(2,::hxcpp::debug::jsonrpc::eval::Expr_obj::EIdent(tmp2)));
HXLINE( 390)								return this->parseExprNext(e5);
            							}
            							break;
            							default:{
            							}
...
HXLINE( 393)					return this->parseExprNext(::hxcpp::debug::jsonrpc::eval::Expr_obj::EArrayDecl(a1));
            				}
            				break;
            				case (int)15: {
HXLINE( 394)					HX_VARI_NAME( ::String,id1,"id") = tk->_hx_getString(0);
HXDLIN( 394)					if (this->allowMetadata) {
HXLINE( 395)						HX_VARI( ::Array< ::Dynamic>,args) = this->parseMetaArgs();
HXLINE( 396)						return ::hxcpp::debug::jsonrpc::eval::Expr_obj::EMeta(id1,args,this->parseExpr());
            					}
            					else {
HXLINE( 398)						return this->unexpected(tk);
            					}
...
HXLINE( 413)						this->unexpected(tk);
            		...
            		_hx_goto_39:;
HXLINE( 416)		{
HXLINE( 416)			 ::hxcpp::debug::jsonrpc::eval::Token t1 = this->token();
HXDLIN( 416)			if (!(__hxcpp_enum_eq(t1,::hxcpp::debug::jsonrpc::eval::Token_obj::TOp(HX_("->",71,27,00,00))))) {
HXLINE( 416)				this->unexpected(t1);
            			}
            		}
...
HXLINE( 430)			{
HXLINE( 430)				 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this1 = this->tokens;
HXDLIN( 430)				_this1->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            			}
...
HXLINE( 437)						HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,tk1,"tk") = _g;
HXLINE( 438)						this->unexpected(tk1);
            					}
            					else {
...
HXLINE( 436)								goto _hx_goto_41;
            							...
            							break;
            							default:{
HXLINE( 437)								HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,tk2,"tk") = _g;
HXLINE( 438)								this->unexpected(tk2);
            							}
            						}
            					}
            				}
...
HXLINE( 455)					HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e1,"e") = _g->__get(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 446)					edef = ::hxcpp::debug::jsonrpc::eval::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(1)->init(0,this->mapCompr(tmp,e1)));
            				}
            				else {
...
HXDLIN( 453)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e11,"e1") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 453)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e21,"e2") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 453)				if (::hx::IsNull( e21 )) {
HXLINE( 446)					edef = ::hxcpp::debug::jsonrpc::eval::Expr_obj::EIf(cond,this->mapCompr(tmp,e11),null());
            				}
            				else {
HXLINE( 446)					edef = ::hxcpp::debug::jsonrpc::eval::Expr_obj::ECall(::hxcpp::debug::jsonrpc::eval::Expr_obj::EField(::hxcpp::debug::jsonrpc::eval::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            				}
            			...
            			break;
            			case (int)10: {
HXLINE( 449)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,cond1,"cond") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 449)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e22,"e2") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 446)				edef = ::hxcpp::debug::jsonrpc::eval::Expr_obj::EWhile(cond1,this->mapCompr(tmp,e22));
            			}
            			break;
            			case (int)11: {
...
HXDLIN( 447)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e23,"e2") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 446)				edef = ::hxcpp::debug::jsonrpc::eval::Expr_obj::EFor(v,it,this->mapCompr(tmp,e23));
            			}
            			break;
            			case (int)24: {
HXLINE( 451)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,cond2,"cond") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 451)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e24,"e2") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE( 446)				edef = ::hxcpp::debug::jsonrpc::eval::Expr_obj::EDoWhile(cond2,this->mapCompr(tmp,e24));
            			}
            			break;
            			default:{
HXLINE( 446)				edef = ::hxcpp::debug::jsonrpc::eval::Expr_obj::ECall(::hxcpp::debug::jsonrpc::eval::Expr_obj::EField(::hxcpp::debug::jsonrpc::eval::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
...
HXDLIN( 467)				return ::hxcpp::debug::jsonrpc::eval::Expr_obj::EBinop(bop,this->makeUnop(op,e1),e2);
            			...
            			break;
            			case (int)22: {
HXLINE( 468)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e11,"e1") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 468)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e21,"e2") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 468)				HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,e3) = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 468)				return ::hxcpp::debug::jsonrpc::eval::Expr_obj::ETernary(this->makeUnop(op,e11),e21,e3);
            			}
            			break;
            			default:{
...
HXLINE( 479)					return ::hxcpp::debug::jsonrpc::eval::Expr_obj::EBinop(op,e1,e);
            			...
            			break;
            			case (int)22: {
HXLINE( 480)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e21,"e2") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 480)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e31,"e3") = e->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
...
HXLINE( 484)					return ::hxcpp::debug::jsonrpc::eval::Expr_obj::ETernary(this->makeBinop(op,e1,e21),e31,e4);
            				}
            			}
            			break;
            			default:{
...
HXLINE( 545)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e1,"e") = this->parseExpr();
HXLINE( 546)			return ::hxcpp::debug::jsonrpc::eval::Expr_obj::EFor(vname,eiter,e1);
HXLINE( 539)			goto _hx_goto_46;
            		}
            		if (  (_hx_switch_0==HX_("function",18,ab,52,14)) ){
HXLINE( 554)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,tk1,"tk") = this->token();
HXLINE( 555)			HX_VARI( ::String,name) = null();
HXLINE( 556)			if (::hx::IsNull( tk1 )) {
HXLINE( 558)				 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this = this->tokens;
HXDLIN( 558)				_this->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk1,_this->head);
            			}
            			else {
HXLINE( 556)				if ((tk1->_hx_getIndex() == 2)) {
HXLINE( 557)					HX_VARI_NAME( ::String,id1,"id") = tk1->_hx_getString(0);
HXDLIN( 557)					name = id1;
            				}
            				else {
HXLINE( 558)					 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this1 = this->tokens;
HXDLIN( 558)					_this1->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk1,_this1->head);
            				}
            			}
...
HXLINE( 493)			{
HXLINE( 493)				 ::hxcpp::debug::jsonrpc::eval::Token t3 = this->token();
HXDLIN( 493)				if (::hx::IsPointerNotEq( t3,::hxcpp::debug::jsonrpc::eval::Token_obj::TPOpen_dyn() )) {
HXLINE( 493)					this->unexpected(t3);
            				}
            			}
HXLINE( 494)			HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,cond) = this->parseExpr();
HXLINE( 495)			{
HXLINE( 495)				 ::hxcpp::debug::jsonrpc::eval::Token t4 = this->token();
HXDLIN( 495)				if (::hx::IsPointerNotEq( t4,::hxcpp::debug::jsonrpc::eval::Token_obj::TPClose_dyn() )) {
HXLINE( 495)					this->unexpected(t4);
            				}
            			}
HXLINE( 496)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e11,"e1") = this->parseExpr();
HXLINE( 497)			HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,e2) = null();
HXLINE( 498)			HX_VARI( bool,semic) = false;
HXLINE( 499)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,tk2,"tk") = this->token();
HXLINE( 500)			if (::hx::IsPointerEq( tk2,::hxcpp::debug::jsonrpc::eval::Token_obj::TSemicolon_dyn() )) {
HXLINE( 501)				semic = true;
HXLINE( 502)				tk2 = this->token();
            			}
HXLINE( 504)			if (__hxcpp_enum_eq(tk2,::hxcpp::debug::jsonrpc::eval::Token_obj::TId(HX_("else",b9,e4,14,43)))) {
HXLINE( 505)				e2 = this->parseExpr();
            			}
            			else {
HXLINE( 507)				{
HXLINE( 507)					 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this2 = this->tokens;
HXDLIN( 507)					_this2->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk2,_this2->head);
            				}
HXLINE( 508)				if (semic) {
HXLINE( 509)					 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this3 = this->tokens;
HXDLIN( 509)					_this3->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,::hxcpp::debug::jsonrpc::eval::Token_obj::TSemicolon_dyn(),_this3->head);
            				}
            			}
HXLINE( 511)			return ::hxcpp::debug::jsonrpc::eval::Expr_obj::EIf(cond,e11,e2);
...
HXLINE( 572)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,tk3,"tk") = this->token();
HXLINE( 573)				if (::hx::IsNull( tk3 )) {
HXLINE( 579)					this->unexpected(tk3);
            				}
            				else {
HXLINE( 573)					switch((int)(tk3->_hx_getIndex())){
            						case (int)4: {
...
HXLINE( 563)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,tk4,"tk") = this->token();
HXLINE( 564)			{
HXLINE( 564)				 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this4 = this->tokens;
HXDLIN( 564)				_this4->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk4,_this4->head);
            			}
HXLINE( 565)			HX_VAR_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e3,"e");
HXDLIN( 565)			if (::hx::IsPointerEq( tk4,::hxcpp::debug::jsonrpc::eval::Token_obj::TSemicolon_dyn() )) {
HXLINE( 565)				e3 = null();
            			}
            			else {
HXLINE( 565)				e3 = this->parseExpr();
            			}
HXLINE( 566)			return ::hxcpp::debug::jsonrpc::eval::Expr_obj::EReturn(e3);
HXLINE( 562)			goto _hx_goto_46;
            		}
            		if (  (_hx_switch_0==HX_("switch",f4,49,79,c5)) ){
HXLINE( 602)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e4,"e") = this->parseExpr();
...
HXLINE( 604)			{
HXLINE( 604)				 ::hxcpp::debug::jsonrpc::eval::Token t5 = this->token();
HXDLIN( 604)				if (::hx::IsPointerNotEq( t5,::hxcpp::debug::jsonrpc::eval::Token_obj::TBrOpen_dyn() )) {
HXLINE( 604)					this->unexpected(t5);
            				}
            			}
HXLINE( 605)			while(true){
HXLINE( 606)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,tk5,"tk") = this->token();
HXLINE( 607)				if (::hx::IsNull( tk5 )) {
HXLINE( 664)					this->unexpected(tk5);
            				}
            				else {
HXLINE( 607)					switch((int)(tk5->_hx_getIndex())){
            						case (int)2: {
HXLINE( 641)							::String _hx_switch_1 = tk5->_hx_getString(0);
...
HXLINE( 612)									HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e5,"e") = this->parseExpr();
HXLINE( 613)									( (::Array< ::Dynamic>)(c->__Field(HX_("values",e2,03,b7,4f),::hx::paccDynamic)) )->push(e5);
HXLINE( 614)									tk5 = this->token();
HXLINE( 615)									if (::hx::IsNull( tk5 )) {
HXLINE( 621)										this->unexpected(tk5);
            									}
            									else {
HXLINE( 615)										switch((int)(tk5->_hx_getIndex())){
            											case (int)9: {
            											}
            											break;
            											case (int)14: {
...
HXLINE( 626)									tk5 = this->token();
HXLINE( 627)									{
HXLINE( 627)										 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this5 = this->tokens;
HXDLIN( 627)										_this5->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk5,_this5->head);
            									}
HXLINE( 628)									if (::hx::IsNull( tk5 )) {
HXLINE( 632)										this->parseFullExpr(exprs);
            									}
            									else {
HXLINE( 628)										switch((int)(tk5->_hx_getIndex())){
            											case (int)2: {
...
HXLINE( 642)									this->unexpected(tk5);
            								}
HXLINE( 643)								{
HXLINE( 643)									 ::hxcpp::debug::jsonrpc::eval::Token t6 = this->token();
HXDLIN( 643)									if (::hx::IsPointerNotEq( t6,::hxcpp::debug::jsonrpc::eval::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 643)										this->unexpected(t6);
            									}
            								}
HXLINE( 644)								HX_VARI_NAME( ::Array< ::Dynamic>,exprs1,"exprs") = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 645)								while(true){
HXLINE( 646)									tk5 = this->token();
HXLINE( 647)									{
HXLINE( 647)										 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this6 = this->tokens;
HXDLIN( 647)										_this6->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk5,_this6->head);
            									}
HXLINE( 648)									if (::hx::IsNull( tk5 )) {
HXLINE( 652)										this->parseFullExpr(exprs1);
            									}
            									else {
HXLINE( 648)										switch((int)(tk5->_hx_getIndex())){
            											case (int)2: {
...
HXLINE( 652)												this->parseFullExpr(exprs1);
            								...
            								_hx_goto_53:;
HXLINE( 655)								if ((exprs1->length == 1)) {
HXLINE( 656)									def = exprs1->__get(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
            								}
            								else {
HXLINE( 657)									if ((exprs1->length == 0)) {
HXLINE( 658)										def = ::hxcpp::debug::jsonrpc::eval::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(0));
            									}
            									else {
HXLINE( 660)										def = ::hxcpp::debug::jsonrpc::eval::Expr_obj::EBlock(exprs1);
            									}
            								}
...
HXLINE( 664)							this->unexpected(tk5);
            			...
            			_hx_goto_48:;
HXLINE( 667)			return ::hxcpp::debug::jsonrpc::eval::Expr_obj::ESwitch(e4,cases,def);
HXLINE( 601)			goto _hx_goto_46;
            		}
            		if (  (_hx_switch_0==HX_("throw",26,5d,90,0f)) ){
HXLINE( 585)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e6,"e") = this->parseExpr();
HXLINE( 586)			return ::hxcpp::debug::jsonrpc::eval::Expr_obj::EThrow(e6);
HXLINE( 584)			goto _hx_goto_46;
            		}
            		if (  (_hx_switch_0==HX_("try",3b,69,58,00)) ){
HXLINE( 588)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e7,"e") = this->parseExpr();
HXLINE( 589)			{
HXLINE( 589)				 ::hxcpp::debug::jsonrpc::eval::Token t7 = this->token();
HXDLIN( 589)				if (!(__hxcpp_enum_eq(t7,::hxcpp::debug::jsonrpc::eval::Token_obj::TId(HX_("catch",3b,7c,21,41))))) {
HXLINE( 589)					this->unexpected(t7);
            				}
            			}
HXLINE( 590)			{
HXLINE( 590)				 ::hxcpp::debug::jsonrpc::eval::Token t8 = this->token();
HXDLIN( 590)				if (::hx::IsPointerNotEq( t8,::hxcpp::debug::jsonrpc::eval::Token_obj::TPOpen_dyn() )) {
HXLINE( 590)					this->unexpected(t8);
            				}
            			}
HXLINE( 591)			HX_VARI_NAME( ::String,vname1,"vname") = this->getIdent();
HXLINE( 592)			{
HXLINE( 592)				 ::hxcpp::debug::jsonrpc::eval::Token t9 = this->token();
HXDLIN( 592)				if (::hx::IsPointerNotEq( t9,::hxcpp::debug::jsonrpc::eval::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 592)					this->unexpected(t9);
            				}
            			}
HXLINE( 593)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::CType,t10,"t") = null();
HXLINE( 594)			if (this->allowTypes) {
HXLINE( 595)				t10 = this->parseType();
            			}
            			else {
HXLINE( 597)				 ::hxcpp::debug::jsonrpc::eval::Token t11 = this->token();
HXDLIN( 597)				if (!(__hxcpp_enum_eq(t11,::hxcpp::debug::jsonrpc::eval::Token_obj::TId(HX_("Dynamic",5f,c7,66,03))))) {
HXLINE( 597)					this->unexpected(t11);
            				}
            			}
HXLINE( 598)			{
HXLINE( 598)				 ::hxcpp::debug::jsonrpc::eval::Token t12 = this->token();
HXDLIN( 598)				if (::hx::IsPointerNotEq( t12,::hxcpp::debug::jsonrpc::eval::Token_obj::TPClose_dyn() )) {
HXLINE( 598)					this->unexpected(t12);
            				}
            			}
HXLINE( 599)			HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,ec) = this->parseExpr();
HXLINE( 600)			return ::hxcpp::debug::jsonrpc::eval::Expr_obj::ETry(e7,vname1,t10,ec);
HXLINE( 587)			goto _hx_goto_46;
            		}
            		if (  (_hx_switch_0==HX_("var",e7,de,59,00)) ){
HXLINE( 513)			HX_VARI( ::String,ident) = this->getIdent();
HXLINE( 514)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,tk6,"tk") = this->token();
HXLINE( 515)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::CType,t13,"t") = null();
HXLINE( 516)			bool _hx_tmp1;
HXDLIN( 516)			if (::hx::IsPointerEq( tk6,::hxcpp::debug::jsonrpc::eval::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 516)				_hx_tmp1 = this->allowTypes;
            			}
            			else {
HXLINE( 516)				_hx_tmp1 = false;
            			}
HXDLIN( 516)			if (_hx_tmp1) {
HXLINE( 517)				t13 = this->parseType();
HXLINE( 518)				tk6 = this->token();
            			}
HXLINE( 520)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e8,"e") = null();
HXLINE( 521)			if (__hxcpp_enum_eq(tk6,::hxcpp::debug::jsonrpc::eval::Token_obj::TOp(HX_("=",3d,00,00,00)))) {
HXLINE( 522)				e8 = this->parseExpr();
            			}
            			else {
HXLINE( 524)				 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this7 = this->tokens;
HXDLIN( 524)				_this7->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk6,_this7->head);
            			}
HXLINE( 525)			return ::hxcpp::debug::jsonrpc::eval::Expr_obj::EVar(ident,t13,e8);
HXLINE( 512)			goto _hx_goto_46;
            		}
            		if (  (_hx_switch_0==HX_("while",b1,43,bd,c9)) ){
HXLINE( 527)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,econd1,"econd") = this->parseExpr();
HXLINE( 528)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e9,"e") = this->parseExpr();
HXLINE( 529)			return ::hxcpp::debug::jsonrpc::eval::Expr_obj::EWhile(econd1,e9);
...
HXLINE( 680)									HX_VARI_NAME( ::String,i1,"i") = _hx_tmp->_hx_getString(0);
HXLINE( 681)									HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,eret1,"eret") = this->parseExpr();
HXLINE( 682)									return ::hxcpp::debug::jsonrpc::eval::Expr_obj::EFunction(::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(::hx::Anon_obj::Create(1)
            										->setFixed(0,HX_("name",4b,72,ff,48),i1))),::hxcpp::debug::jsonrpc::eval::Expr_obj::EReturn(eret1),null(),null());
            								}
            							}
            							break;
            							case (int)26: {
HXLINE( 683)								 ::hxcpp::debug::jsonrpc::eval::Expr _hx_tmp1 = e1->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXDLIN( 683)								if ((_hx_tmp1->_hx_getIndex() == 1)) {
HXLINE( 683)									HX_VARI_NAME( ::String,i2,"i") = _hx_tmp1->_hx_getString(0);
HXDLIN( 683)									HX_VARI(  ::hxcpp::debug::jsonrpc::eval::CType,t) = e1->_hx_getObject(1).StaticCast<  ::hxcpp::debug::jsonrpc::eval::CType >();
HXLINE( 684)									HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,eret2,"eret") = this->parseExpr();
HXLINE( 685)									return ::hxcpp::debug::jsonrpc::eval::Expr_obj::EFunction(::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(::hx::Anon_obj::Create(2)
            										->setFixed(0,HX_("t",74,00,00,00),t)
            										->setFixed(1,HX_("name",4b,72,ff,48),i2))),::hxcpp::debug::jsonrpc::eval::Expr_obj::EReturn(eret2),null(),null());
            								}
            							}
            							break;
            							default:{
...
HXLINE( 696)							{
HXLINE( 696)								 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this1 = this->tokens;
HXDLIN( 696)								_this1->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            							}
...
HXLINE( 709)					{
HXLINE( 709)						 ::hxcpp::debug::jsonrpc::eval::Token t1 = this->token();
HXDLIN( 709)						if (::hx::IsPointerNotEq( t1,::hxcpp::debug::jsonrpc::eval::Token_obj::TBkClose_dyn() )) {
HXLINE( 709)							this->unexpected(t1);
            						}
            					}
HXLINE( 710)					return this->parseExprNext(::hxcpp::debug::jsonrpc::eval::Expr_obj::EArray(e1,e2));
            				...
            				break;
            				case (int)13: {
HXLINE( 712)					HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e21,"e2") = this->parseExpr();
HXLINE( 713)					{
HXLINE( 713)						 ::hxcpp::debug::jsonrpc::eval::Token t2 = this->token();
HXDLIN( 713)						if (::hx::IsPointerNotEq( t2,::hxcpp::debug::jsonrpc::eval::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 713)							this->unexpected(t2);
            						}
            					}
HXLINE( 714)					HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,e3) = this->parseExpr();
HXLINE( 715)					return ::hxcpp::debug::jsonrpc::eval::Expr_obj::ETernary(e1,e21,e3);
            				}
            				break;
            				default:{
HXLINE( 717)					{
HXLINE( 717)						 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this2 = this->tokens;
HXDLIN( 717)						_this2->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this2->head);
            					}
HXLINE( 718)					return e1;
            				}
            			}
...
HXLINE( 821)						 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this1 = this->tokens;
HXDLIN( 821)						_this1->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,t,_this1->head);
            					}
            					else {
...
HXLINE( 807)										switch((int)(t->_hx_getIndex())){
            											case (int)3: {
HXLINE( 809)												HX_VARI_NAME( ::String,op1,"op") = t->_hx_getString(0);
HXDLIN( 809)												{
HXLINE( 810)													if ((op1 == HX_(">",3e,00,00,00))) {
HXLINE( 810)														goto _hx_goto_62;
            													}
HXLINE( 811)													if (::hx::IsEq( op1.charCodeAt(0),62 )) {
HXLINE( 812)														{
HXLINE( 812)															 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this2 = this->tokens;
HXDLIN( 812)															 ::hxcpp::debug::jsonrpc::eval::Token item = ::hxcpp::debug::jsonrpc::eval::Token_obj::TOp(op1.substr(1,null()));
HXDLIN( 812)															_this2->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,item,_this2->head);
            														}
...
HXLINE( 819)								 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this3 = this->tokens;
HXDLIN( 819)								_this3->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,t,_this3->head);
            							}
            						}
            						else {
HXLINE( 821)							 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this4 = this->tokens;
HXDLIN( 821)							_this4->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,t,_this4->head);
            						}
            					}
...
HXLINE( 833)										HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,t1,"t") = _g;
HXLINE( 834)										_gthis->unexpected(t1);
            									}
            								}
            								else {
HXLINE( 833)									HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,t2,"t") = _g;
HXLINE( 834)									_gthis->unexpected(t2);
            								}
            							}
            						}
...
HXLINE( 827)					{
HXLINE( 827)						 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this5 = this->tokens;
HXDLIN( 827)						_this5->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,b,_this5->head);
            					}
HXLINE( 828)					{
HXLINE( 828)						 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this6 = this->tokens;
HXDLIN( 828)						_this6->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,a,_this6->head);
            					}
HXLINE( 830)					HX_VARI(  ::Dynamic,withReturn) =  ::Dynamic(new _hx_Closure_0(_gthis));
HXLINE( 840)					if (::hx::IsNull( a )) {
HXLINE( 856)						HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::CType,t1,"t") = this->parseType();
HXLINE( 857)						 ::hxcpp::debug::jsonrpc::eval::Token _g = this->token();
HXDLIN( 857)						if (::hx::IsNull( _g )) {
HXLINE( 870)							HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,t2,"t") = _g;
HXDLIN( 870)							return this->unexpected(t2);
            						}
            						else {
HXLINE( 857)							switch((int)(_g->_hx_getIndex())){
            								case (int)5: {
HXLINE( 869)									return this->parseTypeNext(::hxcpp::debug::jsonrpc::eval::CType_obj::CTParent(t1));
            								}
            								break;
            								case (int)9: {
HXLINE( 859)									HX_VARI( ::Array< ::Dynamic>,args) = ::Array_obj< ::Dynamic>::__new(1)->init(0,t1);
HXLINE( 861)									do {
HXLINE( 862)										args->push(this->parseType());
            									} while(this->maybe(::hxcpp::debug::jsonrpc::eval::Token_obj::TComma_dyn()));
;
HXLINE( 866)									{
HXLINE( 866)										 ::hxcpp::debug::jsonrpc::eval::Token t3 = this->token();
HXDLIN( 866)										if (::hx::IsPointerNotEq( t3,::hxcpp::debug::jsonrpc::eval::Token_obj::TPClose_dyn() )) {
HXLINE( 866)											this->unexpected(t3);
            										}
            									}
HXLINE( 867)									return withReturn(args);
            								...
            								break;
            								default:{
HXLINE( 870)									HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,t4,"t") = _g;
HXDLIN( 870)									return this->unexpected(t4);
            								}
            							}
            						}
            					}
...
HXLINE( 840)						switch((int)(a->_hx_getIndex())){
            							case (int)2: {
HXLINE( 841)								::String _g1 = a->_hx_getString(0);
HXLINE( 840)								if (::hx::IsNull( b )) {
HXLINE( 856)									HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::CType,t5,"t") = this->parseType();
HXLINE( 857)									 ::hxcpp::debug::jsonrpc::eval::Token _g2 = this->token();
HXDLIN( 857)									if (::hx::IsNull( _g2 )) {
HXLINE( 870)										HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,t6,"t") = _g2;
HXDLIN( 870)										return this->unexpected(t6);
            									}
            									else {
HXLINE( 857)										switch((int)(_g2->_hx_getIndex())){
            											case (int)5: {
HXLINE( 869)												return this->parseTypeNext(::hxcpp::debug::jsonrpc::eval::CType_obj::CTParent(t5));
            											}
            											break;
            											case (int)9: {
HXLINE( 859)												HX_VARI_NAME( ::Array< ::Dynamic>,args1,"args") = ::Array_obj< ::Dynamic>::__new(1)->init(0,t5);
HXLINE( 861)												do {
HXLINE( 862)													args1->push(this->parseType());
            												} while(this->maybe(::hxcpp::debug::jsonrpc::eval::Token_obj::TComma_dyn()));
;
HXLINE( 866)												{
HXLINE( 866)													 ::hxcpp::debug::jsonrpc::eval::Token t7 = this->token();
HXDLIN( 866)													if (::hx::IsPointerNotEq( t7,::hxcpp::debug::jsonrpc::eval::Token_obj::TPClose_dyn() )) {
HXLINE( 866)														this->unexpected(t7);
            													}
            												}
HXLINE( 867)												return withReturn(args1);
            											}
            											break;
            											default:{
HXLINE( 870)												HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,t8,"t") = _g2;
HXDLIN( 870)												return this->unexpected(t8);
            											}
            										}
            									}
            								}
...
HXLINE( 842)										::Array< ::Dynamic> _g3 = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 843)										{
HXLINE( 843)											int _g4 = 0;
HXDLIN( 843)											::Array< ::Dynamic> _g5 = this->parseFunctionArgs();
HXDLIN( 843)											while((_g4 < _g5->length)){
HXLINE( 843)												HX_VARI(  ::Dynamic,arg) = _g5->__get(_g4);
HXDLIN( 843)												_g4 = (_g4 + 1);
HXLINE( 844)												{
HXLINE( 844)													 ::hxcpp::debug::jsonrpc::eval::Expr _g6 = arg->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic);
HXLINE( 845)													if (::hx::IsNotNull( _g6 )) {
HXLINE( 846)														HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,v1,"v") = _g6;
HXLINE( 847)														HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::Error_obj::ECustom(HX_("Default values not allowed in function types",28,46,7a,e6)));
            													}
            												}
...
HXDLIN( 850)												_g3->push(::hxcpp::debug::jsonrpc::eval::CType_obj::CTNamed( ::Dynamic(arg->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)),_hx_tmp));
            											}
            										}
HXLINE( 842)										HX_VARI_NAME( ::Array< ::Dynamic>,args2,"args") = _g3;
HXLINE( 854)										return withReturn(args2);
            									}
            									else {
HXLINE( 856)										HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::CType,t9,"t") = this->parseType();
HXLINE( 857)										 ::hxcpp::debug::jsonrpc::eval::Token _g7 = this->token();
HXDLIN( 857)										if (::hx::IsNull( _g7 )) {
HXLINE( 870)											HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,t10,"t") = _g7;
HXDLIN( 870)											return this->unexpected(t10);
            										}
            										else {
HXLINE( 857)											switch((int)(_g7->_hx_getIndex())){
            												case (int)5: {
HXLINE( 869)													return this->parseTypeNext(::hxcpp::debug::jsonrpc::eval::CType_obj::CTParent(t9));
            												}
            												break;
            												case (int)9: {
HXLINE( 859)													HX_VARI_NAME( ::Array< ::Dynamic>,args3,"args") = ::Array_obj< ::Dynamic>::__new(1)->init(0,t9);
HXLINE( 861)													do {
HXLINE( 862)														args3->push(this->parseType());
            													} while(this->maybe(::hxcpp::debug::jsonrpc::eval::Token_obj::TComma_dyn()));
;
HXLINE( 866)													{
HXLINE( 866)														 ::hxcpp::debug::jsonrpc::eval::Token t11 = this->token();
HXDLIN( 866)														if (::hx::IsPointerNotEq( t11,::hxcpp::debug::jsonrpc::eval::Token_obj::TPClose_dyn() )) {
HXLINE( 866)															this->unexpected(t11);
            														}
            													}
HXLINE( 867)													return withReturn(args3);
            												}
            												break;
            												default:{
HXLINE( 870)													HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,t12,"t") = _g7;
HXDLIN( 870)													return this->unexpected(t12);
            												}
            											}
            										}
            									}
            							...
            							break;
            							case (int)5: {
HXLINE( 842)								::Array< ::Dynamic> _g8 = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 843)								{
HXLINE( 843)									int _g9 = 0;
HXDLIN( 843)									::Array< ::Dynamic> _g10 = this->parseFunctionArgs();
HXDLIN( 843)									while((_g9 < _g10->length)){
HXLINE( 843)										HX_VARI_NAME(  ::Dynamic,arg1,"arg") = _g10->__get(_g9);
HXDLIN( 843)										_g9 = (_g9 + 1);
HXLINE( 844)										{
HXLINE( 844)											 ::hxcpp::debug::jsonrpc::eval::Expr _g11 = arg1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic);
HXLINE( 845)											if (::hx::IsNotNull( _g11 )) {
HXLINE( 846)												HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,v2,"v") = _g11;
HXLINE( 847)												HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::Error_obj::ECustom(HX_("Default values not allowed in function types",28,46,7a,e6)));
            											}
            										}
HXLINE( 850)										 ::hxcpp::debug::jsonrpc::eval::CType _hx_tmp1;
HXDLIN( 850)										if (( (bool)(arg1->__Field(HX_("opt",33,9c,54,00),::hx::paccDynamic)) )) {
HXLINE( 850)											_hx_tmp1 = ::hxcpp::debug::jsonrpc::eval::CType_obj::CTOpt( ::Dynamic(arg1->__Field(HX_("t",74,00,00,00),::hx::paccDynamic)));
            										}
            										else {
HXLINE( 850)											_hx_tmp1 = arg1->__Field(HX_("t",74,00,00,00),::hx::paccDynamic);
            										}
HXDLIN( 850)										_g8->push(::hxcpp::debug::jsonrpc::eval::CType_obj::CTNamed( ::Dynamic(arg1->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)),_hx_tmp1));
            									}
            								}
HXLINE( 842)								HX_VARI_NAME( ::Array< ::Dynamic>,args4,"args") = _g8;
HXLINE( 854)								return withReturn(args4);
            							}
            							break;
            							default:{
HXLINE( 856)								HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::CType,t13,"t") = this->parseType();
HXLINE( 857)								 ::hxcpp::debug::jsonrpc::eval::Token _g12 = this->token();
HXDLIN( 857)								if (::hx::IsNull( _g12 )) {
HXLINE( 870)									HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,t14,"t") = _g12;
HXDLIN( 870)									return this->unexpected(t14);
            								}
            								else {
HXLINE( 857)									switch((int)(_g12->_hx_getIndex())){
            										case (int)5: {
HXLINE( 869)											return this->parseTypeNext(::hxcpp::debug::jsonrpc::eval::CType_obj::CTParent(t13));
            										}
            										break;
            										case (int)9: {
HXLINE( 859)											HX_VARI_NAME( ::Array< ::Dynamic>,args5,"args") = ::Array_obj< ::Dynamic>::__new(1)->init(0,t13);
HXLINE( 861)											do {
HXLINE( 862)												args5->push(this->parseType());
            											} while(this->maybe(::hxcpp::debug::jsonrpc::eval::Token_obj::TComma_dyn()));
;
HXLINE( 866)											{
HXLINE( 866)												 ::hxcpp::debug::jsonrpc::eval::Token t15 = this->token();
HXDLIN( 866)												if (::hx::IsPointerNotEq( t15,::hxcpp::debug::jsonrpc::eval::Token_obj::TPClose_dyn() )) {
HXLINE( 866)													this->unexpected(t15);
            												}
            											}
HXLINE( 867)											return withReturn(args5);
            										}
            										break;
            										default:{
HXLINE( 870)											HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,t16,"t") = _g12;
HXDLIN( 870)											return this->unexpected(t16);
            										}
            									}
            								}
            							}
...
HXLINE( 878)							switch((int)(t->_hx_getIndex())){
            								case (int)2: {
HXLINE( 886)									::String _g13 = t->_hx_getString(0);
HXDLIN( 886)									if ((_g13 == HX_("var",e7,de,59,00))) {
HXLINE( 881)										HX_VARI( ::String,name) = this->getIdent();
HXLINE( 882)										{
HXLINE( 882)											 ::hxcpp::debug::jsonrpc::eval::Token t17 = this->token();
HXDLIN( 882)											if (::hx::IsPointerNotEq( t17,::hxcpp::debug::jsonrpc::eval::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 882)												this->unexpected(t17);
            											}
            										}
...
HXLINE( 885)										{
HXLINE( 885)											 ::hxcpp::debug::jsonrpc::eval::Token t18 = this->token();
HXDLIN( 885)											if (::hx::IsPointerNotEq( t18,::hxcpp::debug::jsonrpc::eval::Token_obj::TSemicolon_dyn() )) {
HXLINE( 885)												this->unexpected(t18);
            											}
            										}
            									}
            									else {
HXLINE( 886)										HX_VARI_NAME( ::String,name1,"name") = _g13;
HXDLIN( 886)										{
HXLINE( 887)											{
HXLINE( 887)												 ::hxcpp::debug::jsonrpc::eval::Token t19 = this->token();
HXDLIN( 887)												if (::hx::IsPointerNotEq( t19,::hxcpp::debug::jsonrpc::eval::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 887)													this->unexpected(t19);
            												}
            											}
...
HXLINE( 879)									goto _hx_goto_69;
            								...
            								break;
            								case (int)15: {
HXLINE( 895)									HX_VARI_NAME( ::String,name2,"name") = t->_hx_getString(0);
HXDLIN( 895)									{
...
HXLINE( 913)					{
HXLINE( 913)						 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this1 = this->tokens;
HXDLIN( 913)						_this1->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            					}
HXLINE( 914)					return t;
            				}
            			}
...
HXLINE( 917)				{
HXLINE( 917)					 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this2 = this->tokens;
HXDLIN( 917)					_this2->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this2->head);
            				}
HXLINE( 918)				return t;
            			}
            		}
...
HXLINE( 975)					{
HXLINE( 975)						 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this1 = this->tokens;
HXDLIN( 975)						_this1->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            					}
HXLINE( 976)					goto _hx_goto_77;
            				}
            			}
...
HXLINE( 984)			HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::Error_obj::EInvalidOp(HX_("Unsupported class type parameters",9d,ae,a3,50)));
            		}
...
HXDLIN(1041)							goto _hx_goto_84;
            						...
            						/* default */{
HXLINE(1043)							{
HXLINE(1043)								 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this1 = this->tokens;
HXDLIN(1043)								_this1->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,t,_this1->head);
            							}
HXLINE(1044)							goto _hx_goto_83;
            						}
            						_hx_goto_84:;
...
HXLINE(1043)						{
HXLINE(1043)							 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this2 = this->tokens;
HXDLIN(1043)							_this2->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,t,_this2->head);
            						}
HXLINE(1044)						goto _hx_goto_83;
            					}
            				}
...
HXLINE(1049)			{
HXLINE(1049)				 ::hxcpp::debug::jsonrpc::eval::Token t1 = this->token();
HXDLIN(1049)				if (::hx::IsPointerNotEq( t1,::hxcpp::debug::jsonrpc::eval::Token_obj::TBrOpen_dyn() )) {
HXLINE(1049)					this->unexpected(t1);
            				}
            			}
...
HXLINE(1012)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Token,t2,"t") = this->token();
HXLINE(1013)				if (::hx::IsPointerNotEq( t2,::hxcpp::debug::jsonrpc::eval::Token_obj::TDot_dyn() )) {
HXLINE(1014)					{
HXLINE(1014)						 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this3 = this->tokens;
HXDLIN(1014)						_this3->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,t2,_this3->head);
            					}
HXLINE(1015)					goto _hx_goto_86;
            				}
HXLINE(1017)				t2 = this->token();
HXLINE(1018)				if (::hx::IsNull( t2 )) {
HXLINE(1024)					this->unexpected(t2);
            				}
            				else {
HXLINE(1018)					switch((int)(t2->_hx_getIndex())){
            						case (int)2: {
HXLINE(1019)							HX_VARI( ::String,id) = t2->_hx_getString(0);
HXLINE(1020)							path->push(id);
            						}
            						break;
            						case (int)3: {
HXLINE(1021)							if ((t2->_hx_getString(0) == HX_("*",2a,00,00,00))) {
...
HXLINE(1024)							this->unexpected(t2);
            			...
            			_hx_goto_86:;
HXLINE(1027)			{
HXLINE(1027)				 ::hxcpp::debug::jsonrpc::eval::Token t3 = this->token();
HXDLIN(1027)				if (::hx::IsPointerNotEq( t3,::hxcpp::debug::jsonrpc::eval::Token_obj::TSemicolon_dyn() )) {
HXLINE(1027)					this->unexpected(t3);
            				}
            			}
...
HXLINE(1005)			HX_VARI_NAME( ::Array< ::String >,path1,"path") = this->parsePath();
HXLINE(1006)			{
HXLINE(1006)				 ::hxcpp::debug::jsonrpc::eval::Token t4 = this->token();
HXDLIN(1006)				if (::hx::IsPointerNotEq( t4,::hxcpp::debug::jsonrpc::eval::Token_obj::TSemicolon_dyn() )) {
HXLINE(1006)					this->unexpected(t4);
            				}
            			}
HXLINE(1007)			return ::hxcpp::debug::jsonrpc::eval::ModuleDecl_obj::DPackage(path1);
HXLINE(1004)			goto _hx_goto_82;
            		}
            		if (  (_hx_switch_1==HX_("typedef",4b,37,d8,f8)) ){
HXLINE(1064)			HX_VARI_NAME( ::String,name1,"name") = this->getIdent();
HXLINE(1065)			HX_VARI_NAME(  ::Dynamic,params1,"params") = this->parseParams();
HXLINE(1066)			{
HXLINE(1066)				 ::hxcpp::debug::jsonrpc::eval::Token t5 = this->token();
HXDLIN(1066)				if (!(__hxcpp_enum_eq(t5,::hxcpp::debug::jsonrpc::eval::Token_obj::TOp(HX_("=",3d,00,00,00))))) {
HXLINE(1066)					this->unexpected(t5);
            				}
            			}
HXLINE(1067)			HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::CType,t6,"t") = this->parseType();
...
HXDLIN(1096)				goto _hx_goto_89;
            			...
            			if (  (_hx_switch_0==HX_("var",e7,de,59,00)) ){
HXLINE(1113)				HX_VARI_NAME( ::String,name1,"name") = this->getIdent();
...
HXLINE(1128)						 ::hxcpp::debug::jsonrpc::eval::Token t2 = this->token();
HXDLIN(1128)						if (::hx::IsPointerNotEq( t2,::hxcpp::debug::jsonrpc::eval::Token_obj::TSemicolon_dyn() )) {
HXLINE(1128)							this->unexpected(t2);
            						}
            					}
            				}
            				else {
...
HXLINE(1132)						 ::hxcpp::debug::jsonrpc::eval::Token t3 = this->token();
HXDLIN(1132)						if (::hx::IsPointerNotEq( t3,::hxcpp::debug::jsonrpc::eval::Token_obj::TSemicolon_dyn() )) {
...
HXLINE(1172)					HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::Error_obj::EUnterminatedString_dyn());
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
            				}
...
HXLINE(1202)								HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::Error_obj::EUnterminatedString_dyn());
            							}
            							else {
            								HX_STACK_DO_THROW(_hx_e);
            							}
...
HXLINE(1205)							{
HXLINE(1206)								k = (k << 4);
HXLINE(1207)								HX_VARI_NAME(  ::Dynamic,char1,"char") = code.charCodeAt(1);
...
HXLINE(1205)							{
HXLINE(1206)								k = (k << 4);
HXLINE(1207)								HX_VARI_NAME(  ::Dynamic,char2,"char") = code.charCodeAt(2);
...
HXLINE(1205)							{
HXLINE(1206)								k = (k << 4);
HXLINE(1207)								HX_VARI_NAME(  ::Dynamic,char3,"char") = code.charCodeAt(3);
...
HXLINE(1380)							return ::hxcpp::debug::jsonrpc::eval::Token_obj::TDot_dyn();
            				...
            				break;
            				case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1265)					HX_VARI_NAME( Float,n1,"n") = (( (Float)((_hx_char - 48)) ) * ((Float)1.0));
HXLINE(1266)					HX_VARI_NAME( Float,exp1,"exp") = ((Float)0.);
HXLINE(1267)					while(true){
HXLINE(1268)						_hx_char = this->readChar();
HXLINE(1269)						exp1 = (exp1 * ( (Float)(10) ));
HXLINE(1270)						switch((int)(_hx_char)){
            							case (int)46: {
HXLINE(1291)								if ((exp1 > 0)) {
HXLINE(1293)									bool _hx_tmp;
HXDLIN(1293)									if ((exp1 == 10)) {
...
HXLINE(1294)										{
HXLINE(1294)											 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this1 = this->tokens;
HXDLIN(1294)											_this1->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,::hxcpp::debug::jsonrpc::eval::Token_obj::TOp(HX_("...",ee,0f,23,00)),_this1->head);
            										}
HXLINE(1295)										HX_VARI( int,i) = ::Std_obj::_hx_int(n1);
HXLINE(1296)										 ::hxcpp::debug::jsonrpc::eval::Const _hx_tmp1;
HXDLIN(1296)										if ((i == n1)) {
HXLINE(1296)											_hx_tmp1 = ::hxcpp::debug::jsonrpc::eval::Const_obj::CInt(i);
            										}
            										else {
HXLINE(1296)											_hx_tmp1 = ::hxcpp::debug::jsonrpc::eval::Const_obj::CFloat(n1);
            										}
HXDLIN(1296)										return ::hxcpp::debug::jsonrpc::eval::Token_obj::TConst(_hx_tmp1);
            									}
HXLINE(1298)									this->invalidChar(_hx_char);
            								}
HXLINE(1300)								exp1 = ((Float)1.);
            							}
            							break;
            							case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1272)								n1 = ((n1 * ( (Float)(10) )) + (_hx_char - 48));
            							}
            							break;
...
HXLINE(1285)									 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this2 = this->tokens;
HXDLIN(1285)									_this2->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this2->head);
            								}
            								else {
...
HXLINE(1285)												 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this3 = this->tokens;
HXDLIN(1285)												_this3->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this3->head);
            											}
            										}
            										break;
            										case (int)3: {
...
HXLINE(1282)													 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this4 = this->tokens;
HXDLIN(1282)													_this4->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this4->head);
            												}
            												else {
HXLINE(1280)													if ((tk->_hx_getIndex() == 1)) {
HXLINE(1281)														 ::hxcpp::debug::jsonrpc::eval::Const _g1 = tk->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Const >();
HXDLIN(1281)														if ((_g1->_hx_getIndex() == 0)) {
HXLINE(1281)															HX_VARI_NAME( int,e1,"e") = _g1->_hx_getInt(0);
HXDLIN(1281)															pow = -(e1);
            														}
            														else {
HXLINE(1282)															 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this5 = this->tokens;
HXDLIN(1282)															_this5->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this5->head);
            														}
            													}
            													else {
HXLINE(1282)														 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this6 = this->tokens;
HXDLIN(1282)														_this6->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this6->head);
            													}
            												}
            											}
            											else {
HXLINE(1285)												 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this7 = this->tokens;
HXDLIN(1285)												_this7->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this7->head);
            											}
            										}
            										break;
            										default:{
HXLINE(1285)											 ::haxe::ds::GenericStack_hxcpp_debug_jsonrpc_eval_Token _this8 = this->tokens;
HXDLIN(1285)											_this8->head =  ::haxe::ds::GenericCell_hxcpp_debug_jsonrpc_eval_Token_obj::__alloc( HX_CTX ,tk,_this8->head);
            										}
            									}
            								}
...
HXLINE(1289)								return ::hxcpp::debug::jsonrpc::eval::Token_obj::TConst(::hxcpp::debug::jsonrpc::eval::Const_obj::CFloat((((::Math_obj::pow(( (Float)(10) ),( (Float)(pow) )) / exp1) * n1) * ( (Float)(10) ))));
            							}
            							break;
            							case (int)120: {
HXLINE(1302)								bool _hx_tmp2;
HXDLIN(1302)								if (!((n1 > 0))) {
HXLINE(1302)									_hx_tmp2 = (exp1 > 0);
            								}
            								else {
HXLINE(1302)									_hx_tmp2 = true;
            								}
HXDLIN(1302)								if (_hx_tmp2) {
HXLINE(1303)									this->invalidChar(_hx_char);
            								}
HXLINE(1306)								HX_VARI_NAME( int,n2,"n") = 0;
HXLINE(1307)								while(true){
HXLINE(1308)									_hx_char = this->readChar();
HXLINE(1309)									switch((int)(_hx_char)){
            										case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1311)											n2 = (((n2 << 4) + _hx_char) - 48);
            										}
            										break;
            										case (int)65: case (int)66: case (int)67: case (int)68: case (int)69: case (int)70: {
HXLINE(1313)											n2 = ((n2 << 4) + (_hx_char - 55));
            										}
            										break;
            										case (int)97: case (int)98: case (int)99: case (int)100: case (int)101: case (int)102: {
HXLINE(1315)											n2 = ((n2 << 4) + (_hx_char - 87));
            										}
            										break;
            										default:{
HXLINE(1317)											this->_hx_char = _hx_char;
HXLINE(1318)											return ::hxcpp::debug::jsonrpc::eval::Token_obj::TConst(::hxcpp::debug::jsonrpc::eval::Const_obj::CInt(n2));
            										}
            									}
            								}
            							}
...
HXLINE(1344)								HX_VARI_NAME( int,i1,"i") = ::Std_obj::_hx_int(n1);
HXLINE(1345)								 ::hxcpp::debug::jsonrpc::eval::Const _hx_tmp3;
HXDLIN(1345)								if ((exp1 > 0)) {
HXLINE(1345)									_hx_tmp3 = ::hxcpp::debug::jsonrpc::eval::Const_obj::CFloat(((n1 * ( (Float)(10) )) / exp1));
            								}
            								else {
HXLINE(1345)									if ((i1 == n1)) {
HXLINE(1345)										_hx_tmp3 = ::hxcpp::debug::jsonrpc::eval::Const_obj::CInt(i1);
            									}
            									else {
HXLINE(1345)										_hx_tmp3 = ::hxcpp::debug::jsonrpc::eval::Const_obj::CFloat(n1);
            									}
            								}
HXDLIN(1345)								return ::hxcpp::debug::jsonrpc::eval::Token_obj::TConst(_hx_tmp3);
            							}
            						}
            					}
            				}
...
HXLINE(1406)					bool _hx_tmp4;
HXDLIN(1406)					if (!(this->idents->__get(_hx_char))) {
HXLINE(1406)						_hx_tmp4 = (_hx_char == 58);
            					}
            					else {
HXLINE(1406)						_hx_tmp4 = true;
            					}
HXDLIN(1406)					if (_hx_tmp4) {
HXLINE(1407)						HX_VARI_NAME( ::String,id1,"id") = ::String::fromCharCode(_hx_char);
...
HXLINE(1412)								return ::hxcpp::debug::jsonrpc::eval::Token_obj::TMeta(id1);
            							}
HXLINE(1414)							id1 = (id1 + ::String::fromCharCode(_hx_char));
            						}
            					}
...
HXLINE(1438)							bool _hx_tmp5;
HXDLIN(1438)							if (this->ops->__get(_hx_char)) {
HXLINE(1438)								_hx_tmp5 = (prev == 61);
            							}
            							else {
HXLINE(1438)								_hx_tmp5 = true;
            							}
HXDLIN(1438)							if (_hx_tmp5) {
...
HXLINE(1449)						HX_VARI_NAME( ::String,id2,"id") = ::String::fromCharCode(_hx_char);
...
HXLINE(1454)								return ::hxcpp::debug::jsonrpc::eval::Token_obj::TId(id2);
            							}
HXLINE(1456)							id2 = (id2 + ::String::fromCharCode(_hx_char));
            						}
            					}
...
HXLINE(1490)				return ::hx::IsNotNull( this->preprocValue(id) );
            			...
            			break;
            			case (int)3: {
HXLINE(1493)				HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e1,"e") = e->_hx_getObject(0).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
...
HXLINE(1495)					HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e11,"e1") = _g;
HXDLIN(1495)					HX_VARI(  ::hxcpp::debug::jsonrpc::eval::Expr,e2) = _g1;
HXLINE(1496)					if (this->evalPreproCond(e11)) {
...
HXLINE(1497)					HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e12,"e1") = _g;
HXDLIN(1497)					HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e21,"e2") = _g1;
HXLINE(1498)					if (!(this->evalPreproCond(e12))) {
HXLINE(1498)						return this->evalPreproCond(e21);
            					}
            					else {
...
HXLINE(1497)					goto _hx_goto_110;
            				...
            				/* default */{
HXLINE(1500)					HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::Error_obj::EInvalidPreprocessor((HX_("Can't eval ",01,17,bf,09) + ::Type_obj::enumConstructor(e))));
            				}
            				_hx_goto_110:;
            			}
            			break;
            			case (int)7: {
HXLINE(1491)				bool _g2 = e->_hx_getBool(1);
HXDLIN(1491)				if ((e->_hx_getString(0) == HX_("!",21,00,00,00))) {
HXLINE(1491)					HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::eval::Expr,e3,"e") = e->_hx_getObject(2).StaticCast<  ::hxcpp::debug::jsonrpc::eval::Expr >();
HXLINE(1492)					return !(this->evalPreproCond(e3));
            				}
            				else {
HXLINE(1500)					HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::Error_obj::EInvalidPreprocessor((HX_("Can't eval ",01,17,bf,09) + ::Type_obj::enumConstructor(e))));
            				}
...
HXLINE(1545)				HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::Error_obj::EInvalidPreprocessor(HX_("Unclosed",e5,94,4a,ea)));
            			}
...
HXLINE(1587)					HX_STACK_DO_THROW(::hxcpp::debug::jsonrpc::eval::Error_obj::EUnterminatedComment_dyn());
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
            				}
...
HXDLIN(1610)				return s;
            			...
            			break;
            			case (int)3: {
HXLINE(1611)				HX_VARI_NAME( ::String,s1,"s") = t->_hx_getString(0);
HXDLIN(1611)				return s1;
            			}
            			break;
            			case (int)4: {
...
HXDLIN(1623)				return (HX_("@",40,00,00,00) + id);
            			...
            			break;
            			case (int)16: {
HXLINE(1624)				HX_VARI_NAME( ::String,id1,"id") = t->_hx_getString(0);
HXDLIN(1624)				return (HX_("#",23,00,00,00) + id1);
            			}
            			break;
            		}

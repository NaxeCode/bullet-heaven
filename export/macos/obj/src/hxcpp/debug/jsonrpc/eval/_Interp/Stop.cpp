...
::hxcpp::debug::jsonrpc::eval::_Interp::Stop Stop_obj::SBreak;

::hxcpp::debug::jsonrpc::eval::_Interp::Stop Stop_obj::SContinue;

::hxcpp::debug::jsonrpc::eval::_Interp::Stop Stop_obj::SReturn;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("hxcpp.debug.jsonrpc.eval._Interp.Stop",c8,4f,c8,ee), ::hx::TCanCast< Stop_obj >,Stop_obj_sStaticFields,0,

...
::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EArray( ::hxcpp::debug::jsonrpc::eval::Expr e, ::hxcpp::debug::jsonrpc::eval::Expr index)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EArray",14,c3,5c,4f),16,2)->_hx_init(0,e)->_hx_init(1,index);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EArrayDecl(::Array< ::Dynamic> e)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EArrayDecl",9e,59,bd,01),17,1)->_hx_init(0,e);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EBinop(::String op, ::hxcpp::debug::jsonrpc::eval::Expr e1, ::hxcpp::debug::jsonrpc::eval::Expr e2)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EBinop",23,6f,cd,dc),6,3)->_hx_init(0,op)->_hx_init(1,e1)->_hx_init(2,e2);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EBlock(::Array< ::Dynamic> e)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EBlock",c8,ca,c9,de),4,1)->_hx_init(0,e);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EBreak;

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::ECall( ::hxcpp::debug::jsonrpc::eval::Expr e,::Array< ::Dynamic> params)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("ECall",83,4b,39,e7),8,2)->_hx_init(0,e)->_hx_init(1,params);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::ECheckType( ::hxcpp::debug::jsonrpc::eval::Expr e, ::hxcpp::debug::jsonrpc::eval::CType t)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("ECheckType",9d,ea,cd,16),26,2)->_hx_init(0,e)->_hx_init(1,t);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EConst( ::hxcpp::debug::jsonrpc::eval::Const c)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EConst",de,4e,2b,74),0,1)->_hx_init(0,c);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EContinue;

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EDoWhile( ::hxcpp::debug::jsonrpc::eval::Expr cond, ::hxcpp::debug::jsonrpc::eval::Expr e)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EDoWhile",61,0e,d4,34),24,2)->_hx_init(0,cond)->_hx_init(1,e);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EField( ::hxcpp::debug::jsonrpc::eval::Expr e,::String f)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EField",35,ea,60,2a),5,2)->_hx_init(0,e)->_hx_init(1,f);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EFor(::String v, ::hxcpp::debug::jsonrpc::eval::Expr it, ::hxcpp::debug::jsonrpc::eval::Expr e)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EFor",c4,37,d1,2d),11,3)->_hx_init(0,v)->_hx_init(1,it)->_hx_init(2,e);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EFunction(::Array< ::Dynamic> args, ::hxcpp::debug::jsonrpc::eval::Expr e,::String name, ::hxcpp::debug::jsonrpc::eval::CType ret)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EFunction",7d,b4,15,c9),14,4)->_hx_init(0,args)->_hx_init(1,e)->_hx_init(2,name)->_hx_init(3,ret);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EIdent(::String v)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EIdent",6b,98,46,e1),1,1)->_hx_init(0,v);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EIf( ::hxcpp::debug::jsonrpc::eval::Expr cond, ::hxcpp::debug::jsonrpc::eval::Expr e1, ::hxcpp::debug::jsonrpc::eval::Expr e2)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EIf",82,9b,34,00),9,3)->_hx_init(0,cond)->_hx_init(1,e1)->_hx_init(2,e2);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EMeta(::String name,::Array< ::Dynamic> args, ::hxcpp::debug::jsonrpc::eval::Expr e)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EMeta",aa,7d,d8,ed),25,3)->_hx_init(0,name)->_hx_init(1,args)->_hx_init(2,e);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::ENew(::String cl,::Array< ::Dynamic> params)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("ENew",1b,41,d7,2d),18,2)->_hx_init(0,cl)->_hx_init(1,params);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EObject(::Array< ::Dynamic> fl)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EObject",e4,f4,1c,7f),21,1)->_hx_init(0,fl);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EParent( ::hxcpp::debug::jsonrpc::eval::Expr e)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EParent",4f,7b,5b,57),3,1)->_hx_init(0,e);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EReturn( ::hxcpp::debug::jsonrpc::eval::Expr e)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EReturn",d5,1a,0b,73),15,1)->_hx_init(0,e);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::ESwitch( ::hxcpp::debug::jsonrpc::eval::Expr e,::Array< ::Dynamic> cases, ::hxcpp::debug::jsonrpc::eval::Expr defaultExpr)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("ESwitch",19,c0,56,2f),23,3)->_hx_init(0,e)->_hx_init(1,cases)->_hx_init(2,defaultExpr);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::ETernary( ::hxcpp::debug::jsonrpc::eval::Expr cond, ::hxcpp::debug::jsonrpc::eval::Expr e1, ::hxcpp::debug::jsonrpc::eval::Expr e2)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("ETernary",56,c3,5c,5e),22,3)->_hx_init(0,cond)->_hx_init(1,e1)->_hx_init(2,e2);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EThrow( ::hxcpp::debug::jsonrpc::eval::Expr e)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EThrow",a1,b2,5d,39),19,1)->_hx_init(0,e);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::ETry( ::hxcpp::debug::jsonrpc::eval::Expr e,::String v, ::hxcpp::debug::jsonrpc::eval::CType t, ::hxcpp::debug::jsonrpc::eval::Expr ecatch)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("ETry",f6,d9,db,2d),20,4)->_hx_init(0,e)->_hx_init(1,v)->_hx_init(2,t)->_hx_init(3,ecatch);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EUnop(::String op,bool prefix, ::hxcpp::debug::jsonrpc::eval::Expr e)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EUnop",9f,02,29,f3),7,3)->_hx_init(0,op)->_hx_init(1,prefix)->_hx_init(2,e);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EVar(::String n, ::hxcpp::debug::jsonrpc::eval::CType t, ::hxcpp::debug::jsonrpc::eval::Expr e)
{
	return ::hx::CreateEnum< Expr_obj >(HX_("EVar",a2,4f,dd,2d),2,3)->_hx_init(0,n)->_hx_init(1,t)->_hx_init(2,e);
}

::hxcpp::debug::jsonrpc::eval::Expr Expr_obj::EWhile( ::hxcpp::debug::jsonrpc::eval::Expr cond, ::hxcpp::debug::jsonrpc::eval::Expr e)
{
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("hxcpp.debug.jsonrpc.eval.Expr",40,9f,3b,54), ::hx::TCanCast< Expr_obj >,Expr_obj_sStaticFields,0,

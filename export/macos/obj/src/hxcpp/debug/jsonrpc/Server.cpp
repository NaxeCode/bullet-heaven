...
HXLINE(  85)
HXLINE(  86)		::haxe::Log_obj::trace(HX_("Debug Server Started:",e9,54,65,f1),::hx::SourceInfo(HX_("hxcpp/debug/jsonrpc/Server.hx",71,c2,e2,bc),86,HX_("hxcpp.debug.jsonrpc.Server",6a,85,bd,65),HX_("new",60,d0,53,00)));
...
HXLINE( 121)				HX_STACK_DO_THROW(HX_("Name lookup error.",d7,ab,8b,46));
            			}
...
HXDLIN( 239)					HX_VARI(  ::Dynamic,e) = _g6;
...
HXLINE( 442)				HX_VARI_NAME( int,frameId1,"frameId") = ( (int)( ::Dynamic(m->__Field(HX_("params",46,fb,7a,ed),::hx::paccDynamic))->__Field(HX_("frameId",68,dd,73,48),::hx::paccDynamic)) );
HXLINE( 443)				HX_VARI(  ::Dynamic,v) = ::hxcpp::debug::jsonrpc::VariablesPrinter_obj::evaluate(this->parser,expr,threadId,frameId1);
...
HXLINE( 447)					{
HXLINE( 447)						 ::hxcpp::debug::jsonrpc::Value _g1 = v->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic);
HXDLIN( 447)						switch((int)(_g1->_hx_getIndex())){
            							case (int)0: {
HXLINE( 463)								HX_VARI(  ::Dynamic,value) = _g1->_hx_getObject(0);
HXLINE( 464)								 ::Dynamic(m->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),value,::hx::paccDynamic);
            							}
            							break;
            							case (int)1: {
HXLINE( 451)								 ::Dynamic _g2 = _g1->_hx_getObject(2);
HXDLIN( 451)								{
HXLINE( 451)									HX_VARI_NAME(  ::Dynamic,value1,"value") = _g1->_hx_getObject(0);
HXDLIN( 451)									HX_VARI( int,length) = _g1->_hx_getInt(1);
HXDLIN( 451)									{
...
HXLINE( 455)										 ::Dynamic(m->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),::Std_obj::string(value1),::hx::paccDynamic);
            									}
            								}
            							}
            							break;
            							case (int)2: {
HXLINE( 457)								bool _g3 = _g1->_hx_getBool(3);
HXDLIN( 457)								 ::Dynamic _g4 = _g1->_hx_getObject(4);
HXDLIN( 457)								{
HXLINE( 457)									HX_VARI_NAME(  ::Dynamic,value2,"value") = _g1->_hx_getObject(0);
HXDLIN( 457)									HX_VARI( ::String,printedValue) = _g1->_hx_getString(1);
HXDLIN( 457)									HX_VARI( ::Array< ::String >,names) = _g1->_hx_getObject(2).StaticCast< ::Array< ::String > >();
HXDLIN( 457)									{
HXLINE( 458)										HX_VARI_NAME( int,refId1,"refId") = this->references->create(v->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic));
HXLINE( 459)										 ::Dynamic(m->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic))->__SetField(HX_("variablesReference",14,76,04,51),refId1,::hx::paccDynamic);
...
HXLINE( 461)										 ::Dynamic(m->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),printedValue,::hx::paccDynamic);
            							...
            							break;
            							case (int)3: {
HXLINE( 448)								HX_VARI_NAME( ::Array< ::String >,names1,"names") = _g1->_hx_getObject(0).StaticCast< ::Array< ::String > >();
HXDLIN( 448)								HX_VARI( ::cpp::VirtualArray,values) = _g1->_hx_getObject(1).StaticCast< ::cpp::VirtualArray >();
HXLINE( 449)								HX_STACK_DO_THROW(HX_("impossible",55,a2,06,35));
            							}
            							break;
            						}
            					}
...
HXLINE( 325)				HX_VARI_NAME( int,threadId1,"threadId") = this->currentThreadInfo->number;
HXLINE( 326)				HX_VARI_NAME( int,frameId2,"frameId") = ( (int)( ::Dynamic(m->__Field(HX_("params",46,fb,7a,ed),::hx::paccDynamic))->__Field(HX_("frameId",68,dd,73,48),::hx::paccDynamic)) );
HXLINE( 328)				HX_VARI( ::Array< ::String >,stackVariables) = ::cpp::vm::Debugger_obj::getStackVariables(threadId1,frameId2,false);
...
HXDLIN( 332)					while((_g5 < stackVariables->length)){
HXLINE( 332)						HX_VARI( ::String,varName) = stackVariables->__get(_g5);
HXDLIN( 332)						_g5 = (_g5 + 1);
HXLINE( 333)						if ((varName == HX_("this",5e,06,fc,4c))) {
HXLINE( 334)							HX_VARI_NAME(  ::Dynamic,value3,"value") = ::cpp::vm::Debugger_obj::getStackVariableValue(threadId1,frameId2,HX_("this",5e,06,fc,4c),false);
HXLINE( 335)							 ::hxcpp::debug::jsonrpc::_Server::References id = this->references;
HXDLIN( 335)							HX_VARI_NAME( int,id1,"id") = id->create(::hxcpp::debug::jsonrpc::VariablesPrinter_obj::resolveValue(value3));
...
HXLINE( 343)							localsVals->push(::cpp::vm::Debugger_obj::getStackVariableValue(threadId1,frameId2,varName,false));
            						}
            					}
            				}
            			}
...
HXLINE( 356)					HX_VARI_NAME( int,refId2,"refId") = ( (int)( ::Dynamic(m->__Field(HX_("params",46,fb,7a,ed),::hx::paccDynamic))->__Field(HX_("variablesReference",14,76,04,51),::hx::paccDynamic)) );
HXLINE( 357)					HX_VARI_NAME(  ::hxcpp::debug::jsonrpc::Value,value4,"value") = this->references->get(refId2);
HXLINE( 358)					HX_VARI( ::Array< ::Dynamic>,vars) = ::hxcpp::debug::jsonrpc::VariablesPrinter_obj::getInnerVariables(value4, ::Dynamic(m->__Field(HX_("params",46,fb,7a,ed),::hx::paccDynamic))->__Field(HX_("start",62,74,0b,84),::hx::paccDynamic), ::Dynamic(m->__Field(HX_("params",46,fb,7a,ed),::hx::paccDynamic))->__Field(HX_("count",cf,44,63,4a),::hx::paccDynamic));
HXLINE( 360)					{
HXLINE( 360)						int _g6 = 0;
HXDLIN( 360)						while((_g6 < vars->length)){
HXLINE( 360)							HX_VARI_NAME(  ::Dynamic,v1,"v") = vars->__get(_g6);
HXDLIN( 360)							_g6 = (_g6 + 1);
HXLINE( 361)							HX_VARI(  ::Dynamic,varInfo) =  ::Dynamic(::hx::Anon_obj::Create(4)
            								->setFixed(0,HX_("value",71,7f,b8,31),HX_("",00,00,00,00))
            								->setFixed(1,HX_("name",4b,72,ff,48), ::Dynamic(v1->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)))
            								->setFixed(2,HX_("type",ba,f2,08,4d), ::Dynamic(v1->__Field(HX_("type",ba,f2,08,4d),::hx::paccDynamic)))
            								->setFixed(3,HX_("variablesReference",14,76,04,51),0));
HXLINE( 367)							{
HXLINE( 367)								 ::hxcpp::debug::jsonrpc::Value _g7 = v1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic);
HXDLIN( 367)								switch((int)(_g7->_hx_getIndex())){
            									case (int)0: {
HXLINE( 383)										HX_VARI_NAME(  ::Dynamic,value5,"value") = _g7->_hx_getObject(0);
HXLINE( 384)										varInfo->__SetField(HX_("value",71,7f,b8,31),value5,::hx::paccDynamic);
            									}
            									break;
            									case (int)1: {
HXLINE( 371)										 ::Dynamic _g8 = _g7->_hx_getObject(2);
HXDLIN( 371)										{
HXLINE( 371)											HX_VARI_NAME(  ::Dynamic,value6,"value") = _g7->_hx_getObject(0);
HXDLIN( 371)											HX_VARI_NAME( int,length1,"length") = _g7->_hx_getInt(1);
HXDLIN( 371)											{
HXLINE( 372)												HX_VARI_NAME( int,refId3,"refId") = this->references->create(v1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic));
HXLINE( 373)												varInfo->__SetField(HX_("variablesReference",14,76,04,51),refId3,::hx::paccDynamic);
HXLINE( 374)												varInfo->__SetField(HX_("indexedVariables",86,e0,4d,32),length1,::hx::paccDynamic);
HXLINE( 375)												varInfo->__SetField(HX_("value",71,7f,b8,31),::Std_obj::string(value6),::hx::paccDynamic);
            											}
            										}
            									}
            									break;
            									case (int)2: {
HXLINE( 377)										bool _g9 = _g7->_hx_getBool(3);
HXDLIN( 377)										 ::Dynamic _g10 = _g7->_hx_getObject(4);
HXDLIN( 377)										{
HXLINE( 377)											HX_VARI_NAME(  ::Dynamic,value7,"value") = _g7->_hx_getObject(0);
HXDLIN( 377)											HX_VARI_NAME( ::String,printedValue1,"printedValue") = _g7->_hx_getString(1);
HXDLIN( 377)											HX_VARI_NAME( ::Array< ::String >,names2,"names") = _g7->_hx_getObject(2).StaticCast< ::Array< ::String > >();
HXDLIN( 377)											{
HXLINE( 378)												HX_VARI_NAME( int,refId4,"refId") = this->references->create(v1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic));
HXLINE( 379)												varInfo->__SetField(HX_("variablesReference",14,76,04,51),refId4,::hx::paccDynamic);
HXLINE( 380)												varInfo->__SetField(HX_("namedVariables",be,f3,f7,2b),names2->length,::hx::paccDynamic);
HXLINE( 381)												varInfo->__SetField(HX_("value",71,7f,b8,31),printedValue1,::hx::paccDynamic);
            											}
            										}
            									}
            									break;
            									case (int)3: {
HXLINE( 368)										HX_VARI_NAME( ::Array< ::String >,names3,"names") = _g7->_hx_getObject(0).StaticCast< ::Array< ::String > >();
HXDLIN( 368)										HX_VARI_NAME( ::cpp::VirtualArray,values1,"values") = _g7->_hx_getObject(1).StaticCast< ::cpp::VirtualArray >();
HXLINE( 369)										HX_STACK_DO_THROW(HX_("impossible",55,a2,06,35));
            									}
            									break;
            								}
            							}
...
HXDLIN( 389)					HX_VARI(  ::Dynamic,e) = _g11;
HXLINE( 390)					this->stateMutex->release();
HXLINE( 391)					HX_STACK_DO_THROW(e);
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
            				}
...
HXLINE( 280)				::Dynamic this2 = this->breakpoints;
HXDLIN( 280)				::Array< ::Dynamic> v2 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 280)				( ( ::haxe::ds::StringMap)(this2) )->set(this->path2Key(( (::String)(params->__Field(HX_("file",7c,ce,bb,43),::hx::paccDynamic)) )),v2);
            			}
HXLINE( 282)			{
HXLINE( 282)				int _g12 = 0;
HXDLIN( 282)				::Dynamic this3 = this->breakpoints;
HXDLIN( 282)				::Array< ::Dynamic> _g13 = ( (::Array< ::Dynamic>)(( ( ::haxe::ds::StringMap)(this3) )->get(this->path2Key(( (::String)(params->__Field(HX_("file",7c,ce,bb,43),::hx::paccDynamic)) )))) );
HXDLIN( 282)				while((_g12 < _g13->length)){
HXLINE( 282)					HX_VARI(  ::Dynamic,rm) = _g13->__get(_g12);
HXDLIN( 282)					_g12 = (_g12 + 1);
HXLINE( 283)					::cpp::vm::Debugger_obj::deleteBreakpoint(rm->__Field(HX_("id",db,5b,00,00),::hx::paccDynamic));
            				}
            			}
HXLINE( 285)			{
HXLINE( 285)				int _g14 = 0;
HXDLIN( 285)				::Array< ::Dynamic> _g15 = ( (::Array< ::Dynamic>)(params->__Field(HX_("breakpoints",22,d0,50,34),::hx::paccDynamic)) );
HXDLIN( 285)				while((_g14 < _g15->length)){
HXLINE( 285)					HX_VARI(  ::Dynamic,b) = _g15->__get(_g14);
HXDLIN( 285)					_g14 = (_g14 + 1);
...
HXLINE( 296)					::Dynamic this4 = this->path2file;
HXDLIN( 296)					::String _hx_tmp = ( ( ::haxe::ds::StringMap)(this4) )->get_string(this->path2Key(( (::String)(params->__Field(HX_("file",7c,ce,bb,43),::hx::paccDynamic)) )));
...
HXLINE( 299)			{
HXLINE( 299)				::Dynamic this5 = this->breakpoints;
HXDLIN( 299)				( ( ::haxe::ds::StringMap)(this5) )->set(this->path2Key(( (::String)(params->__Field(HX_("file",7c,ce,bb,43),::hx::paccDynamic)) )),result);
            			}
HXLINE( 300)			::cpp::VirtualArray _g17 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN( 300)			{
HXLINE( 300)				int _g18 = 0;
HXDLIN( 300)				while((_g18 < result->length)){
HXLINE( 300)					HX_VARI_NAME(  ::Dynamic,b1,"b") = result->__get(_g18);
HXDLIN( 300)					_g18 = (_g18 + 1);
HXDLIN( 300)					_g17->push( ::Dynamic(b1->__Field(HX_("id",db,5b,00,00),::hx::paccDynamic)));
            				}
            			}
HXDLIN( 300)			m->__SetField(HX_("result",dd,68,84,08),_g17,::hx::paccDynamic);
...
HXLINE( 398)				HX_VARI_NAME( ::String,value8,"value") = ( (::String)( ::Dynamic(m->__Field(HX_("params",46,fb,7a,ed),::hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXLINE( 399)				HX_VARI(  ::EReg,stringPattern) =  ::EReg_obj::__alloc( HX_CTX ,HX_("\"(.*?)\"",96,cb,81,1c),HX_("",00,00,00,00));
HXLINE( 400)				if (stringPattern->match(value8)) {
HXLINE( 401)					value8 = stringPattern->matched(1);
            				}
HXLINE( 403)				HX_VARI_NAME( int,frameId3,"frameId") = (this->currentThreadInfo->stack->length - 3);
HXLINE( 404)				HX_VARI_NAME(  ::Dynamic,result1,"result") = ::cpp::vm::Debugger_obj::setStackVariableValue(this->currentThreadInfo->number,frameId3,name,value8,false);
HXLINE( 406)				 ::hxcpp::debug::jsonrpc::Value _g19 = ::hxcpp::debug::jsonrpc::VariablesPrinter_obj::resolveValue(result1);
HXDLIN( 406)				::String _hx_tmp1;
HXDLIN( 406)				if ((_g19->_hx_getIndex() == 0)) {
HXLINE( 407)					HX_VARI(  ::Dynamic,val) = _g19->_hx_getObject(0);
HXLINE( 406)					_hx_tmp1 = ( (::String)(val) );
            				}
            				else {
HXLINE( 406)					_hx_tmp1 = ::Std_obj::string(result1);
            				}
HXLINE( 405)				m->__SetField(HX_("result",dd,68,84,08), ::Dynamic(::hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("value",71,7f,b8,31),_hx_tmp1)),::hx::paccDynamic);
...
HXLINE( 476)				{
HXLINE( 476)					int _g20 = 0;
HXDLIN( 476)					::Array< ::Dynamic> _g21 = this->currentThreadInfo->stack;
HXDLIN( 476)					while((_g20 < _g21->length)){
HXLINE( 476)						HX_VARI(  ::cpp::vm::StackFrame,s) = _g21->__get(_g20).StaticCast<  ::cpp::vm::StackFrame >();
HXDLIN( 476)						_g20 = (_g20 + 1);
...
HXLINE( 481)						i = (i + 1);
HXLINE( 482)						::String _hx_tmp2 = (((HX_("",00,00,00,00) + s->className) + HX_(".",2e,00,00,00)) + s->functionName);
HXLINE( 483)						::Dynamic this6 = this->file2path;
HXDLIN( 483)						::String _hx_tmp3 = ( ( ::haxe::ds::StringMap)(this6) )->get_string(this->path2Key(s->fileName));
HXLINE( 480)						m1( ::Dynamic(::hx::Anon_obj::Create(6)
            							->setFixed(0,HX_("column",d6,4e,8b,c6),0)
            							->setFixed(1,HX_("id",db,5b,00,00),(i - 1))
            							->setFixed(2,HX_("source",db,b0,31,32),_hx_tmp3)
            							->setFixed(3,HX_("artificial",fa,70,1b,44),false)
            							->setFixed(4,HX_("line",f4,17,b3,47),s->lineNumber)
            							->setFixed(5,HX_("name",4b,72,ff,48),_hx_tmp2)));
            					}
            					_hx_goto_26:;
            				}
            			}
...
HXLINE( 314)			::cpp::VirtualArray _g22 = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 315)			{
HXLINE( 315)				HX_VARI(  ::Dynamic,tid) = this->threads->keys();
HXDLIN( 315)				while(( (bool)(tid->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 315)					HX_VARI_NAME( int,tid1,"tid") = ( (int)(tid->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 316)					_g22->push( ::Dynamic(::hx::Anon_obj::Create(2)
            						->setFixed(0,HX_("id",db,5b,00,00),tid1)
            						->setFixed(1,HX_("name",4b,72,ff,48),this->threads->get(tid1))));
            				}
            			}
HXLINE( 314)			m->__SetField(HX_("result",dd,68,84,08),_g22,::hx::paccDynamic);
...
HXLINE( 527)					_hx_tmp1 = (threadNumber == this->currentThreadInfo->number);
            				}
            				else {
...
HXLINE( 592)
HXDLIN( 592)		::haxe::Log_obj::trace(message,::hx::SourceInfo(HX_("hxcpp/debug/jsonrpc/Server.hx",71,c2,e2,bc),592,HX_("hxcpp.debug.jsonrpc.Server",6a,85,bd,65),HX_("log",84,54,52,00)));
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_5d77fc6d6289cb3b_29_new,"cpp.vm.WeakRef","new",0x9ce60541,"cpp.vm.WeakRef.new","/usr/local/lib/haxe/std/cpp/vm/WeakRef.hx",29,0xff0f6792)
HX_LOCAL_STACK_FRAME(_hx_pos_5d77fc6d6289cb3b_37_get,"cpp.vm.WeakRef","get",0x9ce0b577,"cpp.vm.WeakRef.get","/usr/local/lib/haxe/std/cpp/vm/WeakRef.hx",37,0xff0f6792)
namespace cpp{
namespace vm{

void WeakRef_obj::__construct( ::Dynamic inObject,::hx::Null< bool >  __o_inHard){
            		bool inHard = __o_inHard.Default(false);
            	HX_STACKFRAME(&_hx_pos_5d77fc6d6289cb3b_29_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(inObject,"inObject")
            	HX_STACK_ARG(inHard,"inHard")
HXLINE(  29)
...
bool WeakRef_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic WeakRef_obj::get(){
            	HX_STACKFRAME(&_hx_pos_5d77fc6d6289cb3b_37_get)
            	HX_STACK_THIS(this)
HXLINE(  37)

...
HX_DEFINE_STACK_FRAME(_hx_pos_2904dd8f2d87290d_83_new,"cpp.vm.ThreadInfo","new",0x0ce7c2b6,"cpp.vm.ThreadInfo.new","/usr/local/lib/haxe/std/cpp/vm/Debugger.hx",83,0x7c2c74ae)
namespace cpp{
namespace vm{
...
void ThreadInfo_obj::__construct(int number,int status,::hx::Null< int >  __o_breakpoint,::String criticalErrorDescription){
            	...
            	HX_STACKFRAME(&_hx_pos_2904dd8f2d87290d_83_new)
            	HX_STACK_THIS(this)

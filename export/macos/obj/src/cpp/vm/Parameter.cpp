...
HX_DEFINE_STACK_FRAME(_hx_pos_611afd0411da8ae8_34_new,"cpp.vm.Parameter","new",0xef7a672f,"cpp.vm.Parameter.new","/usr/local/lib/haxe/std/cpp/vm/Debugger.hx",34,0x7c2c74ae)
namespace cpp{
namespace vm{

void Parameter_obj::__construct(::String name, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_611afd0411da8ae8_34_new)
            	HX_STACK_THIS(this)

...
HX_DEFINE_STACK_FRAME(_hx_pos_3851c54785e8bb38_50_new,"cpp.vm.StackFrame","new",0x11668ca3,"cpp.vm.StackFrame.new","/usr/local/lib/haxe/std/cpp/vm/Debugger.hx",50,0x7c2c74ae)
namespace cpp{
namespace vm{

void StackFrame_obj::__construct(::String fileName,int lineNumber,::String className,::String functionName){
            	HX_STACKFRAME(&_hx_pos_3851c54785e8bb38_50_new)
            	HX_STACK_THIS(this)

...
HXLINE(  34)
HXLINE(  35)		HX_VARI( ::cpp::Function<  ::hx::Object *  (const char*) >,factory) =  ::__hxcpp_cast_get_proc_address(lib,(prim + HX_("__prime",1f,b0,e9,32)),quietFail);
HXLINE(  36)		if (::hx::IsNotNull( factory )) {
HXLINE(  37)			HX_VARI(  ::Dynamic,func) = ( ( ::Dynamic)(factory(signature.utf8_str())) );
